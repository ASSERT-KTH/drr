...
public class ElitisticListPopulation_ESTest {
  ...
  public void test1()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(2681, 0.0);
      // Undeclared exception!
      try { 
        elitisticListPopulation0.setElitismRate((-1049.2781499));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // elitism rate (-1,049.278)
         //
  ...
  public void test2()  throws Throwable  {
      ...
      try {
        elitisticListPopulation0 = new ElitisticListPopulation(227, 227);
        fail("Expecting exception: IllegalArgumentException");
