...
public class ElitisticListPopulation_ESTest {
  ...
  public void test0()  throws Throwable  {
      ...
      try {
        elitisticListPopulation0 = new ElitisticListPopulation(linkedList0, (-2723), (-2723));
  ...
  public void test2()  throws Throwable  {
      ...
      try { 
        elitisticListPopulation0.setElitismRate((-849.239060548));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // elitism rate (-849.239)
         //
  ...
  public void test3()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = null;
      try {
        elitisticListPopulation0 = new ElitisticListPopulation(836, 836);
        fail("Expecting exception: IllegalArgumentException");
