...
public class GaussianFitter_ESTest {
  ...
  public void test3()  throws Throwable  {
      ...
      WeightedObservedPoint weightedObservedPoint0 = new WeightedObservedPoint(61.338011, 61.338011, 147.335429425);
      ...
      assertArrayEquals(new double[] {147.335429425, 61.338011, 0.0}, doubleArray0, 0.01);
  }
  ...
  public void test4()  throws Throwable  {
      ...
      WeightedObservedPoint weightedObservedPoint1 = new WeightedObservedPoint((-93.8), 0.0, (-1.0));
  ...
  public void test5()  throws Throwable  {
      ...
      weightedObservedPointArray0[0] = weightedObservedPoint0;
      weightedObservedPointArray0[1] = weightedObservedPoint0;
      WeightedObservedPoint weightedObservedPoint1 = new WeightedObservedPoint(3312.348044139449, 0.0, 1.0);
      weightedObservedPointArray0[2] = weightedObservedPoint1;
  ...
  public void test6()  throws Throwable  {
      WeightedObservedPoint[] weightedObservedPointArray0 = new WeightedObservedPoint[3];
      WeightedObservedPoint weightedObservedPoint0 = new WeightedObservedPoint((-2539.671876), (-2539.671876), (-2539.671876));
      weightedObservedPointArray0[0] = weightedObservedPoint0;
      WeightedObservedPoint weightedObservedPoint1 = new WeightedObservedPoint((-2539.671876), 1831.2659233099, 1212.84);
      weightedObservedPointArray0[1] = weightedObservedPoint1;
      weightedObservedPointArray0[2] = weightedObservedPointArray0[0];
      GaussianFitter.ParameterGuesser gaussianFitter_ParameterGuesser0 = new GaussianFitter.ParameterGuesser(weightedObservedPointArray0);
      double[] doubleArray0 = gaussianFitter_ParameterGuesser0.guess();
      assertArrayEquals(new double[] {1212.84, 1831.2659233099, 1856.166380328418}, doubleArray0, 0.01);
  }

  @Test(timeout = 4000)
  public void test7()  throws Throwable  {
      WeightedObservedPoint[] weightedObservedPointArray0 = new WeightedObservedPoint[8];
      WeightedObservedPoint weightedObservedPoint0 = new WeightedObservedPoint(2861.35157635, 144.59, 0.0);
  ...
  public void test8()  throws Throwable  {
      WeightedObservedPoint[] weightedObservedPointArray0 = new WeightedObservedPoint[8];
      WeightedObservedPoint weightedObservedPoint0 = new WeightedObservedPoint(1696.9359, 1696.9359, (-623.651));
      weightedObservedPointArray0[0] = weightedObservedPoint0;
      WeightedObservedPoint weightedObservedPoint1 = new WeightedObservedPoint((-623.651), 1696.9359, (-623.651));
      weightedObservedPointArray0[1] = weightedObservedPoint1;
      GaussianFitter.ParameterGuesser gaussianFitter_ParameterGuesser0 = new GaussianFitter.ParameterGuesser(weightedObservedPointArray0);
      // Undeclared exception!
      try { 
