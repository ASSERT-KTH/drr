...
public class SimplexSolver_ESTest {
  ...
  public void test1()  throws Throwable  {
      ...
      doReturn(arrayRealVector0).when(linearConstraint0).getCoefficients();
      doReturn(relationship0, relationship0, relationship0, relationship0, relationship1).when(linearConstraint0).getRelationship();
      doReturn((-1349.346137151), 1.0).when(linearConstraint0).getValue();
      ...
      doReturn(relationship0, relationship0, relationship0, relationship0, relationship1).when(linearConstraint1).getRelationship();
  ...
  public void test2()  throws Throwable  {
      ...
      LinearConstraint linearConstraint1 = mock(LinearConstraint.class, new ViolatedAssumptionAnswer());
      doReturn(arrayRealVector0).when(linearConstraint1).getCoefficients();
      doReturn(relationship2, relationship2, relationship3, relationship2, relationship3).when(linearConstraint1).getRelationship();
      doReturn(1.0, 1.7976931348623157E308).when(linearConstraint1).getValue();
      linkedList0.add(linearConstraint1);
      linkedList0.addLast(linearConstraint0);
      try { 
  ...
  public void test3()  throws Throwable  {
      ...
      LinkedList<LinearConstraint> linkedList0 = new LinkedList<LinearConstraint>();
      GoalType goalType0 = GoalType.MINIMIZE;
      SimplexTableau simplexTableau0 = new SimplexTableau(linearObjectiveFunction0, linkedList0, goalType0, true, 161.0);
