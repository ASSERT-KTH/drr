...
public class SimplexSolver_ESTest {
  ...
  public void test1()  throws Throwable  {
      ...
      LinearObjectiveFunction linearObjectiveFunction0 = new LinearObjectiveFunction(arrayRealVector0, (-2399.59645));
      LinkedList<LinearConstraint> linkedList0 = new LinkedList<LinearConstraint>();
      ...
      doReturn(doubleArray0[0], (double)100).when(linearConstraint0).getValue();
      linkedList0.add(linearConstraint0);
      GoalType goalType0 = GoalType.MINIMIZE;
      try { 
  ...
  public void test2()  throws Throwable  {
      ...
      doReturn((double)100, 1069.932369419655).when(linearConstraint1).getValue();
  ...
  public void test3()  throws Throwable  {
      ...
      LinkedList<LinearConstraint> linkedList0 = new LinkedList<LinearConstraint>();
      GoalType goalType0 = GoalType.MINIMIZE;
      SimplexTableau simplexTableau0 = new SimplexTableau(linearObjectiveFunction0, linkedList0, goalType0, false, 885.288066555);
