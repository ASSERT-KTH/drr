...
public class AbstractLeastSquaresOptimizer_ESTest {
  ...
  public void test07()  throws Throwable  {
      GaussNewtonOptimizer gaussNewtonOptimizer0 = new GaussNewtonOptimizer(true);
      gaussNewtonOptimizer0.setMaxIterations((-6015));
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // maximal number of iterations (-6,015) exceeded
         //
  ...
  public void test10()  throws Throwable  {
      GaussNewtonOptimizer gaussNewtonOptimizer0 = new GaussNewtonOptimizer(true);
      gaussNewtonOptimizer0.setMaxEvaluations((-2927));
