...
public class AbstractLeastSquaresOptimizer_ESTest {
  ...
  public void test07()  throws Throwable  {
      LevenbergMarquardtOptimizer levenbergMarquardtOptimizer0 = new LevenbergMarquardtOptimizer();
      levenbergMarquardtOptimizer0.setMaxIterations((-3073));
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // maximal number of iterations (-3,073) exceeded
         //
  ...
  public void test08()  throws Throwable  {
      ...
      try { 
        levenbergMarquardtOptimizer0.optimize(differentiableMultivariateVectorialFunction0, doubleArray0[2], doubleArray0[2], doubleArray0[2]);
        fail("Expecting exception: Exception");
  ...
  public void test11()  throws Throwable  {
      GaussNewtonOptimizer gaussNewtonOptimizer0 = new GaussNewtonOptimizer(false);
      gaussNewtonOptimizer0.rows = 184;
      // Undeclared exception!
      try { 
