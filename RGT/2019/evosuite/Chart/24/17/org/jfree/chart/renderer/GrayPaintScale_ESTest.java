...
public class GrayPaintScale_ESTest {
  ...
  public void test0()  throws Throwable  {
      ...
      Color color0 = (Color)grayPaintScale0.getPaint(1561.8);
  ...
  public void test7()  throws Throwable  {
      GrayPaintScale grayPaintScale0 = new GrayPaintScale();
      GrayPaintScale grayPaintScale1 = new GrayPaintScale((-255.52), (-1.0));
      boolean boolean0 = grayPaintScale0.equals(grayPaintScale1);
      assertFalse(boolean0);
      assertEquals((-1.0), grayPaintScale1.getUpperBound(), 0.01);
      assertEquals((-255.52), grayPaintScale1.getLowerBound(), 0.01);
  }

  @Test(timeout = 4000)
  public void test8()  throws Throwable  {
      GrayPaintScale grayPaintScale0 = new GrayPaintScale(1.0, 1036.418994862068);
      GrayPaintScale grayPaintScale1 = new GrayPaintScale(1.0, 3772.0);
      boolean boolean0 = grayPaintScale0.equals(grayPaintScale1);
      assertEquals(1.0, grayPaintScale1.getLowerBound(), 0.01);
      assertEquals(3772.0, grayPaintScale1.getUpperBound(), 0.01);
      assertFalse(boolean0);
