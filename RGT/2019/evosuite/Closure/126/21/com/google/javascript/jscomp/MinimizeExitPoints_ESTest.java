...
public class MinimizeExitPoints_ESTest extends MinimizeExitPoints_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      MockPrintStream mockPrintStream0 = new MockPrintStream("n1f*y-^V.~vc,!");
      Compiler compiler0 = new Compiler(mockPrintStream0);
      MinimizeExitPoints minimizeExitPoints0 = new MinimizeExitPoints(compiler0);
      Node node0 = Node.newString(105, "n1f*y-^V.~vc,!", 105, 105);
  ...
  public void test4()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      MinimizeExitPoints minimizeExitPoints0 = new MinimizeExitPoints(compiler0);
      Node node0 = new Node(115, 114, 117);
      // Undeclared exception!
      try { 
        minimizeExitPoints0.process(node0, node0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test5()  throws Throwable  {
      ...
      MinimizeExitPoints minimizeExitPoints0 = new MinimizeExitPoints(compiler0);
      Node node0 = new Node((-2868));
      minimizeExitPoints0.tryMinimizeExits(node0, (-2868), "WLN'}2");
