...
public class AbstractLeastSquaresOptimizer_ESTest {
  ...
  public void test07()  throws Throwable  {
      GaussNewtonOptimizer gaussNewtonOptimizer0 = new GaussNewtonOptimizer(false);
      gaussNewtonOptimizer0.setMaxIterations((-2646));
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // maximal number of iterations (-2,646) exceeded
         //
  ...
  public void test08()  throws Throwable  {
      ...
      doReturn(doubleArray0[4]).when(differentiableMultivariateVectorialFunction0).value(any(double[].class));
      try { 
        levenbergMarquardtOptimizer0.optimize(differentiableMultivariateVectorialFunction0, doubleArray0[3], doubleArray0[3], doubleArray0[3]);
        fail("Expecting exception: Exception");
  ...
  public void test11()  throws Throwable  {
      GaussNewtonOptimizer gaussNewtonOptimizer0 = new GaussNewtonOptimizer(false);
      gaussNewtonOptimizer0.rows = 639;
      // Undeclared exception!
      try { 
