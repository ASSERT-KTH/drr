...
public class DiscreteDistribution_ESTest {
  ...
  public void test0()  throws Throwable  {
      ...
      Double double0 = new Double(0.6232728299672516);
  ...
  public void test1()  throws Throwable  {
      LinkedList<Pair<Object, Double>> linkedList0 = new LinkedList<Pair<Object, Double>>();
      Double double0 = new Double((-382.92));
      ...
      try {
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // -382.92 is smaller than the minimum (0)
         //
  ...
  public void test3()  throws Throwable  {
      ...
      Double double0 = new Double(2482.178320659911);
  ...
  public void test4()  throws Throwable  {
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      Double double0 = new Double(2482.178320659911);
      Pair<String, Double> pair0 = new Pair<String, Double>("~hPxu[", double0);
      linkedList0.add(pair0);
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(linkedList0);
      double double1 = discreteDistribution0.probability((String) null);
  ...
  public void test7()  throws Throwable  {
      ...
      linkedList0.add(pair0);
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(linkedList0);
      Object[] objectArray0 = discreteDistribution0.sample(1893);
  ...
  public void test8()  throws Throwable  {
      LinkedList<Pair<Object, Double>> linkedList0 = new LinkedList<Pair<Object, Double>>();
      Double double0 = new Double(153.925690855);
      Pair<Object, Double> pair0 = new Pair<Object, Double>(linkedList0, double0);
      linkedList0.add(pair0);
      DiscreteDistribution<Object> discreteDistribution0 = new DiscreteDistribution<Object>(linkedList0);
      try { 
