...
public class DiscreteDistribution_ESTest {
  ...
  public void test0()  throws Throwable  {
      ...
      Double double0 = new Double((-157.0637046989));
      Double double1 = new Double(93.29);
      Pair<Double, Double> pair0 = new Pair<Double, Double>(double0, double1);
      linkedList0.add(pair0);
      DiscreteDistribution<Double> discreteDistribution0 = new DiscreteDistribution<Double>(linkedList0);
      discreteDistribution0.reseedRandomGenerator(745L);
  }

  @Test(timeout = 4000)
  public void test1()  throws Throwable  {
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      Double double0 = new Double((-2335.7268497552373));
      ...
      try {
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // -2,335.727 is smaller than the minimum (0)
         //
  ...
  public void test5()  throws Throwable  {
      ...
      Pair<String, Double> pair0 = new Pair<String, Double>("'4[3}o,ocUHZ?b!GHY", double0);
      linkedList0.add(pair0);
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(well44497a0, linkedList0);
      double double1 = discreteDistribution0.probability("Se-~$\"h1M,Aw;y%KPw");
      assertEquals(0.0, double1, 0.01);
  }
  ...
  public void test7()  throws Throwable  {
      ...
      linkedList0.add(pair0);
      DiscreteDistribution<Object> discreteDistribution0 = new DiscreteDistribution<Object>(linkedList0);
      Object[] objectArray0 = discreteDistribution0.sample(1145);
      assertEquals(1145, objectArray0.length);
  }
  ...
  public void test8()  throws Throwable  {
      ...
      Double double0 = new Double(1545.1);
      Pair<Integer, Double> pair0 = new Pair<Integer, Double>(integer0, double0);
      Pair<Object, Double> pair1 = new Pair<Object, Double>(pair0);
      linkedList0.addFirst(pair1);
      DiscreteDistribution<Object> discreteDistribution0 = new DiscreteDistribution<Object>(linkedList0);
      try { 
        discreteDistribution0.sample((-1509));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // number of samples (-1,509)
         //
         verifyException("org.apache.commons.math3.distribution.DiscreteDistribution", e);
      }
  }
