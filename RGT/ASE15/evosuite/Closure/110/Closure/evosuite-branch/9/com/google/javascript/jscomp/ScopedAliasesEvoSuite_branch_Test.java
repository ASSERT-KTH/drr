...
//       
//       String string0 = "2gJGkFD8";
//       JSSourceFile jSSourceFile0 = JSSourceFile.fromFile(string0);
//       assertNotNull(jSSourceFile0);
//       assertEquals("2gJGkFD8", jSSourceFile0.getOriginalPath());
//       assertEquals(false, jSSourceFile0.isExtern());
//       assertEquals("2gJGkFD8", jSSourceFile0.getName());
//       assertEquals("2gJGkFD8", jSSourceFile0.toString());
//       
//       JSSourceFile[] jSSourceFileArray0 = new JSSourceFile[1];
//       String string1 = "hUB_gC(p8s0";
//       assertNotSame(string1, string0);
//       
//       JSSourceFile jSSourceFile1 = JSSourceFile.fromCode(string1, string1);
//       assertNotSame(string1, string0);
...
//       assertEquals("hUB_gC(p8s0", jSSourceFile1.getName());
//       assertEquals(false, jSSourceFile1.isExtern());
//       assertEquals("hUB_gC(p8s0", jSSourceFile1.getOriginalPath());
//       assertEquals("hUB_gC(p8s0", jSSourceFile1.toString());
//       
//       jSSourceFileArray0[0] = jSSourceFile1;
//       assertNotNull(jSSourceFileArray0[0]);
//       assertEquals(false, jSSourceFileArray0[0].isExtern());
//       assertEquals("hUB_gC(p8s0", jSSourceFileArray0[0].getOriginalPath());
//       assertEquals("hUB_gC(p8s0", jSSourceFileArray0[0].toString());
//       assertEquals("hUB_gC(p8s0", jSSourceFileArray0[0].getName());
//       assertEquals("hUB_gC(p8s0", jSSourceFile1.getName());
//       assertEquals(false, jSSourceFile1.isExtern());
//       assertEquals("hUB_gC(p8s0", jSSourceFile1.getOriginalPath());
//       assertEquals("hUB_gC(p8s0", jSSourceFile1.toString());
...
//       assertEquals(false, node0.isOptionalArg());
//       
//       CompilerInput compilerInput0 = compiler0.newExternInput(compilerOptions0.inputDelimiter);
//       assertFalse(compilerOptions0.removeUnusedPrototypeProperties);
//       assertFalse(compilerOptions0.smartNameRemoval);
//       assertFalse(compilerOptions0.checkSuspiciousCode);
//       assertFalse(compilerOptions0.inlineGetters);
...
//       assertEquals(false, compilerOptions0.isRemoveUnusedClassProperties());
//       
//       Node node1 = compilerInput0.getAstRoot((AbstractCompiler) compiler0);
...
//       assertEquals("// Input %num%", node1.getSourceFileName());
...
//       assertEquals(true, node1.isFromExterns());
