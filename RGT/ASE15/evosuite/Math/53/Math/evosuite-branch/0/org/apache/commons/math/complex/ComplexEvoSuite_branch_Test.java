...
public class ComplexEvoSuite_branch_Test   {
  ...
  public void test02()  throws Throwable  {
      double double0 = (-13.381054653714383);
      Complex complex0 = new Complex(double0, double0);
      assertNotNull(complex0);
      assertEquals(18.9236689701385, complex0.abs(), 0.01D);
      assertEquals(false, complex0.isInfinite());
      assertEquals((-2.356194490192345), complex0.getArgument(), 0.01D);
      assertEquals((-13.381054653714383), complex0.getImaginary(), 0.01D);
      assertEquals(false, complex0.isNaN());
      assertEquals((-13.381054653714383), complex0.getReal(), 0.01D);
  ...
  public void test05()  throws Throwable  {
      ...
      assertNotNull(complex0);
      assertEquals(false, complex0.isNaN());
      assertEquals(3.834E-20, complex0.getImaginary(), 0.01D);
      assertEquals(0.7853981633974483, complex0.getArgument(), 0.01D);
      assertEquals(5.422094798138447E-20, complex0.abs(), 0.01D);
      assertEquals(3.834E-20, complex0.getReal(), 0.01D);
      assertEquals(false, complex0.isInfinite());
      ...
      assertNotSame(complex0, complex1);
      assertNotNull(complex1);
      assertEquals((-1.4699556E-39), complex1.getArgument(), 0.01D);
      assertEquals(false, complex1.isNaN());
      assertEquals((-1.4699556E-39), complex1.getImaginary(), 0.01D);
      ...
      assertEquals(3.834E-20, complex0.getReal(), 0.01D);
      assertEquals(false, complex0.isInfinite());
      assertEquals(3.834E-20, complex2.getImaginary(), 0.01D);
      assertEquals(false, complex2.isInfinite());
      assertEquals(5.422094798138447E-20, complex2.abs(), 0.01D);
      assertEquals(3.834E-20, complex2.getReal(), 0.01D);
  ...
  public void test08()  throws Throwable  {
      double double0 = 850.314306231;
      Complex complex0 = new Complex(double0, double0);
      assertNotNull(complex0);
      assertEquals(1202.5260241517494, complex0.abs(), 0.01D);
      assertEquals(0.7853981633974483, complex0.getArgument(), 0.01D);
      assertEquals(850.314306231, complex0.getReal(), 0.01D);
      assertEquals(850.314306231, complex0.getImaginary(), 0.01D);
      assertEquals(false, complex0.isNaN());
      assertEquals(false, complex0.isInfinite());
  ...
  public void test19()  throws Throwable  {
      ...
      assertEquals(4962.0, complex1.abs(), 0.01D);
      assertEquals(4962.0, complex1.getImaginary(), 0.01D);
      assertEquals(false, complex1.isInfinite());
      assertEquals(false, complex1.isNaN());
  }
  ...
  public void test23()  throws Throwable  {
      ...
      assertEquals(true, complex1.isInfinite());
      assertEquals(Double.POSITIVE_INFINITY, complex1.getImaginary(), 0.01D);
      assertEquals((-13.381054653714383), complex1.getReal(), 0.01D);
      assertEquals(false, complex1.isNaN());
      assertEquals(1.5707963267948966, complex1.getArgument(), 0.01D);
      assertEquals((-13.381054653714383), complex0.getImaginary(), 0.01D);
      assertEquals((-2.356194490192345), complex0.getArgument(), 0.01D);
