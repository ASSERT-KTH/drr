...
public abstract class Axis implements Cloneable, Serializable {
    ...
    public static int eid_Axis_String_7au3e = 0;

	public static int eid_isVisible_7au3e = 0;

	public static int eid_setVisible_boolean_7au3e = 0;

	public static int eid_getLabel_7au3e = 0;

	public static int eid_setLabel_String_7au3e = 0;

	public static int eid_getLabelFont_7au3e = 0;

	public static int eid_setLabelFont_Font_7au3e = 0;

	public static int eid_getLabelPaint_7au3e = 0;

	public static int eid_setLabelPaint_Paint_7au3e = 0;

	public static int eid_getLabelInsets_7au3e = 0;

	public static int eid_setLabelInsets_RectangleInsets_7au3e = 0;

	public static int eid_getLabelAngle_7au3e = 0;

	public static int eid_setLabelAngle_double_7au3e = 0;

	public static int eid_getLabelToolTip_7au3e = 0;

	public static int eid_setLabelToolTip_String_7au3e = 0;

	public static int eid_getLabelURL_7au3e = 0;

	public static int eid_setLabelURL_String_7au3e = 0;

	public static int eid_isAxisLineVisible_7au3e = 0;

	public static int eid_setAxisLineVisible_boolean_7au3e = 0;

	public static int eid_getAxisLinePaint_7au3e = 0;

	public static int eid_setAxisLinePaint_Paint_7au3e = 0;

	public static int eid_getAxisLineStroke_7au3e = 0;

	public static int eid_setAxisLineStroke_Stroke_7au3e = 0;

	public static int eid_isTickLabelsVisible_7au3e = 0;

	public static int eid_setTickLabelsVisible_boolean_7au3e = 0;

	public static int eid_getTickLabelFont_7au3e = 0;

	public static int eid_setTickLabelFont_Font_7au3e = 0;

	public static int eid_getTickLabelPaint_7au3e = 0;

	public static int eid_setTickLabelPaint_Paint_7au3e = 0;

	public static int eid_getTickLabelInsets_7au3e = 0;

	public static int eid_setTickLabelInsets_RectangleInsets_7au3e = 0;

	public static int eid_isTickMarksVisible_7au3e = 0;

	public static int eid_setTickMarksVisible_boolean_7au3e = 0;

	public static int eid_getTickMarkInsideLength_7au3e = 0;

	public static int eid_setTickMarkInsideLength_float_7au3e = 0;

	public static int eid_getTickMarkOutsideLength_7au3e = 0;

	public static int eid_setTickMarkOutsideLength_float_7au3e = 0;

	public static int eid_getTickMarkStroke_7au3e = 0;

	public static int eid_setTickMarkStroke_Stroke_7au3e = 0;

	public static int eid_getTickMarkPaint_7au3e = 0;

	public static int eid_setTickMarkPaint_Paint_7au3e = 0;

	public static int eid_getPlot_7au3e = 0;

	public static int eid_setPlot_Plot_7au3e = 0;

	public static int eid_getFixedDimension_7au3e = 0;

	public static int eid_setFixedDimension_double_7au3e = 0;

	public static int eid_configure_7au3e = 0;

	public static int eid_reserveSpace_Graphics2D_Plot_Rectangle2D_RectangleEdge_AxisSpace_7au3e = 0;

	public static int eid_draw_Graphics2D_double_Rectangle2D_Rectangle2D_RectangleEdge_PlotRenderingInfo_7au3e = 0;

	public static int eid_refreshTicks_Graphics2D_AxisState_Rectangle2D_RectangleEdge_7au3e = 0;

	public static int eid_addChangeListener_AxisChangeListener_7au3e = 0;

	public static int eid_removeChangeListener_AxisChangeListener_7au3e = 0;

	public static int eid_hasListener_EventListener_7au3e = 0;

	public static int eid_notifyListeners_AxisChangeEvent_7au3e = 0;

	public static int eid_getLabelEnclosure_Graphics2D_RectangleEdge_7au3e = 0;

	public static int eid_drawLabel_String_Graphics2D_Rectangle2D_Rectangle2D_RectangleEdge_AxisState_PlotRenderingInfo_7au3e = 0;

	public static int eid_drawAxisLine_Graphics2D_double_Rectangle2D_RectangleEdge_7au3e = 0;
	...
	public static void clearORefMap() {
		oref_map.clear();
		eid_Axis_String_7au3e = 0;
		eid_isVisible_7au3e = 0;
		eid_setVisible_boolean_7au3e = 0;
		eid_getLabel_7au3e = 0;
		eid_setLabel_String_7au3e = 0;
		eid_getLabelFont_7au3e = 0;
		eid_setLabelFont_Font_7au3e = 0;
		eid_getLabelPaint_7au3e = 0;
		eid_setLabelPaint_Paint_7au3e = 0;
		eid_getLabelInsets_7au3e = 0;
		eid_setLabelInsets_RectangleInsets_7au3e = 0;
		eid_getLabelAngle_7au3e = 0;
		eid_setLabelAngle_double_7au3e = 0;
		eid_getLabelToolTip_7au3e = 0;
		eid_setLabelToolTip_String_7au3e = 0;
		eid_getLabelURL_7au3e = 0;
		eid_setLabelURL_String_7au3e = 0;
		eid_isAxisLineVisible_7au3e = 0;
		eid_setAxisLineVisible_boolean_7au3e = 0;
		eid_getAxisLinePaint_7au3e = 0;
		eid_setAxisLinePaint_Paint_7au3e = 0;
		eid_getAxisLineStroke_7au3e = 0;
		eid_setAxisLineStroke_Stroke_7au3e = 0;
		eid_isTickLabelsVisible_7au3e = 0;
		eid_setTickLabelsVisible_boolean_7au3e = 0;
		eid_getTickLabelFont_7au3e = 0;
		eid_setTickLabelFont_Font_7au3e = 0;
		eid_getTickLabelPaint_7au3e = 0;
		eid_setTickLabelPaint_Paint_7au3e = 0;
		eid_getTickLabelInsets_7au3e = 0;
		eid_setTickLabelInsets_RectangleInsets_7au3e = 0;
		eid_isTickMarksVisible_7au3e = 0;
		eid_setTickMarksVisible_boolean_7au3e = 0;
		eid_getTickMarkInsideLength_7au3e = 0;
		eid_setTickMarkInsideLength_float_7au3e = 0;
		eid_getTickMarkOutsideLength_7au3e = 0;
		eid_setTickMarkOutsideLength_float_7au3e = 0;
		eid_getTickMarkStroke_7au3e = 0;
		eid_setTickMarkStroke_Stroke_7au3e = 0;
		eid_getTickMarkPaint_7au3e = 0;
		eid_setTickMarkPaint_Paint_7au3e = 0;
		eid_getPlot_7au3e = 0;
		eid_setPlot_Plot_7au3e = 0;
		eid_getFixedDimension_7au3e = 0;
		eid_setFixedDimension_double_7au3e = 0;
		eid_configure_7au3e = 0;
		eid_reserveSpace_Graphics2D_Plot_Rectangle2D_RectangleEdge_AxisSpace_7au3e = 0;
		eid_draw_Graphics2D_double_Rectangle2D_Rectangle2D_RectangleEdge_PlotRenderingInfo_7au3e = 0;
		eid_refreshTicks_Graphics2D_AxisState_Rectangle2D_RectangleEdge_7au3e = 0;
		eid_addChangeListener_AxisChangeListener_7au3e = 0;
		eid_removeChangeListener_AxisChangeListener_7au3e = 0;
		eid_hasListener_EventListener_7au3e = 0;
		eid_notifyListeners_AxisChangeEvent_7au3e = 0;
		eid_getLabelEnclosure_Graphics2D_RectangleEdge_7au3e = 0;
		eid_drawLabel_String_Graphics2D_Rectangle2D_Rectangle2D_RectangleEdge_AxisState_PlotRenderingInfo_7au3e = 0;
		eid_drawAxisLine_Graphics2D_double_Rectangle2D_RectangleEdge_7au3e = 0;
		eid_clone_7au3e = 0;
	...
	protected AxisState drawLabel(String label, Graphics2D g2,
		...
		try {
			...
			addToORefMap(msig_7au3e, g2);
			addToORefMap(msig_7au3e, plotArea);
			addToORefMap(msig_7au3e, dataArea);
			addToORefMap(msig_7au3e, edge);
			addToORefMap(msig_7au3e, state);
			addToORefMap(msig_7au3e, plotState);
