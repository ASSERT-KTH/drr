...
public class FastMath {
    ...
    public static int eid_FastMath_7au3e = 0;

	public static int eid_sqrt_double_7au3e = 0;

	public static int eid_cosh_double_7au3e = 0;

	public static int eid_sinh_double_7au3e = 0;

	public static int eid_tanh_double_7au3e = 0;

	public static int eid_acosh_double_7au3e = 0;

	public static int eid_asinh_double_7au3e = 0;

	public static int eid_atanh_double_7au3e = 0;

	public static int eid_signum_double_7au3e = 0;

	public static int eid_nextUp_double_7au3e = 0;

	public static int eid_random_7au3e = 0;

	public static int eid_exp_double_7au3e = 0;

	public static int eid_exp_double_double_doubleARR_7au3e = 0;

	public static int eid_expm1_double_7au3e = 0;

	public static int eid_expm1_double_double_7au3e = 0;

	public static int eid_slowexp_double_double_7au3e = 0;

	public static int eid_split_double_double_7au3e = 0;

	public static int eid_resplit_double_7au3e = 0;

	public static int eid_splitMult_double_double_double_7au3e = 0;

	public static int eid_splitAdd_double_double_double_7au3e = 0;

	public static int eid_splitReciprocal_double_double_7au3e = 0;

	public static int eid_quadMult_double_double_double_7au3e = 0;

	public static int eid_expint_int_double_7au3e = 0;

	public static int eid_log_double_7au3e = 0;

	public static int eid_log_double_doubleARR_7au3e = 0;

	public static int eid_log1p_double_7au3e = 0;

	public static int eid_log10_double_7au3e = 0;

	public static int eid_pow_double_double_7au3e = 0;

	public static int eid_slowLog_double_7au3e = 0;

	public static int eid_slowSin_double_double_7au3e = 0;

	public static int eid_slowCos_double_double_7au3e = 0;

	public static int eid_buildSinCosTables_7au3e = 0;

	public static int eid_polySine_double_7au3e = 0;

	public static int eid_polyCosine_double_7au3e = 0;

	public static int eid_sinQ_double_double_7au3e = 0;

	public static int eid_cosQ_double_double_7au3e = 0;

	public static int eid_tanQ_double_double_boolean_7au3e = 0;

	public static int eid_reducePayneHanek_double_double_7au3e = 0;

	public static int eid_sin_double_7au3e = 0;

	public static int eid_cos_double_7au3e = 0;

	public static int eid_tan_double_7au3e = 0;

	public static int eid_atan_double_7au3e = 0;

	public static int eid_atan_double_double_boolean_7au3e = 0;

	public static int eid_atan2_double_double_7au3e = 0;

	public static int eid_asin_double_7au3e = 0;

	public static int eid_acos_double_7au3e = 0;

	public static int eid_cbrt_double_7au3e = 0;

	public static int eid_toRadians_double_7au3e = 0;

	public static int eid_toDegrees_double_7au3e = 0;

	public static int eid_abs_int_7au3e = 0;

	public static int eid_abs_long_7au3e = 0;

	public static int eid_abs_float_7au3e = 0;

	public static int eid_abs_double_7au3e = 0;

	public static int eid_ulp_double_7au3e = 0;

	public static int eid_nextAfter_double_double_7au3e = 0;

	public static int eid_floor_double_7au3e = 0;

	public static int eid_ceil_double_7au3e = 0;

	public static int eid_rint_double_7au3e = 0;

	public static int eid_round_double_7au3e = 0;

	public static int eid_round_float_7au3e = 0;

	public static int eid_min_int_int_7au3e = 0;

	public static int eid_min_long_long_7au3e = 0;

	public static int eid_min_float_float_7au3e = 0;

	public static int eid_min_double_double_7au3e = 0;

	public static int eid_max_int_int_7au3e = 0;

	public static int eid_max_long_long_7au3e = 0;

	public static int eid_max_float_float_7au3e = 0;

	public static int eid_max_double_double_7au3e = 0;

	public static void clearORefMap() {
		eid_FastMath_7au3e = 0;
		eid_sqrt_double_7au3e = 0;
		eid_cosh_double_7au3e = 0;
		eid_sinh_double_7au3e = 0;
		eid_tanh_double_7au3e = 0;
		eid_acosh_double_7au3e = 0;
		eid_asinh_double_7au3e = 0;
		eid_atanh_double_7au3e = 0;
		eid_signum_double_7au3e = 0;
		eid_nextUp_double_7au3e = 0;
		eid_random_7au3e = 0;
		eid_exp_double_7au3e = 0;
		eid_exp_double_double_doubleARR_7au3e = 0;
		eid_expm1_double_7au3e = 0;
		eid_expm1_double_double_7au3e = 0;
		eid_slowexp_double_double_7au3e = 0;
		eid_split_double_double_7au3e = 0;
		eid_resplit_double_7au3e = 0;
		eid_splitMult_double_double_double_7au3e = 0;
		eid_splitAdd_double_double_double_7au3e = 0;
		eid_splitReciprocal_double_double_7au3e = 0;
		eid_quadMult_double_double_double_7au3e = 0;
		eid_expint_int_double_7au3e = 0;
		eid_log_double_7au3e = 0;
		eid_log_double_doubleARR_7au3e = 0;
		eid_log1p_double_7au3e = 0;
		eid_log10_double_7au3e = 0;
		eid_pow_double_double_7au3e = 0;
		eid_slowLog_double_7au3e = 0;
		eid_slowSin_double_double_7au3e = 0;
		eid_slowCos_double_double_7au3e = 0;
		eid_buildSinCosTables_7au3e = 0;
		eid_polySine_double_7au3e = 0;
		eid_polyCosine_double_7au3e = 0;
		eid_sinQ_double_double_7au3e = 0;
		eid_cosQ_double_double_7au3e = 0;
		eid_tanQ_double_double_boolean_7au3e = 0;
		eid_reducePayneHanek_double_double_7au3e = 0;
		eid_sin_double_7au3e = 0;
		eid_cos_double_7au3e = 0;
		eid_tan_double_7au3e = 0;
		eid_atan_double_7au3e = 0;
		eid_atan_double_double_boolean_7au3e = 0;
		eid_atan2_double_double_7au3e = 0;
		eid_asin_double_7au3e = 0;
		eid_acos_double_7au3e = 0;
		eid_cbrt_double_7au3e = 0;
		eid_toRadians_double_7au3e = 0;
		eid_toDegrees_double_7au3e = 0;
		eid_abs_int_7au3e = 0;
		eid_abs_long_7au3e = 0;
		eid_abs_float_7au3e = 0;
		eid_abs_double_7au3e = 0;
		eid_ulp_double_7au3e = 0;
		eid_nextAfter_double_double_7au3e = 0;
		eid_floor_double_7au3e = 0;
		eid_ceil_double_7au3e = 0;
		eid_rint_double_7au3e = 0;
		eid_round_double_7au3e = 0;
		eid_round_float_7au3e = 0;
		eid_min_int_int_7au3e = 0;
		eid_min_long_long_7au3e = 0;
		eid_min_float_float_7au3e = 0;
		eid_min_double_double_7au3e = 0;
		eid_max_int_int_7au3e = 0;
		eid_max_long_long_7au3e = 0;
		eid_max_float_float_7au3e = 0;
		eid_max_double_double_7au3e = 0;
	}
     ...
     * @return b if a is lesser or equal to b, a otherwise
     */
    public static float max_7au3e(final float a, final float b) {
	...
	public static float max(final float a, final float b) {
		Object o_7au3e = null;
		String c_7au3e = "org.apache.commons.math.util.FastMath";
		String msig_7au3e = "max(float$float)" + eid_max_float_float_7au3e;
		try {
			o_7au3e = max_7au3e(a, b);
			FieldPrinter.print(o_7au3e, eid_max_float_float_7au3e, c_7au3e,
					msig_7au3e, 0, 5);
		} catch (Throwable t7au3e) {
			FieldPrinter.print(t7au3e, eid_max_float_float_7au3e, c_7au3e,
					msig_7au3e, 0, 5);
			throw t7au3e;
		} finally {
			eid_max_float_float_7au3e++;
		}
		return (float) o_7au3e;
	}
