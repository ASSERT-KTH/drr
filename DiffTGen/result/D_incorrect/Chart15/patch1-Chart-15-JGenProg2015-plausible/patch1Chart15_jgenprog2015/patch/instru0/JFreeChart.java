...
public class JFreeChart implements Drawable,
    ...
    public static int eid_JFreeChart_Plot_7au3e = 0;

	public static int eid_JFreeChart_String_Plot_7au3e = 0;

	public static int eid_JFreeChart_String_Font_Plot_boolean_7au3e = 0;

	public static int eid_getRenderingHints_7au3e = 0;

	public static int eid_setRenderingHints_RenderingHints_7au3e = 0;

	public static int eid_isBorderVisible_7au3e = 0;

	public static int eid_setBorderVisible_boolean_7au3e = 0;

	public static int eid_getBorderStroke_7au3e = 0;

	public static int eid_setBorderStroke_Stroke_7au3e = 0;

	public static int eid_getBorderPaint_7au3e = 0;

	public static int eid_setBorderPaint_Paint_7au3e = 0;

	public static int eid_getPadding_7au3e = 0;

	public static int eid_setPadding_RectangleInsets_7au3e = 0;

	public static int eid_getTitle_7au3e = 0;

	public static int eid_setTitle_TextTitle_7au3e = 0;

	public static int eid_setTitle_String_7au3e = 0;

	public static int eid_addLegend_LegendTitle_7au3e = 0;

	public static int eid_getLegend_7au3e = 0;

	public static int eid_getLegend_int_7au3e = 0;

	public static int eid_removeLegend_7au3e = 0;

	public static int eid_getSubtitles_7au3e = 0;

	public static int eid_setSubtitles_List_7au3e = 0;

	public static int eid_getSubtitleCount_7au3e = 0;

	public static int eid_getSubtitle_int_7au3e = 0;

	public static int eid_addSubtitle_Title_7au3e = 0;

	public static int eid_addSubtitle_int_Title_7au3e = 0;

	public static int eid_clearSubtitles_7au3e = 0;

	public static int eid_removeSubtitle_Title_7au3e = 0;

	public static int eid_getPlot_7au3e = 0;

	public static int eid_getCategoryPlot_7au3e = 0;

	public static int eid_getXYPlot_7au3e = 0;

	public static int eid_getAntiAlias_7au3e = 0;

	public static int eid_setAntiAlias_boolean_7au3e = 0;

	public static int eid_getTextAntiAlias_7au3e = 0;

	public static int eid_setTextAntiAlias_boolean_7au3e = 0;

	public static int eid_setTextAntiAlias_Object_7au3e = 0;

	public static int eid_getBackgroundPaint_7au3e = 0;

	public static int eid_setBackgroundPaint_Paint_7au3e = 0;

	public static int eid_getBackgroundImage_7au3e = 0;

	public static int eid_setBackgroundImage_Image_7au3e = 0;

	public static int eid_getBackgroundImageAlignment_7au3e = 0;

	public static int eid_setBackgroundImageAlignment_int_7au3e = 0;

	public static int eid_getBackgroundImageAlpha_7au3e = 0;

	public static int eid_setBackgroundImageAlpha_float_7au3e = 0;

	public static int eid_isNotify_7au3e = 0;

	public static int eid_setNotify_boolean_7au3e = 0;

	public static int eid_draw_Graphics2D_Rectangle2D_7au3e = 0;

	public static int eid_draw_Graphics2D_Rectangle2D_ChartRenderingInfo_7au3e = 0;

	public static int eid_draw_Graphics2D_Rectangle2D_Point2D_ChartRenderingInfo_7au3e = 0;

	public static int eid_createAlignedRectangle2D_Size2D_Rectangle2D_HorizontalAlignment_VerticalAlignment_7au3e = 0;

	public static int eid_drawTitle_Title_Graphics2D_Rectangle2D_boolean_7au3e = 0;

	public static int eid_createBufferedImage_int_int_7au3e = 0;

	public static int eid_createBufferedImage_int_int_ChartRenderingInfo_7au3e = 0;

	public static int eid_createBufferedImage_int_int_int_ChartRenderingInfo_7au3e = 0;

	public static int eid_createBufferedImage_int_int_double_double_ChartRenderingInfo_7au3e = 0;

	public static int eid_handleClick_int_int_ChartRenderingInfo_7au3e = 0;

	public static int eid_addChangeListener_ChartChangeListener_7au3e = 0;

	public static int eid_removeChangeListener_ChartChangeListener_7au3e = 0;

	public static int eid_fireChartChanged_7au3e = 0;

	public static int eid_notifyListeners_ChartChangeEvent_7au3e = 0;

	public static int eid_addProgressListener_ChartProgressListener_7au3e = 0;

	public static int eid_removeProgressListener_ChartProgressListener_7au3e = 0;

	public static int eid_notifyListeners_ChartProgressEvent_7au3e = 0;

	public static int eid_titleChanged_TitleChangeEvent_7au3e = 0;

	public static int eid_plotChanged_PlotChangeEvent_7au3e = 0;
	...
	public static int eid_main_StringARR_7au3e = 0;

	public static int eid_clone_7au3e = 0;

	public static void clearORefMap() {
		eid_JFreeChart_Plot_7au3e = 0;
		eid_JFreeChart_String_Plot_7au3e = 0;
		eid_JFreeChart_String_Font_Plot_boolean_7au3e = 0;
		eid_getRenderingHints_7au3e = 0;
		eid_setRenderingHints_RenderingHints_7au3e = 0;
		eid_isBorderVisible_7au3e = 0;
		eid_setBorderVisible_boolean_7au3e = 0;
		eid_getBorderStroke_7au3e = 0;
		eid_setBorderStroke_Stroke_7au3e = 0;
		eid_getBorderPaint_7au3e = 0;
		eid_setBorderPaint_Paint_7au3e = 0;
		eid_getPadding_7au3e = 0;
		eid_setPadding_RectangleInsets_7au3e = 0;
		eid_getTitle_7au3e = 0;
		eid_setTitle_TextTitle_7au3e = 0;
		eid_setTitle_String_7au3e = 0;
		eid_addLegend_LegendTitle_7au3e = 0;
		eid_getLegend_7au3e = 0;
		eid_getLegend_int_7au3e = 0;
		eid_removeLegend_7au3e = 0;
		eid_getSubtitles_7au3e = 0;
		eid_setSubtitles_List_7au3e = 0;
		eid_getSubtitleCount_7au3e = 0;
		eid_getSubtitle_int_7au3e = 0;
		eid_addSubtitle_Title_7au3e = 0;
		eid_addSubtitle_int_Title_7au3e = 0;
		eid_clearSubtitles_7au3e = 0;
		eid_removeSubtitle_Title_7au3e = 0;
		eid_getPlot_7au3e = 0;
		eid_getCategoryPlot_7au3e = 0;
		eid_getXYPlot_7au3e = 0;
		eid_getAntiAlias_7au3e = 0;
		eid_setAntiAlias_boolean_7au3e = 0;
		eid_getTextAntiAlias_7au3e = 0;
		eid_setTextAntiAlias_boolean_7au3e = 0;
		eid_setTextAntiAlias_Object_7au3e = 0;
		eid_getBackgroundPaint_7au3e = 0;
		eid_setBackgroundPaint_Paint_7au3e = 0;
		eid_getBackgroundImage_7au3e = 0;
		eid_setBackgroundImage_Image_7au3e = 0;
		eid_getBackgroundImageAlignment_7au3e = 0;
		eid_setBackgroundImageAlignment_int_7au3e = 0;
		eid_getBackgroundImageAlpha_7au3e = 0;
		eid_setBackgroundImageAlpha_float_7au3e = 0;
		eid_isNotify_7au3e = 0;
		eid_setNotify_boolean_7au3e = 0;
		eid_draw_Graphics2D_Rectangle2D_7au3e = 0;
		eid_draw_Graphics2D_Rectangle2D_ChartRenderingInfo_7au3e = 0;
		eid_draw_Graphics2D_Rectangle2D_Point2D_ChartRenderingInfo_7au3e = 0;
		eid_createAlignedRectangle2D_Size2D_Rectangle2D_HorizontalAlignment_VerticalAlignment_7au3e = 0;
		eid_drawTitle_Title_Graphics2D_Rectangle2D_boolean_7au3e = 0;
		eid_createBufferedImage_int_int_7au3e = 0;
		eid_createBufferedImage_int_int_ChartRenderingInfo_7au3e = 0;
		eid_createBufferedImage_int_int_int_ChartRenderingInfo_7au3e = 0;
		eid_createBufferedImage_int_int_double_double_ChartRenderingInfo_7au3e = 0;
		eid_handleClick_int_int_ChartRenderingInfo_7au3e = 0;
		eid_addChangeListener_ChartChangeListener_7au3e = 0;
		eid_removeChangeListener_ChartChangeListener_7au3e = 0;
		eid_fireChartChanged_7au3e = 0;
		eid_notifyListeners_ChartChangeEvent_7au3e = 0;
		eid_addProgressListener_ChartProgressListener_7au3e = 0;
		eid_removeProgressListener_ChartProgressListener_7au3e = 0;
		eid_notifyListeners_ChartProgressEvent_7au3e = 0;
		eid_titleChanged_TitleChangeEvent_7au3e = 0;
		eid_plotChanged_PlotChangeEvent_7au3e = 0;
		eid_equals_Object_7au3e = 0;
		eid_writeObject_ObjectOutputStream_7au3e = 0;
		eid_readObject_ObjectInputStream_7au3e = 0;
		eid_main_StringARR_7au3e = 0;
		eid_clone_7au3e = 0;
	}
     ...
     * @param info  records info about the drawing (null means collect no info).
     */
    public void draw_7au3e(Graphics2D g2, 
	...
	public void draw(Graphics2D g2, Rectangle2D chartArea, Point2D anchor,
			ChartRenderingInfo info) {
		Object o_7au3e = null;
		String c_7au3e = "org.jfree.chart.JFreeChart";
		String msig_7au3e = "draw(Graphics2D$Rectangle2D$Point2D$ChartRenderingInfo)"
				+ eid_draw_Graphics2D_Rectangle2D_Point2D_ChartRenderingInfo_7au3e;
		try {
			draw_7au3e(g2, chartArea, anchor, info);
			FieldPrinter
					.print(this,
							eid_draw_Graphics2D_Rectangle2D_Point2D_ChartRenderingInfo_7au3e,
