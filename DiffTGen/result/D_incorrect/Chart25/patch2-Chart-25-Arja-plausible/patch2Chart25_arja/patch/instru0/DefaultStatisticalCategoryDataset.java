...
public class DefaultStatisticalCategoryDataset extends AbstractDataset
     ...
     */
    public int getColumnCount_7au3e() {
        this.data=new KeyedObjects2D();
	...
	public int getColumnCount() {
		...
		String msig_7au3e = "getColumnCount()" + eid_getColumnCount_7au3e;
		try {
			o_7au3e = getColumnCount_7au3e();
			FieldPrinter.print(o_7au3e, eid_getColumnCount_7au3e, c_7au3e,
					msig_7au3e, 0, 5);
			FieldPrinter.print(this, eid_getColumnCount_7au3e, c_7au3e,
					msig_7au3e, 1, 5);
		} catch (Throwable t7au3e) {
			FieldPrinter.print(t7au3e, eid_getColumnCount_7au3e, c_7au3e,
					msig_7au3e, 0, 5);
			throw t7au3e;
		} finally {
			eid_getColumnCount_7au3e++;
		}
		return (int) o_7au3e;
	}
}
