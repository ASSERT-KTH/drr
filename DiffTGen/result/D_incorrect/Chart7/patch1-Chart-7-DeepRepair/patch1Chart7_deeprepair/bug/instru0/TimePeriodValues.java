...
public class TimePeriodValues extends Series implements Serializable {
     ...
     * @return The index.
     */
    public int getMaxMiddleIndex_7au3e() {
	...
	public int getMaxMiddleIndex() {
		...
		String msig_7au3e = "getMaxMiddleIndex()" + eid_getMaxMiddleIndex_7au3e;
		try {
			o_7au3e = getMaxMiddleIndex_7au3e();
			FieldPrinter.print(o_7au3e, eid_getMaxMiddleIndex_7au3e, c_7au3e,
					msig_7au3e, 0, 5);
			FieldPrinter.print(this, eid_getMaxMiddleIndex_7au3e, c_7au3e,
					msig_7au3e, 1, 5);
		} catch (Throwable t7au3e) {
			FieldPrinter.print(t7au3e, eid_getMaxMiddleIndex_7au3e, c_7au3e,
					msig_7au3e, 0, 5);
			throw t7au3e;
		} finally {
			eid_getMaxMiddleIndex_7au3e++;
		}
		return (int) o_7au3e;
	}
