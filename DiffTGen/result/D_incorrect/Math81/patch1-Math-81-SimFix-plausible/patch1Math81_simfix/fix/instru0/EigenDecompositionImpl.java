...
public class EigenDecompositionImpl implements EigenDecomposition {
    ...
    public static int eid_EigenDecompositionImpl_RealMatrix_double_7au3e = 0;

	public static int eid_EigenDecompositionImpl_doubleARR_doubleARR_double_7au3e = 0;

	public static int eid_isSymmetric_RealMatrix_7au3e = 0;

	public static int eid_decompose_7au3e = 0;

	public static int eid_getV_7au3e = 0;

	public static int eid_getD_7au3e = 0;

	public static int eid_getVT_7au3e = 0;

	public static int eid_getRealEigenvalues_7au3e = 0;

	public static int eid_getRealEigenvalue_int_7au3e = 0;

	public static int eid_getImagEigenvalues_7au3e = 0;

	public static int eid_getImagEigenvalue_int_7au3e = 0;

	public static int eid_getEigenvector_int_7au3e = 0;

	public static int eid_getDeterminant_7au3e = 0;

	public static int eid_getSolver_7au3e = 0;

	public static int eid_transformToTridiagonal_RealMatrix_7au3e = 0;

	public static int eid_computeGershgorinCircles_7au3e = 0;

	public static int eid_findEigenvalues_7au3e = 0;

	public static int eid_computeSplits_7au3e = 0;

	public static int eid_process1RowBlock_int_7au3e = 0;

	public static int eid_process2RowsBlock_int_7au3e = 0;

	public static int eid_process3RowsBlock_int_7au3e = 0;

	public static int eid_processGeneralBlock_int_7au3e = 0;

	public static int eid_initialSplits_int_7au3e = 0;

	public static int eid_goodStep_int_int_7au3e = 0;

	public static int eid_flipIfWarranted_int_int_7au3e = 0;

	public static int eid_eigenvaluesRange_int_int_7au3e = 0;

	public static int eid_countEigenValues_double_int_int_7au3e = 0;

	public static int eid_ldlTDecomposition_double_int_int_7au3e = 0;

	public static int eid_dqds_int_int_7au3e = 0;

	public static int eid_dqd_int_int_7au3e = 0;

	public static int eid_computeShiftIncrement_int_int_int_7au3e = 0;

	public static int eid_updateSigma_double_7au3e = 0;

	public static int eid_findEigenVectors_7au3e = 0;

	public static int eid_findEigenvector_double_doubleARR_doubleARR_7au3e = 0;

	public static int eid_stationaryQuotientDifferenceWithShift_doubleARR_doubleARR_double_7au3e = 0;

	public static int eid_progressiveQuotientDifferenceWithShift_doubleARR_doubleARR_double_7au3e = 0;

	public static void clearORefMap() {
		eid_EigenDecompositionImpl_RealMatrix_double_7au3e = 0;
		eid_EigenDecompositionImpl_doubleARR_doubleARR_double_7au3e = 0;
		eid_isSymmetric_RealMatrix_7au3e = 0;
		eid_decompose_7au3e = 0;
		eid_getV_7au3e = 0;
		eid_getD_7au3e = 0;
		eid_getVT_7au3e = 0;
		eid_getRealEigenvalues_7au3e = 0;
		eid_getRealEigenvalue_int_7au3e = 0;
		eid_getImagEigenvalues_7au3e = 0;
		eid_getImagEigenvalue_int_7au3e = 0;
		eid_getEigenvector_int_7au3e = 0;
		eid_getDeterminant_7au3e = 0;
		eid_getSolver_7au3e = 0;
		eid_transformToTridiagonal_RealMatrix_7au3e = 0;
		eid_computeGershgorinCircles_7au3e = 0;
		eid_findEigenvalues_7au3e = 0;
		eid_computeSplits_7au3e = 0;
		eid_process1RowBlock_int_7au3e = 0;
		eid_process2RowsBlock_int_7au3e = 0;
		eid_process3RowsBlock_int_7au3e = 0;
		eid_processGeneralBlock_int_7au3e = 0;
		eid_initialSplits_int_7au3e = 0;
		eid_goodStep_int_int_7au3e = 0;
		eid_flipIfWarranted_int_int_7au3e = 0;
		eid_eigenvaluesRange_int_int_7au3e = 0;
		eid_countEigenValues_double_int_int_7au3e = 0;
		eid_ldlTDecomposition_double_int_int_7au3e = 0;
		eid_dqds_int_int_7au3e = 0;
		eid_dqd_int_int_7au3e = 0;
		eid_computeShiftIncrement_int_int_int_7au3e = 0;
		eid_updateSigma_double_7au3e = 0;
		eid_findEigenVectors_7au3e = 0;
		eid_findEigenvector_double_doubleARR_doubleARR_7au3e = 0;
		eid_stationaryQuotientDifferenceWithShift_doubleARR_doubleARR_double_7au3e = 0;
		eid_progressiveQuotientDifferenceWithShift_doubleARR_doubleARR_double_7au3e = 0;
	}
     ...
     */
    private void computeShiftIncrement_7au3e(final int start, final int end, final int deflated) {
	...
	/**
	 * Compute the shift increment as an estimate of the smallest eigenvalue. <p>This implementation is a translation of the LAPACK routine DLAZQ4.</p>
	 * @param start  start index
	 * @param end  end index
	 * @param deflated  number of realEigenvalues just deflated
	 */
	private void computeShiftIncrement(final int start, final int end,
			final int deflated) {
		Object o_7au3e = null;
		String c_7au3e = "org.apache.commons.math.linear.EigenDecompositionImpl";
		String msig_7au3e = "computeShiftIncrement(int$int$int)"
				+ eid_computeShiftIncrement_int_int_int_7au3e;
		try {
			computeShiftIncrement_7au3e(start, end, deflated);
			FieldPrinter.print(this,
					eid_computeShiftIncrement_int_int_int_7au3e, c_7au3e,
					msig_7au3e, 1, 5);
