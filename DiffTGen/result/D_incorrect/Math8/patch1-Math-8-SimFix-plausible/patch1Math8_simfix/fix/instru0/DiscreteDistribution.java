...
public class DiscreteDistribution<T> {
     ...
     * positive.
     */
    public Object[] sample_7au3e(int sampleSize) throws NotStrictlyPositiveException {
        if (sampleSize <= 0) {
	...
	public Object[] sample(int sampleSize) throws NotStrictlyPositiveException {
		...
		try {
			...
			FieldPrinter.print(o_7au3e, eid_sample_int_7au3e, c_7au3e,
					msig_7au3e, 0, 5);
			FieldPrinter.print(this, eid_sample_int_7au3e, c_7au3e, msig_7au3e,
					1, 5);
		} catch (Throwable t7au3e) {
			FieldPrinter.print(t7au3e, eid_sample_int_7au3e, c_7au3e,
					msig_7au3e, 0, 5);
			throw t7au3e;
		} finally {
			eid_sample_int_7au3e++;
		}
		return (Object[]) o_7au3e;
	}
