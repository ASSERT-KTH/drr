...
public class XYSeries extends Series implements Cloneable, Serializable {
    ...
    public static int eid_XYSeries_Comparable_7au3e = 0;

	public static int eid_XYSeries_Comparable_boolean_7au3e = 0;

	public static int eid_XYSeries_Comparable_boolean_boolean_7au3e = 0;

	public static int eid_getAutoSort_7au3e = 0;

	public static int eid_getAllowDuplicateXValues_7au3e = 0;
	...
	public static int eid_add_XYDataItem_7au3e = 0;

	public static int eid_add_double_double_7au3e = 0;

	public static int eid_add_double_double_boolean_7au3e = 0;

	public static int eid_add_double_Number_7au3e = 0;

	public static int eid_add_double_Number_boolean_7au3e = 0;

	public static int eid_add_Number_Number_7au3e = 0;

	public static int eid_add_Number_Number_boolean_7au3e = 0;

	public static int eid_add_XYDataItem_boolean_7au3e = 0;

	public static int eid_delete_int_int_7au3e = 0;

	public static int eid_remove_int_7au3e = 0;

	public static int eid_remove_Number_7au3e = 0;

	public static int eid_clear_7au3e = 0;

	public static int eid_getDataItem_int_7au3e = 0;

	public static int eid_getX_int_7au3e = 0;

	public static int eid_getY_int_7au3e = 0;

	public static int eid_updateByIndex_int_Number_7au3e = 0;

	public static int eid_update_Number_Number_7au3e = 0;

	public static int eid_addOrUpdate_double_double_7au3e = 0;

	public static int eid_addOrUpdate_Number_Number_7au3e = 0;

	public static int eid_indexOf_Number_7au3e = 0;

	public static int eid_toArray_7au3e = 0;
	...
	public static void clearORefMap() {
		oref_map.clear();
		eid_XYSeries_Comparable_7au3e = 0;
		eid_XYSeries_Comparable_boolean_7au3e = 0;
		eid_XYSeries_Comparable_boolean_boolean_7au3e = 0;
		eid_getAutoSort_7au3e = 0;
		eid_getAllowDuplicateXValues_7au3e = 0;
		eid_getItemCount_7au3e = 0;
		eid_getItems_7au3e = 0;
		eid_getMaximumItemCount_7au3e = 0;
		eid_setMaximumItemCount_int_7au3e = 0;
		eid_add_XYDataItem_7au3e = 0;
		eid_add_double_double_7au3e = 0;
		eid_add_double_double_boolean_7au3e = 0;
		eid_add_double_Number_7au3e = 0;
		eid_add_double_Number_boolean_7au3e = 0;
		eid_add_Number_Number_7au3e = 0;
		eid_add_Number_Number_boolean_7au3e = 0;
		eid_add_XYDataItem_boolean_7au3e = 0;
		eid_delete_int_int_7au3e = 0;
		eid_remove_int_7au3e = 0;
		eid_remove_Number_7au3e = 0;
		eid_clear_7au3e = 0;
		eid_getDataItem_int_7au3e = 0;
		eid_getX_int_7au3e = 0;
		eid_getY_int_7au3e = 0;
		eid_updateByIndex_int_Number_7au3e = 0;
		eid_update_Number_Number_7au3e = 0;
		eid_addOrUpdate_double_double_7au3e = 0;
		eid_addOrUpdate_Number_Number_7au3e = 0;
		eid_indexOf_Number_7au3e = 0;
		eid_toArray_7au3e = 0;
		eid_clone_7au3e = 0;
