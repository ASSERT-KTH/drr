...
public abstract class AbstractIntegerDistribution implements IntegerDistribution, Serializable {
    ...
    public static int eid_AbstractIntegerDistribution_7au3e = 0;

	public static int eid_AbstractIntegerDistribution_RandomGenerator_7au3e = 0;

	public static int eid_cumulativeProbability_int_int_7au3e = 0;

	public static int eid_inverseCumulativeProbability_double_7au3e = 0;

	public static int eid_solveInverseCumulativeProbability_double_int_int_7au3e = 0;
	...
	public static int eid_checkedCumulativeProbability_int_7au3e = 0;

	public static void clearORefMap() {
		eid_AbstractIntegerDistribution_7au3e = 0;
		eid_AbstractIntegerDistribution_RandomGenerator_7au3e = 0;
		eid_cumulativeProbability_int_int_7au3e = 0;
		eid_inverseCumulativeProbability_double_7au3e = 0;
		eid_solveInverseCumulativeProbability_double_int_int_7au3e = 0;
		eid_reseedRandomGenerator_long_7au3e = 0;
		eid_sample_7au3e = 0;
		eid_sample_int_7au3e = 0;
		eid_checkedCumulativeProbability_int_7au3e = 0;
	}
     ...
     * </ul>
     */
    public int inverseCumulativeProbability_7au3e(final double p) throws OutOfRangeException {
        if (p < 0.0 || p > 1.0) {
	...
	public int inverseCumulativeProbability(final double p)
		...
		Object o_7au3e = null;
		String c_7au3e = "org.apache.commons.math3.distribution.AbstractIntegerDistribution";
		String msig_7au3e = "inverseCumulativeProbability(double)"
				+ eid_inverseCumulativeProbability_double_7au3e;
		try {
			o_7au3e = inverseCumulativeProbability_7au3e(p);
			FieldPrinter.print(o_7au3e,
					eid_inverseCumulativeProbability_double_7au3e, c_7au3e,
					msig_7au3e, 0, 5);
