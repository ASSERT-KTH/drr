...
public final class Fraction extends Number implements Comparable<Fraction> {
    ...
    public static int eid_Fraction_int_int_7au3e = 0;

	public static int eid_getFraction_int_int_7au3e = 0;

	public static int eid_getFraction_int_int_int_7au3e = 0;

	public static int eid_getReducedFraction_int_int_7au3e = 0;

	public static int eid_getFraction_double_7au3e = 0;

	public static int eid_getFraction_String_7au3e = 0;

	public static int eid_getNumerator_7au3e = 0;

	public static int eid_getDenominator_7au3e = 0;

	public static int eid_getProperNumerator_7au3e = 0;

	public static int eid_getProperWhole_7au3e = 0;

	public static int eid_intValue_7au3e = 0;

	public static int eid_longValue_7au3e = 0;

	public static int eid_floatValue_7au3e = 0;

	public static int eid_doubleValue_7au3e = 0;

	public static int eid_reduce_7au3e = 0;

	public static int eid_invert_7au3e = 0;

	public static int eid_negate_7au3e = 0;

	public static int eid_abs_7au3e = 0;

	public static int eid_pow_int_7au3e = 0;

	public static int eid_greatestCommonDivisor_int_int_7au3e = 0;

	public static int eid_mulAndCheck_int_int_7au3e = 0;

	public static int eid_mulPosAndCheck_int_int_7au3e = 0;

	public static int eid_addAndCheck_int_int_7au3e = 0;

	public static int eid_subAndCheck_int_int_7au3e = 0;

	public static int eid_add_Fraction_7au3e = 0;

	public static int eid_subtract_Fraction_7au3e = 0;

	public static int eid_addSub_Fraction_boolean_7au3e = 0;

	public static int eid_multiplyBy_Fraction_7au3e = 0;

	public static int eid_divideBy_Fraction_7au3e = 0;

	public static int eid_equals_Object_7au3e = 0;

	public static int eid_hashCode_7au3e = 0;

	public static int eid_compareTo_Fraction_7au3e = 0;

	public static int eid_toString_7au3e = 0;

	public static int eid_toProperString_7au3e = 0;

	public static void clearORefMap() {
		eid_Fraction_int_int_7au3e = 0;
		eid_getFraction_int_int_7au3e = 0;
		eid_getFraction_int_int_int_7au3e = 0;
		eid_getReducedFraction_int_int_7au3e = 0;
		eid_getFraction_double_7au3e = 0;
		eid_getFraction_String_7au3e = 0;
		eid_getNumerator_7au3e = 0;
		eid_getDenominator_7au3e = 0;
		eid_getProperNumerator_7au3e = 0;
		eid_getProperWhole_7au3e = 0;
		eid_intValue_7au3e = 0;
		eid_longValue_7au3e = 0;
		eid_floatValue_7au3e = 0;
		eid_doubleValue_7au3e = 0;
		eid_reduce_7au3e = 0;
		eid_invert_7au3e = 0;
		eid_negate_7au3e = 0;
		eid_abs_7au3e = 0;
		eid_pow_int_7au3e = 0;
		eid_greatestCommonDivisor_int_int_7au3e = 0;
		eid_mulAndCheck_int_int_7au3e = 0;
		eid_mulPosAndCheck_int_int_7au3e = 0;
		eid_addAndCheck_int_int_7au3e = 0;
		eid_subAndCheck_int_int_7au3e = 0;
		eid_add_Fraction_7au3e = 0;
		eid_subtract_Fraction_7au3e = 0;
		eid_addSub_Fraction_boolean_7au3e = 0;
		eid_multiplyBy_Fraction_7au3e = 0;
		eid_divideBy_Fraction_7au3e = 0;
		eid_equals_Object_7au3e = 0;
		eid_hashCode_7au3e = 0;
		eid_compareTo_Fraction_7au3e = 0;
		eid_toString_7au3e = 0;
		eid_toProperString_7au3e = 0;
	}
...
//            System.out.println(">>" + delta1 +" "+ delta2+" "+(delta1 > delta2)+" "+i+" "+denom2);
     ...
     */
    private static int greatestCommonDivisor_7au3e(int u, int v) {
        // From Commons Math:
	...
	private static int greatestCommonDivisor(int u, int v) {
		Object o_7au3e = null;
		String c_7au3e = "org.apache.commons.lang3.math.Fraction";
		String msig_7au3e = "greatestCommonDivisor(int$int)"
				+ eid_greatestCommonDivisor_int_int_7au3e;
		try {
			o_7au3e = greatestCommonDivisor_7au3e(u, v);
			FieldPrinter.print(o_7au3e,
					eid_greatestCommonDivisor_int_int_7au3e, c_7au3e,
					msig_7au3e, 0, 5);
		} catch (Throwable t7au3e) {
			FieldPrinter.print(t7au3e, eid_greatestCommonDivisor_int_int_7au3e,
