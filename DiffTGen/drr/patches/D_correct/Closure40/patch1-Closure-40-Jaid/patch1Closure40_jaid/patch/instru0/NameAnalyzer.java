...
final class NameAnalyzer implements CompilerPass {
  ...
  public static int eid_NameAnalyzer_AbstractCompiler_boolean_7au3e = 0;

	public static int eid_process_Node_Node_7au3e = 0;

	public static int eid_recordAlias_String_String_7au3e = 0;

	public static int eid_recordReference_String_String_RefType_7au3e = 0;

	public static int eid_removeUnreferenced_7au3e = 0;

	public static int eid_getHtmlReport_7au3e = 0;

	public static int eid_appendListItem_StringBuilder_String_7au3e = 0;

	public static int eid_nameLink_String_7au3e = 0;

	public static int eid_nameAnchor_String_7au3e = 0;

	public static int eid_getName_String_boolean_7au3e = 0;

	public static int eid_createName_String_7au3e = 0;

	public static int eid_referenceAliases_7au3e = 0;

	public static int eid_referenceParentNames_7au3e = 0;

	public static int eid_createNameInformation_NodeTraversal_Node_Node_7au3e = 0;

	public static int eid_createNameInformation_String_Scope_Node_7au3e = 0;

	public static int eid_isExternallyReferenceable_Scope_String_7au3e = 0;

	public static int eid_getDependencyScope_Node_7au3e = 0;

	public static int eid_getEnclosingFunctionDependencyScope_NodeTraversal_7au3e = 0;

	public static int eid_calculateReferences_7au3e = 0;

	public static int eid_countOf_TriState_TriState_7au3e = 0;

	public static int eid_getSideEffectNodes_Node_7au3e = 0;

	public static int eid_replaceWithRhs_Node_Node_7au3e = 0;

	public static int eid_replaceTopLevelExpressionWithRhs_Node_Node_7au3e = 0;

	public static int eid_valueConsumedByParent_Node_Node_7au3e = 0;

	public static int eid_collapseReplacements_ListLTEMPNodeRTEMP_7au3e = 0;

	public static int eid_getRhsSubexpressions_Node_7au3e = 0;

	public static void clearORefMap() {
		eid_NameAnalyzer_AbstractCompiler_boolean_7au3e = 0;
		eid_process_Node_Node_7au3e = 0;
		eid_recordAlias_String_String_7au3e = 0;
		eid_recordReference_String_String_RefType_7au3e = 0;
		eid_removeUnreferenced_7au3e = 0;
		eid_getHtmlReport_7au3e = 0;
		eid_appendListItem_StringBuilder_String_7au3e = 0;
		eid_nameLink_String_7au3e = 0;
		eid_nameAnchor_String_7au3e = 0;
		eid_getName_String_boolean_7au3e = 0;
		eid_createName_String_7au3e = 0;
		eid_referenceAliases_7au3e = 0;
		eid_referenceParentNames_7au3e = 0;
		eid_createNameInformation_NodeTraversal_Node_Node_7au3e = 0;
		eid_createNameInformation_String_Scope_Node_7au3e = 0;
		eid_isExternallyReferenceable_Scope_String_7au3e = 0;
		eid_getDependencyScope_Node_7au3e = 0;
		eid_getEnclosingFunctionDependencyScope_NodeTraversal_7au3e = 0;
		eid_calculateReferences_7au3e = 0;
		eid_countOf_TriState_TriState_7au3e = 0;
		eid_getSideEffectNodes_Node_7au3e = 0;
		eid_replaceWithRhs_Node_Node_7au3e = 0;
		eid_replaceTopLevelExpressionWithRhs_Node_Node_7au3e = 0;
		eid_valueConsumedByParent_Node_Node_7au3e = 0;
		eid_collapseReplacements_ListLTEMPNodeRTEMP_7au3e = 0;
		eid_getRhsSubexpressions_Node_7au3e = 0;
	}
