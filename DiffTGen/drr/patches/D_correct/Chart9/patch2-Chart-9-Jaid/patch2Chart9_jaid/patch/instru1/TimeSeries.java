...
public class TimeSeries extends Series implements Cloneable, Serializable {
	...
	public static int eid_TimeSeries_Comparable_Class_7au3e = 0;

	public static int eid_TimeSeries_Comparable_String_String_Class_7au3e = 0;
	...
	public static void clearORefMap() {
		...
		eid_TimeSeries_Comparable_Class_7au3e = 0;
		eid_TimeSeries_Comparable_String_String_Class_7au3e = 0;
     ...
     * @throws CloneNotSupportedException if there is a cloning problem.
     */
    public TimeSeries createCopy_7au3e(RegularTimePeriod start, RegularTimePeriod end)
        throws CloneNotSupportedException {
	...
	public TimeSeries createCopy(RegularTimePeriod start, RegularTimePeriod end)
		...
		String msig_7au3e = "createCopy(RegularTimePeriod$RegularTimePeriod)"
				+ eid_createCopy_RegularTimePeriod_RegularTimePeriod_7au3e;
		try {
			o_7au3e = createCopy_7au3e(start, end);
			addToORefMap(msig_7au3e, o_7au3e);
			addToORefMap(msig_7au3e, this);
			addToORefMap(msig_7au3e, start);
			addToORefMap(msig_7au3e, end);
