...
public class GrayPaintScale 
    ...
    public static int eid_GrayPaintScale_7au3e = 0;

	public static int eid_GrayPaintScale_double_double_7au3e = 0;

	public static int eid_getLowerBound_7au3e = 0;

	public static int eid_getUpperBound_7au3e = 0;

	public static int eid_getPaint_double_7au3e = 0;
	...
	public static void clearORefMap() {
		eid_GrayPaintScale_7au3e = 0;
		eid_GrayPaintScale_double_double_7au3e = 0;
		eid_getLowerBound_7au3e = 0;
		eid_getUpperBound_7au3e = 0;
		eid_getPaint_double_7au3e = 0;
     ...
     */
    public Paint getPaint_7au3e(double value) {
	...
	public Paint getPaint(double value) {
		Object o_7au3e = null;
		String c_7au3e = "org.jfree.chart.renderer.GrayPaintScale";
		String msig_7au3e = "getPaint(double)" + eid_getPaint_double_7au3e;
		try {
			o_7au3e = getPaint_7au3e(value);
			FieldPrinter.print(o_7au3e, eid_getPaint_double_7au3e, c_7au3e,
					msig_7au3e, 0, 5);
			FieldPrinter.print(this, eid_getPaint_double_7au3e, c_7au3e,
					msig_7au3e, 1, 5);
		} catch (Throwable t7au3e) {
			FieldPrinter.print(t7au3e, eid_getPaint_double_7au3e, c_7au3e,
					msig_7au3e, 0, 5);
			throw t7au3e;
		} finally {
			eid_getPaint_double_7au3e++;
		}
		return (Paint) o_7au3e;
	}
