...
public class TimeSeries extends Series implements Cloneable, Serializable {
	...
	public void add(TimeSeriesDataItem item, boolean notify) {
		...
		try {
			...
			FieldPrinter.print(this, eid_add_TimeSeriesDataItem_boolean_7au3e,
					c_7au3e, msig_7au3e, 1, 5);
			FieldPrinter.print(item, eid_add_TimeSeriesDataItem_boolean_7au3e,
					c_7au3e, msig_7au3e, 2, 5);
		} catch (Throwable t7au3e) {
			FieldPrinter.print(t7au3e,
					eid_add_TimeSeriesDataItem_boolean_7au3e, c_7au3e,
					msig_7au3e, 0, 5);
			throw t7au3e;
		} finally {
			eid_add_TimeSeriesDataItem_boolean_7au3e++;
