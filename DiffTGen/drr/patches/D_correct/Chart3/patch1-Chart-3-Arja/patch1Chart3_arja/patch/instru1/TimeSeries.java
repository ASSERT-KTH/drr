...
public class TimeSeries extends Series implements Cloneable, Serializable {
     ...
     */
    public void add_7au3e(TimeSeriesDataItem item, boolean notify) {
        if (item == null) {
	...
	/**
	 * Adds a data item to the series and sends a  {@link SeriesChangeEvent}  to all registered listeners.
	...
	public void add(TimeSeriesDataItem item, boolean notify) {
		...
		String msig_7au3e = "add(TimeSeriesDataItem$boolean)"
				+ eid_add_TimeSeriesDataItem_boolean_7au3e;
		try {
			add_7au3e(item, notify);
			addToORefMap(msig_7au3e, null);
			addToORefMap(msig_7au3e, this);
			addToORefMap(msig_7au3e, item);
			addToORefMap(msig_7au3e, null);
