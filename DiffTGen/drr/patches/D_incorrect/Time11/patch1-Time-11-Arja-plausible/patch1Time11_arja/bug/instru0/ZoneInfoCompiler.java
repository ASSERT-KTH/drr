...
public class ZoneInfoCompiler {
    public static int eid_verbose_7au3e = 0;

	public static int eid_main_StringARR_7au3e = 0;

	public static int eid_printUsage_7au3e = 0;

	public static int eid_getStartOfYear_7au3e = 0;

	public static int eid_getLenientISOChronology_7au3e = 0;

	public static int eid_writeZoneInfoMap_DataOutputStream_MapLTEMPString_DateTimeZoneRTEMP_7au3e = 0;

	public static int eid_parseYear_String_int_7au3e = 0;

	public static int eid_parseMonth_String_7au3e = 0;

	public static int eid_parseDayOfWeek_String_7au3e = 0;

	public static int eid_parseOptional_String_7au3e = 0;

	public static int eid_parseTime_String_7au3e = 0;

	public static int eid_parseZoneChar_char_7au3e = 0;

	public static int eid_test_String_DateTimeZone_7au3e = 0;

	public static int eid_ZoneInfoCompiler_7au3e = 0;

	public static int eid_compile_File_FileARR_7au3e = 0;

	public static int eid_parseDataFile_BufferedReader_7au3e = 0;

	public static void clearORefMap() {
		eid_verbose_7au3e = 0;
		eid_main_StringARR_7au3e = 0;
		eid_printUsage_7au3e = 0;
		eid_getStartOfYear_7au3e = 0;
		eid_getLenientISOChronology_7au3e = 0;
		eid_writeZoneInfoMap_DataOutputStream_MapLTEMPString_DateTimeZoneRTEMP_7au3e = 0;
		eid_parseYear_String_int_7au3e = 0;
		eid_parseMonth_String_7au3e = 0;
		eid_parseDayOfWeek_String_7au3e = 0;
		eid_parseOptional_String_7au3e = 0;
		eid_parseTime_String_7au3e = 0;
		eid_parseZoneChar_char_7au3e = 0;
		eid_test_String_DateTimeZone_7au3e = 0;
		eid_ZoneInfoCompiler_7au3e = 0;
		eid_compile_File_FileARR_7au3e = 0;
		eid_parseDataFile_BufferedReader_7au3e = 0;
	}
