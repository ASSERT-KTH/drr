...
public class PiePlot3D extends PiePlot implements Serializable {
     ...
     * @since 1.0.7.
     */
    public void setDarkerSides_7au3e(boolean darker) {
	...
	public void setDarkerSides(boolean darker) {
		...
		String msig_7au3e = "setDarkerSides(boolean)"
				+ eid_setDarkerSides_boolean_7au3e;
		try {
			setDarkerSides_7au3e(darker);
			FieldPrinter.print(this, eid_setDarkerSides_boolean_7au3e, c_7au3e,
					msig_7au3e, 1, 5);
		} catch (Throwable t7au3e) {
			FieldPrinter.print(t7au3e, eid_setDarkerSides_boolean_7au3e,
