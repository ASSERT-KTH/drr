...
public class SimplexSolver extends AbstractLinearOptimizer {
	...
	private Integer getPivotRow(final int col, final SimplexTableau tableau) {
		...
		String msig_7au3e = "getPivotRow(int$SimplexTableau)"
				+ eid_getPivotRow_int_SimplexTableau_7au3e;
		try {
			o_7au3e = getPivotRow_7au3e(col, tableau);
			FieldPrinter.print(o_7au3e,
					eid_getPivotRow_int_SimplexTableau_7au3e, c_7au3e,
					msig_7au3e, 0, 5);
			FieldPrinter.print(this, eid_getPivotRow_int_SimplexTableau_7au3e,
