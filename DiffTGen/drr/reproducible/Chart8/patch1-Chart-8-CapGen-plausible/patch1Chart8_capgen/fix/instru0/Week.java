...
public class Week extends RegularTimePeriod implements Serializable {
    ...
    public static int eid_Week_7au3e = 0;

	public static int eid_Week_int_int_7au3e = 0;

	public static int eid_Week_int_Year_7au3e = 0;

	public static int eid_Week_Date_7au3e = 0;

	public static int eid_Week_Date_TimeZone_7au3e = 0;

	public static int eid_Week_Date_TimeZone_Locale_7au3e = 0;

	public static int eid_getYear_7au3e = 0;

	public static int eid_getYearValue_7au3e = 0;

	public static int eid_getWeek_7au3e = 0;

	public static int eid_getFirstMillisecond_7au3e = 0;

	public static int eid_getLastMillisecond_7au3e = 0;

	public static int eid_peg_Calendar_7au3e = 0;

	public static int eid_previous_7au3e = 0;

	public static int eid_next_7au3e = 0;

	public static int eid_getSerialIndex_7au3e = 0;

	public static int eid_getFirstMillisecond_Calendar_7au3e = 0;

	public static int eid_getLastMillisecond_Calendar_7au3e = 0;
	...
	public static int eid_compareTo_Object_7au3e = 0;

	public static int eid_parseWeek_String_7au3e = 0;

	public static int eid_findSeparator_String_7au3e = 0;

	public static int eid_evaluateAsYear_String_7au3e = 0;

	public static int eid_stringToWeek_String_7au3e = 0;

	public static void clearORefMap() {
		eid_Week_7au3e = 0;
		eid_Week_int_int_7au3e = 0;
		eid_Week_int_Year_7au3e = 0;
		eid_Week_Date_7au3e = 0;
		eid_Week_Date_TimeZone_7au3e = 0;
		eid_Week_Date_TimeZone_Locale_7au3e = 0;
		eid_getYear_7au3e = 0;
		eid_getYearValue_7au3e = 0;
		eid_getWeek_7au3e = 0;
		eid_getFirstMillisecond_7au3e = 0;
		eid_getLastMillisecond_7au3e = 0;
		eid_peg_Calendar_7au3e = 0;
		eid_previous_7au3e = 0;
		eid_next_7au3e = 0;
		eid_getSerialIndex_7au3e = 0;
		eid_getFirstMillisecond_Calendar_7au3e = 0;
		eid_getLastMillisecond_Calendar_7au3e = 0;
		eid_toString_7au3e = 0;
		eid_equals_Object_7au3e = 0;
		eid_hashCode_7au3e = 0;
		eid_compareTo_Object_7au3e = 0;
		eid_parseWeek_String_7au3e = 0;
		eid_findSeparator_String_7au3e = 0;
		eid_evaluateAsYear_String_7au3e = 0;
		eid_stringToWeek_String_7au3e = 0;
	}
     ...
     */
    public void Week_7au3e(Date time, TimeZone zone) {
        // defer argument checking...
	...
	public Week(Date time, TimeZone zone) {
		Object o_7au3e = null;
		String c_7au3e = "org.jfree.data.time.Week";
		String msig_7au3e = "Week(Date$TimeZone)"
				+ eid_Week_Date_TimeZone_7au3e;
		try {
			Week_7au3e(time, zone);
			FieldPrinter.print(this, eid_Week_Date_TimeZone_7au3e, c_7au3e,
					msig_7au3e, 1, 5);
			FieldPrinter.print(time, eid_Week_Date_TimeZone_7au3e, c_7au3e,
					msig_7au3e, 2, 5);
			FieldPrinter.print(zone, eid_Week_Date_TimeZone_7au3e, c_7au3e,
					msig_7au3e, 3, 5);
		} catch (Throwable t7au3e) {
			FieldPrinter.print(t7au3e, eid_Week_Date_TimeZone_7au3e, c_7au3e,
					msig_7au3e, 0, 5);
			throw t7au3e;
		} finally {
			eid_Week_Date_TimeZone_7au3e++;
