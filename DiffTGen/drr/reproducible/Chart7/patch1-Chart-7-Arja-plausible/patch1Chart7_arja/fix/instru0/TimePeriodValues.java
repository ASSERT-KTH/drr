...
public class TimePeriodValues extends Series implements Serializable {
    ...
    public static int eid_TimePeriodValues_Comparable_7au3e = 0;

	public static int eid_TimePeriodValues_Comparable_String_String_7au3e = 0;
	...
	public static int eid_add_TimePeriodValue_7au3e = 0;

	public static int eid_updateBounds_TimePeriod_int_7au3e = 0;

	public static int eid_recalculateBounds_7au3e = 0;

	public static int eid_add_TimePeriod_double_7au3e = 0;

	public static int eid_add_TimePeriod_Number_7au3e = 0;
	...
	public static int eid_getMinStartIndex_7au3e = 0;

	public static int eid_getMaxStartIndex_7au3e = 0;

	public static int eid_getMinMiddleIndex_7au3e = 0;

	public static int eid_getMaxMiddleIndex_7au3e = 0;

	public static int eid_getMinEndIndex_7au3e = 0;

	public static int eid_getMaxEndIndex_7au3e = 0;

	public static void clearORefMap() {
		eid_TimePeriodValues_Comparable_7au3e = 0;
		eid_TimePeriodValues_Comparable_String_String_7au3e = 0;
		...
		eid_add_TimePeriodValue_7au3e = 0;
		eid_updateBounds_TimePeriod_int_7au3e = 0;
		eid_recalculateBounds_7au3e = 0;
		eid_add_TimePeriod_double_7au3e = 0;
		eid_add_TimePeriod_Number_7au3e = 0;
		...
		eid_getMinStartIndex_7au3e = 0;
		eid_getMaxStartIndex_7au3e = 0;
		eid_getMinMiddleIndex_7au3e = 0;
		eid_getMaxMiddleIndex_7au3e = 0;
		eid_getMinEndIndex_7au3e = 0;
		eid_getMaxEndIndex_7au3e = 0;
	}
     ...
     */
    private void updateBounds_7au3e(TimePeriod period, int index) {
	...
	private void updateBounds(TimePeriod period, int index) {
		Object o_7au3e = null;
		String c_7au3e = "org.jfree.data.time.TimePeriodValues";
		String msig_7au3e = "updateBounds(TimePeriod$int)"
				+ eid_updateBounds_TimePeriod_int_7au3e;
		try {
			updateBounds_7au3e(period, index);
			FieldPrinter.print(this, eid_updateBounds_TimePeriod_int_7au3e,
					c_7au3e, msig_7au3e, 1, 5);
			FieldPrinter.print(period, eid_updateBounds_TimePeriod_int_7au3e,
					c_7au3e, msig_7au3e, 2, 5);
		} catch (Throwable t7au3e) {
			FieldPrinter.print(t7au3e, eid_updateBounds_TimePeriod_int_7au3e,
