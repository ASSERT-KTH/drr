...
public class EigenDecompositionImpl implements EigenDecomposition {
     ...
     */
    private boolean flipIfWarranted_7au3e(final int n, final int step) {
	 ...
	 * Flip qd array if warranted.
	 * @param n  number of rows in the block
	 * @param step  within the array (1 for flipping all elements, 2 for flipping only every other element)
	 * @return  true if qd array was flipped
	 */
	private boolean flipIfWarranted(final int n, final int step) {
		Object o_7au3e = null;
		String c_7au3e = "org.apache.commons.math.linear.EigenDecompositionImpl";
		String msig_7au3e = "flipIfWarranted(int$int)"
				+ eid_flipIfWarranted_int_int_7au3e;
		try {
			o_7au3e = flipIfWarranted_7au3e(n, step);
			FieldPrinter.print(o_7au3e, eid_flipIfWarranted_int_int_7au3e,
					c_7au3e, msig_7au3e, 0, 5);
			FieldPrinter.print(this, eid_flipIfWarranted_int_int_7au3e,
					c_7au3e, msig_7au3e, 1, 5);
		} catch (Throwable t7au3e) {
			FieldPrinter.print(t7au3e, eid_flipIfWarranted_int_int_7au3e,
					c_7au3e, msig_7au3e, 0, 5);
			throw t7au3e;
		} finally {
			eid_flipIfWarranted_int_int_7au3e++;
