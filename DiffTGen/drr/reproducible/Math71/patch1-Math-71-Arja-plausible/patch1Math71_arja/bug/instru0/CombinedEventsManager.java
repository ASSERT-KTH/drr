...
public class CombinedEventsManager {
    ...
    public static int eid_CombinedEventsManager_7au3e = 0;

	public static int eid_addEventHandler_EventHandler_double_double_int_7au3e = 0;

	public static int eid_getEventsHandlers_7au3e = 0;

	public static int eid_clearEventsHandlers_7au3e = 0;

	public static int eid_getEventsStates_7au3e = 0;

	public static int eid_isEmpty_7au3e = 0;

	public static int eid_evaluateStep_StepInterpolator_7au3e = 0;

	public static int eid_getEventTime_7au3e = 0;

	public static int eid_stepAccepted_double_doubleARR_7au3e = 0;

	public static int eid_stop_7au3e = 0;

	public static int eid_reset_double_doubleARR_7au3e = 0;

	public static void clearORefMap() {
		eid_CombinedEventsManager_7au3e = 0;
		eid_addEventHandler_EventHandler_double_double_int_7au3e = 0;
		eid_getEventsHandlers_7au3e = 0;
		eid_clearEventsHandlers_7au3e = 0;
		eid_getEventsStates_7au3e = 0;
		eid_isEmpty_7au3e = 0;
		eid_evaluateStep_StepInterpolator_7au3e = 0;
		eid_getEventTime_7au3e = 0;
		eid_stepAccepted_double_doubleARR_7au3e = 0;
		eid_stop_7au3e = 0;
		eid_reset_double_doubleARR_7au3e = 0;
	}
     ...
     */
    public boolean evaluateStep_7au3e(final StepInterpolator interpolator)
	 ...
	 * @param interpolator  step interpolator for the proposed step
	 * @return  true if at least one event handler triggers an event before the end of the proposed step (this implies the step should be rejected)
	 * @exception DerivativeException  if the interpolator fails to compute the function somewhere within the step
	 * @exception IntegratorException  if an event cannot be located
	 */
	public boolean evaluateStep(final StepInterpolator interpolator)
			throws DerivativeException, IntegratorException {
		Object o_7au3e = null;
		String c_7au3e = "org.apache.commons.math.ode.events.CombinedEventsManager";
		String msig_7au3e = "evaluateStep(StepInterpolator)"
				+ eid_evaluateStep_StepInterpolator_7au3e;
		try {
			o_7au3e = evaluateStep_7au3e(interpolator);
			FieldPrinter.print(o_7au3e,
					eid_evaluateStep_StepInterpolator_7au3e, c_7au3e,
					msig_7au3e, 0, 5);
			FieldPrinter.print(this, eid_evaluateStep_StepInterpolator_7au3e,
					c_7au3e, msig_7au3e, 1, 5);
		} catch (Throwable t7au3e) {
			FieldPrinter.print(t7au3e, eid_evaluateStep_StepInterpolator_7au3e,
