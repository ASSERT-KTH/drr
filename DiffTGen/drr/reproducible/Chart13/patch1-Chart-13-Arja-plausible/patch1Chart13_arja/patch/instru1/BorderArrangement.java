...
public class BorderArrangement implements Arrangement, Serializable {
    ...
    public static int eid_BorderArrangement_7au3e = 0;

	public static int eid_add_Block_Object_7au3e = 0;

	public static int eid_arrange_BlockContainer_Graphics2D_RectangleConstraint_7au3e = 0;

	public static int eid_arrangeNN_BlockContainer_Graphics2D_7au3e = 0;

	public static int eid_arrangeFR_BlockContainer_Graphics2D_RectangleConstraint_7au3e = 0;

	public static int eid_arrangeFN_BlockContainer_Graphics2D_double_7au3e = 0;

	public static int eid_arrangeRR_BlockContainer_Range_Range_Graphics2D_7au3e = 0;

	public static int eid_arrangeFF_BlockContainer_Graphics2D_RectangleConstraint_7au3e = 0;
	...
	public static void clearORefMap() {
		oref_map.clear();
		eid_BorderArrangement_7au3e = 0;
		eid_add_Block_Object_7au3e = 0;
		eid_arrange_BlockContainer_Graphics2D_RectangleConstraint_7au3e = 0;
		eid_arrangeNN_BlockContainer_Graphics2D_7au3e = 0;
		eid_arrangeFR_BlockContainer_Graphics2D_RectangleConstraint_7au3e = 0;
		eid_arrangeFN_BlockContainer_Graphics2D_double_7au3e = 0;
		eid_arrangeRR_BlockContainer_Range_Range_Graphics2D_7au3e = 0;
		eid_arrangeFF_BlockContainer_Graphics2D_RectangleConstraint_7au3e = 0;
		eid_clear_7au3e = 0;
     ...
     * @return The container size after the arrangement.
     */
    protected Size2D arrangeFF_7au3e(BlockContainer container, Graphics2D g2,
                               RectangleConstraint constraint) {
        double[] w = new double[5];
        double[] h = new double[5];
	...
	protected Size2D arrangeFF(BlockContainer container, Graphics2D g2,
			RectangleConstraint constraint) {
		Object o_7au3e = null;
		String c_7au3e = "org.jfree.chart.block.BorderArrangement";
		String msig_7au3e = "arrangeFF(BlockContainer$Graphics2D$RectangleConstraint)"
				+ eid_arrangeFF_BlockContainer_Graphics2D_RectangleConstraint_7au3e;
		try {
			o_7au3e = arrangeFF_7au3e(container, g2, constraint);
			addToORefMap(msig_7au3e, o_7au3e);
			addToORefMap(msig_7au3e, this);
			addToORefMap(msig_7au3e, container);
			addToORefMap(msig_7au3e, g2);
			addToORefMap(msig_7au3e, constraint);
