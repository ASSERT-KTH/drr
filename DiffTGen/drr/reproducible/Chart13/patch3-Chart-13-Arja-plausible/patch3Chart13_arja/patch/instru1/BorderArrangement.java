...
public class BorderArrangement implements Arrangement, Serializable {
     ...
     */
    protected Size2D arrangeFN_7au3e(BlockContainer container, Graphics2D g2,
                               double width) {
        double[] w = new double[5];
        double[] h = new double[5];
	...
	protected Size2D arrangeFN(BlockContainer container, Graphics2D g2,
		...
		String msig_7au3e = "arrangeFN(BlockContainer$Graphics2D$double)"
				+ eid_arrangeFN_BlockContainer_Graphics2D_double_7au3e;
		try {
			o_7au3e = arrangeFN_7au3e(container, g2, width);
