...
public abstract class BaseOptimizer<PAIR> {
     ...
     */
    protected void BaseOptimizer_7au3e(ConvergenceChecker<PAIR> checker) {
	...
	protected BaseOptimizer(ConvergenceChecker<PAIR> checker) {
		...
		String msig_7au3e = "BaseOptimizer(ConvergenceChecker<PAIR>)"
				+ eid_BaseOptimizer_ConvergenceCheckerLTEMPPAIRRTEMP_7au3e;
		try {
			BaseOptimizer_7au3e(checker);
			FieldPrinter.print(this,
					eid_BaseOptimizer_ConvergenceCheckerLTEMPPAIRRTEMP_7au3e,
					c_7au3e, msig_7au3e, 1, 5);
			FieldPrinter.print(checker,
					eid_BaseOptimizer_ConvergenceCheckerLTEMPPAIRRTEMP_7au3e,
