...
public class SimplexSolver extends AbstractLinearOptimizer {
	...
	public static int eid_SimplexSolver_double_int_7au3e = 0;

	public static int eid_getPivotColumn_SimplexTableau_7au3e = 0;

	public static int eid_getPivotRow_SimplexTableau_int_7au3e = 0;
	...
	public static void clearORefMap() {
		...
		eid_SimplexSolver_double_int_7au3e = 0;
		eid_getPivotColumn_SimplexTableau_7au3e = 0;
		eid_getPivotRow_SimplexTableau_int_7au3e = 0;
     ...
     */
    private Integer getPivotRow_7au3e(SimplexTableau tableau, final int col) {
	...
	private Integer getPivotRow(SimplexTableau tableau, final int col) {
		Object o_7au3e = null;
		String c_7au3e = "org.apache.commons.math3.optimization.linear.SimplexSolver";
		String msig_7au3e = "getPivotRow(SimplexTableau$int)"
				+ eid_getPivotRow_SimplexTableau_int_7au3e;
		try {
			o_7au3e = getPivotRow_7au3e(tableau, col);
			FieldPrinter.print(o_7au3e,
					eid_getPivotRow_SimplexTableau_int_7au3e, c_7au3e,
					msig_7au3e, 0, 5);
			FieldPrinter.print(this, eid_getPivotRow_SimplexTableau_int_7au3e,
					c_7au3e, msig_7au3e, 1, 5);
			FieldPrinter.print(tableau,
					eid_getPivotRow_SimplexTableau_int_7au3e, c_7au3e,
					msig_7au3e, 2, 5);
