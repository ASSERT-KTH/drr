...
public class MultiplePiePlot extends Plot implements Cloneable, Serializable {
    ...
    public static int eid_MultiplePiePlot_7au3e = 0;

	public static int eid_MultiplePiePlot_CategoryDataset_7au3e = 0;

	public static int eid_getDataset_7au3e = 0;

	public static int eid_setDataset_CategoryDataset_7au3e = 0;

	public static int eid_getPieChart_7au3e = 0;

	public static int eid_setPieChart_JFreeChart_7au3e = 0;

	public static int eid_getDataExtractOrder_7au3e = 0;

	public static int eid_setDataExtractOrder_TableOrder_7au3e = 0;

	public static int eid_getLimit_7au3e = 0;

	public static int eid_setLimit_double_7au3e = 0;

	public static int eid_getAggregatedItemsKey_7au3e = 0;

	public static int eid_setAggregatedItemsKey_Comparable_7au3e = 0;

	public static int eid_getAggregatedItemsPaint_7au3e = 0;

	public static int eid_setAggregatedItemsPaint_Paint_7au3e = 0;
	...
	public static int eid_prefetchSectionPaints_7au3e = 0;
	...
	public static void clearORefMap() {
		eid_MultiplePiePlot_7au3e = 0;
		eid_MultiplePiePlot_CategoryDataset_7au3e = 0;
		eid_getDataset_7au3e = 0;
		eid_setDataset_CategoryDataset_7au3e = 0;
		eid_getPieChart_7au3e = 0;
		eid_setPieChart_JFreeChart_7au3e = 0;
		eid_getDataExtractOrder_7au3e = 0;
		eid_setDataExtractOrder_TableOrder_7au3e = 0;
		eid_getLimit_7au3e = 0;
		eid_setLimit_double_7au3e = 0;
		eid_getAggregatedItemsKey_7au3e = 0;
		eid_setAggregatedItemsKey_Comparable_7au3e = 0;
		eid_getAggregatedItemsPaint_7au3e = 0;
		eid_setAggregatedItemsPaint_Paint_7au3e = 0;
		eid_getPlotType_7au3e = 0;
		eid_draw_Graphics2D_Rectangle2D_Point2D_PlotState_PlotRenderingInfo_7au3e = 0;
		eid_prefetchSectionPaints_7au3e = 0;
     ...
     */
    public void MultiplePiePlot_7au3e(CategoryDataset dataset) {
        super();
        setDataset(dataset);
	...
	public MultiplePiePlot(CategoryDataset dataset) {
		Object o_7au3e = null;
		String c_7au3e = "org.jfree.chart.plot.MultiplePiePlot";
		String msig_7au3e = "MultiplePiePlot(CategoryDataset)"
				+ eid_MultiplePiePlot_CategoryDataset_7au3e;
		try {
			MultiplePiePlot_7au3e(dataset);
			FieldPrinter.print(this, eid_MultiplePiePlot_CategoryDataset_7au3e,
					c_7au3e, msig_7au3e, 1, 5);
			FieldPrinter.print(dataset,
					eid_MultiplePiePlot_CategoryDataset_7au3e, c_7au3e,
					msig_7au3e, 2, 5);
