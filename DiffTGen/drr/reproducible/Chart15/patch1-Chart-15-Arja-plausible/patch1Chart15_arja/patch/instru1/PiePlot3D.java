...
public class PiePlot3D extends PiePlot implements Serializable {
    ...
    public static int eid_PiePlot3D_7au3e = 0;

	public static int eid_PiePlot3D_PieDataset_7au3e = 0;

	public static int eid_getDepthFactor_7au3e = 0;

	public static int eid_setDepthFactor_double_7au3e = 0;

	public static int eid_getDarkerSides_7au3e = 0;

	public static int eid_setDarkerSides_boolean_7au3e = 0;

	public static int eid_draw_Graphics2D_Rectangle2D_Point2D_PlotState_PlotRenderingInfo_7au3e = 0;

	public static int eid_drawSide_Graphics2D_Rectangle2D_Arc2D_Area_Area_Paint_Paint_Stroke_boolean_boolean_7au3e = 0;

	public static int eid_getPlotType_7au3e = 0;

	public static int eid_isAngleAtFront_double_7au3e = 0;

	public static int eid_isAngleAtBack_double_7au3e = 0;
	...
	public static void clearORefMap() {
		oref_map.clear();
		eid_PiePlot3D_7au3e = 0;
		eid_PiePlot3D_PieDataset_7au3e = 0;
		eid_getDepthFactor_7au3e = 0;
		eid_setDepthFactor_double_7au3e = 0;
		eid_getDarkerSides_7au3e = 0;
		eid_setDarkerSides_boolean_7au3e = 0;
		eid_draw_Graphics2D_Rectangle2D_Point2D_PlotState_PlotRenderingInfo_7au3e = 0;
		eid_drawSide_Graphics2D_Rectangle2D_Arc2D_Area_Area_Paint_Paint_Stroke_boolean_boolean_7au3e = 0;
		eid_getPlotType_7au3e = 0;
		eid_isAngleAtFront_double_7au3e = 0;
		eid_isAngleAtBack_double_7au3e = 0;
     ...
     */
    public void draw_7au3e(Graphics2D g2, Rectangle2D plotArea, Point2D anchor,
	...
	/**
	 * Draws the plot on a Java 2D graphics device (such as the screen or a  printer).  This method is called by the  {@link org.jfree.chart.JFreeChart}  class, you don't normally need  to call it yourself.
	 * @param g2   the graphics device.
	 * @param plotArea   the area within which the plot should be drawn.
	 * @param anchor   the anchor point.
	 * @param parentState   the state from the parent plot, if there is one.
	...
	public void draw(Graphics2D g2, Rectangle2D plotArea, Point2D anchor,
		...
		Object o_7au3e = null;
		String c_7au3e = "org.jfree.chart.plot.PiePlot3D";
		...
		try {
			draw_7au3e(g2, plotArea, anchor, parentState, info);
			addToORefMap(msig_7au3e, null);
			addToORefMap(msig_7au3e, this);
			addToORefMap(msig_7au3e, g2);
			addToORefMap(msig_7au3e, plotArea);
			addToORefMap(msig_7au3e, anchor);
			addToORefMap(msig_7au3e, parentState);
			addToORefMap(msig_7au3e, info);
