...
public class DateTimeZoneBuilder {
    public static int eid_readFrom_InputStream_String_7au3e = 0;
	public static int eid_readFrom_DataInput_String_7au3e = 0;
	public static int eid_writeMillis_DataOutput_long_7au3e = 0;
	public static int eid_readMillis_DataInput_7au3e = 0;
	public static int eid_buildFixedZone_String_String_int_int_7au3e = 0;
	public static int eid_DateTimeZoneBuilder_7au3e = 0;
	public static int eid_addCutover_int_char_int_int_int_boolean_int_7au3e = 0;
	public static int eid_setStandardOffset_int_7au3e = 0;
	public static int eid_setFixedSavings_String_int_7au3e = 0;
	public static int eid_addRecurringSavings_String_int_int_int_char_int_int_int_boolean_int_7au3e = 0;
	public static int eid_getLastRuleSet_7au3e = 0;
	public static int eid_toDateTimeZone_String_boolean_7au3e = 0;
	public static int eid_addTransition_ArrayListLTEMPTransitionRTEMP_Transition_7au3e = 0;
	public static int eid_writeTo_String_OutputStream_7au3e = 0;
	public static int eid_writeTo_String_DataOutput_7au3e = 0;
	...
	public static void clearORefMap() {
		oref_map.clear();
		eid_readFrom_InputStream_String_7au3e = 0;
		eid_readFrom_DataInput_String_7au3e = 0;
		eid_writeMillis_DataOutput_long_7au3e = 0;
		eid_readMillis_DataInput_7au3e = 0;
		eid_buildFixedZone_String_String_int_int_7au3e = 0;
		eid_DateTimeZoneBuilder_7au3e = 0;
		eid_addCutover_int_char_int_int_int_boolean_int_7au3e = 0;
		eid_setStandardOffset_int_7au3e = 0;
		eid_setFixedSavings_String_int_7au3e = 0;
		eid_addRecurringSavings_String_int_int_int_char_int_int_int_boolean_int_7au3e = 0;
		eid_getLastRuleSet_7au3e = 0;
		eid_toDateTimeZone_String_boolean_7au3e = 0;
		eid_addTransition_ArrayListLTEMPTransitionRTEMP_Transition_7au3e = 0;
		eid_writeTo_String_OutputStream_7au3e = 0;
		eid_writeTo_String_DataOutput_7au3e = 0;
	}
    ...
    private static final class PrecalculatedZone extends DateTimeZone {
         ...
         */
        static PrecalculatedZone create_7au3e(String id, boolean outputID, ArrayList<Transition> transitions,
                                        DSTZone tailZone) {
            int size = transitions.size();
            if (size == 0) {
                throw new IllegalArgumentException();
		 ...
		 * @param tailZone   optional zone for getting info beyond precalculated tables
		 */
		static PrecalculatedZone create(String id, boolean outputID,
				ArrayList<Transition> transitions, DSTZone tailZone) {
			Object o_7au3e = null;
			String c_7au3e = "org.joda.time.tz.DateTimeZoneBuilder";
			String msig_7au3e = "create(String$boolean$ArrayList<Transition>$DSTZone)"
					+ eid_create_String_boolean_ArrayListLTEMPTransitionRTEMP_DSTZone_7au3e;
			try {
				o_7au3e = create_7au3e(id, outputID, transitions, tailZone);
				addToORefMap(msig_7au3e, o_7au3e);
				addToORefMap(msig_7au3e, null);
				addToORefMap(msig_7au3e, null);
				addToORefMap(msig_7au3e, null);
				addToORefMap(msig_7au3e, transitions);
				addToORefMap(msig_7au3e, tailZone);
			...
			return (PrecalculatedZone) o_7au3e;
		}
    }
}
