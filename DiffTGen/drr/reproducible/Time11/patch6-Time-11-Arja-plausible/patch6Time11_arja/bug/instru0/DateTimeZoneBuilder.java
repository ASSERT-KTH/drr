...
public class DateTimeZoneBuilder {
     ...
     */
    public DateTimeZone toDateTimeZone_7au3e(String id, boolean outputID) {
        if (id == null) {
	...
	public DateTimeZone toDateTimeZone(String id, boolean outputID) {
		...
		String msig_7au3e = "toDateTimeZone(String$boolean)"
				+ eid_toDateTimeZone_String_boolean_7au3e;
		try {
			o_7au3e = toDateTimeZone_7au3e(id, outputID);
			FieldPrinter.print(o_7au3e,
					eid_toDateTimeZone_String_boolean_7au3e, c_7au3e,
					msig_7au3e, 0, 5);
			FieldPrinter.print(this, eid_toDateTimeZone_String_boolean_7au3e,
					c_7au3e, msig_7au3e, 1, 5);
		} catch (Throwable t7au3e) {
			FieldPrinter.print(t7au3e, eid_toDateTimeZone_String_boolean_7au3e,
					c_7au3e, msig_7au3e, 0, 5);
			throw t7au3e;
		} finally {
			eid_toDateTimeZone_String_boolean_7au3e++;
		}
		return (DateTimeZone) o_7au3e;
	}
}
