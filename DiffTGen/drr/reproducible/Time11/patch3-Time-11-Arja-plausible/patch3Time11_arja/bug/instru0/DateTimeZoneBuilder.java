...
public class DateTimeZoneBuilder {
    ...
    private static final class RuleSet {
         ...
         */
        public DSTZone buildTailZone_7au3e(String id) {
            if (iRules.size() == 2) {
		...
		public DSTZone buildTailZone(String id) {
			...
			String msig_7au3e = "buildTailZone(String)"
					+ eid_buildTailZone_String_7au3e;
			try {
				o_7au3e = buildTailZone_7au3e(id);
				FieldPrinter.print(o_7au3e, eid_buildTailZone_String_7au3e,
						c_7au3e, msig_7au3e, 0, 5);
				FieldPrinter.print(this, eid_buildTailZone_String_7au3e,
						c_7au3e, msig_7au3e, 1, 5);
			} catch (Throwable t7au3e) {
				FieldPrinter.print(t7au3e, eid_buildTailZone_String_7au3e,
						c_7au3e, msig_7au3e, 0, 5);
				throw t7au3e;
			} finally {
				eid_buildTailZone_String_7au3e++;
			}
			return (DSTZone) o_7au3e;
		}
    }
