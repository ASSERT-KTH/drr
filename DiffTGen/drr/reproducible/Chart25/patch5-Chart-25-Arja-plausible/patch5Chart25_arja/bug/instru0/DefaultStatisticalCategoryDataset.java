...
public class DefaultStatisticalCategoryDataset extends AbstractDataset
    ...
    public static int eid_DefaultStatisticalCategoryDataset_7au3e = 0;

	public static int eid_getMeanValue_int_int_7au3e = 0;

	public static int eid_getValue_int_int_7au3e = 0;

	public static int eid_getValue_Comparable_Comparable_7au3e = 0;

	public static int eid_getMeanValue_Comparable_Comparable_7au3e = 0;

	public static int eid_getStdDevValue_int_int_7au3e = 0;

	public static int eid_getStdDevValue_Comparable_Comparable_7au3e = 0;

	public static int eid_getColumnIndex_Comparable_7au3e = 0;

	public static int eid_getColumnKey_int_7au3e = 0;

	public static int eid_getColumnKeys_7au3e = 0;

	public static int eid_getRowIndex_Comparable_7au3e = 0;

	public static int eid_getRowKey_int_7au3e = 0;

	public static int eid_getRowKeys_7au3e = 0;

	public static int eid_getRowCount_7au3e = 0;

	public static int eid_getColumnCount_7au3e = 0;

	public static int eid_add_double_double_Comparable_Comparable_7au3e = 0;

	public static int eid_add_Number_Number_Comparable_Comparable_7au3e = 0;

	public static int eid_getRangeLowerBound_boolean_7au3e = 0;

	public static int eid_getRangeUpperBound_boolean_7au3e = 0;

	public static int eid_getRangeBounds_boolean_7au3e = 0;

	public static int eid_equals_Object_7au3e = 0;

	public static void clearORefMap() {
		eid_DefaultStatisticalCategoryDataset_7au3e = 0;
		eid_getMeanValue_int_int_7au3e = 0;
		eid_getValue_int_int_7au3e = 0;
		eid_getValue_Comparable_Comparable_7au3e = 0;
		eid_getMeanValue_Comparable_Comparable_7au3e = 0;
		eid_getStdDevValue_int_int_7au3e = 0;
		eid_getStdDevValue_Comparable_Comparable_7au3e = 0;
		eid_getColumnIndex_Comparable_7au3e = 0;
		eid_getColumnKey_int_7au3e = 0;
		eid_getColumnKeys_7au3e = 0;
		eid_getRowIndex_Comparable_7au3e = 0;
		eid_getRowKey_int_7au3e = 0;
		eid_getRowKeys_7au3e = 0;
		eid_getRowCount_7au3e = 0;
		eid_getColumnCount_7au3e = 0;
		eid_add_double_double_Comparable_Comparable_7au3e = 0;
		eid_add_Number_Number_Comparable_Comparable_7au3e = 0;
		eid_getRangeLowerBound_boolean_7au3e = 0;
		eid_getRangeUpperBound_boolean_7au3e = 0;
		eid_getRangeBounds_boolean_7au3e = 0;
     ...
     */
    public Number getMeanValue_7au3e(int row, int column) {
        Number result = null;
	...
	public Number getMeanValue(int row, int column) {
		Object o_7au3e = null;
		String c_7au3e = "org.jfree.data.statistics.DefaultStatisticalCategoryDataset";
		String msig_7au3e = "getMeanValue(int$int)"
				+ eid_getMeanValue_int_int_7au3e;
		try {
			o_7au3e = getMeanValue_7au3e(row, column);
			FieldPrinter.print(o_7au3e, eid_getMeanValue_int_int_7au3e,
					c_7au3e, msig_7au3e, 0, 5);
			FieldPrinter.print(this, eid_getMeanValue_int_int_7au3e, c_7au3e,
					msig_7au3e, 1, 5);
		} catch (Throwable t7au3e) {
			FieldPrinter.print(t7au3e, eid_getMeanValue_int_int_7au3e, c_7au3e,
					msig_7au3e, 0, 5);
			throw t7au3e;
		} finally {
			eid_getMeanValue_int_int_7au3e++;
