...
public class Frequency_ESTest {
  ...
  public void test06()  throws Throwable  {
      Frequency frequency0 = new Frequency();
      long long0 = frequency0.getCount(6745);
      assertEquals(0L, long0);
  }
  ...
  public void test07()  throws Throwable  {
      Frequency frequency0 = new Frequency();
      double double0 = frequency0.getCumPct((-3188L));
      assertEquals(Double.NaN, double0, 0.01);
  }
  ...
  public void test19()  throws Throwable  {
      Comparator<Object> comparator0 = (Comparator<Object>) mock(Comparator.class, new ViolatedAssumptionAnswer());
      doReturn(2397, 2397, 2397, (-35), 2397).when(comparator0).compare(any() , any());
      Frequency frequency0 = new Frequency(comparator0);
      frequency0.addValue('(');
      double double0 = frequency0.getCumPct(0);
      assertEquals(0.0, double0, 0.01);
