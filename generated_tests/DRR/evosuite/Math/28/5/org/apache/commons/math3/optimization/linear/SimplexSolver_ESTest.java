...
public class SimplexSolver_ESTest {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn(3670.34, 1.0E-12).when(linearConstraint1).getValue();
  ...
  public void test1()  throws Throwable  {
      ...
      doReturn(openMapRealVector0).when(linearConstraint0).getCoefficients();
      doReturn(relationship0).when(linearConstraint0).getRelationship();
      doReturn(1722.5566617256, 1.0E-12).when(linearConstraint0).getValue();
      LinearConstraint linearConstraint1 = mock(LinearConstraint.class, new ViolatedAssumptionAnswer());
      doReturn(arrayRealVector0).when(linearConstraint1).getCoefficients();
      doReturn(relationship0).when(linearConstraint1).getRelationship();
      doReturn(642.168, 100.0).when(linearConstraint1).getValue();
      linkedList0.add(linearConstraint1);
      linkedList0.offerFirst(linearConstraint0);
      GoalType goalType0 = GoalType.MAXIMIZE;
      SimplexTableau simplexTableau0 = new SimplexTableau(linearObjectiveFunction0, linkedList0, goalType0, true, (-4009.1739875384387));
  ...
  public void test3()  throws Throwable  {
      ...
      doReturn(100.0, 1.0E-12).when(linearConstraint2).getValue();
  ...
  public void test4()  throws Throwable  {
      ...
      linkedList0.add(linearConstraint1);
      GoalType goalType0 = GoalType.MAXIMIZE;
      SimplexTableau simplexTableau0 = new SimplexTableau(linearObjectiveFunction0, linkedList0, goalType0, true, 736.8738687, (-3190));
      try { 
        simplexSolver0.doIteration(simplexTableau0);
        fail("Expecting exception: IllegalStateException");
