...
public class DiscreteDistribution_ESTest {
  ...
  public void test0()  throws Throwable  {
      ...
      Short short0 = new Short((short)4204);
      Double double0 = new Double((short)4204);
  ...
  public void test1()  throws Throwable  {
      ...
      Double double0 = new Double((-612.27844428898));
      ...
      try {
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // -612.278 is smaller than the minimum (0)
         //
  ...
  public void test7()  throws Throwable  {
      ...
      linkedList0.add(pair0);
      DiscreteDistribution<Integer> discreteDistribution0 = new DiscreteDistribution<Integer>(linkedList0);
      Object[] objectArray0 = discreteDistribution0.sample(56);
      assertEquals(56, objectArray0.length);
  }
  ...
  public void test8()  throws Throwable  {
      ...
      Pair<String, Double> pair0 = new Pair<String, Double>("'VldS*5u(", double0);
      linkedList0.add(pair0);
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>(linkedList0);
      try { 
        discreteDistribution0.sample((-3291));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // number of samples (-3,291)
         //
         verifyException("org.apache.commons.math3.distribution.DiscreteDistribution", e);
      }
  }
