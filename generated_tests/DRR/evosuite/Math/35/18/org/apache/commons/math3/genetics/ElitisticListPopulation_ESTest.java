...
public class ElitisticListPopulation_ESTest {
  ...
  public void test0()  throws Throwable  {
      ...
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(linkedList0, 171, 1.0);
      assertEquals(1.0, elitisticListPopulation0.getElitismRate(), 0.01);
  }

  @Test(timeout = 4000)
  public void test1()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(1490, 1.0);
  ...
  public void test2()  throws Throwable  {
      ...
      try {
        elitisticListPopulation0 = new ElitisticListPopulation(3483, (-1015.66928));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // elitism rate (-1,015.669)
         //
  ...
  public void test3()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = null;
      try {
        elitisticListPopulation0 = new ElitisticListPopulation(1, 2872.0);
        fail("Expecting exception: IllegalArgumentException");
