...
public class ElitisticListPopulation_ESTest {
  ...
  public void test1()  throws Throwable  {
      ...
      try {
        elitisticListPopulation0 = new ElitisticListPopulation(1868, (-2127.7886));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // elitism rate (-2,127.789)
         //
  ...
  public void test2()  throws Throwable  {
      ...
      ElitisticListPopulation elitisticListPopulation0 = null;
      try {
        elitisticListPopulation0 = new ElitisticListPopulation(linkedList0, 2576, 2576);
        fail("Expecting exception: IllegalArgumentException");
