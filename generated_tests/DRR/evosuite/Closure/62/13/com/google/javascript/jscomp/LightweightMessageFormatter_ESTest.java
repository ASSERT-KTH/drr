...
public class LightweightMessageFormatter_ESTest extends LightweightMessageFormatter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      JSError jSError0 = JSError.make("4viqzSIy&TT3sp", 8232, 0, checkLevel0, diagnosticType0, stringArray0);
      String string0 = lightweightMessageFormatter0.formatError(jSError0);
      assertEquals("4viqzSIy&TT3sp:8232: ERROR - @modifies may only appear in externs files.\n", string0);
  }
  ...
  public void test3()  throws Throwable  {
      ...
      SimpleRegion simpleRegion0 = new SimpleRegion((-3266), (-3266), "{s0D#8@,Q)Rtg");
      String string0 = lightweightMessageFormatter_LineNumberingFormatter0.formatRegion(simpleRegion0);
      assertEquals("  -3266| {s0D#8@,Q)Rtg", string0);
  ...
  public void test5()  throws Throwable  {
      LightweightMessageFormatter.LineNumberingFormatter lightweightMessageFormatter_LineNumberingFormatter0 = new LightweightMessageFormatter.LineNumberingFormatter();
      SimpleRegion simpleRegion0 = new SimpleRegion(151, 151, "^\n");
      String string0 = lightweightMessageFormatter_LineNumberingFormatter0.formatRegion(simpleRegion0);
      assertNotNull(string0);
