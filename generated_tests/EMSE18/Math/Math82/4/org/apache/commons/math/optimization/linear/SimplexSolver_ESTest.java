...
public class SimplexSolver_ESTest  {
  ...
  public void test02()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver(0.45494836899430074);
      double[] doubleArray0 = new double[0];
      LinearObjectiveFunction linearObjectiveFunction0 = new LinearObjectiveFunction(doubleArray0, 0.45494836899430074);
      LinkedList<LinearConstraint> linkedList0 = new LinkedList<LinearConstraint>();
      GoalType goalType0 = GoalType.MAXIMIZE;
  ...
  public void test03()  throws Throwable  {
      ...
      LinearObjectiveFunction linearObjectiveFunction0 = new LinearObjectiveFunction(doubleArray0, 1465.94862011);
  ...
  public void test06()  throws Throwable  {
      ...
      double[] doubleArray0 = new double[0];
      LinearObjectiveFunction linearObjectiveFunction0 = new LinearObjectiveFunction(doubleArray0, 0.0);
      simplexSolver0.setMaxIterations((-4436));
      LinkedList<LinearConstraint> linkedList0 = new LinkedList<LinearConstraint>();
      GoalType goalType0 = GoalType.MAXIMIZE;
      SimplexTableau simplexTableau0 = new SimplexTableau(linearObjectiveFunction0, linkedList0, goalType0, true, 0.0);
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // org.evosuite.runtime.mock.java.lang.MockThrowable: Maximal number of iterations (-4,436) exceeded
         //
         verifyException("org.apache.commons.math.optimization.linear.AbstractLinearOptimizer", e);
      }
  }
  ...
  public void test07()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver((-0.5266763925968743));
      double[] doubleArray0 = new double[1];
      LinearObjectiveFunction linearObjectiveFunction0 = new LinearObjectiveFunction(doubleArray0, (-0.5266763925968743));
      LinkedList<LinearConstraint> linkedList0 = new LinkedList<LinearConstraint>();
      GoalType goalType0 = GoalType.MAXIMIZE;
      RealPointValuePair realPointValuePair0 = simplexSolver0.optimize(linearObjectiveFunction0, linkedList0, goalType0, true);
      RealPointValuePair realPointValuePair1 = simplexSolver0.doOptimize();
  ...
  public void test09()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver((-1606.891089));
      double[] doubleArray0 = new double[1];
      doubleArray0[0] = (double) 100;
      ...
      LinkedList<LinearConstraint> linkedList0 = new LinkedList<LinearConstraint>();
      GoalType goalType0 = GoalType.MINIMIZE;
      SimplexTableau simplexTableau0 = new SimplexTableau(linearObjectiveFunction0, linkedList0, goalType0, false, (-1606.891089));
      boolean boolean0 = simplexSolver0.isOptimal(simplexTableau0);
  ...
  public void test15()  throws Throwable  {
      ...
      LinkedList<LinearConstraint> linkedList0 = new LinkedList<LinearConstraint>();
      GoalType goalType0 = GoalType.MAXIMIZE;
      SimplexTableau simplexTableau0 = new SimplexTableau(linearObjectiveFunction0, linkedList0, goalType0, false, (-209.820077014));
      try { 
        simplexSolver0.doIteration(simplexTableau0);
        fail("Expecting exception: Exception");
