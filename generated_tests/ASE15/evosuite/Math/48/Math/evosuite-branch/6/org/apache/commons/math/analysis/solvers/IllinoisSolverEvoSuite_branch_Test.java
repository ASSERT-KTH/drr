...
public class IllinoisSolverEvoSuite_branch_Test   {
  ...
  public void test0()  throws Throwable  {
      double double0 = (-2737.666035598128);
      IllinoisSolver illinoisSolver0 = new IllinoisSolver(double0, double0, double0);
      assertNotNull(illinoisSolver0);
      assertEquals((-2737.666035598128), illinoisSolver0.getRelativeAccuracy(), 0.01D);
      assertEquals(0.0, illinoisSolver0.getMin(), 0.01D);
      assertEquals((-2737.666035598128), illinoisSolver0.getFunctionValueAccuracy(), 0.01D);
      ...
      assertEquals((-2737.666035598128), illinoisSolver0.getAbsoluteAccuracy(), 0.01D);
  ...
  public void test2()  throws Throwable  {
      double double0 = (-1452.1995);
      IllinoisSolver illinoisSolver0 = new IllinoisSolver(double0);
      assertNotNull(illinoisSolver0);
      assertEquals((-1452.1995), illinoisSolver0.getAbsoluteAccuracy(), 0.01D);
      assertEquals(1.0E-14, illinoisSolver0.getRelativeAccuracy(), 0.01D);
      assertEquals(0.0, illinoisSolver0.getMin(), 0.01D);
      assertEquals(0.0, illinoisSolver0.getMax(), 0.01D);
      assertEquals(1.0E-15, illinoisSolver0.getFunctionValueAccuracy(), 0.01D);
