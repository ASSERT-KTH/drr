...
public class SimplexSolver_ESTest  {
  ...
  public void test2()  throws Throwable  {
      double[] doubleArray0 = new double[1];
      doubleArray0[0] = 3.5037536832675478E-217;
      ...
      LinearObjectiveFunction linearObjectiveFunction0 = new LinearObjectiveFunction((RealVector) realVectorAbstractTest_RealVectorTestImpl0, 3.5037536832675478E-217);
      LinkedList<LinearConstraint> linkedList0 = new LinkedList<LinearConstraint>();
      GoalType goalType0 = GoalType.MINIMIZE;
      SimplexTableau simplexTableau0 = new SimplexTableau(linearObjectiveFunction0, linkedList0, goalType0, false, 3.5037536832675478E-217);
      SimplexSolver simplexSolver0 = new SimplexSolver();
      try { 
  ...
  public void test3()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver(590.99868, 0);
      // Undeclared exception!
      try { 
