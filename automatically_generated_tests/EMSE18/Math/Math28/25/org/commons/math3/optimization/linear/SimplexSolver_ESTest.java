...
public class SimplexSolver_ESTest  {
  ...
  public void test3()  throws Throwable  {
      SimplexSolver simplexSolver0 = new SimplexSolver(14.788290265664894, (-1821));
      double[] doubleArray0 = new double[3];
      doubleArray0[1] = (double) 100;
      LinearObjectiveFunction linearObjectiveFunction0 = new LinearObjectiveFunction(doubleArray0, 100.0);
      LinkedList<LinearConstraint> linkedList0 = new LinkedList<LinearConstraint>();
      GoalType goalType0 = GoalType.MAXIMIZE;
      SimplexTableau simplexTableau0 = new SimplexTableau(linearObjectiveFunction0, linkedList0, goalType0, true, 14.788290265664894, (-1821));
      try { 
