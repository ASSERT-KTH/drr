...
public class DiscreteDistribution_ESTest  {
  ...
  public void test00()  throws Throwable  {
      ...
      Double double0 = new Double(1154.153051);
      Pair<String, Double> pair0 = new Pair<String, Double>("L0-/Vq7DTP8", double0);
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        discreteDistribution0.sample(2904);
  ...
  public void test07()  throws Throwable  {
      ...
      Double double0 = new Double(858.970766361);
      Double double1 = new Double((-2269.047618695455));
      ...
      try {
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // -2,269.048 is smaller than the minimum (0)
         //
         verifyException("org.apache.commons.math3.distribution.DiscreteDistribution", e);
      }
  }
  ...
  public void test08()  throws Throwable  {
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      Double double0 = new Double(32.03460097);
      Pair<String, Double> pair0 = new Pair<String, Double>("", double0);
      linkedList0.add(pair0);
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>((List<Pair<String, Double>>) linkedList0);
      String[] stringArray0 = discreteDistribution0.sample(2065);
  ...
  public void test10()  throws Throwable  {
      ...
      assertEquals("L0-/Vq7DTP8", string0);
  }
  ...
  public void test12()  throws Throwable  {
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      Double double0 = new Double(32.03460097);
      Pair<String, Double> pair0 = new Pair<String, Double>("L-/Vq7DTP8", double0);
      linkedList0.add(pair0);
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>((List<Pair<String, Double>>) linkedList0);
      double double1 = discreteDistribution0.probability("L-/Vq7DTP8");
  ...
  public void test13()  throws Throwable  {
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      Double double0 = new Double(37.966809990274264);
      Pair<String, Double> pair0 = new Pair<String, Double>("L&>Vq7DTP8", double0);
      linkedList0.add(pair0);
      DiscreteDistribution<String> discreteDistribution0 = new DiscreteDistribution<String>((List<Pair<String, Double>>) linkedList0);
  ...
  public void test14()  throws Throwable  {
      LinkedList<Pair<String, Double>> linkedList0 = new LinkedList<Pair<String, Double>>();
      Double double0 = new Double(1374.76);
  ...
  public void test16()  throws Throwable  {
      LinkedList<Pair<Double, Double>> linkedList0 = new LinkedList<Pair<Double, Double>>();
      Double double0 = new Double((-684.2895007424));
      ...
      try {
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // -684.29 is smaller than the minimum (0)
         //
         verifyException("org.apache.commons.math3.distribution.DiscreteDistribution", e);
      }
  }
