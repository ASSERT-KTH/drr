...
public class IllinoisSolverEvoSuite_branch_Test_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.ClassStateSupport.initializeClasses(IllinoisSolverEvoSuite_branch_Test_scaffolding.class.getClassLoader() ,
  ...
  private static void resetClasses() {
    org.evosuite.runtime.reset.ClassResetter.getInstance().setClassLoader(IllinoisSolverEvoSuite_branch_Test_scaffolding.class.getClassLoader()); 
