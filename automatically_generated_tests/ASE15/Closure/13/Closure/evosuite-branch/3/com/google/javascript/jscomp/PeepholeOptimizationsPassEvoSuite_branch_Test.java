...
public class PeepholeOptimizationsPassEvoSuite_branch_Test   {
  ...
  public void test0()  throws Throwable  {
      ...
      abstractPeepholeOptimizationArray0[2] = (AbstractPeepholeOptimization) peepholeReplaceKnownMethods0;
      ...
      abstractPeepholeOptimizationArray0[7] = (AbstractPeepholeOptimization) reorderConstantExpression0;
      assertNotNull(abstractPeepholeOptimizationArray0[7]);
      
      String string0 = "L2r;SgUOUTojZ6";
      ...
      assertEquals("L2r;SgUOUTojZ6", node0.getSourceFileName());
  ...
  public void test2()  throws Throwable  {
      ...
      abstractPeepholeOptimizationArray0[5] = (AbstractPeepholeOptimization) reorderConstantExpression0;
      assertNotNull(abstractPeepholeOptimizationArray0[5]);
      
      abstractPeepholeOptimizationArray0[7] = (AbstractPeepholeOptimization) peepholeFoldWithTypes0;
      assertNotNull(abstractPeepholeOptimizationArray0[7]);
      
      abstractPeepholeOptimizationArray0[8] = (AbstractPeepholeOptimization) peepholeFoldWithTypes0;
      assertNotNull(abstractPeepholeOptimizationArray0[8]);
      
      String string0 = "L:r;SgUOUTojZ6";
      Node node0 = compiler0.parseSyntheticCode(string0, string0);
      assertEquals(false, node0.isNull());
      assertEquals(false, node0.isTrue());
      assertEquals(false, node0.isGetterDef());
      ...
      assertEquals(true, node0.isSyntheticBlock());
      assertEquals(false, node0.isTypeOf());
      assertEquals("L:r;SgUOUTojZ6", node0.getSourceFileName());
      assertEquals(false, node0.isDebugger());
      assertEquals(false, node0.isBreak());
      assertEquals(false, node0.isNot());
      assertEquals(false, node0.isHook());
