...
public class ScopedAliasesEvoSuite_branch_Test   {
  ...
  public void test0()  throws Throwable  {
      ...
      assertEquals(19226623, node1.getSourcePosition());
      ...
      assertEquals(4693, node1.getType());
      assertEquals(false, node1.isNull());
      assertEquals(4693, node1.getLineno());
      ...
      assertEquals(false, compiler0.externsRoot.isStringKey());
      assertEquals(false, compiler0.externsRoot.isSyntheticBlock());
      assertEquals(-1, compiler0.externsRoot.getLineno());
      assertEquals(-1, compiler0.externsRoot.getSourcePosition());
      ...
      assertEquals(-1, compiler0.externsRoot.getCharno());
      ...
      scopedAliases0.process(node1, compiler0.externsRoot);
      assertEquals(false, node1.isGetterDef());
      assertEquals(4095, node1.getCharno());
      assertEquals(false, node1.isOptionalArg());
      assertEquals(false, node1.isNot());
  ...
  public void test1()  throws Throwable  {
      ...
      scopedAliases0.process(node0, compiler0.externsRoot);
      assertEquals(true, compiler0.hasErrors());
      assertEquals(false, compiler0.acceptConstKeyword());
      assertEquals(0, compiler0.getWarningCount());
      assertEquals(CompilerOptions.LanguageMode.ECMASCRIPT3, compiler0.languageMode());
