...
public class TypedScopeCreatorEvoSuite_branch_Test   {
  ...
  public void test0()  throws Throwable  {
      ...
      String string1 = "w}>>s'o^`V^\\|G";
      assertNotSame(string1, string0);
      
      JSSourceFile jSSourceFile0 = JSSourceFile.fromFile(string1);
      assertNotSame(string1, string0);
      assertEquals("w}>>s'o^`V^\\|G", jSSourceFile0.getName());
      assertEquals("w}>>s'o^`V^\\|G", jSSourceFile0.toString());
      assertEquals("w}>>s'o^`V^\\|G", jSSourceFile0.getOriginalPath());
      ...
      assertEquals("w}>>s'o^`V^\\|G", node0.getSourceFileName());
  ...
  public void test1()  throws Throwable  {
      PrintStream printStream0 = null;
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/scratch/ac1gf/Closure/43/4/run_evosuite.pl_15204_1418336076/w}>>s'o^`V^\\|G");
      String string0 = "m.oGl.atrxn.ypePObt2e";
      boolean boolean0 = FileSystemHandling.appendLineToFile(evoSuiteFile0, string0);
      assertTrue(boolean0);
