...
public class PowellOptimizerEvoSuite_branch_Test   {
  ...
  public void test0()  throws Throwable  {
      double double0 = 1155.129177386399;
  ...
  public void test1()  throws Throwable  {
      double double0 = 683.8370545446664;
      PowellOptimizer powellOptimizer0 = new PowellOptimizer(double0, double0);
      assertEquals(0, powellOptimizer0.getEvaluations());
      assertEquals(0, powellOptimizer0.getMaxEvaluations());
      assertEquals(2147483647, powellOptimizer0.getMaxIterations());
  ...
  public void test2()  throws Throwable  {
      double double0 = 3000.501739228408;
      double double1 = (-5840.33987);
      PowellOptimizer powellOptimizer0 = null;
      try {
        powellOptimizer0 = new PowellOptimizer(double0, double1, double1, double0);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // -5,840.34 is smaller than, or equal to, the minimum (0)
         //
      }
  }
  ...
  public void test3()  throws Throwable  {
      double double0 = (-21.149820077068807);
      PowellOptimizer powellOptimizer0 = null;
      try {
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // -21.15 is smaller than the minimum (0)
         //
      }
  }
}
