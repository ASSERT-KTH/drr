...
public class LineEvoSuite_branch_Test   {
  ...
  public void test13()  throws Throwable  {
      ...
      assertEquals(Double.NEGATIVE_INFINITY, vector1D0.getX(), 0.01D);
      assertEquals(Double.POSITIVE_INFINITY, vector1D0.getNormInf(), 0.01D);
      assertEquals(true, vector1D0.isInfinite());
      assertEquals(Double.POSITIVE_INFINITY, vector1D0.getNorm(), 0.01D);
      assertEquals(Double.POSITIVE_INFINITY, vector1D0.getNormSq(), 0.01D);
      assertEquals(Double.POSITIVE_INFINITY, vector1D0.getNorm1(), 0.01D);
