...
public final class ZonedChronology extends org.joda.time.chrono.AssembledChronology {
	...
	static final class ZonedDateTimeField extends org.joda.time.field.BaseDateTimeField {
		...
		public long set(long instant, int value) {
			...
			if ((get(result)) != value) {
				throw new org.joda.time.IllegalFieldValueException(iField.getType(), java.lang.Integer.valueOf(value), (((("Illegal instant due to time zone offset transition: " + (org.joda.time.format.DateTimeFormat.forPattern("yyyy-MM-dd'T'HH:mm:ss.SSS").print(new org.joda.time.Instant(localInstant)))) + " (") + (iZone.getID())) + ")"));
			}
			return result;
		}
