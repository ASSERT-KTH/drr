...
public final class LocalTime extends org.joda.time.base.BaseLocal implements java.io.Serializable , org.joda.time.ReadablePartial {
	...
	public static org.joda.time.LocalTime now(org.joda.time.DateTimeZone zone) {
		if (zone == null) {
			throw new java.lang.NullPointerException("Zone must not be null");
		}
		return new org.joda.time.LocalTime(zone);
	}

	public static org.joda.time.LocalTime now(org.joda.time.Chronology chronology) {
		if (chronology == null) {
			throw new java.lang.NullPointerException("Chronology must not be null");
		}
		return new org.joda.time.LocalTime(chronology);
	}

	@org.joda.convert.FromString
	public static org.joda.time.LocalTime parse(java.lang.String str) {
		return org.joda.time.LocalTime.parse(str, org.joda.time.format.ISODateTimeFormat.localTimeParser());
	}

	public static org.joda.time.LocalTime parse(java.lang.String str, org.joda.time.format.DateTimeFormatter formatter) {
	...
	private java.lang.Object readResolve() {
		if ((org.joda.time.DateTimeZone.UTC.equals(iChronology.getZone())) == false) {
			return new org.joda.time.LocalTime(iLocalMillis, iChronology.withUTC());
		}
