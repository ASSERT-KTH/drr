...
public class DateTimeFormatter {
	...
	public org.joda.time.format.DateTimeFormatter withPivotYear(int pivotYear) {
		return withPivotYear(java.lang.Integer.valueOf(pivotYear));
	}
	...
	public int parseInto(org.joda.time.ReadWritableInstant instant, java.lang.String text, int position) {
		...
		chrono = selectChronology(chrono);
		org.joda.time.format.DateTimeParserBucket bucket = new org.joda.time.format.DateTimeParserBucket(instantLocal, chrono, iLocale, iPivotYear, chrono.year().get(instantLocal));
	...
	public org.joda.time.DateTime parseDateTime(java.lang.String text) {
		...
		if (newPos >= 0) {
			if (newPos >= (text.length())) {
				...
				org.joda.time.DateTime dt = new org.joda.time.DateTime(millis, chrono);
				if ((iZone) != null) {
	...
	public org.joda.time.MutableDateTime parseMutableDateTime(java.lang.String text) {
		...
		if (newPos >= 0) {
			if (newPos >= (text.length())) {
				...
				org.joda.time.MutableDateTime dt = new org.joda.time.MutableDateTime(millis, chrono);
				if ((iZone) != null) {
					dt.setZone(iZone);
				}
				return dt;
