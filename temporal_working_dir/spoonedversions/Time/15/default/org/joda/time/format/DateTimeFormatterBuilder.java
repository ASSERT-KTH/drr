...
public class DateTimeFormatterBuilder {
	...
	public org.joda.time.format.DateTimeFormatterBuilder appendTimeZoneName() {
		return append0(new org.joda.time.format.DateTimeFormatterBuilder.TimeZoneName(org.joda.time.format.DateTimeFormatterBuilder.TimeZoneName.LONG_NAME, null), null);
	}

	public org.joda.time.format.DateTimeFormatterBuilder appendTimeZoneName(java.util.Map<java.lang.String, org.joda.time.DateTimeZone> parseLookup) {
		org.joda.time.format.DateTimeFormatterBuilder.TimeZoneName pp = new org.joda.time.format.DateTimeFormatterBuilder.TimeZoneName(org.joda.time.format.DateTimeFormatterBuilder.TimeZoneName.LONG_NAME, parseLookup);
		return append0(pp, pp);
	}

	public org.joda.time.format.DateTimeFormatterBuilder appendTimeZoneShortName() {
		return append0(new org.joda.time.format.DateTimeFormatterBuilder.TimeZoneName(org.joda.time.format.DateTimeFormatterBuilder.TimeZoneName.SHORT_NAME, null), null);
	}

	public org.joda.time.format.DateTimeFormatterBuilder appendTimeZoneShortName(java.util.Map<java.lang.String, org.joda.time.DateTimeZone> parseLookup) {
		org.joda.time.format.DateTimeFormatterBuilder.TimeZoneName pp = new org.joda.time.format.DateTimeFormatterBuilder.TimeZoneName(org.joda.time.format.DateTimeFormatterBuilder.TimeZoneName.SHORT_NAME, parseLookup);
		return append0(pp, pp);
	}

	public org.joda.time.format.DateTimeFormatterBuilder appendTimeZoneId() {
		return append0(org.joda.time.format.DateTimeFormatterBuilder.TimeZoneId.INSTANCE, org.joda.time.format.DateTimeFormatterBuilder.TimeZoneId.INSTANCE);
	}
		...
		public int parseInto(org.joda.time.format.DateTimeParserBucket bucket, java.lang.String text, int position) {
			...
			synchronized(org.joda.time.format.DateTimeFormatterBuilder.TextField.cParseCache) {
				...
				if (array == null) {
					...
					array = new java.lang.Object[]{ validValues , java.lang.Integer.valueOf(maxLength) };
		...
		public int parseInto(org.joda.time.format.DateTimeParserBucket bucket, java.lang.String text, int position) {
			...
			zeroOffset : if ((iZeroOffsetParseText) != null) {
				if ((iZeroOffsetParseText.length()) == 0) {
					...
					bucket.setOffset(java.lang.Integer.valueOf(0));
					return position;
				}
			...
			bucket.setOffset(java.lang.Integer.valueOf((negative ? -offset : offset)));
			return position;
		}
	...
	static class TimeZoneName implements org.joda.time.format.DateTimeParser , org.joda.time.format.DateTimePrinter {
		...
		TimeZoneName(int type, java.util.Map<java.lang.String, org.joda.time.DateTimeZone> parseLookup) {
			super();
			iType = type;
		...
		public int parseInto(org.joda.time.format.DateTimeParserBucket bucket, java.lang.String text, int position) {
			...
			for (java.lang.String name : iParseLookup.keySet()) {
	...
	static enum TimeZoneId implements org.joda.time.format.DateTimeParser , org.joda.time.format.DateTimePrinter {
INSTANCE;
		static final java.util.Set<java.lang.String> ALL_IDS = org.joda.time.DateTimeZone.getAvailableIDs();
		...
		static {
			...
			for (java.lang.String id : org.joda.time.format.DateTimeFormatterBuilder.TimeZoneId.ALL_IDS) {
				max = java.lang.Math.max(max, id.length());
			}
			MAX_LENGTH = max;
		}

		public int estimatePrintedLength() {
			return org.joda.time.format.DateTimeFormatterBuilder.TimeZoneId.MAX_LENGTH;
		}
		...
		public int parseInto(org.joda.time.format.DateTimeParserBucket bucket, java.lang.String text, int position) {
			...
			if (best != null) {
				bucket.setZone(org.joda.time.DateTimeZone.forID(best));
