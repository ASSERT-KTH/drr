...
public final class DateMidnight extends org.joda.time.base.BaseDateTime implements java.io.Serializable , org.joda.time.ReadableDateTime {
	...
	public static org.joda.time.DateMidnight now() {
		return new org.joda.time.DateMidnight();
	}

	public static org.joda.time.DateMidnight now(org.joda.time.DateTimeZone zone) {
		if (zone == null) {
			throw new java.lang.NullPointerException("Zone must not be null");
		}
		return new org.joda.time.DateMidnight(zone);
	}

	public static org.joda.time.DateMidnight now(org.joda.time.Chronology chronology) {
		if (chronology == null) {
			throw new java.lang.NullPointerException("Chronology must not be null");
		}
		return new org.joda.time.DateMidnight(chronology);
	}
