...
public abstract class BasePeriod extends org.joda.time.base.AbstractPeriod implements java.io.Serializable , org.joda.time.ReadablePeriod {
	...
	private static final org.joda.time.ReadablePeriod DUMMY_PERIOD = new org.joda.time.base.AbstractPeriod() {
		public int getValue(int index) {
			return 0;
		}

		public org.joda.time.PeriodType getPeriodType() {
			return org.joda.time.PeriodType.time();
		}
	};
	...
	protected BasePeriod(long duration) {
		super();
		iType = org.joda.time.PeriodType.standard();
		int[] values = org.joda.time.chrono.ISOChronology.getInstanceUTC().get(org.joda.time.base.BasePeriod.DUMMY_PERIOD, duration);
		iValues = new int[8];
		java.lang.System.arraycopy(values, 0, iValues, 4, 4);
	}
