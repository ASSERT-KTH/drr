...
public final class YearMonth extends org.joda.time.base.BasePartial implements java.io.Serializable , org.joda.time.ReadablePartial {
	...
	public static org.joda.time.YearMonth now() {
		return new org.joda.time.YearMonth();
	}

	public static org.joda.time.YearMonth now(org.joda.time.DateTimeZone zone) {
		if (zone == null) {
			throw new java.lang.NullPointerException("Zone must not be null");
		}
		return new org.joda.time.YearMonth(zone);
	}

	public static org.joda.time.YearMonth now(org.joda.time.Chronology chronology) {
		if (chronology == null) {
			throw new java.lang.NullPointerException("Chronology must not be null");
		}
		return new org.joda.time.YearMonth(chronology);
	}

	@org.joda.convert.FromString
	public static org.joda.time.YearMonth parse(java.lang.String str) {
		return org.joda.time.YearMonth.parse(str, org.joda.time.format.ISODateTimeFormat.localDateParser());
	}

	public static org.joda.time.YearMonth parse(java.lang.String str, org.joda.time.format.DateTimeFormatter formatter) {
		org.joda.time.LocalDate date = formatter.parseLocalDate(str);
		return new org.joda.time.YearMonth(date.getYear(), date.getMonthOfYear());
	}
	...
	private java.lang.Object readResolve() {
		if ((org.joda.time.DateTimeZone.UTC.equals(getChronology().getZone())) == false) {
			return new org.joda.time.YearMonth(org.joda.time.YearMonth.this, getChronology().withUTC());
		}
