	...
	public void validate(org.joda.time.ReadablePartial partial, int[] values) {
		...
		for (int i = 0; i < size; i++) {
			...
			if (value < (field.getMinimumValue())) {
				throw new org.joda.time.IllegalFieldValueException(field.getType(), new java.lang.Integer(value), new java.lang.Integer(field.getMinimumValue()), null);
			}
			if (value > (field.getMaximumValue())) {
				throw new org.joda.time.IllegalFieldValueException(field.getType(), new java.lang.Integer(value), null, new java.lang.Integer(field.getMaximumValue()));
			}
		}
		for (int i = 0; i < size; i++) {
			int value = values[i];
			...
			if (value < (field.getMinimumValue(partial, values))) {
				throw new org.joda.time.IllegalFieldValueException(field.getType(), new java.lang.Integer(value), new java.lang.Integer(field.getMinimumValue(partial, values)), null);
			}
			if (value > (field.getMaximumValue(partial, values))) {
				throw new org.joda.time.IllegalFieldValueException(field.getType(), new java.lang.Integer(value), null, new java.lang.Integer(field.getMaximumValue(partial, values)));
			}
		}
	}
