...
public class DateTimeFormatter {
	...
	private DateTimeFormatter(org.joda.time.format.DateTimePrinter printer, org.joda.time.format.DateTimeParser parser, java.util.Locale locale, boolean offsetParsed, org.joda.time.Chronology chrono, org.joda.time.DateTimeZone zone, java.lang.Integer pivotYear) {
		super();
		iPrinter = printer;
		iParser = parser;
		iLocale = locale;
	...
	public org.joda.time.format.DateTimeFormatter withLocale(java.util.Locale locale) {
		...
		return new org.joda.time.format.DateTimeFormatter(iPrinter, iParser, locale, iOffsetParsed, iChrono, iZone, iPivotYear);
	}
	...
	public org.joda.time.format.DateTimeFormatter withOffsetParsed() {
		...
		return new org.joda.time.format.DateTimeFormatter(iPrinter, iParser, iLocale, true, iChrono, null, iPivotYear);
	}
	...
	public org.joda.time.format.DateTimeFormatter withChronology(org.joda.time.Chronology chrono) {
		...
		return new org.joda.time.format.DateTimeFormatter(iPrinter, iParser, iLocale, iOffsetParsed, chrono, iZone, iPivotYear);
	}
	...
	public org.joda.time.format.DateTimeFormatter withZone(org.joda.time.DateTimeZone zone) {
		...
		return new org.joda.time.format.DateTimeFormatter(iPrinter, iParser, iLocale, false, iChrono, zone, iPivotYear);
	}
	...
	public org.joda.time.format.DateTimeFormatter withPivotYear(java.lang.Integer pivotYear) {
		...
		return new org.joda.time.format.DateTimeFormatter(iPrinter, iParser, iLocale, iOffsetParsed, iChrono, iZone, pivotYear);
	}
	...
	public int parseInto(org.joda.time.ReadWritableInstant instant, java.lang.String text, int position) {
		...
		chrono = selectChronology(chrono);
		org.joda.time.format.DateTimeParserBucket bucket = new org.joda.time.format.DateTimeParserBucket(instantLocal, chrono, iLocale, iPivotYear);
	...
	public long parseMillis(java.lang.String text) {
		...
		org.joda.time.format.DateTimeParserBucket bucket = new org.joda.time.format.DateTimeParserBucket(0, chrono, iLocale, iPivotYear);
