			...
			if (instant >= (iCutover)) {
				...
				if (instant < (iCutover)) {
					...
					if ((get(instant)) != value) {
						throw new org.joda.time.IllegalFieldValueException(iGregorianField.getType(), new java.lang.Integer(value), null, null);
					}
				}
			}else {
				...
				if (instant >= (iCutover)) {
					...
					if ((get(instant)) != value) {
						throw new org.joda.time.IllegalFieldValueException(iJulianField.getType(), new java.lang.Integer(value), null, null);
					}
				}
			}
			return instant;
