...
public class FieldUtils {
	...
	public static void verifyValueBounds(org.joda.time.DateTimeField field, int value, int lowerBound, int upperBound) {
		if ((value < lowerBound) || (value > upperBound)) {
			throw new org.joda.time.IllegalFieldValueException(field.getType(), new java.lang.Integer(value), new java.lang.Integer(lowerBound), new java.lang.Integer(upperBound));
		}
	}

	public static void verifyValueBounds(org.joda.time.DateTimeFieldType fieldType, int value, int lowerBound, int upperBound) {
		if ((value < lowerBound) || (value > upperBound)) {
			throw new org.joda.time.IllegalFieldValueException(fieldType, new java.lang.Integer(value), new java.lang.Integer(lowerBound), new java.lang.Integer(upperBound));
		}
	}

	public static void verifyValueBounds(java.lang.String fieldName, int value, int lowerBound, int upperBound) {
		if ((value < lowerBound) || (value > upperBound)) {
			throw new org.joda.time.IllegalFieldValueException(fieldName, new java.lang.Integer(value), new java.lang.Integer(lowerBound), new java.lang.Integer(upperBound));
		}
	}
