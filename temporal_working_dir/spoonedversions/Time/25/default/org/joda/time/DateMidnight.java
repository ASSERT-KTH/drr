...
public final class DateMidnight extends org.joda.time.base.BaseDateTime implements java.io.Serializable , org.joda.time.ReadableDateTime {
	...
	public static org.joda.time.DateMidnight parse(java.lang.String str) {
		return org.joda.time.DateMidnight.parse(str, org.joda.time.format.ISODateTimeFormat.dateTimeParser().withOffsetParsed());
	}

	public static org.joda.time.DateMidnight parse(java.lang.String str, org.joda.time.format.DateTimeFormatter formatter) {
