...
public class DateTimeParserBucket {
	...
	public DateTimeParserBucket(long instantLocal, org.joda.time.Chronology chrono, java.util.Locale locale, java.lang.Integer pivotYear, int defaultYear) {
		super();
	...
	public long computeMillis(boolean resetFields, java.lang.String text) {
		...
		if (count > 0) {
			org.joda.time.DurationField months = org.joda.time.DurationFieldType.months().getField(iChrono);
			org.joda.time.DurationField days = org.joda.time.DurationFieldType.days().getField(iChrono);
			org.joda.time.DurationField first = savedFields[0].iField.getDurationField();
			if (((org.joda.time.format.DateTimeParserBucket.compareReverse(first, months)) >= 0) && ((org.joda.time.format.DateTimeParserBucket.compareReverse(first, days)) <= 0)) {
				saveField(org.joda.time.DateTimeFieldType.year(), iDefaultYear);
	...
	static class SavedField implements java.lang.Comparable<org.joda.time.format.DateTimeParserBucket.SavedField> {
		...
		public int compareTo(org.joda.time.format.DateTimeParserBucket.SavedField obj) {
			...
			int result = org.joda.time.format.DateTimeParserBucket.compareReverse(iField.getRangeDurationField(), other.getRangeDurationField());
			if (result != 0) {
				return result;
			}
			return org.joda.time.format.DateTimeParserBucket.compareReverse(iField.getDurationField(), other.getDurationField());
		}
	}

	static int compareReverse(org.joda.time.DurationField a, org.joda.time.DurationField b) {
