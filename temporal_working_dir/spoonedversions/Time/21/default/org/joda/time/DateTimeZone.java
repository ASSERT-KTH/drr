...
public abstract class DateTimeZone implements java.io.Serializable {
	...
	public long adjustOffset(long instant, boolean earlierOrLater) {
		long before = convertUTCToLocal((instant - (3 * (org.joda.time.DateTimeConstants.MILLIS_PER_HOUR))));
		long after = convertUTCToLocal((instant + (3 * (org.joda.time.DateTimeConstants.MILLIS_PER_HOUR))));
		if (before == after) {
			return instant;
		}
