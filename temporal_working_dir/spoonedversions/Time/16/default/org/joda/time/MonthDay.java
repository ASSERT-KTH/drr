...
public final class MonthDay extends org.joda.time.base.BasePartial implements java.io.Serializable , org.joda.time.ReadablePartial {
	...
	public static org.joda.time.MonthDay now() {
		return new org.joda.time.MonthDay();
	}

	public static org.joda.time.MonthDay now(org.joda.time.DateTimeZone zone) {
		if (zone == null) {
			throw new java.lang.NullPointerException("Zone must not be null");
		}
		return new org.joda.time.MonthDay(zone);
	}

	public static org.joda.time.MonthDay now(org.joda.time.Chronology chronology) {
		if (chronology == null) {
			throw new java.lang.NullPointerException("Chronology must not be null");
		}
		return new org.joda.time.MonthDay(chronology);
	}
