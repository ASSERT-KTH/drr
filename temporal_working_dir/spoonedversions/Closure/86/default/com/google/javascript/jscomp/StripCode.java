...
class StripCode implements com.google.javascript.jscomp.CompilerPass {
	...
	private class Strip extends com.google.javascript.jscomp.NodeTraversal.AbstractPostOrderCallback {
		...
		void eliminateKeysWithStripNamesFromObjLit(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n) {
			...
			while (key != null) {
				if (((key.getType()) != (com.google.javascript.rhino.Token.NUMBER)) && (isStripName(key.getString()))) {
		...
		com.google.javascript.rhino.Node n) {
			return (((n != null) && (((n.getType()) == (com.google.javascript.rhino.Token.CALL)) || ((n.getType()) == (com.google.javascript.rhino.Token.NEW)))) && (n.hasChildren())) && ((qualifiedNameBeginsWithStripType(n.getFirstChild())) || (nameEndsWithFieldNameToStrip(n.getFirstChild())));
		}
		...
		boolean isMethodOrCtorCallThatTriggersRemoval(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
			...
			if ((function == null) || ((function.getType()) != (com.google.javascript.rhino.Token.GETPROP))) {
				return false;
			}
			if ((parent != null) && ((parent.getType()) == (com.google.javascript.rhino.Token.NAME))) {
				com.google.javascript.rhino.Node gramps = parent.getParent();
				if ((gramps != null) && ((gramps.getType()) == (com.google.javascript.rhino.Token.VAR))) {
					return false;
				}
			}
		...
		com.google.javascript.rhino.Node n) {
			if ((n != null) && ((n.getType()) == (com.google.javascript.rhino.Token.GETPROP))) {
				com.google.javascript.rhino.Node propNode = n.getLastChild();
				return ((propNode != null) && ((propNode.getType()) == (com.google.javascript.rhino.Token.STRING))) && (isStripName(propNode.getString()));
			}
			return false;
		}
