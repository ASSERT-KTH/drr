...
final class RenameVars implements com.google.javascript.jscomp.CompilerPass {
	...
	class Assignment {
		...
		Assignment(java.lang.String name, com.google.javascript.jscomp.CompilerInput input) {
			this.input = input;
			this.oldName = name;
	...
	private static final java.lang.String LOCAL_VAR_PREFIX = "L ";

	RenameVars(com.google.javascript.jscomp.AbstractCompiler compiler, java.lang.String prefix, boolean localRenamingOnly, boolean preserveFunctionExpressionNames, boolean generatePseudoNames, com.google.javascript.jscomp.VariableMap prevUsedRenameMap, @javax.annotation.Nullable
	...
	class ProcessVars extends com.google.javascript.jscomp.NodeTraversal.AbstractPostOrderCallback {
		...
		public void visit(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
			...
			if (local) {
				java.lang.String tempName = (com.google.javascript.jscomp.RenameVars.LOCAL_VAR_PREFIX) + (var.getLocalVarIndex());
		...
		void incCount(java.lang.String name, com.google.javascript.jscomp.CompilerInput input) {
			com.google.javascript.jscomp.RenameVars.Assignment s = assignments.get(name);
			if (s == null) {
				s = new com.google.javascript.jscomp.RenameVars.Assignment(name, input);
