...
DIRECT, BLOCK;	}
	...
	boolean doesFunctionMeetMinimumRequirements(java.lang.String fnName, com.google.javascript.rhino.Node fnNode) {
		com.google.javascript.rhino.Node block = com.google.javascript.jscomp.NodeUtil.getFunctionBody(fnNode);
		if (com.google.javascript.jscomp.NodeUtil.isNameReferenced(block, fnName)) {
			return false;
		}
		java.lang.String fnRecursionName = fnNode.getFirstChild().getString();
		if ((((fnRecursionName != null) && (!(fnRecursionName.isEmpty()))) && (!(fnRecursionName.equals(fnName)))) && (com.google.javascript.jscomp.NodeUtil.isNameReferenced(block, fnRecursionName))) {
			return false;
		}
		if (com.google.javascript.jscomp.NodeUtil.isNameReferenced(block, "arguments")) {
			return false;
		}
		return true;
	}
