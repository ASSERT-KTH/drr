...
public class DiagnosticGroups {
	...
	static final java.lang.String DIAGNOSTIC_GROUP_NAMES = "accessControls, ambiguousFunctionDecl, checkRegExp, " + (((((("checkTypes, checkVars, constantProperty, deprecated, " + "duplicateMessage, ") + "es5Strict, externsValidation, fileoverviewTags, globalThis, ") + "internetExplorerChecks, invalidCasts, missingProperties, ") + "nonStandardJsDocs, strictModuleDepCheck, typeInvalidation, ") + "undefinedNames, undefinedVars, unknownDefines, uselessCode, ") + "visibility");
	...
	public static com.google.javascript.jscomp.DiagnosticGroup UNDEFINED_NAMES = com.google.javascript.jscomp.DiagnosticGroups.registerGroup("undefinedNames", com.google.javascript.jscomp.CheckGlobalNames.UNDEFINED_NAME_WARNING);
