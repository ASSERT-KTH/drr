...
class ReplaceIdGenerators implements com.google.javascript.jscomp.CompilerPass {
	...
	public ReplaceIdGenerators(com.google.javascript.jscomp.AbstractCompiler compiler, java.util.Set<java.lang.String> idGens, boolean generatePseudoNames) {
	...
	private static class ObfuscatedNameSuppier implements com.google.javascript.jscomp.ReplaceIdGenerators.NameSupplier {
		private final com.google.javascript.jscomp.NameGenerator generator = new com.google.javascript.jscomp.NameGenerator(java.util.Collections.<java.lang.String>emptySet(), "", null);
	...
	private com.google.javascript.jscomp.ReplaceIdGenerators.NameSupplier createNameSupplier() {
		if (generatePseudoNames) {
			return new com.google.javascript.jscomp.ReplaceIdGenerators.PseudoNameSuppier();
		}else {
			return new com.google.javascript.jscomp.ReplaceIdGenerators.ObfuscatedNameSuppier();
		}
	}
