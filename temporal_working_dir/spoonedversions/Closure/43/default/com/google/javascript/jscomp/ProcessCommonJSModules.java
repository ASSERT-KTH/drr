...
class ProcessCommonJSModules implements com.google.javascript.jscomp.CompilerPass {
	...
	private java.lang.String guessCJSModuleName(java.lang.String filename) {
	...
	public static java.lang.String toModuleName(java.lang.String filename) {
		return (com.google.javascript.jscomp.ProcessCommonJSModules.MODULE_NAME_PREFIX) + (filename.replaceAll("^\\./", "").replaceAll("/", "\\$").replaceAll("\\.js$", "").replaceAll("-", "_"));
	}
	...
	private class SuffixVarsCallback extends com.google.javascript.jscomp.NodeTraversal.AbstractPostOrderCallback {
		...
		public SuffixVarsCallback(java.lang.String suffix) {
			this.suffix = suffix;
		}
