...
abstract class AbstractCommandLineRunner<A extends com.google.javascript.jscomp.Compiler, B extends com.google.javascript.jscomp.CompilerOptions> {
	...
	private java.lang.String expandManifest(com.google.javascript.jscomp.JSModule forModule, java.lang.String manifestName) {
	...
	private boolean shouldGenerateManifestPerModule(java.lang.String outputManifest) {
		return ((!(config.module.isEmpty())) && (outputManifest != null)) && (outputManifest.contains("%outname%"));
	}

	private void outputManifest() throws java.io.IOException {
		java.util.List<java.lang.String> outputManifests = config.outputManifests;
		if (outputManifests.isEmpty()) {
			return ;
		}
		for (java.lang.String outputManifest : outputManifests) {
			...
			if (shouldGenerateManifestPerModule(outputManifest)) {
				...
				for (com.google.javascript.jscomp.JSModule module : modules) {
					java.io.Writer out = fileNameToOutputWriter(expandManifest(module, outputManifest));
					printManifestTo(module.getInputs(), out);
					out.close();
				}
			}else {
				java.io.Writer out = fileNameToOutputWriter(expandManifest(null, outputManifest));
				if (graph == null) {
