...
class VerboseMessageFormatter extends com.google.javascript.jscomp.AbstractMessageFormatter {
	...
	private java.lang.String format(com.google.javascript.jscomp.JSError message) {
		...
		return java.lang.String.format("%s at %s line %s %s", description, (com.google.common.base.Strings.isNullOrEmpty(sourceName) ? "(unknown source)" : sourceName), (lineNumber < 0 ? java.lang.String.valueOf(lineNumber) : "(unknown line)"), (lineSource != null ? ":\n\n" + lineSource : "."));
	}
}
