...
public class EnumType extends com.google.javascript.rhino.jstype.PrototypeObjectType {
	...
	EnumType(com.google.javascript.rhino.jstype.JSTypeRegistry registry, java.lang.String name, com.google.javascript.rhino.Node source, com.google.javascript.rhino.jstype.JSType elementsType) {
	...
	public com.google.javascript.rhino.jstype.EnumType toMaybeEnumType() {
		return com.google.javascript.rhino.jstype.EnumType.this;
	}
	...
	public boolean isSubtype(com.google.javascript.rhino.jstype.JSType that) {
		return ((that.isEquivalentTo(getNativeType(com.google.javascript.rhino.jstype.JSTypeNative.OBJECT_TYPE))) || (that.isEquivalentTo(getNativeType(com.google.javascript.rhino.jstype.JSTypeNative.OBJECT_PROTOTYPE)))) || (com.google.javascript.rhino.jstype.JSType.isSubtypeHelper(com.google.javascript.rhino.jstype.EnumType.this, that));
	}
