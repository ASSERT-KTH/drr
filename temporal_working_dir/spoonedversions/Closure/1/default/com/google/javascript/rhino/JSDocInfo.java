...
PRIVATE, PROTECTED, PUBLIC, INHERITED;	}
	...
	private static final class LazilyInitializedInfo implements java.io.Serializable {
		...
		java.util.List<com.google.javascript.rhino.JSTypeExpression> extendedInterfaces = null;
		...
		com.google.common.collect.ImmutableList<java.lang.String> templateTypeNames = null;
	...
	private static final class LazilyInitializedDocumentation {
		java.lang.String sourceComment = null;
	...
	static class TrimmedStringPosition extends com.google.javascript.rhino.JSDocInfo.StringPosition {
		@java.lang.Override
		public void setItem(java.lang.String item) {
			com.google.common.base.Preconditions.checkArgument((((item.charAt(0)) != ' ') && ((item.charAt(((item.length()) - 1))) != ' ')), "String has leading or trailing whitespace");
			super.setItem(item);
		}
	}

	public static class NamePosition extends com.google.javascript.rhino.SourcePosition<com.google.javascript.rhino.Node> {	}
	...
	public static final class Marker {
		private com.google.javascript.rhino.JSDocInfo.TrimmedStringPosition annotation = null;

		private com.google.javascript.rhino.JSDocInfo.TrimmedStringPosition name = null;

		private com.google.javascript.rhino.SourcePosition<com.google.javascript.rhino.Node> nameNode = null;

		private com.google.javascript.rhino.JSDocInfo.StringPosition description = null;

		private com.google.javascript.rhino.JSDocInfo.TypePosition type = null;

		public com.google.javascript.rhino.JSDocInfo.StringPosition getAnnotation() {
			return annotation;
		}

		void setAnnotation(com.google.javascript.rhino.JSDocInfo.TrimmedStringPosition p) {
			annotation = p;
		}
		...
		void setName(com.google.javascript.rhino.JSDocInfo.TrimmedStringPosition p) {
			name = p;
		}

		public com.google.javascript.rhino.SourcePosition<com.google.javascript.rhino.Node> getNameNode() {
			return nameNode;
		}

		void setNameNode(com.google.javascript.rhino.SourcePosition<com.google.javascript.rhino.Node> p) {
			nameNode = p;
		}
		...
		void setDescription(com.google.javascript.rhino.JSDocInfo.StringPosition p) {
			description = p;
		}
		...
		void setType(com.google.javascript.rhino.JSDocInfo.TypePosition p) {
			type = p;
		}
	}
	...
	private com.google.javascript.rhino.Node associatedNode = null;
	...
	void setConsistentIdGenerator(boolean value) {
		setFlag(value, com.google.javascript.rhino.JSDocInfo.MASK_CONSISTIDGEN);
	}

	void setStableIdGenerator(boolean value) {
		setFlag(value, com.google.javascript.rhino.JSDocInfo.MASK_STALBEIDGEN);
	}
	...
	void setStruct() {
		setFlag(true, com.google.javascript.rhino.JSDocInfo.MASK_STRUCT);
	}

	void setDict() {
		setFlag(true, com.google.javascript.rhino.JSDocInfo.MASK_DICT);
	}
	...
	void setExpose(boolean value) {
		setFlag(value, com.google.javascript.rhino.JSDocInfo.MASK_EXPOSE);
	}
	...
	void setIdGenerator(boolean value) {
		setFlag(value, com.google.javascript.rhino.JSDocInfo.MASK_IDGEN);
	}
	...
	public boolean isConsistentIdGenerator() {
		return getFlag(com.google.javascript.rhino.JSDocInfo.MASK_CONSISTIDGEN);
	}

	public boolean isStableIdGenerator() {
		return getFlag(com.google.javascript.rhino.JSDocInfo.MASK_STALBEIDGEN);
	}
	...
	public boolean makesStructs() {
		return getFlag(com.google.javascript.rhino.JSDocInfo.MASK_STRUCT);
	}

	public boolean makesDicts() {
		return getFlag(com.google.javascript.rhino.JSDocInfo.MASK_DICT);
	}
	...
	public boolean isExpose() {
		return getFlag(com.google.javascript.rhino.JSDocInfo.MASK_EXPOSE);
	}
	...
	public boolean isIdGenerator() {
		return getFlag(com.google.javascript.rhino.JSDocInfo.MASK_IDGEN);
	}
	...
	boolean declareTemplateTypeNames(java.util.List<java.lang.String> templateTypeNames) {
		lazyInitInfo();
		if ((info.templateTypeNames) != null) {
			return false;
		}
		info.templateTypeNames = com.google.common.collect.ImmutableList.copyOf(templateTypeNames);
		return true;
	}
	...
	boolean addExtendedInterface(com.google.javascript.rhino.JSTypeExpression type) {
		lazyInitInfo();
		if ((info.extendedInterfaces) == null) {
			info.extendedInterfaces = com.google.common.collect.Lists.newArrayListWithCapacity(2);
		}
	...
	public java.util.List<com.google.javascript.rhino.JSTypeExpression> getExtendedInterfaces() {
		if (((info) == null) || ((info.extendedInterfaces) == null)) {
			return com.google.common.collect.ImmutableList.of();
		}
		return java.util.Collections.unmodifiableList(info.extendedInterfaces);
	}
	...
	public com.google.javascript.rhino.Node getAssociatedNode() {
		return com.google.javascript.rhino.JSDocInfo.this.associatedNode;
	}

	public void setAssociatedNode(com.google.javascript.rhino.Node node) {
		com.google.javascript.rhino.JSDocInfo.this.associatedNode = node;
	}

	public java.lang.String getSourceName() {
		return (com.google.javascript.rhino.JSDocInfo.this.associatedNode) != null ? com.google.javascript.rhino.JSDocInfo.this.associatedNode.getSourceFileName() : null;
	}

	public java.util.Collection<com.google.javascript.rhino.JSDocInfo.Marker> getMarkers() {
		return ((documentation) == null) || ((documentation.markers) == null) ? com.google.common.collect.ImmutableList.<com.google.javascript.rhino.JSDocInfo.Marker>of() : documentation.markers;
	}
	...
	public java.util.Collection<com.google.javascript.rhino.Node> getTypeNodes() {
		...
		if ((info) != null) {
			...
			if ((info.extendedInterfaces) != null) {
				for (com.google.javascript.rhino.JSTypeExpression interfaceType : info.extendedInterfaces) {
