...
public class DiagnosticGroups {
	...
	static final java.lang.String DIAGNOSTIC_GROUP_NAMES = "accessControls, ambiguousFunctionDecl, checkRegExp," + ((((("checkTypes, checkVars, constantProperty, deprecated, " + "externsValidation, fileoverviewTags, globalThis, ") + "internetExplorerChecks, invalidCasts, missingProperties, ") + "nonStandardJsDocs, strictModuleDepCheck, typeInvalidation, ") + "undefinedVars, unknownDefines, uselessCode, ") + "visibility");
	...
	public static com.google.javascript.jscomp.DiagnosticGroup CONSTANT_PROPERTY = com.google.javascript.jscomp.DiagnosticGroups.registerGroup("constantProperty", com.google.javascript.jscomp.CheckAccessControls.CONST_PROPERTY_REASSIGNED_VALUE);
	...
	public static com.google.javascript.jscomp.DiagnosticGroup CONST = com.google.javascript.jscomp.DiagnosticGroups.registerGroup("const", com.google.javascript.jscomp.CheckAccessControls.CONST_PROPERTY_REASSIGNED_VALUE, com.google.javascript.jscomp.ConstCheck.CONST_REASSIGNED_VALUE_ERROR);
