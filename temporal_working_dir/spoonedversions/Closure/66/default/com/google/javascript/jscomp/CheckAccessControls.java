...
class CheckAccessControls implements com.google.javascript.jscomp.HotSwapCompilerPass , com.google.javascript.jscomp.NodeTraversal.ScopedCallback {
	...
	private void checkConstantProperty(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node getprop) {
		...
		if (((!((com.google.javascript.jscomp.NodeUtil.isAssignmentOp(parent)) && ((parent.getFirstChild()) == getprop))) && ((parent.getType()) != (com.google.javascript.rhino.Token.INC))) && ((parent.getType()) != (com.google.javascript.rhino.Token.DEC))) {
			return ;
		}
		...
		if (objectType != null) {
			...
			com.google.javascript.rhino.JSDocInfo info = objectType.getOwnPropertyJSDocInfo(propertyName);
			...
			if (objectType.isInstanceType()) {
				...
				if (prototype != null) {
					com.google.javascript.rhino.JSDocInfo prototypeInfo = prototype.getOwnPropertyJSDocInfo(propertyName);
	...
	private void checkPropertyVisibility(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node getprop, com.google.javascript.rhino.Node parent) {
		...
		java.lang.String propertyName = getprop.getLastChild().getString();
		if (objectType != null) {
			boolean isOverride = (((parent.getJSDocInfo()) != null) && ((parent.getType()) == (com.google.javascript.rhino.Token.ASSIGN))) && ((parent.getFirstChild()) == getprop);
			if (isOverride) {
