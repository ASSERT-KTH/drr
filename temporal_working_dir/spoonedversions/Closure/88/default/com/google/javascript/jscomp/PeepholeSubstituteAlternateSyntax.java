...
public class PeepholeSubstituteAlternateSyntax extends com.google.javascript.jscomp.AbstractPeepholeOptimization {
	...
	private boolean isExpressBlock(com.google.javascript.rhino.Node n) {
		if ((n.getType()) == (com.google.javascript.rhino.Token.BLOCK)) {
			if (n.hasOneChild()) {
				return com.google.javascript.jscomp.NodeUtil.isExpressionNode(n.getFirstChild());
			}
		}
		return false;
	}
	...
	private com.google.javascript.rhino.Node getBlockExpression(com.google.javascript.rhino.Node n) {
		com.google.common.base.Preconditions.checkState(isExpressBlock(n));
