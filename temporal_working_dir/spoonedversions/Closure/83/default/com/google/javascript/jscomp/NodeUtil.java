...
public final class NodeUtil {
	...
	static com.google.javascript.rhino.jstype.TernaryValue getExpressionBooleanValue(com.google.javascript.rhino.Node n) {
		switch (n.getType()) {
			case com.google.javascript.rhino.Token.ASSIGN :
			case com.google.javascript.rhino.Token.COMMA :
				return com.google.javascript.jscomp.NodeUtil.getExpressionBooleanValue(n.getLastChild());
			case com.google.javascript.rhino.Token.NOT :
				com.google.javascript.rhino.jstype.TernaryValue value = com.google.javascript.jscomp.NodeUtil.getExpressionBooleanValue(n.getLastChild());
				return value.not();
			case com.google.javascript.rhino.Token.AND :
				{
					com.google.javascript.rhino.jstype.TernaryValue lhs = com.google.javascript.jscomp.NodeUtil.getExpressionBooleanValue(n.getFirstChild());
					com.google.javascript.rhino.jstype.TernaryValue rhs = com.google.javascript.jscomp.NodeUtil.getExpressionBooleanValue(n.getLastChild());
					return lhs.and(rhs);
				}
			...
			case com.google.javascript.rhino.Token.HOOK :
				{
					com.google.javascript.rhino.jstype.TernaryValue trueValue = com.google.javascript.jscomp.NodeUtil.getExpressionBooleanValue(n.getFirstChild().getNext());
					com.google.javascript.rhino.jstype.TernaryValue falseValue = com.google.javascript.jscomp.NodeUtil.getExpressionBooleanValue(n.getLastChild());
			...
			default :
				return com.google.javascript.jscomp.NodeUtil.getBooleanValue(n);
		}
	}

	static com.google.javascript.rhino.jstype.TernaryValue getBooleanValue(com.google.javascript.rhino.Node n) {
		switch (n.getType()) {
	...
	static java.lang.Double getNumberValue(com.google.javascript.rhino.Node n) {
		switch (n.getType()) {
			...
			case com.google.javascript.rhino.Token.NEG :
				...
				return null;
			case com.google.javascript.rhino.Token.STRING :
				java.lang.String s = com.google.javascript.jscomp.NodeUtil.trimJsWhiteSpace(n.getString());
				if ((s.length()) == 0) {
					return 0.0;
				}
	...
	static java.lang.String trimJsWhiteSpace(java.lang.String s) {
		int start = 0;
		int end = s.length();
		while ((end > 0) && (com.google.javascript.jscomp.NodeUtil.isStrWhiteSpaceChar(s.charAt((end - 1))))) {
			end--;
		} 
		while ((start < end) && (com.google.javascript.jscomp.NodeUtil.isStrWhiteSpaceChar(s.charAt(start)))) {
			start++;
		} 
	...
	static boolean isStrWhiteSpaceChar(int c) {
		switch (c) {
			...
			case '\ufeff' :
				return true;
			default :
				return (java.lang.Character.getType(c)) == (java.lang.Character.SPACE_SEPARATOR);
		}
	}
	...
	static java.lang.String getNearestFunctionName(com.google.javascript.rhino.Node n) {
	...
	static boolean referencesThis(com.google.javascript.rhino.Node n) {
		return com.google.javascript.jscomp.NodeUtil.containsType(n, com.google.javascript.rhino.Token.THIS, new com.google.javascript.jscomp.NodeUtil.MatchNotFunction());
	}
	...
	static boolean isVarArgsFunction(com.google.javascript.rhino.Node function) {
		...
		return com.google.javascript.jscomp.NodeUtil.isNameReferenced(function.getLastChild(), "arguments", new com.google.javascript.jscomp.NodeUtil.MatchNotFunction());
	}
	...
	public static java.util.Collection<com.google.javascript.rhino.Node> getVarsDeclaredInBranch(com.google.javascript.rhino.Node root) {
		...
		com.google.javascript.jscomp.NodeUtil.visitPreOrder(root, collector, new com.google.javascript.jscomp.NodeUtil.MatchNotFunction());
	...
	static com.google.javascript.rhino.JSDocInfo getFunctionInfo(com.google.javascript.rhino.Node n) {
	...
	static com.google.javascript.rhino.Node newCallNode(com.google.javascript.rhino.Node callTarget, com.google.javascript.rhino.Node... parameters) {
		boolean isFreeCall = com.google.javascript.jscomp.NodeUtil.isName(callTarget);
