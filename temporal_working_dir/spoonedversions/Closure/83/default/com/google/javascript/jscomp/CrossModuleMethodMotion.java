		...
		for (com.google.javascript.jscomp.AnalyzePrototypeProperties.NameInfo nameInfo : allNameInfo) {
			...
			while (declarations.hasNext()) {
				...
				if ((moduleGraph.dependsOn(deepestCommonModuleRef, prop.getModule())) && ((value.getType()) == (com.google.javascript.rhino.Token.FUNCTION))) {
					...
					valueParent.replaceChild(value, new com.google.javascript.rhino.Node(com.google.javascript.rhino.Token.CALL, com.google.javascript.rhino.Node.newString(com.google.javascript.rhino.Token.NAME, com.google.javascript.jscomp.CrossModuleMethodMotion.STUB_METHOD_NAME), com.google.javascript.rhino.Node.newNumber(stubId)).copyInformationFromForTree(value));
					com.google.javascript.rhino.Node unstubParent = compiler.getNodeForCodeInsertion(deepestCommonModuleRef);
					unstubParent.addChildToFront(new com.google.javascript.rhino.Node(com.google.javascript.rhino.Token.EXPR_RESULT, new com.google.javascript.rhino.Node(com.google.javascript.rhino.Token.ASSIGN, new com.google.javascript.rhino.Node(com.google.javascript.rhino.Token.GETPROP, proto.cloneTree(), com.google.javascript.rhino.Node.newString(com.google.javascript.rhino.Token.STRING, nameInfo.name)), new com.google.javascript.rhino.Node(com.google.javascript.rhino.Token.CALL, com.google.javascript.rhino.Node.newString(com.google.javascript.rhino.Token.NAME, com.google.javascript.jscomp.CrossModuleMethodMotion.UNSTUB_METHOD_NAME), com.google.javascript.rhino.Node.newNumber(stubId), value))).copyInformationFromForTree(value));
