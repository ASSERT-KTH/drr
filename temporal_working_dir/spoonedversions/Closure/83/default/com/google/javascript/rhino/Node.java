...
public class Node implements java.io.Serializable , java.lang.Cloneable {
	...
	private static class NumberNode extends com.google.javascript.rhino.Node {
		...
		public boolean isEquivalentTo(com.google.javascript.rhino.Node node) {
			return (node instanceof com.google.javascript.rhino.Node.NumberNode) && ((getDouble()) == (((com.google.javascript.rhino.Node.NumberNode) (node)).getDouble()));
		}
	...
	private static class StringNode extends com.google.javascript.rhino.Node {
		...
		@java.lang.Override
		public boolean isEquivalentTo(com.google.javascript.rhino.Node node) {
			return (node instanceof com.google.javascript.rhino.Node.StringNode) && (com.google.javascript.rhino.Node.StringNode.this.str.equals(((com.google.javascript.rhino.Node.StringNode) (node)).str));
		}
	...
	public boolean checkTreeEqualsSilent(com.google.javascript.rhino.Node node2) {
	...
	com.google.javascript.rhino.Node.NodeMismatch checkTreeEqualsImpl(com.google.javascript.rhino.Node node2) {
		boolean eq = false;
		if ((((type) == (node2.getType())) && ((getChildCount()) == (node2.getChildCount()))) && ((com.google.javascript.rhino.Node.getNodeClass(com.google.javascript.rhino.Node.this)) == (com.google.javascript.rhino.Node.getNodeClass(node2)))) {
			eq = com.google.javascript.rhino.Node.this.isEquivalentTo(node2);
		}
		if (!eq) {
	...
	public boolean checkTreeTypeAwareEqualsSilent(com.google.javascript.rhino.Node node2) {
	...
	com.google.javascript.rhino.Node.NodeMismatch checkTreeTypeAwareEqualsImpl(com.google.javascript.rhino.Node node2) {
		boolean eq = false;
		if (((((type) == (node2.getType())) && ((getChildCount()) == (node2.getChildCount()))) && ((getClass()) == (node2.getClass()))) && (com.google.javascript.rhino.jstype.JSType.isEquivalent(jsType, node2.getJSType()))) {
			eq = com.google.javascript.rhino.Node.this.isEquivalentTo(node2);
		}
		if (!eq) {
			return new com.google.javascript.rhino.Node.NodeMismatch(com.google.javascript.rhino.Node.this, node2);
