...
class StrictModeCheck extends com.google.javascript.jscomp.NodeTraversal.AbstractPostOrderCallback implements com.google.javascript.jscomp.CompilerPass {
	static final com.google.javascript.jscomp.DiagnosticType UNKNOWN_VARIABLE = com.google.javascript.jscomp.DiagnosticType.error("JSC_UNKNOWN_VARIABLE", "unknown variable {0}");

	static final com.google.javascript.jscomp.DiagnosticType WITH_DISALLOWED = com.google.javascript.jscomp.DiagnosticType.error("JSC_WITH_DISALLOWED", "\"with\" cannot be used in ES5 strict mode");
	...
	static final com.google.javascript.jscomp.DiagnosticType EVAL_DECLARATION = com.google.javascript.jscomp.DiagnosticType.error("JSC_EVAL_DECLARATION", "\"eval\" cannot be redeclared in ES5 strict mode");

	static final com.google.javascript.jscomp.DiagnosticType EVAL_ASSIGNMENT = com.google.javascript.jscomp.DiagnosticType.error("JSC_EVAL_ASSIGNMENT", "the \"eval\" object cannot be reassigned in ES5 strict mode");

	static final com.google.javascript.jscomp.DiagnosticType ARGUMENTS_DECLARATION = com.google.javascript.jscomp.DiagnosticType.error("JSC_ARGUMENTS_DECLARATION", "\"arguments\" cannot be redeclared in ES5 strict mode");

	static final com.google.javascript.jscomp.DiagnosticType ARGUMENTS_ASSIGNMENT = com.google.javascript.jscomp.DiagnosticType.error("JSC_ARGUMENTS_ASSIGNMENT", "the \"arguments\" object cannot be reassigned in ES5 strict mode");

	static final com.google.javascript.jscomp.DiagnosticType DELETE_VARIABLE = com.google.javascript.jscomp.DiagnosticType.error("JSC_DELETE_VARIABLE", ("variables, functions, and arguments cannot be deleted in " + "ES5 strict mode"));
	...
	static final com.google.javascript.jscomp.DiagnosticType DUPLICATE_OBJECT_KEY = com.google.javascript.jscomp.DiagnosticType.error("JSC_DUPLICATE_OBJECT_KEY", "object literals cannot contain duplicate keys in ES5 strict mode");
