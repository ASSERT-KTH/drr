...
class ReplaceMessages extends com.google.javascript.jscomp.JsMessageVisitor {
	...
	static final com.google.javascript.jscomp.DiagnosticType BUNDLE_DOES_NOT_HAVE_THE_MESSAGE = com.google.javascript.jscomp.DiagnosticType.error("JSC_BUNDLE_DOES_NOT_HAVE_THE_MESSAGE", "Message with id = {0} cound not be found in replacement bundle");
	...
	private com.google.javascript.rhino.Node getNewValueNode(com.google.javascript.jscomp.JsMessage message, com.google.javascript.rhino.Node origValueNode) throws com.google.javascript.jscomp.JsMessageVisitor.MalformedException {
		switch (origValueNode.getType()) {
			...
			case com.google.javascript.rhino.Token.ADD :
				return com.google.javascript.rhino.Node.newString(message.toString());
	...
	private void updateFunctionNode(com.google.javascript.jscomp.JsMessage message, com.google.javascript.rhino.Node functionNode) throws com.google.javascript.jscomp.JsMessageVisitor.MalformedException {
		...
		checkNode(argListNode, com.google.javascript.rhino.Token.LP);
		...
		com.google.javascript.rhino.Node valueNode = iterator.hasNext() ? constructAddOrStringNode(iterator, argListNode) : com.google.javascript.rhino.Node.newString("");
		com.google.javascript.rhino.Node newBlockNode = new com.google.javascript.rhino.Node(com.google.javascript.rhino.Token.BLOCK, new com.google.javascript.rhino.Node(com.google.javascript.rhino.Token.RETURN, valueNode));
	...
	private com.google.javascript.rhino.Node constructAddOrStringNode(java.util.Iterator<java.lang.CharSequence> partsIterator, com.google.javascript.rhino.Node argListNode) throws com.google.javascript.jscomp.JsMessageVisitor.MalformedException {
		...
		if (part instanceof com.google.javascript.jscomp.JsMessage.PlaceholderReference) {
			...
			for (com.google.javascript.rhino.Node node : argListNode.children()) {
				if ((node.getType()) == (com.google.javascript.rhino.Token.NAME)) {
					...
					if (arg.equalsIgnoreCase(phRef.getName())) {
						partNode = com.google.javascript.rhino.Node.newString(com.google.javascript.rhino.Token.NAME, arg);
					}
				}
			}
			if (partNode == null) {
			...
			partNode = com.google.javascript.rhino.Node.newString(part.toString());
		}
		if (partsIterator.hasNext()) {
			return new com.google.javascript.rhino.Node(com.google.javascript.rhino.Token.ADD, partNode, constructAddOrStringNode(partsIterator, argListNode));
		}else {
			return partNode;
		}
	}
	...
	private com.google.javascript.rhino.Node constructStringExprNode(java.util.Iterator<java.lang.CharSequence> parts, com.google.javascript.rhino.Node objLitNode) throws com.google.javascript.jscomp.JsMessageVisitor.MalformedException {
		...
		if (parts.hasNext()) {
			return new com.google.javascript.rhino.Node(com.google.javascript.rhino.Token.ADD, partNode, constructStringExprNode(parts, objLitNode));
		}else {
			return partNode;
		}
	}
