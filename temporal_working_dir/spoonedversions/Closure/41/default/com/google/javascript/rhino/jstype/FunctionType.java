...
ORDINARY, CONSTRUCTOR, INTERFACE;	}
	...
	private void appendArgString(java.lang.StringBuilder b, com.google.javascript.rhino.Node p) {
		if (p.isVarArgs()) {
	...
	private void appendOptionalArgString(java.lang.StringBuilder builder, com.google.javascript.rhino.jstype.JSType paramType) {
		if (paramType.isUnionType()) {
			paramType = paramType.toMaybeUnionType().getRestrictedUnion(registry.getNativeType(com.google.javascript.rhino.jstype.JSTypeNative.VOID_TYPE));
		}
