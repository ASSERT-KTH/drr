...
class GenerateExports implements com.google.javascript.jscomp.CompilerPass {
	...
	public void process(com.google.javascript.rhino.Node externs, com.google.javascript.rhino.Node root) {
		...
		for (java.util.Map.Entry<java.lang.String, com.google.javascript.jscomp.FindExportableNodes.GenerateNodeContext> entry : exports.entrySet()) {
			...
			if (useExportSymbol) {
				call = com.google.javascript.rhino.IR.call(com.google.javascript.jscomp.NodeUtil.newQualifiedNameNode(compiler.getCodingConvention(), exportSymbolFunction, context.getNode(), export), com.google.javascript.rhino.IR.string(export), com.google.javascript.jscomp.NodeUtil.newQualifiedNameNode(compiler.getCodingConvention(), export, context.getNode(), export));
			}else {
				java.lang.String property = getPropertyName(node);
				call = com.google.javascript.rhino.IR.call(com.google.javascript.jscomp.NodeUtil.newQualifiedNameNode(compiler.getCodingConvention(), exportPropertyFunction, context.getNode(), exportPropertyFunction), com.google.javascript.jscomp.NodeUtil.newQualifiedNameNode(compiler.getCodingConvention(), parent, context.getNode(), exportPropertyFunction), com.google.javascript.rhino.IR.string(property), com.google.javascript.jscomp.NodeUtil.newQualifiedNameNode(compiler.getCodingConvention(), export, context.getNode(), exportPropertyFunction));
			}
