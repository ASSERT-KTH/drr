...
final class FunctionTypeBuilder {
	...
	private com.google.common.collect.ImmutableList<java.lang.String> classTypeParameterNames = com.google.common.collect.ImmutableList.of();
	...
	static final com.google.javascript.jscomp.DiagnosticType CLASS_TEMPLATE_WITHOUT_CONSTRUCTOR = com.google.javascript.jscomp.DiagnosticType.warning("JSC_CLASS_TEMPLATE_WITHOUT_CONSTRUCTOR", "@classTemplate used without @constructor or @interface for {0}");
	...
	com.google.javascript.rhino.JSDocInfo info) {
		if (info != null) {
			...
			com.google.common.collect.ImmutableList<java.lang.String> typeParameters = info.getClassTemplateTypeNames();
			if (!(typeParameters.isEmpty())) {
				if ((isConstructor) || (isInterface)) {
					com.google.javascript.jscomp.FunctionTypeBuilder.this.classTypeParameterNames = typeParameters;
				}else {
					reportWarning(com.google.javascript.jscomp.FunctionTypeBuilder.CLASS_TEMPLATE_WITHOUT_CONSTRUCTOR, formatFnName());
				}
			}
		}
		return com.google.javascript.jscomp.FunctionTypeBuilder.this;
	...
	com.google.javascript.rhino.JSDocInfo info) {
		...
		for (com.google.javascript.rhino.Node arg : argsParent.children()) {
			...
			if ((info != null) && (info.hasParameterType(argumentName))) {
				...
				if (((arg.getJSDocInfo()) != null) && (arg.getJSDocInfo().hasType())) {
	...
	private com.google.javascript.rhino.jstype.FunctionType getOrCreateConstructor() {
		com.google.javascript.rhino.jstype.FunctionType fnType = typeRegistry.createConstructorType(fnName, contents.getSourceNode(), parametersNode, returnType, classTypeParameterNames);
