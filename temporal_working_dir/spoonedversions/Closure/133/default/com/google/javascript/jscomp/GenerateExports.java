...
class GenerateExports implements com.google.javascript.jscomp.CompilerPass {
	...
	public void process(com.google.javascript.rhino.Node externs, com.google.javascript.rhino.Node root) {
		...
		for (java.util.Map.Entry<java.lang.String, com.google.javascript.jscomp.FindExportableNodes.GenerateNodeContext> entry : exports.entrySet()) {
			...
			if (useExportSymbol) {
				call = com.google.javascript.rhino.IR.call(com.google.javascript.jscomp.NodeUtil.newQualifiedNameNode(convention, exportSymbolFunction, context.getNode(), export), com.google.javascript.rhino.IR.string(export), com.google.javascript.jscomp.NodeUtil.newQualifiedNameNode(convention, export, context.getNode(), export));
			}else {
				java.lang.String property = getPropertyName(node);
				call = com.google.javascript.rhino.IR.call(com.google.javascript.jscomp.NodeUtil.newQualifiedNameNode(convention, exportPropertyFunction, context.getNode(), exportPropertyFunction), com.google.javascript.jscomp.NodeUtil.newQualifiedNameNode(convention, parent, context.getNode(), exportPropertyFunction), com.google.javascript.rhino.IR.string(property), com.google.javascript.jscomp.NodeUtil.newQualifiedNameNode(convention, export, context.getNode(), exportPropertyFunction));
			}
			com.google.javascript.rhino.Node expression = com.google.javascript.rhino.IR.exprResult(call);
			annotate(expression);
	...
	private void annotate(com.google.javascript.rhino.Node node) {
		com.google.javascript.jscomp.NodeTraversal.traverse(compiler, node, new com.google.javascript.jscomp.PrepareAst.PrepareAnnotations());
	}
