...
class SyntacticScopeCreator implements com.google.javascript.jscomp.ScopeCreator {
	...
	public com.google.javascript.jscomp.Scope createScope(com.google.javascript.rhino.Node n, com.google.javascript.jscomp.Scope parent) {
		inputId = null;
		if (parent == null) {
			scope = com.google.javascript.jscomp.Scope.createGlobalScope(n);
		}else {
	...
	private void scanRoot(com.google.javascript.rhino.Node n) {
		if (n.isFunction()) {
			if ((inputId) == null) {
			...
			com.google.common.base.Preconditions.checkState(args.isParamList());
			for (com.google.javascript.rhino.Node a = args.getFirstChild(); a != null; a = a.getNext()) {
				com.google.common.base.Preconditions.checkState(a.isName());
				declareVar(a);
			}
			scanVars(body);
		}else {
	...
	private void scanVars(com.google.javascript.rhino.Node n) {
		switch (n.getType()) {
			...
			case com.google.javascript.rhino.Token.CATCH :
				...
				com.google.common.base.Preconditions.checkState(n.getFirstChild().isName());
	...
	private class DefaultRedeclarationHandler implements com.google.javascript.jscomp.SyntacticScopeCreator.RedeclarationHandler {
		...
		public void onRedeclaration(com.google.javascript.jscomp.Scope s, java.lang.String name, com.google.javascript.rhino.Node n, com.google.javascript.jscomp.CompilerInput input) {
			...
			if (scope.isGlobal()) {
				...
				if (!allowDupe) {
					compiler.report(com.google.javascript.jscomp.JSError.make(com.google.javascript.jscomp.NodeUtil.getSourceName(n), n, com.google.javascript.jscomp.SyntacticScopeCreator.VAR_MULTIPLY_DECLARED_ERROR, name, ((origVar.input) != null ? origVar.input.getName() : "??")));
				}
			}else
				if ((name.equals(com.google.javascript.jscomp.SyntacticScopeCreator.ARGUMENTS)) && (!(com.google.javascript.jscomp.NodeUtil.isVarDeclaration(n)))) {
					compiler.report(com.google.javascript.jscomp.JSError.make(com.google.javascript.jscomp.NodeUtil.getSourceName(n), n, com.google.javascript.jscomp.SyntacticScopeCreator.VAR_ARGUMENTS_SHADOWED_ERROR));
				}
