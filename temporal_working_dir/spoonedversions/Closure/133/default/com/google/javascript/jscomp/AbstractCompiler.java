...
public abstract class AbstractCompiler implements com.google.javascript.jscomp.SourceExcerptProvider {
	...
	abstract com.google.javascript.jscomp.SourceFile getSourceFileByName(java.lang.String sourceName);
...
RAW, NORMALIZED, NORMALIZED_OBFUSCATED;
	...
	abstract void setProgress(double progress, @javax.annotation.Nullable
	java.lang.String lastPassName);

	abstract com.google.javascript.rhino.Node ensureLibraryInjected(java.lang.String resourceName);

	abstract void setOldParseTree(java.lang.String sourceName, com.google.javascript.rhino.head.ast.AstRoot astRoot);

	abstract com.google.javascript.rhino.head.ast.AstRoot getOldParseTreeByName(java.lang.String sourceName);
}
