...
class TypeInference extends com.google.javascript.jscomp.DataFlowAnalysis.BranchedForwardDataFlowAnalysis<com.google.javascript.rhino.Node, com.google.javascript.jscomp.type.FlowScope> {
	...
	@java.lang.Override
	@java.lang.SuppressWarnings(value = { "fallthrough" , "incomplete-switch" })
				...
				case ON_TRUE :
					if (com.google.javascript.jscomp.NodeUtil.isForIn(source)) {
						...
						if (item.isName()) {
							...
							com.google.javascript.rhino.jstype.JSType objIndexType = objType == null ? null : objType.getTemplateTypeMap().getTemplateType(com.google.javascript.rhino.jstype.JSTypeRegistry.OBJECT_INDEX_TEMPLATE);
	...
	private void updateBind(com.google.javascript.rhino.Node n) {
			...
			if (paramType.isUnionType()) {
				...
				if (paramType.isFunctionType()) {
					...
					if (paramType.isTemplatizedType()) {
						com.google.javascript.rhino.jstype.ObjectType referencedParamType = paramType.toMaybeTemplatizedType().getReferencedType();
						com.google.javascript.rhino.jstype.JSType argObjectType = argType.restrictByNotNullOrUndefined().collapseUnion();
						if (argObjectType.isSubtype(referencedParamType)) {
							com.google.javascript.rhino.jstype.TemplateTypeMap paramTypeMap = paramType.getTemplateTypeMap();
							com.google.javascript.rhino.jstype.TemplateTypeMap argTypeMap = argObjectType.getTemplateTypeMap();
							for (java.lang.String key : paramTypeMap.getTemplateKeys()) {
	...
	private com.google.javascript.jscomp.type.FlowScope traverseGetElem(com.google.javascript.rhino.Node n, com.google.javascript.jscomp.type.FlowScope scope) {
		scope = traverseChildren(n, scope);
		com.google.javascript.rhino.jstype.JSType type = getJSType(n.getFirstChild()).restrictByNotNullOrUndefined();
		com.google.javascript.rhino.jstype.TemplateTypeMap typeMap = type.getTemplateTypeMap();
		if (typeMap.hasTemplateType(com.google.javascript.rhino.jstype.JSTypeRegistry.OBJECT_ELEMENT_TEMPLATE)) {
			n.setJSType(typeMap.getTemplateType(com.google.javascript.rhino.jstype.JSTypeRegistry.OBJECT_ELEMENT_TEMPLATE));
		}
