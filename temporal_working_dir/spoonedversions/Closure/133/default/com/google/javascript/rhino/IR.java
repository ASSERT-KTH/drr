...
public class IR {
	...
	public static com.google.javascript.rhino.Node block(java.util.List<com.google.javascript.rhino.Node> stmts) {
		com.google.javascript.rhino.Node paramList = com.google.javascript.rhino.IR.block();
		for (com.google.javascript.rhino.Node stmt : stmts) {
			com.google.common.base.Preconditions.checkState(com.google.javascript.rhino.IR.mayBeStatement(stmt));
	...
	public static com.google.javascript.rhino.Node script(com.google.javascript.rhino.Node... stmts) {
		com.google.javascript.rhino.Node block = com.google.javascript.rhino.IR.script();
		for (com.google.javascript.rhino.Node stmt : stmts) {
			com.google.common.base.Preconditions.checkState(com.google.javascript.rhino.IR.mayBeStatementNoReturn(stmt));
			block.addChildToBack(stmt);
		}
		return block;
	}

	public static com.google.javascript.rhino.Node script(java.util.List<com.google.javascript.rhino.Node> stmts) {
		com.google.javascript.rhino.Node paramList = com.google.javascript.rhino.IR.script();
		for (com.google.javascript.rhino.Node stmt : stmts) {
			com.google.common.base.Preconditions.checkState(com.google.javascript.rhino.IR.mayBeStatementNoReturn(stmt));
			paramList.addChildToBack(stmt);
		}
	...
	public static com.google.javascript.rhino.Node cast(com.google.javascript.rhino.Node expr1) {
		return com.google.javascript.rhino.IR.unaryOp(com.google.javascript.rhino.Token.CAST, expr1);
	}
	...
	private static boolean mayBeStatementNoReturn(com.google.javascript.rhino.Node n) {
		switch (n.getType()) {
	...
	private static boolean mayBeStatement(com.google.javascript.rhino.Node n) {
		if (!(com.google.javascript.rhino.IR.mayBeStatementNoReturn(n))) {
			return n.isReturn();
		}
		return true;
	}
