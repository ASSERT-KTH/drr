...
class RuntimeTypeCheck implements com.google.javascript.jscomp.CompilerPass {
	...
	private static class AddMarkers extends com.google.javascript.jscomp.NodeTraversal.AbstractPostOrderCallback {
		...
		private void visitFunction(com.google.javascript.rhino.Node n) {
		...
		com.google.javascript.rhino.jstype.ObjectType interfaceType) {
			...
			com.google.javascript.rhino.Node classNode = com.google.javascript.jscomp.NodeUtil.newQualifiedNameNode(compiler.getCodingConvention(), className);
			com.google.javascript.rhino.Node marker = com.google.javascript.rhino.IR.string((interfaceType == null ? "instance_of__" + className : "implements__" + (interfaceType.getReferenceName())));
			com.google.javascript.rhino.Node assign = com.google.javascript.rhino.IR.exprResult(com.google.javascript.rhino.IR.assign(com.google.javascript.rhino.IR.getelem(com.google.javascript.rhino.IR.getprop(classNode, com.google.javascript.rhino.IR.string("prototype")), marker), com.google.javascript.rhino.IR.trueNode()));
	...
	private class AddChecks extends com.google.javascript.jscomp.NodeTraversal.AbstractPostOrderCallback {
		...
		private void visitFunction(com.google.javascript.rhino.Node n) {
			...
			for (com.google.javascript.rhino.Node paramType : funType.getParameters()) {
				...
				checkNode = com.google.javascript.rhino.IR.exprResult(checkNode);
		...
		private com.google.javascript.rhino.Node createCheckTypeCallNode(com.google.javascript.rhino.jstype.JSType type, com.google.javascript.rhino.Node expr) {
			com.google.javascript.rhino.Node arrayNode = com.google.javascript.rhino.IR.arraylit();
			...
			return com.google.javascript.rhino.IR.call(jsCode("checkType"), expr, arrayNode);
		}
		...
		private com.google.javascript.rhino.Node createCheckerNode(com.google.javascript.rhino.jstype.JSType type) {
			if (type.isNullType()) {
				...
				if ((((type.isBooleanValueType()) || (type.isNumberValueType())) || (type.isStringValueType())) || (type.isVoidType())) {
					return com.google.javascript.rhino.IR.call(jsCode("valueChecker"), com.google.javascript.rhino.IR.string(type.toString()));
				}else
					if (type.isInstanceType()) {
						...
						if ((sourceFile == null) || (sourceFile.isExtern())) {
							return com.google.javascript.rhino.IR.call(jsCode("externClassChecker"), com.google.javascript.rhino.IR.string(refName));
						}
						return com.google.javascript.rhino.IR.call(jsCode((objType.getConstructor().isInterface() ? "interfaceChecker" : "classChecker")), com.google.javascript.rhino.IR.string(refName));
					}else {
						return null;
					}
	...
	private void addBoilerplateCode() {
		com.google.javascript.rhino.Node newNode = compiler.ensureLibraryInjected("runtime_type_check");
		if ((newNode != null) && ((logFunction) != null)) {
			com.google.javascript.rhino.Node logOverride = com.google.javascript.rhino.IR.exprResult(com.google.javascript.rhino.IR.assign(com.google.javascript.jscomp.NodeUtil.newQualifiedNameNode(compiler.getCodingConvention(), "$jscomp.typecheck.log"), com.google.javascript.jscomp.NodeUtil.newQualifiedNameNode(compiler.getCodingConvention(), logFunction)));
	...
	private com.google.javascript.rhino.Node jsCode(java.lang.String prop) {
		return com.google.javascript.jscomp.NodeUtil.newQualifiedNameNode(compiler.getCodingConvention(), ("$jscomp.typecheck." + prop));
	}
}
