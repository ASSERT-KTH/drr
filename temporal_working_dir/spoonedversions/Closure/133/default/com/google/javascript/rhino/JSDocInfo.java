...
PRIVATE, PROTECTED, PUBLIC, INHERITED;	}
	...
	private static final class LazilyInitializedInfo implements java.io.Serializable {
		...
		com.google.common.collect.ImmutableList<java.lang.String> classTemplateTypeNames = null;
	...
	boolean declareClassTemplateTypeNames(java.util.List<java.lang.String> templateTypeNames) {
		lazyInitInfo();
		if ((info.classTemplateTypeNames) != null) {
			return false;
		}
		info.classTemplateTypeNames = com.google.common.collect.ImmutableList.copyOf(templateTypeNames);
		return true;
	}
