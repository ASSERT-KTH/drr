...
class MakeDeclaredNamesUnique implements com.google.javascript.jscomp.NodeTraversal.ScopedCallback {
	...
	public void enterScope(com.google.javascript.jscomp.NodeTraversal t) {
		...
		if (nameStack.isEmpty()) {
			com.google.common.base.Preconditions.checkState(((!(declarationRoot.isFunction())) || (!((rootRenamer) instanceof com.google.javascript.jscomp.MakeDeclaredNamesUnique.ContextualRenamer))));
	...
	static class InlineRenamer implements com.google.javascript.jscomp.MakeDeclaredNamesUnique.Renamer {
		...
		InlineRenamer(com.google.javascript.jscomp.CodingConvention convention, com.google.common.base.Supplier<java.lang.String> uniqueIdSupplier, java.lang.String idPrefix, boolean removeConstness) {
		...
		@java.lang.Override
		public com.google.javascript.jscomp.MakeDeclaredNamesUnique.Renamer forChildScope() {
			return new com.google.javascript.jscomp.MakeDeclaredNamesUnique.InlineRenamer(convention, uniqueIdSupplier, idPrefix, removeConstness);
		}
	...
	static class BoilerplateRenamer extends com.google.javascript.jscomp.MakeDeclaredNamesUnique.ContextualRenamer {
		...
		BoilerplateRenamer(com.google.javascript.jscomp.CodingConvention convention, com.google.common.base.Supplier<java.lang.String> uniqueIdSupplier, java.lang.String idPrefix) {
			this.convention = convention;
			this.uniqueIdSupplier = uniqueIdSupplier;
			this.idPrefix = idPrefix;
		}
		...
		@java.lang.Override
		public com.google.javascript.jscomp.MakeDeclaredNamesUnique.Renamer forChildScope() {
			return new com.google.javascript.jscomp.MakeDeclaredNamesUnique.InlineRenamer(convention, uniqueIdSupplier, idPrefix, false);
		}
	}

	static class WhitelistedRenamer implements com.google.javascript.jscomp.MakeDeclaredNamesUnique.Renamer {
		...
		WhitelistedRenamer(com.google.javascript.jscomp.MakeDeclaredNamesUnique.Renamer delegate, java.util.Set<java.lang.String> whitelist) {
			com.google.javascript.jscomp.MakeDeclaredNamesUnique.WhitelistedRenamer.this.delegate = delegate;
			com.google.javascript.jscomp.MakeDeclaredNamesUnique.WhitelistedRenamer.this.whitelist = whitelist;
		}
		...
		@java.lang.Override
		public com.google.javascript.jscomp.MakeDeclaredNamesUnique.Renamer forChildScope() {
			return new com.google.javascript.jscomp.MakeDeclaredNamesUnique.WhitelistedRenamer(delegate.forChildScope(), whitelist);
		}
	}
}
