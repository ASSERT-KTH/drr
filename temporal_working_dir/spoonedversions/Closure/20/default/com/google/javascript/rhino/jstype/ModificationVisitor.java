...
public class ModificationVisitor implements com.google.javascript.rhino.jstype.Visitor<com.google.javascript.rhino.jstype.JSType> {
	...
	public com.google.javascript.rhino.jstype.JSType caseFunctionType(com.google.javascript.rhino.jstype.FunctionType type) {
		...
		com.google.javascript.rhino.jstype.ObjectType beforeThis = type.getTypeOfThis();
		com.google.javascript.rhino.jstype.ObjectType afterThis = coerseToThisType(beforeThis.visit(com.google.javascript.rhino.jstype.ModificationVisitor.this));
	...
	private com.google.javascript.rhino.jstype.ObjectType coerseToThisType(com.google.javascript.rhino.jstype.JSType type) {
		com.google.javascript.rhino.jstype.ObjectType restricted = type.restrictByNotNullOrUndefined().collapseUnion().toObjectType();
		return restricted != null ? restricted : registry.getNativeObjectType(com.google.javascript.rhino.jstype.JSTypeNative.UNKNOWN_TYPE);
	}
	...
	@java.lang.Override
	public com.google.javascript.rhino.jstype.JSType caseParameterizedType(com.google.javascript.rhino.jstype.ParameterizedType type) {
		com.google.javascript.rhino.jstype.ObjectType genericType = com.google.javascript.rhino.jstype.ObjectType.cast(type.getReferencedTypeInternal().visit(com.google.javascript.rhino.jstype.ModificationVisitor.this));
		com.google.javascript.rhino.jstype.JSType paramType = type.getParameterType().visit(com.google.javascript.rhino.jstype.ModificationVisitor.this);
