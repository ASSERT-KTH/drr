...
public abstract class PassConfig {
	...
	void regenerateGlobalTypedScope(com.google.javascript.jscomp.AbstractCompiler compiler, com.google.javascript.rhino.Node root) {
		com.google.javascript.jscomp.MemoizedScopeCreator oldScopeCreator = typedScopeCreator;
		...
		if (oldScopeCreator != null) {
			com.google.javascript.jscomp.Scope oldTopScope = oldScopeCreator.getScopeIfMemoized(root);
			if (oldTopScope != null) {
				java.util.Iterator<com.google.javascript.jscomp.Scope.Var> varIt = topScope.getDeclarativelyUnboundVarsWithoutTypes();
				while (varIt.hasNext()) {
					com.google.javascript.jscomp.Scope.Var newVar = varIt.next();
					com.google.javascript.jscomp.Scope.Var oldVar = oldTopScope.getVar(newVar.getName());
					if (oldVar != null) {
