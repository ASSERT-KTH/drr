		...
		if ("prototype".equals(name)) {
			...
			if (!(hasOwnProperty(name))) {
				if ("call".equals(name)) {
					com.google.javascript.rhino.Node params = getParametersNode();
					if (params == null) {
						defineDeclaredProperty(name, new com.google.javascript.rhino.jstype.FunctionBuilder(registry).withReturnType(getReturnType()).build(), false, source);
					}else {
						...
						defineDeclaredProperty(name, new com.google.javascript.rhino.jstype.FunctionBuilder(registry).withParamsNode(params).withReturnType(getReturnType()).build(), false, source);
					}
				}else
					if ("apply".equals(name)) {
						...
						defineDeclaredProperty(name, new com.google.javascript.rhino.jstype.FunctionBuilder(registry).withParams(builder).withReturnType(getReturnType()).build(), false, source);
					}
