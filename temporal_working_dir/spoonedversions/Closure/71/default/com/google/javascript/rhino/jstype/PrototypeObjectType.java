...
class PrototypeObjectType extends com.google.javascript.rhino.jstype.ObjectType {
	...
	public boolean isPropertyTypeDeclared(java.lang.String property) {
		com.google.javascript.rhino.jstype.PrototypeObjectType.Property p = properties.get(property);
		if (p == null) {
			com.google.javascript.rhino.jstype.ObjectType implicitPrototype = getImplicitPrototype();
			if (implicitPrototype != null) {
	...
	boolean defineProperty(java.lang.String name, com.google.javascript.rhino.jstype.JSType type, boolean inferred, boolean inExterns, com.google.javascript.rhino.Node propertyNode) {
		...
		com.google.javascript.rhino.jstype.PrototypeObjectType.Property newProp = new com.google.javascript.rhino.jstype.PrototypeObjectType.Property(type, inferred, inExterns, propertyNode);
	...
	private static final class Property implements java.io.Serializable {
		private static final long serialVersionUID = 1L;
		...
		private Property(com.google.javascript.rhino.jstype.JSType type, boolean inferred, boolean inExterns, com.google.javascript.rhino.Node propertyNode) {
