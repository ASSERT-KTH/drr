...
class GlobalNamespace {
	...
	private class BuildGlobalNamespace extends com.google.javascript.jscomp.NodeTraversal.AbstractPostOrderCallback {
		...
		void handleSetFromGlobal(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent, java.lang.String name, boolean isPropAssign, com.google.javascript.jscomp.GlobalNamespace.Name.Type type) {
			...
			nameObj.type = type;
			com.google.javascript.jscomp.GlobalNamespace.Ref set = new com.google.javascript.jscomp.GlobalNamespace.Ref(t, n, com.google.javascript.jscomp.GlobalNamespace.Ref.Type.SET_FROM_GLOBAL);
			nameObj.addRef(set);
			if (isNestedAssign(parent)) {
				com.google.javascript.jscomp.GlobalNamespace.Ref get = new com.google.javascript.jscomp.GlobalNamespace.Ref(t, n, com.google.javascript.jscomp.GlobalNamespace.Ref.Type.ALIASING_GET);
				nameObj.addRef(get);
		...
		void handleSetFromLocal(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent, java.lang.String name) {
			...
			com.google.javascript.jscomp.GlobalNamespace.Ref set = new com.google.javascript.jscomp.GlobalNamespace.Ref(t, n, com.google.javascript.jscomp.GlobalNamespace.Ref.Type.SET_FROM_LOCAL);
			node.addRef(set);
			if (isNestedAssign(parent)) {
				com.google.javascript.jscomp.GlobalNamespace.Ref get = new com.google.javascript.jscomp.GlobalNamespace.Ref(t, n, com.google.javascript.jscomp.GlobalNamespace.Ref.Type.ALIASING_GET);
				node.addRef(get);
		...
		void handleGet(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent, java.lang.String name, com.google.javascript.jscomp.GlobalNamespace.Ref.Type type) {
			com.google.javascript.jscomp.GlobalNamespace.Name node = getOrCreateName(name);
			node.addRef(new com.google.javascript.jscomp.GlobalNamespace.Ref(t, n, type));
		}
...
OBJECTLIT, FUNCTION, OTHER;		}
		...
		java.util.List<com.google.javascript.jscomp.GlobalNamespace.Ref> refs;
		...
		void removeRef(com.google.javascript.jscomp.GlobalNamespace.Ref ref) {
			if ((ref == (declaration)) || (((refs) != null) && (refs.remove(ref)))) {
				if (ref == (declaration)) {
					declaration = null;
					if ((refs) != null) {
		...
		void addRefInternal(com.google.javascript.jscomp.GlobalNamespace.Ref ref) {
			if ((refs) == null) {
				refs = new java.util.LinkedList<com.google.javascript.jscomp.GlobalNamespace.Ref>();
			}
			refs.add(ref);
		}
		...
		boolean canCollapseUnannotatedChildNames() {
			if ((((type) == (com.google.javascript.jscomp.GlobalNamespace.Name.Type.OTHER)) || ((globalSets) != 1)) || ((localSets) != 0)) {
				return false;
			}
			...
			if (((type) != (com.google.javascript.jscomp.GlobalNamespace.Name.Type.FUNCTION)) && ((aliasingGets) > 0)) {
				return false;
			}
...
SET_FROM_GLOBAL, SET_FROM_LOCAL, PROTOTYPE_GET, ALIASING_GET, DIRECT_GET, CALL_GET;		}
		...
		Ref(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node name, com.google.javascript.jscomp.GlobalNamespace.Ref.Type type) {
		...
		private Ref(com.google.javascript.jscomp.GlobalNamespace.Ref original, com.google.javascript.jscomp.GlobalNamespace.Ref.Type type) {
		...
		private Ref(com.google.javascript.jscomp.GlobalNamespace.Ref.Type type) {
			this.type = type;
		...
		com.google.javascript.jscomp.GlobalNamespace.Ref cloneAndReclassify(com.google.javascript.jscomp.GlobalNamespace.Ref.Type type) {
			return new com.google.javascript.jscomp.GlobalNamespace.Ref(com.google.javascript.jscomp.GlobalNamespace.Ref.this, type);
		}
		...
		static com.google.javascript.jscomp.GlobalNamespace.Ref createRefForTesting(com.google.javascript.jscomp.GlobalNamespace.Ref.Type type) {
			return new com.google.javascript.jscomp.GlobalNamespace.Ref(type);
		}
	}
}
