...
class FlowSensitiveInlineVariables extends com.google.javascript.jscomp.NodeTraversal.AbstractPostOrderCallback implements com.google.javascript.jscomp.CompilerPass , com.google.javascript.jscomp.NodeTraversal.ScopedCallback {
	...
	private static final com.google.common.base.Predicate<com.google.javascript.rhino.Node> SIDE_EFFECT_PREDICATE = new com.google.common.base.Predicate<com.google.javascript.rhino.Node>() {
		...
		public boolean apply(com.google.javascript.rhino.Node n) {
			...
			if ((com.google.javascript.jscomp.NodeUtil.isCall(n)) && (com.google.javascript.jscomp.NodeUtil.functionCallHasSideEffects(n))) {
				return true;
			}
			if ((com.google.javascript.jscomp.NodeUtil.isNew(n)) && (com.google.javascript.jscomp.NodeUtil.constructorCallHasSideEffects(n))) {
				return true;
			}
	...
	public void enterScope(com.google.javascript.jscomp.NodeTraversal t) {
		...
		com.google.common.base.Preconditions.checkState(com.google.javascript.jscomp.NodeUtil.isFunction(t.getScopeRoot()));
	...
	public void process(com.google.javascript.rhino.Node externs, com.google.javascript.rhino.Node root) {
		new com.google.javascript.jscomp.NodeTraversal(compiler, com.google.javascript.jscomp.FlowSensitiveInlineVariables.this).traverse(root);
	}
			...
			com.google.javascript.jscomp.ControlFlowGraph.AbstractCfgNodeTraversalCallback gatherCb = new com.google.javascript.jscomp.ControlFlowGraph.AbstractCfgNodeTraversalCallback() {
				...
				public void visit(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
					if (com.google.javascript.jscomp.NodeUtil.isName(n)) {
						if (((((((com.google.javascript.jscomp.NodeUtil.isAssignmentOp(parent)) && ((parent.getFirstChild()) == n)) || (com.google.javascript.jscomp.NodeUtil.isVar(parent))) || ((parent.getType()) == (com.google.javascript.rhino.Token.INC))) || ((parent.getType()) == (com.google.javascript.rhino.Token.DEC))) || ((parent.getType()) == (com.google.javascript.rhino.Token.LP))) || ((parent.getType()) == (com.google.javascript.rhino.Token.CATCH))) {
							return ;
						}
	...
	private class Candidate {
		...
		Candidate(java.lang.String varName, com.google.javascript.rhino.Node defCfgNode, com.google.javascript.rhino.Node use, com.google.javascript.rhino.Node useCfgNode) {
			com.google.common.base.Preconditions.checkArgument(com.google.javascript.jscomp.NodeUtil.isName(use));
		...
		private boolean canInline() {
			if (com.google.javascript.jscomp.NodeUtil.isFunction(defCfgNode)) {
				return false;
			}
			...
			if ((com.google.javascript.jscomp.NodeUtil.isAssign(def)) && (!(com.google.javascript.jscomp.NodeUtil.isExprAssign(def.getParent())))) {
				return false;
			}
		...
		private void inlineVariable() {
			...
			if (com.google.javascript.jscomp.NodeUtil.isAssign(def)) {
				com.google.javascript.rhino.Node rhs = def.getLastChild();
				rhs.detachFromParent();
				com.google.common.base.Preconditions.checkState(com.google.javascript.jscomp.NodeUtil.isExpressionNode(defParent));
				while ((defParent.getParent().getType()) == (com.google.javascript.rhino.Token.LABEL)) {
					defParent = defParent.getParent();
				} 
				defParent.detachFromParent();
				useParent.replaceChild(use, rhs);
			}else
				if (com.google.javascript.jscomp.NodeUtil.isVar(defParent)) {
					com.google.javascript.rhino.Node rhs = def.getLastChild();
					def.removeChild(rhs);
					useParent.replaceChild(use, rhs);
				}else {
				...
				public void visit(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
					switch (n.getType()) {
						...
						case com.google.javascript.rhino.Token.ASSIGN :
							...
							if ((com.google.javascript.jscomp.NodeUtil.isName(lhs)) && (lhs.getString().equals(varName))) {
								def = n;
							}
							return ;
					}
		...
		private void getNumUseInUseCfgNode(com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parant) {
			com.google.javascript.jscomp.ControlFlowGraph.AbstractCfgNodeTraversalCallback gatherCb = new com.google.javascript.jscomp.ControlFlowGraph.AbstractCfgNodeTraversalCallback() {
				@java.lang.Override
				public void visit(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
					if (((com.google.javascript.jscomp.NodeUtil.isName(n)) && (n.getString().equals(varName))) && (!((com.google.javascript.jscomp.NodeUtil.isAssign(parent)) && ((parent.getFirstChild()) == n)))) {
