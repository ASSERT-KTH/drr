...
public class JSTypeRegistry implements java.io.Serializable {
	...
	private final java.util.Map<java.lang.String, java.util.Set<com.google.javascript.rhino.jstype.ObjectType>> typesIndexedByProperty = com.google.common.collect.Maps.newHashMap();
...
LAZY_EXPRESSIONS, LAZY_NAMES, IMMEDIATE;	}
	...
	private void initializeBuiltInTypes() {
		...
		com.google.javascript.rhino.jstype.ObjectType TOP_LEVEL_PROTOTYPE = new com.google.javascript.rhino.jstype.FunctionPrototypeType(com.google.javascript.rhino.jstype.JSTypeRegistry.this, null, null, true);
		...
		com.google.javascript.rhino.jstype.ObjectType GLOBAL_THIS = createObjectType("global this", null, UNKNOWN_TYPE);
	...
	public void registerPropertyOnType(java.lang.String propertyName, com.google.javascript.rhino.jstype.JSType type) {
		com.google.javascript.rhino.jstype.ObjectType owner = null;
		if (type instanceof com.google.javascript.rhino.jstype.ObjectType) {
			owner = ((com.google.javascript.rhino.jstype.ObjectType) (type));
		}else
			if (getNativeType(com.google.javascript.rhino.jstype.JSTypeNative.ALL_TYPE).isSubtype(type)) {
				owner = getNativeObjectType(com.google.javascript.rhino.jstype.JSTypeNative.OBJECT_TYPE);
			}else
				if (type instanceof com.google.javascript.rhino.jstype.UnionType) {
					for (com.google.javascript.rhino.jstype.JSType alternate : ((com.google.javascript.rhino.jstype.UnionType) (type)).getAlternates()) {
		...
		java.util.Set<com.google.javascript.rhino.jstype.ObjectType> typeSet = typesIndexedByProperty.get(propertyName);
		if (typeSet == null) {
			typesIndexedByProperty.put(propertyName, (typeSet = new java.util.LinkedHashSet<com.google.javascript.rhino.jstype.ObjectType>()));
		}
	...
	public com.google.javascript.rhino.jstype.JSType getGreatestSubtypeWithProperty(com.google.javascript.rhino.jstype.JSType type, java.lang.String propertyName) {
		...
		if (typesIndexedByProperty.containsKey(propertyName)) {
			...
			for (com.google.javascript.rhino.jstype.JSType alt : typesIndexedByProperty.get(propertyName)) {
				builder.addAlternate(alt);
			}
			com.google.javascript.rhino.jstype.JSType built = builder.build();
	...
	public java.util.Set<com.google.javascript.rhino.jstype.ObjectType> getTypesWithProperty(java.lang.String propertyName) {
		java.util.Set<com.google.javascript.rhino.jstype.ObjectType> typeSet = typesIndexedByProperty.get(propertyName);
		if (typeSet == null) {
			java.util.Set<com.google.javascript.rhino.jstype.ObjectType> set = new java.util.LinkedHashSet<com.google.javascript.rhino.jstype.ObjectType>();
			set.add(getNativeObjectType(com.google.javascript.rhino.jstype.JSTypeNative.NO_TYPE));
			return set;
		}
		return typeSet;
	}
	...
	public com.google.javascript.rhino.jstype.JSType getForgivingType(com.google.javascript.rhino.jstype.StaticScope<com.google.javascript.rhino.jstype.JSType> scope, java.lang.String jsTypeName, java.lang.String sourceName, int lineno, int charno) {
		com.google.javascript.rhino.jstype.JSType type = getType(scope, jsTypeName, sourceName, lineno, charno);
	...
	public com.google.javascript.rhino.jstype.EnumType createEnumType(java.lang.String name, com.google.javascript.rhino.jstype.JSType elementsType) {
		return new com.google.javascript.rhino.jstype.EnumType(com.google.javascript.rhino.jstype.JSTypeRegistry.this, name, elementsType);
	}
	...
	public com.google.javascript.rhino.jstype.RecordType createRecordType(java.util.Map<java.lang.String, com.google.javascript.rhino.jstype.JSType> properties) {
	...
	public com.google.javascript.rhino.jstype.JSType createFromTypeNodes(com.google.javascript.rhino.Node n, java.lang.String sourceName, com.google.javascript.rhino.jstype.StaticScope<com.google.javascript.rhino.jstype.JSType> scope, boolean forgiving) {
		if ((resolveMode) == (com.google.javascript.rhino.jstype.JSTypeRegistry.ResolveMode.LAZY_EXPRESSIONS)) {
			...
			if (hasNames) {
				return new com.google.javascript.rhino.jstype.UnresolvedTypeExpression(com.google.javascript.rhino.jstype.JSTypeRegistry.this, n, sourceName, forgiving);
			}
		}
	...
	private com.google.javascript.rhino.jstype.JSType createFromTypeNodesInternal(com.google.javascript.rhino.Node n, java.lang.String sourceName, com.google.javascript.rhino.jstype.StaticScope<com.google.javascript.rhino.jstype.JSType> scope, boolean forgiving) {
		switch (n.getType()) {
			...
			case com.google.javascript.rhino.Token.STRING :
				...
				if ((namedType instanceof com.google.javascript.rhino.jstype.ObjectType) && (!(nonNullableTypeNames.contains(n.getString())))) {
					...
					if ((typeList != null) && (("Array".equals(n.getString())) || ("Object".equals(n.getString())))) {
						com.google.javascript.rhino.jstype.JSType parameterType = createFromTypeNodesInternal(typeList.getLastChild(), sourceName, scope, false);
						...
						if (typeList.hasMoreThanOneChild()) {
							com.google.javascript.rhino.jstype.JSType indexType = createFromTypeNodesInternal(typeList.getFirstChild(), sourceName, scope, false);
			...
			case com.google.javascript.rhino.Token.FUNCTION :
				...
				if ((current.getType()) == (com.google.javascript.rhino.Token.THIS)) {
					com.google.javascript.rhino.Node thisNode = current.getFirstChild();
					thisType = com.google.javascript.rhino.jstype.ObjectType.cast(createFromTypeNodesInternal(thisNode, sourceName, scope, false).restrictByNotNullOrUndefined());
					if (thisType == null) {
						reporter.warning(com.google.javascript.rhino.ScriptRuntime.getMessage0("msg.jsdoc.function.thisnotobject"), sourceName, thisNode.getLineno(), "", thisNode.getCharno());
					}
				...
				if ((current.getType()) == (com.google.javascript.rhino.Token.LP)) {
					...
					for (com.google.javascript.rhino.Node arg = current.getFirstChild(); arg != null; arg = arg.getNext()) {
						if ((arg.getType()) == (com.google.javascript.rhino.Token.ELLIPSIS)) {
							...
							com.google.javascript.rhino.jstype.JSType type = createFromTypeNodesInternal(arg, sourceName, scope, false);
				...
				com.google.javascript.rhino.jstype.JSType returnType = createFromTypeNodesInternal(current, sourceName, scope, false);
				return new com.google.javascript.rhino.jstype.FunctionBuilder(com.google.javascript.rhino.jstype.JSTypeRegistry.this).withParams(paramBuilder).withReturnType(returnType).withTypeOfThis(thisType).build();
		}
	...
	public void setTemplateTypeName(java.lang.String name) {
		...
		templateType = new com.google.javascript.rhino.jstype.TemplateType(com.google.javascript.rhino.jstype.JSTypeRegistry.this, name);
	}
