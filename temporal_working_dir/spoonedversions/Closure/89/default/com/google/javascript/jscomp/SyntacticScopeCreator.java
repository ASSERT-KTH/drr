...
class SyntacticScopeCreator implements com.google.javascript.jscomp.ScopeCreator {
		...
		switch (n.getType()) {
			case com.google.javascript.rhino.Token.VAR :
				for (com.google.javascript.rhino.Node child = n.getFirstChild(); child != null;) {
					...
					com.google.common.base.Preconditions.checkState(((child.getType()) == (com.google.javascript.rhino.Token.NAME)));
	...
	interface RedeclarationHandler {
		void onRedeclaration(com.google.javascript.jscomp.Scope s, java.lang.String name, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent, com.google.javascript.rhino.Node gramps, com.google.javascript.rhino.Node nodeWithLineNumber);
	}
	...
	private class DefaultRedeclarationHandler implements com.google.javascript.jscomp.SyntacticScopeCreator.RedeclarationHandler {
		public void onRedeclaration(com.google.javascript.jscomp.Scope s, java.lang.String name, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent, com.google.javascript.rhino.Node gramps, com.google.javascript.rhino.Node nodeWithLineNumber) {
			if (scope.isGlobal()) {
				...
				if (!allowDupe) {
					compiler.report(com.google.javascript.jscomp.JSError.make(sourceName, nodeWithLineNumber, com.google.javascript.jscomp.SyntacticScopeCreator.VAR_MULTIPLY_DECLARED_ERROR, name, ((origVar.input) != null ? origVar.input.getName() : "??")));
				}
			}else
				if ((name.equals(com.google.javascript.jscomp.SyntacticScopeCreator.ARGUMENTS)) && (!(com.google.javascript.jscomp.NodeUtil.isVarDeclaration(n)))) {
					compiler.report(com.google.javascript.jscomp.JSError.make(sourceName, nodeWithLineNumber, com.google.javascript.jscomp.SyntacticScopeCreator.VAR_ARGUMENTS_SHADOWED_ERROR));
				}
			
		}
	}

	private void declareVar(java.lang.String name, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent, com.google.javascript.rhino.Node gramps, com.google.javascript.rhino.jstype.JSType declaredType, com.google.javascript.rhino.Node nodeWithLineNumber) {
