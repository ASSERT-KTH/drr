...
public class Compiler extends com.google.javascript.jscomp.AbstractCompiler {
	...
	com.google.javascript.jscomp.ControlFlowGraph<com.google.javascript.rhino.Node> computeCFG() {
		...
		com.google.javascript.jscomp.ControlFlowAnalysis cfa = new com.google.javascript.jscomp.ControlFlowAnalysis(com.google.javascript.jscomp.Compiler.this, true);
		process(cfa);
	...
	com.google.javascript.jscomp.parsing.Config getParserConfig() {
		if ((parserConfig) == null) {
			parserConfig = com.google.javascript.jscomp.parsing.ParserRunner.createConfig(isIdeMode());
		}
		return parserConfig;
	}
