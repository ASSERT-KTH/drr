...
class SimpleDefinitionFinder implements com.google.javascript.jscomp.CompilerPass , com.google.javascript.jscomp.DefinitionProvider {
	...
	public SimpleDefinitionFinder(com.google.javascript.jscomp.AbstractCompiler compiler) {
		...
		this.nameDefinitionMultimap = com.google.common.collect.HashMultimap.create();
		this.nameUseSiteMultimap = com.google.common.collect.HashMultimap.create();
	}
	...
	public java.util.Collection<com.google.javascript.jscomp.DefinitionsRemover.Definition> getDefinitionsReferencedAt(com.google.javascript.rhino.Node useSite) {
		...
		if (com.google.javascript.jscomp.NodeUtil.isGetProp(useSite)) {
	...
	private static java.lang.String getSimplifiedName(com.google.javascript.rhino.Node node) {
		if (com.google.javascript.jscomp.NodeUtil.isName(node)) {
			...
			if (com.google.javascript.jscomp.NodeUtil.isGetProp(node)) {
	...
	private class DefinitionGatheringCallback extends com.google.javascript.jscomp.NodeTraversal.AbstractPostOrderCallback {
		...
		public void visit(com.google.javascript.jscomp.NodeTraversal traversal, com.google.javascript.rhino.Node node, com.google.javascript.rhino.Node parent) {
			if (((inExterns) && (com.google.javascript.jscomp.NodeUtil.isName(node))) && ((parent.getType()) == (com.google.javascript.rhino.Token.LP))) {
				return ;
			}
			...
			if (def != null) {
				...
				if (name != null) {
					...
					if (((rValue != null) && (!(com.google.javascript.jscomp.NodeUtil.isImmutableValue(rValue)))) && (!(com.google.javascript.jscomp.NodeUtil.isFunction(rValue)))) {
	...
	private class UseSiteGatheringCallback extends com.google.javascript.jscomp.NodeTraversal.AbstractPostOrderCallback {
		...
		public void visit(com.google.javascript.jscomp.NodeTraversal traversal, com.google.javascript.rhino.Node node, com.google.javascript.rhino.Node parent) {
			...
			nameUseSiteMultimap.put(name, new com.google.javascript.jscomp.UseSite(node, traversal.getModule()));
		}
	}
	...
	static boolean maybeExported(com.google.javascript.jscomp.AbstractCompiler compiler, com.google.javascript.jscomp.DefinitionsRemover.Definition definition) {
		com.google.javascript.rhino.Node lValue = definition.getLValue();
		if (lValue == null) {
			return true;
		}
		java.lang.String partialName;
		if (com.google.javascript.jscomp.NodeUtil.isGetProp(lValue)) {
			partialName = lValue.getLastChild().getString();
		}else
			if (com.google.javascript.jscomp.NodeUtil.isName(lValue)) {
	...
	static boolean isSimpleFunctionDeclaration(com.google.javascript.rhino.Node fn) {
		...
		if (((nameNode != null) && (com.google.javascript.jscomp.NodeUtil.isName(nameNode))) && (nameNode.getString().equals(com.google.javascript.jscomp.NodeUtil.JSC_PROPERTY_NAME_FN))) {
			return false;
		}
		if (com.google.javascript.jscomp.NodeUtil.isFunctionDeclaration(fn)) {
			return true;
		}
		if ((fn.getFirstChild().getString().isEmpty()) && ((com.google.javascript.jscomp.NodeUtil.isExprAssign(gramps)) || (com.google.javascript.jscomp.NodeUtil.isName(parent)))) {
			return true;
		}
		return false;
	}
	...
	void removeReferences(com.google.javascript.rhino.Node node) {
		if (com.google.javascript.jscomp.DefinitionsRemover.isDefinitionNode(node)) {
			...
			java.lang.String name = com.google.javascript.jscomp.SimpleDefinitionFinder.getSimplifiedName(useSite);
			if (name != null) {
				com.google.javascript.jscomp.SimpleDefinitionFinder.this.nameUseSiteMultimap.remove(name, new com.google.javascript.jscomp.UseSite(useSite, null));
			}
		}
