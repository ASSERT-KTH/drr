...
class PrototypeObjectType extends com.google.javascript.rhino.jstype.ObjectType {
	...
	boolean defineProperty(java.lang.String name, com.google.javascript.rhino.jstype.JSType type, boolean inferred, boolean inExterns) {
		...
		properties.put(name, new com.google.javascript.rhino.jstype.PrototypeObjectType.Property(type, inferred, inExterns));
		return true;
	}
	...
	private static final class Property implements java.io.Serializable {
		...
		private Property(com.google.javascript.rhino.jstype.JSType type, boolean inferred, boolean inExterns) {
