...
public class DefaultPassConfig extends com.google.javascript.jscomp.PassConfig {
	...
	protected java.util.List<com.google.javascript.jscomp.PassFactory> getChecks() {
		...
		if ((options.enables(com.google.javascript.jscomp.DiagnosticGroups.ACCESS_CONTROLS)) && (options.checkTypes)) {
	...
	final com.google.javascript.jscomp.PassFactory suspiciousCode = new com.google.javascript.jscomp.PassFactory("suspiciousCode", true) {
		...
		protected com.google.javascript.jscomp.CompilerPass createInternal(final com.google.javascript.jscomp.AbstractCompiler compiler) {
			...
			com.google.javascript.jscomp.CheckLevel checkGlobalThisLevel = options.checkGlobalThisLevel;
			if (checkGlobalThisLevel.isOn()) {
				sharedCallbacks.add(new com.google.javascript.jscomp.CheckGlobalThis(compiler, checkGlobalThisLevel));
			}
	...
	final com.google.javascript.jscomp.PassFactory closurePrimitives = new com.google.javascript.jscomp.PassFactory("processProvidesAndRequires", false) {
		@java.lang.Override
		protected com.google.javascript.jscomp.CompilerPass createInternal(com.google.javascript.jscomp.AbstractCompiler compiler) {
	...
	final com.google.javascript.jscomp.PassFactory closureGoogScopeAliases = new com.google.javascript.jscomp.PassFactory("processGoogScopeAliases", true) {
		@java.lang.Override
		protected com.google.javascript.jscomp.CompilerPass createInternal(com.google.javascript.jscomp.AbstractCompiler compiler) {
			return new com.google.javascript.jscomp.ScopedAliases(compiler);
		}
	};
	...
	private final com.google.javascript.jscomp.PassFactory peepholeOptimizations = new com.google.javascript.jscomp.PassFactory("peepholeOptimizations", false) {
		@java.lang.Override
		protected com.google.javascript.jscomp.CompilerPass createInternal(com.google.javascript.jscomp.AbstractCompiler compiler) {
			return new com.google.javascript.jscomp.PeepholeOptimizationsPass(compiler, new com.google.javascript.jscomp.PeepholeSubstituteAlternateSyntax(), new com.google.javascript.jscomp.PeepholeRemoveDeadCode(), new com.google.javascript.jscomp.PeepholeFoldConstants());
		}
	};

	private final com.google.javascript.jscomp.PassFactory checkVars = new com.google.javascript.jscomp.PassFactory("checkVars", true) {
		@java.lang.Override
		protected com.google.javascript.jscomp.CompilerPass createInternal(com.google.javascript.jscomp.AbstractCompiler compiler) {
	...
	final com.google.javascript.jscomp.PassFactory resolveTypes = new com.google.javascript.jscomp.PassFactory("resolveTypes", false) {
		@java.lang.Override
		protected com.google.javascript.jscomp.CompilerPass createInternal(com.google.javascript.jscomp.AbstractCompiler compiler) {
	...
	final com.google.javascript.jscomp.PassFactory inferTypes = new com.google.javascript.jscomp.PassFactory("inferTypes", false) {
		@java.lang.Override
		protected com.google.javascript.jscomp.CompilerPass createInternal(final com.google.javascript.jscomp.AbstractCompiler compiler) {
			return new com.google.javascript.jscomp.CompilerPass() {
				@java.lang.Override
				public void process(com.google.javascript.rhino.Node externs, com.google.javascript.rhino.Node root) {
					...
					com.google.common.base.Preconditions.checkNotNull(typedScopeCreator);
	...
	private final com.google.javascript.jscomp.PassFactory checkTypes = new com.google.javascript.jscomp.PassFactory("checkTypes", false) {
		@java.lang.Override
		protected com.google.javascript.jscomp.CompilerPass createInternal(final com.google.javascript.jscomp.AbstractCompiler compiler) {
			return new com.google.javascript.jscomp.CompilerPass() {
				@java.lang.Override
	...
	private final com.google.javascript.jscomp.PassFactory checkAccessControls = new com.google.javascript.jscomp.PassFactory("checkAccessControls", true) {
		@java.lang.Override
		protected com.google.javascript.jscomp.CompilerPass createInternal(com.google.javascript.jscomp.AbstractCompiler compiler) {
	...
	private class GlobalTypeResolver implements com.google.javascript.jscomp.CompilerPass {
	...
	private final com.google.javascript.jscomp.PassFactory replaceStrings = new com.google.javascript.jscomp.PassFactory("replaceStrings", true) {
		...
		protected com.google.javascript.jscomp.CompilerPass createInternal(final com.google.javascript.jscomp.AbstractCompiler compiler) {
			...
			return new com.google.javascript.jscomp.CompilerPass() {
				@java.lang.Override
				public void process(com.google.javascript.rhino.Node externs, com.google.javascript.rhino.Node root) {
					com.google.javascript.jscomp.ReplaceStrings pass = new com.google.javascript.jscomp.ReplaceStrings(compiler, options.replaceStringsPlaceholderToken, options.replaceStringsFunctionDescriptions);
					pass.process(externs, root);
	...
	private final com.google.javascript.jscomp.PassFactory optimizeCalls = new com.google.javascript.jscomp.PassFactory("optimizeCalls", true) {
		@java.lang.Override
		protected com.google.javascript.jscomp.CompilerPass createInternal(com.google.javascript.jscomp.AbstractCompiler compiler) {
			...
			if (options.devirtualizePrototypeMethods) {
				passes.addPass(new com.google.javascript.jscomp.DevirtualizePrototypeMethods(compiler));
			}
			return passes;
		}
	};
	...
	private com.google.javascript.jscomp.PassFactory inlineGetters = new com.google.javascript.jscomp.PassFactory("inlineGetters", false) {
		@java.lang.Override
		protected com.google.javascript.jscomp.CompilerPass createInternal(com.google.javascript.jscomp.AbstractCompiler compiler) {
			return new com.google.javascript.jscomp.InlineGetters(compiler);
		}
	};

	private com.google.javascript.jscomp.PassFactory deadAssignmentsElimination = new com.google.javascript.jscomp.PassFactory("deadAssignmentsElimination", false) {
		@java.lang.Override
		protected com.google.javascript.jscomp.CompilerPass createInternal(com.google.javascript.jscomp.AbstractCompiler compiler) {
	...
	private com.google.javascript.jscomp.PassFactory inlineFunctions = new com.google.javascript.jscomp.PassFactory("inlineFunctions", false) {
		@java.lang.Override
		protected com.google.javascript.jscomp.CompilerPass createInternal(com.google.javascript.jscomp.AbstractCompiler compiler) {
	...
	private com.google.javascript.jscomp.PassFactory removeUnusedVars = new com.google.javascript.jscomp.PassFactory("removeUnusedVars", false) {
		@java.lang.Override
		protected com.google.javascript.jscomp.CompilerPass createInternal(com.google.javascript.jscomp.AbstractCompiler compiler) {
			...
			return new com.google.javascript.jscomp.RemoveUnusedVars(compiler, (!removeOnlyLocals), preserveAnonymousFunctionNames);
		}
	};

	private com.google.javascript.jscomp.PassFactory crossModuleCodeMotion = new com.google.javascript.jscomp.PassFactory("crossModuleCodeMotion", false) {
		@java.lang.Override
		protected com.google.javascript.jscomp.CompilerPass createInternal(com.google.javascript.jscomp.AbstractCompiler compiler) {
	...
	private com.google.javascript.jscomp.PassFactory crossModuleMethodMotion = new com.google.javascript.jscomp.PassFactory("crossModuleMethodMotion", false) {
		@java.lang.Override
		protected com.google.javascript.jscomp.CompilerPass createInternal(com.google.javascript.jscomp.AbstractCompiler compiler) {
	...
	private com.google.javascript.jscomp.PassFactory specializeInitialModule = new com.google.javascript.jscomp.PassFactory("specializeInitialModule", true) {
		@java.lang.Override
		protected com.google.javascript.jscomp.CompilerPass createInternal(com.google.javascript.jscomp.AbstractCompiler compiler) {
	...
	private com.google.javascript.jscomp.VariableMap runPropertyRenaming(com.google.javascript.jscomp.AbstractCompiler compiler, com.google.javascript.jscomp.VariableMap prevPropertyMap, com.google.javascript.rhino.Node externs, com.google.javascript.rhino.Node root) {
		...
		switch (options.propertyRenaming) {
			...
			case ALL_UNQUOTED :
				com.google.javascript.jscomp.RenameProperties rprop = new com.google.javascript.jscomp.RenameProperties(compiler, options.generatePseudoNames, prevPropertyMap, reservedChars);
	...
	private com.google.javascript.jscomp.VariableMap runVariableRenaming(com.google.javascript.jscomp.AbstractCompiler compiler, com.google.javascript.jscomp.VariableMap prevVariableMap, com.google.javascript.rhino.Node externs, com.google.javascript.rhino.Node root) {
		char[] reservedChars = options.anonymousFunctionNaming.getReservedCharacters();
		boolean preserveAnonymousFunctionNames = (options.anonymousFunctionNaming) != (com.google.javascript.jscomp.AnonymousFunctionNamingPolicy.OFF);
		com.google.javascript.jscomp.RenameVars rn = new com.google.javascript.jscomp.RenameVars(compiler, options.renamePrefix, ((options.variableRenaming) == (com.google.javascript.jscomp.VariableRenamingPolicy.LOCAL)), preserveAnonymousFunctionNames, options.generatePseudoNames, prevVariableMap, reservedChars, exportedNames);
