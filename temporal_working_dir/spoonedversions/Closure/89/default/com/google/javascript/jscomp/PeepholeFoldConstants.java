...
public class PeepholeFoldConstants extends com.google.javascript.jscomp.AbstractPeepholeOptimization {
	...
	private com.google.javascript.rhino.Node tryFoldAssign(com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node left, com.google.javascript.rhino.Node right) {
		...
		com.google.javascript.rhino.Node leftChild = right.getFirstChild();
		...
		com.google.javascript.rhino.Node newNode = new com.google.javascript.rhino.Node(newType, left.detachFromParent(), right.getLastChild().detachFromParent());
	...
	private com.google.javascript.rhino.Node performArithmeticOp(int opType, com.google.javascript.rhino.Node left, com.google.javascript.rhino.Node right) {
		com.google.common.base.Preconditions.checkState(((left.getType()) == (com.google.javascript.rhino.Token.NUMBER)));
		com.google.common.base.Preconditions.checkState(((right.getType()) == (com.google.javascript.rhino.Token.NUMBER)));
		double result;
	...
	private com.google.javascript.rhino.Node tryFoldComparison(com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node left, com.google.javascript.rhino.Node right) {
		...
		switch (left.getType()) {
			...
			case com.google.javascript.rhino.Token.THIS :
				...
				if ((((tt != (com.google.javascript.rhino.Token.THIS)) && (tt != (com.google.javascript.rhino.Token.TRUE))) && (tt != (com.google.javascript.rhino.Token.FALSE))) && (tt != (com.google.javascript.rhino.Token.NULL))) {
					return n;
				}
				switch (op) {
					case com.google.javascript.rhino.Token.SHEQ :
