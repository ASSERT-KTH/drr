...
class Normalize implements com.google.javascript.jscomp.CompilerPass {
	...
	static class NormalizeStatements implements com.google.javascript.jscomp.NodeTraversal.Callback {
		...
		private void annotateConstantsByConvention(com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
			com.google.common.base.Preconditions.checkState((((n.getType()) == (com.google.javascript.rhino.Token.NAME)) || ((n.getType()) == (com.google.javascript.rhino.Token.STRING))));
	...
	private final class DuplicateDeclarationHandler implements com.google.javascript.jscomp.SyntacticScopeCreator.RedeclarationHandler {
		...
		public void onRedeclaration(com.google.javascript.jscomp.Scope s, java.lang.String name, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent, com.google.javascript.rhino.Node gramps, com.google.javascript.rhino.Node nodeWithLineNumber) {
			...
			if ((v != null) && ((v.getParentNode().getType()) == (com.google.javascript.rhino.Token.CATCH))) {
				...
				compiler.report(com.google.javascript.jscomp.JSError.make(com.google.javascript.jscomp.NodeUtil.getSourceName(nodeWithLineNumber), nodeWithLineNumber, com.google.javascript.jscomp.Normalize.CATCH_BLOCK_VAR_ERROR, name));
			}else
