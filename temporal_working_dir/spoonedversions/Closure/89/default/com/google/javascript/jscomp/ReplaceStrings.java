...
public class ReplaceStrings extends com.google.javascript.jscomp.NodeTraversal.AbstractPostOrderCallback implements com.google.javascript.jscomp.CompilerPass {
	...
	private final com.google.javascript.jscomp.NameGenerator nameGenerator = com.google.javascript.jscomp.ReplaceStrings.createNameGenerator();
	...
	class Result {
		...
		void addLocation(com.google.javascript.rhino.Node n) {
			replacementLocations.add(new com.google.javascript.jscomp.ReplaceStrings.Location(((java.lang.String) (n.getProp(com.google.javascript.rhino.Node.SOURCENAME_PROP))), n.getLineno(), n.getCharno()));
		}
	}
	...
	ReplaceStrings(com.google.javascript.jscomp.AbstractCompiler compiler, java.lang.String placeholderToken, java.util.List<java.lang.String> functionsToInspect) {
	...
	private static com.google.javascript.jscomp.NameGenerator createNameGenerator() {
		final java.lang.String namePrefix = "";
		final char[] reservedChars = new char[0];
		final java.util.Set<java.lang.String> reservedNames = com.google.common.collect.ImmutableSet.of();
		return new com.google.javascript.jscomp.NameGenerator(reservedNames, namePrefix, reservedChars);
	}
}
