...
class SanityCheck implements com.google.javascript.jscomp.CompilerPass {
	...
	private com.google.javascript.rhino.Node sanityCheckCodeGeneration(com.google.javascript.rhino.Node root) {
		...
		if (!(source.equals(source2))) {
			compiler.report(com.google.javascript.jscomp.JSError.make(com.google.javascript.jscomp.SanityCheck.GENERATED_BAD_CODE, com.google.javascript.jscomp.Strings.truncateAtMaxLength(source, 1000, true), com.google.javascript.jscomp.Strings.truncateAtMaxLength(source2, 1000, true)));
			throw new java.lang.IllegalStateException("Sanity Check failed");
		}
		return root2;
	}
