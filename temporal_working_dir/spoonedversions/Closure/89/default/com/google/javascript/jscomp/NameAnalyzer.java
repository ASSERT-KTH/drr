...
final class NameAnalyzer implements com.google.javascript.jscomp.CompilerPass {
	...
	private com.google.javascript.jscomp.graph.DiGraph<com.google.javascript.jscomp.NameAnalyzer.JsName, com.google.javascript.jscomp.NameAnalyzer.RefType> referenceGraph = new com.google.javascript.jscomp.graph.LinkedDirectedGraph<com.google.javascript.jscomp.NameAnalyzer.JsName, com.google.javascript.jscomp.NameAnalyzer.RefType>();
...
REGULAR, INHERITANCE;	}
	...
	private class FindReferences implements com.google.javascript.jscomp.NodeTraversal.Callback {
		...
		public boolean shouldTraverse(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
			...
			if ((((parent.getType()) == (com.google.javascript.rhino.Token.VAR)) || ((parent.getType()) == (com.google.javascript.rhino.Token.EXPR_RESULT))) || ((parent.getType()) == (com.google.javascript.rhino.Token.RETURN))) {
		...
		public void visit(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
			...
			if (((parent.getType()) == (com.google.javascript.rhino.Token.INSTANCEOF)) && ((parent.getLastChild()) == n)) {
			...
			if (nodesToKeep.contains(n)) {
				...
				if (referring != null) {
					if ((((parent.getType()) == (com.google.javascript.rhino.Token.NAME)) || ((parent.getType()) == (com.google.javascript.rhino.Token.ASSIGN))) && ((scopes.get(parent)) == referring)) {
	...
	private com.google.javascript.jscomp.NameAnalyzer.NameInformation createNameInformation(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
		...
		while (com.google.javascript.jscomp.NodeUtil.isGet(rootNameNode)) {
