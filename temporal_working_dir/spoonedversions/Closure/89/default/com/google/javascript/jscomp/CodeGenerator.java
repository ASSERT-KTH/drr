			...
			case com.google.javascript.rhino.Token.OBJECTLIT :
				{
					...
					for (com.google.javascript.rhino.Node c = first; c != null; c = c.getNext()) {
						...
						if (((((c.getType()) == (com.google.javascript.rhino.Token.STRING)) && (!(com.google.javascript.rhino.TokenStream.isKeyword(c.getString())))) && (com.google.javascript.rhino.TokenStream.isJSIdentifier(c.getString()))) && (com.google.javascript.jscomp.NodeUtil.isLatin(c.getString()))) {
							add(c.getString());
						}else {
							addExpr(c, 1);
						}
