...
class RenameProperties implements com.google.javascript.jscomp.CompilerPass {
	...
	RenameProperties(com.google.javascript.jscomp.AbstractCompiler compiler, boolean generatePseudoNames) {
		this(compiler, generatePseudoNames, null, null);
	}

	RenameProperties(com.google.javascript.jscomp.AbstractCompiler compiler, boolean generatePseudoNames, com.google.javascript.jscomp.VariableMap prevUsedPropertyMap) {
		this(compiler, generatePseudoNames, prevUsedPropertyMap, null);
	}

	RenameProperties(com.google.javascript.jscomp.AbstractCompiler compiler, boolean generatePseudoNames, com.google.javascript.jscomp.VariableMap prevUsedPropertyMap, @javax.annotation.Nullable
	...
	public void process(com.google.javascript.rhino.Node externs, com.google.javascript.rhino.Node root) {
		...
		for (com.google.javascript.rhino.Node n : callNodeToParentMap.keySet()) {
			com.google.javascript.rhino.Node parent = callNodeToParentMap.get(n);
			com.google.javascript.rhino.Node firstArg = n.getFirstChild().getNext();
			...
			parent.replaceChild(n, com.google.javascript.rhino.Node.newString(sb.toString()));
			changed = true;
		}
		if (changed) {
