...
SEARCHING_ANNOTATION, SEARCHING_NEWLINE, NEXT_IS_ANNOTATION;	}
	...
	JsDocInfoParser(com.google.javascript.jscomp.parsing.JsDocTokenStream stream, java.lang.String sourceName, com.google.javascript.jscomp.parsing.Config config, com.google.javascript.jscomp.mozilla.rhino.ErrorReporter errorReporter) {
		this.stream = stream;
	...
	public static com.google.javascript.rhino.Node parseTypeString(java.lang.String typeString) {
		com.google.javascript.jscomp.parsing.Config config = new com.google.javascript.jscomp.parsing.Config(com.google.common.collect.Sets.<java.lang.String>newHashSet(), com.google.common.collect.Sets.<java.lang.String>newHashSet(), false);
		com.google.javascript.jscomp.parsing.JsDocInfoParser parser = new com.google.javascript.jscomp.parsing.JsDocInfoParser(new com.google.javascript.jscomp.parsing.JsDocTokenStream(typeString), "typeparsing", config, com.google.javascript.jscomp.parsing.NullErrorReporter.forNewRhino());
						...
						if (annotation == null) {
							...
							switch (annotation) {
								...
								case TYPEDEF :
									...
									charno = stream.getCharno();
									token = next();
									com.google.javascript.rhino.Node typeNode = parseAndRecordTypeNode(token, lineno, charno);
		...
		if (token == (com.google.javascript.jscomp.parsing.JsDocToken.LC)) {
			...
			while (true) {
				if (match(com.google.javascript.jscomp.parsing.JsDocToken.STRING)) {
					...
					if (!(suppressionNames.contains(name))) {
						parser.addWarning("msg.jsdoc.suppress.unknown", name, stream.getLineno(), stream.getCharno());
					}
					suppressions.add(stream.getString());
					token = next();
				}else {
					parser.addWarning("msg.jsdoc.suppress", stream.getLineno(), stream.getCharno());
					return token;
				}
			...
			if (!(match(com.google.javascript.jscomp.parsing.JsDocToken.RC))) {
				...
				if (!(jsdocBuilder.recordSuppressions(suppressions))) {
					parser.addWarning("msg.jsdoc.suppress.duplicate", stream.getLineno(), stream.getCharno());
				}
			}
		}
		return token;
		...
		if (token == (com.google.javascript.jscomp.parsing.JsDocToken.LC)) {
			...
			while (true) {
				if (match(com.google.javascript.jscomp.parsing.JsDocToken.STRING)) {
					...
					if ((!(com.google.javascript.jscomp.parsing.JsDocInfoParser.modifiesAnnotationKeywords.contains(name))) && (!(jsdocBuilder.hasParameter(name)))) {
						parser.addWarning("msg.jsdoc.modifies.unknown", name, stream.getLineno(), stream.getCharno());
					}
					modifies.add(stream.getString());
					token = next();
				}else {
					parser.addWarning("msg.jsdoc.modifies", stream.getLineno(), stream.getCharno());
					return token;
				}
				if (match(com.google.javascript.jscomp.parsing.JsDocToken.PIPE)) {
					token = next();
			...
			if (!(match(com.google.javascript.jscomp.parsing.JsDocToken.RC))) {
				...
				if (!(jsdocBuilder.recordModifies(modifies))) {
					parser.addWarning("msg.jsdoc.modifies.duplicate", stream.getLineno(), stream.getCharno());
				}
			}
		}
		return token;
...
PRESERVE, TRIM, SINGLE_LINE;	}
	...
	private com.google.javascript.rhino.Node parseTypeName(com.google.javascript.jscomp.parsing.JsDocToken token) {
		...
		com.google.javascript.rhino.Node typeName = newStringNode(stream.getString());
	...
	private com.google.javascript.rhino.Node parseFunctionType(com.google.javascript.jscomp.parsing.JsDocToken token) {
		...
		if (!(match(com.google.javascript.jscomp.parsing.JsDocToken.RP))) {
			...
			if ((token == (com.google.javascript.jscomp.parsing.JsDocToken.STRING)) && ("this".equals(stream.getString()))) {
				if (match(com.google.javascript.jscomp.parsing.JsDocToken.COLON)) {
					next();
					skipEOLs();
					com.google.javascript.rhino.Node thisType = wrapNode(com.google.javascript.rhino.Token.THIS, parseTypeName(next()));
					if (thisType == null) {
						return null;
					}
	...
	private com.google.javascript.rhino.Node wrapNode(int type, com.google.javascript.rhino.Node n) {
		return n == null ? null : new com.google.javascript.rhino.Node(type, n, stream.getLineno(), stream.getCharno());
	}

	private com.google.javascript.rhino.Node newNode(int type) {
		return new com.google.javascript.rhino.Node(type, stream.getLineno(), stream.getCharno());
	}

	private com.google.javascript.rhino.Node newStringNode(java.lang.String s) {
		return com.google.javascript.rhino.Node.newString(s, stream.getLineno(), stream.getCharno());
	}
