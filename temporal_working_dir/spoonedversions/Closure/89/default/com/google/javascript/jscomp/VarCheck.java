...
class VarCheck extends com.google.javascript.jscomp.NodeTraversal.AbstractPostOrderCallback implements com.google.javascript.jscomp.CompilerPass {
	static final com.google.javascript.jscomp.DiagnosticType UNDEFINED_VAR_ERROR = com.google.javascript.jscomp.DiagnosticType.error("JSC_UNDEFINED_VARIABLE", "variable {0} is undefined");
	...
	static final com.google.javascript.jscomp.DiagnosticType INVALID_FUNCTION_DECL = com.google.javascript.jscomp.DiagnosticType.error("JSC_INVALID_FUNCTION_DECL", "Syntax error: function declaration must have a name");
	...
	private java.util.Set<java.lang.String> varsToDeclareInExterns = com.google.common.collect.Sets.newHashSet();
	...
	VarCheck(com.google.javascript.jscomp.AbstractCompiler compiler, boolean sanityCheck) {
		...
		com.google.javascript.jscomp.VarCheck.this.strictExternCheck = (compiler.getErrorLevel(com.google.javascript.jscomp.JSError.make("", 0, 0, com.google.javascript.jscomp.VarCheck.UNDEFINED_EXTERN_VAR_ERROR))) == (com.google.javascript.jscomp.CheckLevel.ERROR);
	...
	public void visit(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
		...
		if (varName.isEmpty()) {
			com.google.common.base.Preconditions.checkState(com.google.javascript.jscomp.NodeUtil.isFunction(parent));
			if (!(com.google.javascript.jscomp.NodeUtil.isFunctionExpression(parent))) {
				t.report(n, com.google.javascript.jscomp.VarCheck.INVALID_FUNCTION_DECL);
			}
			return ;
		}
		if ((((parent.getType()) == (com.google.javascript.rhino.Token.VAR)) || (com.google.javascript.jscomp.NodeUtil.isFunctionDeclaration(parent))) && (varsToDeclareInExterns.contains(varName))) {
			createSynthesizedExternVar(varName);
	...
	private void createSynthesizedExternVar(java.lang.String varName) {
		com.google.javascript.rhino.Node nameNode = com.google.javascript.rhino.Node.newString(com.google.javascript.rhino.Token.NAME, varName);
		if (compiler.getCodingConvention().isConstant(varName)) {
			nameNode.putBooleanProp(com.google.javascript.rhino.Node.IS_CONSTANT_NAME, true);
		}
		getSynthesizedExternsRoot().addChildToBack(new com.google.javascript.rhino.Node(com.google.javascript.rhino.Token.VAR, nameNode));
	...
	private com.google.javascript.jscomp.CompilerInput getSynthesizedExternsInput() {
		if ((synthesizedExternsInput) == null) {
			synthesizedExternsInput = compiler.newExternInput("{SyntheticVarsDeclar}");
		}
