...
public class TypeCheck implements com.google.javascript.jscomp.CompilerPass , com.google.javascript.jscomp.NodeTraversal.Callback {
	...
	public boolean shouldTraverse(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
		...
		switch (n.getType()) {
			case com.google.javascript.rhino.Token.FUNCTION :
				final com.google.javascript.jscomp.TypeCheck outerThis = com.google.javascript.jscomp.TypeCheck.this;
	...
	public void visit(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
		...
		switch (n.getType()) {
			...
			case com.google.javascript.rhino.Token.NUMBER :
				if ((n.getParent().getType()) != (com.google.javascript.rhino.Token.OBJECTLIT)) {
				...
				if (rightType.isNumber()) {
					...
					if (leftType.isNumber()) {
						...
						if ((leftType.matchesNumberContext()) && (rightType.matchesNumberContext())) {
							...
							validator.expectNotVoid(t, n, leftType, message, getNativeType(com.google.javascript.rhino.jstype.JSTypeNative.STRING_TYPE));
							message = "right side of comparison";
							validator.expectString(t, n, rightType, message);
							validator.expectNotVoid(t, n, rightType, message, getNativeType(com.google.javascript.rhino.jstype.JSTypeNative.STRING_TYPE));
						}
			...
			case com.google.javascript.rhino.Token.OR :
				if ((n.getJSType()) != null) {
					...
					if (((n.getType()) == (com.google.javascript.rhino.Token.OBJECTLIT)) && ((parent.getJSType()) instanceof com.google.javascript.rhino.jstype.EnumType)) {
	...
	private void visitAssign(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node assign) {
		...
		if ((lvalue.getType()) == (com.google.javascript.rhino.Token.GETPROP)) {
			...
			if ((lvalue.getType()) == (com.google.javascript.rhino.Token.NAME)) {
	...
	private void visitGetProp(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
		...
		if (!(validator.expectNotVoid(t, n, childType, "undefined has no properties", getNativeType(com.google.javascript.rhino.jstype.JSTypeNative.OBJECT_TYPE)))) {
			ensureTyped(t, n);
			return ;
		}
	...
	private void visitFunction(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n) {
		...
		if ((functionType.isInterface()) || (functionType.isConstructor())) {
			...
			if (((baseConstructor != null) && (baseConstructor != (getNativeType(com.google.javascript.rhino.jstype.JSTypeNative.OBJECT_FUNCTION_TYPE)))) && (((baseConstructor.isConstructor()) && (functionType.isInterface())) || ((baseConstructor.isInterface()) && (functionType.isConstructor())))) {
	...
	private void checkEnumInitializer(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node value, com.google.javascript.rhino.jstype.JSType primitiveType) {
		if ((value.getType()) == (com.google.javascript.rhino.Token.OBJECTLIT)) {
			...
			if ((value.getJSType()) instanceof com.google.javascript.rhino.jstype.EnumType) {
