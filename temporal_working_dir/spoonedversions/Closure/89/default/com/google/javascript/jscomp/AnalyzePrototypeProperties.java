...
class AnalyzePrototypeProperties implements com.google.javascript.jscomp.CompilerPass {
	...
	private final com.google.javascript.jscomp.graph.LinkedDirectedGraph<com.google.javascript.jscomp.AnalyzePrototypeProperties.NameInfo, com.google.javascript.jscomp.JSModule> symbolGraph = new com.google.javascript.jscomp.graph.LinkedDirectedGraph<com.google.javascript.jscomp.AnalyzePrototypeProperties.NameInfo, com.google.javascript.jscomp.JSModule>();
			...
			if ((n.getType()) == (com.google.javascript.rhino.Token.GETPROP)) {
				...
				if (((n.getType()) == (com.google.javascript.rhino.Token.OBJECTLIT)) && (!((((parent.getType()) == (com.google.javascript.rhino.Token.ASSIGN)) && ((parent.getFirstChild().getType()) == (com.google.javascript.rhino.Token.GETPROP))) && (parent.getFirstChild().getLastChild().getString().equals("prototype"))))) {
					for (com.google.javascript.rhino.Node propNameNode = n.getFirstChild(); propNameNode != null; propNameNode = propNameNode.getNext()) {
						if (((propNameNode.getType()) == (com.google.javascript.rhino.Token.STRING)) && (!(propNameNode.isQuotedString()))) {
			...
			switch (n.getType()) {
				case com.google.javascript.rhino.Token.GETPROP :
					...
					if ((((dest.getType()) == (com.google.javascript.rhino.Token.STRING)) && (com.google.javascript.jscomp.NodeUtil.isExprAssign(grandParent))) && (com.google.javascript.jscomp.NodeUtil.isLhs(n, parent))) {
						...
						com.google.javascript.jscomp.AnalyzePrototypeProperties.Property prop = new com.google.javascript.jscomp.AnalyzePrototypeProperties.AssignmentProperty(grandParent, grandParent.getParent(), t.getModule());
				...
				case com.google.javascript.rhino.Token.ASSIGN :
					...
					if ((map.getType()) == (com.google.javascript.rhino.Token.OBJECTLIT)) {
						for (com.google.javascript.rhino.Node key = map.getFirstChild(); key != null; key = key.getNext()) {
							if ((key.getType()) == (com.google.javascript.rhino.Token.STRING)) {
...
PROPERTY, VAR;	}
	...
	interface Property extends com.google.javascript.jscomp.AnalyzePrototypeProperties.Symbol {
		...
		com.google.javascript.rhino.Node getValueParent();
	}
	...
	static class AssignmentProperty implements com.google.javascript.jscomp.AnalyzePrototypeProperties.Property {
		...
		AssignmentProperty(com.google.javascript.rhino.Node node, com.google.javascript.rhino.Node parent, com.google.javascript.jscomp.JSModule module) {
			this.node = node;
			this.module = module;
		}
		...
		@java.lang.Override
		public void remove() {
			com.google.javascript.jscomp.NodeUtil.removeChild(node.getParent(), node);
		}
		...
		@java.lang.Override
		public com.google.javascript.rhino.Node getValueParent() {
