			...
			if (scopeToDeclareIn.isDeclared(variableName, false)) {
				...
				if ((scopeToDeclareIn.isGlobal()) && (type instanceof com.google.javascript.rhino.jstype.FunctionType)) {
					...
					if ((fnType.isConstructor()) || (fnType.isInterface())) {
						...
						scopeToDeclareIn.declare((variableName + ".prototype"), n, fnType.getPrototype(), compiler.getInput(sourceName), ((superClassCtor == null) || (superClassCtor.getInstanceType().equals(getNativeType(com.google.javascript.rhino.jstype.JSTypeNative.OBJECT_TYPE)))));
					}
				}
			}
		}
