...
class DisambiguateProperties<T> implements com.google.javascript.jscomp.CompilerPass {
	...
	static final com.google.javascript.jscomp.DiagnosticType INVALIDATION = com.google.javascript.jscomp.DiagnosticType.warning("JSC_INVALIDATION", ("Property disambiguator skipping all instances of property {0} " + "because of type {1} node {2}"));
		...
		private void handleGetProp(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n) {
			...
			if (!(prop.scheduleRenaming(n.getLastChild(), processProperty(t, prop, type, null)))) {
				if (showInvalidationWarnings) {
					compiler.report(com.google.javascript.jscomp.JSError.make(t.getSourceName(), n, com.google.javascript.jscomp.DisambiguateProperties.INVALIDATION, name, (type == null ? "null" : type.toString()), n.toString()));
				}
			}
		}
			...
			while (child != null) {
				if ((child.getType()) == (com.google.javascript.rhino.Token.STRING)) {
					...
					if (!(prop.scheduleRenaming(child, processProperty(t, prop, type, null)))) {
						if (showInvalidationWarnings) {
							compiler.report(com.google.javascript.jscomp.JSError.make(t.getSourceName(), child, com.google.javascript.jscomp.DisambiguateProperties.INVALIDATION, name, (type == null ? "null" : type.toString()), n.toString()));
						}
					}
				}
				child = child.getNext();
