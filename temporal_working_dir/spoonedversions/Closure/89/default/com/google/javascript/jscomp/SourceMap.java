...
ALL {
			...
			@java.lang.Override
			public boolean apply(com.google.javascript.rhino.Node node) {
				return (((((com.google.javascript.jscomp.NodeUtil.isCall(node)) || (com.google.javascript.jscomp.NodeUtil.isNew(node))) || (com.google.javascript.jscomp.NodeUtil.isFunction(node))) || (com.google.javascript.jscomp.NodeUtil.isName(node))) || (com.google.javascript.jscomp.NodeUtil.isGet(node))) || ((com.google.javascript.jscomp.NodeUtil.isString(node)) && (((node.getParent().getType()) == (com.google.javascript.rhino.Token.OBJECTLIT)) || (com.google.javascript.jscomp.NodeUtil.isGet(node.getParent()))));
			}
		};	}
