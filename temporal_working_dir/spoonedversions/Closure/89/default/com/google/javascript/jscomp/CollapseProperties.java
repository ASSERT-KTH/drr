...
class CollapseProperties implements com.google.javascript.jscomp.CompilerPass {
	...
	private void inlineAliases(com.google.javascript.jscomp.GlobalNamespace namespace) {
		...
		while (!(workList.isEmpty())) {
			...
			if ((((name.globalSets) == 1) && ((name.localSets) == 0)) && ((name.aliasingGets) > 0)) {
				java.util.List<com.google.javascript.jscomp.GlobalNamespace.Ref> refs = com.google.common.collect.Lists.newArrayList(name.refs);
	...
	private void warnAboutNamespaceAliasing(com.google.javascript.jscomp.GlobalNamespace.Name nameObj, com.google.javascript.jscomp.GlobalNamespace.Ref ref) {
		compiler.report(com.google.javascript.jscomp.JSError.make(ref.sourceName, ref.node, com.google.javascript.jscomp.CollapseProperties.UNSAFE_NAMESPACE_WARNING, nameObj.fullName()));
	}
	...
	private void warnAboutNamespaceRedefinition(com.google.javascript.jscomp.GlobalNamespace.Name nameObj, com.google.javascript.jscomp.GlobalNamespace.Ref ref) {
		compiler.report(com.google.javascript.jscomp.JSError.make(ref.sourceName, ref.node, com.google.javascript.jscomp.CollapseProperties.NAMESPACE_REDEFINED_WARNING, nameObj.fullName()));
	}
	...
	private void flattenReferencesToCollapsibleDescendantNames(com.google.javascript.jscomp.GlobalNamespace.Name n, java.lang.String alias) {
		...
		for (com.google.javascript.jscomp.GlobalNamespace.Name p : n.props) {
			java.lang.String propAlias = com.google.javascript.jscomp.CollapseProperties.appendPropForAlias(alias, p.name);
			if (p.canCollapse()) {
	...
	private void flattenReferencesTo(com.google.javascript.jscomp.GlobalNamespace.Name n, java.lang.String alias) {
		if ((n.refs) != null) {
			...
			for (com.google.javascript.jscomp.GlobalNamespace.Ref r : n.refs) {
	...
	private void flattenNameRefAtDepth(java.lang.String alias, com.google.javascript.rhino.Node n, int depth, java.lang.String originalName) {
		...
		boolean isObjKey = (nType == (com.google.javascript.rhino.Token.STRING)) || (nType == (com.google.javascript.rhino.Token.NUMBER));
	...
	private void collapseDeclarationOfNameAndDescendants(com.google.javascript.jscomp.GlobalNamespace.Name n, java.lang.String alias) {
		...
		if ((n.props) != null) {
			for (com.google.javascript.jscomp.GlobalNamespace.Name p : n.props) {
				collapseDeclarationOfNameAndDescendants(p, com.google.javascript.jscomp.CollapseProperties.appendPropForAlias(alias, p.name));
				if ((((((!(p.inExterns)) && canCollapseChildNames) && ((p.declaration) != null)) && ((p.declaration.node) != null)) && ((p.declaration.node.getParent()) != null)) && ((p.declaration.node.getParent().getType()) == (com.google.javascript.rhino.Token.ASSIGN))) {
					updateSimpleDeclaration(com.google.javascript.jscomp.CollapseProperties.appendPropForAlias(alias, p.name), p, p.declaration);
				}
			}
		}
	}
	...
	private void updateObjLitOrFunctionDeclaration(com.google.javascript.jscomp.GlobalNamespace.Name n, java.lang.String alias) {
	...
	private void updateObjLitOrFunctionDeclarationAtAssignNode(com.google.javascript.jscomp.GlobalNamespace.Name n, java.lang.String alias) {
		...
		if (isObjLit && (n.canEliminate())) {
			...
			if (ref.node.getLastChild().getBooleanProp(com.google.javascript.rhino.Node.IS_CONSTANT_NAME)) {
			...
			com.google.javascript.jscomp.NodeTraversal.traverse(compiler, function.getLastChild(), new com.google.javascript.jscomp.NodeTraversal.AbstractShallowCallback() {
				public void visit(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
					if ((n.getType()) == (com.google.javascript.rhino.Token.THIS)) {
						compiler.report(com.google.javascript.jscomp.JSError.make(name.declaration.sourceName, n, com.google.javascript.jscomp.CollapseProperties.UNSAFE_THIS, name.fullName()));
					}
				}
			});
		}
	...
	private void updateObjLitOrFunctionDeclarationAtVarNode(com.google.javascript.jscomp.GlobalNamespace.Name n) {
		com.google.javascript.jscomp.GlobalNamespace.Ref ref = n.declaration;
	...
	private void updateFunctionDeclarationAtFunctionNode(com.google.javascript.jscomp.GlobalNamespace.Name n) {
		com.google.javascript.jscomp.GlobalNamespace.Ref ref = n.declaration;
		...
		if ((n.props) != null) {
			for (com.google.javascript.jscomp.GlobalNamespace.Name p : n.props) {
				if (p.needsToBeStubbed()) {
					...
					numStubs++;
					compiler.reportCodeChange();
					if (p.refs.get(0).node.getLastChild().getBooleanProp(com.google.javascript.rhino.Node.IS_CONSTANT_NAME)) {
						nameNode.putBooleanProp(com.google.javascript.rhino.Node.IS_CONSTANT_NAME, true);
					}
				}
			}
