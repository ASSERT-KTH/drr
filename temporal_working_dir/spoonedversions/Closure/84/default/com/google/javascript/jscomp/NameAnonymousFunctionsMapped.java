...
class NameAnonymousFunctionsMapped implements com.google.javascript.jscomp.CompilerPass {
	...
	NameAnonymousFunctionsMapped(com.google.javascript.jscomp.AbstractCompiler compiler) {
		this.compiler = compiler;
		nameGenerator = new com.google.javascript.jscomp.NameGenerator(java.util.Collections.<java.lang.String>emptySet(), com.google.javascript.jscomp.NameAnonymousFunctionsMapped.PREFIX_STRING, null);
		renameMap = com.google.common.collect.Maps.newHashMap();
	}
	...
	public void process(com.google.javascript.rhino.Node externs, com.google.javascript.rhino.Node root) {
		...
		com.google.javascript.jscomp.NameAnonymousFunctionsMapped.logger.info((((("Named " + (namedCount)) + " anon functions using ") + (bytesUsed)) + " bytes"));
		if ((namedCount) > 0) {
