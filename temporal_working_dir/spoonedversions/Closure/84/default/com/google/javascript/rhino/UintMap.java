...
public class UintMap implements java.io.Serializable {
	...
	public UintMap(int initialCapacity) {
		...
		power = i;
		if ((com.google.javascript.rhino.UintMap.check) && ((power) < 2))
			com.google.javascript.rhino.Kit.codeBug();
	...
	private int insertNewKey(int key) {
		if ((com.google.javascript.rhino.UintMap.check) && ((occupiedCount) != (keyCount)))
			com.google.javascript.rhino.Kit.codeBug();
		
		if ((com.google.javascript.rhino.UintMap.check) && ((keyCount) == (1 << (power))))
			com.google.javascript.rhino.Kit.codeBug();
		...
		if ((keys[index]) != (com.google.javascript.rhino.UintMap.EMPTY)) {
			...
			do {
				if ((com.google.javascript.rhino.UintMap.check) && ((keys[index]) == (com.google.javascript.rhino.UintMap.DELETED)))
					com.google.javascript.rhino.Kit.codeBug();
				
				index = (index + step) & mask;
				if ((com.google.javascript.rhino.UintMap.check) && (firstIndex == index))
					com.google.javascript.rhino.Kit.codeBug();
	...
	private int ensureIndex(int key, boolean intType) {
		...
		if (((com.google.javascript.rhino.UintMap.check) && (keys != null)) && ((keys[index]) != (com.google.javascript.rhino.UintMap.EMPTY)))
			com.google.javascript.rhino.Kit.codeBug();
