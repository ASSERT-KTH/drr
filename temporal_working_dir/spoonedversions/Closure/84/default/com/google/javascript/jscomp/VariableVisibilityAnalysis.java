...
public class VariableVisibilityAnalysis implements com.google.javascript.jscomp.CompilerPass {
...
LOCAL, CAPTURED_LOCAL, PARAMETER, GLOBAL;	}
	...
	public com.google.javascript.jscomp.VariableVisibilityAnalysis.VariableVisibility getVariableVisibility(com.google.javascript.rhino.Node declaringNameNode) {
		...
		com.google.common.base.Preconditions.checkArgument((((com.google.javascript.jscomp.NodeUtil.isVar(parent)) || (com.google.javascript.jscomp.NodeUtil.isFunction(parent))) || ((parent.getType()) == (com.google.javascript.rhino.Token.LP))));
	...
	private static boolean variableIsParameter(com.google.javascript.jscomp.Scope.Var variable) {
		...
		return (variableParent != null) && ((variableParent.getType()) == (com.google.javascript.rhino.Token.LP));
	}
}
