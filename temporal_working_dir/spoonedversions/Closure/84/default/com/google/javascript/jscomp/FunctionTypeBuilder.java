	...
	private class ExtendedTypeValidator implements com.google.common.base.Predicate<com.google.javascript.rhino.jstype.JSType> {
		...
		public boolean apply(com.google.javascript.rhino.jstype.JSType type) {
			...
			if (objectType == null) {
				...
				if ((objectType.isUnknownType()) && (((objectType.getImplicitPrototype()) == null) || (objectType.getImplicitPrototype().isResolved()))) {
	...
	com.google.javascript.rhino.Node owner) {
		...
		if (maybeThisType != null) {
			...
			if ((owner != null) && ((info == null) || (!(info.hasType())))) {
				...
				com.google.javascript.rhino.jstype.ObjectType ownerType = com.google.javascript.rhino.jstype.ObjectType.cast(typeRegistry.getForgivingType(scope, ownerTypeName, sourceName, owner.getLineno(), owner.getCharno()));
				if (ownerType != null) {
					thisType = ownerType;
				}
			}
