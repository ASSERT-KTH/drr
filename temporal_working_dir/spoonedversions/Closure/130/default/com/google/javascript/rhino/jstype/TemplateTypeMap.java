...
public class TemplateTypeMap implements java.io.Serializable {
	...
	TemplateTypeMap(com.google.javascript.rhino.jstype.JSTypeRegistry registry, com.google.common.collect.ImmutableList<com.google.javascript.rhino.jstype.TemplateType> templateKeys, com.google.common.collect.ImmutableList<com.google.javascript.rhino.jstype.JSType> templateValues) {
	...
	public boolean hasTemplateKey(com.google.javascript.rhino.jstype.TemplateType templateKey) {
		for (com.google.javascript.rhino.jstype.TemplateType entry : templateKeys) {
	...
	public boolean hasTemplateType(com.google.javascript.rhino.jstype.TemplateType key) {
		return (getTemplateTypeInternal(key)) != null;
	}

	public com.google.javascript.rhino.jstype.JSType getTemplateType(com.google.javascript.rhino.jstype.TemplateType key) {
	...
	public com.google.javascript.rhino.jstype.TemplateType getTemplateTypeKeyByName(java.lang.String keyName) {
		for (com.google.javascript.rhino.jstype.TemplateType key : templateKeys) {
	...
	private com.google.javascript.rhino.jstype.JSType getTemplateTypeInternal(com.google.javascript.rhino.jstype.TemplateType key) {
		int index = 0;
		for (com.google.javascript.rhino.jstype.TemplateType item : templateKeys) {
			if (item == key) {
				break;
			}
			index++;
	...
	com.google.javascript.rhino.jstype.TemplateTypeMap extendKeys(com.google.common.collect.ImmutableList<com.google.javascript.rhino.jstype.TemplateType> newKeys) {
