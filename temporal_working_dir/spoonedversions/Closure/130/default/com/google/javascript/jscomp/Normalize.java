...
class Normalize implements com.google.javascript.jscomp.CompilerPass {
	...
	static com.google.javascript.rhino.Node parseAndNormalizeSyntheticCode(com.google.javascript.jscomp.AbstractCompiler compiler, java.lang.String code, java.lang.String prefix) {
		...
		com.google.javascript.jscomp.NodeTraversal.traverse(compiler, js, new com.google.javascript.jscomp.MakeDeclaredNamesUnique(new com.google.javascript.jscomp.MakeDeclaredNamesUnique.BoilerplateRenamer(compiler.getCodingConvention(), compiler.getUniqueNameIdSupplier(), prefix)));
		return js;
	}

	static com.google.javascript.rhino.Node parseAndNormalizeTestCode(com.google.javascript.jscomp.AbstractCompiler compiler, java.lang.String code) {
		...
		public void visit(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
			if (com.google.javascript.jscomp.NodeUtil.isExprAssign(n)) {
				...
				if ((n.isStringKey()) && (isMarkedExpose(n))) {
					...
					if (((n.isGetProp()) && (n.getParent().isExprResult())) && (isMarkedExpose(n))) {
	...
	static class NormalizeStatements implements com.google.javascript.jscomp.NodeTraversal.Callback {
		...
		private void annotateConstantsByConvention(com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
			...
			boolean isObjLitKey = com.google.javascript.jscomp.NodeUtil.isObjectLitKey(n);
		...
		private void doStatementNormalizations(com.google.javascript.rhino.Node n) {
			if (n.isLabel()) {
				normalizeLabels(n);
			}
