...
public class TokenStream {
	...
	public static boolean isJSIdentifier(java.lang.String s) {
		int length = s.length();
		if (((length == 0) || (java.lang.Character.isIdentifierIgnorable(s.charAt(0)))) || (!(java.lang.Character.isJavaIdentifierStart(s.charAt(0))))) {
			return false;
		}
		for (int i = 1; i < length; i++) {
			if ((java.lang.Character.isIdentifierIgnorable(s.charAt(i))) || (!(java.lang.Character.isJavaIdentifierPart(s.charAt(i))))) {
				return false;
			}
		}
		return true;
