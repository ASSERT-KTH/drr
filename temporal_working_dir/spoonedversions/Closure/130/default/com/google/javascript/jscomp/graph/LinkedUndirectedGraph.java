...
public class LinkedUndirectedGraph<N, E> extends com.google.javascript.jscomp.graph.UndiGraph<N, E> implements com.google.javascript.jscomp.graph.GraphvizGraph {
	...
	public static <N, E> com.google.javascript.jscomp.graph.LinkedUndirectedGraph<N, E> createWithoutAnnotations() {
		return new com.google.javascript.jscomp.graph.LinkedUndirectedGraph<N, E>(false, false);
	}

	public static <N, E> com.google.javascript.jscomp.graph.LinkedUndirectedGraph<N, E> createWithNodeAnnotations() {
		return new com.google.javascript.jscomp.graph.LinkedUndirectedGraph<N, E>(true, false);
	}

	public static <N, E> com.google.javascript.jscomp.graph.LinkedUndirectedGraph<N, E> createWithEdgeAnnotations() {
		return new com.google.javascript.jscomp.graph.LinkedUndirectedGraph<N, E>(false, true);
	}

	public static <N, E> com.google.javascript.jscomp.graph.LinkedUndirectedGraph<N, E> create() {
		return new com.google.javascript.jscomp.graph.LinkedUndirectedGraph<N, E>(true, true);
	}
	...
	public void connect(N srcValue, E edgeValue, N destValue) {
		...
		com.google.javascript.jscomp.graph.LinkedUndirectedGraph.LinkedUndirectedGraphEdge<N, E> edge = useEdgeAnnotations ? new com.google.javascript.jscomp.graph.LinkedUndirectedGraph.AnnotatedLinkedUndirectedGraphEdge<N, E>(src, edgeValue, dest) : new com.google.javascript.jscomp.graph.LinkedUndirectedGraph.LinkedUndirectedGraphEdge<N, E>(src, edgeValue, dest);
	...
	public com.google.javascript.jscomp.graph.UndiGraph.UndiGraphNode<N, E> createUndirectedGraphNode(N nodeValue) {
		...
		if (node == null) {
			node = (useNodeAnnotations) ? new com.google.javascript.jscomp.graph.LinkedUndirectedGraph.AnnotatedLinkedUndirectedGraphNode<N, E>(nodeValue) : new com.google.javascript.jscomp.graph.LinkedUndirectedGraph.LinkedUndirectedGraphNode<N, E>(nodeValue);
	...
	public java.util.Iterator<com.google.javascript.jscomp.graph.GraphNode<N, E>> getNeighborNodesIterator(N value) {
		...
		com.google.common.base.Preconditions.checkNotNull(uNode, "%s should be in the graph.", value);
	...
	public com.google.javascript.jscomp.graph.Graph.GraphEdge<N, E> getFirstEdge(N n1, N n2) {
		com.google.javascript.jscomp.graph.UndiGraph.UndiGraphNode<N, E> dNode1 = getNodeOrFail(n1);
		com.google.javascript.jscomp.graph.UndiGraph.UndiGraphNode<N, E> dNode2 = getNodeOrFail(n2);
		for (com.google.javascript.jscomp.graph.UndiGraph.UndiGraphEdge<N, E> outEdge : dNode1.getNeighborEdges()) {
			if (((outEdge.getNodeA()) == dNode2) || ((outEdge.getNodeB()) == dNode2)) {
				return outEdge;
			}
	...
	static class AnnotatedLinkedUndirectedGraphNode<N, E> extends com.google.javascript.jscomp.graph.LinkedUndirectedGraph.LinkedUndirectedGraphNode<N, E> {
	...
	static class LinkedUndirectedGraphEdge<N, E> implements com.google.javascript.jscomp.graph.GraphvizGraph.GraphvizEdge , com.google.javascript.jscomp.graph.UndiGraph.UndiGraphEdge<N, E> {
		...
		LinkedUndirectedGraphEdge(com.google.javascript.jscomp.graph.UndiGraph.UndiGraphNode<N, E> nodeA, E edgeValue, com.google.javascript.jscomp.graph.UndiGraph.UndiGraphNode<N, E> nodeB) {
	...
	static class AnnotatedLinkedUndirectedGraphEdge<N, E> extends com.google.javascript.jscomp.graph.LinkedUndirectedGraph.LinkedUndirectedGraphEdge<N, E> {
		protected com.google.javascript.jscomp.graph.Annotation annotation;

		AnnotatedLinkedUndirectedGraphEdge(com.google.javascript.jscomp.graph.UndiGraph.UndiGraphNode<N, E> nodeA, E edgeValue, com.google.javascript.jscomp.graph.UndiGraph.UndiGraphNode<N, E> nodeB) {
