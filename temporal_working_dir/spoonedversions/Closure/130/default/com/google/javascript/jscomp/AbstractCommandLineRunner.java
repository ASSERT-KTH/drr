...
abstract class AbstractCommandLineRunner<A extends com.google.javascript.jscomp.Compiler, B extends com.google.javascript.jscomp.CompilerOptions> {
	static final com.google.javascript.jscomp.DiagnosticType OUTPUT_SAME_AS_INPUT_ERROR = com.google.javascript.jscomp.DiagnosticType.error("JSC_OUTPUT_SAME_AS_INPUT_ERROR", "Bad output file (already listed as input file): {0}");
	...
	protected int doRun() throws com.google.javascript.jscomp.AbstractCommandLineRunner.FlagUsageException, java.io.IOException {
		...
		java.util.List<java.lang.String> outputFileNames = com.google.common.collect.Lists.newArrayList();
		...
		for (java.lang.String outputFileName : outputFileNames) {
			if ((compiler.getSourceFileByName(outputFileName)) != null) {
				compiler.report(com.google.javascript.jscomp.JSError.make(com.google.javascript.jscomp.AbstractCommandLineRunner.OUTPUT_SAME_AS_INPUT_ERROR, outputFileName));
				return 1;
			}
		}
	...
	static class CommandLineConfig {
		...
		com.google.javascript.jscomp.AbstractCommandLineRunner.CommandLineConfig setAngularPass(boolean angularPass) {
			com.google.javascript.jscomp.AbstractCommandLineRunner.CommandLineConfig.this.angularPass = angularPass;
			return com.google.javascript.jscomp.AbstractCommandLineRunner.CommandLineConfig.this;
		}
	}
