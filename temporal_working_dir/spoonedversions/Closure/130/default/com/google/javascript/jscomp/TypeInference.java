				...
				case ON_TRUE :
					if (com.google.javascript.jscomp.NodeUtil.isForIn(source)) {
						...
						if (item.isName()) {
							...
							com.google.javascript.rhino.jstype.JSType objIndexType = objType == null ? null : objType.getTemplateTypeMap().getTemplateType(registry.getObjectIndexKey());
				...
				if (paramType.isFunctionType()) {
					...
					if (paramType.isTemplatizedType()) {
						...
						if (argObjectType.isSubtype(referencedParamType)) {
							...
							for (com.google.javascript.rhino.jstype.TemplateType key : paramTypeMap.getTemplateKeys()) {
