...
public abstract class JSType implements java.io.Serializable {
	...
	private final com.google.common.collect.ImmutableList<com.google.javascript.rhino.jstype.JSType> templatizedTypes;
	...
	JSType(com.google.javascript.rhino.jstype.JSTypeRegistry registry, com.google.common.collect.ImmutableList<java.lang.String> templateKeys, com.google.common.collect.ImmutableList<com.google.javascript.rhino.jstype.JSType> templatizedTypes) {
		...
		if (typesLength > keysLength) {
			throw new java.lang.IllegalArgumentException("Cannot have more templatized types than template keys");
		}else
			if (typesLength < keysLength) {
				...
				for (int i = 0; i < (keysLength - typesLength); i++) {
					builder.add(registry.getNativeType(com.google.javascript.rhino.jstype.JSTypeNative.UNKNOWN_TYPE));
				}
				templatizedTypes = builder.build();
			}else
				if ((keysLength == 0) && (typesLength == 0)) {
					templateKeys = com.google.common.collect.ImmutableList.of();
					templatizedTypes = com.google.common.collect.ImmutableList.of();
				}
	...
	public static com.google.javascript.rhino.jstype.ParameterizedType toMaybeParameterizedType(com.google.javascript.rhino.jstype.JSType type) {
	...
	boolean hasAnyTemplateTypesInternal() {
		if (isTemplatized()) {
			for (com.google.javascript.rhino.jstype.JSType templatizedType : templatizedTypes) {
	...
	public com.google.common.collect.ImmutableList<com.google.javascript.rhino.jstype.JSType> getTemplatizedTypes() {
		return templatizedTypes;
	}

	public boolean hasTemplatizedType(java.lang.String key) {
		return templateKeys.contains(key);
	}

	public com.google.javascript.rhino.jstype.JSType getTemplatizedType(java.lang.String key) {
	...
	static boolean hasEquivalentTemplateTypes(com.google.javascript.rhino.jstype.JSType type1, com.google.javascript.rhino.jstype.JSType type2, com.google.javascript.rhino.jstype.EquivalenceMethod eqMethod) {
		com.google.common.collect.ImmutableList<com.google.javascript.rhino.jstype.JSType> templatizedTypes1 = type1.getTemplatizedTypes();
		com.google.common.collect.ImmutableList<com.google.javascript.rhino.jstype.JSType> templatizedTypes2 = type2.getTemplatizedTypes();
		...
		for (int i = 0; i < nTemplatizedTypes1; i++) {
			com.google.javascript.rhino.jstype.JSType templatizedType1 = templatizedTypes1.get(i);
			com.google.javascript.rhino.jstype.JSType templatizedType2 = templatizedTypes2.get(i);
	...
	boolean checkEquivalenceHelper(com.google.javascript.rhino.jstype.JSType that, com.google.javascript.rhino.jstype.EquivalenceMethod eqMethod) {
		...
		com.google.javascript.rhino.jstype.ParameterizedType thisParamType = toMaybeParameterizedType();
		com.google.javascript.rhino.jstype.ParameterizedType thatParamType = that.toMaybeParameterizedType();
		if ((thisParamType != null) || (thatParamType != null)) {
			boolean paramsMatch = false;
			if ((thisParamType != null) && (thatParamType != null)) {
				paramsMatch = thisParamType.getParameterType().checkEquivalenceHelper(thatParamType.getParameterType(), eqMethod);
			}else
				if (eqMethod == (com.google.javascript.rhino.jstype.EquivalenceMethod.IDENTITY)) {
					paramsMatch = false;
				}else {
					paramsMatch = true;
				}
			
			com.google.javascript.rhino.jstype.JSType thisRootType = thisParamType == null ? com.google.javascript.rhino.jstype.JSType.this : thisParamType.getReferencedTypeInternal();
			com.google.javascript.rhino.jstype.JSType thatRootType = thatParamType == null ? that : thatParamType.getReferencedTypeInternal();
