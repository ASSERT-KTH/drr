...
ALL, LOCAL_ONLY, NONE;	}
	...
	public void setReplaceMessagesWithChromeI18n(boolean replaceMessagesWithChromeI18n, java.lang.String tcProjectId) {
		if ((replaceMessagesWithChromeI18n && ((messageBundle) != null)) && (!((messageBundle) instanceof com.google.javascript.jscomp.EmptyMessageBundle))) {
			throw new java.lang.RuntimeException(("When replacing messages with " + "chrome.i18n.getMessage, a message bundle should not be specified."));
		}
		com.google.javascript.jscomp.CompilerOptions.this.replaceMessagesWithChromeI18n = replaceMessagesWithChromeI18n;
		com.google.javascript.jscomp.CompilerOptions.this.tcProjectId = tcProjectId;
	}
	...
	public void setPreferSingleQuotes(boolean enabled) {
		com.google.javascript.jscomp.CompilerOptions.this.preferSingleQuotes = enabled;
	}
	...
	public void setIdGeneratorsMap(java.lang.String previousMappings) {
		com.google.javascript.jscomp.CompilerOptions.this.idGeneratorsMapSerialized = previousMappings;
	}
	...
	public void setSaveDataStructures(boolean save) {
		com.google.javascript.jscomp.CompilerOptions.this.saveDataStructures = save;
	}
	...
	public void setInputAnonymousFunctionNamingMap(com.google.javascript.jscomp.VariableMap inputMap) {
		com.google.javascript.jscomp.CompilerOptions.this.inputAnonymousFunctionNamingMap = inputMap;
	}

	@java.lang.Deprecated
	public void setInputVariableMapSerialized(byte[] inputVariableMapSerialized) throws java.text.ParseException {
		com.google.javascript.jscomp.CompilerOptions.this.inputVariableMap = com.google.javascript.jscomp.VariableMap.fromBytes(inputVariableMapSerialized);
	}

	public void setInputVariableMap(com.google.javascript.jscomp.VariableMap inputVariableMap) {
		com.google.javascript.jscomp.CompilerOptions.this.inputVariableMap = inputVariableMap;
	}

	@java.lang.Deprecated
	public void setInputPropertyMapSerialized(byte[] inputPropertyMapSerialized) throws java.text.ParseException {
		com.google.javascript.jscomp.CompilerOptions.this.inputPropertyMap = com.google.javascript.jscomp.VariableMap.fromBytes(inputPropertyMapSerialized);
	}

	public void setInputPropertyMap(com.google.javascript.jscomp.VariableMap inputPropertyMap) {
		com.google.javascript.jscomp.CompilerOptions.this.inputPropertyMap = inputPropertyMap;
	}
	...
	public void setCssRenamingWhitelist(java.util.Set<java.lang.String> whitelist) {
		com.google.javascript.jscomp.CompilerOptions.this.cssRenamingWhitelist = whitelist;
	}
	...
	public void setReplaceStringsInputMap(com.google.javascript.jscomp.VariableMap serializedMap) {
		com.google.javascript.jscomp.CompilerOptions.this.replaceStringsInputMap = serializedMap;
	}
...
ECMASCRIPT3, ECMASCRIPT5, ECMASCRIPT5_STRICT;
		public static com.google.javascript.jscomp.CompilerOptions.LanguageMode fromString(java.lang.String value) {
			if ((value.equals("ECMASCRIPT5_STRICT")) || (value.equals("ES5_STRICT"))) {
				return com.google.javascript.jscomp.CompilerOptions.LanguageMode.ECMASCRIPT5_STRICT;
			}else
				if ((value.equals("ECMASCRIPT5")) || (value.equals("ES5"))) {
					return com.google.javascript.jscomp.CompilerOptions.LanguageMode.ECMASCRIPT5;
				}else
					if ((value.equals("ECMASCRIPT3")) || (value.equals("ES3"))) {
						return com.google.javascript.jscomp.CompilerOptions.LanguageMode.ECMASCRIPT3;
					}
