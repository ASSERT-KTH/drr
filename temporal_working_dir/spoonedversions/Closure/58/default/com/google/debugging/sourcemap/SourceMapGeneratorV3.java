...
public class SourceMapGeneratorV3 implements com.google.debugging.sourcemap.SourceMapGenerator {
	...
	public void appendIndexMapTo(java.lang.Appendable out, java.lang.String name, java.util.List<com.google.debugging.sourcemap.SourceMapSection> sections) throws java.io.IOException {
		...
		for (com.google.debugging.sourcemap.SourceMapSection section : sections) {
			...
			out.append("{\n");
			com.google.debugging.sourcemap.SourceMapGeneratorV3.appendFirstField(out, "offset", offsetValue(section.getLine(), section.getColumn()));
	...
	private java.lang.CharSequence offsetValue(int line, int column) throws java.io.IOException {
		java.lang.StringBuilder out = new java.lang.StringBuilder();
		out.append("{\n");
		com.google.debugging.sourcemap.SourceMapGeneratorV3.appendFirstField(out, "line", java.lang.String.valueOf(line));
		com.google.debugging.sourcemap.SourceMapGeneratorV3.appendField(out, "column", java.lang.String.valueOf(column));
		out.append("\n}");
		return out;
	}
