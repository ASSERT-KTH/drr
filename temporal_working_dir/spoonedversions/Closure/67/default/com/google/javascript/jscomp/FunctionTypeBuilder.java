...
final class FunctionTypeBuilder {
	...
	com.google.javascript.rhino.Node sourceNode) {
		com.google.javascript.jscomp.FunctionTypeBuilder.this.sourceNode = sourceNode;
	...
	com.google.javascript.jscomp.FunctionTypeBuilder inferReturnStatementsAsLastResort(@javax.annotation.Nullable
	com.google.javascript.rhino.Node functionBlock) {
		...
		if ((returnType) == null) {
			...
			while (!(worklist.isEmpty())) {
				...
				if ((cType == (com.google.javascript.rhino.Token.RETURN)) && ((current.getFirstChild()) != null)) {
					hasNonEmptyReturns = true;
					break;
				}else
					if ((com.google.javascript.jscomp.NodeUtil.isStatementBlock(current)) || (com.google.javascript.jscomp.NodeUtil.isControlStructure(current))) {
	...
	com.google.javascript.jscomp.FunctionTypeBuilder inferThisType(com.google.javascript.rhino.JSDocInfo info, com.google.javascript.rhino.jstype.JSType type) {
		inferThisType(info, ((com.google.javascript.rhino.Node) (null)));
		if ((thisType) == null) {
	...
	com.google.javascript.rhino.Node owner) {
		...
		if (maybeThisType != null) {
			...
			if ((owner != null) && ((info == null) || (!(info.hasType())))) {
				java.lang.String ownerTypeName = owner.getQualifiedName();
				com.google.javascript.jscomp.Scope.Var ownerVar = scope.getVar(ownerTypeName);
				com.google.javascript.rhino.jstype.JSType ownerType = ownerVar == null ? null : ownerVar.getType();
				com.google.javascript.rhino.jstype.FunctionType ownerFnType = ownerType instanceof com.google.javascript.rhino.jstype.FunctionType ? ((com.google.javascript.rhino.jstype.FunctionType) (ownerType)) : null;
				com.google.javascript.rhino.jstype.ObjectType instType = (ownerFnType == null) || (ownerFnType.isOrdinaryFunction()) ? null : ownerFnType.getInstanceType();
				if (instType != null) {
					thisType = instType;
				}
			}
	...
	com.google.javascript.jscomp.FunctionTypeBuilder inferParameterTypes(com.google.javascript.rhino.JSDocInfo info) {
		...
		for (java.lang.String name : info.getParameterNames()) {
			lp.addChildToBack(com.google.javascript.rhino.Node.newString(com.google.javascript.rhino.Token.NAME, name));
		}
	...
	private com.google.javascript.rhino.jstype.FunctionType getOrCreateConstructor() {
		...
		if (existingType != null) {
			...
			if (isInstanceObject || (fnName.equals("Function"))) {
				com.google.javascript.rhino.jstype.FunctionType existingFn = isInstanceObject ? ((com.google.javascript.rhino.jstype.InstanceObjectType) (existingType)).getConstructor() : typeRegistry.getNativeFunctionType(com.google.javascript.rhino.jstype.JSTypeNative.FUNCTION_FUNCTION_TYPE);
