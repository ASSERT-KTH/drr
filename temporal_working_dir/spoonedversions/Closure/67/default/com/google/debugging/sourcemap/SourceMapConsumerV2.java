...
public class SourceMapConsumerV2 implements com.google.debugging.sourcemap.SourceMapConsumer {
	...
	private void parseInternal(org.json.JSONObject sourceMapRoot) throws com.google.debugging.sourcemap.SourceMapParseException, org.json.JSONException {
	...
	public com.google.debugging.sourcemap.proto.Mapping.OriginalMapping getMappingForLine(int lineNumber, int columnIndex) {
		...
		com.google.common.base.Preconditions.checkState((lineNumber >= 0), "Line number must be >= 0");
		com.google.common.base.Preconditions.checkState((columnIndex >= 0), "Column index must be >= 0");
