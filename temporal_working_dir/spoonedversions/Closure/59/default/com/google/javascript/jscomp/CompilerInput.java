...
public class CompilerInput implements com.google.javascript.jscomp.SourceAst , com.google.javascript.jscomp.deps.DependencyInfo , com.google.javascript.rhino.jstype.StaticSourceFile {
	...
	public CompilerInput(com.google.javascript.jscomp.JSSourceFile file, boolean isExtern) {
		this(new com.google.javascript.jscomp.JsAst(file), file.getName(), isExtern);
	}
	...
	private void findLineOffsets() {
		try {
			java.lang.String[] sourceLines = ast.getSourceFile().getCode().split("\n");
