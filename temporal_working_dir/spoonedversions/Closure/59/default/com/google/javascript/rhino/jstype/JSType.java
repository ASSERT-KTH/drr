...
public abstract class JSType implements java.io.Serializable {
	...
	public final com.google.javascript.rhino.jstype.ObjectType dereference() {
		...
		return com.google.javascript.rhino.jstype.ObjectType.cast((autobox == null ? restricted : autobox));
	}
	...
	public com.google.javascript.rhino.jstype.JSType getLeastSupertype(com.google.javascript.rhino.jstype.JSType that) {
		if (that.isUnionType()) {
			return that.getLeastSupertype(com.google.javascript.rhino.jstype.JSType.this);
		}
	...
	public com.google.javascript.rhino.jstype.JSType getGreatestSubtype(com.google.javascript.rhino.jstype.JSType that) {
		if (that.isRecordType()) {
			return that.getGreatestSubtype(com.google.javascript.rhino.jstype.JSType.this);
		}
	...
	static com.google.javascript.rhino.jstype.JSType getGreatestSubtype(com.google.javascript.rhino.jstype.JSType thisType, com.google.javascript.rhino.jstype.JSType thatType) {
				...
				if (thisType.isSubtype(thatType)) {
					...
					if (thatType.isSubtype(thisType)) {
						...
						if (thisType.isUnionType()) {
							return ((com.google.javascript.rhino.jstype.UnionType) (thisType)).meet(thatType);
						}else
							if (thatType.isUnionType()) {
								return ((com.google.javascript.rhino.jstype.UnionType) (thatType)).meet(thisType);
							}
		...
		if (thisType instanceof com.google.javascript.rhino.jstype.EnumElementType) {
			com.google.javascript.rhino.jstype.JSType inf = ((com.google.javascript.rhino.jstype.EnumElementType) (thisType)).meet(thatType);
			if (inf != null) {
				return inf;
			}
		}else
			if (thatType instanceof com.google.javascript.rhino.jstype.EnumElementType) {
				com.google.javascript.rhino.jstype.JSType inf = ((com.google.javascript.rhino.jstype.EnumElementType) (thatType)).meet(thisType);
				if (inf != null) {
					return inf;
				}
			}
	...
	static com.google.javascript.rhino.jstype.JSType filterNoResolvedType(com.google.javascript.rhino.jstype.JSType type) {
		if (type.isNoResolvedType()) {
			...
			if (type instanceof com.google.javascript.rhino.jstype.UnionType) {
				com.google.javascript.rhino.jstype.UnionType unionType = ((com.google.javascript.rhino.jstype.UnionType) (type));
	...
	public com.google.javascript.rhino.jstype.JSType.TypePair getTypesUnderEquality(com.google.javascript.rhino.jstype.JSType that) {
		if (that instanceof com.google.javascript.rhino.jstype.UnionType) {
			com.google.javascript.rhino.jstype.JSType.TypePair p = that.getTypesUnderEquality(com.google.javascript.rhino.jstype.JSType.this);
	...
	public com.google.javascript.rhino.jstype.JSType.TypePair getTypesUnderInequality(com.google.javascript.rhino.jstype.JSType that) {
		if (that instanceof com.google.javascript.rhino.jstype.UnionType) {
			com.google.javascript.rhino.jstype.JSType.TypePair p = that.getTypesUnderInequality(com.google.javascript.rhino.jstype.JSType.this);
			return new com.google.javascript.rhino.jstype.JSType.TypePair(p.typeB, p.typeA);
		}
		switch (com.google.javascript.rhino.jstype.JSType.this.testForEquality(that)) {
			case TRUE :
	...
	public com.google.javascript.rhino.jstype.JSType.TypePair getTypesUnderShallowInequality(com.google.javascript.rhino.jstype.JSType that) {
		if (that instanceof com.google.javascript.rhino.jstype.UnionType) {
			com.google.javascript.rhino.jstype.JSType.TypePair p = that.getTypesUnderShallowInequality(com.google.javascript.rhino.jstype.JSType.this);
			return new com.google.javascript.rhino.jstype.JSType.TypePair(p.typeB, p.typeA);
		}
	...
	public abstract boolean isSubtype(com.google.javascript.rhino.jstype.JSType that);
	...
	static boolean isSubtype(com.google.javascript.rhino.jstype.JSType thisType, com.google.javascript.rhino.jstype.JSType thatType) {
		...
		if (thatType instanceof com.google.javascript.rhino.jstype.UnionType) {
			com.google.javascript.rhino.jstype.UnionType union = ((com.google.javascript.rhino.jstype.UnionType) (thatType));
		...
		if (thatType instanceof com.google.javascript.rhino.jstype.NamedType) {
			return thisType.isSubtype(((com.google.javascript.rhino.jstype.NamedType) (thatType)).getReferencedType());
		}
		return false;
	}
