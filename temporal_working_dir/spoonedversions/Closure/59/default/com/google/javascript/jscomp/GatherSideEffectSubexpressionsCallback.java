...
class GatherSideEffectSubexpressionsCallback implements com.google.javascript.jscomp.NodeTraversal.Callback {
	...
	static final class CopySideEffectSubexpressions implements com.google.javascript.jscomp.GatherSideEffectSubexpressionsCallback.SideEffectAccumulator {
		...
		public void keepSimplifiedShortCircuitExpression(com.google.javascript.rhino.Node original) {
			com.google.common.base.Preconditions.checkArgument((((original.getType()) == (com.google.javascript.rhino.Token.AND)) || ((original.getType()) == (com.google.javascript.rhino.Token.OR))), ("Expected: AND or OR, Got: " + (com.google.javascript.rhino.Token.name(original.getType()))));
		...
		public void keepSimplifiedHookExpression(com.google.javascript.rhino.Node hook, boolean thenHasSideEffects, boolean elseHasSideEffects) {
			com.google.common.base.Preconditions.checkArgument(((hook.getType()) == (com.google.javascript.rhino.Token.HOOK)), ("Expected: HOOK, Got: " + (com.google.javascript.rhino.Token.name(hook.getType()))));
	...
	boolean processShortCircuitExpression(com.google.javascript.rhino.Node node) {
		com.google.common.base.Preconditions.checkArgument((((node.getType()) == (com.google.javascript.rhino.Token.AND)) || ((node.getType()) == (com.google.javascript.rhino.Token.OR))), ("Expected: AND or OR, Got: " + (com.google.javascript.rhino.Token.name(node.getType()))));
	...
	boolean processHook(com.google.javascript.rhino.Node node) {
		com.google.common.base.Preconditions.checkArgument(((node.getType()) == (com.google.javascript.rhino.Token.HOOK)), ("Expected: HOOK, Got: " + (com.google.javascript.rhino.Token.name(node.getType()))));
	...
	boolean processFunctionCall(com.google.javascript.rhino.Node node) {
		com.google.common.base.Preconditions.checkArgument(((node.getType()) == (com.google.javascript.rhino.Token.CALL)), ("Expected: CALL, Got: " + (com.google.javascript.rhino.Token.name(node.getType()))));
	...
	boolean processConstructorCall(com.google.javascript.rhino.Node node) {
		com.google.common.base.Preconditions.checkArgument(((node.getType()) == (com.google.javascript.rhino.Token.NEW)), ("Expected: NEW, Got: " + (com.google.javascript.rhino.Token.name(node.getType()))));
