...
class DisambiguateProperties<T> implements com.google.javascript.jscomp.CompilerPass {
	...
	static class Warnings {
		static final com.google.javascript.jscomp.DiagnosticType INVALIDATION = com.google.javascript.jscomp.DiagnosticType.disabled("JSC_INVALIDATION", ("Property disambiguator skipping all instances of property {0} " + "because of type {1} node {2}"));
	}
	...
	static com.google.javascript.jscomp.DisambiguateProperties<com.google.javascript.rhino.jstype.JSType> forJSTypeSystem(com.google.javascript.jscomp.AbstractCompiler compiler) {
		return new com.google.javascript.jscomp.DisambiguateProperties<com.google.javascript.rhino.jstype.JSType>(compiler, new com.google.javascript.jscomp.DisambiguateProperties.JSTypeSystem(compiler));
	}

	static com.google.javascript.jscomp.DisambiguateProperties<com.google.javascript.jscomp.ConcreteType> forConcreteTypeSystem(com.google.javascript.jscomp.AbstractCompiler compiler, com.google.javascript.jscomp.TightenTypes tt) {
		return new com.google.javascript.jscomp.DisambiguateProperties<com.google.javascript.jscomp.ConcreteType>(compiler, new com.google.javascript.jscomp.DisambiguateProperties.ConcreteTypeSystem(tt, compiler.getCodingConvention()));
	}

	private DisambiguateProperties(com.google.javascript.jscomp.AbstractCompiler compiler, com.google.javascript.jscomp.DisambiguateProperties.TypeSystem<T> typeSystem) {
		this.compiler = compiler;
		this.typeSystem = typeSystem;
		this.showInvalidationWarnings = (compiler.getErrorLevel(com.google.javascript.jscomp.JSError.make("", 0, 0, com.google.javascript.jscomp.DisambiguateProperties.Warnings.INVALIDATION))) != (com.google.javascript.jscomp.CheckLevel.OFF);
	}
	...
	private void addInvalidatingType(com.google.javascript.rhino.jstype.JSType type) {
		...
		if (type instanceof com.google.javascript.rhino.jstype.UnionType) {
			...
			if (type instanceof com.google.javascript.rhino.jstype.EnumElementType) {
				addInvalidatingType(((com.google.javascript.rhino.jstype.EnumElementType) (type)).getPrimitiveType());
			}else {
		...
		private void handleGetProp(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n) {
			...
			if (!(prop.scheduleRenaming(n.getLastChild(), processProperty(t, prop, type, null)))) {
				if (showInvalidationWarnings) {
					compiler.report(com.google.javascript.jscomp.JSError.make(t.getSourceName(), n, com.google.javascript.jscomp.DisambiguateProperties.Warnings.INVALIDATION, name, (type == null ? "null" : type.toString()), n.toString()));
				}
			}
		}
		...
		private void handleObjectLit(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n) {
			...
			while (child != null) {
				...
				if (!(prop.scheduleRenaming(child, processProperty(t, prop, type, null)))) {
					if (showInvalidationWarnings) {
						compiler.report(com.google.javascript.jscomp.JSError.make(t.getSourceName(), child, com.google.javascript.jscomp.DisambiguateProperties.Warnings.INVALIDATION, name, (type == null ? "null" : type.toString()), n.toString()));
					}
				}
				child = child.getNext();
			} 
	...
	void renameProperties() {
		...
		com.google.javascript.jscomp.DisambiguateProperties.logger.info((((("Renamed " + instancesRenamed) + " instances of ") + propsRenamed) + " properties."));
		com.google.javascript.jscomp.DisambiguateProperties.logger.info((((((((("Skipped renaming " + instancesSkipped) + " invalidated ") + "properties, ") + propsSkipped) + " instances of properties ") + "that were skipped for specific types and ") + singleTypeProps) + " properties that were referenced from only one type."));
	}
	...
	private static class JSTypeSystem implements com.google.javascript.jscomp.DisambiguateProperties.TypeSystem<com.google.javascript.rhino.jstype.JSType> {
		...
		public com.google.common.collect.ImmutableSet<com.google.javascript.rhino.jstype.JSType> getTypesToSkipForType(com.google.javascript.rhino.jstype.JSType type) {
			...
			if (type instanceof com.google.javascript.rhino.jstype.UnionType) {
				...
				if (type instanceof com.google.javascript.rhino.jstype.EnumElementType) {
					return getTypesToSkipForType(((com.google.javascript.rhino.jstype.EnumElementType) (type)).getPrimitiveType());
				}
		...
		public java.lang.Iterable<com.google.javascript.rhino.jstype.JSType> getTypeAlternatives(com.google.javascript.rhino.jstype.JSType type) {
			if (type.isUnionType()) {
				return ((com.google.javascript.rhino.jstype.UnionType) (type)).getAlternates();
			}else {
		...
		public com.google.javascript.rhino.jstype.ObjectType getTypeWithProperty(java.lang.String field, com.google.javascript.rhino.jstype.JSType type) {
			if (type instanceof com.google.javascript.rhino.jstype.EnumElementType) {
				return getTypeWithProperty(field, ((com.google.javascript.rhino.jstype.EnumElementType) (type)).getPrimitiveType());
			}
		...
		public com.google.javascript.rhino.jstype.JSType getInstanceFromPrototype(com.google.javascript.rhino.jstype.JSType type) {
			if (type.isFunctionPrototypeType()) {
				com.google.javascript.rhino.jstype.FunctionPrototypeType prototype = ((com.google.javascript.rhino.jstype.FunctionPrototypeType) (type));
				com.google.javascript.rhino.jstype.FunctionType owner = prototype.getOwnerFunction();
				if ((owner.isConstructor()) || (owner.isInterface())) {
					return ((com.google.javascript.rhino.jstype.FunctionPrototypeType) (type)).getOwnerFunction().getInstanceType();
				}
			}
			return null;
		}
		...
		public void recordInterfaces(com.google.javascript.rhino.jstype.JSType type, com.google.javascript.rhino.jstype.JSType relatedType, com.google.javascript.jscomp.DisambiguateProperties<com.google.javascript.rhino.jstype.JSType>.Property p) {
			...
			if (objType != null) {
				...
				if (objType instanceof com.google.javascript.rhino.jstype.FunctionType) {
					constructor = ((com.google.javascript.rhino.jstype.FunctionType) (objType));
				}else
					if (objType instanceof com.google.javascript.rhino.jstype.FunctionPrototypeType) {
						constructor = ((com.google.javascript.rhino.jstype.FunctionPrototypeType) (objType)).getOwnerFunction();
					}else {
	...
	private static class ConcreteTypeSystem implements com.google.javascript.jscomp.DisambiguateProperties.TypeSystem<com.google.javascript.jscomp.ConcreteType> {
		...
		private com.google.javascript.jscomp.ConcreteType maybeAddAutoboxes(com.google.javascript.jscomp.ConcreteType cType, com.google.javascript.rhino.jstype.JSType jsType, java.lang.String prop) {
			...
			if (jsType instanceof com.google.javascript.rhino.jstype.UnionType) {
				...
				if (jsType instanceof com.google.javascript.rhino.jstype.EnumElementType) {
					return maybeAddAutoboxes(cType, ((com.google.javascript.rhino.jstype.EnumElementType) (jsType)).getPrimitiveType(), prop);
				}
