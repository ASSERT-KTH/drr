...
class CollapseProperties implements com.google.javascript.jscomp.CompilerPass {
	...
	private void flattenPrefixes(java.lang.String alias, com.google.javascript.jscomp.GlobalNamespace.Name n, int depth) {
		...
		if (((decl != null) && ((decl.node) != null)) && ((decl.node.getType()) == (com.google.javascript.rhino.Token.GETPROP))) {
	...
	private void collapseDeclarationOfNameAndDescendants(com.google.javascript.jscomp.GlobalNamespace.Name n, java.lang.String alias) {
		...
		if ((n.props) != null) {
			for (com.google.javascript.jscomp.GlobalNamespace.Name p : n.props) {
				...
				if (((((((!(p.inExterns)) && canCollapseChildNames) && ((p.getDeclaration()) != null)) && (p.canCollapse())) && ((p.getDeclaration().node) != null)) && ((p.getDeclaration().node.getParent()) != null)) && ((p.getDeclaration().node.getParent().getType()) == (com.google.javascript.rhino.Token.ASSIGN))) {
					updateSimpleDeclaration(com.google.javascript.jscomp.CollapseProperties.appendPropForAlias(alias, p.getName()), p, p.getDeclaration());
				}
			}
		}
	}
			...
			com.google.javascript.jscomp.NodeTraversal.traverse(compiler, function.getLastChild(), new com.google.javascript.jscomp.NodeTraversal.AbstractShallowCallback() {
				public void visit(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
					if ((n.getType()) == (com.google.javascript.rhino.Token.THIS)) {
						compiler.report(com.google.javascript.jscomp.JSError.make(name.getDeclaration().getSourceName(), n, com.google.javascript.jscomp.CollapseProperties.UNSAFE_THIS, name.fullName()));
					}
				}
			});
		}
