...
class IRFactory {
		...
		if ((node.getComments()) != null) {
			for (com.google.javascript.jscomp.mozilla.rhino.ast.Comment comment : node.getComments()) {
				if (((comment.getCommentType()) == (com.google.javascript.jscomp.mozilla.rhino.Token.CommentType.JSDOC)) && (!(comment.isParsed()))) {
					...
					if ((comment.getCommentType()) == (com.google.javascript.jscomp.mozilla.rhino.Token.CommentType.BLOCK)) {
	...
	private com.google.javascript.jscomp.parsing.JsDocInfoParser createJsDocInfoParser(com.google.javascript.jscomp.mozilla.rhino.ast.Comment node) {
		...
		com.google.javascript.jscomp.parsing.JsDocInfoParser jsdocParser = new com.google.javascript.jscomp.parsing.JsDocInfoParser(new com.google.javascript.jscomp.parsing.JsDocTokenStream(comment.substring(numOpeningChars), lineno, ((position2charno(position)) + numOpeningChars)), node, sourceFile, config, errorReporter);
	...
	private void maybeSetLengthFrom(com.google.javascript.rhino.Node node, com.google.javascript.rhino.Node source) {
		if (config.isIdeMode) {
			node.setLength(source.getLength());
		}
	}
	...
	private class TransformDispatcher extends com.google.javascript.jscomp.parsing.TypeSafeDispatcher<com.google.javascript.rhino.Node> {
		...
		private com.google.javascript.rhino.Node transformAsString(com.google.javascript.jscomp.mozilla.rhino.ast.AstNode n) {
			...
			if (n instanceof com.google.javascript.jscomp.mozilla.rhino.ast.Name) {
				...
				if (n instanceof com.google.javascript.jscomp.mozilla.rhino.ast.NumberLiteral) {
