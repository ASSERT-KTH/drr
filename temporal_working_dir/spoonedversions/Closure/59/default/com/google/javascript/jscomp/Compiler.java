...
public class Compiler extends com.google.javascript.jscomp.AbstractCompiler {
	...
	protected void removeExternInput(java.lang.String name) {
		com.google.javascript.jscomp.CompilerInput input = getInput(name);
		if (input == null) {
			return ;
		}
		com.google.common.base.Preconditions.checkState(input.isExtern(), ("Not an extern input: " + (input.getName())));
	...
	void addIncrementalSourceAst(com.google.javascript.jscomp.JsAst ast) {
		java.lang.String intputName = ast.getSourceFile().getName();
		com.google.common.base.Preconditions.checkState(((getInput(intputName)) == null), ("Duplicate input of name " + intputName));
		inputsByName.put(intputName, new com.google.javascript.jscomp.CompilerInput(ast));
	}

	boolean replaceIncrementalSourceAst(com.google.javascript.jscomp.JsAst ast) {
		java.lang.String inputName = ast.getSourceFile().getName();
		com.google.javascript.jscomp.CompilerInput oldInput = com.google.common.base.Preconditions.checkNotNull(getInput(inputName), ("No input to replace: " + inputName));
	...
	com.google.javascript.jscomp.SymbolTable buildKnownSymbolTable() {
		com.google.javascript.jscomp.SymbolTable symbolTable = new com.google.javascript.jscomp.SymbolTable();
