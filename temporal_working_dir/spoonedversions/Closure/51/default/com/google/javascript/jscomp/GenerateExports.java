	...
	public void process(com.google.javascript.rhino.Node externs, com.google.javascript.rhino.Node root) {
		...
		for (java.util.Map.Entry<java.lang.String, com.google.javascript.jscomp.FindExportableNodes.GenerateNodeContext> entry : exports.entrySet()) {
			...
			if ((node.getType()) == (com.google.javascript.rhino.Token.GETPROP)) {
				...
				if (((node.getFirstChild().getType()) == (com.google.javascript.rhino.Token.GETPROP)) && (getPropertyName(node.getFirstChild()).equals(com.google.javascript.jscomp.GenerateExports.PROTOTYPE_PROPERTY))) {
