...
class PeepholeReplaceKnownMethods extends com.google.javascript.jscomp.AbstractPeepholeOptimization {
	...
	private com.google.javascript.rhino.Node tryFoldKnownStringMethods(com.google.javascript.rhino.Node subtree) {
		com.google.common.base.Preconditions.checkArgument(subtree.isCall());
		com.google.javascript.rhino.Node callTarget = subtree.getFirstChild();
		if (callTarget == null) {
			return subtree;
		}
	...
	private com.google.javascript.rhino.Node tryFoldStringToLowerCase(com.google.javascript.rhino.Node subtree, com.google.javascript.rhino.Node stringNode) {
		...
		com.google.javascript.rhino.Node replacement = com.google.javascript.rhino.IR.string(lowered);
	...
	private com.google.javascript.rhino.Node tryFoldStringToUpperCase(com.google.javascript.rhino.Node subtree, com.google.javascript.rhino.Node stringNode) {
		...
		com.google.javascript.rhino.Node replacement = com.google.javascript.rhino.IR.string(uppered);
		subtree.getParent().replaceChild(subtree, replacement);
		reportCodeChange();
		return replacement;
	}
	...
	private com.google.javascript.rhino.Node tryFoldParseNumber(com.google.javascript.rhino.Node n, java.lang.String functionName, com.google.javascript.rhino.Node firstArg) {
		com.google.common.base.Preconditions.checkArgument(n.isCall());
		...
		if (firstArg.isNumber()) {
			...
			if ((!((radix == 0) || (radix == 10))) && isParseInt) {
				...
				if (isParseInt) {
					numericNode = com.google.javascript.rhino.IR.number(checkVal.intValue());
				}else {
					numericNode = com.google.javascript.rhino.IR.number(checkVal);
				}
		...
		if (isParseInt) {
			...
			newNode = com.google.javascript.rhino.IR.number(newVal);
		}else {
	...
	private com.google.javascript.rhino.Node tryFoldStringIndexOf(com.google.javascript.rhino.Node n, java.lang.String functionName, com.google.javascript.rhino.Node lstringNode, com.google.javascript.rhino.Node firstArg) {
		com.google.common.base.Preconditions.checkArgument(n.isCall());
		com.google.common.base.Preconditions.checkArgument(lstringNode.isString());
		...
		com.google.javascript.rhino.Node newNode = com.google.javascript.rhino.IR.number(indexVal);
		n.getParent().replaceChild(n, newNode);
		reportCodeChange();
		return newNode;
	}
	...
	private com.google.javascript.rhino.Node tryFoldArrayJoin(com.google.javascript.rhino.Node n) {
		...
		while (elem != null) {
			if ((com.google.javascript.jscomp.NodeUtil.isImmutableValue(elem)) || (elem.isEmpty())) {
				if (sb == null) {
				...
				if (sb != null) {
					...
					arrayFoldedChildren.add(com.google.javascript.rhino.IR.string(sb.toString()).copyInformationFrom(prev));
					sb = null;
				}
		...
		switch (arrayFoldedChildren.size()) {
			case 0 :
				com.google.javascript.rhino.Node emptyStringNode = com.google.javascript.rhino.IR.string("");
			...
			case 1 :
				...
				if (!(foldedStringNode.isString())) {
					com.google.javascript.rhino.Node replacement = com.google.javascript.rhino.IR.add(com.google.javascript.rhino.IR.string("").srcref(n), foldedStringNode);
	...
	private com.google.javascript.rhino.Node tryFoldStringSubstr(com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node stringNode, com.google.javascript.rhino.Node arg1) {
		com.google.common.base.Preconditions.checkArgument(n.isCall());
		com.google.common.base.Preconditions.checkArgument(stringNode.isString());
		int start;
		int length;
		...
		com.google.javascript.rhino.Node resultNode = com.google.javascript.rhino.IR.string(result);
	...
	private com.google.javascript.rhino.Node tryFoldStringCharAt(com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node stringNode, com.google.javascript.rhino.Node arg1) {
		...
		com.google.javascript.rhino.Node resultNode = com.google.javascript.rhino.IR.string(stringAsString.substring(index, (index + 1)));
		com.google.javascript.rhino.Node parent = n.getParent();
		parent.replaceChild(n, resultNode);
		reportCodeChange();
		return resultNode;
	...
	private com.google.javascript.rhino.Node tryFoldStringCharCodeAt(com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node stringNode, com.google.javascript.rhino.Node arg1) {
		...
		com.google.javascript.rhino.Node resultNode = com.google.javascript.rhino.IR.number(stringAsString.charAt(index));
		com.google.javascript.rhino.Node parent = n.getParent();
		parent.replaceChild(n, resultNode);
		reportCodeChange();
		return resultNode;
	...
	private int jsSplitMatch(java.lang.String stringValue, int startIndex, java.lang.String separator) {
	...
	private java.lang.String[] jsSplit(java.lang.String stringValue, java.lang.String separator, int limit) {
		com.google.common.base.Preconditions.checkArgument((limit >= 0));
		if (limit == 0) {
		...
		java.util.List<java.lang.String> splitStrings = com.google.common.collect.Lists.newArrayList();
		...
		return splitStrings.toArray(new java.lang.String[splitStrings.size()]);
	}

	private com.google.javascript.rhino.Node tryFoldStringSplit(com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node stringNode, com.google.javascript.rhino.Node arg1) {
		if (late) {
			return n;
		}
		com.google.common.base.Preconditions.checkArgument(n.isCall());
		...
		java.lang.String stringValue = stringNode.getString();
		...
		if (arg1 != null) {
			...
			if (arg2 != null) {
				if (arg2.isNumber()) {
					limit = java.lang.Math.min(((int) (arg2.getDouble())), limit);
					if (limit < 0) {
						return n;
					}
				}else {
		...
		java.lang.String[] stringArray = jsSplit(stringValue, separator, limit);
		com.google.javascript.rhino.Node arrayOfStrings = com.google.javascript.rhino.IR.arraylit();
		for (int i = 0; i < (stringArray.length); i++) {
			arrayOfStrings.addChildToBack(com.google.javascript.rhino.IR.string(stringArray[i]).srcref(stringNode));
		}
		com.google.javascript.rhino.Node parent = n.getParent();
