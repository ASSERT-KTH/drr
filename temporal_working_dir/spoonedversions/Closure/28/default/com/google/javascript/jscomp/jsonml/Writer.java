...
public class Writer {
	public com.google.javascript.jscomp.jsonml.JsonML processAst(com.google.javascript.rhino.Node root) {
		...
		com.google.common.base.Preconditions.checkArgument((((root.getType()) == (com.google.javascript.rhino.Token.BLOCK)) || ((root.getType()) == (com.google.javascript.rhino.Token.SCRIPT))));
		...
		if ((root.getType()) == (com.google.javascript.rhino.Token.SCRIPT)) {
	...
	private void processEmpty(com.google.javascript.rhino.Node node, com.google.javascript.jscomp.jsonml.JsonML currentParent) {
		if ((currentParent.getType()) == (com.google.javascript.jscomp.jsonml.TagType.ArrayExpr)) {
			currentParent.appendChild(new com.google.javascript.jscomp.jsonml.JsonML(com.google.javascript.jscomp.jsonml.TagType.Empty));
		}else {
