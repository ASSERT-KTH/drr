...
public class SourceMapGeneratorV2 implements com.google.debugging.sourcemap.SourceMapGenerator {
	...
	private class LineMapper implements com.google.debugging.sourcemap.SourceMapGeneratorV2.MappingVisitor {
		...
		private void closeEntry(int id, int reps) throws java.io.IOException {
			...
			if (validate) {
				com.google.debugging.sourcemap.SourceMapGeneratorV2.LineMapDecoder.LineEntry entry = com.google.debugging.sourcemap.SourceMapGeneratorV2.LineMapDecoder.decodeLineEntry(sb.toString(), lastId);
	...
	public static class LineMapDecoder {
		private static com.google.debugging.sourcemap.SourceMapGeneratorV2.LineMapDecoder.LineEntry decodeLineEntry(java.lang.String in, int lastId) {
			return com.google.debugging.sourcemap.SourceMapGeneratorV2.LineMapDecoder.decodeLineEntry(new com.google.debugging.sourcemap.SourceMapGeneratorV2.LineMapDecoder.StringParser(in), lastId);
		}

		private static com.google.debugging.sourcemap.SourceMapGeneratorV2.LineMapDecoder.LineEntry decodeLineEntry(com.google.debugging.sourcemap.SourceMapGeneratorV2.LineMapDecoder.StringParser reader, int lastId) {
			int repDigits = 0;
			...
			if (repDigits == 0) {
				...
				int value = com.google.debugging.sourcemap.SourceMapGeneratorV2.LineMapDecoder.addBase64Digit(digit, 0);
				reps = value >> 2;
				idDigits = value & 3;
			}else {
				char digit = reader.next();
				idDigits = com.google.debugging.sourcemap.SourceMapGeneratorV2.LineMapDecoder.addBase64Digit(digit, 0);
				int value = 0;
				for (int i = 0; i < repDigits; i++) {
					digit = reader.next();
					value = com.google.debugging.sourcemap.SourceMapGeneratorV2.LineMapDecoder.addBase64Digit(digit, value);
				}
				reps = value;
			}
			reps += 1;
			...
			int mappingId = com.google.debugging.sourcemap.SourceMapGeneratorV2.LineMapDecoder.getIdFromRelativeId(value, idDigits, lastId);
			return new com.google.debugging.sourcemap.SourceMapGeneratorV2.LineMapDecoder.LineEntry(mappingId, reps);
		}

		public static java.util.List<java.lang.Integer> decodeLine(java.lang.String lineSource) {
			return com.google.debugging.sourcemap.SourceMapGeneratorV2.LineMapDecoder.decodeLine(new com.google.debugging.sourcemap.SourceMapGeneratorV2.LineMapDecoder.StringParser(lineSource));
		}

		private static java.util.List<java.lang.Integer> decodeLine(com.google.debugging.sourcemap.SourceMapGeneratorV2.LineMapDecoder.StringParser reader) {
			java.util.List<java.lang.Integer> result = com.google.common.collect.Lists.newArrayListWithCapacity(512);
			int lastId = 0;
			while (reader.hasNext()) {
				com.google.debugging.sourcemap.SourceMapGeneratorV2.LineMapDecoder.LineEntry entry = com.google.debugging.sourcemap.SourceMapGeneratorV2.LineMapDecoder.decodeLineEntry(reader, lastId);
				lastId = entry.id;
		...
		private static int addBase64Digit(char digit, int previousValue) {
			return (previousValue * 64) + (com.google.debugging.sourcemap.SourceMapGeneratorV2.BASE64_MAP.indexOf(digit));
		}
