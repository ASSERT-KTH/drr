...
final class ArrowType extends com.google.javascript.rhino.jstype.JSType {
	...
	boolean hasEqualParameters(com.google.javascript.rhino.jstype.ArrowType that) {
		com.google.javascript.rhino.Node thisParam = parameters.getFirstChild();
	...
	public boolean isEquivalentTo(com.google.javascript.rhino.jstype.JSType object) {
		if (!(object instanceof com.google.javascript.rhino.jstype.ArrowType)) {
			return false;
		}
		com.google.javascript.rhino.jstype.ArrowType that = ((com.google.javascript.rhino.jstype.ArrowType) (object));
