...
class FunctionRewriter implements com.google.javascript.jscomp.CompilerPass {
	...
	private static boolean isReduceableFunctionExpression(com.google.javascript.rhino.Node n) {
		return (com.google.javascript.jscomp.NodeUtil.isFunctionExpression(n)) && (!(com.google.javascript.jscomp.NodeUtil.isGetOrSetKey(n.getParent())));
	}
	...
	abstract static class Reducer {
		...
		protected final com.google.javascript.rhino.Node buildCallNode(java.lang.String methodName, com.google.javascript.rhino.Node argumentNode, com.google.javascript.rhino.Node srcref) {
			com.google.javascript.rhino.Node call = com.google.javascript.rhino.IR.call(com.google.javascript.rhino.IR.name(methodName)).srcref(srcref);
	...
	private static class EmptyFunctionReducer extends com.google.javascript.jscomp.FunctionRewriter.Reducer {
		...
		public com.google.javascript.rhino.Node reduce(com.google.javascript.rhino.Node node) {
			if (com.google.javascript.jscomp.NodeUtil.isEmptyFunctionExpression(node)) {
				return buildCallNode(com.google.javascript.jscomp.FunctionRewriter.EmptyFunctionReducer.FACTORY_METHOD_NAME, null, node);
			}else {
				return node;
			}
		}
	...
	private static class IdentityReducer extends com.google.javascript.jscomp.FunctionRewriter.SingleReturnStatementReducer {
		...
		public com.google.javascript.rhino.Node reduce(com.google.javascript.rhino.Node node) {
			...
			if (isIdentityFunction(node)) {
				return buildCallNode(com.google.javascript.jscomp.FunctionRewriter.IdentityReducer.FACTORY_METHOD_NAME, null, node);
			}else {
				return node;
			}
		}
		...
		private boolean isIdentityFunction(com.google.javascript.rhino.Node functionNode) {
			...
			if (((value != null) && (value.isName())) && (value.getString().equals(paramNode.getString()))) {
				return true;
			}
			return false;
		}
	...
	private static class ReturnConstantReducer extends com.google.javascript.jscomp.FunctionRewriter.SingleReturnStatementReducer {
		...
		public com.google.javascript.rhino.Node reduce(com.google.javascript.rhino.Node node) {
			...
			if (valueNode != null) {
				return buildCallNode(com.google.javascript.jscomp.FunctionRewriter.ReturnConstantReducer.FACTORY_METHOD_NAME, valueNode, node);
			}else {
				return node;
			}
		}
	...
	private static class GetterReducer extends com.google.javascript.jscomp.FunctionRewriter.SingleReturnStatementReducer {
		...
		public com.google.javascript.rhino.Node reduce(com.google.javascript.rhino.Node node) {
			...
			if (propName != null) {
				...
				return buildCallNode(com.google.javascript.jscomp.FunctionRewriter.GetterReducer.FACTORY_METHOD_NAME, propName, node);
			}else {
				return node;
			}
		}
	...
	private static class SetterReducer extends com.google.javascript.jscomp.FunctionRewriter.Reducer {
		...
		public com.google.javascript.rhino.Node reduce(com.google.javascript.rhino.Node node) {
			...
			if (propName != null) {
				...
				return buildCallNode(com.google.javascript.jscomp.FunctionRewriter.SetterReducer.FACTORY_METHOD_NAME, propName, node);
			}else {
				return node;
			}
		}
