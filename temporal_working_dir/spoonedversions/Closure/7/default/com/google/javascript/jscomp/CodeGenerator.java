...
class CodeGenerator {
	...
	public static void setPreferDoubleQuotesCompatFlag(boolean newVal) {
		com.google.javascript.jscomp.CodeGenerator.preferDoubleQuotesCompatFlag = newVal;
	}
	...
	private java.lang.String jsString(java.lang.String s, boolean useSlashV) {
		...
		char quote;
		if (com.google.javascript.jscomp.CodeGenerator.preferDoubleQuotesCompatFlag ? singleq < doubleq : singleq <= doubleq) {
			quote = '\'';
			doublequote = "\"";
			singlequote = "\\\'";
		}else {
