...
ANY, STRUCT, DICT;	}
	...
	private com.google.javascript.rhino.jstype.ObjectType.Property prototypeSlot;
	...
	private final com.google.common.collect.ImmutableList<java.lang.String> templateTypeNames;

	FunctionType(com.google.javascript.rhino.jstype.JSTypeRegistry registry, java.lang.String name, com.google.javascript.rhino.Node source, com.google.javascript.rhino.jstype.ArrowType arrowType, com.google.javascript.rhino.jstype.ObjectType typeOfThis, com.google.common.collect.ImmutableList<java.lang.String> templateTypeNames, boolean isConstructor, boolean nativeType) {
		...
		this.templateTypeNames = (templateTypeNames != null) ? templateTypeNames : com.google.common.collect.ImmutableList.<java.lang.String>of();
	}
	...
	private FunctionType(com.google.javascript.rhino.jstype.JSTypeRegistry registry, java.lang.String name, com.google.javascript.rhino.Node source) {
		...
		this.templateTypeNames = com.google.common.collect.ImmutableList.of();
	}
	...
	public com.google.javascript.rhino.jstype.ObjectType getPrototype() {
		if ((prototypeSlot) == null) {
			...
			if (refName == null) {
				...
				setPrototype(new com.google.javascript.rhino.jstype.PrototypeObjectType(registry, ((com.google.javascript.rhino.jstype.FunctionType.this.getReferenceName()) + ".prototype"), registry.getNativeObjectType(com.google.javascript.rhino.jstype.JSTypeNative.OBJECT_TYPE), isNativeObjectType()), null);
			}
		}
	...
	void setPrototypeBasedOn(com.google.javascript.rhino.jstype.ObjectType baseType, com.google.javascript.rhino.Node propertyNode) {
		if (((baseType.hasReferenceName()) || (isNativeObjectType())) || (baseType.isFunctionPrototypeType())) {
			baseType = new com.google.javascript.rhino.jstype.PrototypeObjectType(registry, ((com.google.javascript.rhino.jstype.FunctionType.this.getReferenceName()) + ".prototype"), baseType);
		}
	...
	private boolean setPrototypeNoCheck(com.google.javascript.rhino.jstype.ObjectType prototype, com.google.javascript.rhino.Node propertyNode) {
		...
		com.google.javascript.rhino.jstype.FunctionType.this.prototypeSlot = new com.google.javascript.rhino.jstype.ObjectType.Property("prototype", prototype, true, (propertyNode == null ? source : propertyNode));
	...
	public com.google.javascript.rhino.jstype.FunctionType getBindReturnType(int argsToBind) {
		com.google.javascript.rhino.jstype.FunctionBuilder builder = new com.google.javascript.rhino.jstype.FunctionBuilder(registry).withReturnType(getReturnType());
		if (argsToBind >= 0) {
	...
	private com.google.javascript.rhino.jstype.FunctionType getCallOrBindSignature(boolean isCall) {
		...
		com.google.javascript.rhino.jstype.FunctionBuilder builder = new com.google.javascript.rhino.jstype.FunctionBuilder(registry).withReturnType((isCall ? getReturnType() : getBindReturnType((-1))));
		com.google.javascript.rhino.Node origParams = getParametersNode();
		if (origParams != null) {
			com.google.javascript.rhino.Node params = origParams.cloneTree();
	...
	boolean defineProperty(java.lang.String name, com.google.javascript.rhino.jstype.JSType type, boolean inferred, com.google.javascript.rhino.Node propertyNode) {
		if ("prototype".equals(name)) {
			...
			if (objType != null) {
				...
				com.google.javascript.rhino.jstype.FunctionType.this.setPrototypeBasedOn(objType, propertyNode);
				return true;
			}else {
				return false;
			}
	...
	boolean checkFunctionEquivalenceHelper(com.google.javascript.rhino.jstype.FunctionType that, boolean tolerateUnknowns) {
		if (isConstructor()) {
	...
	public boolean hasEqualCallType(com.google.javascript.rhino.jstype.FunctionType otherType) {
		return com.google.javascript.rhino.jstype.FunctionType.this.call.checkArrowEquivalenceHelper(otherType.call, false);
	}
	...
	public com.google.javascript.rhino.jstype.ObjectType getTypeOfThis() {
		return typeOfThis.isNoObjectType() ? registry.getNativeObjectType(com.google.javascript.rhino.jstype.JSTypeNative.UNKNOWN_TYPE) : typeOfThis;
	}
	...
	public void setSource(com.google.javascript.rhino.Node source) {
		if ((prototypeSlot) != null) {
			if ((source == null) || ((prototypeSlot.getNode()) == null)) {
				prototypeSlot = new com.google.javascript.rhino.jstype.ObjectType.Property(prototypeSlot.getName(), prototypeSlot.getType(), prototypeSlot.isTypeInferred(), source);
			}
		}
		com.google.javascript.rhino.jstype.FunctionType.this.source = source;
	}
