...
public class DiagnosticGroups {
	...
	static final java.lang.String DIAGNOSTIC_GROUP_NAMES = "accessControls, ambiguousFunctionDecl, checkRegExp, " + (((((("checkTypes, checkVars, const, constantProperty, deprecated, " + "duplicateMessage, ") + "es5Strict, externsValidation, fileoverviewTags, globalThis, ") + "internetExplorerChecks, invalidCasts, missingProperties, ") + "nonStandardJsDocs, strictModuleDepCheck, typeInvalidation, ") + "undefinedNames, undefinedVars, unknownDefines, uselessCode, ") + "visibility");
