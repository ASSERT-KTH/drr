...
public class UnionType extends com.google.javascript.rhino.jstype.JSType {
	...
	boolean checkUnionEquivalenceHelper(com.google.javascript.rhino.jstype.UnionType that, boolean tolerateUnknowns) {
	...
	private boolean hasAlternate(com.google.javascript.rhino.jstype.JSType type, boolean tolerateUnknowns) {
		for (com.google.javascript.rhino.jstype.JSType alternate : alternates) {
