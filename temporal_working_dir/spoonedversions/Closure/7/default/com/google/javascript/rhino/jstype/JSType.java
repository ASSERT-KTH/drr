...
public abstract class JSType implements java.io.Serializable {
	...
	public boolean isStruct() {
		if (isObject()) {
			com.google.javascript.rhino.jstype.FunctionType ctor = toObjectType().getConstructor();
	...
	public final boolean isEquivalentTo(com.google.javascript.rhino.jstype.JSType jsType) {
	...
	boolean checkEquivalenceHelper(com.google.javascript.rhino.jstype.JSType that, boolean tolerateUnknowns) {
		...
		if ((isUnionType()) && (that.isUnionType())) {
			return com.google.javascript.rhino.jstype.JSType.this.toMaybeUnionType().checkUnionEquivalenceHelper(that.toMaybeUnionType(), tolerateUnknowns);
		}
		if ((isFunctionType()) && (that.isFunctionType())) {
			return com.google.javascript.rhino.jstype.JSType.this.toMaybeFunctionType().checkFunctionEquivalenceHelper(that.toMaybeFunctionType(), tolerateUnknowns);
		}
		if ((isRecordType()) && (that.isRecordType())) {
			return com.google.javascript.rhino.jstype.JSType.this.toMaybeRecordType().checkRecordEquivalenceHelper(that.toMaybeRecordType(), tolerateUnknowns);
		}
		...
		if ((com.google.javascript.rhino.jstype.JSType.this) instanceof com.google.javascript.rhino.jstype.ProxyObjectType) {
			return ((com.google.javascript.rhino.jstype.ProxyObjectType) (com.google.javascript.rhino.jstype.JSType.this)).getReferencedTypeInternal().checkEquivalenceHelper(that, tolerateUnknowns);
		}
		if (that instanceof com.google.javascript.rhino.jstype.ProxyObjectType) {
			return checkEquivalenceHelper(((com.google.javascript.rhino.jstype.ProxyObjectType) (that)).getReferencedTypeInternal(), tolerateUnknowns);
		}
