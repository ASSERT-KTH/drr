...
class SourceMapLineDecoder {
	...
	static com.google.debugging.sourcemap.SourceMapLineDecoder.LineEntry decodeLineEntry(java.lang.String in, int lastId) {
	...
	private static int addBase64Digit(char digit, int previousValue) {
		return (previousValue * 64) + (com.google.debugging.sourcemap.Base64.fromBase64(digit));
	}
