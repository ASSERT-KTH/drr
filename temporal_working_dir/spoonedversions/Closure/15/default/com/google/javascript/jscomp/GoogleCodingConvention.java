...
public class GoogleCodingConvention extends com.google.javascript.jscomp.CodingConventions.Proxy {
	...
	public GoogleCodingConvention() {
		this(new com.google.javascript.jscomp.ClosureCodingConvention());
	}

	public GoogleCodingConvention(com.google.javascript.jscomp.CodingConvention convention) {
		super(convention);
	}
