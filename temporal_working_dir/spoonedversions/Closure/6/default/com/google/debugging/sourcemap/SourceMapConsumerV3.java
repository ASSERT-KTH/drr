...
public class SourceMapConsumerV3 implements com.google.debugging.sourcemap.SourceMapConsumer , com.google.debugging.sourcemap.SourceMappingReversable {
	...
	private java.util.Map<java.lang.String, java.util.Map<java.lang.Integer, java.util.Collection<com.google.debugging.sourcemap.proto.Mapping.OriginalMapping>>> reverseSourceMapping;
		...
		try {
			...
			for (int i = 0, count = sections.length(); i < count; i++) {
				...
				if ((section.has("map")) && (section.has("url"))) {
					throw new com.google.debugging.sourcemap.SourceMapParseException("Invalid map format: section may not have both 'map' and 'url'");
				}
				...
				if (section.has("url")) {
					...
					if (section.has("map")) {
						...
						throw new com.google.debugging.sourcemap.SourceMapParseException("Invalid map format: section must have either 'map' or 'url'");
					}
	...
	public com.google.debugging.sourcemap.proto.Mapping.OriginalMapping getMappingForLine(int lineNumber, int column) {
		...
		com.google.common.base.Preconditions.checkState((index >= 0), "unexpected:%s", index);
	...
	public java.util.Collection<com.google.debugging.sourcemap.proto.Mapping.OriginalMapping> getReverseMapping(java.lang.String originalFile, int line, int column) {
		...
		java.util.Map<java.lang.Integer, java.util.Collection<com.google.debugging.sourcemap.proto.Mapping.OriginalMapping>> sourceLineToCollectionMap = reverseSourceMapping.get(originalFile);
		if (sourceLineToCollectionMap == null) {
			return java.util.Collections.emptyList();
		}else {
			java.util.Collection<com.google.debugging.sourcemap.proto.Mapping.OriginalMapping> mappings = sourceLineToCollectionMap.get(line);
			if (mappings == null) {
				return java.util.Collections.emptyList();
			}else {
				return mappings;
	...
	private com.google.debugging.sourcemap.proto.Mapping.OriginalMapping getOriginalMappingForEntry(com.google.debugging.sourcemap.SourceMapConsumerV3.Entry entry) {
		if ((entry.getSourceFileId()) == (com.google.debugging.sourcemap.SourceMapConsumerV3.UNMAPPED)) {
			...
			com.google.debugging.sourcemap.proto.Mapping.OriginalMapping.Builder x = com.google.debugging.sourcemap.proto.Mapping.OriginalMapping.newBuilder().setOriginalFile(sources[entry.getSourceFileId()]).setLineNumber(((entry.getSourceLine()) + 1)).setColumnPosition(((entry.getSourceColumn()) + 1));
	...
	private void createReverseMapping() {
		reverseSourceMapping = new java.util.HashMap<java.lang.String, java.util.Map<java.lang.Integer, java.util.Collection<com.google.debugging.sourcemap.proto.Mapping.OriginalMapping>>>();
		for (int targetLine = 0; targetLine < (lines.size()); targetLine++) {
			java.util.ArrayList<com.google.debugging.sourcemap.SourceMapConsumerV3.Entry> entries = lines.get(targetLine);
			if (entries != null) {
				for (com.google.debugging.sourcemap.SourceMapConsumerV3.Entry entry : entries) {
					if (((entry.getSourceFileId()) != (com.google.debugging.sourcemap.SourceMapConsumerV3.UNMAPPED)) && ((entry.getSourceLine()) != (com.google.debugging.sourcemap.SourceMapConsumerV3.UNMAPPED))) {
						java.lang.String originalFile = sources[entry.getSourceFileId()];
						if (!(reverseSourceMapping.containsKey(originalFile))) {
							reverseSourceMapping.put(originalFile, new java.util.HashMap<java.lang.Integer, java.util.Collection<com.google.debugging.sourcemap.proto.Mapping.OriginalMapping>>());
						}
						java.util.Map<java.lang.Integer, java.util.Collection<com.google.debugging.sourcemap.proto.Mapping.OriginalMapping>> lineToCollectionMap = reverseSourceMapping.get(originalFile);
						int sourceLine = entry.getSourceLine();
						if (!(lineToCollectionMap.containsKey(sourceLine))) {
							lineToCollectionMap.put(sourceLine, new java.util.ArrayList<com.google.debugging.sourcemap.proto.Mapping.OriginalMapping>(1));
						}
						java.util.Collection<com.google.debugging.sourcemap.proto.Mapping.OriginalMapping> mappings = lineToCollectionMap.get(sourceLine);
						com.google.debugging.sourcemap.proto.Mapping.OriginalMapping.Builder builder = com.google.debugging.sourcemap.proto.Mapping.OriginalMapping.newBuilder().setLineNumber(targetLine).setColumnPosition(entry.getGeneratedColumn());
