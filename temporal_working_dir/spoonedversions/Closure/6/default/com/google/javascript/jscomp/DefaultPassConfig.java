...
public class DefaultPassConfig extends com.google.javascript.jscomp.PassConfig {
	...
	protected java.util.List<com.google.javascript.jscomp.PassFactory> getChecks() {
		...
		checks.add(com.google.javascript.jscomp.DefaultPassConfig.createEmptyPass("beforeStandardChecks"));
		...
		if (((options.checkSuspiciousCode) || (options.enables(com.google.javascript.jscomp.DiagnosticGroups.GLOBAL_THIS))) || (options.enables(com.google.javascript.jscomp.DiagnosticGroups.DEBUGGER_STATEMENT_PRESENT))) {
			checks.add(suspiciousCode);
		}
		if ((options.checkControlStructures) || (options.enables(com.google.javascript.jscomp.DiagnosticGroups.ES5_STRICT))) {
		...
		if ((options.enables(com.google.javascript.jscomp.DiagnosticGroups.ES5_STRICT)) || (options.checkCaja)) {
		...
		checks.add(com.google.javascript.jscomp.DefaultPassConfig.createEmptyPass("afterStandardChecks"));
	...
	protected java.util.List<com.google.javascript.jscomp.PassFactory> getOptimizations() {
		...
		if ((options.renamePrefixNamespace) != null) {
			if (!(com.google.javascript.jscomp.DefaultPassConfig.GLOBAL_SYMBOL_NAMESPACE_PATTERN.matcher(options.renamePrefixNamespace).matches())) {
				throw new java.lang.IllegalArgumentException(("Illegal character in renamePrefixNamespace name: " + (options.renamePrefixNamespace)));
			}
	...
	final com.google.javascript.jscomp.DefaultPassConfig.HotSwapPassFactory checkSideEffects = new com.google.javascript.jscomp.DefaultPassConfig.HotSwapPassFactory("checkSideEffects", true) {
		...
		protected com.google.javascript.jscomp.HotSwapCompilerPass createInternal(final com.google.javascript.jscomp.AbstractCompiler compiler) {
			...
			return new com.google.javascript.jscomp.CheckSideEffects(compiler, (options.checkSuspiciousCode ? com.google.javascript.jscomp.CheckLevel.WARNING : com.google.javascript.jscomp.CheckLevel.OFF), protectHiddenSideEffects);
		}
	};
	...
	final com.google.javascript.jscomp.DefaultPassConfig.HotSwapPassFactory closurePrimitives = new com.google.javascript.jscomp.DefaultPassConfig.HotSwapPassFactory("processProvidesAndRequires", false) {
		...
		protected com.google.javascript.jscomp.HotSwapCompilerPass createInternal(com.google.javascript.jscomp.AbstractCompiler compiler) {
			...
			final com.google.javascript.jscomp.ProcessClosurePrimitives pass = new com.google.javascript.jscomp.ProcessClosurePrimitives(compiler, preprocessorSymbolTable, options.brokenClosureRequiresLevel);
	...
	final com.google.javascript.jscomp.PassFactory replaceMessagesForChrome = new com.google.javascript.jscomp.PassFactory("replaceMessages", true) {
		@java.lang.Override
		protected com.google.javascript.jscomp.CompilerPass createInternal(final com.google.javascript.jscomp.AbstractCompiler compiler) {
			return new com.google.javascript.jscomp.ReplaceMessagesForChrome(compiler, new com.google.javascript.jscomp.GoogleJsMessageIdGenerator(options.tcProjectId), true, com.google.javascript.jscomp.JsMessage.Style.getFromParams(true, false));
		}
	};
	...
	final com.google.javascript.jscomp.DefaultPassConfig.HotSwapPassFactory closureRewriteGoogClass = new com.google.javascript.jscomp.DefaultPassConfig.HotSwapPassFactory("closureRewriteGoogClass", true) {
		@java.lang.Override
		protected com.google.javascript.jscomp.HotSwapCompilerPass createInternal(com.google.javascript.jscomp.AbstractCompiler compiler) {
			return new com.google.javascript.jscomp.ClosureRewriteClass(compiler);
		}
	};
	...
	final com.google.javascript.jscomp.PassFactory clearTypedScopePass = new com.google.javascript.jscomp.PassFactory("clearTypedScopePass", false) {
		@java.lang.Override
		protected com.google.javascript.jscomp.CompilerPass createInternal(com.google.javascript.jscomp.AbstractCompiler compiler) {
			return new com.google.javascript.jscomp.DefaultPassConfig.ClearTypedScope();
		}
	};
	...
	class ClearTypedScope implements com.google.javascript.jscomp.CompilerPass {
		@java.lang.Override
		public void process(com.google.javascript.rhino.Node externs, com.google.javascript.rhino.Node root) {
			clearTypedScope();
		}
	...
	final com.google.javascript.jscomp.PassFactory checkGlobalNames = new com.google.javascript.jscomp.PassFactory("checkGlobalNames", true) {
		...
		protected com.google.javascript.jscomp.CompilerPass createInternal(final com.google.javascript.jscomp.AbstractCompiler compiler) {
			return new com.google.javascript.jscomp.CompilerPass() {
				@java.lang.Override
				public void process(com.google.javascript.rhino.Node externs, com.google.javascript.rhino.Node jsRoot) {
					namespaceForChecks = new com.google.javascript.jscomp.GlobalNamespace(compiler, externs, jsRoot);
	...
	final com.google.javascript.jscomp.PassFactory replaceIdGenerators = new com.google.javascript.jscomp.PassFactory("replaceIdGenerators", true) {
		...
		protected com.google.javascript.jscomp.CompilerPass createInternal(final com.google.javascript.jscomp.AbstractCompiler compiler) {
			return new com.google.javascript.jscomp.CompilerPass() {
				@java.lang.Override
				public void process(com.google.javascript.rhino.Node externs, com.google.javascript.rhino.Node root) {
					com.google.javascript.jscomp.ReplaceIdGenerators pass = new com.google.javascript.jscomp.ReplaceIdGenerators(compiler, options.idGenerators, options.generatePseudoNames, options.idGeneratorsMapSerialized);
					pass.process(externs, root);
	...
	final com.google.javascript.jscomp.PassFactory replaceStrings = new com.google.javascript.jscomp.PassFactory("replaceStrings", true) {
		...
		protected com.google.javascript.jscomp.CompilerPass createInternal(final com.google.javascript.jscomp.AbstractCompiler compiler) {
			return new com.google.javascript.jscomp.CompilerPass() {
				@java.lang.Override
				public void process(com.google.javascript.rhino.Node externs, com.google.javascript.rhino.Node root) {
					com.google.javascript.jscomp.ReplaceStrings pass = new com.google.javascript.jscomp.ReplaceStrings(compiler, options.replaceStringsPlaceholderToken, options.replaceStringsFunctionDescriptions, options.replaceStringsReservedStrings, options.replaceStringsInputMap);
					pass.process(externs, root);
	...
	final com.google.javascript.jscomp.PassFactory rescopeGlobalSymbols = new com.google.javascript.jscomp.PassFactory("rescopeGlobalSymbols", true) {
		@java.lang.Override
		protected com.google.javascript.jscomp.CompilerPass createInternal(com.google.javascript.jscomp.AbstractCompiler compiler) {
			return new com.google.javascript.jscomp.RescopeGlobalSymbols(compiler, options.renamePrefixNamespace);
		}
	};
	...
	final com.google.javascript.jscomp.PassFactory disambiguateProperties = new com.google.javascript.jscomp.PassFactory("disambiguateProperties", true) {
		...
		protected com.google.javascript.jscomp.CompilerPass createInternal(com.google.javascript.jscomp.AbstractCompiler compiler) {
			if ((tightenTypes) == null) {
				return com.google.javascript.jscomp.DisambiguateProperties.forJSTypeSystem(compiler, options.propertyInvalidationErrors);
			}else {
				return com.google.javascript.jscomp.DisambiguateProperties.forConcreteTypeSystem(compiler, tightenTypes, options.propertyInvalidationErrors);
			}
		}
	};
	...
	final com.google.javascript.jscomp.PassFactory inlineFunctions = new com.google.javascript.jscomp.PassFactory("inlineFunctions", false) {
		...
		protected com.google.javascript.jscomp.CompilerPass createInternal(com.google.javascript.jscomp.AbstractCompiler compiler) {
			...
			return new com.google.javascript.jscomp.InlineFunctions(compiler, compiler.getUniqueNameIdSupplier(), options.inlineFunctions, options.inlineLocalFunctions, enableBlockInlining, ((options.assumeStrictThis()) || ((options.getLanguageIn()) == (com.google.javascript.jscomp.CompilerOptions.LanguageMode.ECMASCRIPT5_STRICT))), true);
		}
	};

	final com.google.javascript.jscomp.PassFactory inlineProperties = new com.google.javascript.jscomp.PassFactory("inlineProperties", false) {
		@java.lang.Override
		protected com.google.javascript.jscomp.CompilerPass createInternal(com.google.javascript.jscomp.AbstractCompiler compiler) {
			return new com.google.javascript.jscomp.InlineProperties(compiler);
		}
	};
	...
	final com.google.javascript.jscomp.PassFactory nameMappedAnonymousFunctions = new com.google.javascript.jscomp.PassFactory("nameAnonymousFunctions", true) {
		...
		protected com.google.javascript.jscomp.CompilerPass createInternal(final com.google.javascript.jscomp.AbstractCompiler compiler) {
			return new com.google.javascript.jscomp.CompilerPass() {
				@java.lang.Override
				public void process(com.google.javascript.rhino.Node externs, com.google.javascript.rhino.Node root) {
					com.google.javascript.jscomp.NameAnonymousFunctionsMapped naf = new com.google.javascript.jscomp.NameAnonymousFunctionsMapped(compiler, options.inputAnonymousFunctionNamingMap);
	...
	final com.google.javascript.jscomp.PassFactory renameProperties = new com.google.javascript.jscomp.PassFactory("renameProperties", true) {
		@java.lang.Override
		protected com.google.javascript.jscomp.CompilerPass createInternal(final com.google.javascript.jscomp.AbstractCompiler compiler) {
			final com.google.javascript.jscomp.VariableMap prevPropertyMap = options.inputPropertyMap;
			return new com.google.javascript.jscomp.CompilerPass() {
				@java.lang.Override
				public void process(com.google.javascript.rhino.Node externs, com.google.javascript.rhino.Node root) {
	...
	final com.google.javascript.jscomp.PassFactory renameVars = new com.google.javascript.jscomp.PassFactory("renameVars", true) {
		@java.lang.Override
		protected com.google.javascript.jscomp.CompilerPass createInternal(final com.google.javascript.jscomp.AbstractCompiler compiler) {
			final com.google.javascript.jscomp.VariableMap prevVariableMap = options.inputVariableMap;
			return new com.google.javascript.jscomp.CompilerPass() {
				@java.lang.Override
				public void process(com.google.javascript.rhino.Node externs, com.google.javascript.rhino.Node root) {
