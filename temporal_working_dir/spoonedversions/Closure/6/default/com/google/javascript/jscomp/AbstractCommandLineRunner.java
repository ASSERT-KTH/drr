...
abstract class AbstractCommandLineRunner<A extends com.google.javascript.jscomp.Compiler, B extends com.google.javascript.jscomp.CompilerOptions> {
	...
	private static final java.lang.String OUTPUT_MARKER = "%output%";

	private static final java.lang.String OUTPUT_MARKER_JS_STRING = "%output|jsstring%";
	...
	static com.google.javascript.jscomp.DependencyOptions createDependencyOptions(boolean manageClosureDependencies, boolean onlyClosureDependencies, boolean processCommonJSModules, java.util.List<java.lang.String> closureEntryPoints) throws com.google.javascript.jscomp.AbstractCommandLineRunner.FlagUsageException {
		if (onlyClosureDependencies) {
			...
			return new com.google.javascript.jscomp.DependencyOptions().setDependencyPruning(true).setDependencySorting(true).setMoocherDropping(true).setEntryPoints(closureEntryPoints);
		}else
			if (processCommonJSModules) {
				return new com.google.javascript.jscomp.DependencyOptions().setDependencyPruning(false).setDependencySorting(true).setMoocherDropping(false).setEntryPoints(closureEntryPoints);
			}else
				if (manageClosureDependencies || ((closureEntryPoints.size()) > 0)) {
					return new com.google.javascript.jscomp.DependencyOptions().setDependencyPruning(true).setDependencySorting(true).setMoocherDropping(false).setEntryPoints(closureEntryPoints);
				}
	...
	protected void setRunOptions(com.google.javascript.jscomp.CompilerOptions options) throws com.google.javascript.jscomp.AbstractCommandLineRunner.FlagUsageException, java.io.IOException {
		...
		if (!(config.warningsWhitelistFile.isEmpty())) {
			options.addWarningsGuard(com.google.javascript.jscomp.WhitelistWarningsGuard.fromFile(new java.io.File(config.warningsWhitelistFile)));
		}
		...
		com.google.javascript.jscomp.DependencyOptions depOptions = com.google.javascript.jscomp.AbstractCommandLineRunner.createDependencyOptions(config.manageClosureDependencies, config.onlyClosureDependencies, config.processCommonJSModules, config.closureEntryPoints);
		if (depOptions != null) {
		...
		if (!(config.variableMapInputFile.equals(""))) {
			options.inputVariableMap = com.google.javascript.jscomp.VariableMap.load(config.variableMapInputFile);
		}
		if (!(config.propertyMapInputFile.equals(""))) {
			options.inputPropertyMap = com.google.javascript.jscomp.VariableMap.load(config.propertyMapInputFile);
		}
		if ((config.languageIn.length()) > 0) {
			com.google.javascript.jscomp.CompilerOptions.LanguageMode languageMode = com.google.javascript.jscomp.CompilerOptions.LanguageMode.fromString(config.languageIn);
	...
	void writeModuleOutput(java.lang.Appendable out, com.google.javascript.jscomp.JSModule m) throws com.google.javascript.jscomp.AbstractCommandLineRunner.FlagUsageException, java.io.IOException {
		...
		com.google.javascript.jscomp.AbstractCommandLineRunner.writeOutput(out, compiler, compiler.toSource(m), parsedModuleWrappers.get(m.getName()).replace("%basename%", baseName), "%s", null);
	}

	static void writeOutput(java.lang.Appendable out, com.google.javascript.jscomp.Compiler compiler, java.lang.String code, java.lang.String wrapper, java.lang.String codePlaceholder, @javax.annotation.Nullable
	com.google.common.base.Function<java.lang.String, java.lang.String> escaper) throws java.io.IOException {
	...
	protected int doRun() throws com.google.javascript.jscomp.AbstractCommandLineRunner.FlagUsageException, java.io.IOException {
		...
		if (createCommonJsModules) {
			modules = com.google.common.collect.Lists.newArrayList(compiler.getDegenerateModuleGraph().getAllModules());
		}
	...
	com.google.common.base.Function<java.lang.String, java.lang.String> getJavascriptEscaper() {
		throw new java.lang.UnsupportedOperationException("SourceCodeEscapers is not in the standard release of Guava yet :(");
	}

	void outputSingleBinary() throws java.io.IOException {
		com.google.common.base.Function<java.lang.String, java.lang.String> escaper = null;
		java.lang.String marker = com.google.javascript.jscomp.AbstractCommandLineRunner.OUTPUT_MARKER;
		if (config.outputWrapper.contains(com.google.javascript.jscomp.AbstractCommandLineRunner.OUTPUT_MARKER_JS_STRING)) {
			marker = com.google.javascript.jscomp.AbstractCommandLineRunner.OUTPUT_MARKER_JS_STRING;
			escaper = getJavascriptEscaper();
		}
		com.google.javascript.jscomp.AbstractCommandLineRunner.writeOutput(jsOutput, compiler, compiler.toSource(), config.outputWrapper, marker, escaper);
	}

	private void outputModuleBinaryAndSourceMaps(java.util.List<com.google.javascript.jscomp.JSModule> modules, B options) throws com.google.javascript.jscomp.AbstractCommandLineRunner.FlagUsageException, java.io.IOException {
	...
	private void outputTracerReport() {
		com.google.javascript.jscomp.JvmMetrics.maybeWriteJvmMetrics(com.google.javascript.jscomp.AbstractCommandLineRunner.this.err, "verbose:pretty:all");
		java.io.OutputStreamWriter output = new java.io.OutputStreamWriter(com.google.javascript.jscomp.AbstractCommandLineRunner.this.err);
		try {
			int runtime = 0;
			int runs = 0;
			int changes = 0;
	...
	private void outputModuleGraphJson() throws java.io.IOException {
		if (((config.outputModuleDependencies) != null) && ((config.outputModuleDependencies) != "")) {
			java.io.Writer out = fileNameToOutputWriter2(config.outputModuleDependencies);
	...
	@com.google.common.annotations.VisibleForTesting
	void printModuleGraphJsonTo(com.google.javascript.jscomp.JSModuleGraph graph, java.lang.Appendable out) throws java.io.IOException {
	...
	static class CommandLineConfig {
		...
		com.google.javascript.jscomp.AbstractCommandLineRunner.CommandLineConfig setOnlyClosureDependencies(boolean newVal) {
			com.google.javascript.jscomp.AbstractCommandLineRunner.CommandLineConfig.this.onlyClosureDependencies = newVal;
			return com.google.javascript.jscomp.AbstractCommandLineRunner.CommandLineConfig.this;
		}
		...
		private java.lang.String outputModuleDependencies = null;

		com.google.javascript.jscomp.AbstractCommandLineRunner.CommandLineConfig setOutputModuleDependencies(java.lang.String outputModuleDependencies) {
			com.google.javascript.jscomp.AbstractCommandLineRunner.CommandLineConfig.this.outputModuleDependencies = outputModuleDependencies;
			return com.google.javascript.jscomp.AbstractCommandLineRunner.CommandLineConfig.this;
		}
		...
		com.google.javascript.jscomp.AbstractCommandLineRunner.CommandLineConfig setTransformAMDToCJSModules(boolean transformAMDToCJSModules) {
			com.google.javascript.jscomp.AbstractCommandLineRunner.CommandLineConfig.this.transformAMDToCJSModules = transformAMDToCJSModules;
			return com.google.javascript.jscomp.AbstractCommandLineRunner.CommandLineConfig.this;
		}
		...
		com.google.javascript.jscomp.AbstractCommandLineRunner.CommandLineConfig setProcessCommonJSModules(boolean processCommonJSModules) {
			com.google.javascript.jscomp.AbstractCommandLineRunner.CommandLineConfig.this.processCommonJSModules = processCommonJSModules;
			return com.google.javascript.jscomp.AbstractCommandLineRunner.CommandLineConfig.this;
		}
		...
		com.google.javascript.jscomp.AbstractCommandLineRunner.CommandLineConfig setCommonJSModulePathPrefix(java.lang.String commonJSModulePathPrefix) {
			com.google.javascript.jscomp.AbstractCommandLineRunner.CommandLineConfig.this.commonJSModulePathPrefix = commonJSModulePathPrefix;
			return com.google.javascript.jscomp.AbstractCommandLineRunner.CommandLineConfig.this;
		}

		private java.lang.String warningsWhitelistFile = "";

		com.google.javascript.jscomp.AbstractCommandLineRunner.CommandLineConfig setWarningsWhitelistFile(java.lang.String fileName) {
			com.google.javascript.jscomp.AbstractCommandLineRunner.CommandLineConfig.this.warningsWhitelistFile = fileName;
			return com.google.javascript.jscomp.AbstractCommandLineRunner.CommandLineConfig.this;
		}
	}
