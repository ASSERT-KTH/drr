...
public class DiagnosticGroups {
	...
	static final java.lang.String DIAGNOSTIC_GROUP_NAMES = "accessControls, ambiguousFunctionDecl, checkRegExp, " + ((((((("checkTypes, checkVars, const, constantProperty, deprecated, " + "duplicateMessage, ") + "es5Strict, externsValidation, fileoverviewTags, globalThis, ") + "internetExplorerChecks, invalidCasts, misplacedTypeAnnotation, ") + "missingProperties, ") + "nonStandardJsDocs, strictModuleDepCheck, typeInvalidation, ") + "undefinedNames, undefinedVars, unknownDefines, uselessCode, ") + "visibility");
	...
	public static com.google.javascript.jscomp.DiagnosticGroup FILEOVERVIEW_JSDOC = com.google.javascript.jscomp.DiagnosticGroups.registerDeprecatedGroup("fileoverviewTags");
	...
	public static com.google.javascript.jscomp.DiagnosticGroup VIOLATED_MODULE_DEP = com.google.javascript.jscomp.DiagnosticGroups.registerGroup("violatedModuleDep", com.google.javascript.jscomp.VarCheck.VIOLATED_MODULE_DEP_ERROR);
	...
	public static com.google.javascript.jscomp.DiagnosticGroup MISPLACED_TYPE_ANNOTATION = com.google.javascript.jscomp.DiagnosticGroups.registerGroup("misplacedTypeAnnotation", com.google.javascript.jscomp.RhinoErrorReporter.MISPLACED_TYPE_ANNOTATION);
