...
ANY, STRUCT, DICT;	}
	...
	FunctionType(com.google.javascript.rhino.jstype.JSTypeRegistry registry, java.lang.String name, com.google.javascript.rhino.Node source, com.google.javascript.rhino.jstype.ArrowType arrowType, com.google.javascript.rhino.jstype.JSType typeOfThis, com.google.common.collect.ImmutableList<java.lang.String> templateKeys, boolean isConstructor, boolean nativeType) {
		super(registry, name, registry.getNativeObjectType(com.google.javascript.rhino.jstype.JSTypeNative.FUNCTION_INSTANCE_TYPE), nativeType, templateKeys, null);
		setPrettyPrint(true);
		...
		if (isConstructor) {
			...
			com.google.javascript.rhino.jstype.FunctionType.this.typeOfThis = (typeOfThis != null) ? typeOfThis : new com.google.javascript.rhino.jstype.InstanceObjectType(registry, com.google.javascript.rhino.jstype.FunctionType.this, nativeType, null);
		}else {
	...
	public com.google.javascript.rhino.jstype.ObjectType getPrototype() {
		if ((prototypeSlot) == null) {
			...
			if (refName == null) {
				...
				setPrototype(new com.google.javascript.rhino.jstype.PrototypeObjectType(registry, ((getReferenceName()) + ".prototype"), registry.getNativeObjectType(com.google.javascript.rhino.jstype.JSTypeNative.OBJECT_TYPE), isNativeObjectType(), null, null), null);
			}
		}
