...
public class JsMessageExtractor {
	...
	public JsMessageExtractor(com.google.javascript.jscomp.JsMessage.IdGenerator idGenerator, com.google.javascript.jscomp.JsMessage.Style style) {
		this(idGenerator, style, new com.google.javascript.jscomp.CompilerOptions());
	}

	public JsMessageExtractor(com.google.javascript.jscomp.JsMessage.IdGenerator idGenerator, com.google.javascript.jscomp.JsMessage.Style style, com.google.javascript.jscomp.CompilerOptions options) {
	...
	private class ExtractMessagesVisitor extends com.google.javascript.jscomp.JsMessageVisitor {
		...
		@java.lang.Override
		void processJsMessage(com.google.javascript.jscomp.JsMessage message, com.google.javascript.jscomp.JsMessageDefinition definition) {
	...
	public <T extends com.google.javascript.jscomp.SourceFile> java.util.Collection<com.google.javascript.jscomp.JsMessage> extractMessages(java.lang.Iterable<T> inputs) throws java.io.IOException {
		...
		compiler.init(com.google.common.collect.ImmutableList.<com.google.javascript.jscomp.SourceFile>of(), com.google.common.collect.Lists.newArrayList(inputs), options);
