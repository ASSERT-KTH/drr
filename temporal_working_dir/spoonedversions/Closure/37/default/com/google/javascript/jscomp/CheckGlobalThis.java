...
final class CheckGlobalThis implements com.google.javascript.jscomp.NodeTraversal.Callback {
	...
	public boolean shouldTraverse(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
		if (n.isFunction()) {
			...
			if (!(((((pType == (com.google.javascript.rhino.Token.BLOCK)) || (pType == (com.google.javascript.rhino.Token.SCRIPT))) || (pType == (com.google.javascript.rhino.Token.NAME))) || (pType == (com.google.javascript.rhino.Token.ASSIGN))) || (pType == (com.google.javascript.rhino.Token.STRING)))) {
				return false;
			}
