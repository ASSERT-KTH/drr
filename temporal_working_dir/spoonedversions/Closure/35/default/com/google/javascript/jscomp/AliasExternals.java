...
class AliasExternals implements com.google.javascript.jscomp.CompilerPass {
	...
	java.lang.String aliasableGlobals) {
		...
		if ((!(com.google.common.base.Strings.isNullOrEmpty(unaliasableGlobals))) && (!(com.google.common.base.Strings.isNullOrEmpty(aliasableGlobals)))) {
		...
		if (!(com.google.common.base.Strings.isNullOrEmpty(unaliasableGlobals))) {
		...
		if (!(com.google.common.base.Strings.isNullOrEmpty(aliasableGlobals))) {
	...
	private void replaceAccessor(com.google.javascript.rhino.Node getPropNode) {
		...
		if (props.get(propName).aliasAccessor) {
			...
			com.google.javascript.rhino.Node newNameNode = com.google.javascript.rhino.IR.name(com.google.javascript.jscomp.AliasExternals.getArrayNotationNameFor(propName));
			com.google.javascript.rhino.Node elemNode = com.google.javascript.rhino.IR.getelem(propSrc, newNameNode);
	...
	private void replaceMutator(com.google.javascript.rhino.Node getPropNode) {
		...
		if (prop.aliasMutator) {
			...
			com.google.javascript.rhino.Node callName = com.google.javascript.rhino.IR.name(com.google.javascript.jscomp.AliasExternals.getMutatorFor(propNameNode.getString()));
			com.google.javascript.rhino.Node call = com.google.javascript.rhino.IR.call(callName, propSrc, propDest);
	...
	private void addAccessorPropName(java.lang.String propName, com.google.javascript.rhino.Node root) {
		com.google.javascript.rhino.Node propValue = com.google.javascript.rhino.IR.string(propName);
		com.google.javascript.rhino.Node propNameNode = com.google.javascript.rhino.IR.name(com.google.javascript.jscomp.AliasExternals.getArrayNotationNameFor(propName));
		propNameNode.addChildToFront(propValue);
		com.google.javascript.rhino.Node var = com.google.javascript.rhino.IR.var(propNameNode);
	...
	private void addGlobalAliasNode(com.google.javascript.jscomp.AliasExternals.Symbol global, com.google.javascript.rhino.Node root) {
		...
		com.google.javascript.rhino.Node globalValue = com.google.javascript.rhino.IR.name(global.name);
		globalValue.putBooleanProp(com.google.javascript.rhino.Node.IS_CONSTANT_NAME, global.isConstant);
		com.google.javascript.rhino.Node globalNameNode = com.google.javascript.rhino.IR.name(("GLOBAL_" + globalName));
		globalNameNode.addChildToFront(globalValue);
		com.google.javascript.rhino.Node var = com.google.javascript.rhino.IR.var(globalNameNode);
		root.addChildToFront(var);
		compiler.reportCodeChange();
	}
