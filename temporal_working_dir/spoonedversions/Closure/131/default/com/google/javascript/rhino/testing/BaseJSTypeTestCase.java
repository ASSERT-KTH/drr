...
public abstract class BaseJSTypeTestCase extends junit.framework.TestCase {
	...
	protected com.google.javascript.rhino.jstype.ObjectType CHECKED_UNKNOWN_TYPE;
	...
	protected void initTypes() {
		...
		CHECKED_UNKNOWN_TYPE = registry.getNativeObjectType(com.google.javascript.rhino.jstype.JSTypeNative.CHECKED_UNKNOWN_TYPE);
	...
	protected com.google.javascript.rhino.jstype.TemplatizedType createTemplatizedType(com.google.javascript.rhino.jstype.ObjectType baseType, com.google.common.collect.ImmutableList<com.google.javascript.rhino.jstype.JSType> templatizedTypes) {
		return registry.createTemplatizedType(baseType, templatizedTypes);
	}

	protected com.google.javascript.rhino.jstype.TemplatizedType createTemplatizedType(com.google.javascript.rhino.jstype.ObjectType baseType, com.google.javascript.rhino.jstype.JSType... templatizedType) {
		return createTemplatizedType(baseType, com.google.common.collect.ImmutableList.copyOf(templatizedType));
	}
