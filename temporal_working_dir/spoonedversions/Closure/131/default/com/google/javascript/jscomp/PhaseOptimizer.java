...
RUN_PASSES_NOT_RUN_IN_PREV_ITER, RUN_PASSES_THAT_CHANGED_STH_IN_PREV_ITER;	}
	...
	class NamedPass implements com.google.javascript.jscomp.CompilerPass {
		...
		public void process(com.google.javascript.rhino.Node externs, com.google.javascript.rhino.Node root) {
			...
			tracer = new com.google.javascript.jscomp.Tracer("JSCompiler");
			...
			try {
				...
				throw new java.lang.RuntimeException(("Sanity check failed for " + (name)), e);
			}
		}
	}
	...
	class Loop implements com.google.javascript.jscomp.CompilerPass {
		...
		private com.google.javascript.jscomp.CodeChangeHandler recentChange = new com.google.javascript.jscomp.CodeChangeHandler();
