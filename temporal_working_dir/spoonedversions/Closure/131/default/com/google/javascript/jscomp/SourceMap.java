...
ALL {
			...
			@java.lang.Override
			public boolean apply(com.google.javascript.rhino.Node node) {
				return ((((((node.isCall()) || (node.isNew())) || (node.isFunction())) || (node.isName())) || (com.google.javascript.jscomp.NodeUtil.isGet(node))) || (com.google.javascript.jscomp.NodeUtil.isObjectLitKey(node))) || ((node.isString()) && (com.google.javascript.jscomp.NodeUtil.isGet(node.getParent())));
			}
		};	}
	...
	public void addMapping(com.google.javascript.rhino.Node node, com.google.debugging.sourcemap.FilePosition outputStartPosition, com.google.debugging.sourcemap.FilePosition outputEndPosition) {
		...
		if (((generator) instanceof com.google.debugging.sourcemap.SourceMapGeneratorV1) || ((generator) instanceof com.google.debugging.sourcemap.SourceMapGeneratorV2)) {
			lineBaseOffset = 0;
		}
		generator.addMapping(sourceFile, originalName, new com.google.debugging.sourcemap.FilePosition(((node.getLineno()) - lineBaseOffset), node.getCharno()), outputStartPosition, outputEndPosition);
	}
