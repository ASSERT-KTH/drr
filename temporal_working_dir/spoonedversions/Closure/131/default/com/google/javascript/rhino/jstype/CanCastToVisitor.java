...
class CanCastToVisitor implements com.google.javascript.rhino.jstype.RelationshipVisitor<java.lang.Boolean> {
						...
						if (thatType.isUnionType()) {
							...
							if (thatType.isFunctionType()) {
								...
								if (thatType.isTemplatizedType()) {
									return thisType.visit(com.google.javascript.rhino.jstype.CanCastToVisitor.this, thatType.toMaybeTemplatizedType().getReferencedTypeInternal());
								}
	...
	@java.lang.Override
	public java.lang.Boolean caseTemplatizedType(com.google.javascript.rhino.jstype.TemplatizedType thisType, com.google.javascript.rhino.jstype.JSType thatType) {
