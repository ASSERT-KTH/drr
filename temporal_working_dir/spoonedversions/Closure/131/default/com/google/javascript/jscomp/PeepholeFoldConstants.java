...
class PeepholeFoldConstants extends com.google.javascript.jscomp.AbstractPeepholeOptimization {
	static final com.google.javascript.jscomp.DiagnosticType INVALID_GETELEM_INDEX_ERROR = com.google.javascript.jscomp.DiagnosticType.warning("JSC_INVALID_GETELEM_INDEX_ERROR", "Array index not integer: {0}");

	static final com.google.javascript.jscomp.DiagnosticType INDEX_OUT_OF_BOUNDS_ERROR = com.google.javascript.jscomp.DiagnosticType.warning("JSC_INDEX_OUT_OF_BOUNDS_ERROR", "Array index out of bounds: {0}");

	static final com.google.javascript.jscomp.DiagnosticType NEGATING_A_NON_NUMBER_ERROR = com.google.javascript.jscomp.DiagnosticType.warning("JSC_NEGATING_A_NON_NUMBER_ERROR", "Can't negate non-numeric value: {0}");

	static final com.google.javascript.jscomp.DiagnosticType BITWISE_OPERAND_OUT_OF_RANGE = com.google.javascript.jscomp.DiagnosticType.warning("JSC_BITWISE_OPERAND_OUT_OF_RANGE", "Operand out of range, bitwise operation will lose information: {0}");

	static final com.google.javascript.jscomp.DiagnosticType SHIFT_AMOUNT_OUT_OF_BOUNDS = com.google.javascript.jscomp.DiagnosticType.warning("JSC_SHIFT_AMOUNT_OUT_OF_BOUNDS", "Shift amount out of bounds: {0}");

	static final com.google.javascript.jscomp.DiagnosticType FRACTIONAL_BITWISE_OPERAND = com.google.javascript.jscomp.DiagnosticType.warning("JSC_FRACTIONAL_BITWISE_OPERAND", "Fractional bitwise operand: {0}");
		...
		switch (n.getType()) {
			...
			case com.google.javascript.rhino.Token.NEG :
				...
				if (left.isNumber()) {
					...
					report(com.google.javascript.jscomp.PeepholeFoldConstants.NEGATING_A_NON_NUMBER_ERROR, left);
					return n;
				}
			case com.google.javascript.rhino.Token.BITNOT :
				try {
					...
					if ((val >= (java.lang.Integer.MIN_VALUE)) && (val <= (java.lang.Integer.MAX_VALUE))) {
						...
						if (intVal == val) {
							...
							report(com.google.javascript.jscomp.PeepholeFoldConstants.FRACTIONAL_BITWISE_OPERAND, left);
							return n;
						}
					}else {
						report(com.google.javascript.jscomp.PeepholeFoldConstants.BITWISE_OPERAND_OUT_OF_RANGE, left);
						return n;
					}
	...
	private com.google.javascript.rhino.Node tryFoldShift(com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node left, com.google.javascript.rhino.Node right) {
		if ((left.isNumber()) && (right.isNumber())) {
			...
			if (!((rval >= 0) && (rval < 32))) {
				report(com.google.javascript.jscomp.PeepholeFoldConstants.SHIFT_AMOUNT_OUT_OF_BOUNDS, right);
				return n;
			}
			...
			if (rvalInt != rval) {
				report(com.google.javascript.jscomp.PeepholeFoldConstants.FRACTIONAL_BITWISE_OPERAND, right);
				return n;
			}
			switch (n.getType()) {
				case com.google.javascript.rhino.Token.LSH :
	...
	private com.google.javascript.rhino.Node tryFoldComparison(com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node left, com.google.javascript.rhino.Node right) {
		com.google.javascript.rhino.jstype.TernaryValue result = com.google.javascript.jscomp.PeepholeFoldConstants.evaluateComparison(n.getType(), left, right);
		if (result == (com.google.javascript.rhino.jstype.TernaryValue.UNKNOWN)) {
			return n;
		}
		com.google.javascript.rhino.Node newNode = com.google.javascript.jscomp.NodeUtil.booleanNode(result.toBoolean(true));
		n.getParent().replaceChild(n, newNode);
		reportCodeChange();
		return newNode;
	}

	static com.google.javascript.rhino.jstype.TernaryValue evaluateComparison(int op, com.google.javascript.rhino.Node left, com.google.javascript.rhino.Node right) {
		...
		if ((!leftLiteral) || (!rightLiteral)) {
			if ((op != (com.google.javascript.rhino.Token.GT)) && (op != (com.google.javascript.rhino.Token.LT))) {
		...
		int lhType = com.google.javascript.jscomp.PeepholeFoldConstants.getNormalizedNodeType(left);
		int rhType = com.google.javascript.jscomp.PeepholeFoldConstants.getNormalizedNodeType(right);
		switch (lhType) {
			case com.google.javascript.rhino.Token.VOID :
				if (!leftLiteral) {
					return com.google.javascript.rhino.jstype.TernaryValue.UNKNOWN;
					...
					if (!rightLiteral) {
						...
						return com.google.javascript.rhino.jstype.TernaryValue.forBoolean(com.google.javascript.jscomp.PeepholeFoldConstants.compareToUndefined(right, op));
					}
				
			case com.google.javascript.rhino.Token.NULL :
				if (rightLiteral && (com.google.javascript.jscomp.PeepholeFoldConstants.isEqualityOp(op))) {
					return com.google.javascript.rhino.jstype.TernaryValue.forBoolean(com.google.javascript.jscomp.PeepholeFoldConstants.compareToNull(right, op));
				}
			case com.google.javascript.rhino.Token.TRUE :
			case com.google.javascript.rhino.Token.FALSE :
				if (undefinedRight) {
					return com.google.javascript.rhino.jstype.TernaryValue.forBoolean(com.google.javascript.jscomp.PeepholeFoldConstants.compareToUndefined(left, op));
				}
				...
				switch (op) {
					case com.google.javascript.rhino.Token.SHEQ :
					case com.google.javascript.rhino.Token.EQ :
						return com.google.javascript.rhino.jstype.TernaryValue.forBoolean((lhType == rhType));
					case com.google.javascript.rhino.Token.SHNE :
					case com.google.javascript.rhino.Token.NE :
						return com.google.javascript.rhino.jstype.TernaryValue.forBoolean((lhType != rhType));
					case com.google.javascript.rhino.Token.GE :
					...
					case com.google.javascript.rhino.Token.GT :
					case com.google.javascript.rhino.Token.LT :
						return com.google.javascript.jscomp.PeepholeFoldConstants.compareAsNumbers(op, left, right);
				}
				return com.google.javascript.rhino.jstype.TernaryValue.UNKNOWN;
			...
			case com.google.javascript.rhino.Token.STRING :
				...
				if (nullRight && (com.google.javascript.jscomp.PeepholeFoldConstants.isEqualityOp(op))) {
					return com.google.javascript.rhino.jstype.TernaryValue.forBoolean(com.google.javascript.jscomp.PeepholeFoldConstants.compareToNull(left, op));
				}
				...
				switch (op) {
					case com.google.javascript.rhino.Token.SHEQ :
					case com.google.javascript.rhino.Token.EQ :
						return com.google.javascript.jscomp.PeepholeFoldConstants.areStringsEqual(left.getString(), right.getString());
					case com.google.javascript.rhino.Token.SHNE :
					case com.google.javascript.rhino.Token.NE :
						return com.google.javascript.jscomp.PeepholeFoldConstants.areStringsEqual(left.getString(), right.getString()).not();
				}
				return com.google.javascript.rhino.jstype.TernaryValue.UNKNOWN;
			case com.google.javascript.rhino.Token.NUMBER :
				if (undefinedRight) {
			...
			case com.google.javascript.rhino.Token.NAME :
				...
				if (rightLiteral) {
					...
					if ((leftLiteral && nullRight) && (com.google.javascript.jscomp.PeepholeFoldConstants.isEqualityOp(op))) {
						return com.google.javascript.rhino.jstype.TernaryValue.forBoolean(com.google.javascript.jscomp.PeepholeFoldConstants.compareToNull(left, op));
					}
				}
	...
	private static com.google.javascript.rhino.jstype.TernaryValue areStringsEqual(java.lang.String a, java.lang.String b) {
	...
	private static int getNormalizedNodeType(com.google.javascript.rhino.Node n) {
		int type = n.getType();
	...
	private static com.google.javascript.rhino.jstype.TernaryValue compareAsNumbers(int op, com.google.javascript.rhino.Node left, com.google.javascript.rhino.Node right) {
		...
		switch (op) {
			...
			case com.google.javascript.rhino.Token.EQ :
				...
				return com.google.javascript.rhino.jstype.TernaryValue.forBoolean((lv == rv));
			case com.google.javascript.rhino.Token.SHNE :
			case com.google.javascript.rhino.Token.NE :
				com.google.common.base.Preconditions.checkState(((left.isNumber()) && (right.isNumber())));
				return com.google.javascript.rhino.jstype.TernaryValue.forBoolean((lv != rv));
	...
	private static boolean compareToUndefined(com.google.javascript.rhino.Node value, int op) {
	...
	private static boolean compareToNull(com.google.javascript.rhino.Node value, int op) {
		boolean valueUndefined = com.google.javascript.jscomp.NodeUtil.isUndefined(value);
		boolean valueNull = (com.google.javascript.rhino.Token.NULL) == (value.getType());
		boolean equivalent = valueUndefined || valueNull;
		switch (op) {
	...
	private com.google.javascript.rhino.Node tryFoldArrayAccess(com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node left, com.google.javascript.rhino.Node right) {
		...
		if (intIndex != index) {
			report(com.google.javascript.jscomp.PeepholeFoldConstants.INVALID_GETELEM_INDEX_ERROR, right);
			return n;
		}
		if (intIndex < 0) {
			report(com.google.javascript.jscomp.PeepholeFoldConstants.INDEX_OUT_OF_BOUNDS_ERROR, right);
			return n;
		}
