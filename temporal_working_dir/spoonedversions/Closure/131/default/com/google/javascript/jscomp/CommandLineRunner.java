...
public class CommandLineRunner extends com.google.javascript.jscomp.AbstractCommandLineRunner<com.google.javascript.jscomp.Compiler, com.google.javascript.jscomp.CompilerOptions> {
	private static class GuardLevel {
		...
		GuardLevel(java.lang.String name, com.google.javascript.jscomp.CheckLevel level) {
			this.name = name;
			this.level = level;
		}
	}
	...
	private static class Flags {
		private static java.util.List<com.google.javascript.jscomp.CommandLineRunner.GuardLevel> guardLevels = com.google.common.collect.Lists.newArrayList();
		...
		@org.kohsuke.args4j.Option(name = "--use_types_for_optimization", usage = "Experimental: perform additional optimizations " + ("based on available information.  Inaccurate type annotations " + "may result in incorrect results."))
		...
		@org.kohsuke.args4j.Option(name = "--formatting", usage = "Specifies which formatting options, if any, should be " + ("applied to the output JS. Options: " + "PRETTY_PRINT, PRINT_INPUT_DELIMITER, SINGLE_QUOTES"))
		...
		@org.kohsuke.args4j.Option(name = "--process_common_js_modules", usage = "Process CommonJS modules to a concatenable form.")
		private boolean process_common_js_modules = false;

		@org.kohsuke.args4j.Option(name = "--common_js_module_path_prefix", usage = "Path prefix to be removed from CommonJS module names.")
		...
		@org.kohsuke.args4j.Option(name = "--transform_amd_modules", usage = "Transform AMD to CommonJS modules.")
		...
		@org.kohsuke.args4j.Option(handler = com.google.javascript.jscomp.CommandLineRunner.Flags.BooleanOptionHandler.class, name = "--only_closure_dependencies", usage = "Only include files in the transitive dependency of the " + (("entry points (specified by closure_entry_point). Files that do " + "not provide dependencies will be removed. This supersedes") + "manage_closure_dependencies"))
		...
		@org.kohsuke.args4j.Option(handler = com.google.javascript.jscomp.CommandLineRunner.Flags.BooleanOptionHandler.class, name = "--angular_pass", usage = "Generate $inject properties for AngularJS for functions " + "annotated with @ngInject")
		...
		@org.kohsuke.args4j.Option(name = "--output_module_dependencies", usage = "Prints out a JSON file of dependencies between modules.")
		private java.lang.String output_module_dependencies = "";
		...
		@org.kohsuke.args4j.Option(name = "--warnings_whitelist_file", usage = "A file containing warnings to suppress. Each line should be " + ("of the form\n" + "<file-name>:<line-number>?  <warning-description>"))
		private java.lang.String warnings_whitelist_file = "";

		@org.kohsuke.args4j.Option(name = "--extra_annotation_name", usage = "A whitelist of tag names in JSDoc. You may specify multiple")
		private java.util.List<java.lang.String> extra_annotation_name = com.google.common.collect.Lists.newArrayList();
		...
		private static class WarningGuardSetter implements org.kohsuke.args4j.spi.Setter<java.lang.String> {
			...
			public void addValue(java.lang.String value) throws org.kohsuke.args4j.CmdLineException {
				...
				com.google.javascript.jscomp.CommandLineRunner.Flags.guardLevels.add(new com.google.javascript.jscomp.CommandLineRunner.GuardLevel(value, level));
			}
		}

		public static com.google.javascript.jscomp.AbstractCommandLineRunner.WarningGuardSpec getWarningGuardSpec() {
			com.google.javascript.jscomp.AbstractCommandLineRunner.WarningGuardSpec spec = new com.google.javascript.jscomp.AbstractCommandLineRunner.WarningGuardSpec();
			for (com.google.javascript.jscomp.CommandLineRunner.GuardLevel guardLevel : com.google.javascript.jscomp.CommandLineRunner.Flags.guardLevels) {
...
PRETTY_PRINT, PRINT_INPUT_DELIMITER, SINGLE_QUOTES;
	...
	private java.util.List<java.lang.String> tokenizeKeepingQuotedStrings(java.util.List<java.lang.String> lines) {
		java.util.List<java.lang.String> tokens = com.google.common.collect.Lists.newArrayList();
		java.util.regex.Pattern tokenPattern = java.util.regex.Pattern.compile("(?:[^ \t\f\\x0B\'\"]|(?:\'[^\']*\'|\"[^\"]*\"))+");
	...
	private void processFlagFile(java.io.PrintStream err) throws java.io.IOException, org.kohsuke.args4j.CmdLineException {
		...
		java.util.List<java.lang.String> argsInFile = tokenizeKeepingQuotedStrings(com.google.common.io.Files.readLines(flagFileInput, java.nio.charset.Charset.defaultCharset()));
		flags.flag_file = "";
		...
		java.util.List<com.google.javascript.jscomp.CommandLineRunner.GuardLevel> previous = com.google.common.collect.Lists.newArrayList(com.google.javascript.jscomp.CommandLineRunner.Flags.guardLevels);
		com.google.javascript.jscomp.CommandLineRunner.Flags.guardLevels.clear();
		parserFileArgs.parseArgument(processedFileArgs.toArray(new java.lang.String[]{  }));
		com.google.javascript.jscomp.CommandLineRunner.Flags.guardLevels.addAll(previous);
	...
	private void initConfigFromFlags(java.lang.String[] args, java.io.PrintStream err) {
		...
		if (flags.version) {
			err.println(((((("Closure Compiler (http://code.google.com/closure/compiler)\n" + "Version: ") + (com.google.javascript.jscomp.Compiler.getReleaseVersion())) + "\n") + "Built on: ") + (com.google.javascript.jscomp.Compiler.getReleaseDate())));
			err.flush();
		}
	...
	protected java.util.List<com.google.javascript.jscomp.SourceFile> createExterns() throws com.google.javascript.jscomp.AbstractCommandLineRunner.FlagUsageException, java.io.IOException {
		java.util.List<com.google.javascript.jscomp.SourceFile> externs = super.createExterns();
		if ((flags.use_only_custom_externs) || (isInTestMode())) {
			return externs;
		}else {
			java.util.List<com.google.javascript.jscomp.SourceFile> defaultExterns = com.google.javascript.jscomp.CommandLineRunner.getDefaultExterns();
	...
	public static java.util.List<com.google.javascript.jscomp.SourceFile> getDefaultExterns() throws java.io.IOException {
		java.io.InputStream input = com.google.javascript.jscomp.CommandLineRunner.class.getResourceAsStream("/externs.zip");
		if (input == null) {
			input = com.google.javascript.jscomp.CommandLineRunner.class.getResourceAsStream("externs.zip");
		}
		...
		java.util.Map<java.lang.String, com.google.javascript.jscomp.SourceFile> externsMap = com.google.common.collect.Maps.newHashMap();
		for (java.util.zip.ZipEntry entry = null; (entry = zip.getNextEntry()) != null;) {
			...
			externsMap.put(entry.getName(), com.google.javascript.jscomp.SourceFile.fromInputStream(("externs.zip//" + (entry.getName())), entryStream));
		}
		...
		java.util.List<com.google.javascript.jscomp.SourceFile> externs = com.google.common.collect.Lists.newArrayList();
