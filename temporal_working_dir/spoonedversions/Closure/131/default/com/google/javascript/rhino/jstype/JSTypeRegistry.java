...
public class JSTypeRegistry implements java.io.Serializable {
	...
	public static final java.lang.String OBJECT_INDEX_TEMPLATE = "Object#Key";

	private com.google.javascript.rhino.jstype.TemplateType objectIndexTemplateKey;

	public static final java.lang.String OBJECT_ELEMENT_TEMPLATE = "Object#Element";
...
LAZY_EXPRESSIONS, LAZY_NAMES, IMMEDIATE;	}
	...
	public JSTypeRegistry(com.google.javascript.rhino.ErrorReporter reporter, boolean tolerateUndefinedValues) {
		...
		this.emptyTemplateTypeMap = new com.google.javascript.rhino.jstype.TemplateTypeMap(com.google.javascript.rhino.jstype.JSTypeRegistry.this, com.google.common.collect.ImmutableList.<com.google.javascript.rhino.jstype.TemplateType>of(), com.google.common.collect.ImmutableList.<com.google.javascript.rhino.jstype.JSType>of());
	...
	public com.google.javascript.rhino.jstype.TemplateType getObjectElementKey() {
		return com.google.javascript.rhino.jstype.JSTypeRegistry.this.objectElementTemplateKey;
	}

	public com.google.javascript.rhino.jstype.TemplateType getObjectIndexKey() {
		com.google.common.base.Preconditions.checkNotNull(objectIndexTemplateKey);
	...
	private void initializeBuiltInTypes() {
		objectIndexTemplateKey = new com.google.javascript.rhino.jstype.TemplateType(com.google.javascript.rhino.jstype.JSTypeRegistry.this, com.google.javascript.rhino.jstype.JSTypeRegistry.OBJECT_INDEX_TEMPLATE);
		objectElementTemplateKey = new com.google.javascript.rhino.jstype.TemplateType(com.google.javascript.rhino.jstype.JSTypeRegistry.this, com.google.javascript.rhino.jstype.JSTypeRegistry.OBJECT_ELEMENT_TEMPLATE);
		...
		com.google.javascript.rhino.jstype.UnknownType checkedUnknownType = new com.google.javascript.rhino.jstype.UnknownType(com.google.javascript.rhino.jstype.JSTypeRegistry.this, true);
		registerNativeType(com.google.javascript.rhino.jstype.JSTypeNative.CHECKED_UNKNOWN_TYPE, checkedUnknownType);
		...
		com.google.javascript.rhino.jstype.PrototypeObjectType TOP_LEVEL_PROTOTYPE = new com.google.javascript.rhino.jstype.PrototypeObjectType(com.google.javascript.rhino.jstype.JSTypeRegistry.this, null, null, true, null);
		registerNativeType(com.google.javascript.rhino.jstype.JSTypeNative.TOP_LEVEL_PROTOTYPE, TOP_LEVEL_PROTOTYPE);
		com.google.javascript.rhino.jstype.FunctionType OBJECT_FUNCTION_TYPE = new com.google.javascript.rhino.jstype.FunctionType(com.google.javascript.rhino.jstype.JSTypeRegistry.this, "Object", null, createArrowType(createOptionalParameters(ALL_TYPE), UNKNOWN_TYPE), null, createTemplateTypeMap(com.google.common.collect.ImmutableList.of(objectIndexTemplateKey, objectElementTemplateKey), null), true, true);
		...
		com.google.javascript.rhino.jstype.FunctionType ARRAY_FUNCTION_TYPE = new com.google.javascript.rhino.jstype.FunctionType(com.google.javascript.rhino.jstype.JSTypeRegistry.this, "Array", null, createArrowType(createParametersWithVarArgs(ALL_TYPE), null), null, createTemplateTypeMap(com.google.common.collect.ImmutableList.of(objectElementTemplateKey), null), true, true);
		...
		com.google.javascript.rhino.jstype.FunctionType BOOLEAN_OBJECT_FUNCTION_TYPE = new com.google.javascript.rhino.jstype.FunctionType(com.google.javascript.rhino.jstype.JSTypeRegistry.this, "Boolean", null, createArrowType(createOptionalParameters(ALL_TYPE), BOOLEAN_TYPE), null, null, true, true);
		...
		com.google.javascript.rhino.jstype.FunctionType NUMBER_OBJECT_FUNCTION_TYPE = new com.google.javascript.rhino.jstype.FunctionType(com.google.javascript.rhino.jstype.JSTypeRegistry.this, "Number", null, createArrowType(createOptionalParameters(ALL_TYPE), NUMBER_TYPE), null, null, true, true);
		...
		com.google.javascript.rhino.jstype.FunctionType STRING_OBJECT_FUNCTION_TYPE = new com.google.javascript.rhino.jstype.FunctionType(com.google.javascript.rhino.jstype.JSTypeRegistry.this, "String", null, createArrowType(createOptionalParameters(ALL_TYPE), STRING_TYPE), null, null, true, true);
		...
		com.google.javascript.rhino.jstype.FunctionType U2U_CONSTRUCTOR_TYPE = new com.google.javascript.rhino.jstype.FunctionType(com.google.javascript.rhino.jstype.JSTypeRegistry.this, "Function", null, createArrowType(createParametersWithVarArgs(UNKNOWN_TYPE), UNKNOWN_TYPE), UNKNOWN_TYPE, null, true, true) {
			private static final long serialVersionUID = 1L;
	...
	private void register(com.google.javascript.rhino.jstype.JSType type, java.lang.String name) {
		com.google.common.base.Preconditions.checkArgument((!(name.contains("<"))), "Type names cannot contain template annotations.");
	...
	public com.google.javascript.rhino.jstype.ObjectType createAnonymousObjectType(com.google.javascript.rhino.JSDocInfo info) {
	...
	com.google.javascript.rhino.jstype.ObjectType createNativeAnonymousObjectType() {
		com.google.javascript.rhino.jstype.PrototypeObjectType type = new com.google.javascript.rhino.jstype.PrototypeObjectType(com.google.javascript.rhino.jstype.JSTypeRegistry.this, null, null, true, null);
		type.setPrettyPrint(true);
		return type;
	}

	public com.google.javascript.rhino.jstype.FunctionType createConstructorType(java.lang.String name, com.google.javascript.rhino.Node source, com.google.javascript.rhino.Node parameters, com.google.javascript.rhino.jstype.JSType returnType, com.google.common.collect.ImmutableList<java.lang.String> templateKeyNames) {
		return createConstructorTypeInternal(name, source, parameters, returnType, createTemplateMapKeys(templateKeyNames));
	}

	private com.google.javascript.rhino.jstype.FunctionType createConstructorTypeInternal(java.lang.String name, com.google.javascript.rhino.Node source, com.google.javascript.rhino.Node parameters, com.google.javascript.rhino.jstype.JSType returnType, com.google.common.collect.ImmutableList<com.google.javascript.rhino.jstype.TemplateType> templateKeys) {
		return new com.google.javascript.rhino.jstype.FunctionType(com.google.javascript.rhino.jstype.JSTypeRegistry.this, name, source, createArrowType(parameters, returnType), null, createTemplateTypeMap(templateKeys, null), true, false);
	}

	com.google.common.collect.ImmutableList<com.google.javascript.rhino.jstype.TemplateType> createTemplateMapKeys(com.google.common.collect.ImmutableList<java.lang.String> keys) {
		...
		if (keys != null) {
			for (java.lang.String key : keys) {
				builder.add(new com.google.javascript.rhino.jstype.TemplateType(com.google.javascript.rhino.jstype.JSTypeRegistry.this, key));
			}
		}
		return builder.build();
	}
	...
	public com.google.javascript.rhino.jstype.TemplateType createTemplateType(java.lang.String name) {
		return new com.google.javascript.rhino.jstype.TemplateType(com.google.javascript.rhino.jstype.JSTypeRegistry.this, name);
	}

	public com.google.javascript.rhino.jstype.TemplateTypeMap createTemplateTypeMap(com.google.common.collect.ImmutableList<com.google.javascript.rhino.jstype.TemplateType> templateKeys, com.google.common.collect.ImmutableList<com.google.javascript.rhino.jstype.JSType> templateValues) {
		templateKeys = (templateKeys == null) ? com.google.common.collect.ImmutableList.<com.google.javascript.rhino.jstype.TemplateType>of() : templateKeys;
		templateValues = (templateValues == null) ? com.google.common.collect.ImmutableList.<com.google.javascript.rhino.jstype.JSType>of() : templateValues;
		return (templateKeys.isEmpty()) && (templateValues.isEmpty()) ? emptyTemplateTypeMap : new com.google.javascript.rhino.jstype.TemplateTypeMap(com.google.javascript.rhino.jstype.JSTypeRegistry.this, templateKeys, templateValues);
	}

	public com.google.javascript.rhino.jstype.TemplatizedType createTemplatizedType(com.google.javascript.rhino.jstype.ObjectType baseType, com.google.common.collect.ImmutableList<com.google.javascript.rhino.jstype.JSType> templatizedTypes) {
		return new com.google.javascript.rhino.jstype.TemplatizedType(com.google.javascript.rhino.jstype.JSTypeRegistry.this, baseType, templatizedTypes);
	}

	public com.google.javascript.rhino.jstype.TemplatizedType createTemplatizedType(com.google.javascript.rhino.jstype.ObjectType baseType, com.google.javascript.rhino.jstype.JSType... templatizedTypes) {
		return createTemplatizedType(baseType, com.google.common.collect.ImmutableList.copyOf(templatizedTypes));
	}
			...
			case com.google.javascript.rhino.Token.STRING :
				...
				if ((namedType instanceof com.google.javascript.rhino.jstype.ObjectType) && (!(nonNullableTypeNames.contains(n.getString())))) {
					...
					if ((typeList != null) && (nAllowedTypes > 0)) {
						com.google.common.collect.ImmutableList.Builder<com.google.javascript.rhino.jstype.JSType> templateTypes = com.google.common.collect.ImmutableList.builder();
						if ((n.getString().equals("Object")) && ((typeList.getFirstChild()) == (typeList.getLastChild()))) {
							templateTypes.add(getNativeType(com.google.javascript.rhino.jstype.JSTypeNative.UNKNOWN_TYPE));
						}
						int templateNodeIndex = 0;
						for (com.google.javascript.rhino.Node templateNode : typeList.getFirstChild().siblings()) {
							if ((++templateNodeIndex) > nAllowedTypes) {
								break;
							}
							templateTypes.add(createFromTypeNodesInternal(templateNode, sourceName, scope));
						}
						namedType = createTemplatizedType(((com.google.javascript.rhino.jstype.ObjectType) (namedType)), templateTypes.build());
						com.google.common.base.Preconditions.checkNotNull(namedType);
					}
	...
	public void setTemplateTypeNames(java.util.List<com.google.javascript.rhino.jstype.TemplateType> keys) {
		com.google.common.base.Preconditions.checkNotNull(keys);
		for (com.google.javascript.rhino.jstype.TemplateType key : keys) {
