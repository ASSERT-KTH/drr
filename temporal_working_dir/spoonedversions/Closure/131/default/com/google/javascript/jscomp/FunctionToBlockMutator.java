...
class FunctionToBlockMutator {
	...
	private void makeLocalNamesUnique(com.google.javascript.rhino.Node fnNode, boolean isCallInLoop) {
		...
		com.google.javascript.jscomp.NodeTraversal.traverse(compiler, fnNode, new com.google.javascript.jscomp.MakeDeclaredNamesUnique(new com.google.javascript.jscomp.MakeDeclaredNamesUnique.InlineRenamer(compiler.getCodingConvention(), idSupplier, "inline_", isCallInLoop)));
			...
			for (java.util.Map.Entry<java.lang.String, com.google.javascript.rhino.Node> entry : argMap.entrySet()) {
				...
				if (namesToAlias.contains(name)) {
					if (name.equals(com.google.javascript.jscomp.FunctionArgumentInjector.THIS_MARKER)) {
						...
						if ((!(value.isThis())) && (referencesThis || (com.google.javascript.jscomp.NodeUtil.mayHaveSideEffects(value, compiler)))) {
							...
							newArgMap.put(com.google.javascript.jscomp.FunctionArgumentInjector.THIS_MARKER, com.google.javascript.rhino.IR.name(newName).srcrefTree(newValue));
						}
					}else {
						com.google.javascript.rhino.Node newValue = entry.getValue().cloneTree();
	...
	private static com.google.javascript.rhino.Node replaceReturns(com.google.javascript.rhino.Node block, java.lang.String resultName, java.lang.String labelName, boolean resultMustBeSet) {
		...
		if (returnCount > 0) {
			...
			if (returnCount > 0) {
				...
				com.google.javascript.rhino.Node name = com.google.javascript.rhino.IR.labelName(labelName).srcref(block);
				com.google.javascript.rhino.Node label = com.google.javascript.rhino.IR.label(name, block).srcref(block);
				com.google.javascript.rhino.Node newRoot = com.google.javascript.rhino.IR.block().srcref(block);
	...
	private static void addDummyAssignment(com.google.javascript.rhino.Node node, java.lang.String resultName) {
		com.google.common.base.Preconditions.checkArgument(node.isBlock());
	...
	private static void convertLastReturnToStatement(com.google.javascript.rhino.Node block, java.lang.String resultName) {
		...
		com.google.common.base.Preconditions.checkArgument(ret.isReturn());
	...
	private static com.google.javascript.rhino.Node createAssignStatementNode(java.lang.String name, com.google.javascript.rhino.Node expression) {
		...
		com.google.javascript.rhino.Node assign = com.google.javascript.rhino.IR.assign(nameNode, expression);
	...
	private static com.google.javascript.rhino.Node replaceReturnWithBreak(com.google.javascript.rhino.Node current, com.google.javascript.rhino.Node parent, java.lang.String resultName, java.lang.String labelName) {
		...
		if (current.isReturn()) {
			...
			com.google.javascript.rhino.Node breakNode = com.google.javascript.rhino.IR.breakNode(com.google.javascript.rhino.IR.labelName(labelName));
