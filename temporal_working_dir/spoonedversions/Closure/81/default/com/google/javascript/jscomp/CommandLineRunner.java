...
public class CommandLineRunner extends com.google.javascript.jscomp.AbstractCommandLineRunner<com.google.javascript.jscomp.Compiler, com.google.javascript.jscomp.CompilerOptions> {
	private static class Flags {
		...
		@org.kohsuke.args4j.Option(handler = com.google.javascript.jscomp.CommandLineRunner.Flags.BooleanOptionHandler.class, name = "--compute_phase_ordering", usage = "Runs the compile job many times, then prints out the " + "best phase ordering from this run")
		...
		@org.kohsuke.args4j.Option(aliases = { "--dev_mode" }, name = "--jscomp_dev_mode", usage = "Turns on extra sanity checks")
		...
		@org.kohsuke.args4j.Option(name = "--jscomp_error", usage = "Make the named class of warnings an error. Options:" + (com.google.javascript.jscomp.DiagnosticGroups.DIAGNOSTIC_GROUP_NAMES))
		private java.util.List<java.lang.String> jscomp_error = com.google.common.collect.Lists.newArrayList();

		@org.kohsuke.args4j.Option(name = "--jscomp_warning", usage = ("Make the named class of warnings a normal warning. " + "Options:") + (com.google.javascript.jscomp.DiagnosticGroups.DIAGNOSTIC_GROUP_NAMES))
		private java.util.List<java.lang.String> jscomp_warning = com.google.common.collect.Lists.newArrayList();

		@org.kohsuke.args4j.Option(name = "--jscomp_off", usage = "Turn off the named class of warnings. Options:" + (com.google.javascript.jscomp.DiagnosticGroups.DIAGNOSTIC_GROUP_NAMES))
		...
		@org.kohsuke.args4j.Option(name = "--language_in", usage = "Sets what language spec that input sources conform. " + "Options: ECMASCRIPT3 (default), ECMASCRIPT5")
