...
class PeepholeSubstituteAlternateSyntax extends com.google.javascript.jscomp.AbstractPeepholeOptimization {
	...
	private com.google.javascript.rhino.Node tryReplaceUndefined(com.google.javascript.rhino.Node n) {
		if (((isASTNormalized()) && (com.google.javascript.jscomp.NodeUtil.isUndefined(n))) && (!(com.google.javascript.jscomp.NodeUtil.isLhs(n, n.getParent())))) {
		...
		switch (n.getType()) {
			case com.google.javascript.rhino.Token.NOT :
				...
				switch (first.getType()) {
					...
					default :
						com.google.javascript.rhino.jstype.TernaryValue nVal = com.google.javascript.jscomp.NodeUtil.getBooleanValue(first);
