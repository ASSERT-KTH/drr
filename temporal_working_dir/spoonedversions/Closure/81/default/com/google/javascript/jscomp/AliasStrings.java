...
class AliasStrings extends com.google.javascript.jscomp.NodeTraversal.AbstractPostOrderCallback implements com.google.javascript.jscomp.CompilerPass {
	...
	private final java.util.Map<java.lang.String, com.google.javascript.jscomp.AliasStrings.StringInfo> stringInfoMap = new java.util.LinkedHashMap<java.lang.String, com.google.javascript.jscomp.AliasStrings.StringInfo>();
	...
	public void visit(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
		if (((((n.getType()) == (com.google.javascript.rhino.Token.STRING)) && ((parent.getType()) != (com.google.javascript.rhino.Token.GETPROP))) && ((parent.getType()) != (com.google.javascript.rhino.Token.REGEXP))) && (!(com.google.javascript.jscomp.NodeUtil.isObjectLitKey(n, parent)))) {
			...
			if (((aliasableStrings) == null) || (aliasableStrings.contains(str))) {
				...
				if ((info.numOccurrences) == 1) {
					...
					com.google.javascript.rhino.Node prev = n;
					for (com.google.javascript.rhino.Node ancestor : n.getAncestors()) {
						if ((ancestor.getType()) == (com.google.javascript.rhino.Token.SCRIPT)) {
	...
	private void addAliasDeclarationNodes() {
		for (java.util.Map.Entry<java.lang.String, com.google.javascript.jscomp.AliasStrings.StringInfo> entry : stringInfoMap.entrySet()) {
			...
			com.google.javascript.rhino.Node value = com.google.javascript.rhino.Node.newString(com.google.javascript.rhino.Token.STRING, entry.getKey());
			com.google.javascript.rhino.Node name = com.google.javascript.rhino.Node.newString(com.google.javascript.rhino.Token.NAME, alias);
	...
	private void replaceStringWithAliasName(com.google.javascript.jscomp.AliasStrings.StringOccurrence occurrence, java.lang.String name, com.google.javascript.jscomp.AliasStrings.StringInfo info) {
		occurrence.parent.replaceChild(occurrence.node, com.google.javascript.rhino.Node.newString(com.google.javascript.rhino.Token.NAME, name));
		info.isAliased = true;
		compiler.reportCodeChange();
	}
	...
	private void outputStringUsage() {
		...
		for (java.lang.String str : stringInfoMap.keySet()) {
			com.google.javascript.jscomp.AliasStrings.StringInfo info = stringInfoMap.get(str);
			if ((info.numOccurrences) > 1) {
