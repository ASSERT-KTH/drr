...
class ReplaceStrings extends com.google.javascript.jscomp.NodeTraversal.AbstractPostOrderCallback implements com.google.javascript.jscomp.CompilerPass {
	...
	ReplaceStrings(com.google.javascript.jscomp.AbstractCompiler compiler, java.lang.String placeholderToken, java.util.List<java.lang.String> functionsToInspect, java.util.Set<java.lang.String> blacklisted, com.google.javascript.jscomp.VariableMap previousMappings) {
		this.compiler = compiler;
		this.placeholderToken = (placeholderToken.isEmpty()) ? DEFAULT_PLACEHOLDER_TOKEN : placeholderToken;
		this.registry = compiler.getTypeRegistry();
		java.lang.Iterable<java.lang.String> reservedNames = blacklisted;
		if (previousMappings != null) {
			java.util.Set<java.lang.String> previous = previousMappings.getOriginalNameToNewNameMap().keySet();
			reservedNames = com.google.common.collect.Iterables.concat(blacklisted, previous);
	...
	private void initMapping(com.google.javascript.jscomp.VariableMap previousVarMap, java.util.Set<java.lang.String> reservedNames) {
		java.util.Map<java.lang.String, java.lang.String> previous = previousVarMap.getOriginalNameToNewNameMap();
		for (java.util.Map.Entry<java.lang.String, java.lang.String> entry : previous.entrySet()) {
			java.lang.String key = entry.getKey();
			if (!(reservedNames.contains(key))) {
				java.lang.String value = entry.getValue();
				results.put(value, new com.google.javascript.jscomp.ReplaceStrings.Result(value, key));
			}
		}
	}

	static final com.google.common.base.Predicate<com.google.javascript.jscomp.ReplaceStrings.Result> USED_RESULTS = new com.google.common.base.Predicate<com.google.javascript.jscomp.ReplaceStrings.Result>() {
		@java.lang.Override
		public boolean apply(com.google.javascript.jscomp.ReplaceStrings.Result result) {
			return !(result.replacementLocations.isEmpty());
		}
	};

	java.util.List<com.google.javascript.jscomp.ReplaceStrings.Result> getResult() {
		return com.google.common.collect.ImmutableList.copyOf(com.google.common.collect.Iterables.filter(results.values(), com.google.javascript.jscomp.ReplaceStrings.USED_RESULTS));
	}
	...
	com.google.javascript.jscomp.VariableMap getStringMap() {
		...
		for (com.google.javascript.jscomp.ReplaceStrings.Result result : com.google.common.collect.Iterables.filter(results.values(), com.google.javascript.jscomp.ReplaceStrings.USED_RESULTS)) {
			map.put(result.replacement, result.original);
		}
		com.google.javascript.jscomp.VariableMap stringMap = new com.google.javascript.jscomp.VariableMap(map.build());
		return stringMap;
	}
	...
	private void doSubstitutions(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.jscomp.ReplaceStrings.Config config, com.google.javascript.rhino.Node n) {
		com.google.common.base.Preconditions.checkState(((n.isNew()) || (n.isCall())));
	...
	private com.google.javascript.rhino.Node replaceExpression(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node expr, com.google.javascript.rhino.Node parent) {
		...
		switch (expr.getType()) {
			case com.google.javascript.rhino.Token.STRING :
				...
				replacement = com.google.javascript.rhino.IR.string(replacementString);
				break;
			case com.google.javascript.rhino.Token.ADD :
				java.lang.StringBuilder keyBuilder = new java.lang.StringBuilder();
				com.google.javascript.rhino.Node keyNode = com.google.javascript.rhino.IR.string("");
	...
	private com.google.javascript.rhino.Node buildReplacement(com.google.javascript.rhino.Node expr, com.google.javascript.rhino.Node prefix, java.lang.StringBuilder keyBuilder) {
		switch (expr.getType()) {
			...
			default :
				...
				prefix = com.google.javascript.rhino.IR.add(prefix, com.google.javascript.rhino.IR.string(placeholderToken));
				return com.google.javascript.rhino.IR.add(prefix, expr.cloneTree());
		}
	}
	...
	private static com.google.javascript.jscomp.NameGenerator createNameGenerator(java.lang.Iterable<java.lang.String> reserved) {
		final java.lang.String namePrefix = "";
		final char[] reservedChars = new char[0];
		return new com.google.javascript.jscomp.NameGenerator(com.google.common.collect.ImmutableSet.copyOf(reserved), namePrefix, reservedChars);
	}
}
