...
public class Asserts {
	...
	public static void assertEquivalenceOperations(com.google.javascript.rhino.jstype.JSType a, com.google.javascript.rhino.jstype.JSType b) {
		...
		junit.framework.Assert.assertTrue(a.canCastTo(b));
		junit.framework.Assert.assertTrue(a.canCastTo(a));
		junit.framework.Assert.assertTrue(b.canCastTo(b));
		junit.framework.Assert.assertTrue(b.canCastTo(a));
	}
}
