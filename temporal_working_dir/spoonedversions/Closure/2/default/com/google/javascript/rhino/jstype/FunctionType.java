...
ANY, STRUCT, DICT;	}
		...
		if (!(hasOwnProperty(name))) {
			...
			if (isCall || isBind) {
				...
				if ("apply".equals(name)) {
					...
					defineDeclaredProperty(name, new com.google.javascript.rhino.jstype.FunctionBuilder(registry).withParams(builder).withReturnType(getReturnType()).withTemplateKeys(getTemplateKeys()).build(), source);
				}
	...
	public com.google.javascript.rhino.jstype.FunctionType getBindReturnType(int argsToBind) {
		com.google.javascript.rhino.jstype.FunctionBuilder builder = new com.google.javascript.rhino.jstype.FunctionBuilder(registry).withReturnType(getReturnType()).withTemplateKeys(getTemplateKeys());
		if (argsToBind >= 0) {
	...
	private com.google.javascript.rhino.jstype.FunctionType getCallOrBindSignature(boolean isCall) {
		...
		com.google.javascript.rhino.jstype.FunctionBuilder builder = new com.google.javascript.rhino.jstype.FunctionBuilder(registry).withReturnType((isCall ? getReturnType() : getBindReturnType((-1)))).withTemplateKeys(getTemplateKeys());
		com.google.javascript.rhino.Node origParams = getParametersNode();
		if (origParams != null) {
			com.google.javascript.rhino.Node params = origParams.cloneTree();
