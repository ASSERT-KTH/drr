...
public class ParserRunner {
	...
	private static java.util.Set<java.lang.String> reservedVars = null;
	...
	public static java.util.Set<java.lang.String> getReservedVars() {
		com.google.javascript.jscomp.parsing.ParserRunner.initResourceConfig();
		return com.google.javascript.jscomp.parsing.ParserRunner.reservedVars;
	}
	...
	private static synchronized void initResourceConfig() {
		...
		com.google.javascript.jscomp.parsing.ParserRunner.reservedVars = com.google.javascript.jscomp.parsing.ParserRunner.extractList(config.getString("compiler.reserved.vars"));
	}
	...
	public static com.google.javascript.jscomp.parsing.ParserRunner.ParseResult parse(com.google.javascript.rhino.jstype.StaticSourceFile sourceFile, java.lang.String sourceString, com.google.javascript.jscomp.parsing.Config config, com.google.javascript.rhino.head.ErrorReporter errorReporter, java.util.logging.Logger logger) throws java.io.IOException {
		com.google.javascript.rhino.head.Context cx = com.google.javascript.rhino.head.Context.enter();
		cx.setErrorReporter(errorReporter);
		cx.setLanguageVersion(com.google.javascript.rhino.head.Context.VERSION_1_5);
		com.google.javascript.rhino.head.CompilerEnvirons compilerEnv = new com.google.javascript.rhino.head.CompilerEnvirons();
		...
		boolean acceptEs5 = (config.isIdeMode) || ((config.languageMode) != (com.google.javascript.jscomp.parsing.Config.LanguageMode.ECMASCRIPT3));
		...
		com.google.javascript.rhino.head.ast.AstRoot astRoot = null;
		try {
			...
			com.google.javascript.rhino.head.Context.exit();
		}
		...
		return new com.google.javascript.jscomp.parsing.ParserRunner.ParseResult(root, astRoot);
	}
	...
	public static class ParseResult {
		...
		public ParseResult(com.google.javascript.rhino.Node ast, com.google.javascript.rhino.head.ast.AstRoot oldAst) {
			this.ast = ast;
			this.oldAst = oldAst;
		}
	}
