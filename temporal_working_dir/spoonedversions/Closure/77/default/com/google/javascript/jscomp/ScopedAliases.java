...
class ScopedAliases implements com.google.javascript.jscomp.CompilerPass {
	...
	ScopedAliases(com.google.javascript.jscomp.AbstractCompiler compiler) {
	...
	private class Traversal implements com.google.javascript.jscomp.NodeTraversal.ScopedCallback {
		private java.util.List<com.google.javascript.rhino.Node> aliasDefinitions = com.google.common.collect.Lists.newArrayList();

		private java.util.List<com.google.javascript.rhino.Node> scopeCalls = com.google.common.collect.Lists.newArrayList();

		private java.util.List<com.google.javascript.jscomp.ScopedAliases.AliasUsage> aliasUsages = com.google.common.collect.Lists.newArrayList();

		private java.util.Map<java.lang.String, com.google.javascript.jscomp.Scope.Var> aliases = com.google.common.collect.Maps.newHashMap();
		...
		public void visit(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
			if (isCallToScopeMethod(n)) {
				...
				if ((n.getChildCount()) != 2) {
					...
					if (((!(com.google.javascript.jscomp.NodeUtil.isFunction(anonymousFnNode))) || ((com.google.javascript.jscomp.NodeUtil.getFunctionName(anonymousFnNode)) != null)) || (com.google.javascript.jscomp.NodeUtil.getFnParameters(anonymousFnNode).hasChildren())) {
