...
class RenameProperties implements com.google.javascript.jscomp.CompilerPass {
	...
	private final com.google.javascript.jscomp.graph.UndiGraph<com.google.javascript.jscomp.RenameProperties.Property, com.google.javascript.jscomp.RenameProperties.PropertyAffinity> affinityGraph = com.google.javascript.jscomp.graph.LinkedUndirectedGraph.createWithoutAnnotations();
	...
	private void computeAffinityScores() {
		for (com.google.javascript.jscomp.RenameProperties.Property p : propertyMap.values()) {
			for (com.google.javascript.jscomp.RenameProperties.Property other : propertyMap.values()) {
				if ((p != other) && ((p.numOccurrences) < (other.numOccurrences))) {
					java.util.List<com.google.javascript.jscomp.graph.Graph.GraphEdge<com.google.javascript.jscomp.RenameProperties.Property, com.google.javascript.jscomp.RenameProperties.PropertyAffinity>> edges = affinityGraph.getEdges(p, other);
					if (!(edges.isEmpty())) {
				...
				for (com.google.javascript.jscomp.RenameProperties.Property p1 : currentHighAffinityProperties) {
					for (com.google.javascript.jscomp.RenameProperties.Property p2 : currentHighAffinityProperties) {
						if ((p1.oldName.compareTo(p2.oldName)) < 0) {
							java.util.List<com.google.javascript.jscomp.graph.Graph.GraphEdge<com.google.javascript.jscomp.RenameProperties.Property, com.google.javascript.jscomp.RenameProperties.PropertyAffinity>> edges = affinityGraph.getEdges(p1, p2);
							if (edges.isEmpty()) {
