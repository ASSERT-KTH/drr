...
public class Validator {
	...
	private void validateDataProp(com.google.javascript.jscomp.jsonml.JsonML element) {
		validateChildrenSize(element, 1);
		if (!(error)) {
	...
	private void validateObjectExpr(com.google.javascript.jscomp.jsonml.JsonML element) {
		for (int i = 0; i < (element.childrenSize()); ++i) {
			validateChildType(element, com.google.javascript.jscomp.jsonml.TagType.DataProp, i);
		}
	}
