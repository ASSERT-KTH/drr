		...
		switch (n.getType()) {
			...
			case com.google.javascript.rhino.Token.FUNCTION :
				...
				if (((current.getType()) == (com.google.javascript.rhino.Token.THIS)) || ((current.getType()) == (com.google.javascript.rhino.Token.NEW))) {
					...
					thisType = com.google.javascript.rhino.jstype.ObjectType.cast(createFromTypeNodesInternal(contextNode, sourceName, scope, false).restrictByNotNullOrUndefined());
					if (thisType == null) {
