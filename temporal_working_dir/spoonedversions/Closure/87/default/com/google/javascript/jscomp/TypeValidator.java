...
class TypeValidator {
	...
	boolean expectNotVoid(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.jstype.JSType type, java.lang.String msg, com.google.javascript.rhino.jstype.JSType expectedType) {
		if (type.isVoidType()) {
	...
	void expectAllInterfacePropertiesImplemented(com.google.javascript.rhino.jstype.FunctionType type) {
			...
			if ((implemented.getImplicitPrototype()) != null) {
				for (java.lang.String prop : implemented.getImplicitPrototype().getOwnPropertyNames()) {
					if (!(instance.hasProperty(prop))) {
						com.google.javascript.rhino.Node source = type.getSource();
						com.google.common.base.Preconditions.checkNotNull(source);
						java.lang.String sourceName = ((java.lang.String) (source.getProp(com.google.javascript.rhino.Node.SOURCENAME_PROP)));
						sourceName = (sourceName == null) ? "" : sourceName;
						if (shouldReport) {
							compiler.report(com.google.javascript.jscomp.JSError.make(sourceName, source, com.google.javascript.jscomp.TypeValidator.INTERFACE_METHOD_NOT_IMPLEMENTED, prop, implemented.toString(), instance.toString()));
						}
