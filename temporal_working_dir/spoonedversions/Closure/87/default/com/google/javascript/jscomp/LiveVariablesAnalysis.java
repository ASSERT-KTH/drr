...
class LiveVariablesAnalysis extends com.google.javascript.jscomp.DataFlowAnalysis<com.google.javascript.rhino.Node, com.google.javascript.jscomp.LiveVariablesAnalysis.LiveVariableLattice> {
	...
	static class LiveVariableLattice implements com.google.javascript.jscomp.LatticeElement {
	...
	private void computeGenKill(com.google.javascript.rhino.Node n, java.util.BitSet gen, java.util.BitSet kill, boolean conditional) {
		switch (n.getType()) {
			...
			case com.google.javascript.rhino.Token.NAME :
				...
				return ;
			default :
				if ((com.google.javascript.jscomp.NodeUtil.isAssignmentOp(n)) && (com.google.javascript.jscomp.NodeUtil.isName(n.getFirstChild()))) {
					com.google.javascript.rhino.Node lhs = n.getFirstChild();
					if (!conditional) {
						addToSetIfLocal(lhs, kill);
					}
	...
	private void addToSetIfLocal(com.google.javascript.rhino.Node node, java.util.BitSet set) {
		com.google.common.base.Preconditions.checkState(com.google.javascript.jscomp.NodeUtil.isName(node));
	...
	private boolean isArgumentsName(com.google.javascript.rhino.Node n) {
		if ((((n.getType()) != (com.google.javascript.rhino.Token.NAME)) || (!(n.getString().equals(com.google.javascript.jscomp.LiveVariablesAnalysis.ARGUMENT_ARRAY_ALIAS)))) || (jsScope.isDeclared(com.google.javascript.jscomp.LiveVariablesAnalysis.ARGUMENT_ARRAY_ALIAS, false))) {
			return false;
		}else {
			return true;
		}
