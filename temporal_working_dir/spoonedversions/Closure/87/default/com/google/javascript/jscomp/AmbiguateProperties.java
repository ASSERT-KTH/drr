...
class AmbiguateProperties implements com.google.javascript.jscomp.CompilerPass {
	...
	private void addInvalidatingType(com.google.javascript.rhino.jstype.JSType type) {
		...
		if (objType instanceof com.google.javascript.rhino.jstype.InstanceObjectType) {
	...
	public void process(com.google.javascript.rhino.Node externs, com.google.javascript.rhino.Node root) {
		...
		com.google.javascript.jscomp.AmbiguateProperties.logger.info((((((("Collapsed " + numRenamedPropertyNames) + " properties into ") + numNewPropertyNames) + " and skipped renaming ") + numSkippedPropertyNames) + " properties."));
	}
	...
	private void computeRelatedTypes(com.google.javascript.rhino.jstype.JSType type) {
		...
		if (type instanceof com.google.javascript.rhino.jstype.FunctionPrototypeType) {
			addRelatedInstance(((com.google.javascript.rhino.jstype.FunctionPrototypeType) (type)).getOwnerFunction(), related);
			return ;
		}
	...
	private class Property {
		...
		void addType(com.google.javascript.rhino.jstype.JSType newType) {
			...
			++(numOccurrences);
			if (newType instanceof com.google.javascript.rhino.jstype.UnionType) {
				newType = newType.restrictByNotNullOrUndefined();
				if (newType instanceof com.google.javascript.rhino.jstype.UnionType) {
					for (com.google.javascript.rhino.jstype.JSType alt : ((com.google.javascript.rhino.jstype.UnionType) (newType)).getAlternates()) {
						addNonUnionType(alt);
					}
					return ;
				}
