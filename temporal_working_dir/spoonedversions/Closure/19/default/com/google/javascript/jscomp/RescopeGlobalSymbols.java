...
class RescopeGlobalSymbols implements com.google.javascript.jscomp.CompilerPass {
	...
	private static final java.util.Set<java.lang.String> SPECIAL_EXTERNS = com.google.common.collect.ImmutableSet.of(com.google.javascript.jscomp.RescopeGlobalSymbols.WINDOW, "eval", "arguments");
	...
	private void addExternForGlobalSymbolNamespace() {
		com.google.javascript.rhino.Node varNode = com.google.javascript.rhino.IR.var(com.google.javascript.rhino.IR.name(globalSymbolNamespace));
	...
	public void process(com.google.javascript.rhino.Node externs, com.google.javascript.rhino.Node root) {
		...
		com.google.javascript.jscomp.NodeTraversal.traverse(compiler, root, new com.google.javascript.jscomp.RescopeGlobalSymbols.MakeExternsReferenceWindowExplicitly());
	}
	...
	private class RewriteScopeCallback extends com.google.javascript.jscomp.NodeTraversal.AbstractPostOrderCallback {
		...
		private void replaceSymbol(com.google.javascript.rhino.Node node, java.lang.String name) {
			...
			com.google.javascript.rhino.Node replacement = com.google.javascript.rhino.IR.getprop(com.google.javascript.rhino.IR.name(globalSymbolNamespace).srcref(node), com.google.javascript.rhino.IR.string(name).srcref(node));
			replacement.srcref(node);
			if (node.hasChildren()) {
				com.google.javascript.rhino.Node assign = com.google.javascript.rhino.IR.assign(replacement, node.removeFirstChild());
	...
	private class RemoveGlobalVarCallback extends com.google.javascript.jscomp.NodeTraversal.AbstractShallowStatementCallback {
		...
		public void visit(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
			...
			for (com.google.javascript.rhino.Node c : interestingChildren) {
				if ((parent.isFor()) && ((parent.getFirstChild()) == n)) {
					...
					com.google.javascript.rhino.Node expr = com.google.javascript.rhino.IR.exprResult(c.cloneTree()).srcref(c);
		...
		private com.google.javascript.rhino.Node joinOnComma(java.util.List<com.google.javascript.rhino.Node> commas, com.google.javascript.rhino.Node source) {
			...
			for (int i = 1; i < (commas.size()); i++) {
				com.google.javascript.rhino.Node nextComma = com.google.javascript.rhino.IR.comma(comma, commas.get(i));
	...
	private class MakeExternsReferenceWindowExplicitly extends com.google.javascript.jscomp.NodeTraversal.AbstractPostOrderCallback {
		@java.lang.Override
		public void visit(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
			if (!(n.isName())) {
				return ;
			...
			java.lang.String name = n.getString();
			com.google.javascript.jscomp.Scope.Var var = t.getScope().getVar(name);
			if (((((name.length()) > 0) && ((var == null) || (var.isExtern()))) && (!(globalSymbolNamespace.equals(name)))) && (!(com.google.javascript.jscomp.RescopeGlobalSymbols.SPECIAL_EXTERNS.contains(name)))) {
				parent.replaceChild(n, com.google.javascript.rhino.IR.getprop(com.google.javascript.rhino.IR.name(com.google.javascript.jscomp.RescopeGlobalSymbols.WINDOW), com.google.javascript.rhino.IR.string(name)).srcrefTree(n));
				compiler.reportCodeChange();
			}
		}
	}
