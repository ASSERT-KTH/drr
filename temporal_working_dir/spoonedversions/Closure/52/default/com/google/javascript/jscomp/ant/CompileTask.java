...
public final class CompileTask extends org.apache.tools.ant.Task {
	...
	private java.util.List<com.google.javascript.jscomp.JSSourceFile> findJavaScriptFiles(org.apache.tools.ant.types.Path path) {
		java.util.List<com.google.javascript.jscomp.JSSourceFile> files = com.google.common.collect.Lists.newArrayList();
		for (java.lang.String included : path.list()) {
			files.add(com.google.javascript.jscomp.JSSourceFile.fromFile(new java.io.File(included), java.nio.charset.Charset.forName(encoding)));
		}
		return files;
	}
