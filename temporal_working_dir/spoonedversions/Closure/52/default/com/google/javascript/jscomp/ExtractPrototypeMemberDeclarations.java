	...
	private void extractInstance(com.google.javascript.jscomp.ExtractPrototypeMemberDeclarations.ExtractionInstance instance) {
		...
		if ((pattern) == (com.google.javascript.jscomp.ExtractPrototypeMemberDeclarations.Pattern.USE_GLOBAL_TEMP)) {
			...
			if ((pattern) == (com.google.javascript.jscomp.ExtractPrototypeMemberDeclarations.Pattern.USE_ANON_FUNCTION)) {
				...
				com.google.javascript.rhino.Node func = new com.google.javascript.rhino.Node(com.google.javascript.rhino.Token.FUNCTION, com.google.javascript.rhino.Node.newString(com.google.javascript.rhino.Token.NAME, ""), new com.google.javascript.rhino.Node(com.google.javascript.rhino.Token.LP, com.google.javascript.rhino.Node.newString(com.google.javascript.rhino.Token.NAME, prototypeAlias)), block);
