...
abstract class ChainableReverseAbstractInterpreter implements com.google.javascript.jscomp.ReverseAbstractInterpreter {
	...
	ChainableReverseAbstractInterpreter(com.google.javascript.jscomp.CodingConvention convention, com.google.javascript.rhino.jstype.JSTypeRegistry typeRegistry) {
		com.google.common.base.Preconditions.checkNotNull(convention);
		this.convention = convention;
		this.typeRegistry = typeRegistry;
		firstLink = com.google.javascript.jscomp.ChainableReverseAbstractInterpreter.this;
		nextLink = null;
	}

	com.google.javascript.jscomp.ChainableReverseAbstractInterpreter append(com.google.javascript.jscomp.ChainableReverseAbstractInterpreter lastLink) {
		com.google.common.base.Preconditions.checkArgument(((lastLink.nextLink) == null));
		com.google.javascript.jscomp.ChainableReverseAbstractInterpreter.this.nextLink = lastLink;
		lastLink.firstLink = com.google.javascript.jscomp.ChainableReverseAbstractInterpreter.this.firstLink;
		return lastLink;
	}
	...
	protected com.google.javascript.jscomp.FlowScope firstPreciserScopeKnowingConditionOutcome(com.google.javascript.rhino.Node condition, com.google.javascript.jscomp.FlowScope blindScope, boolean outcome) {
		return firstLink.getPreciserScopeKnowingConditionOutcome(condition, blindScope, outcome);
	}

	protected com.google.javascript.jscomp.FlowScope nextPreciserScopeKnowingConditionOutcome(com.google.javascript.rhino.Node condition, com.google.javascript.jscomp.FlowScope blindScope, boolean outcome) {
		return (nextLink) != null ? nextLink.getPreciserScopeKnowingConditionOutcome(condition, blindScope, outcome) : blindScope;
	}

	com.google.javascript.rhino.jstype.JSType getTypeIfRefinable(com.google.javascript.rhino.Node node, com.google.javascript.jscomp.FlowScope scope) {
		switch (node.getType()) {
	...
	protected void declareNameInScope(com.google.javascript.jscomp.FlowScope scope, com.google.javascript.rhino.Node node, com.google.javascript.rhino.jstype.JSType type) {
		switch (node.getType()) {
			case com.google.javascript.rhino.Token.NAME :
	...
	abstract class RestrictByTypeOfResultVisitor implements com.google.javascript.rhino.jstype.Visitor<com.google.javascript.rhino.jstype.JSType> {
		...
		public com.google.javascript.rhino.jstype.JSType caseUnionType(com.google.javascript.rhino.jstype.UnionType type) {
			...
			for (com.google.javascript.rhino.jstype.JSType alternate : type.getAlternates()) {
				com.google.javascript.rhino.jstype.JSType restrictedAlternate = alternate.visit(com.google.javascript.jscomp.ChainableReverseAbstractInterpreter.RestrictByTypeOfResultVisitor.this);
		...
		@java.lang.Override
		public com.google.javascript.rhino.jstype.JSType caseEnumElementType(com.google.javascript.rhino.jstype.EnumElementType enumElementType) {
			com.google.javascript.rhino.jstype.JSType type = enumElementType.getPrimitiveType().visit(com.google.javascript.jscomp.ChainableReverseAbstractInterpreter.RestrictByTypeOfResultVisitor.this);
			if ((type != null) && (enumElementType.getPrimitiveType().equals(type))) {
				return enumElementType;
			}else {
				return type;
	...
	abstract class RestrictByTrueTypeOfResultVisitor extends com.google.javascript.jscomp.ChainableReverseAbstractInterpreter.RestrictByTypeOfResultVisitor {
		@java.lang.Override
		public com.google.javascript.rhino.jstype.JSType caseNoObjectType() {
			return null;
		}
	...
	abstract class RestrictByFalseTypeOfResultVisitor extends com.google.javascript.jscomp.ChainableReverseAbstractInterpreter.RestrictByTypeOfResultVisitor {
		@java.lang.Override
	...
	private class RestrictByOneTypeOfResultVisitor extends com.google.javascript.jscomp.ChainableReverseAbstractInterpreter.RestrictByTypeOfResultVisitor {
	...
	final com.google.javascript.rhino.jstype.JSType getRestrictedWithoutUndefined(com.google.javascript.rhino.jstype.JSType type) {
		return type == null ? null : type.visit(restrictUndefinedVisitor);
	}

	final com.google.javascript.rhino.jstype.JSType getRestrictedWithoutNull(com.google.javascript.rhino.jstype.JSType type) {
	...
	com.google.javascript.rhino.jstype.JSType getRestrictedByTypeOfResult(com.google.javascript.rhino.jstype.JSType type, java.lang.String value, boolean resultEqualsValue) {
		...
		return type.visit(new com.google.javascript.jscomp.ChainableReverseAbstractInterpreter.RestrictByOneTypeOfResultVisitor(value, resultEqualsValue));
	}
