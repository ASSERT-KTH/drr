...
ORDINARY, CONSTRUCTOR, INTERFACE;	}
	...
	void setPrototypeBasedOn(com.google.javascript.rhino.jstype.ObjectType baseType, com.google.javascript.rhino.Node propertyNode) {
		if ((((baseType.hasReferenceName()) || (isNativeObjectType())) || (baseType.isFunctionPrototypeType())) || (!(baseType instanceof com.google.javascript.rhino.jstype.PrototypeObjectType))) {
		...
		setPrototype(((com.google.javascript.rhino.jstype.PrototypeObjectType) (baseType)), propertyNode);
	}

	boolean setPrototype(com.google.javascript.rhino.jstype.PrototypeObjectType prototype, com.google.javascript.rhino.Node propertyNode) {
		if (prototype == null) {
			return false;
		}
		...
		com.google.javascript.rhino.jstype.PrototypeObjectType oldPrototype = (prototypeSlot) == null ? null : ((com.google.javascript.rhino.jstype.PrototypeObjectType) (prototypeSlot.getType()));
	...
	public void clearCachedValues() {
		...
		if (!(isNativeObjectType())) {
			...
			if ((prototypeSlot) != null) {
				((com.google.javascript.rhino.jstype.PrototypeObjectType) (prototypeSlot.getType())).clearCachedValues();
			}
		}
	}
