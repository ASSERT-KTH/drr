...
final class TypedScopeCreator implements com.google.javascript.jscomp.ScopeCreator {
			...
			if (scopeToDeclareIn.isDeclared(variableName, false)) {
				...
				if ((fnType != null) && (!(type.isEmptyType()))) {
					if (((fnType.isConstructor()) || (fnType.isInterface())) && (!(fnType.equals(getNativeType(com.google.javascript.rhino.jstype.JSTypeNative.U2U_CONSTRUCTOR_TYPE))))) {
						...
						com.google.javascript.rhino.jstype.StaticSlot<com.google.javascript.rhino.jstype.JSType> prototypeSlot = fnType.getSlot("prototype");
						com.google.javascript.rhino.Node prototypeNode = n;
						if ((prototypeSlot.getDeclaration()) != null) {
							prototypeNode = prototypeSlot.getDeclaration().getNode();
						}
						scopeToDeclareIn.declare((variableName + ".prototype"), prototypeNode, prototypeSlot.getType(), input, ((superClassCtor == null) || (superClassCtor.getInstanceType().equals(getNativeType(com.google.javascript.rhino.jstype.JSTypeNative.OBJECT_TYPE)))));
		...
		void maybeDeclareQualifiedName(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.JSDocInfo info, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent, com.google.javascript.rhino.Node rhsValue) {
			...
			if ("prototype".equals(propName)) {
				...
				if (qVar != null) {
					...
					if (((qVarType != null) && (rhsValue != null)) && ((rhsValue.getType()) == (com.google.javascript.rhino.Token.OBJECTLIT))) {
	...
	private static class FirstOrderFunctionAnalyzer extends com.google.javascript.jscomp.NodeTraversal.AbstractScopedCallback implements com.google.javascript.jscomp.CompilerPass {
		...
		public void visit(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
			...
			if (((n.getType()) == (com.google.javascript.rhino.Token.RETURN)) && ((n.getFirstChild()) != null)) {
				data.get(t.getScopeRoot()).recordNonEmptyReturn();
			}else
				if (((n.getType()) == (com.google.javascript.rhino.Token.NAME)) && (com.google.javascript.jscomp.NodeUtil.isLValue(n))) {
