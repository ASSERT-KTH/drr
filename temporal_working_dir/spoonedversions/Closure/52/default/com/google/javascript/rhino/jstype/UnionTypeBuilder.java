			...
			if (alternate.isUnionType()) {
				...
				if (alternate.isFunctionType()) {
					if ((functionTypePosition) == (-1)) {
						...
						com.google.javascript.rhino.jstype.JSType supremum = alternate.toMaybeFunctionType().getLeastSupertype(alternates.get(functionTypePosition).toMaybeFunctionType());
						com.google.common.base.Preconditions.checkState(supremum.isFunctionType());
