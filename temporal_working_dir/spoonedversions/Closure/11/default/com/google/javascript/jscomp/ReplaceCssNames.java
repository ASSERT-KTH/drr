					...
					case 3 :
						...
						if (!(second.isString())) {
							...
							if (first.isString()) {
								...
								n.removeChild(first);
								com.google.javascript.rhino.Node replacement = com.google.javascript.rhino.IR.add(first, com.google.javascript.rhino.IR.string(("-" + (second.getString()))).copyInformationFrom(second)).copyInformationFrom(n);
