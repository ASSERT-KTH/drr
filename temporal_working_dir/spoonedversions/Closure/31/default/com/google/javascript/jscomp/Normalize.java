...
class Normalize implements com.google.javascript.jscomp.CompilerPass {
	...
	public void process(com.google.javascript.rhino.Node externs, com.google.javascript.rhino.Node root) {
		new com.google.javascript.jscomp.NodeTraversal(compiler, new com.google.javascript.jscomp.Normalize.NormalizeStatements(compiler, assertOnChange)).traverseRoots(externs, root);
		...
		com.google.javascript.jscomp.Normalize.FindExposeAnnotations findExposeAnnotations = new com.google.javascript.jscomp.Normalize.FindExposeAnnotations();
		com.google.javascript.jscomp.NodeTraversal.traverse(compiler, root, findExposeAnnotations);
		if (!(findExposeAnnotations.exposedProperties.isEmpty())) {
			com.google.javascript.jscomp.NodeTraversal.traverse(compiler, root, new com.google.javascript.jscomp.Normalize.RewriteExposedProperties(findExposeAnnotations.exposedProperties));
		}
	...
	private static class FindExposeAnnotations extends com.google.javascript.jscomp.NodeTraversal.AbstractPostOrderCallback {
		private final java.util.Set<java.lang.String> exposedProperties = com.google.common.collect.Sets.newHashSet();
		...
		public void visit(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
			if (com.google.javascript.jscomp.NodeUtil.isExprAssign(n)) {
				...
				if (((com.google.javascript.jscomp.NodeUtil.isObjectLitKey(n, parent)) && (n.isString())) && (isMarkedExpose(n))) {
					exposedProperties.add(n.getString());
				}
			
		}

		private boolean isMarkedExpose(com.google.javascript.rhino.Node n) {
			com.google.javascript.rhino.JSDocInfo info = n.getJSDocInfo();
			return (info != null) && (info.isExpose());
		}
	}

	private class RewriteExposedProperties extends com.google.javascript.jscomp.NodeTraversal.AbstractPostOrderCallback {
		private final java.util.Set<java.lang.String> exposedProperties;

		RewriteExposedProperties(java.util.Set<java.lang.String> exposedProperties) {
		...
		public void visit(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
			if (n.isGetProp()) {
				...
				if (exposedProperties.contains(propName)) {
					com.google.javascript.rhino.Node obj = n.removeFirstChild();
					com.google.javascript.rhino.Node prop = n.removeFirstChild();
					n.getParent().replaceChild(n, com.google.javascript.rhino.IR.getelem(obj, prop));
					compiler.reportCodeChange();
				}
			}else
				if ((n.isString()) && (com.google.javascript.jscomp.NodeUtil.isObjectLitKey(n, parent))) {
					java.lang.String propName = n.getString();
					if (exposedProperties.contains(propName)) {
						n.setQuotedString();
						compiler.reportCodeChange();
					}
		...
		public void visit(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
			if (n.isName()) {
				...
				if (checkUserDeclarations) {
					...
					if (expectedConst) {
						com.google.common.base.Preconditions.checkState((expectedConst == isConst), "The name %s is not annotated as constant.", name);
					}else {
						com.google.common.base.Preconditions.checkState((expectedConst == isConst), "The name %s should not be annotated as constant.", name);
					}
				}
				...
				if (value == null) {
					...
					com.google.common.base.Preconditions.checkState(((value.booleanValue()) == isConst), "The name %s is not consistently annotated as constant.", name);
				}
			}
		}
	}
	...
	static class NormalizeStatements implements com.google.javascript.jscomp.NodeTraversal.Callback {
			...
			switch (n.getType()) {
				case com.google.javascript.rhino.Token.WHILE :
					if (com.google.javascript.jscomp.Normalize.CONVERT_WHILE_TO_FOR) {
						...
						com.google.javascript.rhino.Node empty = com.google.javascript.rhino.IR.empty();
		...
		private void annotateConstantsByConvention(com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
			com.google.common.base.Preconditions.checkState(((((n.isName()) || (n.isString())) || (n.isGetterDef())) || (n.isSetterDef())));
		...
		private void rewriteFunctionDeclaration(com.google.javascript.rhino.Node n) {
			...
			com.google.javascript.rhino.Node var = com.google.javascript.rhino.IR.var(fnNameNode).srcref(n);
		...
		private void doStatementNormalizations(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
			...
			if ((com.google.javascript.jscomp.NodeUtil.isStatementBlock(n)) || (n.isLabel())) {
		...
		private void normalizeLabels(com.google.javascript.rhino.Node n) {
			com.google.common.base.Preconditions.checkArgument(n.isLabel());
				...
				switch (c.getType()) {
					...
					case com.google.javascript.rhino.Token.FOR :
						if (com.google.javascript.jscomp.NodeUtil.isForIn(c)) {
							...
							if (first.isVar()) {
								com.google.javascript.rhino.Node newStatement = first;
								com.google.javascript.rhino.Node name = newStatement.getFirstChild().cloneNode();
			...
			for (com.google.javascript.rhino.Node next, c = n.getFirstChild(); c != null; c = next) {
				...
				if (c.isVar()) {
					...
					while ((c.getFirstChild()) != (c.getLastChild())) {
						...
						c.removeChild(name);
						com.google.javascript.rhino.Node newVar = com.google.javascript.rhino.IR.var(name).srcref(n);
		...
		private void moveNamedFunctions(com.google.javascript.rhino.Node functionBody) {
			com.google.common.base.Preconditions.checkState(functionBody.getParent().isFunction());
	...
	private final class DuplicateDeclarationHandler implements com.google.javascript.jscomp.SyntacticScopeCreator.RedeclarationHandler {
		...
		private void replaceVarWithAssignment(com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent, com.google.javascript.rhino.Node gramps) {
			if (n.hasChildren()) {
				...
				n.removeChild(value);
				com.google.javascript.rhino.Node replacement = com.google.javascript.rhino.IR.assign(n, value);
				...
				if (com.google.javascript.jscomp.NodeUtil.isStatementBlock(gramps)) {
					...
					if (gramps.isFor()) {
						...
						com.google.common.base.Preconditions.checkState(gramps.isLabel());
