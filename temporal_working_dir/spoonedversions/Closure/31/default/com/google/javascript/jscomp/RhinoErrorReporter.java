...
class RhinoErrorReporter {
	...
	private RhinoErrorReporter(com.google.javascript.jscomp.AbstractCompiler compiler) {
		...
		typeMap = com.google.common.collect.ImmutableMap.of(replacePlaceHolders(com.google.javascript.rhino.ScriptRuntime.getMessage0("msg.jsdoc.fileoverview.extra")), com.google.javascript.jscomp.RhinoErrorReporter.EXTRA_FILEOVERVIEW, replacePlaceHolders(com.google.javascript.rhino.head.ScriptRuntime.getMessage0("msg.extra.trailing.comma")), com.google.javascript.jscomp.RhinoErrorReporter.TRAILING_COMMA, replacePlaceHolders(com.google.javascript.rhino.head.ScriptRuntime.getMessage0("msg.dup.parms")), com.google.javascript.jscomp.RhinoErrorReporter.DUPLICATE_PARAM, replacePlaceHolders(com.google.javascript.rhino.ScriptRuntime.getMessage0("msg.bad.jsdoc.tag")), com.google.javascript.jscomp.RhinoErrorReporter.BAD_JSDOC_ANNOTATION, java.util.regex.Pattern.compile("^Bad type annotation.*"), com.google.javascript.jscomp.RhinoErrorReporter.TYPE_PARSE_ERROR);
	}
	...
	private static class NewRhinoErrorReporter extends com.google.javascript.jscomp.RhinoErrorReporter implements com.google.javascript.rhino.head.ErrorReporter {
