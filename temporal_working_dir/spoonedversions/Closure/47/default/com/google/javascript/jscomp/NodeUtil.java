...
public final class NodeUtil {
			...
			if (nameNode.isGetProp()) {
				...
				if ((compiler != null) && (!(compiler.hasRegExpGlobalReferences()))) {
					if ((nameNode.getFirstChild().isRegExp()) && (com.google.javascript.jscomp.NodeUtil.REGEXP_METHODS.contains(nameNode.getLastChild().getString()))) {
						...
						if ((nameNode.getFirstChild().isString()) && (com.google.javascript.jscomp.NodeUtil.STRING_REGEXP_METHODS.contains(nameNode.getLastChild().getString()))) {
	...
	static int getOpFromAssignmentOp(com.google.javascript.rhino.Node n) {
		...
		throw new java.lang.IllegalArgumentException(("Not an assiment op:" + n));
	}
	...
	public static com.google.javascript.rhino.Node newFunctionNode(java.lang.String name, java.util.List<com.google.javascript.rhino.Node> params, com.google.javascript.rhino.Node body, int lineno, int charno) {
		com.google.javascript.rhino.Node parameterParen = new com.google.javascript.rhino.Node(com.google.javascript.rhino.Token.PARAM_LIST, lineno, charno);
