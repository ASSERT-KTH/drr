...
class PeepholeSubstituteAlternateSyntax extends com.google.javascript.jscomp.AbstractPeepholeOptimization {
	...
	private void tryJoinForCondition(com.google.javascript.rhino.Node n) {
		...
		if ((maybeIf != null) && ((maybeIf.getType()) == (com.google.javascript.rhino.Token.IF))) {
			com.google.javascript.rhino.Node maybeBreak = maybeIf.getChildAtIndex(1).getFirstChild();
			if (((maybeBreak != null) && ((maybeBreak.getType()) == (com.google.javascript.rhino.Token.BREAK))) && (!(maybeBreak.hasChildren()))) {
				...
				com.google.javascript.rhino.Node fixedIfCondition = new com.google.javascript.rhino.Node(com.google.javascript.rhino.Token.NOT, ifCondition).copyInformationFrom(ifCondition);
				com.google.javascript.rhino.Node forCondition = com.google.javascript.jscomp.NodeUtil.getConditionExpression(n);
				if ((forCondition.getType()) == (com.google.javascript.rhino.Token.EMPTY)) {
	...
	private com.google.javascript.rhino.Node tryFoldSimpleFunctionCall(com.google.javascript.rhino.Node n) {
		...
		if (((callTarget != null) && (callTarget.isName())) && (callTarget.getString().equals("String"))) {
			...
			if (value != null) {
				com.google.javascript.rhino.Node addition = new com.google.javascript.rhino.Node(com.google.javascript.rhino.Token.ADD);
				com.google.javascript.rhino.Node stringNode = com.google.javascript.rhino.Node.newString("").copyInformationFrom(callTarget);
	...
	private com.google.javascript.rhino.Node tryFoldImmediateCallToBoundFunction(com.google.javascript.rhino.Node n) {
		...
		if (bind != null) {
			...
			if (((bind.thisValue) != null) && (!(com.google.javascript.jscomp.NodeUtil.isUndefined(bind.thisValue)))) {
				com.google.javascript.rhino.Node newCallTarget = new com.google.javascript.rhino.Node(com.google.javascript.rhino.Token.GETPROP, callTarget.cloneTree(), com.google.javascript.rhino.Node.newString("call").copyInformationFrom(callTarget));
	...
	private com.google.javascript.rhino.Node trySplitComma(com.google.javascript.rhino.Node n) {
		...
		if ((parent.isExprResult()) && ((parent.getParent().getType()) != (com.google.javascript.rhino.Token.LABEL))) {
			n.detachChildren();
				...
				if ((((nextNode != null) && (elseBranch == null)) && (isReturnBlock(thenBranch))) && (nextNode.isIf())) {
					...
					if (thenBranch.isEquivalentToTyped(nextThen)) {
						...
						if ((nextElse != null) && (thenBranch.isEquivalentToTyped(nextElse))) {
							child.detachFromParent();
							child.detachChildren();
							com.google.javascript.rhino.Node newCond = new com.google.javascript.rhino.Node(com.google.javascript.rhino.Token.AND, new com.google.javascript.rhino.Node(com.google.javascript.rhino.Token.NOT, cond).copyInformationFrom(cond));
							nextNode.replaceChild(nextCond, newCond);
							newCond.addChildToBack(nextCond);
							reportCodeChange();
						}
...
NOT_SAFE_TO_FOLD, SAFE_TO_FOLD_WITH_ARGS, SAFE_TO_FOLD_WITHOUT_ARGS;	}
	...
	private com.google.javascript.rhino.Node reduceTrueFalse(com.google.javascript.rhino.Node n) {
		if (late) {
			com.google.javascript.rhino.Node not = new com.google.javascript.rhino.Node(com.google.javascript.rhino.Token.NOT, com.google.javascript.rhino.Node.newNumber((n.isTrue() ? 0 : 1)));
	...
	private com.google.javascript.rhino.Node tryMinimizeArrayLiteral(com.google.javascript.rhino.Node n) {
		...
		for (com.google.javascript.rhino.Node cur = n.getFirstChild(); cur != null; cur = cur.getNext()) {
			if ((cur.getType()) != (com.google.javascript.rhino.Token.STRING)) {
				allStrings = false;
			}
		}
		if (allStrings) {
	...
	private com.google.javascript.rhino.Node tryMinimizeStringArrayLiteral(com.google.javascript.rhino.Node n) {
		...
		NEXT_DELIMITER : for (char delimiter : new char[]{ ',' , ' ' , ';' , '{' , '}' }) {
			...
			com.google.javascript.rhino.Node call = new com.google.javascript.rhino.Node(com.google.javascript.rhino.Token.CALL, new com.google.javascript.rhino.Node(com.google.javascript.rhino.Token.GETPROP, com.google.javascript.rhino.Node.newString(com.google.javascript.rhino.Token.STRING, template), com.google.javascript.rhino.Node.newString(com.google.javascript.rhino.Token.STRING, "split")), com.google.javascript.rhino.Node.newString(com.google.javascript.rhino.Token.STRING, ("" + delimiter)));
