...
ALL {
			...
			@java.lang.Override
			public boolean apply(com.google.javascript.rhino.Node node) {
				return ((((((node.isCall()) || (node.isNew())) || (node.isFunction())) || (node.isName())) || (com.google.javascript.jscomp.NodeUtil.isGet(node))) || (com.google.javascript.jscomp.NodeUtil.isObjectLitKey(node, node.getParent()))) || ((node.isString()) && (com.google.javascript.jscomp.NodeUtil.isGet(node.getParent())));
			}
		};	}
