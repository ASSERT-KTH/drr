...
class InstrumentFunctions implements com.google.javascript.jscomp.CompilerPass {
	...
	public void process(com.google.javascript.rhino.Node externs, com.google.javascript.rhino.Node root) {
		...
		if (!(appNameSetter.isEmpty())) {
			com.google.javascript.rhino.Node call = com.google.javascript.rhino.IR.call(com.google.javascript.rhino.IR.name(appNameSetter), com.google.javascript.rhino.IR.string(appNameStr));
			call.putBooleanProp(com.google.javascript.rhino.Node.FREE_CALL, true);
			com.google.javascript.rhino.Node expr = com.google.javascript.rhino.IR.exprResult(call);
	...
	private class InstrumentReturns implements com.google.javascript.jscomp.NodeTraversal.Callback {
		...
		private com.google.javascript.rhino.Node newReportFunctionExitNode() {
			com.google.javascript.rhino.Node call = com.google.javascript.rhino.IR.call(com.google.javascript.rhino.IR.name(reportFunctionExitName), com.google.javascript.rhino.IR.number(functionId));
			call.putBooleanProp(com.google.javascript.rhino.Node.FREE_CALL, true);
			return call;
		}
	...
	private class InstrumentCallback extends com.google.javascript.jscomp.NodeTraversal.AbstractPostOrderCallback {
		...
		public void visit(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
			...
			if (!(reportFunctionName.isEmpty())) {
				...
				com.google.javascript.rhino.Node call = com.google.javascript.rhino.IR.call(com.google.javascript.rhino.IR.name(reportFunctionName), com.google.javascript.rhino.IR.number(id));
				call.putBooleanProp(com.google.javascript.rhino.Node.FREE_CALL, true);
				com.google.javascript.rhino.Node expr = com.google.javascript.rhino.IR.exprResult(call);
			...
			if (!(definedFunctionName.isEmpty())) {
				com.google.javascript.rhino.Node call = com.google.javascript.rhino.IR.call(com.google.javascript.rhino.IR.name(definedFunctionName), com.google.javascript.rhino.IR.number(id));
				call.putBooleanProp(com.google.javascript.rhino.Node.FREE_CALL, true);
