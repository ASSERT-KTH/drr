	...
	private class GatherNoSideEffectFunctions extends com.google.javascript.jscomp.NodeTraversal.AbstractPostOrderCallback {
		...
		public void visit(com.google.javascript.jscomp.NodeTraversal traversal, com.google.javascript.rhino.Node node, com.google.javascript.rhino.Node parent) {
			...
			if (com.google.javascript.jscomp.NodeUtil.isGetProp(node)) {
				if ((com.google.javascript.jscomp.NodeUtil.isExpressionNode(parent)) && (com.google.javascript.jscomp.MarkNoSideEffectCalls.hasNoSideEffectsAnnotation(node))) {
				...
				if (com.google.javascript.jscomp.NodeUtil.isFunction(node)) {
					...
					if (com.google.javascript.jscomp.NodeUtil.isName(parent)) {
						...
						if (((com.google.javascript.jscomp.NodeUtil.isVar(gramp)) && (gramp.hasOneChild())) && (com.google.javascript.jscomp.MarkNoSideEffectCalls.hasNoSideEffectsAnnotation(gramp))) {
							hasAnnotation = true;
						}
