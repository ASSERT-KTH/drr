...
SEARCHING_ANNOTATION, SEARCHING_NEWLINE, NEXT_IS_ANNOTATION;	}
	...
	public com.google.javascript.rhino.JSDocInfo parseInlineTypeDoc() {
		skipEOLs();
		com.google.javascript.rhino.Node typeAst = parseAndRecordTypeNode(next());
		com.google.javascript.rhino.JSTypeExpression expr = createJSTypeExpression(typeAst);
		if (expr != null) {
	...
	boolean parse() {
		...
		return parseHelperLoop(token, com.google.common.collect.Lists.<com.google.javascript.jscomp.parsing.JsDocInfoParser.ExtendedTypeInfo>newArrayList());
	}

	private boolean parseHelperLoop(com.google.javascript.jscomp.parsing.JsDocToken token, java.util.List<com.google.javascript.jscomp.parsing.JsDocInfoParser.ExtendedTypeInfo> extendedTypes) {
		while (true) {
			switch (token) {
				case ANNOTATION :
	...
	private com.google.javascript.jscomp.parsing.JsDocToken parseAnnotation(com.google.javascript.jscomp.parsing.JsDocToken token, java.util.List<com.google.javascript.jscomp.parsing.JsDocInfoParser.ExtendedTypeInfo> extendedTypes) {
		...
		if (annotation == null) {
			...
			switch (annotation) {
				...
				case CLASS_TEMPLATE :
					{
						com.google.javascript.jscomp.parsing.JsDocInfoParser.ExtractionInfo classTemplateInfo = extractSingleLineBlock();
						java.util.List<java.lang.String> names = com.google.common.collect.Lists.newArrayList(com.google.common.base.Splitter.on(',').trimResults().split(classTemplateInfo.string));
						if (((names.size()) == 0) || ((names.get(0).length()) == 0)) {
							parser.addTypeWarning("msg.jsdoc.classtemplate.missing.type.name", stream.getLineno(), stream.getCharno());
						}else
							if (!(jsdocBuilder.recordClassTemplateTypeNames(names))) {
	...
	private com.google.javascript.jscomp.parsing.JsDocToken parseSuppressTag(com.google.javascript.jscomp.parsing.JsDocToken token) {
		if (token == (com.google.javascript.jscomp.parsing.JsDocToken.LC)) {
			...
			while (true) {
				...
				if (match(com.google.javascript.jscomp.parsing.JsDocToken.PIPE, com.google.javascript.jscomp.parsing.JsDocToken.COMMA)) {
					token = next();
				}else {
					break;
				}
	...
	com.google.javascript.rhino.Node parseAndRecordTypeNode(com.google.javascript.jscomp.parsing.JsDocToken token) {
	...
	com.google.javascript.rhino.JSTypeExpression createJSTypeExpression(com.google.javascript.rhino.Node n) {
	...
	private com.google.javascript.jscomp.parsing.JsDocInfoParser.ExtractionInfo extractSingleLineBlock() {
		...
		java.lang.String line = getRemainingJSDocLine().trim();
		if ((line.length()) > 0) {
...
PRESERVE, TRIM, SINGLE_LINE;	}
	...
	private com.google.javascript.jscomp.parsing.JsDocInfoParser.ExtractionInfo extractMultilineTextualBlock(com.google.javascript.jscomp.parsing.JsDocToken token, com.google.javascript.jscomp.parsing.JsDocInfoParser.WhitespaceOption option) {
		...
		java.lang.String line = getRemainingJSDocLine();
	...
	private com.google.javascript.rhino.Node createTemplateNode() {
		...
		templateNode.setStaticSourceFile(((com.google.javascript.jscomp.parsing.JsDocInfoParser.this.associatedNode) != null ? com.google.javascript.jscomp.parsing.JsDocInfoParser.this.associatedNode.getStaticSourceFile() : null));
		return templateNode;
	}
	...
	private java.lang.String getRemainingJSDocLine() {
		java.lang.String result = stream.getRemainingJSDocLine();
		unreadToken = com.google.javascript.jscomp.parsing.JsDocInfoParser.NO_UNREAD_TOKEN;
		return result;
	}
