...
class CheckMissingGetCssName extends com.google.javascript.jscomp.NodeTraversal.AbstractPostOrderCallback implements com.google.javascript.jscomp.CompilerPass {
	...
	private boolean insideGetCssNameCall(com.google.javascript.rhino.Node n) {
	...
	private boolean insideGetUniqueIdCall(com.google.javascript.rhino.Node n) {
		com.google.javascript.rhino.Node parent = n.getParent();
	...
	private boolean insideAssignmentToIdConstant(com.google.javascript.rhino.Node n) {
		com.google.javascript.rhino.Node parent = n.getParent();
		if (parent.isAssign()) {
