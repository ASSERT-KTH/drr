...
final class TypedScopeCreator implements com.google.javascript.jscomp.ScopeCreator {
	...
	TypedScopeCreator(com.google.javascript.jscomp.AbstractCompiler compiler, com.google.javascript.jscomp.CodingConvention codingConvention) {
		...
		this.unknownType = typeRegistry.getNativeObjectType(com.google.javascript.rhino.jstype.JSTypeNative.UNKNOWN_TYPE);
	}
	...
	public com.google.javascript.jscomp.Scope createScope(com.google.javascript.rhino.Node root, com.google.javascript.jscomp.Scope parent) {
		...
		if (parent == null) {
			com.google.javascript.rhino.jstype.JSType globalThis = typeRegistry.getNativeObjectType(com.google.javascript.rhino.jstype.JSTypeNative.GLOBAL_THIS);
		...
		for (com.google.javascript.rhino.Node functionNode : scopeBuilder.nonExternFunctions) {
			...
			if ((type != null) && (type.isFunctionType())) {
				...
				com.google.javascript.rhino.jstype.JSType fnThisType = fnType.getTypeOfThis();
	...
	com.google.javascript.jscomp.Scope createInitialScope(com.google.javascript.rhino.Node root) {
		...
		com.google.javascript.jscomp.Scope s = com.google.javascript.jscomp.Scope.createGlobalScope(root);
		...
		declareNativeValueType(s, "ActiveXObject", com.google.javascript.rhino.jstype.JSTypeNative.FUNCTION_INSTANCE_TYPE);
		return s;
	}
	...
	private static class DiscoverEnumsAndTypedefs extends com.google.javascript.jscomp.NodeTraversal.AbstractShallowStatementCallback {
			...
			switch (node.getType()) {
				case com.google.javascript.rhino.Token.VAR :
					for (com.google.javascript.rhino.Node child = node.getFirstChild(); child != null; child = child.getNext()) {
						identifyNameNode(child, com.google.javascript.jscomp.NodeUtil.getBestJSDocInfo(child));
					}
					break;
		...
		private void identifyNameNode(com.google.javascript.rhino.Node nameNode, com.google.javascript.rhino.JSDocInfo info) {
	...
	private abstract class AbstractScopeBuilder implements com.google.javascript.jscomp.NodeTraversal.Callback {
		...
		void processObjectLitProperties(com.google.javascript.rhino.Node objLit, com.google.javascript.rhino.jstype.ObjectType objLitType, boolean declareOnOwner) {
			for (com.google.javascript.rhino.Node keyNode = objLit.getFirstChild(); keyNode != null; keyNode = keyNode.getNext()) {
				...
				com.google.javascript.rhino.jstype.JSType valueType = getDeclaredType(info, keyNode, value);
		...
		private com.google.javascript.rhino.jstype.JSType getDeclaredTypeInAnnotation(com.google.javascript.rhino.Node node, com.google.javascript.rhino.JSDocInfo info) {
		...
		void defineCatch(com.google.javascript.rhino.Node n) {
		...
		void defineVar(com.google.javascript.rhino.Node n) {
		...
		void defineFunctionLiteral(com.google.javascript.rhino.Node n) {
		...
		private void defineName(com.google.javascript.rhino.Node name, com.google.javascript.rhino.Node var, com.google.javascript.rhino.JSDocInfo info) {
			com.google.javascript.rhino.Node value = name.getFirstChild();
			com.google.javascript.rhino.jstype.JSType type = getDeclaredType(info, name, value);
			if (type == null) {
		...
		private boolean shouldUseFunctionLiteralType(com.google.javascript.rhino.jstype.FunctionType type, com.google.javascript.rhino.JSDocInfo info, com.google.javascript.rhino.Node lValue) {
			...
			if ((lValue != null) && (com.google.javascript.jscomp.NodeUtil.isObjectLitKey(lValue))) {
				return false;
			}
		...
		com.google.javascript.rhino.Node lvalueNode) {
			...
			if (functionType == null) {
				...
				if (functionType == null) {
					...
					com.google.javascript.rhino.jstype.FunctionType overriddenType = null;
					if ((ownerType != null) && (propName != null)) {
						overriddenType = findOverriddenFunction(ownerType, propName);
					}
					com.google.javascript.jscomp.FunctionTypeBuilder builder = new com.google.javascript.jscomp.FunctionTypeBuilder(name, compiler, errorRoot, sourceName, scope).setContents(getFunctionAnalysisResults(fnRoot)).inferFromOverriddenFunction(overriddenType, parametersNode).inferTemplateTypeName(info).inferReturnType(info).inferInheritance(info);
					...
					if (((ownerType != null) && (ownerType.isFunctionPrototypeType())) && (ownerType.getOwnerFunction().hasInstanceType())) {
						...
						if ((ownerNode != null) && (ownerNode.isThis())) {
							com.google.javascript.rhino.jstype.JSType injectedThisType = ownerNode.getJSType();
		...
		private void finishConstructorDefinition(com.google.javascript.rhino.Node n, java.lang.String variableName, com.google.javascript.rhino.jstype.FunctionType fnType, com.google.javascript.jscomp.Scope scopeToDeclareIn, com.google.javascript.jscomp.CompilerInput input, com.google.javascript.jscomp.Scope.Var newVar) {
			com.google.javascript.rhino.jstype.FunctionType superClassCtor = fnType.getSuperClassConstructor();
			com.google.javascript.rhino.jstype.Property prototypeSlot = fnType.getSlot("prototype");
			...
			scopeToDeclareIn.declare(prototypeName, n, prototypeSlot.getType(), input, ((superClassCtor == null) || (superClassCtor.getInstanceType().isEquivalentTo(getNativeType(com.google.javascript.rhino.jstype.JSTypeNative.OBJECT_TYPE)))));
		...
		private com.google.javascript.rhino.jstype.JSType getDeclaredType(com.google.javascript.rhino.JSDocInfo info, com.google.javascript.rhino.Node lValue, @javax.annotation.Nullable
		...
		private void checkForClassDefiningCalls(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n) {
			...
			com.google.javascript.jscomp.CodingConvention.ObjectLiteralCast objectLiteralCast = codingConvention.getObjectLiteralCast(n);
			if (objectLiteralCast != null) {
				if ((objectLiteralCast.diagnosticType) == null) {
					...
					compiler.report(com.google.javascript.jscomp.JSError.make(t.getSourceName(), n, objectLiteralCast.diagnosticType));
				}
			}
		}
		...
		private void applyDelegateRelationship(com.google.javascript.jscomp.CodingConvention.DelegateRelationship delegateRelationship) {
			...
			if (((delegatorObject != null) && (delegateBaseObject != null)) && (delegateSuperObject != null)) {
				...
				if (((delegatorCtor != null) && (delegateBaseCtor != null)) && (delegateSuperCtor != null)) {
					...
					com.google.javascript.rhino.jstype.FunctionType delegateProxy = typeRegistry.createConstructorType(((delegateBaseObject.getReferenceName()) + (com.google.javascript.jscomp.TypedScopeCreator.DELEGATE_PROXY_SUFFIX)), null, null, null, null);
		...
		void maybeDeclareQualifiedName(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.JSDocInfo info, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent, com.google.javascript.rhino.Node rhsValue) {
			...
			com.google.javascript.rhino.jstype.JSType valueType = getDeclaredType(info, n, rhsValue);
		...
		private boolean isConstantSymbol(com.google.javascript.rhino.JSDocInfo info, com.google.javascript.rhino.Node node) {
			if ((info != null) && (info.isConstant())) {
				return true;
			}
			switch (node.getType()) {
				case com.google.javascript.rhino.Token.NAME :
					return com.google.javascript.jscomp.NodeUtil.isConstantByConvention(compiler.getCodingConvention(), node, node.getParent());
				case com.google.javascript.rhino.Token.GETPROP :
					return (node.isQualifiedName()) && (com.google.javascript.jscomp.NodeUtil.isConstantByConvention(compiler.getCodingConvention(), node.getLastChild(), node));
			}
			return false;
		}
		...
		private final class CollectProperties extends com.google.javascript.jscomp.NodeTraversal.AbstractShallowStatementCallback {
			...
			CollectProperties(com.google.javascript.rhino.jstype.JSType thisType) {
			...
			public void visit(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
				if (n.isExprResult()) {
					...
					switch (child.getType()) {
						case com.google.javascript.rhino.Token.ASSIGN :
							maybeCollectMember(child.getFirstChild(), child, child.getLastChild());
							break;
						case com.google.javascript.rhino.Token.GETPROP :
			...
			private void maybeCollectMember(com.google.javascript.rhino.Node member, com.google.javascript.rhino.Node nodeWithJsDocInfo, @javax.annotation.Nullable
			com.google.javascript.rhino.Node value) {
				...
				com.google.javascript.rhino.jstype.JSType jsType = getDeclaredType(info, member, value);
	...
	private final class LocalScopeBuilder extends com.google.javascript.jscomp.TypedScopeCreator.AbstractScopeBuilder {
		...
		void build() {
			...
			if (contents != null) {
				...
				for (com.google.common.collect.Multiset.Entry<java.lang.String> entry : contents.getAssignedNameCounts().entrySet()) {
					com.google.javascript.jscomp.Scope.Var v = scope.getVar(entry.getElement());
					com.google.common.base.Preconditions.checkState(((v.getScope()) == (scope)));
					if ((entry.getCount()) == 1) {
		...
		private void declareArguments(com.google.javascript.rhino.Node functionNode) {
			...
			com.google.javascript.rhino.Node iifeArgumentNode = null;
			if (com.google.javascript.jscomp.NodeUtil.isCallOrNewTarget(functionNode)) {
			...
			if (functionType != null) {
				...
				if (jsDocParameters != null) {
					...
					for (com.google.javascript.rhino.Node astParameter : astParameters.children()) {
						com.google.javascript.rhino.jstype.JSType paramType = jsDocParameter == null ? unknownType : jsDocParameter.getJSType();
						boolean inferred = (paramType == null) || (paramType == (unknownType));
						if ((iifeArgumentNode != null) && inferred) {
							java.lang.String argumentName = iifeArgumentNode.getQualifiedName();
							com.google.javascript.jscomp.Scope.Var argumentVar = (argumentName == null) || ((scope.getParent()) == null) ? null : scope.getParent().getVar(argumentName);
	...
	private static class FirstOrderFunctionAnalyzer extends com.google.javascript.jscomp.NodeTraversal.AbstractScopedCallback implements com.google.javascript.jscomp.CompilerPass {
		...
		public void visit(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
			...
			if (((n.isName()) && (com.google.javascript.jscomp.NodeUtil.isLValue(n))) && (!(com.google.javascript.jscomp.NodeUtil.isBleedingFunctionName(n)))) {
				...
				if (((n.isGetProp()) && (n.isUnscopedQualifiedName())) && (com.google.javascript.jscomp.NodeUtil.isLValue(n))) {
					java.lang.String name = com.google.javascript.jscomp.NodeUtil.getRootOfQualifiedName(n).getString();
					com.google.javascript.jscomp.Scope scope = t.getScope();
					com.google.javascript.jscomp.Scope.Var var = scope.getVar(name);
					if (var != null) {
						com.google.javascript.jscomp.Scope ownerScope = var.getScope();
