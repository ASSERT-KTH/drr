...
public class Node implements java.io.Serializable , java.lang.Cloneable {
	...
	public void setString(java.lang.String value) throws java.lang.UnsupportedOperationException {
		if (((com.google.javascript.rhino.Node.this.getType()) == (com.google.javascript.rhino.Token.STRING)) || ((com.google.javascript.rhino.Node.this.getType()) == (com.google.javascript.rhino.Token.NAME))) {
			throw new java.lang.IllegalStateException("String node not created with Node.newString");
		}else {
			throw new java.lang.UnsupportedOperationException(((com.google.javascript.rhino.Node.this) + " is not a string node"));
		}
