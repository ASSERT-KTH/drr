...
class NamedType extends com.google.javascript.rhino.jstype.ProxyObjectType {
	...
	private boolean resolveViaRegistry(com.google.javascript.rhino.ErrorReporter reporter) {
	...
	private void resolveViaProperties(com.google.javascript.rhino.ErrorReporter reporter, com.google.javascript.rhino.jstype.StaticScope<com.google.javascript.rhino.jstype.JSType> enclosing) {
		com.google.javascript.rhino.jstype.JSType value = lookupViaProperties(reporter, enclosing);
		if (((value != null) && (value.isFunctionType())) && ((value.isConstructor()) || (value.isInterface()))) {
			...
			if ((value != null) && (value.isNoObjectType())) {
				setReferencedAndResolvedType(registry.getNativeFunctionType(com.google.javascript.rhino.jstype.JSTypeNative.NO_OBJECT_TYPE).getInstanceType(), reporter);
			}else
				if (value instanceof com.google.javascript.rhino.jstype.EnumType) {
					setReferencedAndResolvedType(((com.google.javascript.rhino.jstype.EnumType) (value)).getElementsType(), reporter);
				}else {
	...
	private com.google.javascript.rhino.jstype.JSType lookupViaProperties(com.google.javascript.rhino.ErrorReporter reporter, com.google.javascript.rhino.jstype.StaticScope<com.google.javascript.rhino.jstype.JSType> enclosing) {
		...
		com.google.javascript.rhino.jstype.JSType value = getTypedefType(reporter, slot);
		if (value == null) {
			return null;
		}
	...
	private void setReferencedAndResolvedType(com.google.javascript.rhino.jstype.JSType type, com.google.javascript.rhino.ErrorReporter reporter) {
		if ((validator) != null) {
	...
	private com.google.javascript.rhino.jstype.JSType getTypedefType(com.google.javascript.rhino.ErrorReporter t, com.google.javascript.rhino.jstype.StaticSlot<com.google.javascript.rhino.jstype.JSType> slot) {
