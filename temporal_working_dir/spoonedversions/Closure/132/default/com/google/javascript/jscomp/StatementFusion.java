...
public class StatementFusion extends com.google.javascript.jscomp.AbstractPeepholeOptimization {
	...
	private boolean canFuseIntoOneStatement(com.google.javascript.rhino.Node block) {
		if (!(block.isBlock())) {
			return false;
		}
		...
		switch (last.getType()) {
			...
			case com.google.javascript.rhino.Token.FOR :
				return (com.google.javascript.jscomp.NodeUtil.isForIn(last)) && (!(mayHaveSideEffects(last.getFirstChild())));
		}
		return false;
	}
