...
public class DefaultPassConfig extends com.google.javascript.jscomp.PassConfig {
	...
	final com.google.javascript.jscomp.DefaultPassConfig.HotSwapPassFactory checkSideEffects = new com.google.javascript.jscomp.DefaultPassConfig.HotSwapPassFactory("checkSideEffects", true) {
		@java.lang.Override
		protected com.google.javascript.jscomp.HotSwapCompilerPass create(final com.google.javascript.jscomp.AbstractCompiler compiler) {
	...
	final com.google.javascript.jscomp.PassFactory stripSideEffectProtection = new com.google.javascript.jscomp.PassFactory("stripSideEffectProtection", true) {
		@java.lang.Override
		protected com.google.javascript.jscomp.CompilerPass create(final com.google.javascript.jscomp.AbstractCompiler compiler) {
	...
	final com.google.javascript.jscomp.DefaultPassConfig.HotSwapPassFactory suspiciousCode = new com.google.javascript.jscomp.DefaultPassConfig.HotSwapPassFactory("suspiciousCode", true) {
		...
		protected com.google.javascript.jscomp.HotSwapCompilerPass create(final com.google.javascript.jscomp.AbstractCompiler compiler) {
			...
			if (options.checkSuspiciousCode) {
				sharedCallbacks.add(new com.google.javascript.jscomp.CheckSuspiciousCode());
			}
	...
	final com.google.javascript.jscomp.PassFactory gatherRawExports = new com.google.javascript.jscomp.PassFactory("gatherRawExports", true) {
		@java.lang.Override
		protected com.google.javascript.jscomp.CompilerPass create(com.google.javascript.jscomp.AbstractCompiler compiler) {
	...
	final com.google.javascript.jscomp.DefaultPassConfig.HotSwapPassFactory closurePrimitives = new com.google.javascript.jscomp.DefaultPassConfig.HotSwapPassFactory("closurePrimitives", true) {
		@java.lang.Override
		protected com.google.javascript.jscomp.HotSwapCompilerPass create(com.google.javascript.jscomp.AbstractCompiler compiler) {
	...
	final com.google.javascript.jscomp.PassFactory angularPass = new com.google.javascript.jscomp.PassFactory("angularPass", true) {
		@java.lang.Override
		protected com.google.javascript.jscomp.CompilerPass create(com.google.javascript.jscomp.AbstractCompiler compiler) {
			return new com.google.javascript.jscomp.AngularPass(compiler);
		}
	};
	...
	final com.google.javascript.jscomp.DefaultPassConfig.HotSwapPassFactory closureGoogScopeAliases = new com.google.javascript.jscomp.DefaultPassConfig.HotSwapPassFactory("closureGoogScopeAliases", true) {
		@java.lang.Override
		protected com.google.javascript.jscomp.HotSwapCompilerPass create(com.google.javascript.jscomp.AbstractCompiler compiler) {
			maybeInitializePreprocessorSymbolTable(compiler);
	...
	final com.google.javascript.jscomp.PassFactory closureCheckGetCssName = new com.google.javascript.jscomp.PassFactory("closureCheckGetCssName", true) {
		@java.lang.Override
		protected com.google.javascript.jscomp.CompilerPass create(com.google.javascript.jscomp.AbstractCompiler compiler) {
	...
	final com.google.javascript.jscomp.PassFactory closureReplaceGetCssName = new com.google.javascript.jscomp.PassFactory("closureReplaceGetCssName", true) {
		@java.lang.Override
		protected com.google.javascript.jscomp.CompilerPass create(final com.google.javascript.jscomp.AbstractCompiler compiler) {
			return new com.google.javascript.jscomp.CompilerPass() {
				@java.lang.Override
				public void process(com.google.javascript.rhino.Node externs, com.google.javascript.rhino.Node jsRoot) {
					...
					com.google.javascript.jscomp.ReplaceCssNames pass = new com.google.javascript.jscomp.ReplaceCssNames(compiler, newCssNames, options.cssRenamingWhitelist);
	...
	final com.google.javascript.jscomp.DefaultPassConfig.HotSwapPassFactory resolveTypes = new com.google.javascript.jscomp.DefaultPassConfig.HotSwapPassFactory("resolveTypes", true) {
		@java.lang.Override
		protected com.google.javascript.jscomp.HotSwapCompilerPass create(com.google.javascript.jscomp.AbstractCompiler compiler) {
	...
	final com.google.javascript.jscomp.PassFactory clearTypedScopePass = new com.google.javascript.jscomp.PassFactory("clearTypedScopePass", true) {
		@java.lang.Override
		protected com.google.javascript.jscomp.CompilerPass create(com.google.javascript.jscomp.AbstractCompiler compiler) {
	...
	final com.google.javascript.jscomp.DefaultPassConfig.HotSwapPassFactory inferTypes = new com.google.javascript.jscomp.DefaultPassConfig.HotSwapPassFactory("inferTypes", true) {
		@java.lang.Override
		protected com.google.javascript.jscomp.HotSwapCompilerPass create(final com.google.javascript.jscomp.AbstractCompiler compiler) {
			return new com.google.javascript.jscomp.HotSwapCompilerPass() {
				@java.lang.Override
	...
	final com.google.javascript.jscomp.DefaultPassConfig.HotSwapPassFactory inferJsDocInfo = new com.google.javascript.jscomp.DefaultPassConfig.HotSwapPassFactory("inferJsDocInfo", true) {
		@java.lang.Override
		protected com.google.javascript.jscomp.HotSwapCompilerPass create(final com.google.javascript.jscomp.AbstractCompiler compiler) {
			return new com.google.javascript.jscomp.HotSwapCompilerPass() {
				@java.lang.Override
	...
	final com.google.javascript.jscomp.DefaultPassConfig.HotSwapPassFactory checkTypes = new com.google.javascript.jscomp.DefaultPassConfig.HotSwapPassFactory("checkTypes", true) {
		@java.lang.Override
		protected com.google.javascript.jscomp.HotSwapCompilerPass create(final com.google.javascript.jscomp.AbstractCompiler compiler) {
			return new com.google.javascript.jscomp.HotSwapCompilerPass() {
				@java.lang.Override
	...
	final com.google.javascript.jscomp.PassFactory invertContextualRenaming = new com.google.javascript.jscomp.PassFactory("invertContextualRenaming", true) {
		@java.lang.Override
		protected com.google.javascript.jscomp.CompilerPass create(com.google.javascript.jscomp.AbstractCompiler compiler) {
	...
	private com.google.javascript.jscomp.VariableMap runVariableRenaming(com.google.javascript.jscomp.AbstractCompiler compiler, com.google.javascript.jscomp.VariableMap prevVariableMap, com.google.javascript.rhino.Node externs, com.google.javascript.rhino.Node root) {
		char[] reservedChars = options.anonymousFunctionNaming.getReservedCharacters();
		boolean preserveAnonymousFunctionNames = (options.anonymousFunctionNaming) != (com.google.javascript.jscomp.AnonymousFunctionNamingPolicy.OFF);
		java.util.Set<java.lang.String> reservedNames = com.google.common.collect.Sets.newHashSet();
		if ((exportedNames) != null) {
			reservedNames.addAll(exportedNames);
		}
		reservedNames.addAll(com.google.javascript.jscomp.parsing.ParserRunner.getReservedVars());
		com.google.javascript.jscomp.RenameVars rn = new com.google.javascript.jscomp.RenameVars(compiler, options.renamePrefix, ((options.variableRenaming) == (com.google.javascript.jscomp.VariableRenamingPolicy.LOCAL)), preserveAnonymousFunctionNames, options.generatePseudoNames, options.shadowVariables, prevVariableMap, reservedChars, reservedNames);
	...
	abstract static class HotSwapPassFactory extends com.google.javascript.jscomp.PassFactory {
		...
		@java.lang.Override
		protected abstract com.google.javascript.jscomp.HotSwapCompilerPass create(com.google.javascript.jscomp.AbstractCompiler compiler);

		@java.lang.Override
		com.google.javascript.jscomp.HotSwapCompilerPass getHotSwapPass(com.google.javascript.jscomp.AbstractCompiler compiler) {
			return com.google.javascript.jscomp.DefaultPassConfig.HotSwapPassFactory.this.create(compiler);
		}
	}
}
