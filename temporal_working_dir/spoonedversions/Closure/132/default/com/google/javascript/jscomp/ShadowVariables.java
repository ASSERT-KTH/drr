...
class ShadowVariables implements com.google.javascript.jscomp.CompilerPass {
	...
	private final java.util.Map<com.google.javascript.rhino.Node, java.lang.String> oldPseudoNameMap;

	private final java.util.Map<com.google.javascript.rhino.Node, java.lang.String> deltaPseudoNameMap;

	ShadowVariables(com.google.javascript.jscomp.AbstractCompiler compiler, java.util.Map<java.lang.String, com.google.javascript.jscomp.RenameVars.Assignment> assignments, java.util.SortedSet<com.google.javascript.jscomp.RenameVars.Assignment> varsByFrequency, java.util.Map<com.google.javascript.rhino.Node, java.lang.String> pseudoNameMap) {
		this.compiler = compiler;
		this.assignments = assignments;
		this.varsByFrequency = varsByFrequency;
		this.oldPseudoNameMap = pseudoNameMap;
		this.deltaPseudoNameMap = com.google.common.collect.Maps.newLinkedHashMap();
	}
	...
	private class DoShadowVariables extends com.google.javascript.jscomp.NodeTraversal.AbstractPostOrderCallback implements com.google.javascript.jscomp.NodeTraversal.ScopedCallback {
		...
		public void enterScope(com.google.javascript.jscomp.NodeTraversal t) {
			...
			for (java.util.Iterator<com.google.javascript.jscomp.Scope.Var> vars = s.getVars(); vars.hasNext();) {
				...
				com.google.javascript.jscomp.RenameVars.Assignment bestShadow = findBestShadow(s);
				if (bestShadow == null) {
					continue;
				}
				...
				if ((oldPseudoNameMap) != null) {
					java.lang.String targetPseudoName = oldPseudoNameMap.get(s.getVar(bestShadow.oldName).nameNode);
		...
		private com.google.javascript.jscomp.RenameVars.Assignment findBestShadow(com.google.javascript.jscomp.Scope curScope) {
			for (com.google.javascript.jscomp.RenameVars.Assignment assignment : varsByFrequency) {
