...
class InlineFunctions implements com.google.javascript.jscomp.SpecializationAwareCompilerPass {
	...
	InlineFunctions(com.google.javascript.jscomp.AbstractCompiler compiler, com.google.common.base.Supplier<java.lang.String> safeNameIdSupplier, boolean inlineGlobalFunctions, boolean inlineLocalFunctions, boolean blockFunctionInliningEnabled, boolean assumeStrictThis, boolean assumeMinimumCapture) {
		...
		this.injector = new com.google.javascript.jscomp.FunctionInjector(compiler, safeNameIdSupplier, true, assumeStrictThis, assumeMinimumCapture);
	}
		...
		public void findNamedFunctions(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
			...
			switch (n.getType()) {
				...
				case com.google.javascript.rhino.Token.FUNCTION :
					com.google.common.base.Preconditions.checkState(((com.google.javascript.jscomp.NodeUtil.isStatementBlock(parent)) || (parent.isLabel())));
	...
	static boolean isCandidateUsage(com.google.javascript.rhino.Node name) {
		...
		if ((((com.google.javascript.jscomp.NodeUtil.isGet(parent)) && (name == (parent.getFirstChild()))) && (name.getNext().isString())) && (name.getNext().getString().equals("call"))) {
	...
	private class FindCandidatesReferences extends com.google.javascript.jscomp.InlineFunctions.CallVisitor implements com.google.javascript.jscomp.InlineFunctions.CallVisitorCallback {
		...
		private boolean maybeAddReferenceUsingMode(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.jscomp.InlineFunctions.FunctionState fs, com.google.javascript.rhino.Node callNode, com.google.javascript.jscomp.JSModule module, com.google.javascript.jscomp.FunctionInjector.InliningMode mode) {
			...
			if (result != (com.google.javascript.jscomp.FunctionInjector.CanInlineResult.NO)) {
				boolean decompose = result == (com.google.javascript.jscomp.FunctionInjector.CanInlineResult.AFTER_PREPARATION);
		...
		private void checkNameUsage(com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
			...
			if (parent.isNew()) {
				...
				if ((target.isName()) && (target.getString().equals(com.google.javascript.jscomp.ObjectPropertyStringPreprocess.EXTERN_OBJECT_PROPERTY_STRING))) {
					fs.setInline(false);
				}
			}
	...
	private static class FunctionState {
		...
		public void addReference(com.google.javascript.jscomp.InlineFunctions.Reference ref) {
			if ((references) == null) {
				references = com.google.common.collect.Maps.newLinkedHashMap();
			}
