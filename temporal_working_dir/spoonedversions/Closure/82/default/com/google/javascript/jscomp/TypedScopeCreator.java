...
final class TypedScopeCreator implements com.google.javascript.jscomp.ScopeCreator {
	...
	private abstract class AbstractScopeBuilder implements com.google.javascript.jscomp.NodeTraversal.Callback {
		...
		void processObjectLitProperties(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node objLit, com.google.javascript.rhino.jstype.ObjectType objLitType) {
			for (com.google.javascript.rhino.Node name = objLit.getFirstChild(); name != null; name = name.getNext()) {
				...
				com.google.javascript.rhino.jstype.JSType valueType = getDeclaredPropType(t, name.getJSDocInfo(), name, value);
				com.google.javascript.rhino.jstype.JSType keyType = com.google.javascript.jscomp.NodeUtil.getObjectLitKeyTypeFromValueType(name, valueType);
				if (keyType != null) {
		...
		private com.google.javascript.rhino.jstype.JSType getDeclaredTypeInAnnotation(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node node, com.google.javascript.rhino.JSDocInfo info) {
		...
		private void defineName(com.google.javascript.rhino.Node name, com.google.javascript.rhino.Node var, com.google.javascript.rhino.Node parent, com.google.javascript.rhino.JSDocInfo info) {
			com.google.javascript.rhino.Node value = name.getFirstChild();
			com.google.javascript.rhino.jstype.JSType type = null;
			if (((value != null) && ((value.getType()) == (com.google.javascript.rhino.Token.FUNCTION))) && (shouldUseFunctionLiteralType(((com.google.javascript.rhino.jstype.FunctionType) (value.getJSType())), info, name))) {
			...
			if (type == null) {
				if (info == null) {
					...
					if (info.hasEnumParameterType()) {
						if ((value != null) && ((value.getType()) == (com.google.javascript.rhino.Token.OBJECTLIT))) {
							type = value.getJSType();
						}else {
		...
		private com.google.javascript.rhino.jstype.JSType getDeclaredPropType(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.JSDocInfo info, com.google.javascript.rhino.Node lValue, @javax.annotation.Nullable
		...
		void maybeDeclareQualifiedName(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.JSDocInfo info, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent, com.google.javascript.rhino.Node rhsValue) {
			...
			com.google.javascript.rhino.jstype.JSType valueType = getDeclaredPropType(t, info, n, rhsValue);
		...
		private final class CollectProperties extends com.google.javascript.jscomp.NodeTraversal.AbstractShallowStatementCallback {
			...
			com.google.javascript.rhino.Node value) {
				...
				com.google.javascript.rhino.jstype.JSType jsType = getDeclaredPropType(t, info, member, value);
