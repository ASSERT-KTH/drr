...
class CodeGenerator {
	...
	void add(com.google.javascript.rhino.Node n, com.google.javascript.jscomp.CodeGenerator.Context context) {
		...
		switch (type) {
			...
			case com.google.javascript.rhino.Token.ARRAYLIT :
				add("[");
				addList(first, ((int[]) (n.getProp(com.google.javascript.rhino.Node.SKIP_INDEXES_PROP))));
				add("]");
				break;
			...
			case com.google.javascript.rhino.Token.SET :
				...
				if ((com.google.javascript.rhino.TokenStream.isJSIdentifier(name)) && (com.google.javascript.jscomp.NodeUtil.isLatin(name))) {
					add(name);
				}else {
			...
			case com.google.javascript.rhino.Token.OBJECTLIT :
				{
					...
					for (com.google.javascript.rhino.Node c = first; c != null; c = c.getNext()) {
						...
						if (((c.getType()) == (com.google.javascript.rhino.Token.GET)) || ((c.getType()) == (com.google.javascript.rhino.Token.SET))) {
							...
							if ((((((c.getType()) == (com.google.javascript.rhino.Token.STRING)) && (!(c.isQuotedString()))) && (!(com.google.javascript.rhino.TokenStream.isKeyword(c.getString())))) && (com.google.javascript.rhino.TokenStream.isJSIdentifier(c.getString()))) && (com.google.javascript.jscomp.NodeUtil.isLatin(c.getString()))) {
								add(c.getString());
							}else {
								addExpr(c, 1);
							}
	...
	void addList(com.google.javascript.rhino.Node firstInList, int[] skipIndexes) {
		int nextSlot = 0;
		int nextSkipSlot = 0;
		for (com.google.javascript.rhino.Node n = firstInList; n != null; n = n.getNext()) {
