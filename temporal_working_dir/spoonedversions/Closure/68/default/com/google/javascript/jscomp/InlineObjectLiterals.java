...
class InlineObjectLiterals implements com.google.javascript.jscomp.CompilerPass {
	...
	public void process(com.google.javascript.rhino.Node externs, com.google.javascript.rhino.Node root) {
		com.google.javascript.jscomp.ReferenceCollectingCallback callback = new com.google.javascript.jscomp.ReferenceCollectingCallback(compiler, new com.google.javascript.jscomp.InlineObjectLiterals.InliningBehavior(), com.google.common.base.Predicates.<com.google.javascript.jscomp.Scope.Var>alwaysTrue());
	...
	private class InliningBehavior implements com.google.javascript.jscomp.ReferenceCollectingCallback.Behavior {
		...
		private boolean isInlinableObject(java.util.List<com.google.javascript.jscomp.ReferenceCollectingCallback.Reference> refs) {
			...
			for (com.google.javascript.jscomp.ReferenceCollectingCallback.Reference ref : refs) {
				com.google.javascript.rhino.Node name = ref.getNameNode();
				com.google.javascript.rhino.Node parent = ref.getParent();
				com.google.javascript.rhino.Node gramps = ref.getGrandparent();
				if ((((parent.getType()) == (com.google.javascript.rhino.Token.GETPROP)) && (((gramps.getType()) != (com.google.javascript.rhino.Token.CALL)) || ((gramps.getFirstChild()) != parent))) && (parent.getFirstChild().isEquivalentTo(name))) {
					continue;
				}
				...
				com.google.javascript.rhino.Node p = parent;
				while ((p = p.getParent()) != null) {
					if ((p.getType()) == (com.google.javascript.rhino.Token.GETPROP)) {
						return false;
					}
				} 
				ret = true;
		...
		private java.util.Map<java.lang.String, java.lang.String> computeVarList(com.google.javascript.jscomp.Scope.Var v, com.google.javascript.jscomp.ReferenceCollectingCallback.ReferenceCollection referenceInfo) {
			java.util.Map<java.lang.String, java.lang.String> varmap = com.google.common.collect.Maps.newHashMap();
			for (com.google.javascript.jscomp.ReferenceCollectingCallback.Reference ref : referenceInfo.references) {
				if ((ref.isLvalue()) || (ref.isInitializingDeclaration())) {
					...
					if ((ref.getParent().getType()) == (com.google.javascript.rhino.Token.VAR)) {
						...
						com.google.common.base.Preconditions.checkState(((getprop.getType()) == (com.google.javascript.rhino.Token.GETPROP)), ("Unexpected reference type: " + (com.google.javascript.rhino.Token.name(getprop.getType()))));
						com.google.common.base.Preconditions.checkState(getprop.getFirstChild().getString().equals(v.getName()), ((("Unexpected variable name: " + (getprop.getFirstChild().getString())) + ", expecting: ") + (v.getName())));
		...
		private void replaceAssignmentExpression(com.google.javascript.jscomp.Scope.Var v, com.google.javascript.jscomp.ReferenceCollectingCallback.Reference ref, java.util.Map<java.lang.String, java.lang.String> varmap) {
			...
			java.util.Set<java.lang.String> all = com.google.common.collect.Sets.newHashSet(varmap.keySet());
