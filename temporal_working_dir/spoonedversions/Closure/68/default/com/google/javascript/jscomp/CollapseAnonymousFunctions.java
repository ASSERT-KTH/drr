...
class CollapseAnonymousFunctions implements com.google.javascript.jscomp.CompilerPass {
	...
	private class Callback extends com.google.javascript.jscomp.NodeTraversal.AbstractPostOrderCallback {
		...
		public void visit(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
			...
			if (!(((parent.getType()) == (com.google.javascript.rhino.Token.SCRIPT)) || (((grandparent != null) && ((grandparent.getType()) == (com.google.javascript.rhino.Token.FUNCTION))) && ((parent.getType()) == (com.google.javascript.rhino.Token.BLOCK))))) {
				return ;
			}
			...
			if (((value != null) && ((value.getType()) == (com.google.javascript.rhino.Token.FUNCTION))) && (!(isRecursiveFunction(value)))) {
		...
		private boolean containsName(com.google.javascript.rhino.Node n, java.lang.String name) {
			if (((n.getType()) == (com.google.javascript.rhino.Token.NAME)) && (n.getString().equals(name))) {
				return true;
			}
