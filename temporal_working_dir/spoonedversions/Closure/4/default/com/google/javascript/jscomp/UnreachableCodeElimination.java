...
class UnreachableCodeElimination extends com.google.javascript.jscomp.NodeTraversal.AbstractPostOrderCallback implements com.google.javascript.jscomp.CompilerPass , com.google.javascript.jscomp.NodeTraversal.ScopedCallback {
	...
	public void exitScope(com.google.javascript.jscomp.NodeTraversal t) {
		...
		new com.google.javascript.jscomp.graph.GraphReachability<com.google.javascript.rhino.Node, com.google.javascript.jscomp.ControlFlowGraph.Branch>(cfg).compute(cfg.getEntry().getValue());
		com.google.javascript.rhino.Node root = scope.getRootNode();
		if (scope.isLocal()) {
			root = root.getLastChild();
		}
		com.google.javascript.jscomp.NodeTraversal.traverse(compiler, root, new com.google.javascript.jscomp.UnreachableCodeElimination.EliminationPass(cfg));
	}
	...
	private class EliminationPass extends com.google.javascript.jscomp.NodeTraversal.AbstractShallowCallback {
