...
class TypeInference extends com.google.javascript.jscomp.DataFlowAnalysis.BranchedForwardDataFlowAnalysis<com.google.javascript.rhino.Node, com.google.javascript.jscomp.type.FlowScope> {
	...
	TypeInference(com.google.javascript.jscomp.AbstractCompiler compiler, com.google.javascript.jscomp.ControlFlowGraph<com.google.javascript.rhino.Node> cfg, com.google.javascript.jscomp.type.ReverseAbstractInterpreter reverseInterpreter, com.google.javascript.jscomp.Scope functionScope, java.util.Map<java.lang.String, com.google.javascript.jscomp.CodingConvention.AssertionFunctionSpec> assertionFunctionsMap) {
		...
		this.unknownType = registry.getNativeObjectType(com.google.javascript.rhino.jstype.JSTypeNative.UNKNOWN_TYPE);
		...
		this.bottomScope = com.google.javascript.jscomp.LinkedFlowScope.createEntryLattice(com.google.javascript.jscomp.Scope.createLatticeBottom(functionScope.getRootNode()));
	}

	private void inferArguments(com.google.javascript.jscomp.Scope functionScope) {
		com.google.javascript.rhino.Node functionNode = functionScope.getRootNode();
		...
		if (functionType != null) {
			com.google.javascript.rhino.Node parameterTypes = functionType.getParametersNode();
			if (parameterTypes != null) {
				com.google.javascript.rhino.Node parameterTypeNode = parameterTypes.getFirstChild();
				for (com.google.javascript.rhino.Node astParameter : astParameters.children()) {
					com.google.javascript.jscomp.Scope.Var var = functionScope.getVar(astParameter.getString());
					com.google.common.base.Preconditions.checkNotNull(var);
					if ((var.isTypeInferred()) && ((var.getType()) == (unknownType))) {
						com.google.javascript.rhino.jstype.JSType newType = null;
	...
	private com.google.javascript.jscomp.type.FlowScope traverseCatch(com.google.javascript.rhino.Node catchNode, com.google.javascript.jscomp.type.FlowScope scope) {
		com.google.javascript.rhino.Node name = catchNode.getFirstChild();
		java.lang.String varName = name.getString();
	...
	private void ensurePropertyDefined(com.google.javascript.rhino.Node getprop, com.google.javascript.rhino.jstype.JSType rightType) {
		...
		com.google.javascript.rhino.Node obj = getprop.getFirstChild();
		com.google.javascript.rhino.jstype.JSType nodeType = getJSType(obj);
		...
		if (value != null) {
			...
			if (var != null) {
				...
				if (isInferred && (syntacticScope.isLocal())) {
					com.google.javascript.jscomp.Scope.Var maybeOuterVar = syntacticScope.getParent().getVar(varName);
	...
	private com.google.javascript.jscomp.type.FlowScope traverseAdd(com.google.javascript.rhino.Node n, com.google.javascript.jscomp.type.FlowScope scope) {
		...
		com.google.javascript.rhino.jstype.JSType type = unknownType;
	...
	private com.google.javascript.jscomp.type.FlowScope traverseCall(com.google.javascript.rhino.Node n, com.google.javascript.jscomp.type.FlowScope scope) {
		...
		if (functionType.isFunctionType()) {
			...
			if (functionType.isEquivalentTo(getNativeType(com.google.javascript.rhino.jstype.JSTypeNative.CHECKED_UNKNOWN_TYPE))) {
	...
	private java.util.Map<com.google.javascript.rhino.jstype.TemplateType, com.google.javascript.rhino.jstype.JSType> inferTemplateTypesFromParameters(com.google.javascript.rhino.jstype.FunctionType fnType, com.google.javascript.rhino.Node call) {
		...
		com.google.javascript.rhino.Node callTarget = call.getFirstChild();
		if (com.google.javascript.jscomp.NodeUtil.isGet(callTarget)) {
			com.google.javascript.rhino.Node obj = callTarget.getFirstChild();
	...
	private void maybeResolveTemplateTypeFromNodes(java.util.Iterator<com.google.javascript.rhino.Node> declParams, java.util.Iterator<com.google.javascript.rhino.Node> callParams, java.util.Map<com.google.javascript.rhino.jstype.TemplateType, com.google.javascript.rhino.jstype.JSType> resolvedTypes) {
		while ((declParams.hasNext()) && (callParams.hasNext())) {
			com.google.javascript.rhino.Node declParam = declParams.next();
