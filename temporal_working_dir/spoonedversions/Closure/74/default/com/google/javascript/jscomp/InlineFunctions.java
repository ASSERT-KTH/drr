...
class InlineFunctions implements com.google.javascript.jscomp.SpecializationAwareCompilerPass {
	...
	InlineFunctions(com.google.javascript.jscomp.AbstractCompiler compiler, com.google.common.base.Supplier<java.lang.String> safeNameIdSupplier, boolean inlineGlobalFunctions, boolean inlineLocalFunctions, boolean blockFunctionInliningEnabled) {
		...
		this.injector = new com.google.javascript.jscomp.FunctionInjector(compiler, safeNameIdSupplier, true);
	}
	...
	private boolean hasLocalNames(com.google.javascript.rhino.Node fnNode) {
		com.google.javascript.rhino.Node block = com.google.javascript.jscomp.NodeUtil.getFunctionBody(fnNode);
		return (com.google.javascript.jscomp.NodeUtil.getFnParameters(fnNode).hasChildren()) || (com.google.javascript.jscomp.NodeUtil.has(block, new com.google.javascript.jscomp.NodeUtil.MatchDeclaration(), new com.google.javascript.jscomp.NodeUtil.MatchShallowStatement()));
	}
	...
	private class FindCandidatesReferences extends com.google.javascript.jscomp.InlineFunctions.CallVisitor implements com.google.javascript.jscomp.InlineFunctions.CallVisitorCallback {
		...
		private void checkNameUsage(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
			...
			if (((parent.getType()) == (com.google.javascript.rhino.Token.CALL)) && ((parent.getFirstChild()) == n)) {
				return ;
			}
			if ((((com.google.javascript.jscomp.NodeUtil.isGet(parent)) && (n == (parent.getFirstChild()))) && ((n.getNext().getType()) == (com.google.javascript.rhino.Token.STRING))) && (n.getNext().getString().equals("call"))) {
