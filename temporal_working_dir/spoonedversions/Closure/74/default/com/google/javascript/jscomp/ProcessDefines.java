		...
		for (com.google.javascript.jscomp.GlobalNamespace.Name name : namespace.getNameIndex().values()) {
			if (((name.docInfo) != null) && (name.docInfo.isDefine())) {
				if (isValidDefineType(name.docInfo.getType())) {
					...
					com.google.javascript.jscomp.JSError error = com.google.javascript.jscomp.JSError.make(name.declaration.sourceName, name.declaration.node, com.google.javascript.jscomp.ProcessDefines.INVALID_DEFINE_TYPE_ERROR);
