...
LAZY_EXPRESSIONS, LAZY_NAMES, IMMEDIATE;	}
	...
	private void initializeBuiltInTypes() {
		...
		com.google.javascript.rhino.jstype.JSType NULL_VOID = createUnionType(NULL_TYPE, VOID_TYPE);
		registerNativeType(com.google.javascript.rhino.jstype.JSTypeNative.NULL_VOID, NULL_VOID);
		...
		com.google.javascript.rhino.jstype.FunctionType LEAST_FUNCTION_TYPE = createNativeFunctionTypeWithVarArgs(NO_TYPE, ALL_TYPE);
		...
		com.google.javascript.rhino.jstype.FunctionType GREATEST_FUNCTION_TYPE = createNativeFunctionTypeWithVarArgs(ALL_TYPE, NO_TYPE);
	...
	private com.google.javascript.rhino.jstype.FunctionType createNativeFunctionTypeWithVarArgs(com.google.javascript.rhino.jstype.JSType returnType, com.google.javascript.rhino.jstype.JSType... parameterTypes) {
	...
	private com.google.javascript.rhino.jstype.FunctionType createConstructorTypeWithVarArgs(com.google.javascript.rhino.jstype.JSType returnType, com.google.javascript.rhino.jstype.JSType... parameterTypes) {
	...
	private com.google.javascript.rhino.jstype.FunctionType createNativeFunctionType(com.google.javascript.rhino.jstype.JSType returnType, com.google.javascript.rhino.Node parameters) {
		return new com.google.javascript.rhino.jstype.FunctionBuilder(com.google.javascript.rhino.jstype.JSTypeRegistry.this).withParamsNode(parameters).withReturnType(returnType).forNativeType().build();
	}
