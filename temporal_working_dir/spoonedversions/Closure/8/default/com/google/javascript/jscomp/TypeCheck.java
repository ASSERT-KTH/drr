...
public class TypeCheck implements com.google.javascript.jscomp.CompilerPass , com.google.javascript.jscomp.NodeTraversal.Callback {
	...
	private void visitFunction(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n) {
		...
		if (functionType.isConstructor()) {
			...
			if ((((baseConstructor != (getNativeType(com.google.javascript.rhino.jstype.JSTypeNative.OBJECT_FUNCTION_TYPE))) && (baseConstructor != null)) && (baseConstructor.isInterface())) && (functionType.isConstructor())) {
				...
				if ((baseConstructor != (getNativeType(com.google.javascript.rhino.jstype.JSTypeNative.OBJECT_FUNCTION_TYPE))) && (baseConstructor != null)) {
					if ((functionType.makesStructs()) && (!(baseConstructor.makesStructs()))) {
						...
						if ((functionType.makesDicts()) && (!(baseConstructor.makesDicts()))) {
