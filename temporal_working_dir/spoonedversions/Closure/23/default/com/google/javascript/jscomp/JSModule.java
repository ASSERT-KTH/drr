...
public class JSModule implements com.google.javascript.jscomp.deps.DependencyInfo , java.io.Serializable {
	...
	public void add(com.google.javascript.jscomp.SourceFile file) {
		add(new com.google.javascript.jscomp.CompilerInput(file));
	}

	public void addFirst(com.google.javascript.jscomp.SourceFile file) {
	...
	void addAndOverrideModule(com.google.javascript.jscomp.CompilerInput input) {
		inputs.add(input);
		input.overrideModule(com.google.javascript.jscomp.JSModule.this);
	}
