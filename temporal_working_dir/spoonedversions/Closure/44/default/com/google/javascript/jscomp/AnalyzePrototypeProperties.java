			...
			switch (n.getType()) {
				case com.google.javascript.rhino.Token.GETPROP :
					...
					if (((dest.isString()) && (com.google.javascript.jscomp.NodeUtil.isExprAssign(grandParent))) && (com.google.javascript.jscomp.NodeUtil.isVarOrSimpleAssignLhs(n, parent))) {
						...
						com.google.javascript.jscomp.AnalyzePrototypeProperties.Property prop = new com.google.javascript.jscomp.AnalyzePrototypeProperties.AssignmentProperty(grandParent, t.getScope().getVar(root.getString()), t.getModule());
				...
				case com.google.javascript.rhino.Token.ASSIGN :
					...
					if (map.isObjectLit()) {
						for (com.google.javascript.rhino.Node key = map.getFirstChild(); key != null; key = key.getNext()) {
							...
							com.google.javascript.jscomp.AnalyzePrototypeProperties.Property prop = new com.google.javascript.jscomp.AnalyzePrototypeProperties.LiteralProperty(key, key.getFirstChild(), map, n, t.getScope().getVar(root.getString()), t.getModule());
							getNameInfoForName(name, PROPERTY).getDeclarations().add(prop);
						}
						return true;
					}
