...
class RenameProperties implements com.google.javascript.jscomp.CompilerPass {
	...
	public void process(com.google.javascript.rhino.Node externs, com.google.javascript.rhino.Node root) {
		...
		for (java.util.Map.Entry<com.google.javascript.rhino.Node, com.google.javascript.rhino.Node> nodeEntry : callNodeToParentMap.entrySet()) {
			...
			parent.replaceChild(nodeEntry.getKey(), com.google.javascript.rhino.IR.string(sb.toString()));
			changed = true;
		}
		if (changed) {
		...
		public void visit(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
			switch (n.getType()) {
				...
				case com.google.javascript.rhino.Token.CALL :
					...
					if ((fnName.isName()) && (com.google.javascript.jscomp.RenameProperties.RENAME_PROPERTY_FUNCTION_NAME.equals(fnName.getString()))) {
				...
				case com.google.javascript.rhino.Token.FUNCTION :
					if (com.google.javascript.jscomp.NodeUtil.isFunctionDeclaration(n)) {
						...
						if ((parent.isName()) && (com.google.javascript.jscomp.RenameProperties.RENAME_PROPERTY_FUNCTION_NAME.equals(parent.getString()))) {
