	...
	private void replaceTopLevelExpressionWithRhs(com.google.javascript.rhino.Node parent, com.google.javascript.rhino.Node n) {
		...
		switch (n.getType()) {
			...
			case com.google.javascript.rhino.Token.VAR :
				break;
			case com.google.javascript.rhino.Token.ASSIGN :
				com.google.common.base.Preconditions.checkArgument(((parent.getType()) == (com.google.javascript.rhino.Token.FOR)), "Unsupported assignment in replaceWithRhs. parent: %s", com.google.javascript.rhino.Token.name(parent.getType()));
				break;
			default :
