...
class PeepholeFoldConstants extends com.google.javascript.jscomp.AbstractPeepholeOptimization {
	...
	private boolean inForcedStringContext(com.google.javascript.rhino.Node n) {
		if (((n.getParent().getType()) == (com.google.javascript.rhino.Token.GETELEM)) && ((n.getParent().getLastChild()) == n)) {
			return true;
		}
		if ((n.getParent().getType()) == (com.google.javascript.rhino.Token.ADD)) {
			return true;
		}
		return false;
	}
