			...
			switch (n.getType()) {
				case com.google.javascript.rhino.Token.TRY :
					...
					if (!(com.google.javascript.jscomp.NodeUtil.isStatementBlock(parent))) {
						block = new com.google.javascript.rhino.Node(com.google.javascript.rhino.Token.BLOCK);
				...
				case com.google.javascript.rhino.Token.RETURN :
					...
					for (com.google.javascript.rhino.Node anc = parent; (anc != null) && ((anc.getType()) != (com.google.javascript.rhino.Token.FUNCTION)); anc = anc.getParent()) {
						if ((anc.getType()) == (com.google.javascript.rhino.Token.TRY)) {
