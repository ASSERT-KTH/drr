...
public class SourceMapGeneratorV2 implements com.google.debugging.sourcemap.SourceMapGenerator {
	...
	public void appendTo(java.lang.Appendable out, java.lang.String name) throws java.io.IOException {
		...
		out.append("]");
		com.google.debugging.sourcemap.SourceMapGeneratorV2.appendFieldEnd(out);
		com.google.debugging.sourcemap.SourceMapGeneratorV2.appendFieldStart(out, "names");
		out.append("[");
	...
	private void addOriginalNameMap(java.lang.Appendable out) throws java.io.IOException {
		addMap(out, originalNameMap);
	}

	private void addMap(java.lang.Appendable out, java.util.Map<java.lang.String, java.lang.Integer> map) throws java.io.IOException {
		int i = 0;
		for (java.util.Map.Entry<java.lang.String, java.lang.Integer> entry : map.entrySet()) {
			...
			out.append(com.google.debugging.sourcemap.SourceMapGeneratorV2.escapeString(key));
			i++;
		}
	}
	...
	private class MappingWriter {
		...
		private void appendMappingTo(com.google.debugging.sourcemap.SourceMapGeneratorV2.Mapping m, java.lang.Appendable out) throws java.io.IOException {
			...
			if ((m.originalName) != null) {
				out.append(",");
				out.append(java.lang.String.valueOf(getNameId(m.originalName)));
			}
			out.append("],\n");
		}
	...
	public static class LineMapEncoder {
		...
		static java.lang.String valueToBase64(int value, int minimumSize) {
			...
			do {
				...
				value = value >>> 6;
				chars[(size++)] = com.google.debugging.sourcemap.Base64.toBase64(charValue);
			} while (value > 0 );
			java.lang.StringBuilder sb = new java.lang.StringBuilder(size);
			while (minimumSize > size) {
				sb.append(com.google.debugging.sourcemap.Base64.toBase64(0));
				minimumSize--;
			} 
			while (size > 0) {
	...
	@java.lang.Override
	public void appendIndexMapTo(java.lang.Appendable out, java.lang.String name, java.util.List<com.google.debugging.sourcemap.SourceMapSection> appSections) throws java.io.IOException {
		out.append("{\n");
		com.google.debugging.sourcemap.SourceMapGeneratorV2.appendFirstField(out, "version", "2");
		com.google.debugging.sourcemap.SourceMapGeneratorV2.appendField(out, "file", com.google.debugging.sourcemap.SourceMapGeneratorV2.escapeString(name));
