...
public abstract class RegExpTree {
	...
	static final class Text extends com.google.javascript.jscomp.regex.RegExpTree.RegExpTreeAtom {
		...
		static void escapeRegularCharOnto(char ch, java.lang.StringBuilder sb) {
			switch (ch) {
				case '$' :
				case '^' :
				case '*' :
		...
		protected void appendSourceCode(java.lang.StringBuilder sb) {
			for (int i = 0, n = text.length(); i < n; ++i) {
				com.google.javascript.jscomp.regex.RegExpTree.Text.escapeRegularCharOnto(text.charAt(i), sb);
			}
		}
		...
		protected void appendSourceCode(java.lang.StringBuilder sb) {
			...
			for (com.google.javascript.jscomp.regex.RegExpTree element : elements) {
				...
				if ((element instanceof com.google.javascript.jscomp.regex.RegExpTree.Alternation) || (element instanceof com.google.javascript.jscomp.regex.RegExpTree.Concatenation)) {
					...
					digitsMightBleed = element instanceof com.google.javascript.jscomp.regex.RegExpTree.Text;
					if (digitsMightBleed) {
						com.google.javascript.jscomp.regex.RegExpTree.Text text = ((com.google.javascript.jscomp.regex.RegExpTree.Text) (element));
				...
				digitsMightBleed = (element instanceof com.google.javascript.jscomp.regex.RegExpTree.BackReference) && ((((com.google.javascript.jscomp.regex.RegExpTree.BackReference) (element)).groupIndex) < 10);
			}
		}
