...
public class ObjToIntMap implements java.io.Serializable {
	...
	public ObjToIntMap(int keyCountHint) {
		...
		power = i;
		if ((com.google.javascript.rhino.ObjToIntMap.check) && ((power) < 2))
			com.google.javascript.rhino.Kit.codeBug();
	...
	private int insertNewKey(java.lang.Object key, int hash) {
		if ((com.google.javascript.rhino.ObjToIntMap.check) && ((occupiedCount) != (keyCount)))
			com.google.javascript.rhino.Kit.codeBug();
		
		if ((com.google.javascript.rhino.ObjToIntMap.check) && ((keyCount) == (1 << (power))))
			com.google.javascript.rhino.Kit.codeBug();
		...
		if ((keys[index]) != null) {
			...
			do {
				if ((com.google.javascript.rhino.ObjToIntMap.check) && ((keys[index]) == (com.google.javascript.rhino.ObjToIntMap.DELETED)))
					com.google.javascript.rhino.Kit.codeBug();
				
				index = (index + step) & mask;
				if ((com.google.javascript.rhino.ObjToIntMap.check) && (firstIndex == index))
					com.google.javascript.rhino.Kit.codeBug();
	...
	private void rehashTable() {
		if ((keys) == null) {
			if ((com.google.javascript.rhino.ObjToIntMap.check) && ((keyCount) != 0))
				com.google.javascript.rhino.Kit.codeBug();
			
			if ((com.google.javascript.rhino.ObjToIntMap.check) && ((occupiedCount) != 0))
				com.google.javascript.rhino.Kit.codeBug();
	...
	private int ensureIndex(java.lang.Object key) {
		...
		if (((com.google.javascript.rhino.ObjToIntMap.check) && ((keys) != null)) && ((keys[index]) != null))
			com.google.javascript.rhino.Kit.codeBug();
