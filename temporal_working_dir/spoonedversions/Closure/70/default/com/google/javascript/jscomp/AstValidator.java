...
public class AstValidator implements com.google.javascript.jscomp.CompilerPass {
	...
	public void validateStatement(com.google.javascript.rhino.Node n) {
		switch (n.getType()) {
			...
			case com.google.javascript.rhino.Token.DEBUGGER :
				...
				return ;
			default :
				violation((("Expected statement but was " + (com.google.javascript.rhino.Node.tokenToName(n.getType()))) + "."), n);
		}
	}
	...
	public void validateExpression(com.google.javascript.rhino.Node n) {
		switch (n.getType()) {
			...
			case com.google.javascript.rhino.Token.FUNCTION :
				...
				return ;
			default :
				violation(("Expected expression but was " + (com.google.javascript.rhino.Node.tokenToName(n.getType()))), n);
		}
	}
	...
	private void validateHasSourceName(com.google.javascript.rhino.Node n) {
		java.lang.String sourceName = ((java.lang.String) (n.getProp(com.google.javascript.rhino.Node.SOURCENAME_PROP)));
	...
	private void validateParameters(com.google.javascript.rhino.Node n) {
		validateNodeType(com.google.javascript.rhino.Token.LP, n);
		for (com.google.javascript.rhino.Node c = n.getFirstChild(); c != null; c = c.getNext()) {
			validateName(c);
		}
	}
	...
	private void validateSwitchMember(com.google.javascript.rhino.Node n) {
		switch (n.getType()) {
			...
			case com.google.javascript.rhino.Token.DEFAULT :
				...
				return ;
			default :
				violation(("Expected switch member but was " + (com.google.javascript.rhino.Node.tokenToName(n.getType()))), n);
		}
	}

	private void validateDefault(com.google.javascript.rhino.Node n) {
		validateNodeType(com.google.javascript.rhino.Token.DEFAULT, n);
		validateChildCount(n, 1);
	...
	private void validateAssignmentTarget(com.google.javascript.rhino.Node n) {
		switch (n.getType()) {
			...
			case com.google.javascript.rhino.Token.GETPROP :
				...
				return ;
			default :
				violation(("Expected assignment target expression but was " + (com.google.javascript.rhino.Node.tokenToName(n.getType()))), n);
		}
	}
	...
	private void validateObjectLitKey(com.google.javascript.rhino.Node n) {
		switch (n.getType()) {
			...
			case com.google.javascript.rhino.Token.STRING :
				...
				return ;
			default :
				violation(("Expected object literal key expression but was " + (com.google.javascript.rhino.Node.tokenToName(n.getType()))), n);
		}
	}

	private void validateObjectLitGetKey(com.google.javascript.rhino.Node n) {
		validateNodeType(com.google.javascript.rhino.Token.GET, n);
		validateChildCount(n, 1);
	...
	private void validateObjectLitSetKey(com.google.javascript.rhino.Node n) {
		validateNodeType(com.google.javascript.rhino.Token.SET, n);
		validateChildCount(n, 1);
		validateObjectLiteralKeyName(n);
		com.google.javascript.rhino.Node function = n.getFirstChild();
		validateFunctionExpression(function);
	...
	private void validateObjectLiteralKeyName(com.google.javascript.rhino.Node n) {
		if (n.isQuotedString()) {
			try {
				...
				violation(("getString failed for" + (com.google.javascript.rhino.Node.tokenToName(n.getType()))), n);
			}
		}else {
			validateNonEmptyString(n);
		}
	...
	private void validateNodeType(int type, com.google.javascript.rhino.Node n) {
		if ((n.getType()) != type) {
			violation(((("Expected " + (com.google.javascript.rhino.Node.tokenToName(type))) + " but was ") + (com.google.javascript.rhino.Node.tokenToName(n.getType()))), n);
		}
	}
