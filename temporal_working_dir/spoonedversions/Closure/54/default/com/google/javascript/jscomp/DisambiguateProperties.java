...
class DisambiguateProperties<T> implements com.google.javascript.jscomp.CompilerPass {
	...
	private DisambiguateProperties(com.google.javascript.jscomp.AbstractCompiler compiler, com.google.javascript.jscomp.DisambiguateProperties.TypeSystem<T> typeSystem) {
		...
		if (com.google.javascript.jscomp.DisambiguateProperties.this.showInvalidationWarnings) {
	...
	private class FindRenameableProperties extends com.google.javascript.jscomp.DisambiguateProperties<T>.AbstractScopingCallback {
				...
				if (showInvalidationWarnings) {
					...
					if (type instanceof com.google.javascript.rhino.jstype.JSType) {
						...
						if ((jsType.isAllType()) || (jsType.isUnknownType())) {
							if ((n.getFirstChild().getType()) == (com.google.javascript.rhino.Token.THIS)) {
					...
					compiler.report(com.google.javascript.jscomp.JSError.make(t.getSourceName(), n, com.google.javascript.jscomp.DisambiguateProperties.Warnings.INVALIDATION, name, (type == null ? "null" : type.toString()), n.toString(), suggestion));
				}
			}
		}
		...
		private void printErrorLocations(java.lang.StringBuilder sb, com.google.javascript.rhino.jstype.JSType t) {
