...
class TypeValidator {
	...
	TypeValidator(com.google.javascript.jscomp.AbstractCompiler compiler) {
		...
		this.recordErrors = (compiler.getErrorLevel(com.google.javascript.jscomp.JSError.make("", 0, 0, com.google.javascript.jscomp.DisambiguateProperties.Warnings.INVALIDATION))) != (com.google.javascript.jscomp.CheckLevel.OFF);
	}
