...
ORDINARY, CONSTRUCTOR, INTERFACE;	}
	...
	private com.google.javascript.rhino.jstype.PrototypeObjectType prototype;
	...
	public com.google.javascript.rhino.jstype.ObjectType getPrototype() {
		if ((prototype) == null) {
			setPrototype(new com.google.javascript.rhino.jstype.PrototypeObjectType(registry, ((com.google.javascript.rhino.jstype.FunctionType.this.getReferenceName()) + ".prototype"), registry.getNativeObjectType(com.google.javascript.rhino.jstype.JSTypeNative.OBJECT_TYPE), isNativeObjectType()));
		}
		return prototype;
	}

	public void setPrototypeBasedOn(com.google.javascript.rhino.jstype.ObjectType baseType) {
		if (((((baseType.hasReferenceName()) || (baseType.isUnknownType())) || (isNativeObjectType())) || (baseType.isFunctionPrototypeType())) || (!(baseType instanceof com.google.javascript.rhino.jstype.PrototypeObjectType))) {
		...
		setPrototype(((com.google.javascript.rhino.jstype.PrototypeObjectType) (baseType)));
	}

	public boolean setPrototype(com.google.javascript.rhino.jstype.PrototypeObjectType prototype) {
		if (prototype == null) {
			return false;
		}
		...
		com.google.javascript.rhino.jstype.FunctionType.this.prototype.setOwnerFunction(com.google.javascript.rhino.jstype.FunctionType.this);
	...
	boolean defineProperty(java.lang.String name, com.google.javascript.rhino.jstype.JSType type, boolean inferred, com.google.javascript.rhino.Node propertyNode) {
		if ("prototype".equals(name)) {
			...
			if (objType != null) {
				...
				com.google.javascript.rhino.jstype.FunctionType.this.setPrototypeBasedOn(objType);
				return true;
			}else {
				return false;
			}
	...
	com.google.javascript.rhino.jstype.JSType resolveInternal(com.google.javascript.rhino.ErrorReporter t, com.google.javascript.rhino.jstype.StaticScope<com.google.javascript.rhino.jstype.JSType> scope) {
		...
		prototype = ((com.google.javascript.rhino.jstype.PrototypeObjectType) (com.google.javascript.rhino.jstype.JSType.safeResolve(prototype, t, scope)));
