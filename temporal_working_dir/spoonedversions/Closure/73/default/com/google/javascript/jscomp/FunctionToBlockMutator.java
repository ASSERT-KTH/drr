...
class FunctionToBlockMutator {
	...
	private void makeLocalNamesUnique(com.google.javascript.rhino.Node fnNode, boolean isCallInLoop) {
		com.google.javascript.jscomp.NodeTraversal.traverse(compiler, fnNode, new com.google.javascript.jscomp.MakeDeclaredNamesUnique(new com.google.javascript.jscomp.MakeDeclaredNamesUnique.InlineRenamer(compiler.getUniqueNameIdSupplier(), "inline_", isCallInLoop)));
	}
