...
class FunctionArgumentInjector {
	...
	static com.google.javascript.rhino.Node inject(com.google.javascript.rhino.Node node, com.google.javascript.rhino.Node parent, java.util.Map<java.lang.String, com.google.javascript.rhino.Node> replacements) {
		...
		for (com.google.javascript.rhino.Node c = node.getFirstChild(); c != null; c = c.getNext()) {
			c = com.google.javascript.jscomp.FunctionArgumentInjector.inject(c, node, replacements);
		}
		return node;
	}
	...
	static java.util.LinkedHashMap<java.lang.String, com.google.javascript.rhino.Node> getFunctionCallParameterMap(com.google.javascript.rhino.Node fnNode, com.google.javascript.rhino.Node callNode, com.google.common.base.Supplier<java.lang.String> safeNameIdSupplier) {
		...
		if ((callNode.getFirstChild().getType()) != (com.google.javascript.rhino.Token.NAME)) {
			if (com.google.javascript.jscomp.NodeUtil.isFunctionObjectCall(callNode)) {
				com.google.common.base.Preconditions.checkNotNull(cArg);
				com.google.common.base.Preconditions.checkState(((cArg.getType()) == (com.google.javascript.rhino.Token.THIS)));
				cArg = cArg.getNext();
			}else {
				com.google.common.base.Preconditions.checkState((!(com.google.javascript.jscomp.NodeUtil.isFunctionObjectApply(callNode))));
			}
		}
		for (com.google.javascript.rhino.Node fnArg : com.google.javascript.jscomp.NodeUtil.getFnParameters(fnNode).children()) {
			if (cArg != null) {
	...
	static java.util.Set<java.lang.String> findModifiedParameters(com.google.javascript.rhino.Node fnNode) {
		...
		return com.google.javascript.jscomp.FunctionArgumentInjector.findModifiedParameters(fnNode, null, names, unsafeNames);
	}

	private static java.util.Set<java.lang.String> findModifiedParameters(com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent, java.util.Set<java.lang.String> names, java.util.Set<java.lang.String> unsafe) {
		...
		if ((n.getType()) == (com.google.javascript.rhino.Token.NAME)) {
			if (names.contains(n.getString())) {
				if (com.google.javascript.jscomp.FunctionArgumentInjector.canNameValueChange(n, parent)) {
					unsafe.add(n.getString());
				}
			}
		}
		for (com.google.javascript.rhino.Node c : n.children()) {
			com.google.javascript.jscomp.FunctionArgumentInjector.findModifiedParameters(c, n, names, unsafe);
		}
		return unsafe;
	}
	...
	private static java.util.Set<java.lang.String> getFunctionParameterSet(com.google.javascript.rhino.Node fnNode) {
		...
		for (com.google.javascript.rhino.Node n : com.google.javascript.jscomp.NodeUtil.getFnParameters(fnNode).children()) {
			set.add(n.getString());
		}
		return set;
	}
