...
class CodeGenerator {
	...
	void add(com.google.javascript.rhino.Node n, com.google.javascript.jscomp.CodeGenerator.Context context) {
		...
		switch (type) {
			...
			case com.google.javascript.rhino.Token.ARRAYLIT :
				add("[");
				addArrayList(first, ((int[]) (n.getProp(com.google.javascript.rhino.Node.SKIP_INDEXES_PROP))));
				add("]");
				break;
	...
	void addArrayList(com.google.javascript.rhino.Node firstInList, int[] skipIndexes) {
		int nextSlot = 0;
		int nextSkipSlot = 0;
		for (com.google.javascript.rhino.Node n = firstInList; n != null; n = n.getNext()) {
