...
public class SourceMapGeneratorV1 implements com.google.javascript.jscomp.sourcemap.SourceMapGenerator {
	...
	static class Mapping {
		...
		com.google.javascript.jscomp.sourcemap.FilePosition originalPosition;

		com.google.javascript.jscomp.sourcemap.FilePosition startPosition;

		com.google.javascript.jscomp.sourcemap.FilePosition endPosition;
	...
	private com.google.javascript.jscomp.sourcemap.FilePosition offsetPosition = new com.google.javascript.jscomp.sourcemap.FilePosition(0, 0);

	private com.google.javascript.jscomp.sourcemap.FilePosition prefixPosition = new com.google.javascript.jscomp.sourcemap.FilePosition(0, 0);
	...
	java.lang.String symbolName, com.google.javascript.jscomp.sourcemap.FilePosition sourceStartPosition, com.google.javascript.jscomp.sourcemap.FilePosition startPosition, com.google.javascript.jscomp.sourcemap.FilePosition endPosition) {
		...
		if (((offsetPosition.getLine()) == 0) && ((offsetPosition.getColumn()) == 0)) {
			...
			mapping.startPosition = new com.google.javascript.jscomp.sourcemap.FilePosition(((startPosition.getLine()) + offsetLine), ((startPosition.getColumn()) + startOffsetPosition));
			mapping.endPosition = new com.google.javascript.jscomp.sourcemap.FilePosition(((endPosition.getLine()) + offsetLine), ((endPosition.getColumn()) + endOffsetPosition));
		}
		if ((lastMapping) != null) {
	...
	public void setWrapperPrefix(java.lang.String prefix) {
		...
		prefixPosition = new com.google.javascript.jscomp.sourcemap.FilePosition(prefixLine, prefixIndex);
	}
	...
	public void setStartingPosition(int offsetLine, int offsetIndex) {
		...
		offsetPosition = new com.google.javascript.jscomp.sourcemap.FilePosition(offsetLine, offsetIndex);
	}

	public void reset() {
		mappings = com.google.common.collect.Lists.newArrayList();
		lastMapping = null;
		offsetPosition = new com.google.javascript.jscomp.sourcemap.FilePosition(0, 0);
		prefixPosition = new com.google.javascript.jscomp.sourcemap.FilePosition(0, 0);
	}
	...
	private class MappingTraversal {
		...
		private int getAdjustedLine(com.google.javascript.jscomp.sourcemap.FilePosition p) {
			return (p.getLine()) + (prefixPosition.getLine());
		}

		private int getAdjustedCol(com.google.javascript.jscomp.sourcemap.FilePosition p) {
	...
	@java.lang.Override
	public void writeMetaMap(java.lang.Appendable out, java.lang.String name, java.util.List<com.google.javascript.jscomp.sourcemap.SourceMapSection> appSections) {
