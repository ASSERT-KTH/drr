...
public abstract class BaseJSTypeTestCase extends junit.framework.TestCase {
	...
	protected com.google.javascript.rhino.jstype.JSType ARRAY_FUNCTION_TYPE;
	...
	protected void initTypes() {
		...
		ARRAY_FUNCTION_TYPE = registry.getNativeType(com.google.javascript.rhino.jstype.JSTypeNative.ARRAY_FUNCTION_TYPE);
	...
	private static void addMethod(com.google.javascript.rhino.jstype.JSTypeRegistry registry, com.google.javascript.rhino.jstype.ObjectType receivingType, java.lang.String methodName, com.google.javascript.rhino.jstype.JSType returnType) {
		receivingType.defineDeclaredProperty(methodName, new com.google.javascript.rhino.jstype.FunctionBuilder(registry).withReturnType(returnType).build(), true, null);
	}
