...
public class SourceMapGeneratorV2 implements com.google.javascript.jscomp.sourcemap.SourceMapGenerator {
	...
	java.lang.String symbolName, com.google.javascript.jscomp.sourcemap.FilePosition sourceStartPosition, com.google.javascript.jscomp.sourcemap.FilePosition startPosition, com.google.javascript.jscomp.sourcemap.FilePosition endPosition) {
		...
		com.google.javascript.jscomp.sourcemap.FilePosition adjustedStart = startPosition;
		com.google.javascript.jscomp.sourcemap.FilePosition adjustedEnd = endPosition;
		if (((offsetPosition.getLine()) != 0) || ((offsetPosition.getColumn()) != 0)) {
			...
			adjustedStart = new com.google.javascript.jscomp.sourcemap.FilePosition(((startPosition.getLine()) + offsetLine), ((startPosition.getColumn()) + startOffsetPosition));
			adjustedEnd = new com.google.javascript.jscomp.sourcemap.FilePosition(((endPosition.getLine()) + offsetLine), ((endPosition.getColumn()) + endOffsetPosition));
		}
	...
	public void appendTo(java.lang.Appendable out, java.lang.String name) throws java.io.IOException {
		...
		out.append("{\n");
		com.google.javascript.jscomp.sourcemap.SourceMapGeneratorV2.appendFirstField(out, "version", "2");
		com.google.javascript.jscomp.sourcemap.SourceMapGeneratorV2.appendField(out, "file", com.google.javascript.jscomp.sourcemap.SourceMapGeneratorV2.escapeString(name));
		com.google.javascript.jscomp.sourcemap.SourceMapGeneratorV2.appendField(out, "lineCount", java.lang.String.valueOf((maxLine + 1)));
		com.google.javascript.jscomp.sourcemap.SourceMapGeneratorV2.appendFieldStart(out, "lineMaps");
		out.append("[");
		new com.google.javascript.jscomp.sourcemap.SourceMapGeneratorV2.LineMapper(out).appendLineMappings();
		out.append("]");
		com.google.javascript.jscomp.sourcemap.SourceMapGeneratorV2.appendFieldEnd(out);
		com.google.javascript.jscomp.sourcemap.SourceMapGeneratorV2.appendFieldStart(out, "sources");
		out.append("[");
		addSourceNameMap(out);
		out.append("]");
		com.google.javascript.jscomp.sourcemap.SourceMapGeneratorV2.appendFieldEnd(out);
		com.google.javascript.jscomp.sourcemap.SourceMapGeneratorV2.appendFieldStart(out, "mappings");
		out.append("[");
	...
	private static void appendFieldStart(java.lang.Appendable out, java.lang.String name) throws java.io.IOException {
		com.google.javascript.jscomp.sourcemap.SourceMapGeneratorV2.appendField(out, name, "");
	}
	...
	public static class LineMapDecoder {
		...
		public static java.util.List<java.lang.Integer> decodeLine(java.lang.String lineSource) {
	...
	@java.lang.Override
	public void writeMetaMap(java.lang.Appendable out, java.lang.String name, java.util.List<com.google.javascript.jscomp.sourcemap.SourceMapSection> appSections) throws java.io.IOException {
		out.append("{\n");
		com.google.javascript.jscomp.sourcemap.SourceMapGeneratorV2.appendFirstField(out, "version", "2");
		com.google.javascript.jscomp.sourcemap.SourceMapGeneratorV2.appendField(out, "file", com.google.javascript.jscomp.sourcemap.SourceMapGeneratorV2.escapeString(name));
		com.google.javascript.jscomp.sourcemap.SourceMapGeneratorV2.appendFieldStart(out, "sections");
		out.append("[\n");
		boolean first = true;
		java.lang.Long offset = new java.lang.Long(0);
		for (com.google.javascript.jscomp.sourcemap.SourceMapSection section : appSections) {
			if (first) {
				first = false;
			}else {
				out.append(",\n");
			...
			out.append("{\n");
			com.google.javascript.jscomp.sourcemap.SourceMapGeneratorV2.appendFirstField(out, "offset", offset.toString());
			com.google.javascript.jscomp.sourcemap.SourceMapGeneratorV2.appendField(out, "file", com.google.javascript.jscomp.sourcemap.SourceMapGeneratorV2.escapeString(section.getSectionUrl()));
			out.append("\n}");
