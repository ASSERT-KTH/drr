...
class CheckRequiresForConstructors implements com.google.javascript.jscomp.HotSwapCompilerPass {
	...
	private static boolean isClassName(java.lang.String name) {
		return (((name != null) && ((name.length()) > 1)) && (java.lang.Character.isUpperCase(name.charAt(0)))) && (!(name.equals(name.toUpperCase())));
	}

	private static java.lang.String getOutermostClassName(java.lang.String className) {
		for (java.lang.String part : className.split("\\.")) {
			if (com.google.javascript.jscomp.CheckRequiresForConstructors.isClassName(part)) {
	...
	private class CheckRequiresForConstructorsCallback implements com.google.javascript.jscomp.NodeTraversal.Callback {
					...
					if (com.google.javascript.jscomp.NodeUtil.isFunctionExpression(n)) {
						if (parent.isName()) {
							...
							if ((info != null) && (info.isConstructor())) {
								...
								com.google.common.base.Preconditions.checkState(((gramps != null) && (gramps.isVar())));
		...
		private void visitScriptNode(com.google.javascript.jscomp.NodeTraversal t) {
			...
			for (com.google.javascript.rhino.Node node : newNodes) {
				...
				java.lang.String outermostClassName = com.google.javascript.jscomp.CheckRequiresForConstructors.getOutermostClassName(className);
