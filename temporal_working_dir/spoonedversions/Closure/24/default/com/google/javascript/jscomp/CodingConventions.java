...
public class CodingConventions {
	...
	public static class Proxy implements com.google.javascript.jscomp.CodingConvention {
		...
		@java.lang.Override
		public boolean isInlinableFunction(com.google.javascript.rhino.Node n) {
		...
		@java.lang.Override
		public void defineDelegateProxyPrototypeProperties(com.google.javascript.rhino.jstype.JSTypeRegistry registry, com.google.javascript.rhino.jstype.StaticScope<com.google.javascript.rhino.jstype.JSType> scope, java.util.List<com.google.javascript.rhino.jstype.ObjectType> delegateProxyPrototypes, java.util.Map<java.lang.String, java.lang.String> delegateCallingConventions) {
	...
	private static class DefaultCodingConvention implements com.google.javascript.jscomp.CodingConvention {
		...
		public com.google.javascript.jscomp.CodingConvention.Bind describeFunctionBind(com.google.javascript.rhino.Node n, boolean useTypeInfo) {
			...
			if ((callTarget.isGetProp()) && (callTarget.getLastChild().getString().equals("bind"))) {
				com.google.javascript.rhino.Node maybeFn = callTarget.getFirstChild();
				com.google.javascript.rhino.jstype.JSType maybeFnType = maybeFn.getJSType();
				com.google.javascript.rhino.jstype.FunctionType fnType = null;
				...
				if ((fnType != null) || (maybeFn.isFunction())) {
					...
					com.google.javascript.rhino.Node parameters = safeNext(thisValue);
					return new com.google.javascript.jscomp.CodingConvention.Bind(maybeFn, thisValue, parameters);
				}
			}
			return null;
		}
