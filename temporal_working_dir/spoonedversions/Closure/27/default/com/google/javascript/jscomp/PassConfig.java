...
public abstract class PassConfig {
	...
	void regenerateGlobalTypedScope(com.google.javascript.jscomp.AbstractCompiler compiler, com.google.javascript.rhino.Node root) {
		internalScopeCreator = new com.google.javascript.jscomp.TypedScopeCreator(compiler);
		typedScopeCreator = new com.google.javascript.jscomp.MemoizedScopeCreator(internalScopeCreator);
		topScope = typedScopeCreator.createScope(root, null);
	}

	void patchGlobalTypedScope(com.google.javascript.jscomp.AbstractCompiler compiler, com.google.javascript.rhino.Node scriptRoot) {
		com.google.common.base.Preconditions.checkNotNull(internalScopeCreator);
	...
	final com.google.javascript.jscomp.InferJSDocInfo makeInferJsDocInfo(com.google.javascript.jscomp.AbstractCompiler compiler) {
		return new com.google.javascript.jscomp.InferJSDocInfo(compiler);
	}
	...
	protected abstract void setIntermediateState(com.google.javascript.jscomp.PassConfig.State state);
