...
public class Compiler extends com.google.javascript.jscomp.AbstractCompiler {
	...
	public void initOptions(com.google.javascript.jscomp.CompilerOptions options) {
		...
		com.google.javascript.jscomp.WarningsGuard warningsGuard = options.getWarningsGuard();
		if (warningsGuard != null) {
			guards.add(options.getWarningsGuard());
		}
		if ((!(options.checkSymbols)) && ((warningsGuard == null) || (!(warningsGuard.disables(com.google.javascript.jscomp.DiagnosticGroups.CHECK_VARIABLES))))) {
			guards.add(new com.google.javascript.jscomp.DiagnosticGroupWarningsGuard(com.google.javascript.jscomp.DiagnosticGroups.CHECK_VARIABLES, com.google.javascript.jscomp.CheckLevel.OFF));
		}
		if (options.enables(com.google.javascript.jscomp.DiagnosticGroups.CHECK_TYPES)) {
			...
			if (options.disables(com.google.javascript.jscomp.DiagnosticGroups.CHECK_TYPES)) {
				...
				if (!(options.checkTypes)) {
					guards.add(new com.google.javascript.jscomp.DiagnosticGroupWarningsGuard(com.google.javascript.jscomp.DiagnosticGroup.forType(com.google.javascript.jscomp.RhinoErrorReporter.TYPE_PARSE_ERROR), com.google.javascript.jscomp.CheckLevel.OFF));
				}
	...
	public void toSource(final com.google.javascript.jscomp.Compiler.CodeBuilder cb, final int inputSeqNum, final com.google.javascript.rhino.Node root) {
		runInCompilerThread(new java.util.concurrent.Callable<java.lang.Void>() {
			public java.lang.Void call() throws java.lang.Exception {
				...
				java.lang.String code = toSource(root, sourceMap);
				if (!(code.isEmpty())) {
					cb.append(code);
	...
	private java.lang.String toSource(com.google.javascript.rhino.Node n, com.google.javascript.jscomp.SourceMap sourceMap) {
		...
		builder.setTagAsStrict(((options.getLanguageOut()) == (com.google.javascript.jscomp.CompilerOptions.LanguageMode.ECMASCRIPT5_STRICT)));
	...
	public boolean acceptEcmaScript5() {
		return (options.getLanguageIn()) == (com.google.javascript.jscomp.CompilerOptions.LanguageMode.ECMASCRIPT5);
	}
	...
	public com.google.javascript.jscomp.CheckLevel getErrorLevel(com.google.javascript.jscomp.JSError error) {
		...
		com.google.javascript.jscomp.WarningsGuard guards = options.getWarningsGuard();
		if (guards == null) {
			return error.level;
		}else {
