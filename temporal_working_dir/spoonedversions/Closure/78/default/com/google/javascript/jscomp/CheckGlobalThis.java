...
final class CheckGlobalThis implements com.google.javascript.jscomp.NodeTraversal.Callback {
	...
	CheckGlobalThis(com.google.javascript.jscomp.AbstractCompiler compiler, com.google.javascript.jscomp.CheckLevel level) {
	...
	public void visit(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
		if (((n.getType()) == (com.google.javascript.rhino.Token.THIS)) && (shouldReportThis(n, parent))) {
			compiler.report(t.makeError(n, level, com.google.javascript.jscomp.CheckGlobalThis.GLOBAL_THIS));
		}
		if (n == (assignLhsChild)) {
			assignLhsChild = null;
		}
