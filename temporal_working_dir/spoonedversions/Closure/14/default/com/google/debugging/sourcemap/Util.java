...
class Util {
	...
	static java.lang.String escapeString(java.lang.String s) {
		return com.google.debugging.sourcemap.Util.escapeString(s, '"', "\\\"", "\'", "\\\\", null);
	}
				...
				default :
					if (outputCharsetEncoder != null) {
						if (outputCharsetEncoder.canEncode(c)) {
							...
							com.google.debugging.sourcemap.Util.appendCharAsHex(sb, c);
						}
					}else {
						if ((c > 31) && (c <= 127)) {
							sb.append(c);
	...
	private static void appendCharAsHex(java.lang.StringBuilder sb, char c) {
		try {
			com.google.debugging.sourcemap.Util.appendHexJavaScriptRepresentation(sb, ((int) (c)));
	...
	private static void appendHexJavaScriptRepresentation(java.lang.Appendable out, int codePoint) throws java.io.IOException {
		if (java.lang.Character.isSupplementaryCodePoint(codePoint)) {
			...
			com.google.debugging.sourcemap.Util.appendHexJavaScriptRepresentation(out, surrogates[0]);
			com.google.debugging.sourcemap.Util.appendHexJavaScriptRepresentation(out, surrogates[1]);
			return ;
		}
		out.append("\\u").append(com.google.debugging.sourcemap.Util.HEX_CHARS[((codePoint >>> 12) & 15)]).append(com.google.debugging.sourcemap.Util.HEX_CHARS[((codePoint >>> 8) & 15)]).append(com.google.debugging.sourcemap.Util.HEX_CHARS[((codePoint >>> 4) & 15)]).append(com.google.debugging.sourcemap.Util.HEX_CHARS[(codePoint & 15)]);
	}
}
