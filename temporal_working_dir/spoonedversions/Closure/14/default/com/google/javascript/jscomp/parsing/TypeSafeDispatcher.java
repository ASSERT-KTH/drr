...
abstract class TypeSafeDispatcher<T> {
	...
	abstract T processEmptyStatement(com.google.javascript.rhino.head.ast.EmptyStatement exprNode);
	...
	public T process(com.google.javascript.rhino.head.ast.AstNode node) {
		switch (node.getType()) {
			...
			case com.google.javascript.rhino.head.Token.EMPTY :
				return node instanceof com.google.javascript.rhino.head.ast.EmptyExpression ? processEmptyExpression(((com.google.javascript.rhino.head.ast.EmptyExpression) (node))) : processEmptyStatement(((com.google.javascript.rhino.head.ast.EmptyStatement) (node)));
