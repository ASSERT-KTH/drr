...
class TypeValidator {
	...
	void expectIndexMatch(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.jstype.JSType objType, com.google.javascript.rhino.jstype.JSType indexType) {
		com.google.common.base.Preconditions.checkState(((n.getType()) == (com.google.javascript.rhino.Token.GETELEM)));
	...
	void expectUndeclaredVariable(java.lang.String sourceName, com.google.javascript.jscomp.CompilerInput input, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent, com.google.javascript.jscomp.Scope.Var var, java.lang.String variableName, com.google.javascript.rhino.jstype.JSType newType) {
	...
	private void expectInterfaceProperty(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.jstype.ObjectType instance, com.google.javascript.rhino.jstype.ObjectType implementedInterface, java.lang.String prop) {
		if (!(instance.hasProperty(prop))) {
			...
			if (!(found.canAssignTo(required))) {
				...
				registerMismatch(found, required, report(t.makeError(n, com.google.javascript.jscomp.TypeValidator.HIDDEN_INTERFACE_PROPERTY_MISMATCH, prop, constructor.getTopMostDefiningType(prop).toString(), required.toString(), found.toString())));
			}
		}
	}
