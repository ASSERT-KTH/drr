...
SEARCHING_ANNOTATION, SEARCHING_NEWLINE, NEXT_IS_ANNOTATION;	}
	...
	JsDocInfoParser(com.google.javascript.jscomp.parsing.JsDocTokenStream stream, com.google.javascript.jscomp.mozilla.rhino.ast.Comment commentNode, com.google.javascript.rhino.Node associatedNode, com.google.javascript.jscomp.parsing.Config config, com.google.javascript.jscomp.mozilla.rhino.ErrorReporter errorReporter) {
		this.stream = stream;
...
PRESERVE, TRIM, SINGLE_LINE;	}
	...
	private com.google.javascript.rhino.Node newStringNode(java.lang.String s, int lineno, int charno) {
		return com.google.javascript.rhino.Node.newString(s, lineno, charno).clonePropsFrom(templateNode);
	}
