...
class CheckAccessControls implements com.google.javascript.jscomp.HotSwapCompilerPass , com.google.javascript.jscomp.NodeTraversal.ScopedCallback {
	...
	private void checkConstantProperty(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node getprop) {
		...
		boolean isDelete = (parent.getType()) == (com.google.javascript.rhino.Token.DELPROP);
		if ((((!((com.google.javascript.jscomp.NodeUtil.isAssignmentOp(parent)) && ((parent.getFirstChild()) == getprop))) && ((parent.getType()) != (com.google.javascript.rhino.Token.INC))) && ((parent.getType()) != (com.google.javascript.rhino.Token.DEC))) && (!isDelete)) {
			return ;
		}
