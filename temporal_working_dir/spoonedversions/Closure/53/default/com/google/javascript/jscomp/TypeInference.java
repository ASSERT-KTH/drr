...
class TypeInference extends com.google.javascript.jscomp.DataFlowAnalysis.BranchedForwardDataFlowAnalysis<com.google.javascript.rhino.Node, com.google.javascript.jscomp.FlowScope> {
	...
	private com.google.javascript.jscomp.FlowScope narrowScope(com.google.javascript.jscomp.FlowScope scope, com.google.javascript.rhino.Node node, com.google.javascript.rhino.jstype.JSType narrowed) {
		scope = scope.createChildFlowScope();
		if ((node.getType()) == (com.google.javascript.rhino.Token.GETPROP)) {
	...
	private void updateTypeOfParameters(com.google.javascript.rhino.Node n, com.google.javascript.rhino.jstype.FunctionType fnType) {
		...
		for (com.google.javascript.rhino.Node iParameter : fnType.getParameters()) {
			...
			if (iParameterType.isFunctionType()) {
				...
				if ((((iArgument.getType()) == (com.google.javascript.rhino.Token.FUNCTION)) && (iArgumentType.isFunctionType())) && ((iArgument.getJSDocInfo()) == null)) {
				...
				for (com.google.javascript.rhino.Node jParameter : fnType.getParameters()) {
					...
					if (jParameterType.isFunctionType()) {
						...
						if (jParameterFnType.getTypeOfThis().equals(iParameterType)) {
							...
							if (((jArgument.getType()) == (com.google.javascript.rhino.Token.FUNCTION)) && (jArgumentType.isFunctionType())) {
	...
	private void inferPropertyTypesToMatchConstraint(com.google.javascript.rhino.jstype.JSType type, com.google.javascript.rhino.jstype.JSType constraint) {
		...
		if ((constraintObj != null) && (constraintObj.isRecordType())) {
			com.google.javascript.rhino.jstype.ObjectType objType = com.google.javascript.rhino.jstype.ObjectType.cast(type.restrictByNotNullOrUndefined());
			if (objType != null) {
	...
	private void redeclareSimpleVar(com.google.javascript.jscomp.FlowScope scope, com.google.javascript.rhino.Node nameNode, com.google.javascript.rhino.jstype.JSType varType) {
		com.google.common.base.Preconditions.checkState(((nameNode.getType()) == (com.google.javascript.rhino.Token.NAME)));
