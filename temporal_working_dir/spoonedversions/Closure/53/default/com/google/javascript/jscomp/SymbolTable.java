...
public final class SymbolTable implements com.google.javascript.rhino.jstype.StaticSymbolTable<com.google.javascript.jscomp.SymbolTable.Symbol, com.google.javascript.jscomp.SymbolTable.Reference> {
	...
	void fillJSDocInfo(com.google.javascript.jscomp.AbstractCompiler compiler, com.google.javascript.rhino.Node externs, com.google.javascript.rhino.Node root) {
		com.google.javascript.jscomp.NodeTraversal.traverseRoots(compiler, com.google.common.collect.Lists.newArrayList(externs, root), new com.google.javascript.jscomp.SymbolTable.JSDocInfoCollector());
	}
	...
	private class ThisRefCollector extends com.google.javascript.jscomp.NodeTraversal.AbstractPostOrderCallback implements com.google.javascript.jscomp.CompilerPass {
		...
		public void visit(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
			...
			if ((type.isGlobalThisType()) && ((globalScope.getSlot(com.google.javascript.jscomp.SymbolTable.GLOBAL_THIS)) == null)) {
				declareSymbol(com.google.javascript.jscomp.SymbolTable.GLOBAL_THIS, registry.getNativeType(com.google.javascript.rhino.jstype.JSTypeNative.GLOBAL_THIS), false, globalScope, n);
			}
			com.google.javascript.jscomp.SymbolTable.Symbol s = getOnlySymbolForType(type);
			if (s != null) {
