...
public class DefaultPassConfig extends com.google.javascript.jscomp.PassConfig {
	...
	final com.google.javascript.jscomp.PassFactory peepholeOptimizations = new com.google.javascript.jscomp.PassFactory("peepholeOptimizations", false) {
		...
		protected com.google.javascript.jscomp.CompilerPass createInternal(com.google.javascript.jscomp.AbstractCompiler compiler) {
			...
			return new com.google.javascript.jscomp.PeepholeOptimizationsPass(compiler, new com.google.javascript.jscomp.PeepholeSubstituteAlternateSyntax(late), new com.google.javascript.jscomp.PeepholeReplaceKnownMethods(), new com.google.javascript.jscomp.PeepholeRemoveDeadCode(), new com.google.javascript.jscomp.PeepholeFoldConstants(late), new com.google.javascript.jscomp.PeepholeCollectPropertyAssignments());
		}
	};
	...
	final com.google.javascript.jscomp.PassFactory latePeepholeOptimizations = new com.google.javascript.jscomp.PassFactory("latePeepholeOptimizations", true) {
		...
		protected com.google.javascript.jscomp.CompilerPass createInternal(com.google.javascript.jscomp.AbstractCompiler compiler) {
			...
			return new com.google.javascript.jscomp.PeepholeOptimizationsPass(compiler, new com.google.javascript.jscomp.StatementFusion(), new com.google.javascript.jscomp.PeepholeRemoveDeadCode(), new com.google.javascript.jscomp.PeepholeSubstituteAlternateSyntax(late), new com.google.javascript.jscomp.PeepholeReplaceKnownMethods(), new com.google.javascript.jscomp.PeepholeFoldConstants(late), new com.google.javascript.jscomp.ReorderConstantExpression());
		}
	};
	...
	final com.google.javascript.jscomp.PassFactory checkShadowVars = new com.google.javascript.jscomp.PassFactory("variableShadowDeclarationCheck", true) {
		@java.lang.Override
		protected com.google.javascript.jscomp.CompilerPass createInternal(com.google.javascript.jscomp.AbstractCompiler compiler) {
	...
	final com.google.javascript.jscomp.PassFactory operaCompoundAssignFix = new com.google.javascript.jscomp.PassFactory("operaCompoundAssignFix", true) {
		@java.lang.Override
		protected com.google.javascript.jscomp.CompilerPass createInternal(com.google.javascript.jscomp.AbstractCompiler compiler) {
