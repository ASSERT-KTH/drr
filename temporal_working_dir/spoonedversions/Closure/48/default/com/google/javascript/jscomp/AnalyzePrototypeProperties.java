	...
	private class ProcessProperties implements com.google.javascript.jscomp.NodeTraversal.ScopedCallback {
		...
		public void visit(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
			if (n.isGetProp()) {
				...
				if ((n.isObjectLit()) && (!(((parent.isAssign()) && (parent.getFirstChild().isGetProp())) && (parent.getFirstChild().getLastChild().getString().equals("prototype"))))) {
		...
		private boolean isGlobalFunctionDeclaration(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n) {
			return (t.inGlobalScope()) && ((com.google.javascript.jscomp.NodeUtil.isFunctionDeclaration(n)) || ((n.isFunction()) && (n.getParent().isName())));
		}
		...
		private boolean isPrototypePropertyAssign(com.google.javascript.rhino.Node assign) {
			...
			if ((((n != null) && (com.google.javascript.jscomp.NodeUtil.isVarOrSimpleAssignLhs(n, assign))) && (n.isGetProp())) && (assign.getParent().isExprResult())) {
