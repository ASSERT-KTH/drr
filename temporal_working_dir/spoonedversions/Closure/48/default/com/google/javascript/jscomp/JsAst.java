...
public class JsAst implements com.google.javascript.jscomp.SourceAst {
	...
	private void parse(com.google.javascript.jscomp.AbstractCompiler compiler) {
		try {
			...
			root = com.google.javascript.jscomp.parsing.ParserRunner.parse(sourceFile, sourceFile.getCode(), compiler.getParserConfig(), compiler.getDefaultErrorReporter(), com.google.javascript.jscomp.JsAst.logger_);
