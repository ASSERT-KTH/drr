...
public final class SymbolTable implements com.google.javascript.rhino.jstype.StaticSymbolTable<com.google.javascript.jscomp.SymbolTable.Symbol, com.google.javascript.jscomp.SymbolTable.Reference> {
	...
	com.google.javascript.rhino.jstype.StaticReference<com.google.javascript.rhino.jstype.JSType> ref) {
		return (((ref != null) && ((ref.getNode()) != null)) && ((ref.getNode().getStaticSourceFile()) != null)) && (!(com.google.javascript.jscomp.VarCheck.SYNTHETIC_VARS_DECLAR.equals(ref.getNode().getStaticSourceFile().getName())));
	}
	...
	void fillNamespaceReferences() {
		for (com.google.javascript.jscomp.SymbolTable.Symbol symbol : getAllSymbolsSorted()) {
			...
			com.google.javascript.jscomp.SymbolTable.Symbol root = symbol.scope.getSlot(qName.substring(0, rootIndex));
			if (root == null) {
				continue;
			}
			for (com.google.javascript.jscomp.SymbolTable.Reference ref : getReferences(symbol)) {
				...
				while (currentNode.isGetProp()) {
					...
					if (name != null) {
						com.google.javascript.jscomp.SymbolTable.Symbol namespace = root.scope.getSlot(name);
	...
	void pruneOrphanedNames() {
		nextSymbol : for (com.google.javascript.jscomp.SymbolTable.Symbol s : getAllSymbolsSorted()) {
			...
			while ((-1) != (dot = currentName.lastIndexOf('.'))) {
				...
				com.google.javascript.jscomp.SymbolTable.Symbol owner = s.scope.getSlot(currentName);
	...
	private class PropertyRefCollector extends com.google.javascript.jscomp.NodeTraversal.AbstractPostOrderCallback implements com.google.javascript.jscomp.CompilerPass {
		...
		private void maybeDefineReference(com.google.javascript.rhino.Node n, java.lang.String propName, com.google.javascript.jscomp.SymbolTable.Symbol ownerSymbol) {
		...
		private void tryDefineLexicalPropRef(java.lang.String name, com.google.javascript.rhino.Node n) {
			if (name != null) {
				com.google.javascript.jscomp.SymbolTable.Symbol lexicalSym = getEnclosingScope(n).getSlot(name);
				if (lexicalSym != null) {
		...
		private void maybeDefineTypedReference(com.google.javascript.rhino.Node n, java.lang.String propName, com.google.javascript.rhino.jstype.JSType owner) {
		...
		public void visit(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
			if (n.isGetProp()) {
				...
				if ((com.google.javascript.jscomp.NodeUtil.isObjectLitKey(n, parent)) && ((n.getType()) == (com.google.javascript.rhino.Token.STRING))) {
					com.google.javascript.rhino.jstype.JSType owner = parent.getJSType();
					if ((owner == null) || (owner.isUnknownType())) {
						tryDefineLexicalPropRef(com.google.javascript.jscomp.NodeUtil.getBestLValueName(n), n);
						return ;
					}
