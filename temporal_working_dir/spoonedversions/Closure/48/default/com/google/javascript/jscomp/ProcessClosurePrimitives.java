...
class ProcessClosurePrimitives extends com.google.javascript.jscomp.NodeTraversal.AbstractPostOrderCallback implements com.google.javascript.jscomp.HotSwapCompilerPass {
	...
	com.google.javascript.jscomp.PreprocessorSymbolTable preprocessorSymbolTable, com.google.javascript.jscomp.CheckLevel requiresLevel, boolean rewriteNewDateGoogNow) {
	...
	public void hotSwapScript(com.google.javascript.rhino.Node scriptRoot, com.google.javascript.rhino.Node originalRoot) {
		com.google.javascript.jscomp.ProcessClosurePrimitives.this.compiler.process(com.google.javascript.jscomp.ProcessClosurePrimitives.this);
	}
	...
	public void visit(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
		switch (n.getType()) {
			...
			case com.google.javascript.rhino.Token.GETPROP :
				if ((((n.getFirstChild().isName()) && ((parent.getType()) != (com.google.javascript.rhino.Token.CALL))) && ((parent.getType()) != (com.google.javascript.rhino.Token.ASSIGN))) && ("goog.base".equals(n.getQualifiedName()))) {
	...
	private void handleTypedefDefinition(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
	...
	private class ProvidedName {
		...
		void addDefinition(com.google.javascript.rhino.Node node, com.google.javascript.jscomp.JSModule module) {
			com.google.common.base.Preconditions.checkArgument((((com.google.javascript.jscomp.NodeUtil.isExpressionNode(node)) || (node.isFunction())) || (node.isVar())));
		...
		void replace() {
			...
			if (((candidateDefinition) != null) && ((explicitNode) != null)) {
				...
				compiler.reportCodeChange();
				replacementNode = candidateDefinition;
				if ((com.google.javascript.jscomp.NodeUtil.isExpressionNode(candidateDefinition)) && (!(candidateDefinition.getFirstChild().isQualifiedName()))) {
