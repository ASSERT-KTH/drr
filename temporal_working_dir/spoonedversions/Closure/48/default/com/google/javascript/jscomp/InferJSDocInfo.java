	...
	public void visit(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
		...
		switch (n.getType()) {
			case com.google.javascript.rhino.Token.NAME :
				...
				if ((((parent.getType()) != (com.google.javascript.rhino.Token.VAR)) && (!(com.google.javascript.jscomp.NodeUtil.isFunctionDeclaration(parent)))) && (!((parent.isAssign()) && (n == (parent.getFirstChild()))))) {
					return ;
				}
