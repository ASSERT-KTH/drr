...
class DevirtualizePrototypeMethods implements com.google.javascript.jscomp.OptimizeCalls.CallGraphCompilerPass , com.google.javascript.jscomp.SpecializationAwareCompilerPass {
	...
	private static boolean isPrototypeMethodDefinition(com.google.javascript.rhino.Node node) {
		...
		if ((functionNode == null) || (!(com.google.javascript.jscomp.NodeUtil.isFunction(functionNode)))) {
			return false;
		}
		...
		return (com.google.javascript.jscomp.NodeUtil.isGetProp(nameNode)) && (nameNode.getLastChild().getString().equals("prototype"));
	}
	...
	private boolean isEligibleDefinition(com.google.javascript.jscomp.SimpleDefinitionFinder defFinder, com.google.javascript.jscomp.DefinitionSite definitionSite) {
		...
		if ((lValue == null) || (!(com.google.javascript.jscomp.NodeUtil.isGetProp(lValue)))) {
			return false;
		}
	...
	private void rewriteCallSites(com.google.javascript.jscomp.SimpleDefinitionFinder defFinder, com.google.javascript.jscomp.DefinitionsRemover.Definition definition, java.lang.String newMethodName) {
		...
		for (com.google.javascript.jscomp.UseSite site : useSites) {
			...
			parent.addChildToFront(com.google.javascript.rhino.Node.newString(com.google.javascript.rhino.Token.NAME, newMethodName).copyInformationFrom(node));
			com.google.common.base.Preconditions.checkState(((parent.getType()) == (com.google.javascript.rhino.Token.CALL)));
	...
	private void rewriteDefinition(com.google.javascript.rhino.Node node, java.lang.String newMethodName) {
		...
		com.google.javascript.rhino.Node newNameNode = com.google.javascript.rhino.Node.newString(com.google.javascript.rhino.Token.NAME, newMethodName).copyInformationFrom(parent.getFirstChild());
		if ((specializationState) != null) {
		...
		block.replaceChild(expr, new com.google.javascript.rhino.Node(com.google.javascript.rhino.Token.VAR, newNameNode));
		java.lang.String self = newMethodName + "$self";
		com.google.javascript.rhino.Node argList = functionNode.getFirstChild().getNext();
		argList.addChildToFront(com.google.javascript.rhino.Node.newString(com.google.javascript.rhino.Token.NAME, self).copyInformationFrom(functionNode));
	...
	private void fixFunctionType(com.google.javascript.rhino.Node functionNode) {
		com.google.javascript.rhino.jstype.FunctionType type = ((com.google.javascript.rhino.jstype.FunctionType) (functionNode.getJSType()));
		if (type != null) {
	...
	private void replaceReferencesToThis(com.google.javascript.rhino.Node node, java.lang.String name) {
		...
		for (com.google.javascript.rhino.Node child : node.children()) {
			if (com.google.javascript.jscomp.NodeUtil.isThis(child)) {
				com.google.javascript.rhino.Node newName = com.google.javascript.rhino.Node.newString(com.google.javascript.rhino.Token.NAME, name);
