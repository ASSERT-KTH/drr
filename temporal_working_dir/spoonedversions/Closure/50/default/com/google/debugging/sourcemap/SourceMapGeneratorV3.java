...
public class SourceMapGeneratorV3 implements com.google.debugging.sourcemap.SourceMapGenerator {
	...
	public void appendIndexMapTo(java.lang.Appendable out, java.lang.String name, java.util.List<com.google.debugging.sourcemap.SourceMapSection> sections) throws java.io.IOException {
		...
		for (com.google.debugging.sourcemap.SourceMapSection section : sections) {
			...
			if ((section.getSectionType()) == (com.google.debugging.sourcemap.SourceMapSection.SectionType.URL)) {
				com.google.debugging.sourcemap.SourceMapGeneratorV3.appendField(out, "url", com.google.debugging.sourcemap.SourceMapGeneratorV3.escapeString(section.getSectionValue()));
			}else
				if ((section.getSectionType()) == (com.google.debugging.sourcemap.SourceMapSection.SectionType.MAP)) {
					com.google.debugging.sourcemap.SourceMapGeneratorV3.appendField(out, "map", section.getSectionValue());
				}else {
					throw new java.io.IOException("Unexpected section type");
				}
