...
public final class TestErrorReporter extends junit.framework.Assert implements com.google.javascript.jscomp.mozilla.rhino.ErrorReporter {
	...
	public com.google.javascript.jscomp.mozilla.rhino.EvaluatorException runtimeError(java.lang.String message, java.lang.String sourceName, int line, java.lang.String lineSource, int lineOffset) {
		return new com.google.javascript.jscomp.mozilla.rhino.EvaluatorException(("JSCompiler test code: " + message));
	}
