...
public class ClosureCodingConvention extends com.google.javascript.jscomp.DefaultCodingConvention {
	...
	private static final java.lang.String TYPEDEF_NAME = "goog.typedef";
	...
	public void applySubclassRelationship(com.google.javascript.rhino.jstype.FunctionType parentCtor, com.google.javascript.rhino.jstype.FunctionType childCtor, com.google.javascript.jscomp.CodingConvention.SubclassType type) {
		if (type == (com.google.javascript.jscomp.CodingConvention.SubclassType.INHERITS)) {
			childCtor.defineDeclaredProperty("superClass_", parentCtor.getPrototype(), false, parentCtor.getSource());
			childCtor.getPrototype().defineDeclaredProperty("constructor", childCtor, false, parentCtor.getSource());
		}
	}
	...
	public java.util.List<java.lang.String> identifyTypeDeclarationCall(com.google.javascript.rhino.Node n) {
		...
		if (("goog.addDependency".equals(callName.getQualifiedName())) && ((n.getChildCount()) >= 3)) {
			...
			if (((typeArray.getType()) == (com.google.javascript.rhino.Token.ARRAYLIT)) && (!(com.google.javascript.jscomp.NodeUtil.isSparseArray(typeArray)))) {
	...
	@java.lang.Override
	public java.lang.String identifyTypeDefAssign(com.google.javascript.rhino.Node n) {
		com.google.javascript.rhino.Node firstChild = n.getFirstChild();
		int type = n.getType();
		if (type == (com.google.javascript.rhino.Token.ASSIGN)) {
			if (com.google.javascript.jscomp.ClosureCodingConvention.TYPEDEF_NAME.equals(n.getLastChild().getQualifiedName())) {
				return firstChild.getQualifiedName();
			}
		}else
			if ((type == (com.google.javascript.rhino.Token.VAR)) && (firstChild.hasChildren())) {
				if (com.google.javascript.jscomp.ClosureCodingConvention.TYPEDEF_NAME.equals(firstChild.getFirstChild().getQualifiedName())) {
	...
	public void applySingletonGetter(com.google.javascript.rhino.jstype.FunctionType functionType, com.google.javascript.rhino.jstype.FunctionType getterType, com.google.javascript.rhino.jstype.ObjectType objectType) {
		functionType.defineDeclaredProperty("getInstance", getterType, false, functionType.getSource());
