...
class NamedType extends com.google.javascript.rhino.jstype.ProxyObjectType {
	...
	private void resolveViaProperties(com.google.javascript.rhino.ErrorReporter t, com.google.javascript.rhino.jstype.StaticScope<com.google.javascript.rhino.jstype.JSType> enclosing) {
		...
		if ((value instanceof com.google.javascript.rhino.jstype.FunctionType) && ((value.isConstructor()) || (value.isInterface()))) {
			com.google.javascript.rhino.jstype.FunctionType functionType = ((com.google.javascript.rhino.jstype.FunctionType) (value));
	...
	private void handleTypeCycle(com.google.javascript.rhino.ErrorReporter t) {
		...
		t.warning(("Cycle detected in inheritance chain of type " + (reference)), sourceName, lineno, null, charno);
		setResolvedTypeInternal(getReferencedType());
	}
		...
		if (registry.isLastGeneration()) {
			...
			if ((!beForgiving) && (registry.isLastGeneration())) {
				...
				if (isForwardDeclared) {
					...
					setReferencedType(registry.getNativeObjectType(com.google.javascript.rhino.jstype.JSTypeNative.CHECKED_UNKNOWN_TYPE));
				}
