...
public final class NodeUtil {
	...
	static com.google.javascript.rhino.jstype.TernaryValue getBooleanValue(com.google.javascript.rhino.Node n) {
		switch (n.getType()) {
			...
			case com.google.javascript.rhino.Token.NOT :
				return com.google.javascript.jscomp.NodeUtil.getBooleanValue(n.getLastChild()).not();
	...
	static java.lang.String getStringValue(com.google.javascript.rhino.Node n) {
		switch (n.getType()) {
			...
			case com.google.javascript.rhino.Token.VOID :
				return "undefined";
			case com.google.javascript.rhino.Token.NOT :
				com.google.javascript.rhino.jstype.TernaryValue child = com.google.javascript.jscomp.NodeUtil.getBooleanValue(n.getFirstChild());
	...
	static java.lang.String getArrayElementStringValue(com.google.javascript.rhino.Node n) {
		return com.google.javascript.jscomp.NodeUtil.isNullOrUndefined(n) ? "" : com.google.javascript.jscomp.NodeUtil.getStringValue(n);
	}
	...
	static java.lang.String arrayToString(com.google.javascript.rhino.Node literal) {
		...
		int[] skipIndexes = ((int[]) (literal.getProp(com.google.javascript.rhino.Node.SKIP_INDEXES_PROP)));
	...
	static boolean isSparseArray(com.google.javascript.rhino.Node node) {
		com.google.common.base.Preconditions.checkArgument(com.google.javascript.jscomp.NodeUtil.isArrayLiteral(node));
		int[] skipList = ((int[]) (node.getProp(com.google.javascript.rhino.Node.SKIP_INDEXES_PROP)));
