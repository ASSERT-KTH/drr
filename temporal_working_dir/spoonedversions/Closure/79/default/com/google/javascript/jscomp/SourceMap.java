...
ALL {
	...
	public void addMapping(com.google.javascript.rhino.Node node, com.google.javascript.jscomp.sourcemap.FilePosition outputStartPosition, com.google.javascript.jscomp.sourcemap.FilePosition outputEndPosition) {
		...
		generator.addMapping(sourceFile, originalName, new com.google.javascript.jscomp.sourcemap.FilePosition(node.getLineno(), node.getCharno()), outputStartPosition, outputEndPosition);
	}
