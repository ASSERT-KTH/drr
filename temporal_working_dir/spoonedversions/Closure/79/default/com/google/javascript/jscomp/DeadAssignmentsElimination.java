		...
		while (n != exprRoot) {
			for (com.google.javascript.rhino.Node sibling = n.getNext(); sibling != null; sibling = sibling.getNext()) {
				if (!(com.google.javascript.jscomp.ControlFlowGraph.isEnteringNewCfgNode(sibling))) {
					com.google.javascript.jscomp.DeadAssignmentsElimination.VariableLiveness state = isVariableReadBeforeKill(sibling, variable);
	...
	private com.google.javascript.jscomp.DeadAssignmentsElimination.VariableLiveness isVariableReadBeforeKill(com.google.javascript.rhino.Node n, java.lang.String variable) {
		if ((com.google.javascript.jscomp.NodeUtil.isName(n)) && (variable.equals(n.getString()))) {
			if (com.google.javascript.jscomp.NodeUtil.isLhs(n, n.getParent())) {
				com.google.common.base.Preconditions.checkState(((n.getParent().getType()) == (com.google.javascript.rhino.Token.ASSIGN)));
