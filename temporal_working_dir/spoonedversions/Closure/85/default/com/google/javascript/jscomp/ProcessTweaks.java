...
REGISTER_BOOLEAN("goog.tweak.registerBoolean","boolean",com.google.javascript.rhino.Token.TRUE,com.google.javascript.rhino.Token.FALSE), REGISTER_NUMBER("goog.tweak.registerNumber","number",com.google.javascript.rhino.Token.NUMBER), REGISTER_STRING("goog.tweak.registerString","string",com.google.javascript.rhino.Token.STRING), OVERRIDE_DEFAULT_VALUE("goog.tweak.overrideDefaultValue"), GET_BOOLEAN("goog.tweak.getBoolean",com.google.javascript.jscomp.ProcessTweaks.TweakFunction.REGISTER_BOOLEAN), GET_NUMBER("goog.tweak.getNumber",com.google.javascript.jscomp.ProcessTweaks.TweakFunction.REGISTER_NUMBER), GET_STRING("goog.tweak.getString",com.google.javascript.jscomp.ProcessTweaks.TweakFunction.REGISTER_STRING);
	...
	ProcessTweaks(com.google.javascript.jscomp.AbstractCompiler compiler) {
	...
	private java.util.Map<java.lang.String, com.google.javascript.jscomp.ProcessTweaks.TweakInfo> collectTweaks(com.google.javascript.rhino.Node root) {
	...
	private final class TweakInfo {
		...
		void addRegisterCall(java.lang.String sourceName, com.google.javascript.jscomp.ProcessTweaks.TweakFunction tweakFunc, com.google.javascript.rhino.Node callNode, com.google.javascript.rhino.Node defaultValueNode) {
			...
			if ((com.google.javascript.jscomp.ProcessTweaks.TweakInfo.this.defaultValueNode) == null) {
