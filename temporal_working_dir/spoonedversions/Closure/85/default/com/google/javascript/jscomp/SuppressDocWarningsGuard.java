...
class SuppressDocWarningsGuard extends com.google.javascript.jscomp.WarningsGuard {
	...
	SuppressDocWarningsGuard(java.util.Map<java.lang.String, com.google.javascript.jscomp.DiagnosticGroup> suppressableGroups) {
		for (java.util.Map.Entry<java.lang.String, com.google.javascript.jscomp.DiagnosticGroup> entry : suppressableGroups.entrySet()) {
		...
		if (node != null) {
			for (com.google.javascript.rhino.Node current = node; current != null; current = current.getParent()) {
				...
				if (type == (com.google.javascript.rhino.Token.FUNCTION)) {
					info = com.google.javascript.jscomp.NodeUtil.getFunctionInfo(current);
				}else
