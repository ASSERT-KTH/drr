...
public class Compiler extends com.google.javascript.jscomp.AbstractCompiler {
	...
	public boolean acceptEcmaScript5() {
		return (options.languageIn) == (com.google.javascript.jscomp.CompilerOptions.LanguageMode.ECMASCRIPT5);
	}

	@java.lang.Override
	com.google.javascript.jscomp.parsing.Config getParserConfig() {
		if ((parserConfig) == null) {
			parserConfig = com.google.javascript.jscomp.parsing.ParserRunner.createConfig(isIdeMode(), acceptEcmaScript5());
		}
		return parserConfig;
	}
