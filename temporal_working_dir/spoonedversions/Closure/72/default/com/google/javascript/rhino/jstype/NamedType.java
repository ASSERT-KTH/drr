...
class NamedType extends com.google.javascript.rhino.jstype.ProxyObjectType {
	...
	boolean defineProperty(java.lang.String propertyName, com.google.javascript.rhino.jstype.JSType type, boolean inferred, boolean inExterns, com.google.javascript.rhino.Node propertyNode) {
		if (!(isResolved())) {
			...
			propertyContinuations.add(new com.google.javascript.rhino.jstype.NamedType.PropertyContinuation(propertyName, type, inferred, inExterns, propertyNode));
			return true;
		}else {
	...
	private static final class PropertyContinuation {
		...
		private PropertyContinuation(java.lang.String propertyName, com.google.javascript.rhino.jstype.JSType type, boolean inferred, boolean inExterns, com.google.javascript.rhino.Node propertyNode) {
		...
		void commit(com.google.javascript.rhino.jstype.ObjectType target) {
			target.defineProperty(propertyName, type, inferred, inExterns, propertyNode);
		}
	}
}
