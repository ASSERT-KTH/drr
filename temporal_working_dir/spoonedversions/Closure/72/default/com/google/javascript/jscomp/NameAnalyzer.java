...
REGULAR, INHERITANCE;	}
	...
	private class PrototypeSetNode extends com.google.javascript.jscomp.NameAnalyzer.JsNameRefNode {
		PrototypeSetNode(com.google.javascript.jscomp.NameAnalyzer.JsName name, com.google.javascript.rhino.Node parent) {
			...
			com.google.common.base.Preconditions.checkState(((parent.getType()) == (com.google.javascript.rhino.Token.ASSIGN)));
		}
	...
	private class ClassDefiningFunctionNode extends com.google.javascript.jscomp.NameAnalyzer.SpecialReferenceNode {
		ClassDefiningFunctionNode(com.google.javascript.jscomp.NameAnalyzer.JsName name, com.google.javascript.rhino.Node node, com.google.javascript.rhino.Node parent, com.google.javascript.rhino.Node gramps) {
			...
			com.google.common.base.Preconditions.checkState(((node.getType()) == (com.google.javascript.rhino.Token.CALL)));
		}
	...
	private class FindDependencyScopes extends com.google.javascript.jscomp.NodeTraversal.AbstractPostOrderCallback {
		public void visit(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
			...
			if ((n.getType()) == (com.google.javascript.rhino.Token.ASSIGN)) {
				...
				if (ns != null) {
					if (((parent.getType()) == (com.google.javascript.rhino.Token.FOR)) && (!(com.google.javascript.jscomp.NodeUtil.isForIn(parent)))) {
	...
	private class FindDeclarationsAndSetters extends com.google.javascript.jscomp.NodeTraversal.AbstractPostOrderCallback {
		...
		private void recordSet(java.lang.String name, com.google.javascript.rhino.Node node) {
			...
			if ((node.getType()) == (com.google.javascript.rhino.Token.GETELEM)) {
		...
		private void recordPrototypeSet(java.lang.String className, java.lang.String prototypeProperty, com.google.javascript.rhino.Node node) {
			com.google.javascript.jscomp.NameAnalyzer.JsName name = getName(className, false);
			if (name != null) {
	...
	private static final com.google.common.base.Predicate<com.google.javascript.rhino.Node> NON_LOCAL_RESULT_PREDICATE = new com.google.common.base.Predicate<com.google.javascript.rhino.Node>() {
		...
		public boolean apply(com.google.javascript.rhino.Node input) {
			if ((input.getType()) == (com.google.javascript.rhino.Token.CALL)) {
				return false;
			}
			return true;
		}
	...
	private class FindReferences implements com.google.javascript.jscomp.NodeTraversal.Callback {
		...
		private void addSimplifiedExpression(com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
			if ((parent.getType()) == (com.google.javascript.rhino.Token.VAR)) {
				...
				if (((n.getType()) == (com.google.javascript.rhino.Token.ASSIGN)) && ((((parent.getType()) == (com.google.javascript.rhino.Token.EXPR_RESULT)) || ((parent.getType()) == (com.google.javascript.rhino.Token.FOR))) || ((parent.getType()) == (com.google.javascript.rhino.Token.RETURN)))) {
					for (com.google.javascript.rhino.Node child : n.children()) {
						addSimplifiedChildren(child);
					}
				}else
					if (((n.getType()) == (com.google.javascript.rhino.Token.CALL)) && ((parent.getType()) == (com.google.javascript.rhino.Token.EXPR_RESULT))) {
		...
		public boolean shouldTraverse(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
			...
			if ((n.getType()) == (com.google.javascript.rhino.Token.FOR)) {
			...
			if (((((parent.getType()) == (com.google.javascript.rhino.Token.VAR)) || ((parent.getType()) == (com.google.javascript.rhino.Token.EXPR_RESULT))) || ((parent.getType()) == (com.google.javascript.rhino.Token.RETURN))) || ((parent.getType()) == (com.google.javascript.rhino.Token.THROW))) {
				addSimplifiedExpression(n, parent);
			}
			if (((((((parent.getType()) == (com.google.javascript.rhino.Token.IF)) || ((parent.getType()) == (com.google.javascript.rhino.Token.WHILE))) || ((parent.getType()) == (com.google.javascript.rhino.Token.WITH))) || ((parent.getType()) == (com.google.javascript.rhino.Token.SWITCH))) || ((parent.getType()) == (com.google.javascript.rhino.Token.CASE))) && ((parent.getFirstChild()) == n)) {
				addAllChildren(n);
			}
			if (((parent.getType()) == (com.google.javascript.rhino.Token.DO)) && ((parent.getLastChild()) == n)) {
				addAllChildren(n);
			}
			return true;
		}
		...
		public void visit(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
			if (!((com.google.javascript.jscomp.NodeUtil.isName(n)) || ((com.google.javascript.jscomp.NodeUtil.isGet(n)) && (!(com.google.javascript.jscomp.NodeUtil.isGetProp(parent)))))) {
				return ;
			}
			...
			if (com.google.javascript.jscomp.NodeUtil.isLhs(n, parent)) {
				if (referring != null) {
			...
			if (nodesToKeep.contains(n)) {
				...
				if (referring != null) {
					...
					for (com.google.javascript.rhino.Node ancestor : n.getAncestors()) {
						if ((com.google.javascript.jscomp.NodeUtil.isAssignmentOp(ancestor)) || (com.google.javascript.jscomp.NodeUtil.isFunction(ancestor))) {
							recordReference(com.google.javascript.jscomp.NameAnalyzer.WINDOW, name, com.google.javascript.jscomp.NameAnalyzer.RefType.REGULAR);
							break;
						}
					}
		...
		private boolean maybeHiddenAlias(java.lang.String name, com.google.javascript.rhino.Node n) {
			...
			if (com.google.javascript.jscomp.NodeUtil.isLhs(n, parent)) {
				com.google.javascript.rhino.Node rhs = (parent.getType()) == (com.google.javascript.rhino.Token.VAR) ? n.getFirstChild() : parent.getLastChild();
		...
		private boolean maybeRecordAlias(java.lang.String name, com.google.javascript.rhino.Node parent, com.google.javascript.jscomp.NameAnalyzer.NameInformation referring, java.lang.String referringName) {
			if (((((parent.getType()) == (com.google.javascript.rhino.Token.NAME)) || ((parent.getType()) == (com.google.javascript.rhino.Token.ASSIGN))) && (referring != null)) && ((scopes.get(parent)) == referring)) {
	...
	private com.google.javascript.jscomp.NameAnalyzer.NameInformation createNameInformation(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
		...
		while (true) {
			if (com.google.javascript.jscomp.NodeUtil.isGet(rootNameNode)) {
				...
				if ((rootNameNode.getType()) == (com.google.javascript.rhino.Token.GETPROP)) {
				...
				if (com.google.javascript.jscomp.NodeUtil.isObjectLitKey(rootNameNode, rootNameNode.getParent())) {
					...
					if ((objLitParent.getType()) == (com.google.javascript.rhino.Token.ASSIGN)) {
						rootNameNode = objLitParent.getFirstChild();
					}else
						if ((objLitParent.getType()) == (com.google.javascript.rhino.Token.NAME)) {
							rootNameNode = objLitParent;
						}else
							if ((objLitParent.getType()) == (com.google.javascript.rhino.Token.STRING)) {
								rootNameNode = objLitParent;
							}else {
								return null;
							}
		...
		if ((com.google.javascript.jscomp.NodeUtil.isCall(parent)) && (t.inGlobalScope())) {
		...
		switch (rootNameNode.getType()) {
			case com.google.javascript.rhino.Token.NAME :
				if ((((!bNameWasShortened) && ((n.getType()) == (com.google.javascript.rhino.Token.GETPROP))) && ((parent.getType()) == (com.google.javascript.rhino.Token.ASSIGN))) && ("prototype".equals(n.getLastChild().getString()))) {
	...
	private com.google.javascript.jscomp.NameAnalyzer.NameInformation getEnclosingFunctionDependencyScope(com.google.javascript.jscomp.NodeTraversal t) {
		...
		if (parent != null) {
			while ((parent.getType()) == (com.google.javascript.rhino.Token.HOOK)) {
			...
			if ((parent.getType()) == (com.google.javascript.rhino.Token.ASSIGN)) {
				...
				if ((gramp != null) && ((gramp.getType()) == (com.google.javascript.rhino.Token.EXPR_RESULT))) {
...
TRUE, FALSE, BOTH;	}
	...
	private void replaceWithRhs(com.google.javascript.rhino.Node parent, com.google.javascript.rhino.Node n) {
		if (valueConsumedByParent(n, parent)) {
			...
			if (((n.getType()) == (com.google.javascript.rhino.Token.ASSIGN)) && ((parent.getType()) != (com.google.javascript.rhino.Token.FOR))) {
	...
	private void replaceTopLevelExpressionWithRhs(com.google.javascript.rhino.Node parent, com.google.javascript.rhino.Node n) {
		...
		switch (n.getType()) {
			...
			case com.google.javascript.rhino.Token.VAR :
				break;
			case com.google.javascript.rhino.Token.ASSIGN :
				com.google.common.base.Preconditions.checkArgument(((parent.getType()) == (com.google.javascript.rhino.Token.FOR)), ("Unsupported assignment in replaceWithRhs. parent: " + (com.google.javascript.rhino.Token.name(parent.getType()))));
				break;
			default :
		...
		if ((parent.getType()) == (com.google.javascript.rhino.Token.FOR)) {
	...
	private com.google.javascript.rhino.Node collapseReplacements(java.util.List<com.google.javascript.rhino.Node> replacements) {
		...
		for (com.google.javascript.rhino.Node rep : replacements) {
			if ((rep.getType()) == (com.google.javascript.rhino.Token.EXPR_RESULT)) {
