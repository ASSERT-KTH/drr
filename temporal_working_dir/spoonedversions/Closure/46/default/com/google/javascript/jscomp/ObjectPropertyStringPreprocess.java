...
public class ObjectPropertyStringPreprocess implements com.google.javascript.jscomp.CompilerPass {
	...
	public void process(com.google.javascript.rhino.Node externs, com.google.javascript.rhino.Node root) {
		addExternDeclaration(externs, new com.google.javascript.rhino.Node(com.google.javascript.rhino.Token.VAR, com.google.javascript.rhino.Node.newString(com.google.javascript.rhino.Token.NAME, com.google.javascript.jscomp.ObjectPropertyStringPreprocess.EXTERN_OBJECT_PROPERTY_STRING)));
	...
	private void addExternDeclaration(com.google.javascript.rhino.Node externs, com.google.javascript.rhino.Node declarationStmt) {
		...
		if ((script == null) || (!(script.isScript()))) {
			script = new com.google.javascript.rhino.Node(com.google.javascript.rhino.Token.SCRIPT);
