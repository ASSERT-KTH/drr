	...
	private void extractInstance(com.google.javascript.jscomp.ExtractPrototypeMemberDeclarations.ExtractionInstance instance) {
		...
		if ((pattern) == (com.google.javascript.jscomp.ExtractPrototypeMemberDeclarations.Pattern.USE_GLOBAL_TEMP)) {
			...
			if ((pattern) == (com.google.javascript.jscomp.ExtractPrototypeMemberDeclarations.Pattern.USE_ANON_FUNCTION)) {
				...
				com.google.javascript.rhino.Node func = new com.google.javascript.rhino.Node(com.google.javascript.rhino.Token.FUNCTION, com.google.javascript.rhino.Node.newString(com.google.javascript.rhino.Token.NAME, ""), new com.google.javascript.rhino.Node(com.google.javascript.rhino.Token.PARAM_LIST, com.google.javascript.rhino.Node.newString(com.google.javascript.rhino.Token.NAME, prototypeAlias)), block);
				com.google.javascript.rhino.Node call = new com.google.javascript.rhino.Node(com.google.javascript.rhino.Token.CALL, func, com.google.javascript.jscomp.NodeUtil.newQualifiedNameNode(compiler.getCodingConvention(), (className + ".prototype"), instance.parent, (className + ".prototype")));
