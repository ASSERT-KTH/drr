...
class AliasExternals implements com.google.javascript.jscomp.CompilerPass {
	...
	public void process(com.google.javascript.rhino.Node externs, com.google.javascript.rhino.Node root) {
		...
		com.google.common.base.Preconditions.checkState(defaultRoot.isScript());
	...
	private void addMutatorFunction(java.lang.String propName, com.google.javascript.rhino.Node root) {
		...
		com.google.javascript.rhino.Node fnNode = com.google.javascript.rhino.IR.function(com.google.javascript.rhino.IR.name(functionName), com.google.javascript.rhino.IR.paramList(com.google.javascript.rhino.IR.name(localPropName), com.google.javascript.rhino.IR.name(localValueName)), com.google.javascript.rhino.IR.block(com.google.javascript.rhino.IR.returnNode(com.google.javascript.rhino.IR.assign(com.google.javascript.rhino.IR.getprop(com.google.javascript.rhino.IR.name(localPropName), com.google.javascript.rhino.IR.string(propName)), com.google.javascript.rhino.IR.name(localValueName)))));
		...
		public void visit(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
			if (n.isName()) {
				...
				if (global != null) {
					...
					if (((((com.google.javascript.jscomp.NodeUtil.isAssignmentOp(parent)) && isFirst) || ((parent.isNew()) && isFirst)) || (parent.isInc())) || (parent.isDec())) {
