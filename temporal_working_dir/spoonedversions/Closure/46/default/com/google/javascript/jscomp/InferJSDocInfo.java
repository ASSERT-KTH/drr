	...
	public void visit(com.google.javascript.jscomp.NodeTraversal t, com.google.javascript.rhino.Node n, com.google.javascript.rhino.Node parent) {
		...
		switch (n.getType()) {
			case com.google.javascript.rhino.Token.NAME :
				...
				if (((!(parent.isVar())) && (!(com.google.javascript.jscomp.NodeUtil.isFunctionDeclaration(parent)))) && (!((parent.isAssign()) && (n == (parent.getFirstChild()))))) {
					return ;
				}
			...
			case com.google.javascript.rhino.Token.GETPROP :
				if ((com.google.javascript.jscomp.NodeUtil.isExpressionNode(parent)) || ((parent.isAssign()) && ((parent.getFirstChild()) == n))) {
					docInfo = n.getJSDocInfo();
					if (docInfo == null) {
						docInfo = parent.getJSDocInfo();
					}
		...
		if (((objType.isConstructor()) || (objType.isEnumType())) || (objType.isInterface())) {
			if ((objType.hasReferenceName()) && (objType.getReferenceName().equals(qName))) {
				...
				if ((objType.isConstructor()) || (objType.isInterface())) {
					com.google.javascript.rhino.jstype.JSType.toMaybeFunctionType(objType).getInstanceType().setJSDocInfo(docInfo);
				}else
