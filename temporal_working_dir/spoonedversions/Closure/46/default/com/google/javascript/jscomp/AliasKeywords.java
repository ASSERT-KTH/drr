...
class AliasKeywords implements com.google.javascript.jscomp.CompilerPass {
	private class FindAliasableNodes extends com.google.javascript.jscomp.NodeTraversal.AbstractPostOrderCallback {
		...
		private void visitNameNode(com.google.javascript.rhino.Node n) {
			if (isAliasDefinition(n)) {
				throw new java.lang.IllegalStateException(("Existing alias definition for " + (com.google.javascript.rhino.Token.name(n.getType()))));
			}
		}
	}
	...
	private static com.google.javascript.rhino.Node createAliasFunctionNode(java.lang.String aliasName) {
		final java.lang.String PARAM_NAME = "jscomp_throw_param";
		return com.google.javascript.rhino.IR.function(com.google.javascript.rhino.IR.name(aliasName), com.google.javascript.rhino.IR.paramList(com.google.javascript.rhino.IR.name(PARAM_NAME)), com.google.javascript.rhino.IR.block(com.google.javascript.rhino.IR.throwNode(com.google.javascript.rhino.IR.name(PARAM_NAME))));
	}
