...
public class JsAst implements com.google.javascript.jscomp.SourceAst {
	...
	public JsAst(com.google.javascript.jscomp.SourceFile sourceFile) {
		com.google.javascript.jscomp.JsAst.this.inputId = new com.google.javascript.rhino.InputId(sourceFile.getName());
	...
	private void parse(com.google.javascript.jscomp.AbstractCompiler compiler) {
		try {
			com.google.javascript.jscomp.JsAst.logger_.fine(("Parsing: " + (sourceFile.getName())));
			com.google.javascript.jscomp.parsing.ParserRunner.ParseResult result = com.google.javascript.jscomp.parsing.ParserRunner.parse(sourceFile, sourceFile.getCode(), compiler.getParserConfig(), compiler.getDefaultErrorReporter(), com.google.javascript.jscomp.JsAst.logger_);
			root = result.ast;
