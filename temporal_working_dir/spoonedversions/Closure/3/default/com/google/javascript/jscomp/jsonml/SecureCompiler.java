...
public class SecureCompiler {
	...
	public void compile(com.google.javascript.jscomp.jsonml.JsonML source) {
		...
		module.add(input);
		com.google.javascript.jscomp.Result result = compiler.compileModules(com.google.common.collect.ImmutableList.<com.google.javascript.jscomp.SourceFile>of(), com.google.common.collect.ImmutableList.of(module), options);
