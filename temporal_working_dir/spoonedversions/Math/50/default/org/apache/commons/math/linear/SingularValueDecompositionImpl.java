...
public class SingularValueDecompositionImpl implements org.apache.commons.math.linear.SingularValueDecomposition {
	...
	public SingularValueDecompositionImpl(final org.apache.commons.math.linear.RealMatrix matrix) {
		...
		final int nu = org.apache.commons.math.util.FastMath.min(m, n);
		...
		final int nrt = org.apache.commons.math.util.FastMath.max(0, org.apache.commons.math.util.FastMath.min(((n) - 2), m));
		...
		while (p > 0) {
			...
			if (k == (p - 2)) {
				...
				for (ks = p - 1; ks >= k; ks--) {
					...
					final double t = (ks != p ? org.apache.commons.math.util.FastMath.abs(e[ks]) : 0.0) + (ks != (k + 1) ? org.apache.commons.math.util.FastMath.abs(e[(ks - 1)]) : 0.0);
	...
	public int getRank() {
		final double tol = ((m) * (singularValues[0])) * (org.apache.commons.math.linear.SingularValueDecompositionImpl.EPS);
		int r = 0;
	...
	public org.apache.commons.math.linear.DecompositionSolver getSolver() {
		return new org.apache.commons.math.linear.SingularValueDecompositionImpl.Solver(singularValues, getUT(), getV(), ((getRank()) == (m)));
	}
