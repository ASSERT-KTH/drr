...
public class ValueServer {
	...
	private double getNextDigest() {
		if (((empiricalDistribution) == null) || ((empiricalDistribution.getBinStats().size()) == 0)) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalStateException(org.apache.commons.math.exception.util.LocalizedFormats.DIGEST_NOT_INITIALIZED);
		}
	...
	private double getNextReplay() throws java.io.IOException {
		...
		if ((str = filePointer.readLine()) == null) {
			...
			resetReplayFile();
			if ((str = filePointer.readLine()) == null) {
				throw org.apache.commons.math.MathRuntimeException.createEOFException(org.apache.commons.math.exception.util.LocalizedFormats.URL_CONTAINS_NO_DATA, valuesFileURL);
			}
		}
