...
final class SaddlePointExpansion {
	private static double HALF_LOG_2_PI = 0.5 * (java.lang.Math.log(org.apache.commons.math.util.MathUtils.TWO_PI));
	...
	static double getStirlingError(double z) {
		...
		if (z < 15.0) {
			...
			if ((java.lang.Math.floor(z2)) == z2) {
				...
				ret = (((org.apache.commons.math.special.Gamma.logGamma((z + 1.0))) - ((z + 0.5) * (java.lang.Math.log(z)))) + z) - (org.apache.commons.math.distribution.SaddlePointExpansion.HALF_LOG_2_PI);
			}
		}else {
			double z2 = z * z;
