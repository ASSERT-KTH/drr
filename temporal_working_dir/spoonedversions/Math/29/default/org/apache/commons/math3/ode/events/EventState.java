...
public class EventState {
	...
	public void reinitializeBegin(final org.apache.commons.math3.ode.sampling.StepInterpolator interpolator) {
	...
	public boolean evaluateStep(final org.apache.commons.math3.ode.sampling.StepInterpolator interpolator) throws org.apache.commons.math3.exception.ConvergenceException {
		...
		for (int i = 0; i < n; ++i) {
			...
			if ((g0Positive) ^ (gb >= 0)) {
				...
				if (((!(java.lang.Double.isNaN(previousEventTime))) && ((org.apache.commons.math3.util.FastMath.abs((root - ta))) <= (convergence))) && ((org.apache.commons.math3.util.FastMath.abs((root - (previousEventTime)))) <= (convergence))) {
					...
					if ((java.lang.Double.isNaN(previousEventTime)) || ((org.apache.commons.math3.util.FastMath.abs(((previousEventTime) - root))) > (convergence))) {
