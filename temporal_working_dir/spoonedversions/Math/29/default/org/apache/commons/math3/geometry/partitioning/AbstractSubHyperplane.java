...
public abstract class AbstractSubHyperplane<S extends org.apache.commons.math3.geometry.Space, T extends org.apache.commons.math3.geometry.Space> implements org.apache.commons.math3.geometry.partitioning.SubHyperplane<S> {
	...
	public org.apache.commons.math3.geometry.partitioning.AbstractSubHyperplane<S, T> applyTransform(final org.apache.commons.math3.geometry.partitioning.Transform<S, T> transform) {
		...
		final org.apache.commons.math3.geometry.partitioning.BSPTree<T> tTree = recurseTransform(remainingRegion.getTree(false), tHyperplane, transform);
		return buildNew(tHyperplane, remainingRegion.buildNew(tTree));
	}

	private org.apache.commons.math3.geometry.partitioning.BSPTree<T> recurseTransform(final org.apache.commons.math3.geometry.partitioning.BSPTree<T> node, final org.apache.commons.math3.geometry.partitioning.Hyperplane<S> transformed, final org.apache.commons.math3.geometry.partitioning.Transform<S, T> transform) {
		if ((node.getCut()) == null) {
			return new org.apache.commons.math3.geometry.partitioning.BSPTree<T>(node.getAttribute());
		}
		@java.lang.SuppressWarnings(value = "unchecked")
		...
		if (attribute != null) {
			...
			attribute = new org.apache.commons.math3.geometry.partitioning.BoundaryAttribute<T>(tPO, tPI);
		}
		return new org.apache.commons.math3.geometry.partitioning.BSPTree<T>(transform.apply(node.getCut(), hyperplane, transformed), recurseTransform(node.getPlus(), transformed, transform), recurseTransform(node.getMinus(), transformed, transform), attribute);
	}
