...
public class Gaussian implements org.apache.commons.math3.analysis.DifferentiableUnivariateFunction {
	...
	public org.apache.commons.math3.analysis.UnivariateFunction derivative() {
		return new org.apache.commons.math3.analysis.UnivariateFunction() {
			public double value(double x) {
				...
				final double g = org.apache.commons.math3.analysis.function.Gaussian.value(diff, norm, i2s2);
				if (g == 0) {
					return 0;
				}else {
