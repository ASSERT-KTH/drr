...
public class SmoothingPolynomialBicubicSplineInterpolator extends org.apache.commons.math3.analysis.interpolation.BicubicSplineInterpolator {
	private final org.apache.commons.math3.optimization.fitting.PolynomialFitter xFitter;

	private final org.apache.commons.math3.optimization.fitting.PolynomialFitter yFitter;
	...
	public SmoothingPolynomialBicubicSplineInterpolator(int xDegree, int yDegree) {
		xFitter = new org.apache.commons.math3.optimization.fitting.PolynomialFitter(xDegree, new org.apache.commons.math3.optimization.general.GaussNewtonOptimizer(false));
		yFitter = new org.apache.commons.math3.optimization.fitting.PolynomialFitter(yDegree, new org.apache.commons.math3.optimization.general.GaussNewtonOptimizer(false));
	}
