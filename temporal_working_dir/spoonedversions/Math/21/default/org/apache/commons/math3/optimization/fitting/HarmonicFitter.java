...
public class HarmonicFitter extends org.apache.commons.math3.optimization.fitting.CurveFitter<org.apache.commons.math3.analysis.function.HarmonicOscillator.Parametric> {
	...
	public static class ParameterGuesser {
		...
		private double[] guessAOmega(org.apache.commons.math3.optimization.fitting.WeightedObservedPoint[] observations) {
		...
		private double guessPhi(org.apache.commons.math3.optimization.fitting.WeightedObservedPoint[] observations) {
			double fcMean = 0;
			double fsMean = 0;
			double currentX = observations[0].getX();
			double currentY = observations[0].getY();
