...
public abstract class AbstractFieldMatrix<T extends org.apache.commons.math3.FieldElement<T>> implements org.apache.commons.math3.linear.FieldMatrix<T> {
	...
	public void setRowMatrix(final int row, final org.apache.commons.math3.linear.FieldMatrix<T> matrix) throws org.apache.commons.math3.exception.OutOfRangeException {
		checkRowIndex(row);
		final int nCols = getColumnDimension();
	...
	public void setColumnMatrix(final int column, final org.apache.commons.math3.linear.FieldMatrix<T> matrix) throws org.apache.commons.math3.exception.OutOfRangeException {
		checkColumnIndex(column);
		final int nRows = getRowDimension();
	...
	public void setRowVector(final int row, final org.apache.commons.math3.linear.FieldVector<T> vector) throws org.apache.commons.math3.exception.OutOfRangeException {
		checkRowIndex(row);
		final int nCols = getColumnDimension();
	...
	public void setColumnVector(final int column, final org.apache.commons.math3.linear.FieldVector<T> vector) throws org.apache.commons.math3.exception.OutOfRangeException {
		checkColumnIndex(column);
		final int nRows = getRowDimension();
	...
	public void setRow(final int row, final T[] array) throws org.apache.commons.math3.exception.OutOfRangeException {
		checkRowIndex(row);
		final int nCols = getColumnDimension();
	...
	public void setColumn(final int column, final T[] array) throws org.apache.commons.math3.exception.OutOfRangeException {
		checkColumnIndex(column);
		final int nRows = getRowDimension();
