...
public class Line implements org.apache.commons.math3.geometry.partitioning.Embedding<org.apache.commons.math3.geometry.euclidean.twod.Euclidean2D, org.apache.commons.math3.geometry.euclidean.oned.Euclidean1D> , org.apache.commons.math3.geometry.partitioning.Hyperplane<org.apache.commons.math3.geometry.euclidean.twod.Euclidean2D> {
	...
	public Line(final org.apache.commons.math3.geometry.euclidean.twod.Line line) {
		...
		cos = org.apache.commons.math3.util.FastMath.cos(angle);
		sin = org.apache.commons.math3.util.FastMath.sin(angle);
	...
	public org.apache.commons.math3.geometry.euclidean.twod.Line getReverse() {
		return new org.apache.commons.math3.geometry.euclidean.twod.Line(((angle) < (org.apache.commons.math3.util.FastMath.PI) ? (angle) + (org.apache.commons.math3.util.FastMath.PI) : (angle) - (org.apache.commons.math3.util.FastMath.PI)), (-(cos)), (-(sin)), (-(originOffset)));
	}

	public org.apache.commons.math3.geometry.euclidean.oned.Vector1D toSubSpace(final org.apache.commons.math3.geometry.Vector<org.apache.commons.math3.geometry.euclidean.twod.Euclidean2D> point) {
	...
	public org.apache.commons.math3.geometry.euclidean.twod.Vector2D toSpace(final org.apache.commons.math3.geometry.Vector<org.apache.commons.math3.geometry.euclidean.oned.Euclidean1D> point) {
		final double abscissa = ((org.apache.commons.math3.geometry.euclidean.oned.Vector1D) (point)).getX();
		return new org.apache.commons.math3.geometry.euclidean.twod.Vector2D(((abscissa * (cos)) - ((originOffset) * (sin))), ((abscissa * (sin)) + ((originOffset) * (cos))));
	}
	...
	public org.apache.commons.math3.geometry.euclidean.twod.Vector2D intersection(final org.apache.commons.math3.geometry.euclidean.twod.Line other) {
		...
		if ((org.apache.commons.math3.util.FastMath.abs(d)) < 1.0E-10) {
			return null;
		}
		return new org.apache.commons.math3.geometry.euclidean.twod.Vector2D(((((cos) * (other.originOffset)) - ((other.cos) * (originOffset))) / d), ((((sin) * (other.originOffset)) - ((other.sin) * (originOffset))) / d));
	}

	public org.apache.commons.math3.geometry.euclidean.twod.SubLine wholeHyperplane() {
		return new org.apache.commons.math3.geometry.euclidean.twod.SubLine(org.apache.commons.math3.geometry.euclidean.twod.Line.this, new org.apache.commons.math3.geometry.euclidean.oned.IntervalsSet());
	}

	public org.apache.commons.math3.geometry.euclidean.twod.PolygonsSet wholeSpace() {
		return new org.apache.commons.math3.geometry.euclidean.twod.PolygonsSet();
	}
	...
	public double getOffset(final org.apache.commons.math3.geometry.Vector<org.apache.commons.math3.geometry.euclidean.twod.Euclidean2D> point) {
		org.apache.commons.math3.geometry.euclidean.twod.Vector2D p2 = ((org.apache.commons.math3.geometry.euclidean.twod.Vector2D) (point));
	...
	public org.apache.commons.math3.geometry.euclidean.twod.Vector2D getPointAt(final org.apache.commons.math3.geometry.euclidean.oned.Vector1D abscissa, final double offset) {
		...
		return new org.apache.commons.math3.geometry.euclidean.twod.Vector2D(((x * (cos)) + (dOffset * (sin))), ((x * (sin)) - (dOffset * (cos))));
	}
	...
	public boolean isParallelTo(final org.apache.commons.math3.geometry.euclidean.twod.Line line) {
		return (org.apache.commons.math3.util.FastMath.abs((((sin) * (line.cos)) - ((cos) * (line.sin))))) < 1.0E-10;
	}
	...
	private static class LineTransform implements org.apache.commons.math3.geometry.partitioning.Transform<org.apache.commons.math3.geometry.euclidean.twod.Euclidean2D, org.apache.commons.math3.geometry.euclidean.oned.Euclidean1D> {
		...
		public org.apache.commons.math3.geometry.euclidean.twod.Vector2D apply(final org.apache.commons.math3.geometry.Vector<org.apache.commons.math3.geometry.euclidean.twod.Euclidean2D> point) {
			...
			return new org.apache.commons.math3.geometry.euclidean.twod.Vector2D(((((cXX) * x) + ((cXY) * y)) + (cX1)), ((((cYX) * x) + ((cYY) * y)) + (cY1)));
		}
		...
		public org.apache.commons.math3.geometry.euclidean.twod.Line apply(final org.apache.commons.math3.geometry.partitioning.Hyperplane<org.apache.commons.math3.geometry.euclidean.twod.Euclidean2D> hyperplane) {
			...
			return new org.apache.commons.math3.geometry.euclidean.twod.Line(((org.apache.commons.math3.util.FastMath.PI) + (org.apache.commons.math3.util.FastMath.atan2((-rSin), (-rCos)))), (inv * rCos), (inv * rSin), (inv * rOffset));
		}
		...
		public org.apache.commons.math3.geometry.partitioning.SubHyperplane<org.apache.commons.math3.geometry.euclidean.oned.Euclidean1D> apply(final org.apache.commons.math3.geometry.partitioning.SubHyperplane<org.apache.commons.math3.geometry.euclidean.oned.Euclidean1D> sub, final org.apache.commons.math3.geometry.partitioning.Hyperplane<org.apache.commons.math3.geometry.euclidean.twod.Euclidean2D> original, final org.apache.commons.math3.geometry.partitioning.Hyperplane<org.apache.commons.math3.geometry.euclidean.twod.Euclidean2D> transformed) {
			...
			return new org.apache.commons.math3.geometry.euclidean.oned.OrientedPoint(newLoc, op.isDirect()).wholeHyperplane();
		}
	}
}
