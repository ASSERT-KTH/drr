...
public abstract class AdaptiveStepsizeIntegrator implements org.apache.commons.math.ode.FirstOrderIntegrator {
	...
	protected void sanityChecks(org.apache.commons.math.ode.FirstOrderDifferentialEquations equations, double t0, double[] y0, double t, double[] y) throws org.apache.commons.math.ode.IntegratorException {
		if ((equations.getDimension()) != (y0.length)) {
			throw new org.apache.commons.math.ode.IntegratorException(("dimensions mismatch: ODE problem has dimension {0}," + " initial state vector has dimension {1}"), new java.lang.Object[]{ new java.lang.Integer(equations.getDimension()) , new java.lang.Integer(y0.length) });
		}
		if ((equations.getDimension()) != (y.length)) {
			throw new org.apache.commons.math.ode.IntegratorException(("dimensions mismatch: ODE problem has dimension {0}," + " final state vector has dimension {1}"), new java.lang.Object[]{ new java.lang.Integer(equations.getDimension()) , new java.lang.Integer(y.length) });
		}
		if (((vecAbsoluteTolerance) != null) && ((vecAbsoluteTolerance.length) != (y0.length))) {
			throw new org.apache.commons.math.ode.IntegratorException(("dimensions mismatch: state vector has dimension {0}," + " absolute tolerance vector has dimension {1}"), new java.lang.Object[]{ new java.lang.Integer(y0.length) , new java.lang.Integer(vecAbsoluteTolerance.length) });
		}
		if (((vecRelativeTolerance) != null) && ((vecRelativeTolerance.length) != (y0.length))) {
			throw new org.apache.commons.math.ode.IntegratorException(("dimensions mismatch: state vector has dimension {0}," + " relative tolerance vector has dimension {1}"), new java.lang.Object[]{ new java.lang.Integer(y0.length) , new java.lang.Integer(vecRelativeTolerance.length) });
		}
		if ((java.lang.Math.abs((t - t0))) <= (1.0E-12 * (java.lang.Math.max(java.lang.Math.abs(t0), java.lang.Math.abs(t))))) {
			throw new org.apache.commons.math.ode.IntegratorException("too small integration interval: length = {0}", new java.lang.Object[]{ new java.lang.Double(java.lang.Math.abs((t - t0))) });
		}
	}
	...
	protected double filterStep(double h, boolean acceptSmall) throws org.apache.commons.math.ode.IntegratorException {
		if ((java.lang.Math.abs(h)) < (minStep)) {
			if (acceptSmall) {
				...
				throw new org.apache.commons.math.ode.IntegratorException(("minimal step size ({0}) reached," + " integration needs {1}"), new java.lang.Object[]{ new java.lang.Double(minStep) , new java.lang.Double(java.lang.Math.abs(h)) });
			}
		}
		if (h > (maxStep)) {
			h = maxStep;
