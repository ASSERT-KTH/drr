...
public class PolynomialFunctionNewtonForm implements org.apache.commons.math.analysis.UnivariateRealFunction {
	...
	protected static void verifyInputArray(double[] a, double[] c) throws java.lang.IllegalArgumentException {
		if (((a.length) < 1) || ((c.length) < 1)) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.LocalizedFormats.EMPTY_POLYNOMIALS_COEFFICIENTS_ARRAY);
		}
		if ((a.length) != ((c.length) + 1)) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.LocalizedFormats.ARRAY_SIZES_SHOULD_HAVE_DIFFERENCE_1, a.length, c.length);
		}
	}
}
