...
public class RandomDataImpl implements java.io.Serializable , org.apache.commons.math.random.RandomData {
	...
	public java.lang.String nextHexString(int len) {
		if (len <= 0) {
			throw new org.apache.commons.math.exception.NotStrictlyPositiveException(org.apache.commons.math.exception.LocalizedFormats.LENGTH, len);
		}
	...
	public int nextInt(int lower, int upper) {
		if (lower >= upper) {
			throw new org.apache.commons.math.exception.NumberIsTooLargeException(org.apache.commons.math.exception.LocalizedFormats.LOWER_BOUND_NOT_BELOW_UPPER_BOUND, lower, upper, false);
		}
	...
	public long nextPoisson(double mean) {
		if (mean <= 0) {
			throw new org.apache.commons.math.exception.NotStrictlyPositiveException(org.apache.commons.math.exception.LocalizedFormats.MEAN, mean);
		}
	...
	public double nextGaussian(double mu, double sigma) {
		if (sigma <= 0) {
			throw new org.apache.commons.math.exception.NotStrictlyPositiveException(org.apache.commons.math.exception.LocalizedFormats.STANDARD_DEVIATION, sigma);
		}
	...
	public int[] nextPermutation(int n, int k) {
		if (k > n) {
			throw new org.apache.commons.math.exception.NumberIsTooLargeException(org.apache.commons.math.exception.LocalizedFormats.PERMUTATION_EXCEEDS_N, k, n, true);
		}
		if (k == 0) {
			throw new org.apache.commons.math.exception.NotStrictlyPositiveException(org.apache.commons.math.exception.LocalizedFormats.PERMUTATION_SIZE, k);
		}
	...
	public java.lang.Object[] nextSample(java.util.Collection<?> c, int k) {
		int len = c.size();
		if (k > len) {
			throw new org.apache.commons.math.exception.NumberIsTooLargeException(org.apache.commons.math.exception.LocalizedFormats.SAMPLE_SIZE_EXCEEDS_COLLECTION_SIZE, k, len, true);
		}
		if (k <= 0) {
			throw new org.apache.commons.math.exception.NotStrictlyPositiveException(org.apache.commons.math.exception.LocalizedFormats.NUMBER_OF_SAMPLES, k);
		}
