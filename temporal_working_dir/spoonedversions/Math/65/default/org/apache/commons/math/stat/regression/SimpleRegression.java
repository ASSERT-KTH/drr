...
public class SimpleRegression implements java.io.Serializable {
	...
	public double getSlopeConfidenceInterval(double alpha) throws org.apache.commons.math.MathException {
		if ((alpha >= 1) || (alpha <= 0)) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.LocalizedFormats.OUT_OF_BOUND_SIGNIFICANCE_LEVEL, alpha, 0.0, 1.0);
		}
