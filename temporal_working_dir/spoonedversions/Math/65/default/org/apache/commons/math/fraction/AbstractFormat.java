...
public abstract class AbstractFormat extends java.text.NumberFormat implements java.io.Serializable {
	...
	protected AbstractFormat(final java.text.NumberFormat numeratorFormat, final java.text.NumberFormat denominatorFormat) {
		org.apache.commons.math.fraction.AbstractFormat.this.numeratorFormat = numeratorFormat;
		org.apache.commons.math.fraction.AbstractFormat.this.denominatorFormat = denominatorFormat;
	}
	...
	public void setDenominatorFormat(final java.text.NumberFormat format) {
		if (format == null) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.LocalizedFormats.NULL_DENOMINATOR_FORMAT);
		}
		org.apache.commons.math.fraction.AbstractFormat.this.denominatorFormat = format;
	}

	public void setNumeratorFormat(final java.text.NumberFormat format) {
		if (format == null) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.LocalizedFormats.NULL_NUMERATOR_FORMAT);
		}
		org.apache.commons.math.fraction.AbstractFormat.this.numeratorFormat = format;
	}
