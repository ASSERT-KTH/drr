...
public class ProperBigFractionFormat extends org.apache.commons.math.fraction.BigFractionFormat {
	...
	public void setWholeFormat(final java.text.NumberFormat format) {
		if (format == null) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.LocalizedFormats.NULL_WHOLE_FORMAT);
		}
		org.apache.commons.math.fraction.ProperBigFractionFormat.this.wholeFormat = format;
	}
}
