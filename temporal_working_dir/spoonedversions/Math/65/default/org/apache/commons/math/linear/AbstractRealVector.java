...
public abstract class AbstractRealVector implements org.apache.commons.math.linear.RealVector {
	...
	protected void checkVectorDimensions(int n) throws java.lang.IllegalArgumentException {
		...
		if (d != n) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.LocalizedFormats.VECTOR_LENGTH_MISMATCH, d, n);
		}
	}

	protected void checkIndex(final int index) throws org.apache.commons.math.linear.MatrixIndexException {
		if ((index < 0) || (index >= (getDimension()))) {
			throw new org.apache.commons.math.linear.MatrixIndexException(org.apache.commons.math.exception.LocalizedFormats.INDEX_OUT_OF_RANGE, index, 0, ((getDimension()) - 1));
		}
	}
	...
	public java.util.Iterator<org.apache.commons.math.linear.RealVector.Entry> iterator() {
		...
		return new java.util.Iterator<org.apache.commons.math.linear.RealVector.Entry>() {
			...
			public void remove() {
				throw org.apache.commons.math.MathRuntimeException.createUnsupportedOperationException(org.apache.commons.math.exception.LocalizedFormats.UNSUPPORTED_OPERATION);
			}
		};
	}
