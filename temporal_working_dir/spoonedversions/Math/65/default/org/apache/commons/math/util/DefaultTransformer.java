...
public class DefaultTransformer implements java.io.Serializable , org.apache.commons.math.util.NumberTransformer {
	...
	public double transform(java.lang.Object o) throws org.apache.commons.math.MathException {
		if (o == null) {
			throw new org.apache.commons.math.MathException(org.apache.commons.math.exception.LocalizedFormats.NULL_OBJECT_TRANSFORMATION);
		}
		...
		try {
			...
			throw new org.apache.commons.math.MathException(e, org.apache.commons.math.exception.LocalizedFormats.CANNOT_TRANSFORM_TO_DOUBLE, e.getMessage());
		}
	}
