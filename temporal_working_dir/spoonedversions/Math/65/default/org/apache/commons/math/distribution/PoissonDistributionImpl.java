...
public class PoissonDistributionImpl extends org.apache.commons.math.distribution.AbstractIntegerDistribution implements java.io.Serializable , org.apache.commons.math.distribution.PoissonDistribution {
	...
	public PoissonDistributionImpl(double p, double epsilon, int maxIterations) {
		setMean(p);
		org.apache.commons.math.distribution.PoissonDistributionImpl.this.epsilon = epsilon;
		org.apache.commons.math.distribution.PoissonDistributionImpl.this.maxIterations = maxIterations;
	}
	...
	private void setNormalAndMeanInternal(org.apache.commons.math.distribution.NormalDistribution z, double p) {
		if (p <= 0) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.LocalizedFormats.NOT_POSITIVE_POISSON_MEAN, p);
		}
		mean = p;
		normal = z;
		normal.setMean(p);
	...
	public int sample() throws org.apache.commons.math.MathException {
		return ((int) (java.lang.Math.min(randomData.nextPoisson(mean), java.lang.Integer.MAX_VALUE)));
	}
