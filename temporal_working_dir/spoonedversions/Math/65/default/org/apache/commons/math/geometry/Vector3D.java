...
public class Vector3D implements java.io.Serializable {
	...
	public org.apache.commons.math.geometry.Vector3D normalize() {
		double s = getNorm();
		if (s == 0) {
			throw org.apache.commons.math.MathRuntimeException.createArithmeticException(org.apache.commons.math.exception.LocalizedFormats.CANNOT_NORMALIZE_A_ZERO_NORM_VECTOR);
		}
	...
	public org.apache.commons.math.geometry.Vector3D orthogonal() {
		...
		if (threshold == 0) {
			throw org.apache.commons.math.MathRuntimeException.createArithmeticException(org.apache.commons.math.exception.LocalizedFormats.ZERO_NORM);
		}
