...
public class LoessInterpolator implements java.io.Serializable , org.apache.commons.math.analysis.interpolation.UnivariateRealInterpolator {
	...
	public LoessInterpolator(double bandwidth, int robustnessIters, double accuracy) throws org.apache.commons.math.MathException {
		if ((bandwidth < 0) || (bandwidth > 1)) {
			throw new org.apache.commons.math.MathException(org.apache.commons.math.exception.LocalizedFormats.BANDWIDTH_OUT_OF_INTERVAL, bandwidth);
		}
		this.bandwidth = bandwidth;
		if (robustnessIters < 0) {
			throw new org.apache.commons.math.MathException(org.apache.commons.math.exception.LocalizedFormats.NEGATIVE_ROBUSTNESS_ITERATIONS, robustnessIters);
		}
	...
	public final double[] smooth(final double[] xval, final double[] yval, final double[] weights) throws org.apache.commons.math.MathException {
		if ((xval.length) != (yval.length)) {
			throw new org.apache.commons.math.MathException(org.apache.commons.math.exception.LocalizedFormats.MISMATCHED_LOESS_ABSCISSA_ORDINATE_ARRAYS, xval.length, yval.length);
		}
		final int n = xval.length;
		if (n == 0) {
			throw new org.apache.commons.math.MathException(org.apache.commons.math.exception.LocalizedFormats.LOESS_EXPECTS_AT_LEAST_ONE_POINT);
		}
		org.apache.commons.math.analysis.interpolation.LoessInterpolator.checkAllFiniteReal(xval, org.apache.commons.math.exception.LocalizedFormats.NON_REAL_FINITE_ABSCISSA);
		org.apache.commons.math.analysis.interpolation.LoessInterpolator.checkAllFiniteReal(yval, org.apache.commons.math.exception.LocalizedFormats.NON_REAL_FINITE_ORDINATE);
		org.apache.commons.math.analysis.interpolation.LoessInterpolator.checkAllFiniteReal(weights, org.apache.commons.math.exception.LocalizedFormats.NON_REAL_FINITE_WEIGHT);
		...
		if (bandwidthInPoints < 2) {
			throw new org.apache.commons.math.MathException(org.apache.commons.math.exception.LocalizedFormats.TOO_SMALL_BANDWIDTH, n, (2.0 / n), bandwidth);
		}
	...
	private static void checkAllFiniteReal(final double[] values, final org.apache.commons.math.exception.Localizable pattern) throws org.apache.commons.math.MathException {
	...
	private static void checkStrictlyIncreasing(final double[] xval) throws org.apache.commons.math.MathException {
		for (int i = 0; i < (xval.length); ++i) {
			if ((i >= 1) && ((xval[(i - 1)]) >= (xval[i]))) {
				throw new org.apache.commons.math.MathException(org.apache.commons.math.exception.LocalizedFormats.OUT_OF_ORDER_ABSCISSA_ARRAY, (i - 1), xval[(i - 1)], i, xval[i]);
			}
		}
	}
}
