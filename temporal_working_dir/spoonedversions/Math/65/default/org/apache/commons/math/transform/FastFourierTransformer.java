...
public class FastFourierTransformer implements java.io.Serializable {
	...
	public static double[] sample(org.apache.commons.math.analysis.UnivariateRealFunction f, double min, double max, int n) throws java.lang.IllegalArgumentException, org.apache.commons.math.FunctionEvaluationException {
		if (n <= 0) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.LocalizedFormats.NOT_POSITIVE_NUMBER_OF_SAMPLES, n);
		}
	...
	public static void verifyDataSet(double[] d) throws java.lang.IllegalArgumentException {
		if (!(org.apache.commons.math.transform.FastFourierTransformer.isPowerOf2(d.length))) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.LocalizedFormats.NOT_POWER_OF_TWO_CONSIDER_PADDING, d.length);
		}
	}
	...
	public static void verifyDataSet(java.lang.Object[] o) throws java.lang.IllegalArgumentException {
		if (!(org.apache.commons.math.transform.FastFourierTransformer.isPowerOf2(o.length))) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.LocalizedFormats.NOT_POWER_OF_TWO_CONSIDER_PADDING, o.length);
		}
	}

	public static void verifyInterval(double lower, double upper) throws java.lang.IllegalArgumentException {
		if (lower >= upper) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.LocalizedFormats.ENDPOINTS_NOT_AN_INTERVAL, lower, upper);
		}
	}
		...
		public org.apache.commons.math.complex.Complex get(int... vector) throws java.lang.IllegalArgumentException {
			if (vector == null) {
				if ((dimensionSize.length) > 0) {
					throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.LocalizedFormats.DIMENSIONS_MISMATCH_SIMPLE, 0, dimensionSize.length);
				}
				return null;
			}
			if ((vector.length) != (dimensionSize.length)) {
				throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.LocalizedFormats.DIMENSIONS_MISMATCH_SIMPLE, vector.length, dimensionSize.length);
			}
	...
	private static class RootsOfUnity implements java.io.Serializable {
		...
		public synchronized boolean isForward() throws java.lang.IllegalStateException {
			if ((omegaCount) == 0) {
				throw org.apache.commons.math.MathRuntimeException.createIllegalStateException(org.apache.commons.math.exception.LocalizedFormats.ROOTS_OF_UNITY_NOT_COMPUTED_YET);
			}
			return isForward;
		}
		...
		public synchronized void computeOmega(int n) throws java.lang.IllegalArgumentException {
			if (n == 0) {
				throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.LocalizedFormats.CANNOT_COMPUTE_0TH_ROOT_OF_UNITY);
			}
			isForward = n > 0;
		...
		public synchronized double getOmegaReal(int k) throws java.lang.IllegalArgumentException, java.lang.IllegalStateException {
			...
			if ((k < 0) || (k >= (omegaCount))) {
				throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.LocalizedFormats.OUT_OF_RANGE_ROOT_OF_UNITY_INDEX, k, 0, ((omegaCount) - 1));
			}
			return omegaReal[k];
		}
