...
public class Array2DRowRealMatrix extends org.apache.commons.math.linear.AbstractRealMatrix implements java.io.Serializable {
	...
	public org.apache.commons.math.linear.Array2DRowRealMatrix add(final org.apache.commons.math.linear.Array2DRowRealMatrix m) throws java.lang.IllegalArgumentException {
		org.apache.commons.math.linear.MatrixUtils.checkAdditionCompatible(org.apache.commons.math.linear.Array2DRowRealMatrix.this, m);
	...
	public org.apache.commons.math.linear.Array2DRowRealMatrix subtract(final org.apache.commons.math.linear.Array2DRowRealMatrix m) throws java.lang.IllegalArgumentException {
		org.apache.commons.math.linear.MatrixUtils.checkSubtractionCompatible(org.apache.commons.math.linear.Array2DRowRealMatrix.this, m);
		final int rowCount = getRowDimension();
		final int columnCount = getColumnDimension();
		final double[][] outData = new double[rowCount][columnCount];
		for (int row = 0; row < rowCount; row++) {
	...
	public org.apache.commons.math.linear.Array2DRowRealMatrix multiply(final org.apache.commons.math.linear.Array2DRowRealMatrix m) throws java.lang.IllegalArgumentException {
		org.apache.commons.math.linear.MatrixUtils.checkMultiplicationCompatible(org.apache.commons.math.linear.Array2DRowRealMatrix.this, m);
		final int nRows = org.apache.commons.math.linear.Array2DRowRealMatrix.this.getRowDimension();
		final int nCols = m.getColumnDimension();
		final int nSum = org.apache.commons.math.linear.Array2DRowRealMatrix.this.getColumnDimension();
		...
		if ((data) == null) {
			...
			for (int i = 0; i < (data.length); ++i) {
				if ((subMatrix[i].length) != nCols) {
					throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.LocalizedFormats.DIFFERENT_ROWS_LENGTHS, nCols, subMatrix[i].length);
				}
	...
	public double[] operate(final double[] v) throws java.lang.IllegalArgumentException {
		final int nRows = org.apache.commons.math.linear.Array2DRowRealMatrix.this.getRowDimension();
		final int nCols = org.apache.commons.math.linear.Array2DRowRealMatrix.this.getColumnDimension();
		if ((v.length) != nCols) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.LocalizedFormats.VECTOR_LENGTH_MISMATCH, v.length, nCols);
		}
	...
	public double walkInRowOrder(final org.apache.commons.math.linear.RealMatrixChangingVisitor visitor, final int startRow, final int endRow, final int startColumn, final int endColumn) throws org.apache.commons.math.linear.MatrixIndexException, org.apache.commons.math.linear.MatrixVisitorException {
		org.apache.commons.math.linear.MatrixUtils.checkSubMatrixIndex(org.apache.commons.math.linear.Array2DRowRealMatrix.this, startRow, endRow, startColumn, endColumn);
	...
	private double[][] copyOut() {
		final int nRows = org.apache.commons.math.linear.Array2DRowRealMatrix.this.getRowDimension();
		final double[][] out = new double[nRows][org.apache.commons.math.linear.Array2DRowRealMatrix.this.getColumnDimension()];
		for (int i = 0; i < nRows; i++) {
