...
public final class MathUtils {
	...
	public static int addAndCheck(int x, int y) {
		...
		if ((s < (java.lang.Integer.MIN_VALUE)) || (s > (java.lang.Integer.MAX_VALUE))) {
			throw org.apache.commons.math.MathRuntimeException.createArithmeticException(org.apache.commons.math.exception.LocalizedFormats.OVERFLOW_IN_ADDITION, x, y);
		}
		return ((int) (s));
	}

	public static long addAndCheck(long a, long b) {
		return org.apache.commons.math.util.MathUtils.addAndCheck(a, b, org.apache.commons.math.exception.LocalizedFormats.OVERFLOW_IN_ADDITION);
	}

	private static long addAndCheck(long a, long b, org.apache.commons.math.exception.Localizable pattern) {
		long ret;
		if (a > b) {
	...
	private static void checkBinomial(final int n, final int k) throws java.lang.IllegalArgumentException {
		if (n < k) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.LocalizedFormats.BINOMIAL_INVALID_PARAMETERS_ORDER, n, k);
		}
		if (n < 0) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.LocalizedFormats.BINOMIAL_NEGATIVE_PARAMETER, n);
		}
	}
	...
	public static boolean equals(double x, double y, double eps) {
		return (org.apache.commons.math.util.MathUtils.equals(x, y, 1)) || ((java.lang.Math.abs((y - x))) <= eps);
	}

	public static boolean equalsIncludingNaN(double x, double y, double eps) {
		return (org.apache.commons.math.util.MathUtils.equalsIncludingNaN(x, y)) || ((java.lang.Math.abs((y - x))) <= eps);
	}
	...
	public static long factorial(final int n) {
		if (n < 0) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.LocalizedFormats.FACTORIAL_NEGATIVE_PARAMETER, n);
		}
		if (n > 20) {
	...
	public static int gcd(final int p, final int q) {
		...
		if ((u == 0) || (v == 0)) {
			if ((u == (java.lang.Integer.MIN_VALUE)) || (v == (java.lang.Integer.MIN_VALUE))) {
				throw org.apache.commons.math.MathRuntimeException.createArithmeticException(org.apache.commons.math.exception.LocalizedFormats.GCD_OVERFLOW_32_BITS, p, q);
			}
	...
	public static long gcd(final long p, final long q) {
		...
		if ((u == 0) || (v == 0)) {
			if ((u == (java.lang.Long.MIN_VALUE)) || (v == (java.lang.Long.MIN_VALUE))) {
				throw org.apache.commons.math.MathRuntimeException.createArithmeticException(org.apache.commons.math.exception.LocalizedFormats.GCD_OVERFLOW_64_BITS, p, q);
			}
			return (java.lang.Math.abs(u)) + (java.lang.Math.abs(v));
		}
		if (u > 0) {
	...
	public static int lcm(int a, int b) {
		...
		if (lcm == (java.lang.Integer.MIN_VALUE)) {
			throw org.apache.commons.math.MathRuntimeException.createArithmeticException(org.apache.commons.math.exception.LocalizedFormats.LCM_OVERFLOW_32_BITS, a, b);
		}
		return lcm;
	}
	...
	public static long lcm(long a, long b) {
		...
		if (lcm == (java.lang.Long.MIN_VALUE)) {
			throw org.apache.commons.math.MathRuntimeException.createArithmeticException(org.apache.commons.math.exception.LocalizedFormats.LCM_OVERFLOW_64_BITS, a, b);
		}
		return lcm;
	}
	...
	public static double[] normalizeArray(double[] values, double normalizedSum) throws java.lang.ArithmeticException, java.lang.IllegalArgumentException {
		if (java.lang.Double.isInfinite(normalizedSum)) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.LocalizedFormats.NORMALIZE_INFINITE);
		}
		if (java.lang.Double.isNaN(normalizedSum)) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.LocalizedFormats.NORMALIZE_NAN);
		}
		double sum = 0.0;
		...
		for (int i = 0; i < len; i++) {
			if (java.lang.Double.isInfinite(values[i])) {
				throw org.apache.commons.math.MathRuntimeException.createArithmeticException(org.apache.commons.math.exception.LocalizedFormats.INFINITE_ARRAY_ELEMENT, values[i], i);
			}
		...
		if (sum == 0) {
			throw org.apache.commons.math.MathRuntimeException.createArithmeticException(org.apache.commons.math.exception.LocalizedFormats.ARRAY_SUMS_TO_ZERO);
		}
		for (int i = 0; i < len; i++) {
			if (java.lang.Double.isNaN(values[i])) {
	...
	public static int subAndCheck(int x, int y) {
		long s = ((long) (x)) - ((long) (y));
		if ((s < (java.lang.Integer.MIN_VALUE)) || (s > (java.lang.Integer.MAX_VALUE))) {
			throw org.apache.commons.math.MathRuntimeException.createArithmeticException(org.apache.commons.math.exception.LocalizedFormats.OVERFLOW_IN_SUBTRACTION, x, y);
		}
		return ((int) (s));
	}
	...
	public static long subAndCheck(long a, long b) {
		...
		if (b == (java.lang.Long.MIN_VALUE)) {
			...
			ret = org.apache.commons.math.util.MathUtils.addAndCheck(a, (-b), org.apache.commons.math.exception.LocalizedFormats.OVERFLOW_IN_ADDITION);
		}
		return ret;
	}
	...
	public static int pow(final int k, int e) throws java.lang.IllegalArgumentException {
		if (e < 0) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.LocalizedFormats.POWER_NEGATIVE_PARAMETERS, k, e);
		}
		int result = 1;
		int k2p = k;
		while (e != 0) {
