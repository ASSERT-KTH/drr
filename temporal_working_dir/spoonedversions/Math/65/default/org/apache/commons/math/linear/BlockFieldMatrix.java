...
public class BlockFieldMatrix<T extends org.apache.commons.math.FieldElement<T>> extends org.apache.commons.math.linear.AbstractFieldMatrix<T> implements java.io.Serializable {
		...
		for (int iBlock = 0; iBlock < (blockRows); ++iBlock) {
			...
			for (int jBlock = 0; jBlock < (blockColumns); ++jBlock , ++index) {
				if ((blockData[index].length) != (iHeight * (blockWidth(jBlock)))) {
					throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.LocalizedFormats.WRONG_BLOCK_LENGTH, blockData[index].length, (iHeight * (blockWidth(jBlock))));
				}
				if (copyArray) {
	...
	public static <T extends org.apache.commons.math.FieldElement<T>> T[][] toBlocksLayout(final T[][] rawData) throws java.lang.IllegalArgumentException {
		...
		for (int i = 0; i < (rawData.length); ++i) {
			...
			if (length != columns) {
				throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.LocalizedFormats.DIFFERENT_ROWS_LENGTHS, columns, length);
			}
		}
		...
		for (int iBlock = 0; iBlock < blockRows; ++iBlock) {
			...
			final int pEnd = java.lang.Math.min((pStart + (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE)), rows);
			final int iHeight = pEnd - pStart;
			for (int jBlock = 0; jBlock < blockColumns; ++jBlock) {
				final int qStart = jBlock * (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE);
				final int qEnd = java.lang.Math.min((qStart + (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE)), columns);
	...
	public org.apache.commons.math.linear.FieldMatrix<T> multiply(final org.apache.commons.math.linear.FieldMatrix<T> m) throws java.lang.IllegalArgumentException {
		try {
			...
			for (int iBlock = 0; iBlock < (out.blockRows); ++iBlock) {
				...
				for (int jBlock = 0; jBlock < (out.blockColumns); ++jBlock) {
					final int qStart = jBlock * (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE);
					final int qEnd = java.lang.Math.min((qStart + (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE)), m.getColumnDimension());
					final T[] outBlock = out.blocks[blockIndex];
	...
	public void setSubMatrix(final T[][] subMatrix, final int row, final int column) throws org.apache.commons.math.linear.MatrixIndexException {
		...
		if (refLength < 1) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.LocalizedFormats.AT_LEAST_ONE_COLUMN);
		}
		...
		for (final T[] subRow : subMatrix) {
			if ((subRow.length) != refLength) {
				throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.LocalizedFormats.DIFFERENT_ROWS_LENGTHS, refLength, subRow.length);
			}
		}
	...
	public void setRowMatrix(final int row, final org.apache.commons.math.linear.BlockFieldMatrix<T> matrix) throws org.apache.commons.math.linear.InvalidMatrixException, org.apache.commons.math.linear.MatrixIndexException {
		...
		if (((matrix.getRowDimension()) != 1) || ((matrix.getColumnDimension()) != nCols)) {
			throw new org.apache.commons.math.linear.InvalidMatrixException(org.apache.commons.math.exception.LocalizedFormats.DIMENSIONS_MISMATCH_2x2, matrix.getRowDimension(), matrix.getColumnDimension(), 1, nCols);
		}
		final int iBlock = row / (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE);
		final int iRow = row - (iBlock * (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE));
		int mBlockIndex = 0;
	...
	void setColumnMatrix(final int column, final org.apache.commons.math.linear.BlockFieldMatrix<T> matrix) throws org.apache.commons.math.linear.InvalidMatrixException, org.apache.commons.math.linear.MatrixIndexException {
		...
		if (((matrix.getRowDimension()) != nRows) || ((matrix.getColumnDimension()) != 1)) {
			throw new org.apache.commons.math.linear.InvalidMatrixException(org.apache.commons.math.exception.LocalizedFormats.DIMENSIONS_MISMATCH_2x2, matrix.getRowDimension(), matrix.getColumnDimension(), nRows, 1);
		}
		final int jBlock = column / (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE);
		final int jColumn = column - (jBlock * (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE));
		final int jWidth = blockWidth(jBlock);
	...
	public void setRow(final int row, final T[] array) throws org.apache.commons.math.linear.InvalidMatrixException, org.apache.commons.math.linear.MatrixIndexException {
		...
		if ((array.length) != nCols) {
			throw new org.apache.commons.math.linear.InvalidMatrixException(org.apache.commons.math.exception.LocalizedFormats.DIMENSIONS_MISMATCH_2x2, 1, array.length, 1, nCols);
		}
		final int iBlock = row / (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE);
		final int iRow = row - (iBlock * (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE));
		int outIndex = 0;
	...
	public void setColumn(final int column, final T[] array) throws org.apache.commons.math.linear.InvalidMatrixException, org.apache.commons.math.linear.MatrixIndexException {
		...
		if ((array.length) != nRows) {
			throw new org.apache.commons.math.linear.InvalidMatrixException(org.apache.commons.math.exception.LocalizedFormats.DIMENSIONS_MISMATCH_2x2, array.length, 1, nRows, 1);
		}
		final int jBlock = column / (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE);
		final int jColumn = column - (jBlock * (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE));
		final int jWidth = blockWidth(jBlock);
	...
	public T getEntry(final int row, final int column) throws org.apache.commons.math.linear.MatrixIndexException {
		try {
			...
			throw new org.apache.commons.math.linear.MatrixIndexException(org.apache.commons.math.exception.LocalizedFormats.NO_SUCH_MATRIX_ENTRY, row, column, getRowDimension(), getColumnDimension());
		}
	}
	...
	public org.apache.commons.math.linear.FieldMatrix<T> transpose() {
		...
		for (int iBlock = 0; iBlock < (blockColumns); ++iBlock) {
			for (int jBlock = 0; jBlock < (blockRows); ++jBlock) {
				...
				final int pStart = iBlock * (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE);
				final int pEnd = java.lang.Math.min((pStart + (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE)), columns);
				final int qStart = jBlock * (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE);
				final int qEnd = java.lang.Math.min((qStart + (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE)), rows);
				int k = 0;
				for (int p = pStart; p < pEnd; ++p) {
	...
	public T[] operate(final T[] v) throws java.lang.IllegalArgumentException {
		if ((v.length) != (columns)) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.LocalizedFormats.VECTOR_LENGTH_MISMATCH, v.length, columns);
		}
		final T[] out = org.apache.commons.math.linear.AbstractFieldMatrix.buildArray(getField(), rows);
		final T zero = getField().getZero();
		for (int iBlock = 0; iBlock < (blockRows); ++iBlock) {
	...
	public T[] preMultiply(final T[] v) throws java.lang.IllegalArgumentException {
		if ((v.length) != (rows)) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.LocalizedFormats.VECTOR_LENGTH_MISMATCH, v.length, rows);
		}
		final T[] out = org.apache.commons.math.linear.AbstractFieldMatrix.buildArray(getField(), columns);
		final T zero = getField().getZero();
		for (int jBlock = 0; jBlock < (blockColumns); ++jBlock) {
	...
	public T walkInRowOrder(final org.apache.commons.math.linear.FieldMatrixChangingVisitor<T> visitor, final int startRow, final int endRow, final int startColumn, final int endColumn) throws org.apache.commons.math.linear.MatrixIndexException, org.apache.commons.math.linear.MatrixVisitorException {
		...
		for (int iBlock = startRow / (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE); iBlock < (1 + (endRow / (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE))); ++iBlock) {
			...
			final int pEnd = java.lang.Math.min(((iBlock + 1) * (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE)), (1 + endRow));
			for (int p = pStart; p < pEnd; ++p) {
				for (int jBlock = startColumn / (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE); jBlock < (1 + (endColumn / (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE))); ++jBlock) {
					...
					final int qEnd = java.lang.Math.min(((jBlock + 1) * (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE)), (1 + endColumn));
					final T[] block = blocks[((iBlock * (blockColumns)) + jBlock)];
