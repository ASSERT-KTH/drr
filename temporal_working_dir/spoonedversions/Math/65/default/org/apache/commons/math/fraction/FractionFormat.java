...
public class FractionFormat extends org.apache.commons.math.fraction.AbstractFormat {
		...
		if (obj instanceof org.apache.commons.math.fraction.Fraction) {
			...
			if (obj instanceof java.lang.Number) {
				try {
					...
					throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.LocalizedFormats.CANNOT_CONVERT_OBJECT_TO_FRACTION, ex.getLocalizedMessage());
				}
			}else {
				throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.LocalizedFormats.CANNOT_FORMAT_OBJECT_TO_FRACTION);
			}
	...
	public org.apache.commons.math.fraction.Fraction parse(final java.lang.String source) throws java.text.ParseException {
		...
		if ((parsePosition.getIndex()) == 0) {
			throw org.apache.commons.math.MathRuntimeException.createParseException(parsePosition.getErrorIndex(), org.apache.commons.math.exception.LocalizedFormats.UNPARSEABLE_FRACTION_NUMBER, source);
		}
		return result;
	}
