...
public class RandomDataImpl implements java.io.Serializable , org.apache.commons.math.random.RandomData {
	...
	public int nextInt(int lower, int upper) {
		if (lower >= upper) {
			throw new org.apache.commons.math.exception.NumberIsTooLargeException(org.apache.commons.math.util.LocalizedFormats.LOWER_BOUND_NOT_BELOW_UPPER_BOUND, lower, upper, false);
		}
	...
	public int[] nextPermutation(int n, int k) {
		if (k > n) {
			throw new org.apache.commons.math.exception.NumberIsTooLargeException(org.apache.commons.math.util.LocalizedFormats.PERMUTATION_EXCEEDS_N, k, n, true);
		}
		if (k == 0) {
			throw new org.apache.commons.math.exception.NotStrictlyPositiveException(org.apache.commons.math.util.LocalizedFormats.PERMUTATION_SIZE, k);
		}
	...
	public java.lang.Object[] nextSample(java.util.Collection<?> c, int k) {
		int len = c.size();
		if (k > len) {
			throw new org.apache.commons.math.exception.NumberIsTooLargeException(org.apache.commons.math.util.LocalizedFormats.SAMPLE_SIZE_EXCEEDS_COLLECTION_SIZE, k, len, true);
		}
		if (k <= 0) {
