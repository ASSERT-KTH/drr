...
public class TTestImpl implements org.apache.commons.math.stat.inference.TTest {
	...
	private void checkSignificanceLevel(final double alpha) throws java.lang.IllegalArgumentException {
		if ((alpha <= 0) || (alpha > 0.5)) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.util.LocalizedFormats.OUT_OF_BOUND_SIGNIFICANCE_LEVEL, alpha, 0.0, 0.5);
		}
	}

	private void checkSampleData(final double[] data) throws java.lang.IllegalArgumentException {
		if ((data == null) || ((data.length) < 2)) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.util.LocalizedFormats.INSUFFICIENT_DATA_FOR_T_STATISTIC, (data == null ? 0 : data.length));
		}
	}
	...
	private void checkSampleData(final org.apache.commons.math.stat.descriptive.StatisticalSummary stat) throws java.lang.IllegalArgumentException {
		if ((stat == null) || ((stat.getN()) < 2)) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.util.LocalizedFormats.INSUFFICIENT_DATA_FOR_T_STATISTIC, (stat == null ? 0 : stat.getN()));
		}
	}
}
