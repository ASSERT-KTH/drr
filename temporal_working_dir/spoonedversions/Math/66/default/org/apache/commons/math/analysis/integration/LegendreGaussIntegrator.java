	...
	public LegendreGaussIntegrator(final int n, final int defaultMaximalIterationCount) throws java.lang.IllegalArgumentException {
		...
		switch (n) {
			...
			case 5 :
				...
				break;
			default :
				throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.util.LocalizedFormats.N_POINTS_GAUSS_LEGENDRE_INTEGRATOR_NOT_SUPPORTED, n, 2, 5);
		}
	}
