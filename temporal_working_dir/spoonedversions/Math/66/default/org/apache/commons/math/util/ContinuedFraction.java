	...
	public double evaluate(double x, double epsilon, int maxIterations) throws org.apache.commons.math.MathException {
		...
		while ((n < maxIterations) && (relativeError > epsilon)) {
			...
			if ((java.lang.Double.isInfinite(p2)) || (java.lang.Double.isInfinite(q2))) {
				...
				if (scale <= 0) {
					throw new org.apache.commons.math.ConvergenceException(org.apache.commons.math.util.LocalizedFormats.CONTINUED_FRACTION_INFINITY_DIVERGENCE, x);
				}
				infinite = true;
			...
			if (java.lang.Double.isNaN(r)) {
				throw new org.apache.commons.math.ConvergenceException(org.apache.commons.math.util.LocalizedFormats.CONTINUED_FRACTION_NAN_DIVERGENCE, x);
			}
		...
		if (n >= maxIterations) {
			throw new org.apache.commons.math.MaxIterationsExceededException(maxIterations, org.apache.commons.math.util.LocalizedFormats.NON_CONVERGENT_CONTINUED_FRACTION, x);
		}
		return c;
	}
}
