...
public abstract class AbstractUnivariateRealOptimizer extends org.apache.commons.math.ConvergingAlgorithmImpl implements org.apache.commons.math.optimization.UnivariateRealOptimizer {
	...
	public double optimize(org.apache.commons.math.analysis.UnivariateRealFunction function, org.apache.commons.math.optimization.GoalType goal, double min, double max, double startValue) throws org.apache.commons.math.FunctionEvaluationException, org.apache.commons.math.MaxIterationsExceededException {
		org.apache.commons.math.optimization.univariate.AbstractUnivariateRealOptimizer.this.min = min;
		org.apache.commons.math.optimization.univariate.AbstractUnivariateRealOptimizer.this.max = max;
		org.apache.commons.math.optimization.univariate.AbstractUnivariateRealOptimizer.this.startValue = startValue;
		org.apache.commons.math.optimization.univariate.AbstractUnivariateRealOptimizer.this.goal = goal;
		org.apache.commons.math.optimization.univariate.AbstractUnivariateRealOptimizer.this.function = function;
