...
public class Rotation implements java.io.Serializable {
	...
	public Rotation(double[][] m, double threshold) throws org.apache.commons.math.geometry.NotARotationMatrixException {
		if (((((m.length) != 3) || ((m[0].length) != 3)) || ((m[1].length) != 3)) || ((m[2].length) != 3)) {
			throw new org.apache.commons.math.geometry.NotARotationMatrixException(org.apache.commons.math.util.LocalizedFormats.ROTATION_MATRIX_DIMENSIONS, m.length, m[0].length);
		}
		...
		if (det < 0.0) {
			throw new org.apache.commons.math.geometry.NotARotationMatrixException(org.apache.commons.math.util.LocalizedFormats.CLOSEST_ORTHOGONAL_MATRIX_HAS_NEGATIVE_DETERMINANT, det);
		}
	...
	private double[][] orthogonalizeMatrix(double[][] m, double threshold) throws org.apache.commons.math.geometry.NotARotationMatrixException {
		...
		throw new org.apache.commons.math.geometry.NotARotationMatrixException(org.apache.commons.math.util.LocalizedFormats.UNABLE_TO_ORTHOGONOLIZE_MATRIX, (i - 1));
	}
