...
public class MaxIterationsExceededException extends org.apache.commons.math.ConvergenceException {
	...
	public MaxIterationsExceededException(final int maxIterations) {
		super(org.apache.commons.math.util.LocalizedFormats.MAX_ITERATIONS_EXCEEDED, maxIterations);
	...
	public MaxIterationsExceededException(final int maxIterations, final java.lang.String pattern, final java.lang.Object... arguments) {
		this(maxIterations, new org.apache.commons.math.util.DummyLocalizable(pattern), arguments);
	}

	public MaxIterationsExceededException(final int maxIterations, final org.apache.commons.math.util.Localizable pattern, final java.lang.Object... arguments) {
