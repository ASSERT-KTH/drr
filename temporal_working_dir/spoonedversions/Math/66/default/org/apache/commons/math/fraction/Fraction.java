...
public class Fraction extends java.lang.Number implements java.io.Serializable , java.lang.Comparable<org.apache.commons.math.fraction.Fraction> , org.apache.commons.math.FieldElement<org.apache.commons.math.fraction.Fraction> {
	...
	public Fraction(int num, int den) {
		if (den == 0) {
			throw org.apache.commons.math.MathRuntimeException.createArithmeticException(org.apache.commons.math.util.LocalizedFormats.ZERO_DENOMINATOR_IN_FRACTION, num, den);
		}
		if (den < 0) {
			if ((num == (java.lang.Integer.MIN_VALUE)) || (den == (java.lang.Integer.MIN_VALUE))) {
				throw org.apache.commons.math.MathRuntimeException.createArithmeticException(org.apache.commons.math.util.LocalizedFormats.OVERFLOW_IN_FRACTION, num, den);
			}
			num = -num;
			den = -den;
		}
	...
	public org.apache.commons.math.fraction.Fraction negate() {
		if ((numerator) == (java.lang.Integer.MIN_VALUE)) {
			throw org.apache.commons.math.MathRuntimeException.createArithmeticException(org.apache.commons.math.util.LocalizedFormats.OVERFLOW_IN_FRACTION, numerator, denominator);
		}
	...
	private org.apache.commons.math.fraction.Fraction addSub(org.apache.commons.math.fraction.Fraction fraction, boolean isAdd) {
		if (fraction == null) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.util.LocalizedFormats.NULL_FRACTION);
		}
		if ((numerator) == 0) {
		...
		if ((w.bitLength()) > 31) {
			throw org.apache.commons.math.MathRuntimeException.createArithmeticException(org.apache.commons.math.util.LocalizedFormats.NUMERATOR_OVERFLOW_AFTER_MULTIPLY, w);
		}
	...
	public org.apache.commons.math.fraction.Fraction divide(org.apache.commons.math.fraction.Fraction fraction) {
		...
		if ((fraction.numerator) == 0) {
			throw org.apache.commons.math.MathRuntimeException.createArithmeticException(org.apache.commons.math.util.LocalizedFormats.ZERO_FRACTION_TO_DIVIDE_BY, fraction.numerator, fraction.denominator);
		}
	...
	public static org.apache.commons.math.fraction.Fraction getReducedFraction(int numerator, int denominator) {
		if (denominator == 0) {
			throw org.apache.commons.math.MathRuntimeException.createArithmeticException(org.apache.commons.math.util.LocalizedFormats.ZERO_DENOMINATOR_IN_FRACTION, numerator, denominator);
		}
		if (numerator == 0) {
			return org.apache.commons.math.fraction.Fraction.ZERO;
		}
