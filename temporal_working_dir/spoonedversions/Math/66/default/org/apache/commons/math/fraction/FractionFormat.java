		...
		if (obj instanceof org.apache.commons.math.fraction.Fraction) {
			...
			if (obj instanceof java.lang.Number) {
				try {
					...
					throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.util.LocalizedFormats.CANNOT_CONVERT_OBJECT_TO_FRACTION, ex.getLocalizedMessage());
				}
			}else {
