...
public class HarmonicCoefficientsGuesser {
	...
	private void guessAOmega() throws org.apache.commons.math.optimization.OptimizationException {
		...
		if (((c1 / c2) < 0.0) || ((c2 / c3) < 0.0)) {
			throw new org.apache.commons.math.optimization.OptimizationException(org.apache.commons.math.util.LocalizedFormats.UNABLE_TO_FIRST_GUESS_HARMONIC_COEFFICIENTS);
		}
