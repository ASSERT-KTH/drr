...
public class GLSMultipleLinearRegression extends org.apache.commons.math.stat.regression.AbstractMultipleLinearRegression {
	...
	protected void newCovarianceData(double[][] omega) {
		org.apache.commons.math.stat.regression.GLSMultipleLinearRegression.this.Omega = new org.apache.commons.math.linear.Array2DRowRealMatrix(omega);
	...
	protected org.apache.commons.math.linear.RealMatrix getOmegaInverse() {
		if ((OmegaInverse) == null) {
			OmegaInverse = new org.apache.commons.math.linear.LUDecomposition(Omega).getSolver().getInverse();
		}
		return OmegaInverse;
	}
	...
	protected org.apache.commons.math.linear.RealVector calculateBeta() {
		...
		org.apache.commons.math.linear.RealMatrix inverse = new org.apache.commons.math.linear.LUDecomposition(XTOIX).getSolver().getInverse();
	...
	protected org.apache.commons.math.linear.RealMatrix calculateBetaVariance() {
		...
		return new org.apache.commons.math.linear.LUDecomposition(XTOIX).getSolver().getInverse();
	}
