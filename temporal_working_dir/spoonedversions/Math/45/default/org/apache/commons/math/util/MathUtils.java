...
INCREASING, DECREASING;	}
	...
	public static boolean isMonotone(java.lang.Comparable[] val, org.apache.commons.math.util.MathUtils.OrderDirection dir, boolean strict) {
	...
	public static boolean isMonotone(double[] val, org.apache.commons.math.util.MathUtils.OrderDirection dir, boolean strict) {
	...
	public static double linearCombination(final double[] a, final double[] b) {
		...
		for (int i = 0; i < len; i++) {
			final double ai = a[i];
			final double ca = (org.apache.commons.math.util.MathUtils.SPLIT_FACTOR) * ai;
			final double aHigh = ca - (ca - ai);
			final double aLow = ai - aHigh;
			final double bi = b[i];
			final double cb = (org.apache.commons.math.util.MathUtils.SPLIT_FACTOR) * bi;
