...
public class AdamsNordsieckTransformer {
	...
	private AdamsNordsieckTransformer(final int nSteps) {
		...
		org.apache.commons.math.linear.FieldDecompositionSolver<org.apache.commons.math.fraction.BigFraction> pSolver = new org.apache.commons.math.linear.FieldLUDecomposition<org.apache.commons.math.fraction.BigFraction>(bigP).getSolver();
		...
		org.apache.commons.math.fraction.BigFraction[] bigC1 = pSolver.solve(new org.apache.commons.math.linear.ArrayFieldVector<org.apache.commons.math.fraction.BigFraction>(u, false)).toArray();
	...
	public org.apache.commons.math.linear.Array2DRowRealMatrix initializeHighOrderDerivatives(final double h, final double[] t, final double[][] y, final double[][] yDot) {
		...
		org.apache.commons.math.linear.QRDecomposition decomposition;
		decomposition = new org.apache.commons.math.linear.QRDecomposition(new org.apache.commons.math.linear.Array2DRowRealMatrix(a, false));
		org.apache.commons.math.linear.RealMatrix x = decomposition.getSolver().solve(new org.apache.commons.math.linear.Array2DRowRealMatrix(b, false));
		return new org.apache.commons.math.linear.Array2DRowRealMatrix(x.getData(), false);
	}
