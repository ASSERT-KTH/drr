...
abstract class RungeKuttaStepInterpolator extends org.apache.commons.math.ode.sampling.AbstractStepInterpolator {
	...
	public void reinitialize(final org.apache.commons.math.ode.AbstractIntegrator rkIntegrator, final double[] y, final double[][] yDotArray, final boolean forward, final org.apache.commons.math.ode.EquationsMapper primaryMapper, final org.apache.commons.math.ode.EquationsMapper[] secondaryMappers) {
		reinitialize(y, forward, primaryMapper, secondaryMappers);
		org.apache.commons.math.ode.nonstiff.RungeKuttaStepInterpolator.this.yDotK = yDotArray;
		org.apache.commons.math.ode.nonstiff.RungeKuttaStepInterpolator.this.integrator = rkIntegrator;
	}
