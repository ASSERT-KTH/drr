...
public class MultiStartUnivariateRealOptimizer<FUNC extends org.apache.commons.math.analysis.UnivariateRealFunction> implements org.apache.commons.math.optimization.univariate.BaseUnivariateRealOptimizer<FUNC> {
	...
	public org.apache.commons.math.optimization.univariate.UnivariateRealPointValuePair optimize(final FUNC f, final org.apache.commons.math.optimization.GoalType goalType, final double min, final double max, final double startValue) throws org.apache.commons.math.FunctionEvaluationException {
