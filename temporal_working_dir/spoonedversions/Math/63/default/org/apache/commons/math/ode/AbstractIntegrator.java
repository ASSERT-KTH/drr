...
public abstract class AbstractIntegrator implements org.apache.commons.math.ode.FirstOrderIntegrator {
	...
	protected org.apache.commons.math.ode.events.CombinedEventsManager addEndTimeChecker(final double startTime, final double endTime, final org.apache.commons.math.ode.events.CombinedEventsManager manager) {
		...
		newManager.addEventHandler(new org.apache.commons.math.ode.AbstractIntegrator.EndTimeChecker(endTime), java.lang.Double.POSITIVE_INFINITY, org.apache.commons.math.util.FastMath.ulp(org.apache.commons.math.util.FastMath.max(org.apache.commons.math.util.FastMath.abs(startTime), org.apache.commons.math.util.FastMath.abs(endTime))), 100);
		return newManager;
	}
