...
public class GaussNewtonEstimator extends org.apache.commons.math.estimation.AbstractEstimator implements java.io.Serializable {
	...
	public GaussNewtonEstimator() {
		org.apache.commons.math.estimation.GaussNewtonEstimator.this.steadyStateThreshold = org.apache.commons.math.estimation.GaussNewtonEstimator.DEFAULT_STEADY_STATE_THRESHOLD;
		org.apache.commons.math.estimation.GaussNewtonEstimator.this.convergence = org.apache.commons.math.estimation.GaussNewtonEstimator.DEFAULT_CONVERGENCE;
	}
	...
	public void estimate(org.apache.commons.math.estimation.EstimationProblem problem) throws org.apache.commons.math.estimation.EstimationException {
		...
		do {
			...
			try {
				...
				throw new org.apache.commons.math.estimation.EstimationException(org.apache.commons.math.exception.util.LocalizedFormats.UNABLE_TO_SOLVE_SINGULAR_PROBLEM);
			}
			previous = cost;
			updateResidualsAndCost();
		} while (((getCostEvaluations()) < 2) || (((org.apache.commons.math.util.FastMath.abs((previous - (cost)))) > ((cost) * (steadyStateThreshold))) && ((org.apache.commons.math.util.FastMath.abs(cost)) > (convergence))) );
	}
}
