...
public class OLSMultipleLinearRegression extends org.apache.commons.math.stat.regression.AbstractMultipleLinearRegression {
	...
	public double calculateTotalSumOfSquares() {
		return new org.apache.commons.math.stat.descriptive.moment.SecondMoment().evaluate(Y.getData());
	}
	...
	protected void newXSampleData(double[][] x) {
		org.apache.commons.math.stat.regression.OLSMultipleLinearRegression.this.X = new org.apache.commons.math.linear.Array2DRowRealMatrix(x);
		qr = new org.apache.commons.math.linear.QRDecompositionImpl(X);
	}
