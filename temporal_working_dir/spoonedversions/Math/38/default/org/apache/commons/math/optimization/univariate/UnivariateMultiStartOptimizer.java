...
public class UnivariateMultiStartOptimizer<FUNC extends org.apache.commons.math.analysis.UnivariateFunction> implements org.apache.commons.math.optimization.univariate.BaseUnivariateOptimizer<FUNC> {
	...
	public org.apache.commons.math.optimization.univariate.UnivariateRealPointValuePair optimize(int maxEval, final FUNC f, final org.apache.commons.math.optimization.GoalType goal, final double min, final double max) {
		return optimize(maxEval, f, goal, min, max, (min + (0.5 * (max - min))));
	}

	public org.apache.commons.math.optimization.univariate.UnivariateRealPointValuePair optimize(int maxEval, final FUNC f, final org.apache.commons.math.optimization.GoalType goal, final double min, final double max, final double startValue) {
