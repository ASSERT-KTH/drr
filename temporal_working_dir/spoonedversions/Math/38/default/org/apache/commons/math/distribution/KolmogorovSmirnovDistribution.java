...
public class KolmogorovSmirnovDistribution implements java.io.Serializable {
	...
	public KolmogorovSmirnovDistribution(int n) throws org.apache.commons.math.exception.NotStrictlyPositiveException {
		if (n <= 0) {
		...
		org.apache.commons.math.distribution.KolmogorovSmirnovDistribution.this.n = n;
	}

	public double cdf(double d) throws org.apache.commons.math.exception.MathArithmeticException {
		return org.apache.commons.math.distribution.KolmogorovSmirnovDistribution.this.cdf(d, false);
	}

	public double cdfExact(double d) throws org.apache.commons.math.exception.MathArithmeticException {
		return org.apache.commons.math.distribution.KolmogorovSmirnovDistribution.this.cdf(d, true);
	}
	...
	private double exactK(double d) throws org.apache.commons.math.exception.MathArithmeticException {
		...
		final org.apache.commons.math.linear.FieldMatrix<org.apache.commons.math.fraction.BigFraction> H = org.apache.commons.math.distribution.KolmogorovSmirnovDistribution.this.createH(d);
	...
	private double roundedK(double d) throws org.apache.commons.math.exception.MathArithmeticException {
		final int k = ((int) (java.lang.Math.ceil(((n) * d))));
		final org.apache.commons.math.linear.FieldMatrix<org.apache.commons.math.fraction.BigFraction> HBigFraction = org.apache.commons.math.distribution.KolmogorovSmirnovDistribution.this.createH(d);
	...
	private org.apache.commons.math.linear.FieldMatrix<org.apache.commons.math.fraction.BigFraction> createH(double d) throws org.apache.commons.math.exception.NumberIsTooLargeException, org.apache.commons.math.fraction.FractionConversionException {
		int k = ((int) (java.lang.Math.ceil(((n) * d))));
		int m = (2 * k) - 1;
		double hDouble = k - ((n) * d);
		if (hDouble >= 1) {
			throw new org.apache.commons.math.exception.NumberIsTooLargeException(hDouble, 1.0, false);
		}
		...
		return new org.apache.commons.math.linear.Array2DRowFieldMatrix<org.apache.commons.math.fraction.BigFraction>(org.apache.commons.math.fraction.BigFractionField.getInstance(), Hdata);
	}
}
