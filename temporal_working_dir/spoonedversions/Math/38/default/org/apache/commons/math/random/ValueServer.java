...
public class ValueServer {
	...
	public ValueServer(org.apache.commons.math.random.RandomDataImpl randomData) {
	...
	public double getNext() throws java.io.IOException {
		switch (mode) {
			...
			case org.apache.commons.math.random.ValueServer.CONSTANT_MODE :
				return mu;
			default :
				throw new org.apache.commons.math.exception.MathIllegalStateException(org.apache.commons.math.exception.util.LocalizedFormats.UNKNOWN_MODE, mode, "DIGEST_MODE", org.apache.commons.math.random.ValueServer.DIGEST_MODE, "REPLAY_MODE", org.apache.commons.math.random.ValueServer.REPLAY_MODE, "UNIFORM_MODE", org.apache.commons.math.random.ValueServer.UNIFORM_MODE, "EXPONENTIAL_MODE", org.apache.commons.math.random.ValueServer.EXPONENTIAL_MODE, "GAUSSIAN_MODE", org.apache.commons.math.random.ValueServer.GAUSSIAN_MODE, "CONSTANT_MODE", org.apache.commons.math.random.ValueServer.CONSTANT_MODE);
		}
	}
	...
	public void computeDistribution() throws java.io.IOException {
		computeDistribution(org.apache.commons.math.random.EmpiricalDistributionImpl.DEFAULT_BIN_COUNT);
	}

	public void computeDistribution(int binCount) throws java.io.IOException {
		empiricalDistribution = new org.apache.commons.math.random.EmpiricalDistributionImpl(binCount, randomData);
	...
	private double getNextDigest() {
		if (((empiricalDistribution) == null) || ((empiricalDistribution.getBinStats().size()) == 0)) {
			throw new org.apache.commons.math.exception.MathIllegalStateException(org.apache.commons.math.exception.util.LocalizedFormats.DIGEST_NOT_INITIALIZED);
		}
	...
	private double getNextReplay() throws java.io.IOException {
		...
		if ((str = filePointer.readLine()) == null) {
			...
			resetReplayFile();
			if ((str = filePointer.readLine()) == null) {
				throw new org.apache.commons.math.exception.MathIllegalStateException(org.apache.commons.math.exception.util.LocalizedFormats.URL_CONTAINS_NO_DATA, valuesFileURL);
			}
		}
