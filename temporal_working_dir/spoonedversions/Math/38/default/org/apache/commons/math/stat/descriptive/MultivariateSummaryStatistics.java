...
public class MultivariateSummaryStatistics implements java.io.Serializable , org.apache.commons.math.stat.descriptive.StatisticalMultivariateSummary {
	...
	public boolean equals(java.lang.Object object) {
		...
		return ((((((((org.apache.commons.math.util.MathArrays.equalsIncludingNaN(stat.getGeometricMean(), getGeometricMean())) && (org.apache.commons.math.util.MathArrays.equalsIncludingNaN(stat.getMax(), getMax()))) && (org.apache.commons.math.util.MathArrays.equalsIncludingNaN(stat.getMean(), getMean()))) && (org.apache.commons.math.util.MathArrays.equalsIncludingNaN(stat.getMin(), getMin()))) && (org.apache.commons.math.util.Precision.equalsIncludingNaN(stat.getN(), getN()))) && (org.apache.commons.math.util.MathArrays.equalsIncludingNaN(stat.getSum(), getSum()))) && (org.apache.commons.math.util.MathArrays.equalsIncludingNaN(stat.getSumSq(), getSumSq()))) && (org.apache.commons.math.util.MathArrays.equalsIncludingNaN(stat.getSumLog(), getSumLog()))) && (stat.getCovariance().equals(getCovariance()));
	}
	...
	private void setImpl(org.apache.commons.math.stat.descriptive.StorelessUnivariateStatistic[] newImpl, org.apache.commons.math.stat.descriptive.StorelessUnivariateStatistic[] oldImpl) {
		checkEmpty();
	...
	private void checkEmpty() {
		if ((n) > 0) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalStateException(org.apache.commons.math.exception.util.LocalizedFormats.VALUES_ADDED_BEFORE_CONFIGURING_STATISTIC, n);
		}
	}

	private void checkDimension(int dimension) {
		if (dimension != (k)) {
			throw new org.apache.commons.math.exception.DimensionMismatchException(dimension, k);
		}
	}
}
