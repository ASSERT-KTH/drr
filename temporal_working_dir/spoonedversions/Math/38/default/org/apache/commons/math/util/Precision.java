...
public class Precision {
	...
	public static boolean equals(float x, float y) {
		return org.apache.commons.math.util.Precision.equals(x, y, 1);
	}

	public static boolean equalsIncludingNaN(float x, float y) {
		return ((java.lang.Float.isNaN(x)) && (java.lang.Float.isNaN(y))) || (org.apache.commons.math.util.Precision.equals(x, y, 1));
	}

	public static boolean equals(float x, float y, float eps) {
		return (org.apache.commons.math.util.Precision.equals(x, y, 1)) || ((org.apache.commons.math.util.FastMath.abs((y - x))) <= eps);
	}

	public static boolean equalsIncludingNaN(float x, float y, float eps) {
		return (org.apache.commons.math.util.Precision.equalsIncludingNaN(x, y)) || ((org.apache.commons.math.util.FastMath.abs((y - x))) <= eps);
	}
	...
	public static boolean equalsIncludingNaN(float x, float y, int maxUlps) {
		return ((java.lang.Float.isNaN(x)) && (java.lang.Float.isNaN(y))) || (org.apache.commons.math.util.Precision.equals(x, y, maxUlps));
	}
	...
	public static boolean equalsIncludingNaN(double x, double y) {
		return ((java.lang.Double.isNaN(x)) && (java.lang.Double.isNaN(y))) || (org.apache.commons.math.util.Precision.equals(x, y, 1));
	}
	...
	public static boolean equalsIncludingNaN(double x, double y, int maxUlps) {
		return ((java.lang.Double.isNaN(x)) && (java.lang.Double.isNaN(y))) || (org.apache.commons.math.util.Precision.equals(x, y, maxUlps));
	}

	public static double round(double x, int scale) {
		return org.apache.commons.math.util.Precision.round(x, scale, java.math.BigDecimal.ROUND_HALF_UP);
	}
	...
	public static float round(float x, int scale, int roundingMethod) {
		final float sign = org.apache.commons.math.util.FastMath.copySign(1.0F, x);
		final float factor = ((float) (org.apache.commons.math.util.FastMath.pow(10.0F, scale))) * sign;
