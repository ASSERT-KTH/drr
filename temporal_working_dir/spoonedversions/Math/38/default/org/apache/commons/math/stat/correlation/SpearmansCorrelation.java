...
public class SpearmansCorrelation {
	...
	public double correlation(final double[] xArray, final double[] yArray) throws java.lang.IllegalArgumentException {
		if ((xArray.length) != (yArray.length)) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.util.LocalizedFormats.DIMENSIONS_MISMATCH_SIMPLE, xArray.length, yArray.length);
		}else
			if ((xArray.length) < 2) {
