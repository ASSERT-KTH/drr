...
public class Frequency implements java.io.Serializable {
	...
	public void addValue(java.lang.Comparable<?> v) {
		...
		try {
			...
			throw new org.apache.commons.math.exception.MathIllegalArgumentException(org.apache.commons.math.exception.util.LocalizedFormats.INSTANCES_NOT_COMPARABLE_TO_EXISTING_VALUES, v.getClass().getName());
		}
	}
