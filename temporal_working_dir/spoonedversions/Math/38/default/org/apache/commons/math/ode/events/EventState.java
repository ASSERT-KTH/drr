...
public class EventState {
	...
	private org.apache.commons.math.ode.events.EventHandler.Action nextAction;
	...
	public boolean evaluateStep(final org.apache.commons.math.ode.sampling.StepInterpolator interpolator) throws org.apache.commons.math.exception.ConvergenceException {
		...
		final double h = dt / n;
		final org.apache.commons.math.analysis.UnivariateFunction f = new org.apache.commons.math.analysis.UnivariateFunction() {
		...
		for (int i = 0; i < n; ++i) {
			...
			if ((g0Positive) ^ (gb >= 0)) {
				...
				if ((solver) instanceof org.apache.commons.math.analysis.solvers.BracketedUnivariateRealSolver<?>) {
					...
					org.apache.commons.math.analysis.solvers.BracketedUnivariateRealSolver<org.apache.commons.math.analysis.UnivariateFunction> bracketing = ((org.apache.commons.math.analysis.solvers.BracketedUnivariateRealSolver<org.apache.commons.math.analysis.UnivariateFunction>) (solver));
					...
					org.apache.commons.math.analysis.solvers.BracketedUnivariateRealSolver<org.apache.commons.math.analysis.UnivariateFunction> bracketing = new org.apache.commons.math.analysis.solvers.PegasusSolver(solver.getRelativeAccuracy(), solver.getAbsoluteAccuracy());
	...
	public boolean stop() {
		return (nextAction) == (org.apache.commons.math.ode.events.EventHandler.Action.STOP);
	}
	...
	public boolean reset(final double t, final double[] y) {
		...
		if ((nextAction) == (org.apache.commons.math.ode.events.EventHandler.Action.RESET_STATE)) {
			handler.resetState(t, y);
		}
		pendingEvent = false;
		pendingEventTime = java.lang.Double.NaN;
		return ((nextAction) == (org.apache.commons.math.ode.events.EventHandler.Action.RESET_STATE)) || ((nextAction) == (org.apache.commons.math.ode.events.EventHandler.Action.RESET_DERIVATIVES));
	}
}
