...
public class OpenIntToFieldHashMap<T extends org.apache.commons.math.FieldElement<T>> implements java.io.Serializable {
	...
	private static int computeCapacity(final int expectedSize) {
		...
		final int capacity = ((int) (java.lang.Math.ceil((expectedSize / (org.apache.commons.math.util.OpenIntToFieldHashMap.LOAD_FACTOR)))));
	...
	public T get(final int key) {
		...
		for (int perturb = org.apache.commons.math.util.OpenIntToFieldHashMap.perturb(hash), j = index; (states[index]) != (org.apache.commons.math.util.OpenIntToFieldHashMap.FREE); perturb >>= org.apache.commons.math.util.OpenIntToFieldHashMap.PERTURB_SHIFT) {
	...
	public class Iterator {
		...
		public int key() throws java.util.ConcurrentModificationException, java.util.NoSuchElementException {
			if ((referenceCount) != (count)) {
				throw org.apache.commons.math.MathRuntimeException.createConcurrentModificationException("map has been modified while iterating");
			}
			if ((current) < 0) {
				throw org.apache.commons.math.MathRuntimeException.createNoSuchElementException("iterator exhausted");
			}
			return keys[current];
		}
