...
public class SimpleVectorialPointChecker implements java.io.Serializable , org.apache.commons.math.optimization.VectorialConvergenceChecker {
	...
	public SimpleVectorialPointChecker() {
		this.relativeThreshold = org.apache.commons.math.optimization.SimpleVectorialPointChecker.DEFAULT_RELATIVE_THRESHOLD;
		this.absoluteThreshold = org.apache.commons.math.optimization.SimpleVectorialPointChecker.DEFAULT_ABSOLUTE_THRESHOLD;
	}
