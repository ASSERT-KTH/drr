...
public abstract class AbstractListChromosome<T> extends org.apache.commons.math.genetics.Chromosome {
	...
	protected abstract void checkValidity(java.util.List<T> representation) throws org.apache.commons.math.genetics.InvalidRepresentationException;
	...
	public abstract org.apache.commons.math.genetics.AbstractListChromosome<T> newFixedLengthChromosome(final java.util.List<T> representation);
