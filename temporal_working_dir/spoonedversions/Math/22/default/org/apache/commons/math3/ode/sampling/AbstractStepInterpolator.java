...
public abstract class AbstractStepInterpolator implements org.apache.commons.math3.ode.sampling.StepInterpolator {
	...
	protected abstract void computeInterpolatedStateAndDerivatives(double theta, double oneMinusThetaH) throws org.apache.commons.math3.exception.MaxCountExceededException;
	...
	public double[] getInterpolatedSecondaryState(final int index) throws org.apache.commons.math3.exception.MaxCountExceededException {
		evaluateCompleteInterpolatedState();
		try {
	...
	public double[] getInterpolatedSecondaryDerivatives(final int index) throws org.apache.commons.math3.exception.MaxCountExceededException {
		evaluateCompleteInterpolatedState();
		try {
