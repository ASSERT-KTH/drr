...
class GraggBulirschStoerStepInterpolator extends org.apache.commons.math3.ode.sampling.AbstractStepInterpolator {
	...
	public GraggBulirschStoerStepInterpolator(final double[] y, final double[] y0Dot, final double[] y1, final double[] y1Dot, final double[][] yMidDots, final boolean forward, final org.apache.commons.math3.ode.EquationsMapper primaryMapper, final org.apache.commons.math3.ode.EquationsMapper[] secondaryMappers) {
		super(y, forward, primaryMapper, secondaryMappers);
		org.apache.commons.math3.ode.nonstiff.GraggBulirschStoerStepInterpolator.this.y0Dot = y0Dot;
		org.apache.commons.math3.ode.nonstiff.GraggBulirschStoerStepInterpolator.this.y1 = y1;
		org.apache.commons.math3.ode.nonstiff.GraggBulirschStoerStepInterpolator.this.y1Dot = y1Dot;
		org.apache.commons.math3.ode.nonstiff.GraggBulirschStoerStepInterpolator.this.yMidDots = yMidDots;
		resetTables(((yMidDots.length) + 4));
	}

	public GraggBulirschStoerStepInterpolator(final org.apache.commons.math3.ode.nonstiff.GraggBulirschStoerStepInterpolator interpolator) {
		super(interpolator);
		...
		if (maxDegree < 0) {
			...
			if (maxDegree <= 4) {
				...
				for (int i = 0; i < (errfac.length); ++i) {
					...
					final double e = 0.5 * (org.apache.commons.math3.util.FastMath.sqrt((((double) (i + 1)) / ip5)));
					for (int j = 0; j <= i; ++j) {
						errfac[i] *= e / (j + 1);
					}
				}
	...
	protected org.apache.commons.math3.ode.sampling.StepInterpolator doCopy() {
		return new org.apache.commons.math3.ode.nonstiff.GraggBulirschStoerStepInterpolator(org.apache.commons.math3.ode.nonstiff.GraggBulirschStoerStepInterpolator.this);
	}
	...
	public double estimateError(final double[] scale) {
		...
		if ((currentDegree) >= 5) {
			...
			error = (org.apache.commons.math3.util.FastMath.sqrt((error / (scale.length)))) * (errfac[((currentDegree) - 5)]);
		}
		return error;
	}
