...
public class RiddersSolver extends org.apache.commons.math3.analysis.solvers.AbstractUnivariateSolver {
	...
	@java.lang.Override
	protected double doSolve() throws org.apache.commons.math3.exception.NoBracketingException, org.apache.commons.math3.exception.TooManyEvaluationsException {
		double min = getMin();
		double max = getMax();
		double x1 = min;
