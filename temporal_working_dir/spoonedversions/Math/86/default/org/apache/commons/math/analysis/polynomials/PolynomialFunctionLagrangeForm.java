...
public class PolynomialFunctionLagrangeForm implements java.io.Serializable , org.apache.commons.math.analysis.UnivariateRealFunction {
	...
	public PolynomialFunctionLagrangeForm(double[] x, double[] y) throws java.lang.IllegalArgumentException {
		...
		org.apache.commons.math.analysis.polynomials.PolynomialFunctionLagrangeForm.this.x = new double[x.length];
		org.apache.commons.math.analysis.polynomials.PolynomialFunctionLagrangeForm.this.y = new double[y.length];
	...
	public static void verifyInterpolationArray(double[] x, double[] y) throws java.lang.IllegalArgumentException {
		if ((java.lang.Math.min(x.length, y.length)) < 2) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException("{0} points are required, got only {1}", 2, java.lang.Math.min(x.length, y.length));
		}
