...
public class FieldMatrixImpl<T extends org.apache.commons.math.FieldElement<T>> extends org.apache.commons.math.linear.AbstractFieldMatrix<T> implements java.io.Serializable {
	private static final long serialVersionUID = 7260756672015356458L;

	protected T[][] data;

	public FieldMatrixImpl(final org.apache.commons.math.Field<T> field) {
		super(field);
	}

	public FieldMatrixImpl(final org.apache.commons.math.Field<T> field, final int rowDimension, final int columnDimension) throws java.lang.IllegalArgumentException {
		super(field, rowDimension, columnDimension);
		data = org.apache.commons.math.linear.AbstractFieldMatrix.buildArray(field, rowDimension, columnDimension);
	}

	public FieldMatrixImpl(final T[][] d) throws java.lang.IllegalArgumentException, java.lang.NullPointerException {
		super(org.apache.commons.math.linear.AbstractFieldMatrix.extractField(d));
		copyIn(d);
	}

	public FieldMatrixImpl(final T[][] d, final boolean copyArray) throws java.lang.IllegalArgumentException, java.lang.NullPointerException {
		super(org.apache.commons.math.linear.AbstractFieldMatrix.extractField(d));
		if (copyArray) {
			copyIn(d);
		}else {
	...
	public org.apache.commons.math.linear.FieldMatrix<T> createMatrix(final int rowDimension, final int columnDimension) throws java.lang.IllegalArgumentException {
		return new org.apache.commons.math.linear.FieldMatrixImpl<T>(getField(), rowDimension, columnDimension);
	}

	@java.lang.Override
	public org.apache.commons.math.linear.FieldMatrix<T> copy() {
		return new org.apache.commons.math.linear.FieldMatrixImpl<T>(copyOut(), false);
	}
	...
	public org.apache.commons.math.linear.FieldMatrix<T> add(final org.apache.commons.math.linear.FieldMatrix<T> m) throws java.lang.IllegalArgumentException {
		try {
			return add(((org.apache.commons.math.linear.FieldMatrixImpl<T>) (m)));
		} catch (java.lang.ClassCastException cce) {
			return super.add(m);
		}
	}

	public org.apache.commons.math.linear.FieldMatrixImpl<T> add(final org.apache.commons.math.linear.FieldMatrixImpl<T> m) throws java.lang.IllegalArgumentException {
		...
		return new org.apache.commons.math.linear.FieldMatrixImpl<T>(outData, false);
	}
	...
	public org.apache.commons.math.linear.FieldMatrix<T> subtract(final org.apache.commons.math.linear.FieldMatrix<T> m) throws java.lang.IllegalArgumentException {
		try {
			return subtract(((org.apache.commons.math.linear.FieldMatrixImpl<T>) (m)));
		} catch (java.lang.ClassCastException cce) {
			return super.subtract(m);
		}
	}

	public org.apache.commons.math.linear.FieldMatrixImpl<T> subtract(final org.apache.commons.math.linear.FieldMatrixImpl<T> m) throws java.lang.IllegalArgumentException {
	...
	public org.apache.commons.math.linear.FieldMatrix<T> multiply(final org.apache.commons.math.linear.FieldMatrix<T> m) throws java.lang.IllegalArgumentException {
		try {
			return multiply(((org.apache.commons.math.linear.FieldMatrixImpl<T>) (m)));
		} catch (java.lang.ClassCastException cce) {
			return super.multiply(m);
		}
	}

	public org.apache.commons.math.linear.FieldMatrixImpl<T> multiply(final org.apache.commons.math.linear.FieldMatrixImpl<T> m) throws java.lang.IllegalArgumentException {
		checkMultiplicationCompatible(m);
		final int nRows = org.apache.commons.math.linear.FieldMatrixImpl.this.getRowDimension();
		final int nCols = m.getColumnDimension();
		final int nSum = org.apache.commons.math.linear.FieldMatrixImpl.this.getColumnDimension();
	...
	public T[] operate(final T[] v) throws java.lang.IllegalArgumentException {
		final int nRows = org.apache.commons.math.linear.FieldMatrixImpl.this.getRowDimension();
		final int nCols = org.apache.commons.math.linear.FieldMatrixImpl.this.getColumnDimension();
		if ((v.length) != nCols) {
