...
public class FieldVectorImpl<T extends org.apache.commons.math.FieldElement<T>> implements java.io.Serializable , org.apache.commons.math.linear.FieldVector<T> {
	...
	public FieldVectorImpl(final org.apache.commons.math.Field<T> field) {
		this(field, 0);
	}

	public FieldVectorImpl(org.apache.commons.math.Field<T> field, int size) {
		this.field = field;
	...
	public FieldVectorImpl(T[] d) throws java.lang.IllegalArgumentException {
		try {
			field = d[0].getField();
			data = d.clone();
	...
	public FieldVectorImpl(T[] d, boolean copyArray) throws java.lang.IllegalArgumentException, java.lang.NullPointerException {
		try {
			field = d[0].getField();
	...
	public FieldVectorImpl(org.apache.commons.math.linear.FieldVector<T> v) {
		field = v.getField();
	...
	public FieldVectorImpl(org.apache.commons.math.linear.FieldVectorImpl<T> v) {
		field = v.getField();
		data = v.data.clone();
	}

	public FieldVectorImpl(org.apache.commons.math.linear.FieldVectorImpl<T> v, boolean deep) {
		field = v.getField();
		data = (deep) ? v.data.clone() : v.data;
	}

	public FieldVectorImpl(org.apache.commons.math.linear.FieldVectorImpl<T> v1, org.apache.commons.math.linear.FieldVectorImpl<T> v2) {
		field = v1.getField();
	...
	public FieldVectorImpl(org.apache.commons.math.linear.FieldVectorImpl<T> v1, T[] v2) {
		field = v1.getField();
	...
	public FieldVectorImpl(T[] v1, org.apache.commons.math.linear.FieldVectorImpl<T> v2) {
		field = v2.getField();
	...
	public org.apache.commons.math.linear.FieldVector<T> copy() {
		return new org.apache.commons.math.linear.FieldVectorImpl<T>(org.apache.commons.math.linear.FieldVectorImpl.this, true);
	}
	...
	public org.apache.commons.math.linear.FieldVector<T> add(org.apache.commons.math.linear.FieldVector<T> v) throws java.lang.IllegalArgumentException {
		try {
			return add(((org.apache.commons.math.linear.FieldVectorImpl<T>) (v)));
			...
			return new org.apache.commons.math.linear.FieldVectorImpl<T>(out);
		}
	}
	...
	public org.apache.commons.math.linear.FieldVectorImpl<T> add(org.apache.commons.math.linear.FieldVectorImpl<T> v) throws java.lang.IllegalArgumentException {
		return ((org.apache.commons.math.linear.FieldVectorImpl<T>) (add(v.data)));
	}
	...
	public org.apache.commons.math.linear.FieldVector<T> subtract(org.apache.commons.math.linear.FieldVector<T> v) throws java.lang.IllegalArgumentException {
		try {
			return subtract(((org.apache.commons.math.linear.FieldVectorImpl<T>) (v)));
		} catch (java.lang.ClassCastException cce) {
			checkVectorDimensions(v);
			T[] out = buildArray(data.length);
			for (int i = 0; i < (data.length); i++) {
	...
	public org.apache.commons.math.linear.FieldVectorImpl<T> subtract(org.apache.commons.math.linear.FieldVectorImpl<T> v) throws java.lang.IllegalArgumentException {
		return ((org.apache.commons.math.linear.FieldVectorImpl<T>) (subtract(v.data)));
	}
	...
	public org.apache.commons.math.linear.FieldVector<T> mapAddToSelf(T d) {
		...
		return org.apache.commons.math.linear.FieldVectorImpl.this;
	}
	...
	public org.apache.commons.math.linear.FieldVector<T> ebeMultiply(org.apache.commons.math.linear.FieldVector<T> v) throws java.lang.IllegalArgumentException {
		try {
			return ebeMultiply(((org.apache.commons.math.linear.FieldVectorImpl<T>) (v)));
		} catch (java.lang.ClassCastException cce) {
			checkVectorDimensions(v);
			T[] out = buildArray(data.length);
			for (int i = 0; i < (data.length); i++) {
	...
	public org.apache.commons.math.linear.FieldVectorImpl<T> ebeMultiply(org.apache.commons.math.linear.FieldVectorImpl<T> v) throws java.lang.IllegalArgumentException {
		return ((org.apache.commons.math.linear.FieldVectorImpl<T>) (ebeMultiply(v.data)));
	}
	...
	public org.apache.commons.math.linear.FieldVector<T> ebeDivide(org.apache.commons.math.linear.FieldVector<T> v) throws java.lang.IllegalArgumentException {
		try {
			return ebeDivide(((org.apache.commons.math.linear.FieldVectorImpl<T>) (v)));
		} catch (java.lang.ClassCastException cce) {
			checkVectorDimensions(v);
			T[] out = buildArray(data.length);
			for (int i = 0; i < (data.length); i++) {
	...
	public org.apache.commons.math.linear.FieldVectorImpl<T> ebeDivide(org.apache.commons.math.linear.FieldVectorImpl<T> v) throws java.lang.IllegalArgumentException {
		return ((org.apache.commons.math.linear.FieldVectorImpl<T>) (ebeDivide(v.data)));
	}
	...
	public T dotProduct(org.apache.commons.math.linear.FieldVector<T> v) throws java.lang.IllegalArgumentException {
		try {
			return dotProduct(((org.apache.commons.math.linear.FieldVectorImpl<T>) (v)));
		} catch (java.lang.ClassCastException cce) {
			checkVectorDimensions(v);
			T dot = field.getZero();
			for (int i = 0; i < (data.length); i++) {
	...
	public T dotProduct(org.apache.commons.math.linear.FieldVectorImpl<T> v) throws java.lang.IllegalArgumentException {
	...
	public org.apache.commons.math.linear.FieldVector<T> projection(T[] v) {
		return projection(new org.apache.commons.math.linear.FieldVectorImpl<T>(v, false));
	}

	public org.apache.commons.math.linear.FieldVectorImpl<T> projection(org.apache.commons.math.linear.FieldVectorImpl<T> v) {
		return ((org.apache.commons.math.linear.FieldVectorImpl<T>) (v.mapMultiply(dotProduct(v).divide(v.dotProduct(v)))));
	}
	...
	public org.apache.commons.math.linear.FieldMatrix<T> outerProduct(org.apache.commons.math.linear.FieldVector<T> v) throws java.lang.IllegalArgumentException {
		try {
			return outerProduct(((org.apache.commons.math.linear.FieldVectorImpl<T>) (v)));
		} catch (java.lang.ClassCastException cce) {
			checkVectorDimensions(v);
			final int m = data.length;
			final org.apache.commons.math.linear.FieldMatrix<T> out = new org.apache.commons.math.linear.FieldMatrixImpl<T>(field, m, m);
			for (int i = 0; i < (data.length); i++) {
	...
	public org.apache.commons.math.linear.FieldMatrix<T> outerProduct(org.apache.commons.math.linear.FieldVectorImpl<T> v) throws java.lang.IllegalArgumentException {
	...
	public org.apache.commons.math.linear.FieldVector<T> append(org.apache.commons.math.linear.FieldVector<T> v) {
		try {
			return append(((org.apache.commons.math.linear.FieldVectorImpl<T>) (v)));
		} catch (java.lang.ClassCastException cce) {
			return new org.apache.commons.math.linear.FieldVectorImpl<T>(org.apache.commons.math.linear.FieldVectorImpl.this, new org.apache.commons.math.linear.FieldVectorImpl<T>(v));
		}
	}

	public org.apache.commons.math.linear.FieldVectorImpl<T> append(org.apache.commons.math.linear.FieldVectorImpl<T> v) {
		return new org.apache.commons.math.linear.FieldVectorImpl<T>(org.apache.commons.math.linear.FieldVectorImpl.this, v);
	}
	...
	public org.apache.commons.math.linear.FieldVector<T> append(T[] in) {
		return new org.apache.commons.math.linear.FieldVectorImpl<T>(org.apache.commons.math.linear.FieldVectorImpl.this, in);
	}

	public org.apache.commons.math.linear.FieldVector<T> getSubVector(int index, int n) {
		org.apache.commons.math.linear.FieldVectorImpl<T> out = new org.apache.commons.math.linear.FieldVectorImpl<T>(field, n);
		try {
	...
	public void setSubVector(int index, org.apache.commons.math.linear.FieldVector<T> v) {
		try {
			try {
				set(index, ((org.apache.commons.math.linear.FieldVectorImpl<T>) (v)));
			} catch (java.lang.ClassCastException cce) {
	...
	public void set(int index, org.apache.commons.math.linear.FieldVectorImpl<T> v) throws org.apache.commons.math.linear.MatrixIndexException {
	...
	public boolean equals(java.lang.Object other) {
		if ((org.apache.commons.math.linear.FieldVectorImpl.this) == other) {
			return true;
		}
		if (other == null) {
			return false;
