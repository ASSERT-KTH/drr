...
public abstract class MultistepIntegrator extends org.apache.commons.math.ode.AbstractIntegrator {
	...
	protected org.apache.commons.math.ode.sampling.StepInterpolator prototype;

	protected MultistepIntegrator(final java.lang.String name, final int k, final org.apache.commons.math.ode.sampling.StepInterpolator prototype) {
		super(name);
		...
		org.apache.commons.math.ode.MultistepIntegrator.this.prototype = prototype;
	}
	...
	public void setStarterIntegrator(org.apache.commons.math.ode.FirstOrderIntegrator starter) {
		org.apache.commons.math.ode.MultistepIntegrator.this.starter = starter;
	}
	...
	protected double start(final int n, final double h, final org.apache.commons.math.ode.events.CombinedEventsManager manager, final org.apache.commons.math.ode.FirstOrderDifferentialEquations equations, final double t0, final double[] y) throws org.apache.commons.math.ode.DerivativeException, org.apache.commons.math.ode.IntegratorException {
		...
		for (org.apache.commons.math.ode.events.EventState state : manager.getEventsStates()) {
			starter.addEventHandler(new org.apache.commons.math.ode.MultistepIntegrator.ResetCheckingWrapper(state.getEventHandler()), state.getMaxCheckInterval(), state.getConvergence(), state.getMaxIterationCount());
		}
		starter.clearStepHandlers();
		for (final org.apache.commons.math.ode.sampling.StepHandler handler : stepHandlers) {
			starter.addStepHandler(new org.apache.commons.math.ode.MultistepIntegrator.FilteringWrapper(handler));
		}
		final org.apache.commons.math.ode.MultistepIntegrator.StoringStepHandler store = new org.apache.commons.math.ode.MultistepIntegrator.StoringStepHandler(n);
		...
		do {
			...
			for (org.apache.commons.math.ode.events.EventHandler handler : starter.getEventHandlers()) {
				((org.apache.commons.math.ode.MultistepIntegrator.ResetCheckingWrapper) (handler)).setRange(t, java.lang.Math.abs(dt));
			}
			store.restart();
	...
	private class ResetCheckingWrapper implements org.apache.commons.math.ode.events.EventHandler {
		...
		public void setRange(final double rangeStart, final double rangeSize) {
			org.apache.commons.math.ode.MultistepIntegrator.ResetCheckingWrapper.this.rangeStart = rangeStart;
			org.apache.commons.math.ode.MultistepIntegrator.ResetCheckingWrapper.this.rangeSize = rangeSize;
		}
		...
		public int eventOccurred(double t, double[] y, boolean increasing) throws org.apache.commons.math.ode.events.EventException {
			...
			if ((java.lang.Math.abs((t - (rangeStart)))) < (1.0E-10 * (rangeSize))) {
				return action;
			}
