	...
	public double evaluate(double x, double epsilon, int maxIterations) {
		...
		while ((n < maxIterations) && (relativeError > epsilon)) {
			...
			if ((java.lang.Double.isInfinite(p2)) || (java.lang.Double.isInfinite(q2))) {
				...
				if (scale <= 0) {
					throw new org.apache.commons.math.exception.ConvergenceException(org.apache.commons.math.exception.util.LocalizedFormats.CONTINUED_FRACTION_INFINITY_DIVERGENCE, x);
				}
				infinite = true;
			...
			if (java.lang.Double.isNaN(r)) {
				throw new org.apache.commons.math.exception.ConvergenceException(org.apache.commons.math.exception.util.LocalizedFormats.CONTINUED_FRACTION_NAN_DIVERGENCE, x);
			}
		...
		if (n >= maxIterations) {
			throw new org.apache.commons.math.exception.MaxCountExceededException(org.apache.commons.math.exception.util.LocalizedFormats.NON_CONVERGENT_CONTINUED_FRACTION, maxIterations, x);
		}
		return c;
	}
}
