...
public class Kurtosis extends org.apache.commons.math.stat.descriptive.AbstractStorelessUnivariateStatistic implements java.io.Serializable {
	...
	public Kurtosis(org.apache.commons.math.stat.descriptive.moment.Kurtosis original) {
		org.apache.commons.math.stat.descriptive.moment.Kurtosis.copy(original, org.apache.commons.math.stat.descriptive.moment.Kurtosis.this);
	}
	...
	public void increment(final double d) {
		if (incMoment) {
			...
			throw org.apache.commons.math.MathRuntimeException.createIllegalStateException(org.apache.commons.math.exception.util.LocalizedFormats.CANNOT_INCREMENT_STATISTIC_CONSTRUCTED_FROM_EXTERNAL_MOMENTS);
		}
	}
	...
	public void clear() {
		if (incMoment) {
			...
			throw org.apache.commons.math.MathRuntimeException.createIllegalStateException(org.apache.commons.math.exception.util.LocalizedFormats.CANNOT_CLEAR_STATISTIC_CONSTRUCTED_FROM_EXTERNAL_MOMENTS);
		}
	}
	...
	public double evaluate(final double[] values, final int begin, final int length) {
		...
		if ((test(values, begin, length)) && (length > 3)) {
			...
			for (int i = begin; i < (begin + length); i++) {
				accum3 += org.apache.commons.math.util.FastMath.pow(((values[i]) - mean), 4.0);
			}
			accum3 /= org.apache.commons.math.util.FastMath.pow(stdDev, 4.0);
			double n0 = length;
			double coefficientOne = (n0 * (n0 + 1)) / (((n0 - 1) * (n0 - 2)) * (n0 - 3));
			double termTwo = (3 * (org.apache.commons.math.util.FastMath.pow((n0 - 1), 2.0))) / ((n0 - 2) * (n0 - 3));
	...
	public org.apache.commons.math.stat.descriptive.moment.Kurtosis copy() {
		...
		org.apache.commons.math.stat.descriptive.moment.Kurtosis.copy(org.apache.commons.math.stat.descriptive.moment.Kurtosis.this, result);
		return result;
	}

	public static void copy(org.apache.commons.math.stat.descriptive.moment.Kurtosis source, org.apache.commons.math.stat.descriptive.moment.Kurtosis dest) throws org.apache.commons.math.exception.NullArgumentException {
