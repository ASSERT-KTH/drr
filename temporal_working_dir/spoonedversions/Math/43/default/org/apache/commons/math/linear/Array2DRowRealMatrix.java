...
public class Array2DRowRealMatrix extends org.apache.commons.math.linear.AbstractRealMatrix implements java.io.Serializable {
	...
	public Array2DRowRealMatrix(final double[][] d) throws org.apache.commons.math.exception.DimensionMismatchException, org.apache.commons.math.exception.NoDataException, org.apache.commons.math.exception.NullArgumentException {
		copyIn(d);
	}
	...
	public Array2DRowRealMatrix(final double[][] d, final boolean copyArray) {
		if (copyArray) {
			...
			for (int r = 1; r < nRows; r++) {
				if ((d[r].length) != nCols) {
					throw new org.apache.commons.math.exception.DimensionMismatchException(d[r].length, nCols);
				}
			}
			data = d;
		}
	...
	@java.lang.Override
	public org.apache.commons.math.linear.RealMatrix createMatrix(final int rowDimension, final int columnDimension) {
	...
	public org.apache.commons.math.linear.Array2DRowRealMatrix add(final org.apache.commons.math.linear.Array2DRowRealMatrix m) {
	...
	public org.apache.commons.math.linear.Array2DRowRealMatrix subtract(final org.apache.commons.math.linear.Array2DRowRealMatrix m) {
	...
	public org.apache.commons.math.linear.Array2DRowRealMatrix multiply(final org.apache.commons.math.linear.Array2DRowRealMatrix m) {
		...
		if ((data) == null) {
			...
			for (int i = 0; i < (data.length); ++i) {
				if ((subMatrix[i].length) != nCols) {
					throw new org.apache.commons.math.exception.DimensionMismatchException(subMatrix[i].length, nCols);
				}
	...
	public double getEntry(final int row, final int column) {
		org.apache.commons.math.linear.MatrixUtils.checkMatrixIndex(org.apache.commons.math.linear.Array2DRowRealMatrix.this, row, column);
	...
	private void copyIn(final double[][] in) throws org.apache.commons.math.exception.DimensionMismatchException, org.apache.commons.math.exception.NoDataException, org.apache.commons.math.exception.NullArgumentException {
		setSubMatrix(in, 0, 0);
	}
}
