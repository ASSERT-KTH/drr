...
public abstract class AbstractConvergenceChecker<PAIR> implements org.apache.commons.math.optimization.ConvergenceChecker<PAIR> {
	private static final double DEFAULT_RELATIVE_THRESHOLD = 100 * (org.apache.commons.math.util.Precision.EPSILON);

	private static final double DEFAULT_ABSOLUTE_THRESHOLD = 100 * (org.apache.commons.math.util.Precision.SAFE_MIN);
