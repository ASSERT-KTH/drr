...
public class GammaDistribution extends org.apache.commons.math.distribution.AbstractContinuousDistribution implements java.io.Serializable {
	...
	public GammaDistribution(double alpha, double beta) {
		this(alpha, beta, org.apache.commons.math.distribution.GammaDistribution.DEFAULT_INVERSE_ABSOLUTE_ACCURACY);
	}

	public GammaDistribution(double alpha, double beta, double inverseCumAccuracy) throws org.apache.commons.math.exception.NotStrictlyPositiveException {
		if (alpha <= 0) {
