...
public class Fraction extends java.lang.Number implements java.io.Serializable , java.lang.Comparable<org.apache.commons.math.fraction.Fraction> , org.apache.commons.math.FieldElement<org.apache.commons.math.fraction.Fraction> {
	...
	private Fraction(double value, double epsilon, int maxDenominator, int maxIterations) throws org.apache.commons.math.fraction.FractionConversionException {
		...
		do {
			++n;
			double r1 = 1.0 / (r0 - a0);
			long a1 = ((long) (org.apache.commons.math.util.FastMath.floor(r1)));
			p2 = (a1 * p1) + p0;
			q2 = (a1 * q1) + q0;
	...
	public Fraction(int num, int den) {
		if (den == 0) {
			throw new org.apache.commons.math.exception.MathArithmeticException(org.apache.commons.math.exception.util.LocalizedFormats.ZERO_DENOMINATOR_IN_FRACTION, num, den);
		}
		if (den < 0) {
			if ((num == (java.lang.Integer.MIN_VALUE)) || (den == (java.lang.Integer.MIN_VALUE))) {
				throw new org.apache.commons.math.exception.MathArithmeticException(org.apache.commons.math.exception.util.LocalizedFormats.OVERFLOW_IN_FRACTION, num, den);
			}
			num = -num;
			den = -den;
		}
		final int d = org.apache.commons.math.util.ArithmeticUtils.gcd(num, den);
		if (d > 1) {
			num /= d;
			den /= d;
		}
	...
	public org.apache.commons.math.fraction.Fraction negate() {
		if ((numerator) == (java.lang.Integer.MIN_VALUE)) {
			throw new org.apache.commons.math.exception.MathArithmeticException(org.apache.commons.math.exception.util.LocalizedFormats.OVERFLOW_IN_FRACTION, numerator, denominator);
		}
	...
	private org.apache.commons.math.fraction.Fraction addSub(org.apache.commons.math.fraction.Fraction fraction, boolean isAdd) {
		...
		int d1 = org.apache.commons.math.util.ArithmeticUtils.gcd(denominator, fraction.denominator);
		if (d1 == 1) {
			int uvp = org.apache.commons.math.util.ArithmeticUtils.mulAndCheck(numerator, fraction.denominator);
			int upv = org.apache.commons.math.util.ArithmeticUtils.mulAndCheck(fraction.numerator, denominator);
			return new org.apache.commons.math.fraction.Fraction((isAdd ? org.apache.commons.math.util.ArithmeticUtils.addAndCheck(uvp, upv) : org.apache.commons.math.util.ArithmeticUtils.subAndCheck(uvp, upv)), org.apache.commons.math.util.ArithmeticUtils.mulAndCheck(denominator, fraction.denominator));
		}
		...
		int d2 = tmodd1 == 0 ? d1 : org.apache.commons.math.util.ArithmeticUtils.gcd(tmodd1, d1);
		java.math.BigInteger w = t.divide(java.math.BigInteger.valueOf(d2));
		if ((w.bitLength()) > 31) {
			throw new org.apache.commons.math.exception.MathArithmeticException(org.apache.commons.math.exception.util.LocalizedFormats.NUMERATOR_OVERFLOW_AFTER_MULTIPLY, w);
		}
		return new org.apache.commons.math.fraction.Fraction(w.intValue(), org.apache.commons.math.util.ArithmeticUtils.mulAndCheck(((denominator) / d1), ((fraction.denominator) / d2)));
	}
	...
	public org.apache.commons.math.fraction.Fraction multiply(org.apache.commons.math.fraction.Fraction fraction) {
		...
		int d1 = org.apache.commons.math.util.ArithmeticUtils.gcd(numerator, fraction.denominator);
		int d2 = org.apache.commons.math.util.ArithmeticUtils.gcd(fraction.numerator, denominator);
		return org.apache.commons.math.fraction.Fraction.getReducedFraction(org.apache.commons.math.util.ArithmeticUtils.mulAndCheck(((numerator) / d1), ((fraction.numerator) / d2)), org.apache.commons.math.util.ArithmeticUtils.mulAndCheck(((denominator) / d2), ((fraction.denominator) / d1)));
	}
	...
	public org.apache.commons.math.fraction.Fraction divide(org.apache.commons.math.fraction.Fraction fraction) {
		...
		if ((fraction.numerator) == 0) {
			throw new org.apache.commons.math.exception.MathArithmeticException(org.apache.commons.math.exception.util.LocalizedFormats.ZERO_FRACTION_TO_DIVIDE_BY, fraction.numerator, fraction.denominator);
		}
	...
	public static org.apache.commons.math.fraction.Fraction getReducedFraction(int numerator, int denominator) {
		if (denominator == 0) {
			throw new org.apache.commons.math.exception.MathArithmeticException(org.apache.commons.math.exception.util.LocalizedFormats.ZERO_DENOMINATOR_IN_FRACTION, numerator, denominator);
		}
		if (numerator == 0) {
			return org.apache.commons.math.fraction.Fraction.ZERO;
		}
		...
		int gcd = org.apache.commons.math.util.ArithmeticUtils.gcd(numerator, denominator);
		numerator /= gcd;
		denominator /= gcd;
		return new org.apache.commons.math.fraction.Fraction(numerator, denominator);
	}
