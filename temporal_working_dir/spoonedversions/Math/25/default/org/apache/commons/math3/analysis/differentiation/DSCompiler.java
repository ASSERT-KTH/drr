...
public class DSCompiler {
	...
	public static org.apache.commons.math3.analysis.differentiation.DSCompiler getCompiler(int parameters, int order) {
		...
		for (int diag = 0; diag <= (maxParameters + maxOrder); ++diag) {
			for (int o = org.apache.commons.math3.util.FastMath.max(0, (diag - maxParameters)); o <= (org.apache.commons.math3.util.FastMath.min(maxOrder, diag)); ++o) {
				final int p = diag - o;
	...
	private DSCompiler(final int parameters, final int order, final org.apache.commons.math3.analysis.differentiation.DSCompiler valueCompiler, final org.apache.commons.math3.analysis.differentiation.DSCompiler derivativeCompiler) {
		...
		this.order = order;
		this.sizes = org.apache.commons.math3.analysis.differentiation.DSCompiler.compileSizes(parameters, order, valueCompiler, derivativeCompiler);
		...
		this.compIndirection = org.apache.commons.math3.analysis.differentiation.DSCompiler.compileCompositionIndirection(parameters, order, valueCompiler, derivativeCompiler, sizes, derivativesIndirection, lowerIndirection);
	}

	private static int[][] compileSizes(final int parameters, final int order, final org.apache.commons.math3.analysis.differentiation.DSCompiler valueCompiler, final org.apache.commons.math3.analysis.differentiation.DSCompiler derivativeCompiler) {
	...
	private static int[][][] compileCompositionIndirection(final int parameters, final int order, final org.apache.commons.math3.analysis.differentiation.DSCompiler valueCompiler, final org.apache.commons.math3.analysis.differentiation.DSCompiler derivativeCompiler, final int[][] sizes, final int[][] derivativesIndirection, final int[] lowerIndirection) {
		if ((parameters == 0) || (order == 0)) {
