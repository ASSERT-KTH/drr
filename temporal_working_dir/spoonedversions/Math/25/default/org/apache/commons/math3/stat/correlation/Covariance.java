...
public class Covariance {
	...
	public Covariance(org.apache.commons.math3.linear.RealMatrix matrix, boolean biasCorrected) {
		checkSufficientData(matrix);
		n = matrix.getRowDimension();
		covarianceMatrix = computeCovarianceMatrix(matrix, biasCorrected);
	}

	public Covariance(org.apache.commons.math3.linear.RealMatrix matrix) {
		this(matrix, true);
	}
	...
	protected org.apache.commons.math3.linear.RealMatrix computeCovarianceMatrix(org.apache.commons.math3.linear.RealMatrix matrix, boolean biasCorrected) {
	...
	protected org.apache.commons.math3.linear.RealMatrix computeCovarianceMatrix(org.apache.commons.math3.linear.RealMatrix matrix) {
		return computeCovarianceMatrix(matrix, true);
	}

	protected org.apache.commons.math3.linear.RealMatrix computeCovarianceMatrix(double[][] data, boolean biasCorrected) {
		return computeCovarianceMatrix(new org.apache.commons.math3.linear.BlockRealMatrix(data), biasCorrected);
	}

	protected org.apache.commons.math3.linear.RealMatrix computeCovarianceMatrix(double[][] data) {
