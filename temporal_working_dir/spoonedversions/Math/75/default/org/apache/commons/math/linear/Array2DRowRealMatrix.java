...
public class Array2DRowRealMatrix extends org.apache.commons.math.linear.AbstractRealMatrix implements java.io.Serializable {
	...
	public Array2DRowRealMatrix(final double[][] d, final boolean copyArray) throws java.lang.IllegalArgumentException, java.lang.NullPointerException {
		if (copyArray) {
			...
			if (nRows == 0) {
				throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.linear.Array2DRowRealMatrix.AT_LEAST_ONE_ROW_MESSAGE);
			}
			final int nCols = d[0].length;
			if (nCols == 0) {
				throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.linear.Array2DRowRealMatrix.AT_LEAST_ONE_COLUMN_MESSAGE);
			}
			for (int r = 1; r < nRows; r++) {
				if ((d[r].length) != nCols) {
					throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.linear.Array2DRowRealMatrix.DIFFERENT_ROWS_LENGTHS_MESSAGE, nCols, d[r].length);
				}
			}
			data = d;
		}
		...
		if ((data) == null) {
			...
			for (int i = 0; i < (data.length); ++i) {
				if ((subMatrix[i].length) != nCols) {
					throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.linear.Array2DRowRealMatrix.DIFFERENT_ROWS_LENGTHS_MESSAGE, nCols, subMatrix[i].length);
				}
	...
	public double getEntry(final int row, final int column) throws org.apache.commons.math.linear.MatrixIndexException {
		try {
			...
			throw new org.apache.commons.math.linear.MatrixIndexException(org.apache.commons.math.linear.Array2DRowRealMatrix.NO_ENTRY_MESSAGE, row, column, getRowDimension(), getColumnDimension());
		}
	}
	...
	public double[] operate(final double[] v) throws java.lang.IllegalArgumentException {
		...
		if ((v.length) != nCols) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.linear.Array2DRowRealMatrix.VECTOR_LENGTHS_MISMATCH, v.length, nCols);
		}
	...
	public double[] preMultiply(final double[] v) throws java.lang.IllegalArgumentException {
		...
		if ((v.length) != nRows) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.linear.Array2DRowRealMatrix.VECTOR_LENGTHS_MISMATCH, v.length, nRows);
		}
