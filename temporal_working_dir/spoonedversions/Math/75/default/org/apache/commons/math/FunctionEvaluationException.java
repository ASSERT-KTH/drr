...
public class FunctionEvaluationException extends org.apache.commons.math.MathException {
	...
	public FunctionEvaluationException(double argument) {
		super(org.apache.commons.math.FunctionEvaluationException.FAILED_EVALUATION_MESSAGE, argument);
		org.apache.commons.math.FunctionEvaluationException.this.argument = new double[]{ argument };
	}

	public FunctionEvaluationException(double[] argument) {
		super(org.apache.commons.math.FunctionEvaluationException.FAILED_EVALUATION_MESSAGE, new org.apache.commons.math.linear.ArrayRealVector(argument));
