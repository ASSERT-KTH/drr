...
public class DormandPrince54Integrator extends org.apache.commons.math.ode.nonstiff.EmbeddedRungeKuttaIntegrator {
	...
	public DormandPrince54Integrator(final double minStep, final double maxStep, final double scalAbsoluteTolerance, final double scalRelativeTolerance) {
		super(org.apache.commons.math.ode.nonstiff.DormandPrince54Integrator.METHOD_NAME, true, org.apache.commons.math.ode.nonstiff.DormandPrince54Integrator.STATIC_C, org.apache.commons.math.ode.nonstiff.DormandPrince54Integrator.STATIC_A, org.apache.commons.math.ode.nonstiff.DormandPrince54Integrator.STATIC_B, new org.apache.commons.math.ode.nonstiff.DormandPrince54StepInterpolator(), minStep, maxStep, scalAbsoluteTolerance, scalRelativeTolerance);
	}
	...
	public DormandPrince54Integrator(final double minStep, final double maxStep, final double[] vecAbsoluteTolerance, final double[] vecRelativeTolerance) {
		super(org.apache.commons.math.ode.nonstiff.DormandPrince54Integrator.METHOD_NAME, true, org.apache.commons.math.ode.nonstiff.DormandPrince54Integrator.STATIC_C, org.apache.commons.math.ode.nonstiff.DormandPrince54Integrator.STATIC_A, org.apache.commons.math.ode.nonstiff.DormandPrince54Integrator.STATIC_B, new org.apache.commons.math.ode.nonstiff.DormandPrince54StepInterpolator(), minStep, maxStep, vecAbsoluteTolerance, vecRelativeTolerance);
	}
