...
public class Rotation implements java.io.Serializable {
	...
	public Rotation(org.apache.commons.math.geometry.euclidean.threed.Vector3D u1, org.apache.commons.math.geometry.euclidean.threed.Vector3D u2, org.apache.commons.math.geometry.euclidean.threed.Vector3D v1, org.apache.commons.math.geometry.euclidean.threed.Vector3D v2) {
		double u1u1 = org.apache.commons.math.geometry.euclidean.threed.Vector3D.dotProduct(u1, u1);
		double u2u2 = org.apache.commons.math.geometry.euclidean.threed.Vector3D.dotProduct(u2, u2);
		double v1v1 = org.apache.commons.math.geometry.euclidean.threed.Vector3D.dotProduct(v1, v1);
		double v2v2 = org.apache.commons.math.geometry.euclidean.threed.Vector3D.dotProduct(v2, v2);
		...
		v1 = new org.apache.commons.math.geometry.euclidean.threed.Vector3D(v1x, v1y, v1z);
		double u1u2 = org.apache.commons.math.geometry.euclidean.threed.Vector3D.dotProduct(u1, u2);
		double v1v2 = org.apache.commons.math.geometry.euclidean.threed.Vector3D.dotProduct(v1, v2);
		...
		v2 = new org.apache.commons.math.geometry.euclidean.threed.Vector3D(v2x, v2y, v2z);
		...
		org.apache.commons.math.geometry.euclidean.threed.Vector3D k = new org.apache.commons.math.geometry.euclidean.threed.Vector3D(((dy1 * dz2) - (dz1 * dy2)), ((dz1 * dx2) - (dx1 * dz2)), ((dx1 * dy2) - (dy1 * dx2)));
		double c = (((k.getX()) * ((u1y * u2z) - (u1z * u2y))) + ((k.getY()) * ((u1z * u2x) - (u1x * u2z)))) + ((k.getZ()) * ((u1x * u2y) - (u1y * u2x)));
		if (c == 0) {
			org.apache.commons.math.geometry.euclidean.threed.Vector3D u3 = org.apache.commons.math.geometry.euclidean.threed.Vector3D.crossProduct(u1, u2);
			...
			double dy3 = v3y - u3y;
			double dz3 = v3z - u3z;
			k = new org.apache.commons.math.geometry.euclidean.threed.Vector3D(((dy1 * dz3) - (dz1 * dy3)), ((dz1 * dx3) - (dx1 * dz3)), ((dx1 * dy3) - (dy1 * dx3)));
			c = (((k.getX()) * ((u1y * u3z) - (u1z * u3y))) + ((k.getY()) * ((u1z * u3x) - (u1x * u3z)))) + ((k.getZ()) * ((u1x * u3y) - (u1y * u3x)));
			if (c == 0) {
				k = new org.apache.commons.math.geometry.euclidean.threed.Vector3D(((dy2 * dz3) - (dz2 * dy3)), ((dz2 * dx3) - (dx2 * dz3)), ((dx2 * dy3) - (dy2 * dx3)));
		...
		c = org.apache.commons.math.geometry.euclidean.threed.Vector3D.dotProduct(k, k);
		q0 = (org.apache.commons.math.geometry.euclidean.threed.Vector3D.dotProduct(vRef, k)) / (c + c);
	}
	...
	public Rotation(org.apache.commons.math.geometry.euclidean.threed.Vector3D u, org.apache.commons.math.geometry.euclidean.threed.Vector3D v) {
		...
		double dot = org.apache.commons.math.geometry.euclidean.threed.Vector3D.dotProduct(u, v);
