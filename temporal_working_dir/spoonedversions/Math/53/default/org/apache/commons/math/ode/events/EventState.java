			...
			for (int i = 0; i < n; ++i) {
				...
				if ((g0Positive) ^ (gb >= 0)) {
					...
					if ((solver) instanceof org.apache.commons.math.analysis.solvers.BracketedUnivariateRealSolver<?>) {
						...
						root = (forward) ? bracketing.solve(maxIterationCount, f, ta, tb, org.apache.commons.math.analysis.solvers.AllowedSolutions.RIGHT_SIDE) : bracketing.solve(maxIterationCount, f, tb, ta, org.apache.commons.math.analysis.solvers.AllowedSolutions.LEFT_SIDE);
					}else {
						...
						root = (forward) ? org.apache.commons.math.analysis.solvers.UnivariateRealSolverUtils.forceSide(remainingEval, f, bracketing, baseRoot, ta, tb, org.apache.commons.math.analysis.solvers.AllowedSolutions.RIGHT_SIDE) : org.apache.commons.math.analysis.solvers.UnivariateRealSolverUtils.forceSide(remainingEval, f, bracketing, baseRoot, tb, ta, org.apache.commons.math.analysis.solvers.AllowedSolutions.LEFT_SIDE);
					}
