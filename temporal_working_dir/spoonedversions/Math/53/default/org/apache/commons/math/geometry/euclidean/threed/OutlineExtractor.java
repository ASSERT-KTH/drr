...
public class OutlineExtractor {
	...
	private class BoundaryProjector implements org.apache.commons.math.geometry.partitioning.BSPTreeVisitor<org.apache.commons.math.geometry.euclidean.threed.Euclidean3D> {
		...
		private void addContribution(final org.apache.commons.math.geometry.partitioning.SubHyperplane<org.apache.commons.math.geometry.euclidean.threed.Euclidean3D> facet, final boolean reversed) {
			...
			final double scal = org.apache.commons.math.geometry.euclidean.threed.Vector3D.dotProduct(plane.getNormal(), w);
			if ((org.apache.commons.math.util.FastMath.abs(scal)) > 0.001) {
				...
				for (org.apache.commons.math.geometry.euclidean.twod.Vector2D[] loop : vertices) {
					...
					org.apache.commons.math.geometry.euclidean.twod.Vector2D pPoint = new org.apache.commons.math.geometry.euclidean.twod.Vector2D(org.apache.commons.math.geometry.euclidean.threed.Vector3D.dotProduct(previous3D, u), org.apache.commons.math.geometry.euclidean.threed.Vector3D.dotProduct(previous3D, v));
					while (current < (loop.length)) {
						...
						final org.apache.commons.math.geometry.euclidean.twod.Vector2D cPoint = new org.apache.commons.math.geometry.euclidean.twod.Vector2D(org.apache.commons.math.geometry.euclidean.threed.Vector3D.dotProduct(current3D, u), org.apache.commons.math.geometry.euclidean.threed.Vector3D.dotProduct(current3D, v));
