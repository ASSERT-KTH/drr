...
public abstract class AbstractScalarDifferentiableOptimizer extends org.apache.commons.math.optimization.direct.BaseAbstractScalarOptimizer<org.apache.commons.math.analysis.DifferentiableMultivariateRealFunction> implements org.apache.commons.math.optimization.DifferentiableMultivariateRealOptimizer {
	...
	protected double[] computeObjectiveGradient(final double[] evaluationPoint) throws org.apache.commons.math.exception.MathUserException {
		return gradient.value(evaluationPoint);
	}

	@java.lang.Override
	public org.apache.commons.math.optimization.RealPointValuePair optimize(int maxEval, final org.apache.commons.math.analysis.DifferentiableMultivariateRealFunction f, final org.apache.commons.math.optimization.GoalType goalType, final double[] startPoint) throws org.apache.commons.math.exception.MathUserException {
		gradient = f.gradient();
