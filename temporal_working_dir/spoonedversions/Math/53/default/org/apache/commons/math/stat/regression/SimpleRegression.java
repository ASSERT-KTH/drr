...
public class SimpleRegression implements java.io.Serializable {
	...
	public SimpleRegression(int degrees) {
		distribution = new org.apache.commons.math.distribution.TDistributionImpl(degrees);
	}
	...
	public void addData(double x, double y) {
		...
		(n)++;
		if ((n) > 2) {
			distribution = new org.apache.commons.math.distribution.TDistributionImpl(((n) - 2));
		}
	}
