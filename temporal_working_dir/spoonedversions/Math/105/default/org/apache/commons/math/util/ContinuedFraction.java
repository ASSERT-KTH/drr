...
public abstract class ContinuedFraction implements java.io.Serializable {
	...
	public double evaluate(double x, double epsilon, int maxIterations) throws org.apache.commons.math.MathException {
			...
			if ((java.lang.Double.isInfinite(p2)) || (java.lang.Double.isInfinite(q2))) {
				if (a != 0.0) {
					...
					if (b != 0) {
						...
						throw new org.apache.commons.math.ConvergenceException(("Continued fraction convergents diverged to +/- " + "infinity."));
					}
		...
		if (n >= maxIterations) {
			throw new org.apache.commons.math.ConvergenceException("Continued fraction convergents failed to converge.");
		}
		return c;
	}
}
