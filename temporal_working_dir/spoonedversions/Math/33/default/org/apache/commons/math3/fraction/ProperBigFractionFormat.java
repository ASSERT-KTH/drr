...
public class ProperBigFractionFormat extends org.apache.commons.math3.fraction.BigFractionFormat {
	private static final long serialVersionUID = -6337346779577272307L;

	private java.text.NumberFormat wholeFormat;

	public ProperBigFractionFormat() {
		this(org.apache.commons.math3.fraction.AbstractFormat.getDefaultNumberFormat());
	}
	...
	@java.lang.Override
	public java.lang.StringBuffer format(final org.apache.commons.math3.fraction.BigFraction fraction, final java.lang.StringBuffer toAppendTo, final java.text.FieldPosition pos) {
		pos.setBeginIndex(0);
		pos.setEndIndex(0);
	...
	public org.apache.commons.math3.fraction.BigFraction parse(final java.lang.String source, final java.text.ParsePosition pos) {
		org.apache.commons.math3.fraction.BigFraction ret = super.parse(source, pos);
		if (ret != null) {
			return ret;
		}
	...
	public void setWholeFormat(final java.text.NumberFormat format) {
		if (format == null) {
			throw new org.apache.commons.math3.exception.NullArgumentException(org.apache.commons.math3.exception.util.LocalizedFormats.WHOLE_FORMAT);
		}
		org.apache.commons.math3.fraction.ProperBigFractionFormat.this.wholeFormat = format;
	}
}
