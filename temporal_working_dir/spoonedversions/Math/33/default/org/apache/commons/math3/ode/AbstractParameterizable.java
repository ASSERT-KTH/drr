...
public abstract class AbstractParameterizable implements org.apache.commons.math3.ode.Parameterizable {
	...
	public void complainIfNotSupported(final java.lang.String name) throws org.apache.commons.math3.exception.MathIllegalArgumentException {
		if (!(isSupported(name))) {
			throw new org.apache.commons.math3.exception.MathIllegalArgumentException(org.apache.commons.math3.exception.util.LocalizedFormats.UNKNOWN_PARAMETER, name);
		}
	}
}
