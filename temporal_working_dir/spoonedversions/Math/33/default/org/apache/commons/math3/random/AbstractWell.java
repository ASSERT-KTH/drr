...
public abstract class AbstractWell extends org.apache.commons.math3.random.BitsStreamGenerator implements java.io.Serializable {
	...
	protected AbstractWell(final int k, final int m1, final int m2, final int m3, final int[] seed) {
		...
		final int r = ((k + w) - 1) / w;
		this.v = new int[r];
		org.apache.commons.math3.random.AbstractWell.this.index = 0;
		iRm1 = new int[r];
		iRm2 = new int[r];
		i1 = new int[r];
		i2 = new int[r];
	...
	public void setSeed(final int[] seed) {
		if (seed == null) {
			setSeed(((java.lang.System.currentTimeMillis()) + (java.lang.System.identityHashCode(org.apache.commons.math3.random.AbstractWell.this))));
			return ;
		}
