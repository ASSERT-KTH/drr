...
public class Plane implements org.apache.commons.math3.geometry.partitioning.Embedding<org.apache.commons.math3.geometry.euclidean.threed.Euclidean3D, org.apache.commons.math3.geometry.euclidean.twod.Euclidean2D> , org.apache.commons.math3.geometry.partitioning.Hyperplane<org.apache.commons.math3.geometry.euclidean.threed.Euclidean3D> {
	...
	public Plane(final org.apache.commons.math3.geometry.euclidean.threed.Vector3D normal) {
		setNormal(normal);
		originOffset = 0;
		setFrame();
	}

	public Plane(final org.apache.commons.math3.geometry.euclidean.threed.Vector3D p, final org.apache.commons.math3.geometry.euclidean.threed.Vector3D normal) {
		setNormal(normal);
		originOffset = -(p.dotProduct(w));
		setFrame();
	}

	public Plane(final org.apache.commons.math3.geometry.euclidean.threed.Vector3D p1, final org.apache.commons.math3.geometry.euclidean.threed.Vector3D p2, final org.apache.commons.math3.geometry.euclidean.threed.Vector3D p3) {
	...
	public void reset(final org.apache.commons.math3.geometry.euclidean.threed.Vector3D p, final org.apache.commons.math3.geometry.euclidean.threed.Vector3D normal) {
		setNormal(normal);
		originOffset = -(p.dotProduct(w));
		setFrame();
	}
	...
	private void setNormal(final org.apache.commons.math3.geometry.euclidean.threed.Vector3D normal) {
	...
	public org.apache.commons.math3.geometry.euclidean.twod.Vector2D toSubSpace(final org.apache.commons.math3.geometry.Vector<org.apache.commons.math3.geometry.euclidean.threed.Euclidean3D> point) {
		return new org.apache.commons.math3.geometry.euclidean.twod.Vector2D(point.dotProduct(u), point.dotProduct(v));
	}

	public org.apache.commons.math3.geometry.euclidean.threed.Vector3D toSpace(final org.apache.commons.math3.geometry.Vector<org.apache.commons.math3.geometry.euclidean.twod.Euclidean2D> point) {
	...
	public org.apache.commons.math3.geometry.euclidean.threed.Plane rotate(final org.apache.commons.math3.geometry.euclidean.threed.Vector3D center, final org.apache.commons.math3.geometry.euclidean.threed.Rotation rotation) {
		...
		final org.apache.commons.math3.geometry.euclidean.threed.Plane plane = new org.apache.commons.math3.geometry.euclidean.threed.Plane(center.add(rotation.applyTo(delta)), rotation.applyTo(w));
	...
	public org.apache.commons.math3.geometry.euclidean.threed.Plane translate(final org.apache.commons.math3.geometry.euclidean.threed.Vector3D translation) {
		final org.apache.commons.math3.geometry.euclidean.threed.Plane plane = new org.apache.commons.math3.geometry.euclidean.threed.Plane(origin.add(translation), w);
		plane.u = u;
		plane.v = v;
		return plane;
	}
	...
	public org.apache.commons.math3.geometry.euclidean.threed.Vector3D intersection(final org.apache.commons.math3.geometry.euclidean.threed.Line line) {
		...
		final org.apache.commons.math3.geometry.euclidean.threed.Vector3D point = line.toSpace(org.apache.commons.math3.geometry.euclidean.oned.Vector1D.ZERO);
	...
	public org.apache.commons.math3.geometry.euclidean.threed.Line intersection(final org.apache.commons.math3.geometry.euclidean.threed.Plane other) {
		...
		final org.apache.commons.math3.geometry.euclidean.threed.Vector3D point = org.apache.commons.math3.geometry.euclidean.threed.Plane.intersection(org.apache.commons.math3.geometry.euclidean.threed.Plane.this, other, new org.apache.commons.math3.geometry.euclidean.threed.Plane(direction));
		return new org.apache.commons.math3.geometry.euclidean.threed.Line(point, point.add(direction));
	}
	...
	public org.apache.commons.math3.geometry.euclidean.threed.SubPlane wholeHyperplane() {
		return new org.apache.commons.math3.geometry.euclidean.threed.SubPlane(org.apache.commons.math3.geometry.euclidean.threed.Plane.this, new org.apache.commons.math3.geometry.euclidean.twod.PolygonsSet());
	}

	public org.apache.commons.math3.geometry.euclidean.threed.PolyhedronsSet wholeSpace() {
		return new org.apache.commons.math3.geometry.euclidean.threed.PolyhedronsSet();
	}
	...
	public double getOffset(final org.apache.commons.math3.geometry.Vector<org.apache.commons.math3.geometry.euclidean.threed.Euclidean3D> point) {
