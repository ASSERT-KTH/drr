...
public final class MathUtils {
	...
	public static double round(double x, int scale, int roundingMethod) {
		double sign = org.apache.commons.math.util.MathUtils.indicator(x);
		double factor = (java.lang.Math.pow(10.0, scale)) * sign;
		return (org.apache.commons.math.util.MathUtils.roundUnscaled((x * factor), sign, roundingMethod)) / factor;
	}
	...
	private static double roundUnscaled(double unscaled, double sign, int roundingMethod) {
		switch (roundingMethod) {
			...
			case java.math.BigDecimal.ROUND_HALF_DOWN :
				{
					double fraction = java.lang.Math.abs((unscaled - (java.lang.Math.floor(unscaled))));
					if (fraction > 0.5) {
						unscaled = java.lang.Math.ceil(unscaled);
					}else {
						unscaled = java.lang.Math.floor(unscaled);
