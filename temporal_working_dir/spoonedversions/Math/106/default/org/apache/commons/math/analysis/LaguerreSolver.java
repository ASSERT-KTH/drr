...
public class LaguerreSolver extends org.apache.commons.math.analysis.UnivariateRealSolverImpl {
	...
	public double solve(double min, double max) throws org.apache.commons.math.ConvergenceException, org.apache.commons.math.FunctionEvaluationException {
		...
		throw new org.apache.commons.math.ConvergenceException("Convergence failed.");
	}
	...
	public org.apache.commons.math.complex.Complex[] solveAll(org.apache.commons.math.complex.Complex[] coefficients, org.apache.commons.math.complex.Complex initial) throws org.apache.commons.math.ConvergenceException, org.apache.commons.math.FunctionEvaluationException {
	...
	public org.apache.commons.math.complex.Complex solve(org.apache.commons.math.complex.Complex[] coefficients, org.apache.commons.math.complex.Complex initial) throws org.apache.commons.math.ConvergenceException, org.apache.commons.math.FunctionEvaluationException {
		int n = (coefficients.length) - 1;
		if (n < 1) {
			throw new java.lang.IllegalArgumentException(("Polynomial degree must be positive: degree=" + n));
		}
		...
		while (i <= (maximalIterationCount)) {
			...
			org.apache.commons.math.complex.Complex dplus = G.add(org.apache.commons.math.complex.ComplexUtils.sqrt(delta));
			org.apache.commons.math.complex.Complex dminus = G.subtract(org.apache.commons.math.complex.ComplexUtils.sqrt(delta));
