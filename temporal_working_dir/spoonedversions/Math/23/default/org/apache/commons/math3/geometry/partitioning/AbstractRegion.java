...
public abstract class AbstractRegion<S extends org.apache.commons.math3.geometry.Space, T extends org.apache.commons.math3.geometry.Space> implements org.apache.commons.math3.geometry.partitioning.Region<S> {
	...
	public org.apache.commons.math3.geometry.partitioning.BSPTree<S> getTree(final boolean includeBoundaryAttributes) {
		if ((includeBoundaryAttributes && ((tree.getCut()) != null)) && ((tree.getAttribute()) == null)) {
			tree.visit(new org.apache.commons.math3.geometry.partitioning.AbstractRegion.BoundaryBuilder<S>());
		}
		return tree;
	}

	private static class BoundaryBuilder<S extends org.apache.commons.math3.geometry.Space> implements org.apache.commons.math3.geometry.partitioning.BSPTreeVisitor<S> {
		...
		public void visitInternalNode(org.apache.commons.math3.geometry.partitioning.BSPTree<S> node) {
			...
			final org.apache.commons.math3.geometry.partitioning.SubHyperplane<S>[] plusChar = ((org.apache.commons.math3.geometry.partitioning.SubHyperplane<S>[]) (java.lang.reflect.Array.newInstance(org.apache.commons.math3.geometry.partitioning.SubHyperplane.class, 2)));
		...
		private void characterize(final org.apache.commons.math3.geometry.partitioning.BSPTree<S> node, final org.apache.commons.math3.geometry.partitioning.SubHyperplane<S> sub, final org.apache.commons.math3.geometry.partitioning.SubHyperplane<S>[] characterization) {
			if ((node.getCut()) == null) {
