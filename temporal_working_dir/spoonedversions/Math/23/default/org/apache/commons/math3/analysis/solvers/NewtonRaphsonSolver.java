...
public class NewtonRaphsonSolver extends org.apache.commons.math3.analysis.solvers.AbstractUnivariateDifferentiableSolver {
	...
	@java.lang.Override
	public double solve(int maxEval, final org.apache.commons.math3.analysis.differentiation.UnivariateDifferentiable f, final double min, final double max) throws org.apache.commons.math3.exception.TooManyEvaluationsException {
