...
public class PearsonsCorrelation {
	...
	public PearsonsCorrelation(double[][] data) {
		this(new org.apache.commons.math.linear.DenseRealMatrix(data));
	}
	...
	public org.apache.commons.math.linear.RealMatrix getCorrelationStandardErrors() {
		...
		return new org.apache.commons.math.linear.DenseRealMatrix(out);
	}
	...
	public org.apache.commons.math.linear.RealMatrix computeCorrelation(org.apache.commons.math.linear.RealMatrix matrix) {
		int nVars = matrix.getColumnDimension();
		org.apache.commons.math.linear.RealMatrix outMatrix = new org.apache.commons.math.linear.DenseRealMatrix(nVars, nVars);
		for (int i = 0; i < nVars; i++) {
			for (int j = 0; j < i; j++) {
