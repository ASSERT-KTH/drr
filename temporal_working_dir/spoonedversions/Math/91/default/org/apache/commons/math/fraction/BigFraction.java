...
public class BigFraction extends java.lang.Number implements java.lang.Comparable<org.apache.commons.math.fraction.BigFraction> {
	public static final org.apache.commons.math.fraction.BigFraction ONE = new org.apache.commons.math.fraction.BigFraction(1, 1);

	public static final org.apache.commons.math.fraction.BigFraction ZERO = new org.apache.commons.math.fraction.BigFraction(0, 1);
	...
	public static final org.apache.commons.math.fraction.BigFraction MINUS_ONE = new org.apache.commons.math.fraction.BigFraction((-1), 1);
	...
	public org.apache.commons.math.fraction.BigFraction add(final java.math.BigInteger bg) {
		return add(new org.apache.commons.math.fraction.BigFraction(bg, java.math.BigInteger.ONE));
	}
	...
	public org.apache.commons.math.fraction.BigFraction add(final int i) {
		return add(new org.apache.commons.math.fraction.BigFraction(i, 1));
	}

	public org.apache.commons.math.fraction.BigFraction add(final long l) {
		return add(new org.apache.commons.math.fraction.BigFraction(l, 1L));
	}
	...
	public org.apache.commons.math.fraction.BigFraction divide(final java.math.BigInteger bg) {
		return divide(new org.apache.commons.math.fraction.BigFraction(bg, java.math.BigInteger.ONE));
	}
	...
	public org.apache.commons.math.fraction.BigFraction divide(final int i) {
		return divide(new org.apache.commons.math.fraction.BigFraction(i, 1));
	}

	public org.apache.commons.math.fraction.BigFraction divide(final long l) {
		return divide(new org.apache.commons.math.fraction.BigFraction(l, 1L));
	}
	...
	public org.apache.commons.math.fraction.BigFraction multiply(final int i) {
		return multiply(new org.apache.commons.math.fraction.BigFraction(i, 1));
	}

	public org.apache.commons.math.fraction.BigFraction multiply(final long l) {
		return multiply(new org.apache.commons.math.fraction.BigFraction(l, 1L));
	}
	...
	public org.apache.commons.math.fraction.BigFraction pow(final java.math.BigInteger exponent) {
		org.apache.commons.math.fraction.BigFraction ret = org.apache.commons.math.fraction.BigFraction.this;
		if (!(java.math.BigInteger.ONE.equals(exponent))) {
			ret = org.apache.commons.math.fraction.BigFraction.ONE;
			if (!(java.math.BigInteger.ZERO.equals(exponent))) {
				for (java.math.BigInteger bg = java.math.BigInteger.ONE; (bg.compareTo(exponent)) < 0; bg = bg.add(java.math.BigInteger.ONE)) {
					ret = ret.multiply(org.apache.commons.math.fraction.BigFraction.this);
				}
			}
		}
		return ret;
	...
	public double pow(final org.apache.commons.math.fraction.BigFraction exponent) {
		return (java.lang.Math.pow(numerator.doubleValue(), exponent.doubleValue())) / (java.lang.Math.pow(denominator.doubleValue(), exponent.doubleValue()));
	}

	public org.apache.commons.math.fraction.BigFraction pow(final int exponent) {
		return pow(java.math.BigInteger.valueOf(exponent));
	}
	...
	public org.apache.commons.math.fraction.BigFraction subtract(final java.math.BigInteger bg) {
		return subtract(new org.apache.commons.math.fraction.BigFraction(bg, java.math.BigInteger.valueOf(1)));
	}
	...
	public org.apache.commons.math.fraction.BigFraction subtract(final int i) {
		return subtract(new org.apache.commons.math.fraction.BigFraction(i, 1));
	}

	public org.apache.commons.math.fraction.BigFraction subtract(final long l) {
		return subtract(new org.apache.commons.math.fraction.BigFraction(l, 1L));
	}
