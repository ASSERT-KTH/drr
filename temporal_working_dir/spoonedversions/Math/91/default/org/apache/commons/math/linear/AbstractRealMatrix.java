...
public abstract class AbstractRealMatrix implements java.io.Serializable , org.apache.commons.math.linear.RealMatrix {
	private static final long serialVersionUID = -3665653040524315561L;

	private org.apache.commons.math.linear.decomposition.DecompositionSolver lu;
	...
	public org.apache.commons.math.linear.RealMatrix inverse() throws org.apache.commons.math.linear.InvalidMatrixException {
		if ((lu) == null) {
			lu = new org.apache.commons.math.linear.decomposition.LUDecompositionImpl(org.apache.commons.math.linear.AbstractRealMatrix.this, org.apache.commons.math.util.MathUtils.SAFE_MIN).getSolver();
		}
	...
	public double getDeterminant() throws org.apache.commons.math.linear.InvalidMatrixException {
		return new org.apache.commons.math.linear.decomposition.LUDecompositionImpl(org.apache.commons.math.linear.AbstractRealMatrix.this, org.apache.commons.math.util.MathUtils.SAFE_MIN).getDeterminant();
	}
	...
	public double getTrace() throws org.apache.commons.math.linear.decomposition.NonSquareMatrixException {
		final int nRows = getRowDimension();
		final int nCols = getColumnDimension();
		if (nRows != nCols) {
			throw new org.apache.commons.math.linear.decomposition.NonSquareMatrixException(nRows, nCols);
		}
		double trace = 0;
		for (int i = 0; i < nRows; ++i) {
			trace += getEntry(i, i);
	...
	protected void checkAdditionCompatible(final org.apache.commons.math.linear.RealMatrix m) {
	...
	protected void checkSubtractionCompatible(final org.apache.commons.math.linear.RealMatrix m) {
		if (((getRowDimension()) != (m.getRowDimension())) || ((getColumnDimension()) != (m.getColumnDimension()))) {
	...
	protected void checkMultiplicationCompatible(final org.apache.commons.math.linear.RealMatrix m) {
