...
public class Covariance {
	...
	protected org.apache.commons.math.linear.RealMatrix computeCovariance(org.apache.commons.math.linear.RealMatrix matrix, boolean biasCorrected) {
	...
	public double covariance(final double[] xArray, final double[] yArray, boolean biasCorrected) throws java.lang.IllegalArgumentException {
		...
		if ((length == (yArray.length)) && (length > 1)) {
			...
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(("arrays must have the same length and both must have at " + "least two elements. xArray has size {0}, yArray has {1} elements"), xArray.length, yArray.length);
		}
