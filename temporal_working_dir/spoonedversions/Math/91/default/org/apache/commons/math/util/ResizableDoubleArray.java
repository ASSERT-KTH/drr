...
public class ResizableDoubleArray implements java.io.Serializable , org.apache.commons.math.util.DoubleArray {
	...
	protected void checkContractExpand(float contractionCritera, float expansionFactor) {
		if (contractionCritera < expansionFactor) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(("contraction criteria ({0}) smaller than the expansion factor ({1}).  This would " + ("lead to a never ending loop of expansion and contraction as a newly expanded " + "internal storage array would immediately satisfy the criteria for contraction")), contractionCritera, expansionFactor);
		}
		if ((contractionCriteria) <= 1.0) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(("contraction criteria smaller than one ({0}).  This would lead to a never ending " + ("loop of expansion and contraction as an internal storage array length equal " + "to the number of elements would satisfy the contraction criteria.")), contractionCriteria);
		}
		if (expansionFactor <= 1.0) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException("expansion factor smaller than one ({0})", contractionCriteria);
		}
	}
	...
	public void setExpansionMode(int expansionMode) {
		if ((expansionMode != (org.apache.commons.math.util.ResizableDoubleArray.MULTIPLICATIVE_MODE)) && (expansionMode != (org.apache.commons.math.util.ResizableDoubleArray.ADDITIVE_MODE))) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException("unsupported expansion mode {0}, supported modes are {1} ({2}) and {3} ({4})", expansionMode, org.apache.commons.math.util.ResizableDoubleArray.MULTIPLICATIVE_MODE, "MULTIPLICATIVE_MODE", org.apache.commons.math.util.ResizableDoubleArray.ADDITIVE_MODE, "ADDITIVE_MODE");
		}
