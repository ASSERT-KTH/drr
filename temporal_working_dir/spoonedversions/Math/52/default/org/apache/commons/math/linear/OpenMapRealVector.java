...
public class OpenMapRealVector extends org.apache.commons.math.linear.AbstractRealVector implements java.io.Serializable , org.apache.commons.math.linear.SparseRealVector {
	...
	protected boolean isDefaultValue(double value) {
		return (org.apache.commons.math.util.FastMath.abs(value)) < (epsilon);
	}
	...
	public org.apache.commons.math.linear.OpenMapRealVector add(org.apache.commons.math.linear.OpenMapRealVector v) {
		checkVectorDimensions(v.getDimension());
		boolean copyThis = (entries.size()) > (v.entries.size());
		org.apache.commons.math.linear.OpenMapRealVector res = copyThis ? org.apache.commons.math.linear.OpenMapRealVector.this.copy() : v.copy();
	...
	public double dotProduct(org.apache.commons.math.linear.OpenMapRealVector v) {
		checkVectorDimensions(v.getDimension());
	...
	public org.apache.commons.math.linear.OpenMapRealVector ebeDivide(org.apache.commons.math.linear.RealVector v) {
		checkVectorDimensions(v.getDimension());
	...
	@java.lang.Override
	public org.apache.commons.math.linear.OpenMapRealVector ebeDivide(double[] v) {
	...
	public org.apache.commons.math.linear.OpenMapRealVector ebeMultiply(org.apache.commons.math.linear.RealVector v) {
		checkVectorDimensions(v.getDimension());
		org.apache.commons.math.linear.OpenMapRealVector res = new org.apache.commons.math.linear.OpenMapRealVector(org.apache.commons.math.linear.OpenMapRealVector.this);
		org.apache.commons.math.util.OpenIntToDoubleHashMap.Iterator iter = res.entries.iterator();
		while (iter.hasNext()) {
	...
	@java.lang.Override
	public org.apache.commons.math.linear.OpenMapRealVector ebeMultiply(double[] v) {
		checkVectorDimensions(v.length);
		org.apache.commons.math.linear.OpenMapRealVector res = new org.apache.commons.math.linear.OpenMapRealVector(org.apache.commons.math.linear.OpenMapRealVector.this);
		org.apache.commons.math.util.OpenIntToDoubleHashMap.Iterator iter = res.entries.iterator();
		while (iter.hasNext()) {
	...
	public org.apache.commons.math.linear.OpenMapRealVector getSubVector(int index, int n) {
		checkIndex(index);
	...
	public double getDistance(org.apache.commons.math.linear.OpenMapRealVector v) {
		org.apache.commons.math.util.OpenIntToDoubleHashMap.Iterator iter = entries.iterator();
		double res = 0;
		while (iter.hasNext()) {
			iter.advance();
	...
	public double getL1Distance(org.apache.commons.math.linear.OpenMapRealVector v) {
		...
		while (iter.hasNext()) {
			...
			int key = iter.key();
			if (!(entries.containsKey(key))) {
				double delta = org.apache.commons.math.util.FastMath.abs(iter.value());
				max += org.apache.commons.math.util.FastMath.abs(delta);
			}
		} 
		return max;
	}
	...
	public org.apache.commons.math.linear.RealMatrix outerProduct(double[] v) {
		...
		org.apache.commons.math.linear.RealMatrix res = new org.apache.commons.math.linear.OpenMapRealMatrix(virtualSize, n);
		org.apache.commons.math.util.OpenIntToDoubleHashMap.Iterator iter = entries.iterator();
		while (iter.hasNext()) {
			iter.advance();
			int row = iter.key();
	...
	@java.lang.Override
	public org.apache.commons.math.linear.OpenMapRealVector projection(double[] v) {
		checkVectorDimensions(v.length);
	...
	public org.apache.commons.math.linear.OpenMapRealVector subtract(org.apache.commons.math.linear.OpenMapRealVector v) {
		checkVectorDimensions(v.getDimension());
	...
	@java.lang.Override
	public org.apache.commons.math.linear.OpenMapRealVector subtract(org.apache.commons.math.linear.RealVector v) {
		checkVectorDimensions(v.getDimension());
		if (v instanceof org.apache.commons.math.linear.OpenMapRealVector) {
	...
	@java.lang.Override
	public org.apache.commons.math.linear.OpenMapRealVector subtract(double[] v) {
		checkVectorDimensions(v.length);
		org.apache.commons.math.linear.OpenMapRealVector res = new org.apache.commons.math.linear.OpenMapRealVector(org.apache.commons.math.linear.OpenMapRealVector.this);
		for (int i = 0; i < (v.length); i++) {
