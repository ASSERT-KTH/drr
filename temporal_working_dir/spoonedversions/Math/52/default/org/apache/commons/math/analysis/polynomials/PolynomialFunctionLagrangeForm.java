...
public class PolynomialFunctionLagrangeForm implements org.apache.commons.math.analysis.UnivariateRealFunction {
	...
	public PolynomialFunctionLagrangeForm(double[] x, double[] y) {
		...
		if (!(org.apache.commons.math.analysis.polynomials.PolynomialFunctionLagrangeForm.verifyInterpolationArray(x, y, false))) {
			org.apache.commons.math.util.MathUtils.sortInPlace(org.apache.commons.math.analysis.polynomials.PolynomialFunctionLagrangeForm.this.x, org.apache.commons.math.analysis.polynomials.PolynomialFunctionLagrangeForm.this.y);
	...
	public static double evaluate(double[] x, double[] y, double z) {
		...
		org.apache.commons.math.util.MathUtils.sortInPlace(xNew, yNew);
	...
	public static boolean verifyInterpolationArray(double[] x, double[] y, boolean abort) {
		...
		return org.apache.commons.math.util.MathUtils.checkOrder(x, org.apache.commons.math.util.MathUtils.OrderDirection.INCREASING, true, abort);
	}
}
