...
public class ComplexFormat {
	...
	public ComplexFormat() {
		this(org.apache.commons.math3.complex.ComplexFormat.DEFAULT_IMAGINARY_CHARACTER, org.apache.commons.math3.util.CompositeFormat.getDefaultNumberFormat());
	}

	public ComplexFormat(java.text.NumberFormat format) {
		this(org.apache.commons.math3.complex.ComplexFormat.DEFAULT_IMAGINARY_CHARACTER, format);
	}

	public ComplexFormat(java.text.NumberFormat realFormat, java.text.NumberFormat imaginaryFormat) {
		this(org.apache.commons.math3.complex.ComplexFormat.DEFAULT_IMAGINARY_CHARACTER, realFormat, imaginaryFormat);
	}
	...
	public static org.apache.commons.math3.complex.ComplexFormat getInstance(java.lang.String imaginaryCharacter, java.util.Locale locale) {
		java.text.NumberFormat f = org.apache.commons.math3.util.CompositeFormat.getDefaultNumberFormat(locale);
	...
	public org.apache.commons.math3.complex.Complex parse(java.lang.String source) {
