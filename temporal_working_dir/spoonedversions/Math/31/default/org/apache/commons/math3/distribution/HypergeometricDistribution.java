...
public class HypergeometricDistribution extends org.apache.commons.math3.distribution.AbstractIntegerDistribution {
	...
	private double probability(int n, int m, int k, int x) {
		return org.apache.commons.math3.util.FastMath.exp((((org.apache.commons.math3.util.ArithmeticUtils.binomialCoefficientLog(m, x)) + (org.apache.commons.math3.util.ArithmeticUtils.binomialCoefficientLog((n - m), (k - x)))) - (org.apache.commons.math3.util.ArithmeticUtils.binomialCoefficientLog(n, k))));
	}
