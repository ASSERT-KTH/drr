...
public abstract class AbstractFormat extends java.text.NumberFormat implements java.io.Serializable {
	...
	protected AbstractFormat(final java.text.NumberFormat numeratorFormat, final java.text.NumberFormat denominatorFormat) {
		org.apache.commons.math3.fraction.AbstractFormat.this.numeratorFormat = numeratorFormat;
		org.apache.commons.math3.fraction.AbstractFormat.this.denominatorFormat = denominatorFormat;
	}
	...
	public void setDenominatorFormat(final java.text.NumberFormat format) {
		if (format == null) {
			throw new org.apache.commons.math3.exception.NullArgumentException(org.apache.commons.math3.exception.util.LocalizedFormats.DENOMINATOR_FORMAT);
		}
		org.apache.commons.math3.fraction.AbstractFormat.this.denominatorFormat = format;
	}

	public void setNumeratorFormat(final java.text.NumberFormat format) {
		if (format == null) {
			throw new org.apache.commons.math3.exception.NullArgumentException(org.apache.commons.math3.exception.util.LocalizedFormats.NUMERATOR_FORMAT);
		}
		org.apache.commons.math3.fraction.AbstractFormat.this.numeratorFormat = format;
	}

	protected static void parseAndIgnoreWhitespace(final java.lang.String source, final java.text.ParsePosition pos) {
		org.apache.commons.math3.fraction.AbstractFormat.parseNextCharacter(source, pos);
