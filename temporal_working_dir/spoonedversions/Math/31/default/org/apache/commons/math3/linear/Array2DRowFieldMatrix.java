...
public class Array2DRowFieldMatrix<T extends org.apache.commons.math3.FieldElement<T>> extends org.apache.commons.math3.linear.AbstractFieldMatrix<T> implements java.io.Serializable {
	...
	public Array2DRowFieldMatrix(final org.apache.commons.math3.Field<T> field, final int rowDimension, final int columnDimension) {
		super(field, rowDimension, columnDimension);
		data = org.apache.commons.math3.linear.AbstractFieldMatrix.buildArray(field, rowDimension, columnDimension);
	}
	...
	public Array2DRowFieldMatrix(final org.apache.commons.math3.Field<T> field, final T[][] d) {
		super(field);
		copyIn(d);
	}
	...
	public Array2DRowFieldMatrix(final org.apache.commons.math3.Field<T> field, final T[] v) {
		...
		data = org.apache.commons.math3.linear.AbstractFieldMatrix.buildArray(getField(), nRows, 1);
	...
	public org.apache.commons.math3.linear.Array2DRowFieldMatrix<T> add(final org.apache.commons.math3.linear.Array2DRowFieldMatrix<T> m) {
		checkAdditionCompatible(m);
		final int rowCount = getRowDimension();
		final int columnCount = getColumnDimension();
		final T[][] outData = org.apache.commons.math3.linear.AbstractFieldMatrix.buildArray(getField(), rowCount, columnCount);
	...
	public org.apache.commons.math3.linear.Array2DRowFieldMatrix<T> subtract(final org.apache.commons.math3.linear.Array2DRowFieldMatrix<T> m) {
	...
	public org.apache.commons.math3.linear.Array2DRowFieldMatrix<T> multiply(final org.apache.commons.math3.linear.Array2DRowFieldMatrix<T> m) {
		...
		final T[][] outData = org.apache.commons.math3.linear.AbstractFieldMatrix.buildArray(getField(), nRows, nCols);
		for (int row = 0; row < nRows; row++) {
			final T[] dataRow = data[row];
			final T[] outDataRow = outData[row];
	...
	public void setSubMatrix(final T[][] subMatrix, final int row, final int column) {
		if ((data) == null) {
			...
			data = org.apache.commons.math3.linear.AbstractFieldMatrix.buildArray(getField(), subMatrix.length, nCols);
	...
	public T[] operate(final T[] v) {
		...
		final T[] out = org.apache.commons.math3.linear.AbstractFieldMatrix.buildArray(getField(), nRows);
		for (int row = 0; row < nRows; row++) {
			final T[] dataRow = data[row];
			T sum = getField().getZero();
	...
	public T[] preMultiply(final T[] v) {
		...
		final T[] out = org.apache.commons.math3.linear.AbstractFieldMatrix.buildArray(getField(), nCols);
		for (int col = 0; col < nCols; ++col) {
			T sum = getField().getZero();
	...
	private T[][] copyOut() {
		final int nRows = org.apache.commons.math3.linear.Array2DRowFieldMatrix.this.getRowDimension();
		final T[][] out = org.apache.commons.math3.linear.AbstractFieldMatrix.buildArray(getField(), nRows, getColumnDimension());
		for (int i = 0; i < nRows; i++) {
