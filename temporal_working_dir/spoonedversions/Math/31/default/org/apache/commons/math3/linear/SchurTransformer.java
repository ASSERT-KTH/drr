			...
			if (l == idx) {
				...
				if (l == (idx - 1)) {
					...
					if ((++iteration) > (maxIterations)) {
						throw new org.apache.commons.math3.exception.MaxCountExceededException(org.apache.commons.math3.exception.util.LocalizedFormats.CONVERGENCE_FAILED, maxIterations);
					}
					int m = idx - 2;
