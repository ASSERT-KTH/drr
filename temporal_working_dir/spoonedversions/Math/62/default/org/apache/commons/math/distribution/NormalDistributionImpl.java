...
public class NormalDistributionImpl extends org.apache.commons.math.distribution.AbstractContinuousDistribution implements java.io.Serializable , org.apache.commons.math.distribution.NormalDistribution {
	...
	private void setMeanInternal(double newMean) {
		org.apache.commons.math.distribution.NormalDistributionImpl.this.mean = newMean;
	}
	...
	private void setStandardDeviationInternal(double sd) {
		if (sd <= 0.0) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.util.LocalizedFormats.NOT_POSITIVE_STANDARD_DEVIATION, sd);
		}
	...
	public double density(double x) {
		double x0 = x - (mean);
		return (org.apache.commons.math.util.FastMath.exp((((-x0) * x0) / ((2 * (standardDeviation)) * (standardDeviation))))) / ((standardDeviation) * (org.apache.commons.math.distribution.NormalDistributionImpl.SQRT2PI));
	}

	public double cumulativeProbability(double x) throws org.apache.commons.math.MathException {
		try {
			return 0.5 * (1.0 + (org.apache.commons.math.special.Erf.erf(((x - (mean)) / ((standardDeviation) * (org.apache.commons.math.util.FastMath.sqrt(2.0)))))));
