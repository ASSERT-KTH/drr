...
public class StandardDeviation extends org.apache.commons.math.stat.descriptive.AbstractStorelessUnivariateStatistic implements java.io.Serializable {
	...
	public double getResult() {
		return org.apache.commons.math.util.FastMath.sqrt(variance.getResult());
	}
	...
	public double evaluate(final double[] values) {
		return org.apache.commons.math.util.FastMath.sqrt(variance.evaluate(values));
	}

	@java.lang.Override
	public double evaluate(final double[] values, final int begin, final int length) {
		return org.apache.commons.math.util.FastMath.sqrt(variance.evaluate(values, begin, length));
	}

	public double evaluate(final double[] values, final double mean, final int begin, final int length) {
		return org.apache.commons.math.util.FastMath.sqrt(variance.evaluate(values, mean, begin, length));
	}

	public double evaluate(final double[] values, final double mean) {
		return org.apache.commons.math.util.FastMath.sqrt(variance.evaluate(values, mean));
	}
