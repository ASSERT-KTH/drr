...
public class ArrayRealVector extends org.apache.commons.math.linear.AbstractRealVector implements java.io.Serializable {
	...
	public ArrayRealVector(double[] d, boolean copyArray) throws java.lang.IllegalArgumentException, java.lang.NullPointerException {
		...
		if ((d.length) == 0) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.util.LocalizedFormats.VECTOR_MUST_HAVE_AT_LEAST_ONE_ELEMENT);
		}
	...
	public ArrayRealVector(double[] d, int pos, int size) {
		if ((d.length) < (pos + size)) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.util.LocalizedFormats.POSITION_SIZE_MISMATCH_INPUT_ARRAY, pos, size, d.length);
		}
		data = new double[size];
	...
	public org.apache.commons.math.linear.RealVector mapPowToSelf(double d) {
		for (int i = 0; i < (data.length); i++) {
			data[i] = org.apache.commons.math.util.FastMath.pow(data[i], d);
		}
		return org.apache.commons.math.linear.ArrayRealVector.this;
	}
	...
	public org.apache.commons.math.linear.RealVector mapExpToSelf() {
		for (int i = 0; i < (data.length); i++) {
			data[i] = org.apache.commons.math.util.FastMath.exp(data[i]);
		}
		return org.apache.commons.math.linear.ArrayRealVector.this;
	}
	...
	public org.apache.commons.math.linear.RealVector mapExpm1ToSelf() {
		for (int i = 0; i < (data.length); i++) {
			data[i] = org.apache.commons.math.util.FastMath.expm1(data[i]);
		}
		return org.apache.commons.math.linear.ArrayRealVector.this;
	}
	...
	public org.apache.commons.math.linear.RealVector mapLogToSelf() {
		for (int i = 0; i < (data.length); i++) {
			data[i] = org.apache.commons.math.util.FastMath.log(data[i]);
		}
		return org.apache.commons.math.linear.ArrayRealVector.this;
	}
	...
	public org.apache.commons.math.linear.RealVector mapLog10ToSelf() {
		for (int i = 0; i < (data.length); i++) {
			data[i] = org.apache.commons.math.util.FastMath.log10(data[i]);
		}
		return org.apache.commons.math.linear.ArrayRealVector.this;
	}
	...
	public org.apache.commons.math.linear.RealVector mapLog1pToSelf() {
		for (int i = 0; i < (data.length); i++) {
			data[i] = org.apache.commons.math.util.FastMath.log1p(data[i]);
		}
		return org.apache.commons.math.linear.ArrayRealVector.this;
	}
	...
	public org.apache.commons.math.linear.RealVector mapCoshToSelf() {
		for (int i = 0; i < (data.length); i++) {
			data[i] = org.apache.commons.math.util.FastMath.cosh(data[i]);
		}
		return org.apache.commons.math.linear.ArrayRealVector.this;
	}
	...
	public org.apache.commons.math.linear.RealVector mapSinhToSelf() {
		for (int i = 0; i < (data.length); i++) {
			data[i] = org.apache.commons.math.util.FastMath.sinh(data[i]);
		}
		return org.apache.commons.math.linear.ArrayRealVector.this;
	}
	...
	public org.apache.commons.math.linear.RealVector mapTanhToSelf() {
		for (int i = 0; i < (data.length); i++) {
			data[i] = org.apache.commons.math.util.FastMath.tanh(data[i]);
		}
		return org.apache.commons.math.linear.ArrayRealVector.this;
	}
	...
	public org.apache.commons.math.linear.RealVector mapCosToSelf() {
		for (int i = 0; i < (data.length); i++) {
			data[i] = org.apache.commons.math.util.FastMath.cos(data[i]);
		}
		return org.apache.commons.math.linear.ArrayRealVector.this;
	}
	...
	public org.apache.commons.math.linear.RealVector mapSinToSelf() {
		for (int i = 0; i < (data.length); i++) {
			data[i] = org.apache.commons.math.util.FastMath.sin(data[i]);
		}
		return org.apache.commons.math.linear.ArrayRealVector.this;
	}
	...
	public org.apache.commons.math.linear.RealVector mapTanToSelf() {
		for (int i = 0; i < (data.length); i++) {
			data[i] = org.apache.commons.math.util.FastMath.tan(data[i]);
		}
		return org.apache.commons.math.linear.ArrayRealVector.this;
	}
	...
	public org.apache.commons.math.linear.RealVector mapAcosToSelf() {
		for (int i = 0; i < (data.length); i++) {
			data[i] = org.apache.commons.math.util.FastMath.acos(data[i]);
		}
		return org.apache.commons.math.linear.ArrayRealVector.this;
	}
	...
	public org.apache.commons.math.linear.RealVector mapAsinToSelf() {
		for (int i = 0; i < (data.length); i++) {
			data[i] = org.apache.commons.math.util.FastMath.asin(data[i]);
		}
		return org.apache.commons.math.linear.ArrayRealVector.this;
	}
	...
	public org.apache.commons.math.linear.RealVector mapAtanToSelf() {
		for (int i = 0; i < (data.length); i++) {
			data[i] = org.apache.commons.math.util.FastMath.atan(data[i]);
		}
		return org.apache.commons.math.linear.ArrayRealVector.this;
	}
	...
	public org.apache.commons.math.linear.RealVector mapAbsToSelf() {
		for (int i = 0; i < (data.length); i++) {
			data[i] = org.apache.commons.math.util.FastMath.abs(data[i]);
		}
		return org.apache.commons.math.linear.ArrayRealVector.this;
	}
	...
	public org.apache.commons.math.linear.RealVector mapSqrtToSelf() {
		for (int i = 0; i < (data.length); i++) {
			data[i] = org.apache.commons.math.util.FastMath.sqrt(data[i]);
		}
		return org.apache.commons.math.linear.ArrayRealVector.this;
	}
	...
	public org.apache.commons.math.linear.RealVector mapCbrtToSelf() {
		for (int i = 0; i < (data.length); i++) {
			data[i] = org.apache.commons.math.util.FastMath.cbrt(data[i]);
		}
		return org.apache.commons.math.linear.ArrayRealVector.this;
	}
	...
	public org.apache.commons.math.linear.RealVector mapCeilToSelf() {
		for (int i = 0; i < (data.length); i++) {
			data[i] = org.apache.commons.math.util.FastMath.ceil(data[i]);
		}
		return org.apache.commons.math.linear.ArrayRealVector.this;
	}
	...
	public org.apache.commons.math.linear.RealVector mapFloorToSelf() {
		for (int i = 0; i < (data.length); i++) {
			data[i] = org.apache.commons.math.util.FastMath.floor(data[i]);
		}
		return org.apache.commons.math.linear.ArrayRealVector.this;
	}
	...
	public org.apache.commons.math.linear.RealVector mapRintToSelf() {
		for (int i = 0; i < (data.length); i++) {
			data[i] = org.apache.commons.math.util.FastMath.rint(data[i]);
		}
		return org.apache.commons.math.linear.ArrayRealVector.this;
	}
	...
	public org.apache.commons.math.linear.RealVector mapSignumToSelf() {
		for (int i = 0; i < (data.length); i++) {
			data[i] = org.apache.commons.math.util.FastMath.signum(data[i]);
		}
		return org.apache.commons.math.linear.ArrayRealVector.this;
	}
	...
	public org.apache.commons.math.linear.RealVector mapUlpToSelf() {
		for (int i = 0; i < (data.length); i++) {
			data[i] = org.apache.commons.math.util.FastMath.ulp(data[i]);
		}
		return org.apache.commons.math.linear.ArrayRealVector.this;
	}
	...
	public org.apache.commons.math.linear.RealVector unitVector() throws java.lang.ArithmeticException {
		...
		if (norm == 0) {
			throw org.apache.commons.math.MathRuntimeException.createArithmeticException(org.apache.commons.math.exception.util.LocalizedFormats.ZERO_NORM);
		}
	...
	public void unitize() throws java.lang.ArithmeticException {
		final double norm = getNorm();
		if (norm == 0) {
			throw org.apache.commons.math.MathRuntimeException.createArithmeticException(org.apache.commons.math.exception.util.LocalizedFormats.CANNOT_NORMALIZE_A_ZERO_NORM_VECTOR);
		}
	...
	protected void checkVectorDimensions(int n) throws java.lang.IllegalArgumentException {
		if ((data.length) != n) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.util.LocalizedFormats.VECTOR_LENGTH_MISMATCH, data.length, n);
		}
	}
