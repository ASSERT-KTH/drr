...
public class ExponentialDistributionImpl extends org.apache.commons.math.distribution.AbstractContinuousDistribution implements java.io.Serializable , org.apache.commons.math.distribution.ExponentialDistribution {
	...
	private void setMeanInternal(double newMean) {
		if (newMean <= 0.0) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.util.LocalizedFormats.NOT_POSITIVE_MEAN, newMean);
		}
		org.apache.commons.math.distribution.ExponentialDistributionImpl.this.mean = newMean;
	}
