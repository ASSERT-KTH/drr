		...
		while (true) {
			...
			if (!stop) {
				...
				if (fu <= fx) {
					...
					if ((fu <= fw) || (org.apache.commons.math.util.MathUtils.equals(w, x))) {
						v = w;
						fv = fw;
						w = u;
						fw = fu;
					}else
						if (((fu <= fv) || (org.apache.commons.math.util.MathUtils.equals(v, x))) || (org.apache.commons.math.util.MathUtils.equals(v, w))) {
							v = u;
							fv = fu;
						}
