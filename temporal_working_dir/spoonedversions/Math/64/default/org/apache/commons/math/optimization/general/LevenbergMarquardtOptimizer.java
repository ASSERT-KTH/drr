...
public class LevenbergMarquardtOptimizer extends org.apache.commons.math.optimization.general.AbstractLeastSquaresOptimizer {
	...
	public LevenbergMarquardtOptimizer() {
		...
		setQRRankingThreshold(org.apache.commons.math.util.MathUtils.SAFE_MIN);
	}

	public void setInitialStepBoundFactor(double initialStepBoundFactor) {
		org.apache.commons.math.optimization.general.LevenbergMarquardtOptimizer.this.initialStepBoundFactor = initialStepBoundFactor;
	}

	public void setCostRelativeTolerance(double costRelativeTolerance) {
		org.apache.commons.math.optimization.general.LevenbergMarquardtOptimizer.this.costRelativeTolerance = costRelativeTolerance;
	}

	public void setParRelativeTolerance(double parRelativeTolerance) {
		org.apache.commons.math.optimization.general.LevenbergMarquardtOptimizer.this.parRelativeTolerance = parRelativeTolerance;
	}

	public void setOrthoTolerance(double orthoTolerance) {
		org.apache.commons.math.optimization.general.LevenbergMarquardtOptimizer.this.orthoTolerance = orthoTolerance;
	}

	public void setQRRankingThreshold(final double threshold) {
		org.apache.commons.math.optimization.general.LevenbergMarquardtOptimizer.this.qrRankingThreshold = threshold;
	}
		...
		for (int k = 0; k < (cols); ++k) {
			...
			for (int i = k; i < (cols); ++i) {
				...
				if ((java.lang.Double.isInfinite(norm2)) || (java.lang.Double.isNaN(norm2))) {
					throw new org.apache.commons.math.optimization.OptimizationException(org.apache.commons.math.exception.util.LocalizedFormats.UNABLE_TO_PERFORM_QR_DECOMPOSITION_ON_JACOBIAN, rows, cols);
				}
				if (norm2 > ak2) {
					nextColumn = i;
					ak2 = norm2;
