...
public abstract class BaseRuleFactory<T extends java.lang.Number> {
	...
	public org.apache.commons.math3.util.Pair<double[], double[]> getRule(int numberOfPoints) {
	...
	protected synchronized org.apache.commons.math3.util.Pair<T[], T[]> getRuleInternal(int numberOfPoints) {
