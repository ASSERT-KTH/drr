...
public class JacobianMatrices {
	...
	public JacobianMatrices(final org.apache.commons.math3.ode.FirstOrderDifferentialEquations fode, final double[] hY, final java.lang.String... parameters) throws org.apache.commons.math3.exception.MathIllegalArgumentException {
		this(new org.apache.commons.math3.ode.JacobianMatrices.MainStateJacobianWrapper(fode, hY), parameters);
	}

	public JacobianMatrices(final org.apache.commons.math3.ode.MainStateJacobianProvider jode, final java.lang.String... parameters) throws org.apache.commons.math3.exception.MathIllegalArgumentException {
	...
	public void registerVariationalEquations(final org.apache.commons.math3.ode.ExpandableStatefulODE expandable) throws org.apache.commons.math3.exception.MathIllegalArgumentException {
		...
		if ((expandable.getPrimary()) != ode) {
			throw new org.apache.commons.math3.exception.MathIllegalArgumentException(org.apache.commons.math3.exception.util.LocalizedFormats.UNMATCHED_ODE_IN_EXPANDED_SET);
		}
		efode = expandable;
	...
	public void setParameterStep(final java.lang.String parameter, final double hP) {
		...
		throw new org.apache.commons.math3.exception.MathIllegalArgumentException(org.apache.commons.math3.exception.util.LocalizedFormats.UNKNOWN_PARAMETER, parameter);
	}
	...
	public void setInitialParameterJacobian(final java.lang.String pName, final double[] dYdP) throws org.apache.commons.math3.exception.MathIllegalArgumentException {
		...
		throw new org.apache.commons.math3.exception.MathIllegalArgumentException(org.apache.commons.math3.exception.util.LocalizedFormats.UNKNOWN_PARAMETER, pName);
	}
	...
	private class JacobiansSecondaryEquations implements org.apache.commons.math3.ode.SecondaryEquations {
		...
		public void computeDerivatives(final double t, final double[] y, final double[] yDot, final double[] z, final double[] zDot) {
			...
			if ((paramDim) != 0) {
				...
				for (org.apache.commons.math3.ode.ParameterConfiguration param : selectedParameters) {
					boolean found = false;
					for (org.apache.commons.math3.ode.ParameterJacobianProvider provider : jacobianProviders) {
					...
					if (!found) {
						throw new org.apache.commons.math3.exception.MathIllegalArgumentException(org.apache.commons.math3.exception.util.LocalizedFormats.UNKNOWN_PARAMETER, param);
					}
				}
			}
		}
	...
	private static class MainStateJacobianWrapper implements org.apache.commons.math3.ode.MainStateJacobianProvider {
		...
		public MainStateJacobianWrapper(final org.apache.commons.math3.ode.FirstOrderDifferentialEquations ode, final double[] hY) {
			this.ode = ode;
			this.hY = hY.clone();
		}
