...
public class EigenDecomposition {
	...
	public EigenDecomposition(final org.apache.commons.math3.linear.RealMatrix matrix) {
	...
	public EigenDecomposition(final org.apache.commons.math3.linear.RealMatrix matrix, final double splitTolerance) {
		this(matrix);
	}
	...
	public boolean hasComplexEigenvalues() {
		for (int i = 0; i < (imagEigenvalues.length); i++) {
			if (!(org.apache.commons.math3.util.Precision.equals(imagEigenvalues[i], 0.0, epsilon))) {
				return true;
			}
		}
		return false;
	...
	private org.apache.commons.math3.linear.SchurTransformer transformToSchur(final org.apache.commons.math3.linear.RealMatrix matrix) {
		...
		for (int i = 0; i < (realEigenvalues.length); i++) {
			if ((i == ((realEigenvalues.length) - 1)) || (org.apache.commons.math3.util.Precision.equals(matT[(i + 1)][i], 0.0, epsilon))) {
	...
	private void findEigenVectorsFromSchur(final org.apache.commons.math3.linear.SchurTransformer schur) {
		...
		if (org.apache.commons.math3.util.Precision.equals(norm, 0.0, epsilon)) {
