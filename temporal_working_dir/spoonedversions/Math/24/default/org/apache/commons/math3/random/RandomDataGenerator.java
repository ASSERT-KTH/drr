...
public class RandomDataGenerator implements java.io.Serializable , org.apache.commons.math3.random.RandomData {
	...
	public int nextInt(int lower, int upper) {
		if (lower >= upper) {
			throw new org.apache.commons.math3.exception.MathIllegalArgumentException(org.apache.commons.math3.exception.util.LocalizedFormats.LOWER_BOUND_NOT_BELOW_UPPER_BOUND, lower, upper, false);
		}
	...
	public double nextUniform(double lower, double upper, boolean lowerInclusive) {
		...
		if ((java.lang.Double.isInfinite(lower)) || (java.lang.Double.isInfinite(upper))) {
			throw new org.apache.commons.math3.exception.MathIllegalArgumentException(org.apache.commons.math3.exception.util.LocalizedFormats.INFINITE_BOUND);
		}
		if ((java.lang.Double.isNaN(lower)) || (java.lang.Double.isNaN(upper))) {
			throw new org.apache.commons.math3.exception.MathIllegalArgumentException(org.apache.commons.math3.exception.util.LocalizedFormats.NAN_NOT_ALLOWED);
		}
	...
	public int[] nextPermutation(int n, int k) {
		if (k > n) {
			throw new org.apache.commons.math3.exception.MathIllegalArgumentException(org.apache.commons.math3.exception.util.LocalizedFormats.PERMUTATION_EXCEEDS_N, k, n, true);
		}
		if (k <= 0) {
