...
public class FunctionUtils {
	...
	public static org.apache.commons.math3.analysis.differentiation.UnivariateDifferentiable compose(final org.apache.commons.math3.analysis.differentiation.UnivariateDifferentiable... f) {
		return new org.apache.commons.math3.analysis.differentiation.UnivariateDifferentiable() {
	...
	public static org.apache.commons.math3.analysis.differentiation.UnivariateDifferentiable add(final org.apache.commons.math3.analysis.differentiation.UnivariateDifferentiable... f) {
		return new org.apache.commons.math3.analysis.differentiation.UnivariateDifferentiable() {
			public double value(final double t) {
	...
	public static org.apache.commons.math3.analysis.differentiation.UnivariateDifferentiable multiply(final org.apache.commons.math3.analysis.differentiation.UnivariateDifferentiable... f) {
		return new org.apache.commons.math3.analysis.differentiation.UnivariateDifferentiable() {
			public double value(final double t) {
				double r = f[0].value(t);
				for (int i = 1; i < (f.length); i++) {
	...
	public static org.apache.commons.math3.analysis.DifferentiableUnivariateFunction toDifferentiableUnivariateFunction(final org.apache.commons.math3.analysis.differentiation.UnivariateDifferentiable f) {
		return new org.apache.commons.math3.analysis.DifferentiableUnivariateFunction() {
	...
	@java.lang.Deprecated
	public static org.apache.commons.math3.analysis.differentiation.UnivariateDifferentiable toUnivariateDifferential(final org.apache.commons.math3.analysis.DifferentiableUnivariateFunction f) {
		return new org.apache.commons.math3.analysis.differentiation.UnivariateDifferentiable() {
			public double value(final double x) {
				return f.value(x);
			}
