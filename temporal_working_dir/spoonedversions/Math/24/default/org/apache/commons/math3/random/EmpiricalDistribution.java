...
public class EmpiricalDistribution implements java.io.Serializable {
	...
	public void load(java.net.URL url) throws java.io.IOException, org.apache.commons.math3.exception.NullArgumentException {
	...
	private class DataAdapterFactory {
		public org.apache.commons.math3.random.EmpiricalDistribution.DataAdapter getAdapter(java.lang.Object in) {
			if (in instanceof java.io.BufferedReader) {
				java.io.BufferedReader inputStream = ((java.io.BufferedReader) (in));
				return new org.apache.commons.math3.random.EmpiricalDistribution.StreamDataAdapter(inputStream);
			}else
				if (in instanceof double[]) {
					double[] inputArray = ((double[]) (in));
					return new org.apache.commons.math3.random.EmpiricalDistribution.ArrayDataAdapter(inputArray);
				}else {
					throw new org.apache.commons.math3.exception.MathIllegalArgumentException(org.apache.commons.math3.exception.util.LocalizedFormats.INPUT_DATA_FROM_UNSUPPORTED_DATASOURCE, in.getClass().getName(), java.io.BufferedReader.class.getName(), double[].class.getName());
				}
	...
	private void fillBinStats(java.lang.Object in) throws java.io.IOException {
		...
		org.apache.commons.math3.random.EmpiricalDistribution.DataAdapterFactory aFactory = new org.apache.commons.math3.random.EmpiricalDistribution.DataAdapterFactory();
		org.apache.commons.math3.random.EmpiricalDistribution.DataAdapter da = aFactory.getAdapter(in);
		da.computeBinStats();
