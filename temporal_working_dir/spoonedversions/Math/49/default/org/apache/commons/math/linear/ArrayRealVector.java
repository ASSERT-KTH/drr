...
public class ArrayRealVector extends org.apache.commons.math.linear.AbstractRealVector implements java.io.Serializable {
	...
	public org.apache.commons.math.linear.RealVector add(org.apache.commons.math.linear.RealVector v) {
		if (v instanceof org.apache.commons.math.linear.ArrayRealVector) {
			return add(((org.apache.commons.math.linear.ArrayRealVector) (v)).data);
		}else {
	...
	public org.apache.commons.math.linear.RealVector subtract(org.apache.commons.math.linear.RealVector v) {
		if (v instanceof org.apache.commons.math.linear.ArrayRealVector) {
			return subtract(((org.apache.commons.math.linear.ArrayRealVector) (v)).data);
		}else {
			checkVectorDimensions(v);
			double[] out = data.clone();
			java.util.Iterator<org.apache.commons.math.linear.RealVector.Entry> it = v.sparseIterator();
	...
	public org.apache.commons.math.linear.RealVector ebeMultiply(org.apache.commons.math.linear.RealVector v) {
		if (v instanceof org.apache.commons.math.linear.ArrayRealVector) {
			return ebeMultiply(((org.apache.commons.math.linear.ArrayRealVector) (v)).data);
		}else {
			checkVectorDimensions(v);
			double[] out = data.clone();
			for (int i = 0; i < (data.length); i++) {
	...
	public org.apache.commons.math.linear.RealVector ebeDivide(org.apache.commons.math.linear.RealVector v) {
		if (v instanceof org.apache.commons.math.linear.ArrayRealVector) {
			return ebeDivide(((org.apache.commons.math.linear.ArrayRealVector) (v)).data);
		}else {
			checkVectorDimensions(v);
			double[] out = data.clone();
			for (int i = 0; i < (data.length); i++) {
	...
	public double dotProduct(org.apache.commons.math.linear.RealVector v) {
		if (v instanceof org.apache.commons.math.linear.ArrayRealVector) {
			return dotProduct(((org.apache.commons.math.linear.ArrayRealVector) (v)).data);
		}else {
			checkVectorDimensions(v);
			double dot = 0;
			java.util.Iterator<org.apache.commons.math.linear.RealVector.Entry> it = v.sparseIterator();
	...
	public double getDistance(org.apache.commons.math.linear.RealVector v) {
		if (v instanceof org.apache.commons.math.linear.ArrayRealVector) {
			return getDistance(((org.apache.commons.math.linear.ArrayRealVector) (v)).data);
		}else {
			checkVectorDimensions(v);
			double sum = 0;
			for (int i = 0; i < (data.length); ++i) {
	...
	public double getL1Distance(org.apache.commons.math.linear.RealVector v) {
		if (v instanceof org.apache.commons.math.linear.ArrayRealVector) {
			return getL1Distance(((org.apache.commons.math.linear.ArrayRealVector) (v)).data);
		}else {
			checkVectorDimensions(v);
			double sum = 0;
			for (int i = 0; i < (data.length); ++i) {
	...
	public double getLInfDistance(org.apache.commons.math.linear.RealVector v) {
		if (v instanceof org.apache.commons.math.linear.ArrayRealVector) {
			return getLInfDistance(((org.apache.commons.math.linear.ArrayRealVector) (v)).data);
		}else {
			checkVectorDimensions(v);
			double max = 0;
			for (int i = 0; i < (data.length); ++i) {
	...
	public org.apache.commons.math.linear.RealMatrix outerProduct(org.apache.commons.math.linear.RealVector v) {
		if (v instanceof org.apache.commons.math.linear.ArrayRealVector) {
			return outerProduct(((org.apache.commons.math.linear.ArrayRealVector) (v)).data);
		}else {
	...
	public org.apache.commons.math.linear.ArrayRealVector combine(double a, double b, org.apache.commons.math.linear.ArrayRealVector y) {
		return ((org.apache.commons.math.linear.ArrayRealVector) (copy().combineToSelf(a, b, y.data)));
	}
	...
	public org.apache.commons.math.linear.ArrayRealVector combineToSelf(double a, double b, org.apache.commons.math.linear.ArrayRealVector y) {
	...
	public org.apache.commons.math.linear.RealVector combineToSelf(double a, double b, org.apache.commons.math.linear.RealVector y) {
		if (y instanceof org.apache.commons.math.linear.ArrayRealVector) {
			return combineToSelf(a, b, ((org.apache.commons.math.linear.ArrayRealVector) (y)).data);
		}else {
