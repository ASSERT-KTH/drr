...
public abstract class AbstractRealVector implements org.apache.commons.math.linear.RealVector {
	...
	public double cosine(double[] v) {
		return cosine(new org.apache.commons.math.linear.ArrayRealVector(v, false));
	}
	...
	public org.apache.commons.math.linear.RealVector combine(double a, double b, double[] y) {
	...
	public org.apache.commons.math.linear.RealVector combineToSelf(double a, double b, double[] y) {
		return combineToSelf(a, b, new org.apache.commons.math.linear.ArrayRealVector(y, false));
	}
