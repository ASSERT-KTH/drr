...
public class Array2DRowFieldMatrix<T extends org.apache.commons.math.FieldElement<T>> extends org.apache.commons.math.linear.AbstractFieldMatrix<T> implements java.io.Serializable {
	...
	public Array2DRowFieldMatrix(final T[][] d, final boolean copyArray) throws java.lang.IllegalArgumentException, java.lang.NullPointerException {
		...
		if (copyArray) {
			...
			if (nRows == 0) {
				throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.linear.Array2DRowFieldMatrix.AT_LEAST_ONE_ROW_MESSAGE);
			}
			final int nCols = d[0].length;
			if (nCols == 0) {
				throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.linear.Array2DRowFieldMatrix.AT_LEAST_ONE_COLUMN_MESSAGE);
			}
			for (int r = 1; r < nRows; r++) {
				if ((d[r].length) != nCols) {
					throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.linear.Array2DRowFieldMatrix.DIFFERENT_ROWS_LENGTHS_MESSAGE, nCols, d[r].length);
				}
			}
			data = d;
		}
		...
		if ((data) == null) {
			...
			for (int i = 0; i < (data.length); ++i) {
				if ((subMatrix[i].length) != nCols) {
					throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.linear.Array2DRowFieldMatrix.DIFFERENT_ROWS_LENGTHS_MESSAGE, nCols, subMatrix[i].length);
				}
	...
	public T getEntry(final int row, final int column) throws org.apache.commons.math.linear.MatrixIndexException {
		try {
			...
			throw new org.apache.commons.math.linear.MatrixIndexException(org.apache.commons.math.linear.Array2DRowFieldMatrix.NO_ENTRY_MESSAGE, row, column, getRowDimension(), getColumnDimension());
		}
	}
	...
	public T[] operate(final T[] v) throws java.lang.IllegalArgumentException {
		...
		if ((v.length) != nCols) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.linear.Array2DRowFieldMatrix.VECTOR_LENGTHS_MISMATCH, v.length, nCols);
		}
	...
	public T[] preMultiply(final T[] v) throws java.lang.IllegalArgumentException {
		...
		if ((v.length) != nRows) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.linear.Array2DRowFieldMatrix.VECTOR_LENGTHS_MISMATCH, v.length, nRows);
		}
