...
public class Fraction extends java.lang.Number implements java.io.Serializable , java.lang.Comparable<org.apache.commons.math.fraction.Fraction> , org.apache.commons.math.FieldElement<org.apache.commons.math.fraction.Fraction> {
	...
	public Fraction(int num, int den) {
		if (den == 0) {
			throw org.apache.commons.math.MathRuntimeException.createArithmeticException(org.apache.commons.math.fraction.Fraction.ZERO_DENOMINATOR_MESSAGE, num, den);
		}
		if (den < 0) {
			if ((num == (java.lang.Integer.MIN_VALUE)) || (den == (java.lang.Integer.MIN_VALUE))) {
				throw org.apache.commons.math.MathRuntimeException.createArithmeticException(org.apache.commons.math.fraction.Fraction.OVERFLOW_MESSAGE, num, den);
			}
			num = -num;
			den = -den;
		}
	...
	public org.apache.commons.math.fraction.Fraction negate() {
		if ((numerator) == (java.lang.Integer.MIN_VALUE)) {
			throw org.apache.commons.math.MathRuntimeException.createArithmeticException(org.apache.commons.math.fraction.Fraction.OVERFLOW_MESSAGE, numerator, denominator);
		}
	...
	private org.apache.commons.math.fraction.Fraction addSub(org.apache.commons.math.fraction.Fraction fraction, boolean isAdd) {
		if (fraction == null) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.fraction.Fraction.NULL_FRACTION);
		}
		if ((numerator) == 0) {
	...
	public static org.apache.commons.math.fraction.Fraction getReducedFraction(int numerator, int denominator) {
		if (denominator == 0) {
			throw org.apache.commons.math.MathRuntimeException.createArithmeticException(org.apache.commons.math.fraction.Fraction.ZERO_DENOMINATOR_MESSAGE, numerator, denominator);
		}
		if (numerator == 0) {
			return org.apache.commons.math.fraction.Fraction.ZERO;
		}
