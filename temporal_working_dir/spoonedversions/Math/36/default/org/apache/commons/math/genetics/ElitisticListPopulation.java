...
public class ElitisticListPopulation extends org.apache.commons.math.genetics.ListPopulation {
	...
	public ElitisticListPopulation(final java.util.List<org.apache.commons.math.genetics.Chromosome> chromosomes, final int populationLimit, final double elitismRate) {
	...
	public org.apache.commons.math.genetics.Population nextGeneration() {
		...
		int boundIndex = ((int) (org.apache.commons.math.util.FastMath.ceil(((1.0 - (org.apache.commons.math.genetics.ElitisticListPopulation.this.getElitismRate())) * (oldChromosomes.size())))));
	...
	public void setElitismRate(final double elitismRate) {
		if ((elitismRate < 0) || (elitismRate > 1)) {
			throw new org.apache.commons.math.exception.OutOfRangeException(org.apache.commons.math.exception.util.LocalizedFormats.ELITISM_RATE, elitismRate, 0, 1);
		}
		org.apache.commons.math.genetics.ElitisticListPopulation.this.elitismRate = elitismRate;
	}
