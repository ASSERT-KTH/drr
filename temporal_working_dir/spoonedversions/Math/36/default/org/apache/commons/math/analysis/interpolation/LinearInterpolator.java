...
public class LinearInterpolator implements org.apache.commons.math.analysis.interpolation.UnivariateInterpolator {
	public org.apache.commons.math.analysis.polynomials.PolynomialSplineFunction interpolate(double[] x, double[] y) {
		...
		if ((x.length) < 2) {
			throw new org.apache.commons.math.exception.NumberIsTooSmallException(org.apache.commons.math.exception.util.LocalizedFormats.NUMBER_OF_POINTS, x.length, 2, true);
		}
		int n = (x.length) - 1;
