...
public final class StatUtils {
	...
	public static double sumSq(final double[] values) {
		return org.apache.commons.math.stat.StatUtils.SUM_OF_SQUARES.evaluate(values);
	}

	public static double sumSq(final double[] values, final int begin, final int length) {
		return org.apache.commons.math.stat.StatUtils.SUM_OF_SQUARES.evaluate(values, begin, length);
	}

	public static double product(final double[] values) {
		return org.apache.commons.math.stat.StatUtils.PRODUCT.evaluate(values);
	}

	public static double product(final double[] values, final int begin, final int length) {
		return org.apache.commons.math.stat.StatUtils.PRODUCT.evaluate(values, begin, length);
	}

	public static double sumLog(final double[] values) {
		return org.apache.commons.math.stat.StatUtils.SUM_OF_LOGS.evaluate(values);
	}

	public static double sumLog(final double[] values, final int begin, final int length) {
		return org.apache.commons.math.stat.StatUtils.SUM_OF_LOGS.evaluate(values, begin, length);
	}
	...
	public static double geometricMean(final double[] values) {
		return org.apache.commons.math.stat.StatUtils.GEOMETRIC_MEAN.evaluate(values);
	}

	public static double geometricMean(final double[] values, final int begin, final int length) {
		return org.apache.commons.math.stat.StatUtils.GEOMETRIC_MEAN.evaluate(values, begin, length);
	}
	...
	public static double populationVariance(final double[] values) {
		return new org.apache.commons.math.stat.descriptive.moment.Variance(false).evaluate(values);
	}

	public static double populationVariance(final double[] values, final int begin, final int length) {
		return new org.apache.commons.math.stat.descriptive.moment.Variance(false).evaluate(values, begin, length);
	}

	public static double populationVariance(final double[] values, final double mean, final int begin, final int length) {
		return new org.apache.commons.math.stat.descriptive.moment.Variance(false).evaluate(values, mean, begin, length);
	}

	public static double populationVariance(final double[] values, final double mean) {
		return new org.apache.commons.math.stat.descriptive.moment.Variance(false).evaluate(values, mean);
	}
	...
	public static double sumDifference(final double[] sample1, final double[] sample2) {
		...
		if (n != (sample2.length)) {
			throw new org.apache.commons.math.exception.DimensionMismatchException(n, sample2.length);
		}
		if (n <= 0) {
			throw new org.apache.commons.math.exception.NoDataException(org.apache.commons.math.exception.util.LocalizedFormats.INSUFFICIENT_DIMENSION);
		}
		double result = 0;
		for (int i = 0; i < n; i++) {
	...
	public static double varianceDifference(final double[] sample1, final double[] sample2, double meanDifference) {
		...
		if (n < 2) {
			throw new org.apache.commons.math.exception.NumberIsTooSmallException(n, 2, true);
		}
		for (int i = 0; i < n; i++) {
