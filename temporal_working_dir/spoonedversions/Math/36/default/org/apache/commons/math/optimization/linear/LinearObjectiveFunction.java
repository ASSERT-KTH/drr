...
public class LinearObjectiveFunction implements java.io.Serializable {
	...
	public double getValue(final double[] point) {
		return (coefficients.dotProduct(new org.apache.commons.math.linear.ArrayRealVector(point, false))) + (constantTerm);
	}
	...
	public boolean equals(java.lang.Object other) {
		if ((org.apache.commons.math.optimization.linear.LinearObjectiveFunction.this) == other) {
			return true;
		}
	...
	private void readObject(java.io.ObjectInputStream ois) throws java.io.IOException, java.lang.ClassNotFoundException {
		...
		org.apache.commons.math.linear.MatrixUtils.deserializeRealVector(org.apache.commons.math.optimization.linear.LinearObjectiveFunction.this, "coefficients", ois);
	}
}
