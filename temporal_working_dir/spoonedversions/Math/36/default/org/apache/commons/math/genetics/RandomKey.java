...
public abstract class RandomKey<T> extends org.apache.commons.math.genetics.AbstractListChromosome<java.lang.Double> implements org.apache.commons.math.genetics.PermutationChromosome<T> {
	...
	public RandomKey(final java.util.List<java.lang.Double> representation) {
	...
	public RandomKey(final java.lang.Double[] representation) {
	...
	private static <S> java.util.List<S> decodeGeneric(final java.util.List<S> sequence, java.util.List<java.lang.Double> representation, final java.util.List<java.lang.Double> sortedRepr) {
		int l = sequence.size();
		if ((representation.size()) != l) {
			throw new org.apache.commons.math.exception.DimensionMismatchException(representation.size(), l);
		}
		if ((sortedRepr.size()) != l) {
			throw new org.apache.commons.math.exception.DimensionMismatchException(sortedRepr.size(), l);
		}
	...
	protected boolean isSame(final org.apache.commons.math.genetics.Chromosome another) {
		...
		java.util.List<java.lang.Integer> thisPerm = org.apache.commons.math.genetics.RandomKey.this.baseSeqPermutation;
	...
	@java.lang.Override
	protected void checkValidity(final java.util.List<java.lang.Double> chromosomeRepresentation) throws org.apache.commons.math.genetics.InvalidRepresentationException {
		for (double val : chromosomeRepresentation) {
			if ((val < 0) || (val > 1)) {
				throw new org.apache.commons.math.genetics.InvalidRepresentationException(org.apache.commons.math.exception.util.LocalizedFormats.OUT_OF_RANGE_SIMPLE, val, 0, 1);
			}
		}
	}
	...
	public static <S> java.util.List<java.lang.Double> inducedPermutation(final java.util.List<S> originalData, final java.util.List<S> permutedData) {
		if ((originalData.size()) != (permutedData.size())) {
			throw new org.apache.commons.math.exception.DimensionMismatchException(permutedData.size(), originalData.size());
		}
		...
		for (int i = 0; i < l; i++) {
			...
			if (index == (-1)) {
				throw new org.apache.commons.math.exception.MathIllegalArgumentException(org.apache.commons.math.exception.util.LocalizedFormats.DIFFERENT_ORIG_AND_PERMUTED_DATA);
			}
