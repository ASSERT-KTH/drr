...
public class GeneticAlgorithm {
	...
	public GeneticAlgorithm(final org.apache.commons.math.genetics.CrossoverPolicy crossoverPolicy, final double crossoverRate, final org.apache.commons.math.genetics.MutationPolicy mutationPolicy, final double mutationRate, final org.apache.commons.math.genetics.SelectionPolicy selectionPolicy) {
		if ((crossoverRate < 0) || (crossoverRate > 1)) {
			throw new org.apache.commons.math.exception.OutOfRangeException(org.apache.commons.math.exception.util.LocalizedFormats.CROSSOVER_RATE, crossoverRate, 0, 1);
		}
		if ((mutationRate < 0) || (mutationRate > 1)) {
			throw new org.apache.commons.math.exception.OutOfRangeException(org.apache.commons.math.exception.util.LocalizedFormats.MUTATION_RATE, mutationRate, 0, 1);
		}
	...
	public static synchronized void setRandomGenerator(final org.apache.commons.math.random.RandomGenerator random) {
	...
	public org.apache.commons.math.genetics.Population evolve(final org.apache.commons.math.genetics.Population initial, final org.apache.commons.math.genetics.StoppingCondition condition) {
	...
	public org.apache.commons.math.genetics.Population nextGeneration(final org.apache.commons.math.genetics.Population current) {
