...
public class SymmLQ extends org.apache.commons.math.linear.PreconditionedIterativeLinearSolver {
	private class State {
		...
		private final org.apache.commons.math.linear.RealLinearOperator minv;

		private double minusEpsZeta;

		private final org.apache.commons.math.linear.RealVector minvb;
		...
		public State(final org.apache.commons.math.linear.RealLinearOperator a, final org.apache.commons.math.linear.RealLinearOperator minv, final org.apache.commons.math.linear.RealVector b, final org.apache.commons.math.linear.RealVector x, final boolean goodb, final double shift) {
			this.a = a;
			this.minv = minv;
			this.b = b;
			this.x = x;
		...
		private void init() {
			...
			org.apache.commons.math.linear.SymmLQ.State.this.y = ((org.apache.commons.math.linear.SymmLQ.State.this.minv) == null) ? org.apache.commons.math.linear.SymmLQ.State.this.b.copy() : org.apache.commons.math.linear.SymmLQ.State.this.minv.operate(org.apache.commons.math.linear.SymmLQ.State.this.r1);
			if (((org.apache.commons.math.linear.SymmLQ.State.this.minv) != null) && (check)) {
				org.apache.commons.math.linear.SymmLQ.checkSymmetry(org.apache.commons.math.linear.SymmLQ.State.this.minv, org.apache.commons.math.linear.SymmLQ.State.this.r1, org.apache.commons.math.linear.SymmLQ.State.this.y, org.apache.commons.math.linear.SymmLQ.State.this.minv.operate(org.apache.commons.math.linear.SymmLQ.State.this.y));
			}
			...
			if ((org.apache.commons.math.linear.SymmLQ.State.this.beta1) < 0.0) {
				org.apache.commons.math.linear.SymmLQ.throwNPDLOException(org.apache.commons.math.linear.SymmLQ.State.this.minv, org.apache.commons.math.linear.SymmLQ.State.this.y);
			}
			if ((org.apache.commons.math.linear.SymmLQ.State.this.beta1) == 0.0) {
				return ;
			}
			...
			if ((org.apache.commons.math.linear.SymmLQ.State.this.minv) != null) {
				org.apache.commons.math.linear.SymmLQ.State.this.y = org.apache.commons.math.linear.SymmLQ.State.this.minv.operate(org.apache.commons.math.linear.SymmLQ.State.this.r2);
			}
		...
		private void update() {
			...
			if ((beta) < 0.0) {
				org.apache.commons.math.linear.SymmLQ.throwNPDLOException(minv, y);
			}
	...
	private class SymmLQEvent extends org.apache.commons.math.linear.IterativeLinearSolverEvent {
		private static final long serialVersionUID = 2012012801L;

		private final org.apache.commons.math.linear.SymmLQ.State state;

		public SymmLQEvent(final java.lang.Object source, final org.apache.commons.math.linear.SymmLQ.State state) {
		...
		public double getNormOfResidual() {
			return org.apache.commons.math.util.FastMath.min(state.cgnorm, state.lqnorm);
		}

		@java.lang.Override
		public org.apache.commons.math.linear.RealVector getRightHandSideVector() {
			return org.apache.commons.math.linear.RealVector.unmodifiableRealVector(state.b);
		}
	...
	public org.apache.commons.math.linear.RealVector solve(final org.apache.commons.math.linear.RealLinearOperator a, final org.apache.commons.math.linear.RealLinearOperator minv, final org.apache.commons.math.linear.RealVector b) throws org.apache.commons.math.exception.DimensionMismatchException, org.apache.commons.math.exception.MaxCountExceededException, org.apache.commons.math.exception.NullArgumentException, org.apache.commons.math.linear.IllConditionedOperatorException, org.apache.commons.math.linear.NonPositiveDefiniteOperatorException, org.apache.commons.math.linear.NonSelfAdjointOperatorException, org.apache.commons.math.linear.NonSquareOperatorException {
		...
		return solveInPlace(a, minv, b, x, false, 0.0);
	}

	public org.apache.commons.math.linear.RealVector solve(final org.apache.commons.math.linear.RealLinearOperator a, final org.apache.commons.math.linear.RealLinearOperator minv, final org.apache.commons.math.linear.RealVector b, final boolean goodb, final double shift) throws org.apache.commons.math.exception.DimensionMismatchException, org.apache.commons.math.exception.MaxCountExceededException, org.apache.commons.math.exception.NullArgumentException, org.apache.commons.math.linear.IllConditionedOperatorException, org.apache.commons.math.linear.NonPositiveDefiniteOperatorException, org.apache.commons.math.linear.NonSelfAdjointOperatorException, org.apache.commons.math.linear.NonSquareOperatorException {
		org.apache.commons.math.util.MathUtils.checkNotNull(a);
		final org.apache.commons.math.linear.RealVector x = new org.apache.commons.math.linear.ArrayRealVector(a.getColumnDimension());
	...
	@java.lang.Override
	public org.apache.commons.math.linear.RealVector solve(final org.apache.commons.math.linear.RealLinearOperator a, final org.apache.commons.math.linear.RealLinearOperator minv, final org.apache.commons.math.linear.RealVector b, final org.apache.commons.math.linear.RealVector x) throws org.apache.commons.math.exception.DimensionMismatchException, org.apache.commons.math.exception.MaxCountExceededException, org.apache.commons.math.exception.NullArgumentException, org.apache.commons.math.linear.IllConditionedOperatorException, org.apache.commons.math.linear.NonPositiveDefiniteOperatorException, org.apache.commons.math.linear.NonSelfAdjointOperatorException, org.apache.commons.math.linear.NonSquareOperatorException {
		org.apache.commons.math.util.MathUtils.checkNotNull(x);
		return solveInPlace(a, minv, b, x.copy(), false, 0.0);
	}
	...
	@java.lang.Override
	public org.apache.commons.math.linear.RealVector solveInPlace(final org.apache.commons.math.linear.RealLinearOperator a, final org.apache.commons.math.linear.RealLinearOperator minv, final org.apache.commons.math.linear.RealVector b, final org.apache.commons.math.linear.RealVector x) throws org.apache.commons.math.exception.DimensionMismatchException, org.apache.commons.math.exception.MaxCountExceededException, org.apache.commons.math.exception.NullArgumentException, org.apache.commons.math.linear.IllConditionedOperatorException, org.apache.commons.math.linear.NonPositiveDefiniteOperatorException, org.apache.commons.math.linear.NonSelfAdjointOperatorException, org.apache.commons.math.linear.NonSquareOperatorException {
		return solveInPlace(a, minv, b, x, false, 0.0);
	}

	public org.apache.commons.math.linear.RealVector solveInPlace(final org.apache.commons.math.linear.RealLinearOperator a, final org.apache.commons.math.linear.RealLinearOperator minv, final org.apache.commons.math.linear.RealVector b, final org.apache.commons.math.linear.RealVector x, final boolean goodb, final double shift) throws org.apache.commons.math.exception.DimensionMismatchException, org.apache.commons.math.exception.MaxCountExceededException, org.apache.commons.math.exception.NullArgumentException, org.apache.commons.math.linear.IllConditionedOperatorException, org.apache.commons.math.linear.NonPositiveDefiniteOperatorException, org.apache.commons.math.linear.NonSelfAdjointOperatorException, org.apache.commons.math.linear.NonSquareOperatorException {
		org.apache.commons.math.linear.PreconditionedIterativeLinearSolver.checkParameters(a, minv, b, x);
		final org.apache.commons.math.util.IterationManager manager = getIterationManager();
		manager.resetIterationCount();
		manager.incrementIterationCount();
		final org.apache.commons.math.linear.SymmLQ.State state = new org.apache.commons.math.linear.SymmLQ.State(a, minv, b, x, goodb, shift);
		final org.apache.commons.math.linear.IterativeLinearSolverEvent event = new org.apache.commons.math.linear.SymmLQ.SymmLQEvent(org.apache.commons.math.linear.SymmLQ.this, state);
		if ((state.beta1) == 0.0) {
