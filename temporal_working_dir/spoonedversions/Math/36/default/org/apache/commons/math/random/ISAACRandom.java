...
public class ISAACRandom extends org.apache.commons.math.random.BitsStreamGenerator implements java.io.Serializable {
	...
	private final int[] rsl = new int[org.apache.commons.math.random.ISAACRandom.SIZE];

	private final int[] mem = new int[org.apache.commons.math.random.ISAACRandom.SIZE];
