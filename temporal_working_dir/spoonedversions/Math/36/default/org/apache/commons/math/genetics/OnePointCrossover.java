...
public class OnePointCrossover<T> implements org.apache.commons.math.genetics.CrossoverPolicy {
	...
	public org.apache.commons.math.genetics.ChromosomePair crossover(final org.apache.commons.math.genetics.Chromosome first, final org.apache.commons.math.genetics.Chromosome second) {
		if (!((first instanceof org.apache.commons.math.genetics.AbstractListChromosome<?>) && (second instanceof org.apache.commons.math.genetics.AbstractListChromosome<?>))) {
			throw new org.apache.commons.math.exception.MathIllegalArgumentException(org.apache.commons.math.exception.util.LocalizedFormats.INVALID_FIXED_LENGTH_CHROMOSOME);
		}
	...
	private org.apache.commons.math.genetics.ChromosomePair crossover(final org.apache.commons.math.genetics.AbstractListChromosome<T> first, final org.apache.commons.math.genetics.AbstractListChromosome<T> second) {
		int length = first.getLength();
		if (length != (second.getLength())) {
			throw new org.apache.commons.math.exception.DimensionMismatchException(second.getLength(), length);
		}
