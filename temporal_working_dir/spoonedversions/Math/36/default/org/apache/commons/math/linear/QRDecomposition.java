...
public class QRDecomposition {
	...
	public QRDecomposition(org.apache.commons.math.linear.RealMatrix matrix, double threshold) {
	...
	public org.apache.commons.math.linear.DecompositionSolver getSolver() {
		return new org.apache.commons.math.linear.QRDecomposition.Solver(qrt, rDiag, threshold);
	}
	...
	private static class Solver implements org.apache.commons.math.linear.DecompositionSolver {
		...
		public boolean isNonSingular() {
			for (double diag : rDiag) {
				if ((org.apache.commons.math.util.FastMath.abs(diag)) <= (threshold)) {
					return false;
				}
			}
			return true;
