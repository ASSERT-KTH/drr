...
public abstract class BaseAbstractMultivariateOptimizer<FUNC extends org.apache.commons.math.analysis.MultivariateFunction> implements org.apache.commons.math.optimization.BaseMultivariateOptimizer<FUNC> {
	...
	private org.apache.commons.math.optimization.ConvergenceChecker<org.apache.commons.math.optimization.PointValuePair> checker;
	...
	protected BaseAbstractMultivariateOptimizer(org.apache.commons.math.optimization.ConvergenceChecker<org.apache.commons.math.optimization.PointValuePair> checker) {
	...
	public org.apache.commons.math.optimization.PointValuePair optimize(int maxEval, FUNC f, org.apache.commons.math.optimization.GoalType goalType, double[] startPoint) {
		if (f == null) {
	...
	protected abstract org.apache.commons.math.optimization.PointValuePair doOptimize();
}
