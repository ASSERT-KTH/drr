...
public class SimplexSolver extends org.apache.commons.math.optimization.linear.AbstractLinearOptimizer {
	...
	private java.lang.Integer getPivotColumn(org.apache.commons.math.optimization.linear.SimplexTableau tableau) {
		...
		for (int i = tableau.getNumObjectiveFunctions(); i < ((tableau.getWidth()) - 1); i++) {
			...
			if ((org.apache.commons.math.util.Precision.compareTo(entry, minValue, maxUlps)) < 0) {
				minValue = entry;
				minPos = i;
			}
		}
	...
	private java.lang.Integer getPivotRow(org.apache.commons.math.optimization.linear.SimplexTableau tableau, final int col) {
		...
		for (int i = tableau.getNumObjectiveFunctions(); i < (tableau.getHeight()); i++) {
			...
			if ((org.apache.commons.math.util.Precision.compareTo(entry, 0.0, maxUlps)) > 0) {
				...
				final int cmp = org.apache.commons.math.util.Precision.compareTo(ratio, minRatio, maxUlps);
				if (cmp == 0) {
			...
			if ((minRatioPositions.size()) > 1) {
				for (java.lang.Integer row : minRatioPositions) {
					for (int i = 0; i < (tableau.getNumArtificialVariables()); i++) {
						...
						if ((org.apache.commons.math.util.Precision.equals(entry, 1.0, maxUlps)) && (row.equals(tableau.getBasicRow(column)))) {
							return row;
						}
					}
				}
	...
	protected void solvePhase1(final org.apache.commons.math.optimization.linear.SimplexTableau tableau) throws org.apache.commons.math.exception.MaxCountExceededException, org.apache.commons.math.optimization.linear.NoFeasibleSolutionException, org.apache.commons.math.optimization.linear.UnboundedSolutionException {
		...
		if (!(org.apache.commons.math.util.Precision.equals(tableau.getEntry(0, tableau.getRhsOffset()), 0.0, epsilon))) {
			throw new org.apache.commons.math.optimization.linear.NoFeasibleSolutionException();
		}
	}

	@java.lang.Override
	public org.apache.commons.math.optimization.PointValuePair doOptimize() throws org.apache.commons.math.exception.MaxCountExceededException, org.apache.commons.math.optimization.linear.NoFeasibleSolutionException, org.apache.commons.math.optimization.linear.UnboundedSolutionException {
