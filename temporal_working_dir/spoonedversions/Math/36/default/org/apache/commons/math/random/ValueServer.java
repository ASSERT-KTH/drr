...
public class ValueServer {
	...
	public void computeDistribution() throws java.io.IOException {
		computeDistribution(org.apache.commons.math.random.EmpiricalDistribution.DEFAULT_BIN_COUNT);
	}

	public void computeDistribution(int binCount) throws java.io.IOException {
		empiricalDistribution = new org.apache.commons.math.random.EmpiricalDistribution(binCount, randomData);
