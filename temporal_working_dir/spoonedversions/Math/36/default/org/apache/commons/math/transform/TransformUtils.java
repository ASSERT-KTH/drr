...
public class TransformUtils {
	...
	public static double[][] createRealImaginaryArray(final org.apache.commons.math.complex.Complex[] dataC) {
		final double[][] dataRI = new double[2][dataC.length];
		final double[] dataR = dataRI[0];
		final double[] dataI = dataRI[1];
		for (int i = 0; i < (dataC.length); i++) {
			final org.apache.commons.math.complex.Complex c = dataC[i];
			dataR[i] = c.getReal();
	...
	public static org.apache.commons.math.complex.Complex[] createComplexArray(final double[][] dataRI) throws org.apache.commons.math.exception.DimensionMismatchException {
		if ((dataRI.length) != 2) {
		...
		final org.apache.commons.math.complex.Complex[] c = new org.apache.commons.math.complex.Complex[n];
		for (int i = 0; i < n; i++) {
			c[i] = new org.apache.commons.math.complex.Complex(dataR[i], dataI[i]);
		}
		return c;
	}

	public static int exactLog2(final int n) throws org.apache.commons.math.exception.MathIllegalArgumentException {
		int index = java.util.Arrays.binarySearch(org.apache.commons.math.transform.TransformUtils.POWERS_OF_TWO, n);
		if (index < 0) {
