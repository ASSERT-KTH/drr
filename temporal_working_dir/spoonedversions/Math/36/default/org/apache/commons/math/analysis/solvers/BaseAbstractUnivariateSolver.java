...
public abstract class BaseAbstractUnivariateSolver<FUNC extends org.apache.commons.math.analysis.UnivariateFunction> implements org.apache.commons.math.analysis.solvers.BaseUnivariateSolver<FUNC> {
	...
	protected BaseAbstractUnivariateSolver(final double absoluteAccuracy) {
		this(org.apache.commons.math.analysis.solvers.BaseAbstractUnivariateSolver.DEFAULT_RELATIVE_ACCURACY, absoluteAccuracy, org.apache.commons.math.analysis.solvers.BaseAbstractUnivariateSolver.DEFAULT_FUNCTION_VALUE_ACCURACY);
	}

	protected BaseAbstractUnivariateSolver(final double relativeAccuracy, final double absoluteAccuracy) {
		this(relativeAccuracy, absoluteAccuracy, org.apache.commons.math.analysis.solvers.BaseAbstractUnivariateSolver.DEFAULT_FUNCTION_VALUE_ACCURACY);
	}
	...
	protected boolean isBracketing(final double lower, final double upper) {
		return org.apache.commons.math.analysis.solvers.UnivariateSolverUtils.isBracketing(function, lower, upper);
	}

	protected boolean isSequence(final double start, final double mid, final double end) {
		return org.apache.commons.math.analysis.solvers.UnivariateSolverUtils.isSequence(start, mid, end);
	}
	...
	protected void verifySequence(final double lower, final double initial, final double upper) {
		org.apache.commons.math.analysis.solvers.UnivariateSolverUtils.verifySequence(lower, initial, upper);
	}

	protected void verifyBracketing(final double lower, final double upper) {
		org.apache.commons.math.analysis.solvers.UnivariateSolverUtils.verifyBracketing(function, lower, upper);
	}
