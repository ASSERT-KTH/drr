...
public class PowellOptimizer extends org.apache.commons.math.optimization.direct.BaseAbstractMultivariateOptimizer<org.apache.commons.math.analysis.MultivariateFunction> implements org.apache.commons.math.optimization.MultivariateOptimizer {
	...
	public PowellOptimizer(double rel, double abs, org.apache.commons.math.optimization.ConvergenceChecker<org.apache.commons.math.optimization.PointValuePair> checker) {
		super(checker);
	...
	protected org.apache.commons.math.optimization.PointValuePair doOptimize() {
		...
		while (true) {
			...
			for (int i = 0; i < n; i++) {
				...
				fX2 = fVal;
				final org.apache.commons.math.optimization.univariate.UnivariatePointValuePair optimum = line.search(x, d);
			...
			final org.apache.commons.math.optimization.PointValuePair previous = new org.apache.commons.math.optimization.PointValuePair(x1, fX);
			final org.apache.commons.math.optimization.PointValuePair current = new org.apache.commons.math.optimization.PointValuePair(x, fVal);
			if (!stop) {
				if (checker != null) {
	...
	private class LineSearch extends org.apache.commons.math.optimization.univariate.BrentOptimizer {
		...
		public org.apache.commons.math.optimization.univariate.UnivariatePointValuePair search(final double[] p, final double[] d) {
			final int n = p.length;
