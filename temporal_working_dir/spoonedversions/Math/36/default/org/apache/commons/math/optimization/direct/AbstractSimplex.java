...
public abstract class AbstractSimplex {
	private org.apache.commons.math.optimization.PointValuePair[] simplex;
	...
	public abstract void iterate(final org.apache.commons.math.analysis.MultivariateFunction evaluationFunction, final java.util.Comparator<org.apache.commons.math.optimization.PointValuePair> comparator);

	public void build(final double[] startPoint) {
		if ((dimension) != (startPoint.length)) {
			throw new org.apache.commons.math.exception.DimensionMismatchException(dimension, startPoint.length);
		}
		simplex = new org.apache.commons.math.optimization.PointValuePair[(dimension) + 1];
		simplex[0] = new org.apache.commons.math.optimization.PointValuePair(startPoint, java.lang.Double.NaN);
		for (int i = 0; i < (dimension); i++) {
			...
			simplex[(i + 1)] = new org.apache.commons.math.optimization.PointValuePair(vertexI, java.lang.Double.NaN);
		}
	}

	public void evaluate(final org.apache.commons.math.analysis.MultivariateFunction evaluationFunction, final java.util.Comparator<org.apache.commons.math.optimization.PointValuePair> comparator) {
		for (int i = 0; i < (simplex.length); i++) {
			final org.apache.commons.math.optimization.PointValuePair vertex = simplex[i];
			final double[] point = vertex.getPointRef();
			if (java.lang.Double.isNaN(vertex.getValue())) {
				simplex[i] = new org.apache.commons.math.optimization.PointValuePair(point, evaluationFunction.value(point), false);
			}
		}
		java.util.Arrays.sort(simplex, comparator);
	}

	protected void replaceWorstPoint(org.apache.commons.math.optimization.PointValuePair pointValuePair, final java.util.Comparator<org.apache.commons.math.optimization.PointValuePair> comparator) {
		for (int i = 0; i < (dimension); i++) {
			if ((comparator.compare(simplex[i], pointValuePair)) > 0) {
				org.apache.commons.math.optimization.PointValuePair tmp = simplex[i];
	...
	public org.apache.commons.math.optimization.PointValuePair[] getPoints() {
		final org.apache.commons.math.optimization.PointValuePair[] copy = new org.apache.commons.math.optimization.PointValuePair[simplex.length];
		java.lang.System.arraycopy(simplex, 0, copy, 0, simplex.length);
		return copy;
	}

	public org.apache.commons.math.optimization.PointValuePair getPoint(int index) {
	...
	protected void setPoint(int index, org.apache.commons.math.optimization.PointValuePair point) {
		if ((index < 0) || (index >= (simplex.length))) {
			throw new org.apache.commons.math.exception.OutOfRangeException(index, 0, ((simplex.length) - 1));
		}
		simplex[index] = point;
	...
	protected void setPoints(org.apache.commons.math.optimization.PointValuePair[] points) {
