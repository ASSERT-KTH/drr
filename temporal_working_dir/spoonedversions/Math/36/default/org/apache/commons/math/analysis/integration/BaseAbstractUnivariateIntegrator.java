...
public abstract class BaseAbstractUnivariateIntegrator implements org.apache.commons.math.analysis.integration.UnivariateIntegrator {
	...
	protected BaseAbstractUnivariateIntegrator(final double relativeAccuracy, final double absoluteAccuracy, final int minimalIterationCount, final int maximalIterationCount) throws org.apache.commons.math.exception.NotStrictlyPositiveException, org.apache.commons.math.exception.NumberIsTooSmallException {
		org.apache.commons.math.analysis.integration.BaseAbstractUnivariateIntegrator.this.relativeAccuracy = relativeAccuracy;
		org.apache.commons.math.analysis.integration.BaseAbstractUnivariateIntegrator.this.absoluteAccuracy = absoluteAccuracy;
		...
		org.apache.commons.math.analysis.integration.BaseAbstractUnivariateIntegrator.this.minimalIterationCount = minimalIterationCount;
		org.apache.commons.math.analysis.integration.BaseAbstractUnivariateIntegrator.this.iterations = new org.apache.commons.math.util.Incrementor();
	...
	protected BaseAbstractUnivariateIntegrator(final double relativeAccuracy, final double absoluteAccuracy) {
		this(relativeAccuracy, absoluteAccuracy, org.apache.commons.math.analysis.integration.BaseAbstractUnivariateIntegrator.DEFAULT_MIN_ITERATIONS_COUNT, org.apache.commons.math.analysis.integration.BaseAbstractUnivariateIntegrator.DEFAULT_MAX_ITERATIONS_COUNT);
	}

	protected BaseAbstractUnivariateIntegrator(final int minimalIterationCount, final int maximalIterationCount) throws org.apache.commons.math.exception.NotStrictlyPositiveException, org.apache.commons.math.exception.NumberIsTooSmallException {
		this(org.apache.commons.math.analysis.integration.BaseAbstractUnivariateIntegrator.DEFAULT_RELATIVE_ACCURACY, org.apache.commons.math.analysis.integration.BaseAbstractUnivariateIntegrator.DEFAULT_ABSOLUTE_ACCURACY, minimalIterationCount, maximalIterationCount);
	}
	...
	protected void setup(final int maxEval, final org.apache.commons.math.analysis.UnivariateFunction f, final double lower, final double upper) throws org.apache.commons.math.exception.MathIllegalArgumentException, org.apache.commons.math.exception.NullArgumentException {
		...
		org.apache.commons.math.analysis.integration.BaseAbstractUnivariateIntegrator.this.min = lower;
		org.apache.commons.math.analysis.integration.BaseAbstractUnivariateIntegrator.this.max = upper;
		function = f;
