...
public class MullerSolver extends org.apache.commons.math.analysis.solvers.AbstractUnivariateSolver {
	...
	private double solve(double min, double max, double fMin, double fMax) {
		...
		while (true) {
			...
			if (!bisect) {
				...
				if (((org.apache.commons.math.util.FastMath.signum(y0)) + (org.apache.commons.math.util.FastMath.signum(ym))) == 0.0) {
					x2 = xm;
					y2 = ym;
				}else {
					x0 = xm;
