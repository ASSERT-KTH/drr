...
public class EventState {
	...
	public EventState(final org.apache.commons.math.ode.events.EventHandler handler, final double maxCheckInterval, final double convergence, final int maxIterationCount, final org.apache.commons.math.analysis.solvers.UnivariateSolver solver) {
	...
	public boolean evaluateStep(final org.apache.commons.math.ode.sampling.StepInterpolator interpolator) throws org.apache.commons.math.exception.ConvergenceException {
		...
		for (int i = 0; i < n; ++i) {
			...
			if ((g0Positive) ^ (gb >= 0)) {
				increasing = gb >= ga;
				final double root;
				if ((solver) instanceof org.apache.commons.math.analysis.solvers.BracketedUnivariateSolver<?>) {
					@java.lang.SuppressWarnings(value = "unchecked")
					org.apache.commons.math.analysis.solvers.BracketedUnivariateSolver<org.apache.commons.math.analysis.UnivariateFunction> bracketing = ((org.apache.commons.math.analysis.solvers.BracketedUnivariateSolver<org.apache.commons.math.analysis.UnivariateFunction>) (solver));
					...
					org.apache.commons.math.analysis.solvers.BracketedUnivariateSolver<org.apache.commons.math.analysis.UnivariateFunction> bracketing = new org.apache.commons.math.analysis.solvers.PegasusSolver(solver.getRelativeAccuracy(), solver.getAbsoluteAccuracy());
					root = (forward) ? org.apache.commons.math.analysis.solvers.UnivariateSolverUtils.forceSide(remainingEval, f, bracketing, baseRoot, ta, tb, org.apache.commons.math.analysis.solvers.AllowedSolution.RIGHT_SIDE) : org.apache.commons.math.analysis.solvers.UnivariateSolverUtils.forceSide(remainingEval, f, bracketing, baseRoot, tb, ta, org.apache.commons.math.analysis.solvers.AllowedSolution.LEFT_SIDE);
				}
