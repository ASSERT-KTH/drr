...
public class OpenMapRealVector extends org.apache.commons.math3.linear.SparseRealVector implements java.io.Serializable {
	...
	public double dotProduct(org.apache.commons.math3.linear.OpenMapRealVector v) {
		...
		org.apache.commons.math3.util.OpenIntToDoubleHashMap.Iterator iter = thisIsSmaller ? entries.iterator() : v.entries.iterator();
		org.apache.commons.math3.util.OpenIntToDoubleHashMap larger = thisIsSmaller ? v.entries : entries;
		double d = 0;
		while (iter.hasNext()) {
			iter.advance();
	...
	public double dotProduct(org.apache.commons.math3.linear.RealVector v) {
		if (v instanceof org.apache.commons.math3.linear.OpenMapRealVector) {
			return dotProduct(((org.apache.commons.math3.linear.OpenMapRealVector) (v)));
		}else {
	...
	@java.lang.Override
	public org.apache.commons.math3.linear.OpenMapRealVector unitVector() {
		org.apache.commons.math3.linear.OpenMapRealVector res = copy();
		res.unitize();
		return res;
	}
