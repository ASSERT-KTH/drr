...
public class GaussianFitter extends org.apache.commons.math3.optimization.fitting.CurveFitter {
	public GaussianFitter(org.apache.commons.math3.optimization.DifferentiableMultivariateVectorOptimizer optimizer) {
		super(optimizer);
	}

	public double[] fit(double[] initialGuess) {
		final org.apache.commons.math3.analysis.ParametricUnivariateFunction f = new org.apache.commons.math3.analysis.ParametricUnivariateFunction() {
			private final org.apache.commons.math3.analysis.ParametricUnivariateFunction g = new org.apache.commons.math3.analysis.function.Gaussian.Parametric();
