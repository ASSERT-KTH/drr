...
public class EventState {
	...
	public boolean evaluateStep(final org.apache.commons.math.ode.sampling.StepInterpolator interpolator) throws org.apache.commons.math.ConvergenceException, org.apache.commons.math.exception.MathUserException, org.apache.commons.math.ode.events.EventException {
		try {
			...
			final org.apache.commons.math.analysis.UnivariateRealFunction f = new org.apache.commons.math.analysis.UnivariateRealFunction() {
				public double value(final double t) {
					try {
						...
						throw new org.apache.commons.math.ode.events.EventState.ConveyedException(e);
					}
				}
			};
			double ta = t0;
			...
			pendingEventTime = java.lang.Double.NaN;
			return false;
		} catch (org.apache.commons.math.ode.events.EventState.ConveyedException ce) {
	...
	private static class ConveyedException extends java.lang.RuntimeException {
		private static final long serialVersionUID = 2668348550531980574L;

		private final org.apache.commons.math.ode.events.EventException conveyedException;

		public ConveyedException(final org.apache.commons.math.ode.events.EventException conveyedException) {
			this.conveyedException = conveyedException;
		}

		public org.apache.commons.math.ode.events.EventException getConveyedException() {
