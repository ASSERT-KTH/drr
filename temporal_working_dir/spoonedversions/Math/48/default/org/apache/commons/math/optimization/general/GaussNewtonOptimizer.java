...
public class GaussNewtonOptimizer extends org.apache.commons.math.optimization.general.AbstractLeastSquaresOptimizer {
	...
	public GaussNewtonOptimizer(org.apache.commons.math.optimization.ConvergenceChecker<org.apache.commons.math.optimization.VectorialPointValuePair> checker) {
		this(true, checker);
	}

	public GaussNewtonOptimizer(final boolean useLU) {
		this(useLU, new org.apache.commons.math.optimization.SimpleVectorialValueChecker());
	}

	public GaussNewtonOptimizer(final boolean useLU, org.apache.commons.math.optimization.ConvergenceChecker<org.apache.commons.math.optimization.VectorialPointValuePair> checker) {
		super(checker);
		this.useLU = useLU;
	}
