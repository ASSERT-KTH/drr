...
public abstract class UnivariateRealIntegratorImpl implements org.apache.commons.math.analysis.integration.UnivariateRealIntegrator {
	...
	protected org.apache.commons.math.analysis.UnivariateRealFunction function;
	...
	protected void setup(final int maxEval, final org.apache.commons.math.analysis.UnivariateRealFunction f, final double min, final double max) throws org.apache.commons.math.exception.MathIllegalArgumentException, org.apache.commons.math.exception.NullArgumentException {
		org.apache.commons.math.util.MathUtils.checkNotNull(f);
		org.apache.commons.math.analysis.solvers.UnivariateRealSolverUtils.verifyInterval(min, max);
		org.apache.commons.math.analysis.integration.UnivariateRealIntegratorImpl.this.min = min;
		org.apache.commons.math.analysis.integration.UnivariateRealIntegratorImpl.this.max = max;
		function = f;
	...
	public double integrate(final int maxEval, final org.apache.commons.math.analysis.UnivariateRealFunction f, final double min, final double max) throws org.apache.commons.math.ConvergenceException, org.apache.commons.math.exception.MathIllegalArgumentException, org.apache.commons.math.exception.NullArgumentException, org.apache.commons.math.exception.TooManyEvaluationsException {
		setup(maxEval, f, min, max);
		return doIntegrate();
	}

	protected abstract double doIntegrate() throws org.apache.commons.math.ConvergenceException, org.apache.commons.math.exception.TooManyEvaluationsException;
}
