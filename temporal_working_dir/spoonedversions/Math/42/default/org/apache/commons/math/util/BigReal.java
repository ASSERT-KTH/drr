...
public class BigReal implements java.io.Serializable , java.lang.Comparable<org.apache.commons.math.util.BigReal> , org.apache.commons.math.FieldElement<org.apache.commons.math.util.BigReal> {
	...
	public void setRoundingMode(java.math.RoundingMode roundingMode) {
		org.apache.commons.math.util.BigReal.this.roundingMode = roundingMode;
	}
	...
	public void setScale(int scale) {
		org.apache.commons.math.util.BigReal.this.scale = scale;
	}
	...
	public org.apache.commons.math.util.BigReal negate() {
		return new org.apache.commons.math.util.BigReal(d.negate());
	}
	...
	public org.apache.commons.math.util.BigReal reciprocal() {
		return new org.apache.commons.math.util.BigReal(java.math.BigDecimal.ONE.divide(d, scale, roundingMode));
	}
	...
	public org.apache.commons.math.util.BigReal multiply(final int n) {
		return new org.apache.commons.math.util.BigReal(d.multiply(new java.math.BigDecimal(n)));
	}
	...
	public boolean equals(java.lang.Object other) {
		if ((org.apache.commons.math.util.BigReal.this) == other) {
			return true;
		}
