	...
	public SingularValueDecomposition(final org.apache.commons.math.linear.RealMatrix matrix) {
		...
		while (p > 0) {
			...
			switch (kase) {
				...
				case 3 :
					{
						final double maxPm1Pm2 = org.apache.commons.math.util.FastMath.max(org.apache.commons.math.util.FastMath.abs(singularValues[(p - 1)]), org.apache.commons.math.util.FastMath.abs(singularValues[(p - 2)]));
						final double scale = org.apache.commons.math.util.FastMath.max(org.apache.commons.math.util.FastMath.max(org.apache.commons.math.util.FastMath.max(maxPm1Pm2, org.apache.commons.math.util.FastMath.abs(e[(p - 2)])), org.apache.commons.math.util.FastMath.abs(singularValues[k])), org.apache.commons.math.util.FastMath.abs(e[k]));
		...
		tol = org.apache.commons.math.util.FastMath.max((((m) * (singularValues[0])) * (org.apache.commons.math.linear.SingularValueDecomposition.EPS)), org.apache.commons.math.util.FastMath.sqrt(org.apache.commons.math.util.Precision.SAFE_MIN));
		if (!(transposed)) {
