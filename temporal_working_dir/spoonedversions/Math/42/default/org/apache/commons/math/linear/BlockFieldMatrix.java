...
public class BlockFieldMatrix<T extends org.apache.commons.math.FieldElement<T>> extends org.apache.commons.math.linear.AbstractFieldMatrix<T> implements java.io.Serializable {
	...
	public BlockFieldMatrix(final org.apache.commons.math.Field<T> field, final int rows, final int columns) {
	...
	public static <T extends org.apache.commons.math.FieldElement<T>> T[][] toBlocksLayout(final T[][] rawData) {
	...
	@java.lang.Override
	public org.apache.commons.math.linear.FieldMatrix<T> add(final org.apache.commons.math.linear.FieldMatrix<T> m) {
		try {
	...
	public org.apache.commons.math.linear.BlockFieldMatrix<T> add(final org.apache.commons.math.linear.BlockFieldMatrix<T> m) {
		checkAdditionCompatible(m);
		final org.apache.commons.math.linear.BlockFieldMatrix<T> out = new org.apache.commons.math.linear.BlockFieldMatrix<T>(getField(), rows, columns);
	...
	public org.apache.commons.math.linear.BlockFieldMatrix<T> subtract(final org.apache.commons.math.linear.BlockFieldMatrix<T> m) {
		checkSubtractionCompatible(m);
		final org.apache.commons.math.linear.BlockFieldMatrix<T> out = new org.apache.commons.math.linear.BlockFieldMatrix<T>(getField(), rows, columns);
		for (int blockIndex = 0; blockIndex < (out.blocks.length); ++blockIndex) {
			final T[] outBlock = out.blocks[blockIndex];
	...
	public org.apache.commons.math.linear.BlockFieldMatrix<T> multiply(org.apache.commons.math.linear.BlockFieldMatrix<T> m) {
		checkMultiplicationCompatible(m);
	...
	public org.apache.commons.math.linear.FieldVector<T> getRowVector(final int row) {
		...
		return new org.apache.commons.math.linear.ArrayFieldVector<T>(getField(), outData, false);
	}
