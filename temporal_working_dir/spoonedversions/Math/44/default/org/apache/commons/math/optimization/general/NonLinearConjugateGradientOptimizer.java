...
public class NonLinearConjugateGradientOptimizer extends org.apache.commons.math.optimization.general.AbstractScalarDifferentiableOptimizer {
	...
	private final org.apache.commons.math.optimization.general.Preconditioner preconditioner;
	...
	public NonLinearConjugateGradientOptimizer(final org.apache.commons.math.optimization.general.ConjugateGradientFormula updateFormula) {
		this(updateFormula, new org.apache.commons.math.optimization.SimpleScalarValueChecker());
	}

	public NonLinearConjugateGradientOptimizer(final org.apache.commons.math.optimization.general.ConjugateGradientFormula updateFormula, org.apache.commons.math.optimization.ConvergenceChecker<org.apache.commons.math.optimization.RealPointValuePair> checker) {
		this(updateFormula, checker, new org.apache.commons.math.analysis.solvers.BrentSolver(), new org.apache.commons.math.optimization.general.NonLinearConjugateGradientOptimizer.IdentityPreconditioner());
	}

	public NonLinearConjugateGradientOptimizer(final org.apache.commons.math.optimization.general.ConjugateGradientFormula updateFormula, org.apache.commons.math.optimization.ConvergenceChecker<org.apache.commons.math.optimization.RealPointValuePair> checker, final org.apache.commons.math.analysis.solvers.UnivariateRealSolver lineSearchSolver) {
		this(updateFormula, checker, lineSearchSolver, new org.apache.commons.math.optimization.general.NonLinearConjugateGradientOptimizer.IdentityPreconditioner());
	}

	public NonLinearConjugateGradientOptimizer(final org.apache.commons.math.optimization.general.ConjugateGradientFormula updateFormula, org.apache.commons.math.optimization.ConvergenceChecker<org.apache.commons.math.optimization.RealPointValuePair> checker, final org.apache.commons.math.analysis.solvers.UnivariateRealSolver lineSearchSolver, final org.apache.commons.math.optimization.general.Preconditioner preconditioner) {
		super(checker);
	...
	private double findUpperBound(final org.apache.commons.math.analysis.UnivariateRealFunction f, final double a, final double h) {
	...
	public static class IdentityPreconditioner implements org.apache.commons.math.optimization.general.Preconditioner {
