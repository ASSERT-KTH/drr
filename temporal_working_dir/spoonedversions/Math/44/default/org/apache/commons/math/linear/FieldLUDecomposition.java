...
public class FieldLUDecomposition<T extends org.apache.commons.math.FieldElement<T>> {
	...
	public FieldLUDecomposition(org.apache.commons.math.linear.FieldMatrix<T> matrix) {
		if (!(matrix.isSquare())) {
	...
	public org.apache.commons.math.linear.FieldDecompositionSolver<T> getSolver() {
		return new org.apache.commons.math.linear.FieldLUDecomposition.Solver<T>(field, lu, pivot, singular);
	}
	...
	private static class Solver<T extends org.apache.commons.math.FieldElement<T>> implements org.apache.commons.math.linear.FieldDecompositionSolver<T> {
		...
		public org.apache.commons.math.linear.FieldVector<T> solve(org.apache.commons.math.linear.FieldVector<T> b) {
			try {
				...
				final T[] bp = ((T[]) (java.lang.reflect.Array.newInstance(field.getRuntimeClass(), m)));
				for (int row = 0; row < m; row++) {
				...
				return new org.apache.commons.math.linear.ArrayFieldVector<T>(field, bp, false);
			}
		}

		public org.apache.commons.math.linear.ArrayFieldVector<T> solve(org.apache.commons.math.linear.ArrayFieldVector<T> b) {
			final int m = pivot.length;
			if ((b.data.length) != m) {
				throw new org.apache.commons.math.exception.DimensionMismatchException(b.data.length, m);
			}
			if (singular) {
				throw new org.apache.commons.math.linear.SingularMatrixException();
			}
		...
		public org.apache.commons.math.linear.FieldMatrix<T> solve(org.apache.commons.math.linear.FieldMatrix<T> b) {
			final int m = pivot.length;
			...
			@java.lang.SuppressWarnings(value = "unchecked")
			final T[][] bp = ((T[][]) (java.lang.reflect.Array.newInstance(field.getRuntimeClass(), new int[]{ m , nColB })));
			for (int row = 0; row < m; row++) {
			...
			return new org.apache.commons.math.linear.Array2DRowFieldMatrix<T>(field, bp, false);
		}

		public org.apache.commons.math.linear.FieldMatrix<T> getInverse() {
			final int m = pivot.length;
