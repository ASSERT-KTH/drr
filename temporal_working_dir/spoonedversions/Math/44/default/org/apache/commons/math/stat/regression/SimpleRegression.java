...
public class SimpleRegression implements java.io.Serializable , org.apache.commons.math.stat.regression.UpdatingMultipleLinearRegression {
	...
	public void addData(final double[][] data) {
		for (int i = 0; i < (data.length); i++) {
			if ((data[i].length) < 2) {
				throw new org.apache.commons.math.stat.regression.ModelSpecificationException(org.apache.commons.math.exception.util.LocalizedFormats.INVALID_REGRESSION_OBSERVATION, data[i].length, 2);
			}
	...
	public void addObservation(final double[] x, final double y) throws org.apache.commons.math.stat.regression.ModelSpecificationException {
		if ((x == null) || ((x.length) == 0)) {
			throw new org.apache.commons.math.stat.regression.ModelSpecificationException(org.apache.commons.math.exception.util.LocalizedFormats.INVALID_REGRESSION_OBSERVATION, (x != null ? x.length : 0), 1);
		}
		addData(x[0], y);
		return ;
	}
	...
	public void addObservations(final double[][] x, final double[] y) {
		...
		if (!obsOk) {
			throw new org.apache.commons.math.stat.regression.ModelSpecificationException(org.apache.commons.math.exception.util.LocalizedFormats.NOT_ENOUGH_DATA_FOR_NUMBER_OF_PREDICTORS, 0, 1);
		}
		for (int i = 0; i < (x.length); i++) {
			addData(x[i][0], y[i]);
		}
	...
	public double getSlopeConfidenceInterval(final double alpha) throws org.apache.commons.math.MathException {
		if ((alpha >= 1) || (alpha <= 0)) {
	...
	public org.apache.commons.math.stat.regression.RegressionResults regress() throws org.apache.commons.math.stat.regression.ModelSpecificationException {
		if (hasIntercept) {
			if ((n) < 3) {
				throw new org.apache.commons.math.exception.NoDataException(org.apache.commons.math.exception.util.LocalizedFormats.NOT_ENOUGH_DATA_REGRESSION);
			}
			if ((org.apache.commons.math.util.FastMath.abs(sumXX)) > (org.apache.commons.math.util.MathUtils.SAFE_MIN)) {
				final double[] params = new double[]{ getIntercept() , getSlope() };
				final double mse = getMeanSquareError();
				final double _syy = (sumYY) + (((sumY) * (sumY)) / ((double) (n)));
				final double[] vcv = new double[]{ mse * ((((xbar) * (xbar)) / (sumXX)) + (1.0 / ((double) (n)))) , ((-(xbar)) * mse) / (sumXX) , mse / (sumXX) };
				return new org.apache.commons.math.stat.regression.RegressionResults(params, new double[][]{ vcv }, true, n, 2, sumY, _syy, getSumSquaredErrors(), true, false);
			}else {
				final double[] params = new double[]{ (sumY) / ((double) (n)) , java.lang.Double.NaN };
				final double[] vcv = new double[]{ (ybar) / (((double) (n)) - 1.0) , java.lang.Double.NaN , java.lang.Double.NaN };
				return new org.apache.commons.math.stat.regression.RegressionResults(params, new double[][]{ vcv }, true, n, 1, sumY, sumYY, getSumSquaredErrors(), true, false);
			}
		}else {
			if ((n) < 2) {
				throw new org.apache.commons.math.exception.NoDataException(org.apache.commons.math.exception.util.LocalizedFormats.NOT_ENOUGH_DATA_REGRESSION);
			...
			if (!(java.lang.Double.isNaN(sumXX))) {
				...
				return new org.apache.commons.math.stat.regression.RegressionResults(params, new double[][]{ vcv }, true, n, 1, sumY, sumYY, getSumSquaredErrors(), false, false);
			}else {
				final double[] vcv = new double[]{ java.lang.Double.NaN };
				final double[] params = new double[]{ java.lang.Double.NaN };
				return new org.apache.commons.math.stat.regression.RegressionResults(params, new double[][]{ vcv }, true, n, 1, java.lang.Double.NaN, java.lang.Double.NaN, java.lang.Double.NaN, false, false);
			}
		}
	}
	...
	public org.apache.commons.math.stat.regression.RegressionResults regress(int[] variablesToInclude) throws org.apache.commons.math.stat.regression.ModelSpecificationException {
		if ((variablesToInclude == null) || ((variablesToInclude.length) == 0)) {
			throw new org.apache.commons.math.exception.MathIllegalArgumentException(org.apache.commons.math.exception.util.LocalizedFormats.ARRAY_ZERO_LENGTH_OR_NULL_NOTALLOWED);
		}
		if (((variablesToInclude.length) > 2) || (((variablesToInclude.length) > 1) && (!(hasIntercept)))) {
			throw new org.apache.commons.math.stat.regression.ModelSpecificationException(org.apache.commons.math.exception.util.LocalizedFormats.ARRAY_SIZE_EXCEEDS_MAX_VARIABLES, (((variablesToInclude.length) > 1) && (!(hasIntercept)) ? 1 : 2));
		}
		if (hasIntercept) {
			if ((variablesToInclude.length) == 2) {
				if ((variablesToInclude[0]) == 1) {
					throw new org.apache.commons.math.stat.regression.ModelSpecificationException(org.apache.commons.math.exception.util.LocalizedFormats.NOT_INCREASING_SEQUENCE);
				}else
					if ((variablesToInclude[0]) != 0) {
						throw new org.apache.commons.math.exception.OutOfRangeException(variablesToInclude[0], 0, 1);
					}
				...
				if ((variablesToInclude[0]) == 0) {
					...
					return new org.apache.commons.math.stat.regression.RegressionResults(params, new double[][]{ vcv }, true, n, 1, sumY, (_syy + _mean), sumYY, true, false);
				}else
					if ((variablesToInclude[0]) == 1) {
						final double _sxx = (sumXX) + (((sumX) * (sumX)) / ((double) (n)));
						final double _sxy = (sumXY) + (((sumX) * (sumY)) / ((double) (n)));
						final double _sse = org.apache.commons.math.util.FastMath.max(0.0, (_syy - ((_sxy * _sxy) / _sxx)));
						...
						if (!(java.lang.Double.isNaN(_sxx))) {
							...
							return new org.apache.commons.math.stat.regression.RegressionResults(params, new double[][]{ vcv }, true, n, 1, sumY, _syy, _sse, false, false);
						}else {
							final double[] vcv = new double[]{ java.lang.Double.NaN };
							final double[] params = new double[]{ java.lang.Double.NaN };
							return new org.apache.commons.math.stat.regression.RegressionResults(params, new double[][]{ vcv }, true, n, 1, java.lang.Double.NaN, java.lang.Double.NaN, java.lang.Double.NaN, false, false);
			...
			if ((variablesToInclude[0]) != 0) {
				throw new org.apache.commons.math.exception.OutOfRangeException(variablesToInclude[0], 0, 0);
			}
			return regress();
		}
		return null;
