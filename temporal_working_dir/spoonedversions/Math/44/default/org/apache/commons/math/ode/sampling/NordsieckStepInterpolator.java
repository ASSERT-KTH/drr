...
public class NordsieckStepInterpolator extends org.apache.commons.math.ode.sampling.AbstractStepInterpolator {
	...
	@java.lang.Override
	public void reinitialize(final double[] y, final boolean forward, final org.apache.commons.math.ode.EquationsMapper primaryMapper, final org.apache.commons.math.ode.EquationsMapper[] secondaryMappers) {
	...
	public void reinitialize(final double time, final double stepSize, final double[] scaledDerivative, final org.apache.commons.math.linear.Array2DRowRealMatrix nordsieckVector) {
		org.apache.commons.math.ode.sampling.NordsieckStepInterpolator.this.referenceTime = time;
		org.apache.commons.math.ode.sampling.NordsieckStepInterpolator.this.scalingH = stepSize;
		org.apache.commons.math.ode.sampling.NordsieckStepInterpolator.this.scaled = scaledDerivative;
		org.apache.commons.math.ode.sampling.NordsieckStepInterpolator.this.nordsieck = nordsieckVector;
	...
	protected void computeInterpolatedStateAndDerivatives(final double theta, final double oneMinusThetaH) {
		...
		for (int i = (nData.length) - 1; i >= 0; --i) {
			final int order = i + 2;
			final double[] nDataI = nData[i];
			final double power = org.apache.commons.math.util.FastMath.pow(normalizedAbscissa, order);
			for (int j = 0; j < (nDataI.length); ++j) {
