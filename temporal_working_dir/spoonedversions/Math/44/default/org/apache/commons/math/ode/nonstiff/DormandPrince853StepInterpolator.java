...
class DormandPrince853StepInterpolator extends org.apache.commons.math.ode.nonstiff.RungeKuttaStepInterpolator {
	...
	protected void doFinalize() {
		...
		integrator.computeDerivatives((pT + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.C14) * (h))), yTmp, yDotKLast[0]);
		for (int j = 0; j < (currentState.length); ++j) {
		...
		integrator.computeDerivatives((pT + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.C15) * (h))), yTmp, yDotKLast[1]);
		for (int j = 0; j < (currentState.length); ++j) {
		...
		integrator.computeDerivatives((pT + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.C16) * (h))), yTmp, yDotKLast[2]);
	}
