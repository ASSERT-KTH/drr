...
public class CurveFitter {
	...
	public double[] fit(final org.apache.commons.math.analysis.ParametricUnivariateRealFunction f, final double[] initialGuess) {
		return fit(java.lang.Integer.MAX_VALUE, f, initialGuess);
	}

	public double[] fit(int maxEval, final org.apache.commons.math.analysis.ParametricUnivariateRealFunction f, final double[] initialGuess) {
	...
	private class TheoreticalValuesFunction implements org.apache.commons.math.analysis.DifferentiableMultivariateVectorialFunction {
		private final org.apache.commons.math.analysis.ParametricUnivariateRealFunction f;

		public TheoreticalValuesFunction(final org.apache.commons.math.analysis.ParametricUnivariateRealFunction f) {
			this.f = f;
		}
