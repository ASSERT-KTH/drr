...
public class StatisticalSummaryValues implements java.io.Serializable , org.apache.commons.math.stat.descriptive.StatisticalSummary {
	...
	public double getStandardDeviation() {
		return org.apache.commons.math.util.FastMath.sqrt(variance);
	}
	...
	public boolean equals(java.lang.Object object) {
		...
		return (((((org.apache.commons.math.util.Precision.equalsIncludingNaN(stat.getMax(), getMax())) && (org.apache.commons.math.util.Precision.equalsIncludingNaN(stat.getMean(), getMean()))) && (org.apache.commons.math.util.Precision.equalsIncludingNaN(stat.getMin(), getMin()))) && (org.apache.commons.math.util.Precision.equalsIncludingNaN(stat.getN(), getN()))) && (org.apache.commons.math.util.Precision.equalsIncludingNaN(stat.getSum(), getSum()))) && (org.apache.commons.math.util.Precision.equalsIncludingNaN(stat.getVariance(), getVariance()));
	}
