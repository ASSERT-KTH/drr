...
public class PolynomialFunction implements java.io.Serializable , org.apache.commons.math.analysis.DifferentiableUnivariateRealFunction {
	...
	public PolynomialFunction(double[] c) throws org.apache.commons.math.exception.NoDataException, org.apache.commons.math.exception.NullArgumentException {
		super();
		org.apache.commons.math.util.MathUtils.checkNotNull(c);
		int n = c.length;
		if (n == 0) {
		...
		java.lang.System.arraycopy(c, 0, org.apache.commons.math.analysis.polynomials.PolynomialFunction.this.coefficients, 0, n);
	}
	...
	protected static double evaluate(double[] coefficients, double argument) throws org.apache.commons.math.exception.NoDataException, org.apache.commons.math.exception.NullArgumentException {
		org.apache.commons.math.util.MathUtils.checkNotNull(coefficients);
	...
	public org.apache.commons.math.analysis.polynomials.PolynomialFunction add(final org.apache.commons.math.analysis.polynomials.PolynomialFunction p) {
		final int lowLength = org.apache.commons.math.util.FastMath.min(coefficients.length, p.coefficients.length);
		final int highLength = org.apache.commons.math.util.FastMath.max(coefficients.length, p.coefficients.length);
	...
	public org.apache.commons.math.analysis.polynomials.PolynomialFunction subtract(final org.apache.commons.math.analysis.polynomials.PolynomialFunction p) {
		int lowLength = org.apache.commons.math.util.FastMath.min(coefficients.length, p.coefficients.length);
		int highLength = org.apache.commons.math.util.FastMath.max(coefficients.length, p.coefficients.length);
		double[] newCoefficients = new double[highLength];
		for (int i = 0; i < lowLength; ++i) {
			newCoefficients[i] = (coefficients[i]) - (p.coefficients[i]);
		}
	...
	public org.apache.commons.math.analysis.polynomials.PolynomialFunction multiply(final org.apache.commons.math.analysis.polynomials.PolynomialFunction p) {
		...
		for (int i = 0; i < (newCoefficients.length); ++i) {
			...
			for (int j = org.apache.commons.math.util.FastMath.max(0, ((i + 1) - (p.coefficients.length))); j < (org.apache.commons.math.util.FastMath.min(coefficients.length, (i + 1))); ++j) {
	...
	protected static double[] differentiate(double[] coefficients) throws org.apache.commons.math.exception.NoDataException, org.apache.commons.math.exception.NullArgumentException {
		org.apache.commons.math.util.MathUtils.checkNotNull(coefficients);
		int n = coefficients.length;
		if (n == 0) {
			throw new org.apache.commons.math.exception.NoDataException(org.apache.commons.math.exception.util.LocalizedFormats.EMPTY_POLYNOMIALS_COEFFICIENTS_ARRAY);
	...
	public java.lang.String toString() {
		...
		if ((coefficients[0]) == 0.0) {
			...
			s.append(org.apache.commons.math.analysis.polynomials.PolynomialFunction.toString(coefficients[0]));
		}
		for (int i = 1; i < (coefficients.length); ++i) {
			if ((coefficients[i]) != 0) {
				...
				double absAi = org.apache.commons.math.util.FastMath.abs(coefficients[i]);
				if ((absAi - 1) != 0) {
					s.append(org.apache.commons.math.analysis.polynomials.PolynomialFunction.toString(absAi));
					s.append(' ');
				}
				s.append("x");
				if (i > 1) {
	...
	public boolean equals(java.lang.Object obj) {
		if ((org.apache.commons.math.analysis.polynomials.PolynomialFunction.this) == obj) {
			return true;
		}
	...
	public static class Parametric implements org.apache.commons.math.analysis.ParametricUnivariateRealFunction {
		...
		public double value(final double x, final double... parameters) {
			return org.apache.commons.math.analysis.polynomials.PolynomialFunction.evaluate(parameters, x);
		}
	}
}
