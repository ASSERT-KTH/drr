...
public abstract class AbstractParameterizable implements org.apache.commons.math.ode.Parameterizable {
	...
	public void complainIfNotSupported(final java.lang.String name) throws org.apache.commons.math.exception.MathIllegalArgumentException {
		if (!(isSupported(name))) {
