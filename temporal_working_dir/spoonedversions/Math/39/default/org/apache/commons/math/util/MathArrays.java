...
INCREASING, DECREASING;	}
	...
	public static boolean isMonotonic(java.lang.Comparable[] val, org.apache.commons.math.util.MathArrays.OrderDirection dir, boolean strict) {
		java.lang.Comparable previous = val[0];
	...
	public static boolean isMonotonic(double[] val, org.apache.commons.math.util.MathArrays.OrderDirection dir, boolean strict) {
		return org.apache.commons.math.util.MathArrays.checkOrder(val, dir, strict, false);
	}

	public static boolean checkOrder(double[] val, org.apache.commons.math.util.MathArrays.OrderDirection dir, boolean strict, boolean abort) {
	...
	public static void checkOrder(double[] val, org.apache.commons.math.util.MathArrays.OrderDirection dir, boolean strict) {
		org.apache.commons.math.util.MathArrays.checkOrder(val, dir, strict, true);
	}

	public static void checkOrder(double[] val) {
		org.apache.commons.math.util.MathArrays.checkOrder(val, org.apache.commons.math.util.MathArrays.OrderDirection.INCREASING, true);
	}
	...
	public static void sortInPlace(double[] x, double[]... yList) {
		org.apache.commons.math.util.MathArrays.sortInPlace(x, org.apache.commons.math.util.MathArrays.OrderDirection.INCREASING, yList);
	}

	public static void sortInPlace(double[] x, final org.apache.commons.math.util.MathArrays.OrderDirection dir, double[]... yList) {
		if (x == null) {
	...
	public static int[] copyOf(int[] source) {
		return org.apache.commons.math.util.MathArrays.copyOf(source, source.length);
	}
	...
	public static double linearCombination(final double[] a, final double[] b) {
		...
		for (int i = 0; i < len; i++) {
			final double ai = a[i];
			final double ca = (org.apache.commons.math.util.MathArrays.SPLIT_FACTOR) * ai;
			final double aHigh = ca - (ca - ai);
			final double aLow = ai - aHigh;
			final double bi = b[i];
			final double cb = (org.apache.commons.math.util.MathArrays.SPLIT_FACTOR) * bi;
	...
	public static double linearCombination(final double a1, final double b1, final double a2, final double b2) {
		final double ca1 = (org.apache.commons.math.util.MathArrays.SPLIT_FACTOR) * a1;
		final double a1High = ca1 - (ca1 - a1);
		final double a1Low = a1 - a1High;
		final double cb1 = (org.apache.commons.math.util.MathArrays.SPLIT_FACTOR) * b1;
		final double b1High = cb1 - (cb1 - b1);
		final double b1Low = b1 - b1High;
		final double prod1High = a1 * b1;
		final double prod1Low = (a1Low * b1Low) - (((prod1High - (a1High * b1High)) - (a1Low * b1High)) - (a1High * b1Low));
		final double ca2 = (org.apache.commons.math.util.MathArrays.SPLIT_FACTOR) * a2;
		final double a2High = ca2 - (ca2 - a2);
		final double a2Low = a2 - a2High;
		final double cb2 = (org.apache.commons.math.util.MathArrays.SPLIT_FACTOR) * b2;
	...
	public static double linearCombination(final double a1, final double b1, final double a2, final double b2, final double a3, final double b3) {
		...
		final double prod2High = a2 * b2;
		final double prod2Low = (a2Low * b2Low) - (((prod2High - (a2High * b2High)) - (a2Low * b2High)) - (a2High * b2Low));
		final double ca3 = (org.apache.commons.math.util.MathArrays.SPLIT_FACTOR) * a3;
		final double a3High = ca3 - (ca3 - a3);
		final double a3Low = a3 - a3High;
		final double cb3 = (org.apache.commons.math.util.MathArrays.SPLIT_FACTOR) * b3;
	...
	public static double linearCombination(final double a1, final double b1, final double a2, final double b2, final double a3, final double b3, final double a4, final double b4) {
		...
		final double prod3High = a3 * b3;
		final double prod3Low = (a3Low * b3Low) - (((prod3High - (a3High * b3High)) - (a3Low * b3High)) - (a3High * b3Low));
		final double ca4 = (org.apache.commons.math.util.MathArrays.SPLIT_FACTOR) * a4;
		final double a4High = ca4 - (ca4 - a4);
		final double a4Low = a4 - a4High;
		final double cb4 = (org.apache.commons.math.util.MathArrays.SPLIT_FACTOR) * b4;
