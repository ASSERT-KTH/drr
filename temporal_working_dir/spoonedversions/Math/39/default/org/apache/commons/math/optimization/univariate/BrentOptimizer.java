...
public class BrentOptimizer extends org.apache.commons.math.optimization.univariate.BaseAbstractUnivariateOptimizer {
	...
	public BrentOptimizer(double rel, double abs, org.apache.commons.math.optimization.ConvergenceChecker<org.apache.commons.math.optimization.univariate.UnivariateRealPointValuePair> checker) {
		super(checker);
	...
	@java.lang.Override
	protected org.apache.commons.math.optimization.univariate.UnivariateRealPointValuePair doOptimize() {
		...
		double fv = fx;
		double fw = fx;
		org.apache.commons.math.optimization.univariate.UnivariateRealPointValuePair previous = null;
		org.apache.commons.math.optimization.univariate.UnivariateRealPointValuePair current = new org.apache.commons.math.optimization.univariate.UnivariateRealPointValuePair(x, (isMinim ? fx : -fx));
		int iter = 0;
		while (true) {
			...
			if (!stop) {
				...
				previous = current;
				current = new org.apache.commons.math.optimization.univariate.UnivariateRealPointValuePair(x, (isMinim ? fx : -fx));
				if (checker != null) {
