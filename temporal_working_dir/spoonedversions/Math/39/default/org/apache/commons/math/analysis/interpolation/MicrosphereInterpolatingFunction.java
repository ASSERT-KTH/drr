...
public class MicrosphereInterpolatingFunction implements org.apache.commons.math.analysis.MultivariateFunction {
	...
	private static class MicrosphereSurfaceElement {
		...
		void store(final double illuminationFromSample, final java.util.Map.Entry<org.apache.commons.math.linear.RealVector, java.lang.Double> sample) {
			if (illuminationFromSample > (org.apache.commons.math.analysis.interpolation.MicrosphereInterpolatingFunction.MicrosphereSurfaceElement.this.brightestIllumination)) {
				org.apache.commons.math.analysis.interpolation.MicrosphereInterpolatingFunction.MicrosphereSurfaceElement.this.brightestIllumination = illuminationFromSample;
				org.apache.commons.math.analysis.interpolation.MicrosphereInterpolatingFunction.MicrosphereSurfaceElement.this.brightestSample = sample;
			}
		}
	...
	public MicrosphereInterpolatingFunction(double[][] xval, double[] yval, int brightnessExponent, int microsphereElements, org.apache.commons.math.random.UnitSphereRandomVectorGenerator rand) {
		...
		for (int i = 0; i < (xval.length); ++i) {
			...
			if ((xvalI.length) != (dimension)) {
				throw new org.apache.commons.math.exception.DimensionMismatchException(xvalI.length, dimension);
			}
	...
	public double value(double[] point) {
		...
		for (java.util.Map.Entry<org.apache.commons.math.linear.RealVector, java.lang.Double> sd : samples.entrySet()) {
			...
			if ((org.apache.commons.math.util.FastMath.abs(diffNorm)) < (org.apache.commons.math.util.FastMath.ulp(1.0))) {
				return sd.getValue();
			}
			for (org.apache.commons.math.analysis.interpolation.MicrosphereInterpolatingFunction.MicrosphereSurfaceElement md : microsphere) {
				final double w = org.apache.commons.math.util.FastMath.pow(diffNorm, (-(brightnessExponent)));
