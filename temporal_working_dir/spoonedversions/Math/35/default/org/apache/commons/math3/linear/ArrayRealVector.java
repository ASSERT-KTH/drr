...
public class ArrayRealVector extends org.apache.commons.math3.linear.RealVector implements java.io.Serializable {
	...
	public ArrayRealVector(org.apache.commons.math3.linear.RealVector v) {
		if (v == null) {
			throw new org.apache.commons.math3.exception.NullArgumentException();
		}
	...
	public ArrayRealVector(org.apache.commons.math3.linear.ArrayRealVector v) {
		this(v, true);
	}
	...
	@java.lang.Override
	public org.apache.commons.math3.linear.ArrayRealVector add(org.apache.commons.math3.linear.RealVector v) {
		if (v instanceof org.apache.commons.math3.linear.ArrayRealVector) {
			...
			java.util.Iterator<org.apache.commons.math3.linear.RealVector.Entry> it = v.sparseIterator();
	...
	@java.lang.Override
	public org.apache.commons.math3.linear.ArrayRealVector subtract(org.apache.commons.math3.linear.RealVector v) {
		if (v instanceof org.apache.commons.math3.linear.ArrayRealVector) {
			final double[] vData = ((org.apache.commons.math3.linear.ArrayRealVector) (v)).data;
			final int dim = vData.length;
			checkVectorDimensions(dim);
	...
	@java.lang.Override
	public org.apache.commons.math3.linear.ArrayRealVector ebeMultiply(org.apache.commons.math3.linear.RealVector v) {
		if (v instanceof org.apache.commons.math3.linear.ArrayRealVector) {
			final double[] vData = ((org.apache.commons.math3.linear.ArrayRealVector) (v)).data;
			final int dim = vData.length;
			checkVectorDimensions(dim);
	...
	@java.lang.Override
	public org.apache.commons.math3.linear.ArrayRealVector ebeDivide(org.apache.commons.math3.linear.RealVector v) {
		if (v instanceof org.apache.commons.math3.linear.ArrayRealVector) {
			final double[] vData = ((org.apache.commons.math3.linear.ArrayRealVector) (v)).data;
			final int dim = vData.length;
			checkVectorDimensions(dim);
	...
	@java.lang.Override
	public org.apache.commons.math3.linear.RealVector projection(org.apache.commons.math3.linear.RealVector v) {
	...
	public boolean equals(java.lang.Object other) {
		...
		if ((other == null) || (!(other instanceof org.apache.commons.math3.linear.RealVector))) {
			return false;
		}
	...
	@java.lang.Override
	public org.apache.commons.math3.linear.ArrayRealVector combine(double a, double b, org.apache.commons.math3.linear.RealVector y) {
		return copy().combineToSelf(a, b, y);
	}

	@java.lang.Override
	public org.apache.commons.math3.linear.ArrayRealVector combineToSelf(double a, double b, org.apache.commons.math3.linear.RealVector y) {
