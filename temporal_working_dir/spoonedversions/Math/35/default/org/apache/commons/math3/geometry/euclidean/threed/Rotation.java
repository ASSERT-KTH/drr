...
public class Rotation implements java.io.Serializable {
	...
	public Rotation(double[][] m, double threshold) throws org.apache.commons.math3.geometry.euclidean.threed.NotARotationMatrixException {
		...
		if (s > (-0.19)) {
			q0 = 0.5 * (org.apache.commons.math3.util.FastMath.sqrt((s + 1.0)));
			double inv = 0.25 / (q0);
			...
			if (s > (-0.19)) {
				q1 = 0.5 * (org.apache.commons.math3.util.FastMath.sqrt((s + 1.0)));
				double inv = 0.25 / (q1);
				...
				if (s > (-0.19)) {
					q2 = 0.5 * (org.apache.commons.math3.util.FastMath.sqrt((s + 1.0)));
					double inv = 0.25 / (q2);
					...
					q3 = 0.5 * (org.apache.commons.math3.util.FastMath.sqrt((s + 1.0)));
					double inv = 0.25 / (q3);
	...
	public Rotation(org.apache.commons.math3.geometry.euclidean.threed.Vector3D u1, org.apache.commons.math3.geometry.euclidean.threed.Vector3D u2, org.apache.commons.math3.geometry.euclidean.threed.Vector3D v1, org.apache.commons.math3.geometry.euclidean.threed.Vector3D v2) {
		...
		v1 = new org.apache.commons.math3.geometry.euclidean.threed.Vector3D(org.apache.commons.math3.util.FastMath.sqrt((u1u1 / v1v1)), v1);
		double u1u2 = u1.dotProduct(u2);
		double v1v2 = v1.dotProduct(v2);
		double coeffU = u1u2 / u1u1;
		double coeffV = v1v2 / u1u1;
		double beta = org.apache.commons.math3.util.FastMath.sqrt(((u2u2 - (u1u2 * coeffU)) / (v2v2 - (v1v2 * coeffV))));
		double alpha = coeffU - (beta * coeffV);
		v2 = new org.apache.commons.math3.geometry.euclidean.threed.Vector3D(alpha, v1, beta, v2);
		org.apache.commons.math3.geometry.euclidean.threed.Vector3D uRef = u1;
		org.apache.commons.math3.geometry.euclidean.threed.Vector3D vRef = v1;
		org.apache.commons.math3.geometry.euclidean.threed.Vector3D v1Su1 = v1.subtract(u1);
		org.apache.commons.math3.geometry.euclidean.threed.Vector3D v2Su2 = v2.subtract(u2);
		org.apache.commons.math3.geometry.euclidean.threed.Vector3D k = v1Su1.crossProduct(v2Su2);
		org.apache.commons.math3.geometry.euclidean.threed.Vector3D u3 = u1.crossProduct(u2);
		...
		if (c <= ((inPlaneThreshold * (k.getNorm())) * (u3.getNorm()))) {
			...
			org.apache.commons.math3.geometry.euclidean.threed.Vector3D v3Su3 = v3.subtract(u3);
			k = v1Su1.crossProduct(v3Su3);
			org.apache.commons.math3.geometry.euclidean.threed.Vector3D u2Prime = u1.crossProduct(u3);
		...
		c = org.apache.commons.math3.util.FastMath.sqrt(c);
		double inv = 1.0 / (c + c);
		q1 = inv * (k.getX());
		q2 = inv * (k.getY());
		q3 = inv * (k.getZ());
		k = new org.apache.commons.math3.geometry.euclidean.threed.Vector3D((((uRef.getY()) * (q3)) - ((uRef.getZ()) * (q2))), (((uRef.getZ()) * (q1)) - ((uRef.getX()) * (q3))), (((uRef.getX()) * (q2)) - ((uRef.getY()) * (q1))));
