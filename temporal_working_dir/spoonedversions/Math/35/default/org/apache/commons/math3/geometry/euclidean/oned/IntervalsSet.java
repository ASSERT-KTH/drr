...
public class IntervalsSet extends org.apache.commons.math3.geometry.partitioning.AbstractRegion<org.apache.commons.math3.geometry.euclidean.oned.Euclidean1D, org.apache.commons.math3.geometry.euclidean.oned.Euclidean1D> {
	public IntervalsSet() {
		super();
	}

	public IntervalsSet(final double lower, final double upper) {
		super(org.apache.commons.math3.geometry.euclidean.oned.IntervalsSet.buildTree(lower, upper));
	}
	...
	private static org.apache.commons.math3.geometry.partitioning.BSPTree<org.apache.commons.math3.geometry.euclidean.oned.Euclidean1D> buildTree(final double lower, final double upper) {
		if ((java.lang.Double.isInfinite(lower)) && (lower < 0)) {
			...
			final org.apache.commons.math3.geometry.partitioning.SubHyperplane<org.apache.commons.math3.geometry.euclidean.oned.Euclidean1D> upperCut = new org.apache.commons.math3.geometry.euclidean.oned.OrientedPoint(new org.apache.commons.math3.geometry.euclidean.oned.Vector1D(upper), true).wholeHyperplane();
		...
		final org.apache.commons.math3.geometry.partitioning.SubHyperplane<org.apache.commons.math3.geometry.euclidean.oned.Euclidean1D> lowerCut = new org.apache.commons.math3.geometry.euclidean.oned.OrientedPoint(new org.apache.commons.math3.geometry.euclidean.oned.Vector1D(lower), false).wholeHyperplane();
		if ((java.lang.Double.isInfinite(upper)) && (upper > 0)) {
	...
	public org.apache.commons.math3.geometry.euclidean.oned.IntervalsSet buildNew(final org.apache.commons.math3.geometry.partitioning.BSPTree<org.apache.commons.math3.geometry.euclidean.oned.Euclidean1D> tree) {
		return new org.apache.commons.math3.geometry.euclidean.oned.IntervalsSet(tree);
	}
	...
	protected void computeGeometricalProperties() {
		if ((getTree(false).getCut()) == null) {
			...
			setSize(size);
			setBarycenter((java.lang.Double.isInfinite(size) ? org.apache.commons.math3.geometry.euclidean.oned.Vector1D.NaN : new org.apache.commons.math3.geometry.euclidean.oned.Vector1D((sum / size))));
		}
	}
	...
	private void recurseList(final org.apache.commons.math3.geometry.partitioning.BSPTree<org.apache.commons.math3.geometry.euclidean.oned.Euclidean1D> node, final java.util.List<org.apache.commons.math3.geometry.euclidean.oned.Interval> list, final double lower, final double upper) {
		if ((node.getCut()) == null) {
			if (((java.lang.Boolean) (node.getAttribute()))) {
				list.add(new org.apache.commons.math3.geometry.euclidean.oned.Interval(lower, upper));
			}
		}else {
			final org.apache.commons.math3.geometry.euclidean.oned.OrientedPoint op = ((org.apache.commons.math3.geometry.euclidean.oned.OrientedPoint) (node.getCut().getHyperplane()));
			final org.apache.commons.math3.geometry.euclidean.oned.Vector1D loc = op.getLocation();
			double x = loc.getX();
			final org.apache.commons.math3.geometry.partitioning.BSPTree<org.apache.commons.math3.geometry.euclidean.oned.Euclidean1D> low = op.isDirect() ? node.getMinus() : node.getPlus();
			final org.apache.commons.math3.geometry.partitioning.BSPTree<org.apache.commons.math3.geometry.euclidean.oned.Euclidean1D> high = op.isDirect() ? node.getPlus() : node.getMinus();
			recurseList(low, list, lower, x);
			if (((checkPoint(low, loc)) == (org.apache.commons.math3.geometry.partitioning.Region.Location.INSIDE)) && ((checkPoint(high, loc)) == (org.apache.commons.math3.geometry.partitioning.Region.Location.INSIDE))) {
