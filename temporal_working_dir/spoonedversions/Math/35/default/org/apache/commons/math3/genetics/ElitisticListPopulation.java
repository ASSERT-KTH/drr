...
public class ElitisticListPopulation extends org.apache.commons.math3.genetics.ListPopulation {
	...
	public org.apache.commons.math3.genetics.Population nextGeneration() {
		org.apache.commons.math3.genetics.ElitisticListPopulation nextGeneration = new org.apache.commons.math3.genetics.ElitisticListPopulation(org.apache.commons.math3.genetics.ElitisticListPopulation.this.getPopulationLimit(), org.apache.commons.math3.genetics.ElitisticListPopulation.this.getElitismRate());
		java.util.List<org.apache.commons.math3.genetics.Chromosome> oldChromosomes = org.apache.commons.math3.genetics.ElitisticListPopulation.this.getChromosomes();
		java.util.Collections.sort(oldChromosomes);
		int boundIndex = ((int) (org.apache.commons.math3.util.FastMath.ceil(((1.0 - (org.apache.commons.math3.genetics.ElitisticListPopulation.this.getElitismRate())) * (oldChromosomes.size())))));
