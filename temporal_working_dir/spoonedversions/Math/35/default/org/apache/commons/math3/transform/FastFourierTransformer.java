...
public class FastFourierTransformer implements java.io.Serializable {
	...
	public FastFourierTransformer(final org.apache.commons.math3.transform.DftNormalization normalization) {
	...
	private static void normalizeTransformedData(final double[][] dataRI, final org.apache.commons.math3.transform.DftNormalization normalization, final org.apache.commons.math3.transform.TransformType type) {
		...
		switch (normalization) {
			case STANDARD :
				if (type == (org.apache.commons.math3.transform.TransformType.INVERSE)) {
				...
				break;
			case UNITARY :
				final double scaleFactor = 1.0 / (org.apache.commons.math3.util.FastMath.sqrt(n));
				for (int i = 0; i < n; i++) {
					dataR[i] *= scaleFactor;
					dataI[i] *= scaleFactor;
				}
	...
	public static void transformInPlace(final double[][] dataRI, final org.apache.commons.math3.transform.DftNormalization normalization, final org.apache.commons.math3.transform.TransformType type) {
		if ((dataRI.length) != 2) {
		...
		if (n == 1) {
			...
			if (n == 2) {
				...
				dataR[1] = srcR0 - srcR1;
				dataI[1] = srcI0 - srcI1;
				org.apache.commons.math3.transform.FastFourierTransformer.normalizeTransformedData(dataRI, normalization, type);
				return ;
			}
		
		org.apache.commons.math3.transform.FastFourierTransformer.bitReversalShuffle2(dataR, dataI);
		if (type == (org.apache.commons.math3.transform.TransformType.INVERSE)) {
		...
		while (lastN0 < n) {
			...
			double wSubN0R = org.apache.commons.math3.transform.FastFourierTransformer.W_SUB_N_R[logN0];
			double wSubN0I = org.apache.commons.math3.transform.FastFourierTransformer.W_SUB_N_I[logN0];
			if (type == (org.apache.commons.math3.transform.TransformType.INVERSE)) {
				wSubN0I = -wSubN0I;
			}
	...
	public org.apache.commons.math3.complex.Complex[] transform(final double[] f, final org.apache.commons.math3.transform.TransformType type) {
		final double[][] dataRI = new double[][]{ org.apache.commons.math3.util.MathArrays.copyOf(f, f.length) , new double[f.length] };
		org.apache.commons.math3.transform.FastFourierTransformer.transformInPlace(dataRI, normalization, type);
		return org.apache.commons.math3.transform.TransformUtils.createComplexArray(dataRI);
	}

	public org.apache.commons.math3.complex.Complex[] transform(final org.apache.commons.math3.analysis.UnivariateFunction f, final double min, final double max, final int n, final org.apache.commons.math3.transform.TransformType type) {
		final double[] data = org.apache.commons.math3.analysis.FunctionUtils.sample(f, min, max, n);
		return transform(data, type);
	}

	public org.apache.commons.math3.complex.Complex[] transform(final org.apache.commons.math3.complex.Complex[] f, final org.apache.commons.math3.transform.TransformType type) {
		final double[][] dataRI = org.apache.commons.math3.transform.TransformUtils.createRealImaginaryArray(f);
		org.apache.commons.math3.transform.FastFourierTransformer.transformInPlace(dataRI, normalization, type);
		return org.apache.commons.math3.transform.TransformUtils.createComplexArray(dataRI);
	}

	@java.lang.Deprecated
	public java.lang.Object mdfft(java.lang.Object mdca, org.apache.commons.math3.transform.TransformType type) {
		org.apache.commons.math3.transform.FastFourierTransformer.MultiDimensionalComplexMatrix mdcm = ((org.apache.commons.math3.transform.FastFourierTransformer.MultiDimensionalComplexMatrix) (new org.apache.commons.math3.transform.FastFourierTransformer.MultiDimensionalComplexMatrix(mdca).clone()));
	...
	@java.lang.Deprecated
	private void mdfft(org.apache.commons.math3.transform.FastFourierTransformer.MultiDimensionalComplexMatrix mdcm, org.apache.commons.math3.transform.TransformType type, int d, int[] subVector) {
		int[] dimensionSize = mdcm.getDimensionSizes();
		if ((subVector.length) == (dimensionSize.length)) {
			org.apache.commons.math3.complex.Complex[] temp = new org.apache.commons.math3.complex.Complex[dimensionSize[d]];
	...
	private static class MultiDimensionalComplexMatrix implements java.lang.Cloneable {
		...
		public MultiDimensionalComplexMatrix(java.lang.Object multiDimensionalComplexArray) {
			org.apache.commons.math3.transform.FastFourierTransformer.MultiDimensionalComplexMatrix.this.multiDimensionalComplexArray = multiDimensionalComplexArray;
		...
		public org.apache.commons.math3.complex.Complex get(int... vector) throws org.apache.commons.math3.exception.DimensionMismatchException {
			if (vector == null) {
				if ((dimensionSize.length) > 0) {
					throw new org.apache.commons.math3.exception.DimensionMismatchException(0, dimensionSize.length);
				}
				return null;
			}
			if ((vector.length) != (dimensionSize.length)) {
				throw new org.apache.commons.math3.exception.DimensionMismatchException(vector.length, dimensionSize.length);
			}
			java.lang.Object lastDimension = multiDimensionalComplexArray;
			for (int i = 0; i < (dimensionSize.length); i++) {
				lastDimension = ((java.lang.Object[]) (lastDimension))[vector[i]];
			}
			return ((org.apache.commons.math3.complex.Complex) (lastDimension));
		}

		public org.apache.commons.math3.complex.Complex set(org.apache.commons.math3.complex.Complex magnitude, int... vector) throws org.apache.commons.math3.exception.DimensionMismatchException {
			if (vector == null) {
				if ((dimensionSize.length) > 0) {
					throw new org.apache.commons.math3.exception.DimensionMismatchException(0, dimensionSize.length);
				}
			...
			org.apache.commons.math3.complex.Complex lastValue = ((org.apache.commons.math3.complex.Complex) (lastDimension[vector[((dimensionSize.length) - 1)]]));
		...
		public java.lang.Object clone() {
			org.apache.commons.math3.transform.FastFourierTransformer.MultiDimensionalComplexMatrix mdcm = new org.apache.commons.math3.transform.FastFourierTransformer.MultiDimensionalComplexMatrix(java.lang.reflect.Array.newInstance(org.apache.commons.math3.complex.Complex.class, dimensionSize));
			clone(mdcm);
			return mdcm;
		}

		private void clone(org.apache.commons.math3.transform.FastFourierTransformer.MultiDimensionalComplexMatrix mdcm) {
