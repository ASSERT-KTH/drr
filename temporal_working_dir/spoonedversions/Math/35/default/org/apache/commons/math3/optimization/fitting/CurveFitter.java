...
public class CurveFitter {
	...
	public double[] fit(final org.apache.commons.math3.analysis.ParametricUnivariateFunction f, final double[] initialGuess) {
		return fit(java.lang.Integer.MAX_VALUE, f, initialGuess);
	}

	public double[] fit(int maxEval, final org.apache.commons.math3.analysis.ParametricUnivariateFunction f, final double[] initialGuess) {
		...
		org.apache.commons.math3.optimization.PointVectorValuePair optimum = optimizer.optimize(maxEval, new org.apache.commons.math3.optimization.fitting.CurveFitter.TheoreticalValuesFunction(f), target, weights, initialGuess);
