...
public class EventState implements java.io.Serializable {
	...
	public void reinitializeBegin(final double t0, final double[] y0) throws org.apache.commons.math.ode.events.EventException {
		org.apache.commons.math.ode.events.EventState.this.t0 = t0;
		g0 = handler.g(t0, y0);
		g0Positive = (g0) >= 0;
	}
	...
	public boolean evaluateStep(final org.apache.commons.math.ode.sampling.StepInterpolator interpolator) throws org.apache.commons.math.ConvergenceException, org.apache.commons.math.ode.DerivativeException, org.apache.commons.math.ode.events.EventException {
		try {
			...
			for (int i = 0; i < n; ++i) {
				...
				if ((g0Positive) ^ (gb >= 0)) {
					increasing = gb >= ga;
					final org.apache.commons.math.analysis.UnivariateRealSolver solver = new org.apache.commons.math.analysis.BrentSolver(new org.apache.commons.math.analysis.UnivariateRealFunction() {
