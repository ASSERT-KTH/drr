...
public abstract class AbstractEstimator implements org.apache.commons.math.estimation.Estimator {
	...
	protected void updateResidualsAndCost() throws org.apache.commons.math.estimation.EstimationException {
		if ((++(costEvaluations)) > (maxCostEval)) {
			throw new org.apache.commons.math.estimation.EstimationException("maximal number of evaluations exceeded ({0})", new java.lang.Object[]{ java.lang.Integer.valueOf(maxCostEval) });
		}
		cost = 0;
	...
	public double[] guessParametersErrors(org.apache.commons.math.estimation.EstimationProblem problem) throws org.apache.commons.math.estimation.EstimationException {
		...
		if (m <= p) {
			throw new org.apache.commons.math.estimation.EstimationException("no degrees of freedom ({0} measurements, {1} parameters)", new java.lang.Object[]{ java.lang.Integer.valueOf(m) , java.lang.Integer.valueOf(p) });
		}
