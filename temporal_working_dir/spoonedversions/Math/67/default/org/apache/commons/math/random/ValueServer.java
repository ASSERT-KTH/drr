...
public class ValueServer {
	...
	public double getNext() throws java.io.IOException {
		switch (mode) {
			...
			case org.apache.commons.math.random.ValueServer.CONSTANT_MODE :
				return mu;
			default :
				throw org.apache.commons.math.MathRuntimeException.createIllegalStateException(org.apache.commons.math.util.LocalizedFormats.UNKNOWN_MODE, mode, "DIGEST_MODE", org.apache.commons.math.random.ValueServer.DIGEST_MODE, "REPLAY_MODE", org.apache.commons.math.random.ValueServer.REPLAY_MODE, "UNIFORM_MODE", org.apache.commons.math.random.ValueServer.UNIFORM_MODE, "EXPONENTIAL_MODE", org.apache.commons.math.random.ValueServer.EXPONENTIAL_MODE, "GAUSSIAN_MODE", org.apache.commons.math.random.ValueServer.GAUSSIAN_MODE, "CONSTANT_MODE", org.apache.commons.math.random.ValueServer.CONSTANT_MODE);
		}
	}
	...
	private double getNextReplay() throws java.io.IOException {
		...
		if ((str = filePointer.readLine()) == null) {
			...
			resetReplayFile();
			if ((str = filePointer.readLine()) == null) {
				throw org.apache.commons.math.MathRuntimeException.createEOFException(org.apache.commons.math.util.LocalizedFormats.URL_CONTAINS_NO_DATA, valuesFileURL);
			}
		}
