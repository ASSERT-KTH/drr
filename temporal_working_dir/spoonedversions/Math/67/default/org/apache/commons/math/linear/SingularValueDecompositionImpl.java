...
public class SingularValueDecompositionImpl implements org.apache.commons.math.linear.SingularValueDecomposition {
	...
	public org.apache.commons.math.linear.RealMatrix getCovariance(final double minSingularValue) {
		...
		if (dimension == 0) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.util.LocalizedFormats.TOO_LARGE_CUTOFF_SINGULAR_VALUE, minSingularValue, singularValues[0]);
		}
