...
public class RealVectorFormat extends org.apache.commons.math.util.CompositeFormat {
	...
	public java.lang.StringBuffer format(java.lang.Object obj, java.lang.StringBuffer toAppendTo, java.text.FieldPosition pos) {
		...
		throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.util.LocalizedFormats.CANNOT_FORMAT_INSTANCE_AS_REAL_VECTOR, obj.getClass().getName());
	}
	...
	public org.apache.commons.math.linear.ArrayRealVector parse(java.lang.String source) throws java.text.ParseException {
		...
		if ((parsePosition.getIndex()) == 0) {
			throw org.apache.commons.math.MathRuntimeException.createParseException(parsePosition.getErrorIndex(), org.apache.commons.math.util.LocalizedFormats.UNPARSEABLE_REAL_VECTOR, source);
		}
		return result;
	}
