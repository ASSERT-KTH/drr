...
public class Frequency implements java.io.Serializable {
	...
	public void addValue(java.lang.Object v) {
		if (v instanceof java.lang.Comparable<?>) {
			...
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.util.LocalizedFormats.CLASS_DOESNT_IMPLEMENT_COMPARABLE, v.getClass().getName());
		}
	}
	...
	public void addValue(java.lang.Comparable<?> v) {
		...
		try {
			...
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.util.LocalizedFormats.INSTANCES_NOT_COMPARABLE_TO_EXISTING_VALUES, v.getClass().getName());
		}
	}
