...
public class EigenDecompositionImpl implements org.apache.commons.math.linear.decomposition.EigenDecomposition {
	...
	private static final double TOLERANCE_2 = (org.apache.commons.math.linear.decomposition.EigenDecompositionImpl.TOLERANCE) * (org.apache.commons.math.linear.decomposition.EigenDecompositionImpl.TOLERANCE);
	...
	private org.apache.commons.math.linear.decomposition.TriDiagonalTransformer transformer;
	...
	private org.apache.commons.math.linear.RealVectorImpl[] eigenvectors;
	...
	public EigenDecompositionImpl(final org.apache.commons.math.linear.RealMatrix matrix, final double splitTolerance) throws org.apache.commons.math.linear.InvalidMatrixException {
		if (isSymmetric(matrix)) {
			org.apache.commons.math.linear.decomposition.EigenDecompositionImpl.this.splitTolerance = splitTolerance;
	...
	public EigenDecompositionImpl(final double[] main, double[] secondary, final double splitTolerance) throws org.apache.commons.math.linear.InvalidMatrixException {
		org.apache.commons.math.linear.decomposition.EigenDecompositionImpl.this.main = main.clone();
		org.apache.commons.math.linear.decomposition.EigenDecompositionImpl.this.secondary = secondary.clone();
		transformer = null;
	...
	public org.apache.commons.math.linear.decomposition.DecompositionSolver getSolver() {
		...
		return new org.apache.commons.math.linear.decomposition.EigenDecompositionImpl.Solver(realEigenvalues, imagEigenvalues, eigenvectors);
	}
	...
	private static class Solver implements org.apache.commons.math.linear.decomposition.DecompositionSolver {
		...
		private final org.apache.commons.math.linear.RealVectorImpl[] eigenvectors;

		private Solver(final double[] realEigenvalues, final double[] imagEigenvalues, final org.apache.commons.math.linear.RealVectorImpl[] eigenvectors) {
			org.apache.commons.math.linear.decomposition.EigenDecompositionImpl.Solver.this.realEigenvalues = realEigenvalues;
			org.apache.commons.math.linear.decomposition.EigenDecompositionImpl.Solver.this.imagEigenvalues = imagEigenvalues;
		...
		public double[] solve(final double[] b) throws java.lang.IllegalArgumentException, org.apache.commons.math.linear.InvalidMatrixException {
			...
			for (int i = 0; i < m; ++i) {
				final org.apache.commons.math.linear.RealVectorImpl v = eigenvectors[i];
	...
	private void transformToTridiagonal(final org.apache.commons.math.linear.RealMatrix matrix) {
		transformer = new org.apache.commons.math.linear.decomposition.TriDiagonalTransformer(matrix);
	...
	private void processGeneralBlock(final int n) throws org.apache.commons.math.linear.InvalidMatrixException {
		...
		while (n0 > 0) {
			...
			for (int i = 4 * (n0 - 2); i >= 0; i -= 4) {
				...
				if (qMin >= (4 * eMax)) {
					qMin = java.lang.Math.min(qMin, work[(i + 4)]);
					eMax = java.lang.Math.max(eMax, work[(i + 2)]);
				}
				qMax = java.lang.Math.max(qMax, ((work[i]) + (work[(i + 2)])));
				eMin = java.lang.Math.min(eMin, work[(i + 2)]);
			}
			work[((4 * n0) - 2)] = eMin;
			dMin = -(java.lang.Math.max(0, (qMin - (2 * (java.lang.Math.sqrt((qMin * eMax)))))));
			pingPong = 0;
			...
			for (int k = 0; i0 < n0; ++k) {
				...
				n0 = goodStep(i0, n0);
				pingPong = 1 - (pingPong);
				if (((((pingPong) == 0) && ((n0 - i0) > 3)) && ((work[((4 * n0) - 1)]) <= ((org.apache.commons.math.linear.decomposition.EigenDecompositionImpl.TOLERANCE_2) * qMax))) && ((work[((4 * n0) - 2)]) <= ((org.apache.commons.math.linear.decomposition.EigenDecompositionImpl.TOLERANCE_2) * (sigma)))) {
					int split = i0 - 1;
					qMax = work[(4 * i0)];
					eMin = work[((4 * i0) + 2)];
					double previousEMin = work[((4 * i0) + 3)];
					for (int i = 4 * i0; i < ((4 * n0) - 11); i += 4) {
						if (((work[(i + 3)]) <= ((org.apache.commons.math.linear.decomposition.EigenDecompositionImpl.TOLERANCE_2) * (work[i]))) && ((work[(i + 2)]) <= ((org.apache.commons.math.linear.decomposition.EigenDecompositionImpl.TOLERANCE_2) * (sigma)))) {
							work[(i + 2)] = -(sigma);
							split = i / 4;
							qMax = 0;
							eMin = work[(i + 6)];
							...
							qMax = java.lang.Math.max(qMax, work[(i + 4)]);
							eMin = java.lang.Math.min(eMin, work[(i + 2)]);
	...
	private void initialSplits(final int n) {
		...
		for (int k = 0; k < 2; ++k) {
			...
			for (int i = (4 * (n - 2)) + (pingPong); i >= 0; i -= 4) {
				if ((work[(i + 2)]) <= ((org.apache.commons.math.linear.decomposition.EigenDecompositionImpl.TOLERANCE_2) * d)) {
					work[(i + 2)] = -0.0;
					d = work[i];
				}else {
					d *= (work[i]) / (d + (work[(i + 2)]));
			...
			for (int i = 2 + (pingPong); i < ((4 * n) - 2); i += 4) {
				...
				work[j] = d + (work[i]);
				if ((work[i]) <= ((org.apache.commons.math.linear.decomposition.EigenDecompositionImpl.TOLERANCE_2) * d)) {
					work[i] = -0.0;
					work[j] = d;
					work[(j + 2)] = 0.0;
					d = work[(i + 2)];
	...
	private int goodStep(final int start, final int end) {
		...
		for (boolean deflating = true; deflating;) {
			...
			if ((start == (deflatedEnd - 1)) || ((start != (deflatedEnd - 2)) && (((work[(k - 5)]) <= ((org.apache.commons.math.linear.decomposition.EigenDecompositionImpl.TOLERANCE_2) * ((sigma) + (work[(k - 3)])))) || ((work[((k - (2 * (pingPong))) - 4)]) <= ((org.apache.commons.math.linear.decomposition.EigenDecompositionImpl.TOLERANCE_2) * (work[(k - 7)])))))) {
				work[((4 * deflatedEnd) - 4)] = (sigma) + (work[(((4 * deflatedEnd) - 4) + (pingPong))]);
				deflatedEnd -= 1;
			}else
				if (((start == (deflatedEnd - 2)) || ((work[(k - 9)]) <= ((org.apache.commons.math.linear.decomposition.EigenDecompositionImpl.TOLERANCE_2) * (sigma)))) || ((work[((k - (2 * (pingPong))) - 8)]) <= ((org.apache.commons.math.linear.decomposition.EigenDecompositionImpl.TOLERANCE_2) * (work[(k - 11)])))) {
					if ((work[(k - 3)]) > (work[(k - 7)])) {
						final double tmp = work[(k - 3)];
						work[(k - 3)] = work[(k - 7)];
						work[(k - 7)] = tmp;
					}
					if ((work[(k - 5)]) > ((org.apache.commons.math.linear.decomposition.EigenDecompositionImpl.TOLERANCE_2) * (work[(k - 3)]))) {
		...
		if (((dMin) < 0) || (((org.apache.commons.math.util.MathUtils.SAFE_MIN) * (qMax)) < (java.lang.Math.min(work[(l - 1)], java.lang.Math.min(work[(l - 9)], ((dMin2) + (work[(l - (2 * (pingPong)))]))))))) {
			...
			for (boolean loop = true; loop;) {
				...
				if (((dMin) >= 0) && ((dMin1) > 0)) {
					...
					if (((((dMin) < 0.0) && ((dMin1) > 0.0)) && ((work[(((4 * deflatedEnd) - 5) - (pingPong))]) < ((org.apache.commons.math.linear.decomposition.EigenDecompositionImpl.TOLERANCE) * ((sigma) + (dN1))))) && ((java.lang.Math.abs(dN)) < ((org.apache.commons.math.linear.decomposition.EigenDecompositionImpl.TOLERANCE) * (sigma)))) {
	...
	private void findEigenVectors() {
		final int m = main.length;
		eigenvectors = new org.apache.commons.math.linear.RealVectorImpl[m];
	...
	private org.apache.commons.math.linear.RealVectorImpl findEigenvector(final double eigenvalue, final double[] d, final double[] l) {
		final int m = main.length;
		...
		for (int i = 0, sixI = 0; i < (m - 1); ++i , sixI += 6) {
			...
			final double absG = java.lang.Math.abs(g);
			if (absG < minG) {
				r = i;
				minG = absG;
			}
		...
		return (transformer) == null ? new org.apache.commons.math.linear.RealVectorImpl(eigenvector, false) : new org.apache.commons.math.linear.RealVectorImpl(transformer.getQ().operate(eigenvector), false);
	}
