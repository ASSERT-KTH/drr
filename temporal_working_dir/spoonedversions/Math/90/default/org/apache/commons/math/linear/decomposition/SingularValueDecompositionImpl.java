...
public class SingularValueDecompositionImpl implements org.apache.commons.math.linear.decomposition.SingularValueDecomposition {
	...
	private org.apache.commons.math.linear.decomposition.BiDiagonalTransformer transformer;
	...
	private org.apache.commons.math.linear.decomposition.EigenDecomposition eigenDecomposition;
	...
	public SingularValueDecompositionImpl(org.apache.commons.math.linear.RealMatrix matrix) throws org.apache.commons.math.linear.InvalidMatrixException {
		...
		cachedV = null;
		cachedVt = null;
		transformer = new org.apache.commons.math.linear.decomposition.BiDiagonalTransformer(matrix);
		...
		eigenDecomposition = new org.apache.commons.math.linear.decomposition.EigenDecompositionImpl(mainTridiagonal, secondaryTridiagonal, org.apache.commons.math.util.MathUtils.SAFE_MIN);
	...
	public org.apache.commons.math.linear.decomposition.DecompositionSolver getSolver() {
		return new org.apache.commons.math.linear.decomposition.SingularValueDecompositionImpl.Solver(singularValues, getUT(), getV(), ((getRank()) == (singularValues.length)));
	}
	...
	private static class Solver implements org.apache.commons.math.linear.decomposition.DecompositionSolver {
		...
		private Solver(final double[] singularValues, final org.apache.commons.math.linear.RealMatrix uT, final org.apache.commons.math.linear.RealMatrix v, final boolean nonSingular) {
			...
			this.uT = uT;
			this.v = v;
			org.apache.commons.math.linear.decomposition.SingularValueDecompositionImpl.Solver.this.nonSingular = nonSingular;
		}
