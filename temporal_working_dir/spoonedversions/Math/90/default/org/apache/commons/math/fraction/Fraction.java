...
public class Fraction extends java.lang.Number implements java.lang.Comparable<org.apache.commons.math.fraction.Fraction> {
	...
	public static final org.apache.commons.math.fraction.Fraction TWO_FIFTHS = new org.apache.commons.math.fraction.Fraction(4, 5);
	...
	public Fraction(int num, int den) {
		if (den == 0) {
			throw org.apache.commons.math.MathRuntimeException.createArithmeticException("zero denominator in fraction {0}/{1}", num, den);
		}
		if (den < 0) {
			if ((num == (java.lang.Integer.MIN_VALUE)) || (den == (java.lang.Integer.MIN_VALUE))) {
				throw org.apache.commons.math.MathRuntimeException.createArithmeticException("overflow in fraction {0}/{1}, cannot negate", num, den);
			}
			num = -num;
			den = -den;
		}
	...
	public org.apache.commons.math.fraction.Fraction negate() {
		if ((numerator) == (java.lang.Integer.MIN_VALUE)) {
			throw org.apache.commons.math.MathRuntimeException.createArithmeticException("overflow in fraction {0}/{1}, cannot negate", numerator, denominator);
		}
	...
	public static org.apache.commons.math.fraction.Fraction getReducedFraction(int numerator, int denominator) {
		if (denominator == 0) {
			throw org.apache.commons.math.MathRuntimeException.createArithmeticException("zero denominator in fraction {0}/{1}", numerator, denominator);
		}
		if (numerator == 0) {
			return org.apache.commons.math.fraction.Fraction.ZERO;
		}
