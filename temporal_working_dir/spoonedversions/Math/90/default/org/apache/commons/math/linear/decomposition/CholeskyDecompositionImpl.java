...
public class CholeskyDecompositionImpl implements org.apache.commons.math.linear.decomposition.CholeskyDecomposition {
	...
	public CholeskyDecompositionImpl(final org.apache.commons.math.linear.RealMatrix matrix) throws org.apache.commons.math.linear.decomposition.NonSquareMatrixException, org.apache.commons.math.linear.decomposition.NotPositiveDefiniteMatrixException, org.apache.commons.math.linear.decomposition.NotSymmetricMatrixException {
		this(matrix, org.apache.commons.math.linear.decomposition.CholeskyDecompositionImpl.DEFAULT_RELATIVE_SYMMETRY_THRESHOLD, org.apache.commons.math.linear.decomposition.CholeskyDecompositionImpl.DEFAULT_ABSOLUTE_POSITIVITY_THRESHOLD);
	}

	public CholeskyDecompositionImpl(final org.apache.commons.math.linear.RealMatrix matrix, final double relativeSymmetryThreshold, final double absolutePositivityThreshold) throws org.apache.commons.math.linear.decomposition.NonSquareMatrixException, org.apache.commons.math.linear.decomposition.NotPositiveDefiniteMatrixException, org.apache.commons.math.linear.decomposition.NotSymmetricMatrixException {
		if (!(matrix.isSquare())) {
			throw new org.apache.commons.math.linear.decomposition.NonSquareMatrixException(matrix.getRowDimension(), matrix.getColumnDimension());
		}
		...
		for (int i = 0; i < order; ++i) {
			...
			if ((lTData[i][i]) < absolutePositivityThreshold) {
				throw new org.apache.commons.math.linear.decomposition.NotPositiveDefiniteMatrixException();
			}
			for (int j = i + 1; j < order; ++j) {
				...
				if ((java.lang.Math.abs((lIJ - lJI))) > maxDelta) {
					throw new org.apache.commons.math.linear.decomposition.NotSymmetricMatrixException();
				}
				lJ[i] = 0;
			}
		}
	...
	public org.apache.commons.math.linear.decomposition.DecompositionSolver getSolver() {
		return new org.apache.commons.math.linear.decomposition.CholeskyDecompositionImpl.Solver(lTData);
	}

	private static class Solver implements org.apache.commons.math.linear.decomposition.DecompositionSolver {
