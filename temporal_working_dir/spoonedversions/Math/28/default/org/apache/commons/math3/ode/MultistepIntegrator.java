...
public abstract class MultistepIntegrator extends org.apache.commons.math3.ode.nonstiff.AdaptiveStepsizeIntegrator {
	...
	protected MultistepIntegrator(final java.lang.String name, final int nSteps, final int order, final double minStep, final double maxStep, final double scalAbsoluteTolerance, final double scalRelativeTolerance) {
		...
		if (nSteps <= 1) {
			throw new org.apache.commons.math3.exception.MathIllegalArgumentException(org.apache.commons.math3.exception.util.LocalizedFormats.INTEGRATION_METHOD_NEEDS_AT_LEAST_TWO_PREVIOUS_POINTS, name);
		}
	...
	protected void start(final double t0, final double[] y0, final double t) throws org.apache.commons.math3.exception.MathIllegalStateException {
		...
		try {
			starter.integrate(new org.apache.commons.math3.ode.MultistepIntegrator.CountingDifferentialEquations(y0.length), t0, y0, t, new double[y0.length]);
	...
	private class CountingDifferentialEquations implements org.apache.commons.math3.ode.FirstOrderDifferentialEquations {
		...
		public void computeDerivatives(double t, double[] y, double[] dot) {
			org.apache.commons.math3.ode.MultistepIntegrator.this.computeDerivatives(t, y, dot);
		}
