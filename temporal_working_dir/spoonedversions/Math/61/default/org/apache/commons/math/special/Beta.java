	...
	public static double regularizedBeta(double x, final double a, final double b, double epsilon, int maxIterations) throws org.apache.commons.math.MathException {
		...
		if (((((((java.lang.Double.isNaN(x)) || (java.lang.Double.isNaN(a))) || (java.lang.Double.isNaN(b))) || (x < 0)) || (x > 1)) || (a <= 0.0)) || (b <= 0.0)) {
			...
			if (x > ((a + 1.0) / ((a + b) + 2.0))) {
				...
				ret = ((org.apache.commons.math.util.FastMath.exp(((((a * (org.apache.commons.math.util.FastMath.log(x))) + (b * (org.apache.commons.math.util.FastMath.log((1.0 - x))))) - (org.apache.commons.math.util.FastMath.log(a))) - (org.apache.commons.math.special.Beta.logBeta(a, b, epsilon, maxIterations))))) * 1.0) / (fraction.evaluate(x, epsilon, maxIterations));
			}
