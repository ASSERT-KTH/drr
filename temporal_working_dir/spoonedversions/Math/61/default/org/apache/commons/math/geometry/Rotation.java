...
public class Rotation implements java.io.Serializable {
	...
	public Rotation(org.apache.commons.math.geometry.Vector3D axis, double angle) {
		...
		if (norm == 0) {
			throw org.apache.commons.math.MathRuntimeException.createArithmeticException(org.apache.commons.math.exception.util.LocalizedFormats.ZERO_NORM_FOR_ROTATION_AXIS);
		}
	...
	public Rotation(double[][] m, double threshold) throws org.apache.commons.math.geometry.NotARotationMatrixException {
		if (((((m.length) != 3) || ((m[0].length) != 3)) || ((m[1].length) != 3)) || ((m[2].length) != 3)) {
			throw new org.apache.commons.math.geometry.NotARotationMatrixException(org.apache.commons.math.exception.util.LocalizedFormats.ROTATION_MATRIX_DIMENSIONS, m.length, m[0].length);
		}
		...
		if (det < 0.0) {
			throw new org.apache.commons.math.geometry.NotARotationMatrixException(org.apache.commons.math.exception.util.LocalizedFormats.CLOSEST_ORTHOGONAL_MATRIX_HAS_NEGATIVE_DETERMINANT, det);
		}
	...
	public Rotation(org.apache.commons.math.geometry.Vector3D u1, org.apache.commons.math.geometry.Vector3D u2, org.apache.commons.math.geometry.Vector3D v1, org.apache.commons.math.geometry.Vector3D v2) {
		...
		if ((((u1u1 == 0) || (u2u2 == 0)) || (v1v1 == 0)) || (v2v2 == 0)) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.util.LocalizedFormats.ZERO_NORM_FOR_ROTATION_DEFINING_VECTOR);
		}
		double u1x = u1.getX();
		double u1y = u1.getY();
		double u1z = u1.getZ();
	...
	private double[][] orthogonalizeMatrix(double[][] m, double threshold) throws org.apache.commons.math.geometry.NotARotationMatrixException {
		...
		throw new org.apache.commons.math.geometry.NotARotationMatrixException(org.apache.commons.math.exception.util.LocalizedFormats.UNABLE_TO_ORTHOGONOLIZE_MATRIX, (i - 1));
	}
