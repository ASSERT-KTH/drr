...
public class NonLinearConjugateGradientOptimizer extends org.apache.commons.math.optimization.general.AbstractScalarDifferentiableOptimizer {
	...
	public void setLineSearchSolver(final org.apache.commons.math.analysis.solvers.UnivariateRealSolver lineSearchSolver) {
		org.apache.commons.math.optimization.general.NonLinearConjugateGradientOptimizer.this.solver = lineSearchSolver;
	}
	...
	private double findUpperBound(final org.apache.commons.math.analysis.UnivariateRealFunction f, final double a, final double h) throws org.apache.commons.math.FunctionEvaluationException {
