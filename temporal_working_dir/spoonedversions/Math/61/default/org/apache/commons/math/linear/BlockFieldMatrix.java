...
public class BlockFieldMatrix<T extends org.apache.commons.math.FieldElement<T>> extends org.apache.commons.math.linear.AbstractFieldMatrix<T> implements java.io.Serializable {
	...
	public BlockFieldMatrix(final org.apache.commons.math.Field<T> field, final int rows, final int columns) throws java.lang.IllegalArgumentException {
		...
		blockRows = ((rows + (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE)) - 1) / (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE);
		blockColumns = ((columns + (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE)) - 1) / (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE);
		...
		for (int iBlock = 0; iBlock < (blockRows); ++iBlock) {
			...
			for (int jBlock = 0; jBlock < (blockColumns); ++jBlock , ++index) {
				if ((blockData[index].length) != (iHeight * (blockWidth(jBlock)))) {
					throw new org.apache.commons.math.exception.DimensionMismatchException(blockData[index].length, (iHeight * (blockWidth(jBlock))));
				}
				if (copyArray) {
	...
	public static <T extends org.apache.commons.math.FieldElement<T>> T[][] toBlocksLayout(final T[][] rawData) throws java.lang.IllegalArgumentException {
		...
		final int blockRows = ((rows + (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE)) - 1) / (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE);
		final int blockColumns = ((columns + (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE)) - 1) / (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE);
		for (int i = 0; i < (rawData.length); ++i) {
			final int length = rawData[i].length;
			if (length != columns) {
				throw new org.apache.commons.math.exception.DimensionMismatchException(columns, length);
			}
		}
		...
		int blockIndex = 0;
		for (int iBlock = 0; iBlock < blockRows; ++iBlock) {
			final int pStart = iBlock * (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE);
			final int pEnd = org.apache.commons.math.util.FastMath.min((pStart + (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE)), rows);
			final int iHeight = pEnd - pStart;
			for (int jBlock = 0; jBlock < blockColumns; ++jBlock) {
				final int qStart = jBlock * (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE);
				final int qEnd = org.apache.commons.math.util.FastMath.min((qStart + (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE)), columns);
	...
	public org.apache.commons.math.linear.FieldMatrix<T> multiply(final org.apache.commons.math.linear.FieldMatrix<T> m) throws java.lang.IllegalArgumentException {
		try {
			...
			for (int iBlock = 0; iBlock < (out.blockRows); ++iBlock) {
				...
				for (int jBlock = 0; jBlock < (out.blockColumns); ++jBlock) {
					final int qStart = jBlock * (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE);
					final int qEnd = org.apache.commons.math.util.FastMath.min((qStart + (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE)), m.getColumnDimension());
					final T[] outBlock = out.blocks[blockIndex];
					for (int kBlock = 0; kBlock < (blockColumns); ++kBlock) {
						final int kWidth = blockWidth(kBlock);
						final T[] tBlock = blocks[((iBlock * (blockColumns)) + kBlock)];
						final int rStart = kBlock * (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE);
						int k = 0;
						for (int p = pStart; p < pEnd; ++p) {
	...
	public T[][] getData() {
		...
		final int lastColumns = (columns) - (((blockColumns) - 1) * (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE));
		for (int iBlock = 0; iBlock < (blockRows); ++iBlock) {
			final int pStart = iBlock * (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE);
			final int pEnd = org.apache.commons.math.util.FastMath.min((pStart + (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE)), rows);
			int regularPos = 0;
			...
			for (int p = pStart; p < pEnd; ++p) {
				...
				for (int jBlock = 0; jBlock < ((blockColumns) - 1); ++jBlock) {
					java.lang.System.arraycopy(blocks[(blockIndex++)], regularPos, dataP, dataPos, org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE);
					dataPos += org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE;
				}
				java.lang.System.arraycopy(blocks[blockIndex], lastPos, dataP, dataPos, lastColumns);
				regularPos += org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE;
				lastPos += lastColumns;
			}
		}
		return data;
	...
	public org.apache.commons.math.linear.FieldMatrix<T> getSubMatrix(final int startRow, final int endRow, final int startColumn, final int endColumn) throws org.apache.commons.math.linear.MatrixIndexException {
		...
		final int blockStartRow = startRow / (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE);
		final int rowsShift = startRow % (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE);
		final int blockStartColumn = startColumn / (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE);
		final int columnsShift = startColumn % (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE);
		...
		for (int iBlock = 0; iBlock < (out.blockRows); ++iBlock) {
			...
			for (int jBlock = 0; jBlock < (out.blockColumns); ++jBlock) {
				...
				final int heightExcess = (iHeight + rowsShift) - (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE);
				final int widthExcess = (jWidth + columnsShift) - (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE);
				if (heightExcess > 0) {
					if (widthExcess > 0) {
						final int width2 = blockWidth((qBlock + 1));
						copyBlockPart(blocks[index], width, rowsShift, org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE, columnsShift, org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE, outBlock, jWidth, 0, 0);
						copyBlockPart(blocks[(index + 1)], width2, rowsShift, org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE, 0, widthExcess, outBlock, jWidth, 0, (jWidth - widthExcess));
						copyBlockPart(blocks[(index + (blockColumns))], width, 0, heightExcess, columnsShift, org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE, outBlock, jWidth, (iHeight - heightExcess), 0);
						...
						copyBlockPart(blocks[index], width, rowsShift, org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE, columnsShift, (jWidth + columnsShift), outBlock, jWidth, 0, 0);
					...
					if (widthExcess > 0) {
						final int width2 = blockWidth((qBlock + 1));
						copyBlockPart(blocks[index], width, rowsShift, (iHeight + rowsShift), columnsShift, org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE, outBlock, jWidth, 0, 0);
	...
	public void setSubMatrix(final T[][] subMatrix, final int row, final int column) throws org.apache.commons.math.linear.MatrixIndexException {
		...
		for (final T[] subRow : subMatrix) {
			if ((subRow.length) != refLength) {
				throw new org.apache.commons.math.exception.DimensionMismatchException(refLength, subRow.length);
			}
		}
		final int blockStartRow = row / (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE);
		final int blockEndRow = (endRow + (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE)) / (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE);
		final int blockStartColumn = column / (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE);
		final int blockEndColumn = (endColumn + (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE)) / (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE);
		for (int iBlock = blockStartRow; iBlock < blockEndRow; ++iBlock) {
			final int iHeight = blockHeight(iBlock);
			final int firstRow = iBlock * (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE);
			final int iStart = org.apache.commons.math.util.FastMath.max(row, firstRow);
			final int iEnd = org.apache.commons.math.util.FastMath.min((endRow + 1), (firstRow + iHeight));
			for (int jBlock = blockStartColumn; jBlock < blockEndColumn; ++jBlock) {
				final int jWidth = blockWidth(jBlock);
				final int firstColumn = jBlock * (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE);
				final int jStart = org.apache.commons.math.util.FastMath.max(column, firstColumn);
				final int jEnd = org.apache.commons.math.util.FastMath.min((endColumn + 1), (firstColumn + jWidth));
	...
	public org.apache.commons.math.linear.FieldMatrix<T> getRowMatrix(final int row) throws org.apache.commons.math.linear.MatrixIndexException {
		...
		final int iBlock = row / (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE);
		final int iRow = row - (iBlock * (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE));
		int outBlockIndex = 0;
		int outIndex = 0;
	...
	public void setRowMatrix(final int row, final org.apache.commons.math.linear.BlockFieldMatrix<T> matrix) {
		checkRowIndex(row);
		final int nCols = getColumnDimension();
		if (((matrix.getRowDimension()) != 1) || ((matrix.getColumnDimension()) != nCols)) {
			throw new org.apache.commons.math.exception.MatrixDimensionMismatchException(matrix.getRowDimension(), matrix.getColumnDimension(), 1, nCols);
		}
		final int iBlock = row / (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE);
		final int iRow = row - (iBlock * (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE));
		int mBlockIndex = 0;
	...
	public org.apache.commons.math.linear.FieldMatrix<T> getColumnMatrix(final int column) throws org.apache.commons.math.linear.MatrixIndexException {
		...
		final int jBlock = column / (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE);
		final int jColumn = column - (jBlock * (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE));
		final int jWidth = blockWidth(jBlock);
		int outBlockIndex = 0;
		int outIndex = 0;
		T[] outBlock = out.blocks[outBlockIndex];
	...
	void setColumnMatrix(final int column, final org.apache.commons.math.linear.BlockFieldMatrix<T> matrix) {
		checkColumnIndex(column);
		final int nRows = getRowDimension();
		if (((matrix.getRowDimension()) != nRows) || ((matrix.getColumnDimension()) != 1)) {
			throw new org.apache.commons.math.exception.MatrixDimensionMismatchException(matrix.getRowDimension(), matrix.getColumnDimension(), nRows, 1);
		}
		final int jBlock = column / (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE);
		final int jColumn = column - (jBlock * (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE));
		final int jWidth = blockWidth(jBlock);
	...
	public void setRow(final int row, final T[] array) {
		...
		if ((array.length) != nCols) {
			throw new org.apache.commons.math.exception.MatrixDimensionMismatchException(1, array.length, 1, nCols);
		}
		final int iBlock = row / (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE);
		final int iRow = row - (iBlock * (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE));
		int outIndex = 0;
	...
	public void setColumn(final int column, final T[] array) {
		...
		if ((array.length) != nRows) {
			throw new org.apache.commons.math.exception.MatrixDimensionMismatchException(array.length, 1, nRows, 1);
		}
		final int jBlock = column / (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE);
		final int jColumn = column - (jBlock * (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE));
		final int jWidth = blockWidth(jBlock);
	...
	public T getEntry(final int row, final int column) throws org.apache.commons.math.linear.MatrixIndexException {
		try {
			final int iBlock = row / (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE);
			final int jBlock = column / (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE);
			final int k = ((row - (iBlock * (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE))) * (blockWidth(jBlock))) + (column - (jBlock * (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE)));
			return blocks[((iBlock * (blockColumns)) + jBlock)][k];
		} catch (java.lang.ArrayIndexOutOfBoundsException e) {
			throw new org.apache.commons.math.linear.MatrixIndexException(org.apache.commons.math.exception.util.LocalizedFormats.NO_SUCH_MATRIX_ENTRY, row, column, getRowDimension(), getColumnDimension());
		}
	}
	...
	public org.apache.commons.math.linear.FieldMatrix<T> transpose() {
		...
		for (int iBlock = 0; iBlock < (blockColumns); ++iBlock) {
			for (int jBlock = 0; jBlock < (blockRows); ++jBlock) {
				...
				final int pStart = iBlock * (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE);
				final int pEnd = org.apache.commons.math.util.FastMath.min((pStart + (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE)), columns);
				final int qStart = jBlock * (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE);
				final int qEnd = org.apache.commons.math.util.FastMath.min((qStart + (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE)), rows);
				int k = 0;
				for (int p = pStart; p < pEnd; ++p) {
	...
	public T[] operate(final T[] v) throws java.lang.IllegalArgumentException {
		if ((v.length) != (columns)) {
			throw new org.apache.commons.math.exception.DimensionMismatchException(v.length, columns);
		}
		final T[] out = org.apache.commons.math.linear.AbstractFieldMatrix.buildArray(getField(), rows);
		final T zero = getField().getZero();
		for (int iBlock = 0; iBlock < (blockRows); ++iBlock) {
	...
	public T[] preMultiply(final T[] v) throws java.lang.IllegalArgumentException {
		if ((v.length) != (rows)) {
			throw new org.apache.commons.math.exception.DimensionMismatchException(v.length, rows);
		}
		final T[] out = org.apache.commons.math.linear.AbstractFieldMatrix.buildArray(getField(), columns);
		final T zero = getField().getZero();
		for (int jBlock = 0; jBlock < (blockColumns); ++jBlock) {
	...
	public T walkInRowOrder(final org.apache.commons.math.linear.FieldMatrixChangingVisitor<T> visitor, final int startRow, final int endRow, final int startColumn, final int endColumn) throws org.apache.commons.math.linear.MatrixIndexException, org.apache.commons.math.linear.MatrixVisitorException {
		...
		for (int iBlock = startRow / (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE); iBlock < (1 + (endRow / (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE))); ++iBlock) {
			final int p0 = iBlock * (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE);
			final int pStart = org.apache.commons.math.util.FastMath.max(startRow, p0);
			final int pEnd = org.apache.commons.math.util.FastMath.min(((iBlock + 1) * (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE)), (1 + endRow));
			for (int p = pStart; p < pEnd; ++p) {
				for (int jBlock = startColumn / (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE); jBlock < (1 + (endColumn / (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE))); ++jBlock) {
					final int jWidth = blockWidth(jBlock);
					final int q0 = jBlock * (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE);
					final int qStart = org.apache.commons.math.util.FastMath.max(startColumn, q0);
					final int qEnd = org.apache.commons.math.util.FastMath.min(((jBlock + 1) * (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE)), (1 + endColumn));
					final T[] block = blocks[((iBlock * (blockColumns)) + jBlock)];
	...
	private int blockHeight(final int blockRow) {
		return blockRow == ((blockRows) - 1) ? (rows) - (blockRow * (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE)) : org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE;
	}

	private int blockWidth(final int blockColumn) {
		return blockColumn == ((blockColumns) - 1) ? (columns) - (blockColumn * (org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE)) : org.apache.commons.math.linear.BlockFieldMatrix.BLOCK_SIZE;
	}
}
