...
public abstract class BaseAbstractScalarOptimizer<FUNC extends org.apache.commons.math.analysis.MultivariateRealFunction> implements org.apache.commons.math.optimization.BaseMultivariateRealOptimizer<FUNC> {
	...
	public org.apache.commons.math.optimization.RealPointValuePair optimize(FUNC f, org.apache.commons.math.optimization.GoalType goalType, double[] startPoint) throws org.apache.commons.math.FunctionEvaluationException {
		if (f == null) {
