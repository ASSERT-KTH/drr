...
public class EigenDecompositionImpl implements org.apache.commons.math.linear.EigenDecomposition {
	...
	public EigenDecompositionImpl(final org.apache.commons.math.linear.RealMatrix matrix, final double splitTolerance) {
	...
	public EigenDecompositionImpl(final double[] main, final double[] secondary, final double splitTolerance) {
	...
	private static class Solver implements org.apache.commons.math.linear.DecompositionSolver {
		...
		public double[] solve(final double[] b) {
			...
			final org.apache.commons.math.linear.ArrayRealVector bVector = new org.apache.commons.math.linear.ArrayRealVector(b, false);
			for (int i = 0; i < m; ++i) {
