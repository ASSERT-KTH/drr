...
public class SingularValueDecompositionImpl implements org.apache.commons.math.linear.SingularValueDecomposition {
	...
	public SingularValueDecompositionImpl(final org.apache.commons.math.linear.RealMatrix matrix) {
		...
		tol = org.apache.commons.math.util.FastMath.max((((m) * (singularValues[0])) * (org.apache.commons.math.linear.SingularValueDecompositionImpl.EPS)), org.apache.commons.math.util.FastMath.sqrt(org.apache.commons.math.util.MathUtils.SAFE_MIN));
		if (!(transposed)) {
	...
	public org.apache.commons.math.linear.DecompositionSolver getSolver() {
		return new org.apache.commons.math.linear.SingularValueDecompositionImpl.Solver(singularValues, getUT(), getV(), ((getRank()) == (m)), tol);
	}
