...
public class FieldLUDecompositionImpl<T extends org.apache.commons.math.FieldElement<T>> implements org.apache.commons.math.linear.FieldLUDecomposition<T> {
	...
	public FieldLUDecompositionImpl(org.apache.commons.math.linear.FieldMatrix<T> matrix) {
		if (!(matrix.isSquare())) {
	...
	private static class Solver<T extends org.apache.commons.math.FieldElement<T>> implements org.apache.commons.math.linear.FieldDecompositionSolver<T> {
		...
		public org.apache.commons.math.linear.ArrayFieldVector<T> solve(org.apache.commons.math.linear.ArrayFieldVector<T> b) {
			return new org.apache.commons.math.linear.ArrayFieldVector<T>(field, solve(b.getDataRef()), false);
		}
