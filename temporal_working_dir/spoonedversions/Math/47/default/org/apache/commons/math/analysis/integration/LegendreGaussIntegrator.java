...
public class LegendreGaussIntegrator extends org.apache.commons.math.analysis.integration.UnivariateRealIntegratorImpl {
	...
	public LegendreGaussIntegrator(final int n, final double relativeAccuracy, final double absoluteAccuracy) {
		this(n, relativeAccuracy, absoluteAccuracy, org.apache.commons.math.analysis.integration.UnivariateRealIntegratorImpl.DEFAULT_MIN_ITERATIONS_COUNT, org.apache.commons.math.analysis.integration.UnivariateRealIntegratorImpl.DEFAULT_MAX_ITERATIONS_COUNT);
	}

	public LegendreGaussIntegrator(final int n, final int minimalIterationCount, final int maximalIterationCount) {
		this(n, org.apache.commons.math.analysis.integration.UnivariateRealIntegratorImpl.DEFAULT_RELATIVE_ACCURACY, org.apache.commons.math.analysis.integration.UnivariateRealIntegratorImpl.DEFAULT_ABSOLUTE_ACCURACY, minimalIterationCount, maximalIterationCount);
	}

	protected double doIntegrate() throws org.apache.commons.math.ConvergenceException, org.apache.commons.math.exception.TooManyEvaluationsException {
		double oldt = stage(1);
		int n = 2;
		while (true) {
