...
LARGEST_VARIANCE, LARGEST_POINTS_NUMBER, FARTHEST_POINT, ERROR;	}
	...
	public java.util.List<org.apache.commons.math.stat.clustering.Cluster<T>> cluster(final java.util.Collection<T> points, final int k, int numTrials, int maxIterationsPerTrial) throws org.apache.commons.math.exception.MathIllegalArgumentException {
		java.util.List<org.apache.commons.math.stat.clustering.Cluster<T>> best = null;
		double bestVarianceSum = java.lang.Double.POSITIVE_INFINITY;
		for (int i = 0; i < numTrials; ++i) {
			java.util.List<org.apache.commons.math.stat.clustering.Cluster<T>> clusters = cluster(points, k, maxIterationsPerTrial);
	...
	public java.util.List<org.apache.commons.math.stat.clustering.Cluster<T>> cluster(final java.util.Collection<T> points, final int k, final int maxIterations) throws org.apache.commons.math.exception.MathIllegalArgumentException {
		org.apache.commons.math.util.MathUtils.checkNotNull(points);
		if ((points.size()) < k) {
			throw new org.apache.commons.math.exception.NumberIsTooSmallException(points.size(), k, false);
		}
		...
		org.apache.commons.math.stat.clustering.KMeansPlusPlusClusterer.assignPointsToClusters(clusters, points, assignments);
		...
		for (int count = 0; count < max; count++) {
			...
			int changes = org.apache.commons.math.stat.clustering.KMeansPlusPlusClusterer.assignPointsToClusters(newClusters, points, assignments);
	...
	private static <T extends org.apache.commons.math.stat.clustering.Clusterable<T>> int assignPointsToClusters(final java.util.List<org.apache.commons.math.stat.clustering.Cluster<T>> clusters, final java.util.Collection<T> points, final int[] assignments) {
		int assignedDifferently = 0;
		int pointIndex = 0;
		for (final T p : points) {
			int clusterIndex = org.apache.commons.math.stat.clustering.KMeansPlusPlusClusterer.getNearestCluster(clusters, p);
			if (clusterIndex != (assignments[pointIndex])) {
				assignedDifferently++;
			}
			org.apache.commons.math.stat.clustering.Cluster<T> cluster = clusters.get(clusterIndex);
			cluster.addPoint(p);
	...
	private static <T extends org.apache.commons.math.stat.clustering.Clusterable<T>> int getNearestCluster(final java.util.Collection<org.apache.commons.math.stat.clustering.Cluster<T>> clusters, final T point) {
