...
public class BrentOptimizer extends org.apache.commons.math3.optim.univariate.UnivariateOptimizer {
	...
	public BrentOptimizer(double rel, double abs, org.apache.commons.math3.optim.ConvergenceChecker<org.apache.commons.math3.optim.univariate.UnivariatePointValuePair> checker) {
		super(checker);
		if (rel < (org.apache.commons.math3.optim.univariate.BrentOptimizer.MIN_RELATIVE_TOLERANCE)) {
			throw new org.apache.commons.math3.exception.NumberIsTooSmallException(rel, org.apache.commons.math3.optim.univariate.BrentOptimizer.MIN_RELATIVE_TOLERANCE, true);
		}
		if (abs <= 0) {
	...
	private org.apache.commons.math3.optim.univariate.UnivariatePointValuePair best(org.apache.commons.math3.optim.univariate.UnivariatePointValuePair a, org.apache.commons.math3.optim.univariate.UnivariatePointValuePair b, boolean isMinim) {
		if (a == null) {
			return b;
		}
		if (b == null) {
