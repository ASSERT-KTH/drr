...
public class MultivariateFunctionMappingAdapter implements org.apache.commons.math3.analysis.MultivariateFunction {
	...
	public MultivariateFunctionMappingAdapter(final org.apache.commons.math3.analysis.MultivariateFunction bounded, final double[] lower, final double[] upper) {
		...
		this.mappers = new org.apache.commons.math3.optim.nonlinear.scalar.MultivariateFunctionMappingAdapter.Mapper[lower.length];
		for (int i = 0; i < (mappers.length); ++i) {
			if (java.lang.Double.isInfinite(lower[i])) {
				if (java.lang.Double.isInfinite(upper[i])) {
					mappers[i] = new org.apache.commons.math3.optim.nonlinear.scalar.MultivariateFunctionMappingAdapter.NoBoundsMapper();
				}else {
					mappers[i] = new org.apache.commons.math3.optim.nonlinear.scalar.MultivariateFunctionMappingAdapter.UpperBoundMapper(upper[i]);
				}
			}else {
				if (java.lang.Double.isInfinite(upper[i])) {
					mappers[i] = new org.apache.commons.math3.optim.nonlinear.scalar.MultivariateFunctionMappingAdapter.LowerBoundMapper(lower[i]);
				}else {
					mappers[i] = new org.apache.commons.math3.optim.nonlinear.scalar.MultivariateFunctionMappingAdapter.LowerUpperBoundMapper(lower[i], upper[i]);
				}
			}
		}
	}
	...
	private static class NoBoundsMapper implements org.apache.commons.math3.optim.nonlinear.scalar.MultivariateFunctionMappingAdapter.Mapper {
	...
	private static class LowerBoundMapper implements org.apache.commons.math3.optim.nonlinear.scalar.MultivariateFunctionMappingAdapter.Mapper {
	...
	private static class UpperBoundMapper implements org.apache.commons.math3.optim.nonlinear.scalar.MultivariateFunctionMappingAdapter.Mapper {
	...
	private static class LowerUpperBoundMapper implements org.apache.commons.math3.optim.nonlinear.scalar.MultivariateFunctionMappingAdapter.Mapper {
