...
public class PowellOptimizer extends org.apache.commons.math3.optimization.direct.BaseAbstractMultivariateOptimizer<org.apache.commons.math3.analysis.MultivariateFunction> implements org.apache.commons.math3.optimization.MultivariateOptimizer {
	...
	public PowellOptimizer(double rel, double abs, double lineRel, double lineAbs, org.apache.commons.math3.optimization.ConvergenceChecker<org.apache.commons.math3.optimization.PointValuePair> checker) {
		super(checker);
		...
		line = new org.apache.commons.math3.optimization.direct.PowellOptimizer.LineSearch(lineRel, lineAbs);
	}
