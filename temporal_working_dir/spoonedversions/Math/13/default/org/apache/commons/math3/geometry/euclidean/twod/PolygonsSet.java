...
public class PolygonsSet extends org.apache.commons.math3.geometry.partitioning.AbstractRegion<org.apache.commons.math3.geometry.euclidean.twod.Euclidean2D, org.apache.commons.math3.geometry.euclidean.oned.Euclidean1D> {
	...
	public PolygonsSet(final double hyperplaneThickness, final org.apache.commons.math3.geometry.euclidean.twod.Vector2D... vertices) {
		super(org.apache.commons.math3.geometry.euclidean.twod.PolygonsSet.verticesToTree(hyperplaneThickness, vertices));
	}
	...
	private static org.apache.commons.math3.geometry.partitioning.BSPTree<org.apache.commons.math3.geometry.euclidean.twod.Euclidean2D> verticesToTree(final double hyperplaneThickness, final org.apache.commons.math3.geometry.euclidean.twod.Vector2D... vertices) {
		...
		java.util.List<org.apache.commons.math3.geometry.euclidean.twod.PolygonsSet.Edge> edges = new java.util.ArrayList<org.apache.commons.math3.geometry.euclidean.twod.PolygonsSet.Edge>();
		for (int i = 0; i < n; ++i) {
			...
			for (final org.apache.commons.math3.geometry.euclidean.twod.PolygonsSet.Vertex vertex : vArray) {
				if (((vertex != start) && (vertex != end)) && ((org.apache.commons.math3.util.FastMath.abs(line.getOffset(vertex.getLocation()))) <= hyperplaneThickness)) {
	...
	private static class SegmentsBuilder implements org.apache.commons.math3.geometry.partitioning.BSPTreeVisitor<org.apache.commons.math3.geometry.euclidean.twod.Euclidean2D> {
		...
		private void addContribution(final org.apache.commons.math3.geometry.partitioning.SubHyperplane<org.apache.commons.math3.geometry.euclidean.twod.Euclidean2D> sub, final boolean reversed) {
			...
			for (final org.apache.commons.math3.geometry.euclidean.oned.Interval i : intervals) {
				final org.apache.commons.math3.geometry.euclidean.twod.Vector2D start = java.lang.Double.isInfinite(i.getInf()) ? null : ((org.apache.commons.math3.geometry.euclidean.twod.Vector2D) (line.toSpace(new org.apache.commons.math3.geometry.euclidean.oned.Vector1D(i.getInf()))));
				final org.apache.commons.math3.geometry.euclidean.twod.Vector2D end = java.lang.Double.isInfinite(i.getSup()) ? null : ((org.apache.commons.math3.geometry.euclidean.twod.Vector2D) (line.toSpace(new org.apache.commons.math3.geometry.euclidean.oned.Vector1D(i.getSup()))));
				if (reversed) {
