...
public class Dfp implements org.apache.commons.math3.FieldElement<org.apache.commons.math3.dfp.Dfp> {
	...
	protected Dfp(final org.apache.commons.math3.dfp.DfpField field, final byte sign, final byte nans) {
		this.field = field;
		org.apache.commons.math3.dfp.Dfp.this.mant = new int[field.getRadixDigits()];
		org.apache.commons.math3.dfp.Dfp.this.sign = sign;
		org.apache.commons.math3.dfp.Dfp.this.exp = 0;
		org.apache.commons.math3.dfp.Dfp.this.nans = nans;
	}
	...
	protected int align(int e) {
		...
		if (adiff > ((mant.length) + 1)) {
			...
			dotrap(org.apache.commons.math3.dfp.DfpField.FLAG_INEXACT, org.apache.commons.math3.dfp.Dfp.ALIGN_TRAP, org.apache.commons.math3.dfp.Dfp.this, org.apache.commons.math3.dfp.Dfp.this);
			return 0;
		}
	...
	public boolean lessThan(final org.apache.commons.math3.dfp.Dfp x) {
		...
		return (org.apache.commons.math3.dfp.Dfp.compare(org.apache.commons.math3.dfp.Dfp.this, x)) < 0;
	}
	...
	public boolean negativeOrNull() {
		if (isNaN()) {
			field.setIEEEFlagsBits(org.apache.commons.math3.dfp.DfpField.FLAG_INVALID);
			dotrap(org.apache.commons.math3.dfp.DfpField.FLAG_INVALID, org.apache.commons.math3.dfp.Dfp.LESS_THAN_TRAP, org.apache.commons.math3.dfp.Dfp.this, newInstance(getZero()));
			return false;
		}
	...
	public org.apache.commons.math3.dfp.Dfp abs() {
		org.apache.commons.math3.dfp.Dfp result = newInstance(org.apache.commons.math3.dfp.Dfp.this);
		result.sign = 1;
		return result;
	}
	...
	public org.apache.commons.math3.dfp.Dfp remainder(final org.apache.commons.math3.dfp.Dfp d) {
		final org.apache.commons.math3.dfp.Dfp result = org.apache.commons.math3.dfp.Dfp.this.subtract(org.apache.commons.math3.dfp.Dfp.this.divide(d).rint().multiply(d));
	...
	protected org.apache.commons.math3.dfp.Dfp trunc(final org.apache.commons.math3.dfp.DfpField.RoundingMode rmode) {
		...
		if (isNaN()) {
			return newInstance(org.apache.commons.math3.dfp.Dfp.this);
		}
		...
		if ((exp) < 0) {
			...
			result = dotrap(org.apache.commons.math3.dfp.DfpField.FLAG_INEXACT, org.apache.commons.math3.dfp.Dfp.TRUNC_TRAP, org.apache.commons.math3.dfp.Dfp.this, result);
			return result;
		}
		if ((exp) >= (mant.length)) {
			return newInstance(org.apache.commons.math3.dfp.Dfp.this);
	...
	public org.apache.commons.math3.dfp.Dfp add(final org.apache.commons.math3.dfp.Dfp x) {
		...
		if (((nans) != (org.apache.commons.math3.dfp.Dfp.FINITE)) || ((x.nans) != (org.apache.commons.math3.dfp.Dfp.FINITE))) {
			if (isNaN()) {
				return org.apache.commons.math3.dfp.Dfp.this;
			}
			if (x.isNaN()) {
				return x;
			}
		...
		org.apache.commons.math3.dfp.Dfp a = newInstance(org.apache.commons.math3.dfp.Dfp.this);
	...
	public org.apache.commons.math3.dfp.Dfp multiply(final org.apache.commons.math3.dfp.Dfp x) {
		...
		if (((nans) != (org.apache.commons.math3.dfp.Dfp.FINITE)) || ((x.nans) != (org.apache.commons.math3.dfp.Dfp.FINITE))) {
			...
			if ((((nans) == (org.apache.commons.math3.dfp.Dfp.INFINITE)) && ((x.nans) == (org.apache.commons.math3.dfp.Dfp.FINITE))) && ((x.mant[((mant.length) - 1)]) != 0)) {
				result = newInstance(org.apache.commons.math3.dfp.Dfp.this);
	...
	public org.apache.commons.math3.dfp.Dfp reciprocal() {
		return field.getOne().divide(org.apache.commons.math3.dfp.Dfp.this);
	}
	...
	public org.apache.commons.math3.dfp.Dfp sqrt() {
		...
		org.apache.commons.math3.dfp.Dfp x = newInstance(org.apache.commons.math3.dfp.Dfp.this);
		if (((x.exp) < (-1)) || ((x.exp) > 1)) {
			x.exp = (org.apache.commons.math3.dfp.Dfp.this.exp) / 2;
		}
		...
		while (x.unequal(px)) {
			dx = newInstance(x);
			dx.sign = -1;
			dx = dx.add(org.apache.commons.math3.dfp.Dfp.this.divide(x));
			dx = dx.divide(2);
			ppx = px;
			px = x;
			x = x.add(dx);
	...
	public org.apache.commons.math3.dfp.Dfp nextAfter(final org.apache.commons.math3.dfp.Dfp x) {
		...
		boolean up = false;
		if (org.apache.commons.math3.dfp.Dfp.this.lessThan(x)) {
			up = true;
		}
		if ((org.apache.commons.math3.dfp.Dfp.compare(org.apache.commons.math3.dfp.Dfp.this, x)) == 0) {
		...
		if (up) {
			...
			inc.exp = ((org.apache.commons.math3.dfp.Dfp.this.exp) - (mant.length)) + 1;
			inc.sign = org.apache.commons.math3.dfp.Dfp.this.sign;
			if (org.apache.commons.math3.dfp.Dfp.this.equals(getZero())) {
				inc.exp = (org.apache.commons.math3.dfp.Dfp.MIN_EXP) - (mant.length);
			}
			result = add(inc);
		}else {
			inc = newInstance(getOne());
			inc.exp = org.apache.commons.math3.dfp.Dfp.this.exp;
			inc.sign = org.apache.commons.math3.dfp.Dfp.this.sign;
			if (org.apache.commons.math3.dfp.Dfp.this.equals(inc)) {
				inc.exp = (org.apache.commons.math3.dfp.Dfp.this.exp) - (mant.length);
			}else {
				inc.exp = ((org.apache.commons.math3.dfp.Dfp.this.exp) - (mant.length)) + 1;
			}
			if (org.apache.commons.math3.dfp.Dfp.this.equals(getZero())) {
			...
			result = org.apache.commons.math3.dfp.Dfp.this.subtract(inc);
		}
		if (((result.classify()) == (org.apache.commons.math3.dfp.Dfp.INFINITE)) && ((org.apache.commons.math3.dfp.Dfp.this.classify()) != (org.apache.commons.math3.dfp.Dfp.INFINITE))) {
			field.setIEEEFlagsBits(org.apache.commons.math3.dfp.DfpField.FLAG_INEXACT);
		...
		if ((result.equals(getZero())) && ((org.apache.commons.math3.dfp.Dfp.this.equals(getZero())) == false)) {
			field.setIEEEFlagsBits(org.apache.commons.math3.dfp.DfpField.FLAG_INEXACT);
			result = dotrap(org.apache.commons.math3.dfp.DfpField.FLAG_INEXACT, org.apache.commons.math3.dfp.Dfp.NEXT_AFTER_TRAP, x, result);
		}
		return result;
	...
	public double toDouble() {
		...
		org.apache.commons.math3.dfp.Dfp y = org.apache.commons.math3.dfp.Dfp.this;
		boolean negate = false;
		int cmp0 = org.apache.commons.math3.dfp.Dfp.compare(org.apache.commons.math3.dfp.Dfp.this, getZero());
		if (cmp0 == 0) {
