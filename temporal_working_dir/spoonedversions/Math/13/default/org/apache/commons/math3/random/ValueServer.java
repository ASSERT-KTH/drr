...
public class ValueServer {
	...
	public ValueServer(org.apache.commons.math3.random.RandomGenerator generator) {
		this.randomData = new org.apache.commons.math3.random.RandomDataImpl(generator);
	}
	...
	public void resetReplayFile() throws java.io.IOException {
		...
		filePointer = new java.io.BufferedReader(new java.io.InputStreamReader(valuesFileURL.openStream(), "UTF-8"));
	}
