...
public class LevenbergMarquardtOptimizer extends org.apache.commons.math3.optimization.general.AbstractLeastSquaresOptimizer {
	...
	protected org.apache.commons.math3.optimization.PointVectorValuePair doOptimize() {
		...
		org.apache.commons.math3.optimization.PointVectorValuePair current = new org.apache.commons.math3.optimization.PointVectorValuePair(currentPoint, currentObjective);
		...
		while (true) {
			++iter;
			final org.apache.commons.math3.optimization.PointVectorValuePair previous = current;
