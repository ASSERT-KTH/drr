...
public abstract class ListPopulation implements org.apache.commons.math3.genetics.Population {
	...
	public ListPopulation(final int populationLimit) throws org.apache.commons.math3.exception.NotPositiveException {
		this(java.util.Collections.<org.apache.commons.math3.genetics.Chromosome>emptyList(), populationLimit);
	}

	public ListPopulation(final java.util.List<org.apache.commons.math3.genetics.Chromosome> chromosomes, final int populationLimit) throws org.apache.commons.math3.exception.NotPositiveException, org.apache.commons.math3.exception.NullArgumentException, org.apache.commons.math3.exception.NumberIsTooLargeException {
		if (chromosomes == null) {
	...
	public void setChromosomes(final java.util.List<org.apache.commons.math3.genetics.Chromosome> chromosomes) throws org.apache.commons.math3.exception.NullArgumentException, org.apache.commons.math3.exception.NumberIsTooLargeException {
		if (chromosomes == null) {
			throw new org.apache.commons.math3.exception.NullArgumentException();
		}
		if ((chromosomes.size()) > (populationLimit)) {
	...
	public void addChromosomes(final java.util.Collection<org.apache.commons.math3.genetics.Chromosome> chromosomeColl) throws org.apache.commons.math3.exception.NumberIsTooLargeException {
	...
	public void addChromosome(final org.apache.commons.math3.genetics.Chromosome chromosome) throws org.apache.commons.math3.exception.NumberIsTooLargeException {
		if ((chromosomes.size()) >= (populationLimit)) {
			throw new org.apache.commons.math3.exception.NumberIsTooLargeException(org.apache.commons.math3.exception.util.LocalizedFormats.LIST_OF_CHROMOSOMES_BIGGER_THAN_POPULATION_SIZE, chromosomes.size(), populationLimit, false);
		}
	...
	public void setPopulationLimit(final int populationLimit) throws org.apache.commons.math3.exception.NotPositiveException, org.apache.commons.math3.exception.NumberIsTooSmallException {
		if (populationLimit <= 0) {
			throw new org.apache.commons.math3.exception.NotPositiveException(org.apache.commons.math3.exception.util.LocalizedFormats.POPULATION_LIMIT_NOT_POSITIVE, populationLimit);
		}
