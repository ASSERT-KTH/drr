...
public class OpenMapRealVector extends org.apache.commons.math3.linear.SparseRealVector implements java.io.Serializable {
	...
	public org.apache.commons.math3.linear.OpenMapRealVector add(org.apache.commons.math3.linear.OpenMapRealVector v) throws org.apache.commons.math3.exception.DimensionMismatchException {
		checkVectorDimensions(v.getDimension());
	...
	@java.lang.Deprecated
	public double dotProduct(org.apache.commons.math3.linear.OpenMapRealVector v) throws org.apache.commons.math3.exception.DimensionMismatchException {
		return dotProduct(((org.apache.commons.math3.linear.RealVector) (v)));
	}

	@java.lang.Override
	public org.apache.commons.math3.linear.OpenMapRealVector ebeDivide(org.apache.commons.math3.linear.RealVector v) throws org.apache.commons.math3.exception.DimensionMismatchException {
		checkVectorDimensions(v.getDimension());
	...
	@java.lang.Override
	public org.apache.commons.math3.linear.OpenMapRealVector ebeMultiply(org.apache.commons.math3.linear.RealVector v) throws org.apache.commons.math3.exception.DimensionMismatchException {
		checkVectorDimensions(v.getDimension());
		org.apache.commons.math3.linear.OpenMapRealVector res = new org.apache.commons.math3.linear.OpenMapRealVector(org.apache.commons.math3.linear.OpenMapRealVector.this);
	...
	@java.lang.Override
	public org.apache.commons.math3.linear.OpenMapRealVector getSubVector(int index, int n) throws org.apache.commons.math3.exception.NotPositiveException, org.apache.commons.math3.exception.OutOfRangeException {
		checkIndex(index);
		if (n < 0) {
	...
	public double getDistance(org.apache.commons.math3.linear.OpenMapRealVector v) throws org.apache.commons.math3.exception.DimensionMismatchException {
		checkVectorDimensions(v.getDimension());
		org.apache.commons.math3.util.OpenIntToDoubleHashMap.Iterator iter = entries.iterator();
		double res = 0;
		while (iter.hasNext()) {
	...
	public double getL1Distance(org.apache.commons.math3.linear.OpenMapRealVector v) throws org.apache.commons.math3.exception.DimensionMismatchException {
		checkVectorDimensions(v.getDimension());
		double max = 0;
		org.apache.commons.math3.util.OpenIntToDoubleHashMap.Iterator iter = entries.iterator();
		while (iter.hasNext()) {
	...
	private double getLInfDistance(org.apache.commons.math3.linear.OpenMapRealVector v) throws org.apache.commons.math3.exception.DimensionMismatchException {
		checkVectorDimensions(v.getDimension());
		double max = 0;
		org.apache.commons.math3.util.OpenIntToDoubleHashMap.Iterator iter = entries.iterator();
		while (iter.hasNext()) {
	...
	public org.apache.commons.math3.linear.OpenMapRealVector subtract(org.apache.commons.math3.linear.OpenMapRealVector v) throws org.apache.commons.math3.exception.DimensionMismatchException {
		checkVectorDimensions(v.getDimension());
