...
public class LinearObjectiveFunction implements java.io.Serializable {
	...
	public double getValue(final double[] point) {
		return (coefficients.dotProduct(new org.apache.commons.math3.linear.ArrayRealVector(point, false))) + (constantTerm);
	}

	public double getValue(final org.apache.commons.math3.linear.RealVector point) {
		return (coefficients.dotProduct(point)) + (constantTerm);
	}

	@java.lang.Override
	public boolean equals(java.lang.Object other) {
		if ((org.apache.commons.math3.optimization.linear.LinearObjectiveFunction.this) == other) {
			return true;
		}
		if (other instanceof org.apache.commons.math3.optimization.linear.LinearObjectiveFunction) {
			org.apache.commons.math3.optimization.linear.LinearObjectiveFunction rhs = ((org.apache.commons.math3.optimization.linear.LinearObjectiveFunction) (other));
	...
	private void readObject(java.io.ObjectInputStream ois) throws java.io.IOException, java.lang.ClassNotFoundException {
		...
		org.apache.commons.math3.linear.MatrixUtils.deserializeRealVector(org.apache.commons.math3.optimization.linear.LinearObjectiveFunction.this, "coefficients", ois);
	}
}
