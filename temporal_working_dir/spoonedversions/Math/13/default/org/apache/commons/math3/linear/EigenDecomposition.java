...
public class EigenDecomposition {
	...
	public EigenDecomposition(final org.apache.commons.math3.linear.RealMatrix matrix) throws org.apache.commons.math3.exception.MathArithmeticException {
		final double symTol = ((10 * (matrix.getRowDimension())) * (matrix.getColumnDimension())) * (org.apache.commons.math3.util.Precision.EPSILON);
		isSymmetric = org.apache.commons.math3.linear.MatrixUtils.isSymmetric(matrix, symTol);
		if (isSymmetric) {
	...
	public org.apache.commons.math3.linear.RealMatrix getSquareRoot() {
		...
		for (int i = 0; i < (realEigenvalues.length); i++) {
			...
			sqrtEigenValues[i] = org.apache.commons.math3.util.FastMath.sqrt(eigen);
		}
		final org.apache.commons.math3.linear.RealMatrix sqrtEigen = org.apache.commons.math3.linear.MatrixUtils.createRealDiagonalMatrix(sqrtEigenValues);
		final org.apache.commons.math3.linear.RealMatrix v = getV();
		final org.apache.commons.math3.linear.RealMatrix vT = getVT();
