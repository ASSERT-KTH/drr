...
public class BOBYQAOptimizer extends org.apache.commons.math3.optim.nonlinear.scalar.MultivariateOptimizer {
	...
	private static final double MINUS_ONE = -(org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ONE);

	private static final double HALF = (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ONE) / 2;

	private static final double ONE_OVER_FOUR = (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ONE) / 4;

	private static final double ONE_OVER_EIGHT = (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ONE) / 8;

	private static final double ONE_OVER_TEN = (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ONE) / 10;

	private static final double ONE_OVER_A_THOUSAND = (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ONE) / 1000;
	...
	public BOBYQAOptimizer(int numberOfInterpolationPoints) {
		this(numberOfInterpolationPoints, org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.DEFAULT_INITIAL_RADIUS, org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.DEFAULT_STOPPING_RADIUS);
	}
	...
	public BOBYQAOptimizer(int numberOfInterpolationPoints, double initialTrustRegionRadius, double stoppingTrustRegionRadius) {
		...
		org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.this.initialTrustRegionRadius = initialTrustRegionRadius;
	...
	protected org.apache.commons.math3.optim.PointValuePair doOptimize() {
		...
		return new org.apache.commons.math3.optim.PointValuePair(currentBest.getDataRef(), (isMinimize ? value : -value));
	}
	...
	private double bobyqa(double[] lowerBound, double[] upperBound) {
		...
		for (int j = 0; j < n; j++) {
			...
			if ((lowerDifference.getEntry(j)) >= (-(initialTrustRegionRadius))) {
				if ((lowerDifference.getEntry(j)) >= (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO)) {
					currentBest.setEntry(j, lowerBound[j]);
					lowerDifference.setEntry(j, org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO);
				...
				if ((upperDifference.getEntry(j)) <= (initialTrustRegionRadius)) {
					if ((upperDifference.getEntry(j)) <= (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO)) {
						currentBest.setEntry(j, upperBound[j]);
						lowerDifference.setEntry(j, (-boundDiff));
						upperDifference.setEntry(j, org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO);
					}else {
	...
	private double bobyqb(double[] lowerBound, double[] upperBound) {
		...
		double xoptsq = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
		for (int i = 0; i < n; i++) {
		...
		double delta = rho;
		double diffa = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
		double diffb = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
		double diffc = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
		double f = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
		double beta = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
		double adelt = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
		double denom = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
		double ratio = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
		double dnorm = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
		double scaden = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
		double biglsq = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
		double distsq = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
		int state = 20;
		for (; ;)
			switch (state) {
				case 20 :
					{
						org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.printState(20);
						if ((trustRegionCenterInterpolationPointIndex) != kbase) {
							...
							if ((getEvaluations()) > npt) {
								for (int k = 0; k < npt; k++) {
									double temp = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
									for (int j = 0; j < n; j++) {
				...
				case 60 :
					{
						org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.printState(60);
						...
						if (dnorm < ((org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.HALF) * rho)) {
							ntrits = -1;
							deltaOne = (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.TEN) * rho;
							...
							final double frhosq = (rho * (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ONE_OVER_EIGHT)) * rho;
							if ((crvmin > (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO)) && (errbig > (frhosq * crvmin))) {
								state = 650;
								break;
							}
							...
							for (int j = 0; j < n; j++) {
								...
								if (bdtest < bdtol) {
									...
									bdtest += ((org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.HALF) * curv) * rho;
									if (bdtest < bdtol) {
										state = 650;
										break;
									}
				...
				case 90 :
					{
						org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.printState(90);
						if (dsq <= (xoptsq * (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ONE_OVER_A_THOUSAND))) {
							final double fracsq = xoptsq * (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ONE_OVER_FOUR);
							double sumpq = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
							for (int k = 0; k < npt; k++) {
								sumpq += modelSecondDerivativesParameters.getEntry(k);
								double sum = (-(org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.HALF)) * xoptsq;
								for (int i = 0; i < n; i++) {
									sum += (interpolationPoints.getEntry(k, i)) * (trustRegionCenterOffset.getEntry(i));
								}
								work2.setEntry(k, sum);
								final double temp = fracsq - ((org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.HALF) * sum);
								for (int i = 0; i < n; i++) {
							...
							for (int m = 0; m < nptm; m++) {
								double sumz = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
								double sumw = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
								for (int k = 0; k < npt; k++) {
								...
								for (int j = 0; j < n; j++) {
									double sum = ((fracsq * sumz) - ((org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.HALF) * sumw)) * (trustRegionCenterOffset.getEntry(j));
									for (int k = 0; k < npt; k++) {
							...
							int ih = 0;
							for (int j = 0; j < n; j++) {
								work1.setEntry(j, (((-(org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.HALF)) * sumpq) * (trustRegionCenterOffset.getEntry(j))));
								for (int k = 0; k < npt; k++) {
							...
							for (int i = 0; i < n; i++) {
								...
								trustRegionCenterOffset.setEntry(i, org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO);
							}
							xoptsq = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
						}
						if (ntrits == 0) {
							state = 210;
							break;
				...
				case 210 :
					{
						org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.printState(210);
				...
				case 230 :
					{
						org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.printState(230);
						for (int k = 0; k < npt; k++) {
							double suma = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
							double sumb = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
							double sum = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
							for (int j = 0; j < n; j++) {
							...
							work3.setEntry(k, (suma * (((org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.HALF) * suma) + sumb)));
							lagrangeValuesAtNewPoint.setEntry(k, sum);
							work2.setEntry(k, suma);
						}
						beta = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
						for (int m = 0; m < nptm; m++) {
							double sum = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
							for (int k = 0; k < npt; k++) {
						...
						dsq = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
						double bsum = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
						double dx = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
						for (int j = 0; j < n; j++) {
						...
						beta = (((dx * dx) + (dsq * (((xoptsq + dx) + dx) + ((org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.HALF) * dsq)))) + beta) - bsum;
						lagrangeValuesAtNewPoint.setEntry(trustRegionCenterInterpolationPointIndex, ((lagrangeValuesAtNewPoint.getEntry(trustRegionCenterInterpolationPointIndex)) + (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ONE)));
						if (ntrits == 0) {
							final double d1 = lagrangeValuesAtNewPoint.getEntry(knew);
							denom = (d1 * d1) + (alpha * beta);
							if ((denom < cauchy) && (cauchy > (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO))) {
								for (int i = 0; i < n; i++) {
									newPoint.setEntry(i, alternativeNewPoint.getEntry(i));
									trialStepPoint.setEntry(i, ((newPoint.getEntry(i)) - (trustRegionCenterOffset.getEntry(i))));
								}
								cauchy = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
								state = 230;
								break;
							}
						}else {
							final double delsq = delta * delta;
							scaden = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
							biglsq = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
							knew = 0;
							for (int k = 0; k < npt; k++) {
								if (k == (trustRegionCenterInterpolationPointIndex)) {
									continue;
								}
								double hdiag = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
								for (int m = 0; m < nptm; m++) {
								...
								distsq = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
								for (int j = 0; j < n; j++) {
									final double d3 = (interpolationPoints.getEntry(k, j)) - (trustRegionCenterOffset.getEntry(j));
									distsq += d3 * d3;
								}
								final double d4 = distsq / delsq;
								final double temp = java.lang.Math.max(org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ONE, (d4 * d4));
								if ((temp * den) > scaden) {
									scaden = temp * den;
									knew = k;
									denom = den;
				...
				case 360 :
					{
						org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.printState(360);
						for (int i = 0; i < n; i++) {
						...
						double vquad = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
						int ih = 0;
						for (int j = 0; j < n; j++) {
							...
							for (int i = 0; i <= j; i++) {
								...
								if (i == j) {
									temp *= org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.HALF;
								}
						...
						for (int k = 0; k < npt; k++) {
							...
							vquad += ((org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.HALF) * (modelSecondDerivativesParameters.getEntry(k))) * d2;
						}
						...
						if (ntrits > 0) {
							if (vquad >= (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO)) {
							...
							ratio = (f - fopt) / vquad;
							final double hDelta = (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.HALF) * delta;
							if (ratio <= (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ONE_OVER_TEN)) {
							...
							if (f < fopt) {
								...
								for (int k = 0; k < npt; k++) {
									...
									final double temp = java.lang.Math.max(org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ONE, (d3 * d3));
									if ((temp * den) > scaden) {
										scaden = temp * den;
										knew = k;
										denom = den;
								...
								if (scaden <= ((org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.HALF) * biglsq)) {
									knew = ksav;
									denom = densav;
								}
							}
						...
						modelSecondDerivativesParameters.setEntry(knew, org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO);
						for (int i = 0; i < n; i++) {
						...
						if (ntrits > 0) {
							for (int k = 0; k < npt; k++) {
								...
								work3.setEntry(k, org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO);
							}
							...
							double gqsq = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
							double gisq = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
							for (int i = 0; i < n; i++) {
								double sum = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
								for (int k = 0; k < npt; k++) {
								...
								if ((trustRegionCenterOffset.getEntry(i)) == (lowerDifference.getEntry(i))) {
									final double d1 = java.lang.Math.min(org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO, gradientAtTrustRegionCenter.getEntry(i));
									gqsq += d1 * d1;
									final double d2 = java.lang.Math.min(org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO, sum);
									gisq += d2 * d2;
								}else
									if ((trustRegionCenterOffset.getEntry(i)) == (upperDifference.getEntry(i))) {
										final double d1 = java.lang.Math.max(org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO, gradientAtTrustRegionCenter.getEntry(i));
										gqsq += d1 * d1;
										final double d2 = java.lang.Math.max(org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO, sum);
										gisq += d2 * d2;
									}else {
							...
							++itest;
							if (gqsq < ((org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.TEN) * gisq)) {
								itest = 0;
							}
							if (itest >= 3) {
								for (int i = 0, max = java.lang.Math.max(npt, nh); i < max; i++) {
									...
									if (i < nh) {
										modelSecondDerivativesValues.setEntry(i, org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO);
									}
									itest = 0;
								}
							}
						...
						if (f <= (fopt + ((org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ONE_OVER_TEN) * vquad))) {
							state = 60;
							break;
						}
						final double d1 = (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.TWO) * delta;
						final double d2 = (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.TEN) * rho;
						distsq = java.lang.Math.max((d1 * d1), (d2 * d2));
					}
				case 650 :
					{
						org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.printState(650);
						knew = -1;
						for (int k = 0; k < npt; k++) {
							double sum = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
							for (int j = 0; j < n; j++) {
						...
						if (knew >= 0) {
							...
							if (ntrits == (-1)) {
								delta = java.lang.Math.min(((org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ONE_OVER_TEN) * delta), ((org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.HALF) * dist));
								if (delta <= (rho * 1.5)) {
									delta = rho;
								}
							}
							ntrits = 0;
							final double d1 = java.lang.Math.min(((org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ONE_OVER_TEN) * dist), delta);
						...
						if (ratio > (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO)) {
							state = 60;
							break;
						}
				...
				case 680 :
					{
						org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.printState(680);
						if (rho > (stoppingTrustRegionRadius)) {
							delta = (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.HALF) * rho;
							ratio = rho / (stoppingTrustRegionRadius);
							if (ratio <= (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.SIXTEEN)) {
								rho = stoppingTrustRegionRadius;
							}else
								if (ratio <= (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.TWO_HUNDRED_FIFTY)) {
									rho = (java.lang.Math.sqrt(ratio)) * (stoppingTrustRegionRadius);
								}else {
									rho *= org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ONE_OVER_TEN;
								}
				...
				case 720 :
					{
						org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.printState(720);
	...
	private double[] altmov(int knew, double adelt) {
		...
		for (int k = 0; k < npt; k++) {
			hcol.setEntry(k, org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO);
		}
		...
		final double ha = (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.HALF) * alpha;
		for (int i = 0; i < n; i++) {
			glag.setEntry(i, bMatrix.getEntry(knew, i));
		}
		for (int k = 0; k < npt; k++) {
			double tmp = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
			for (int j = 0; j < n; j++) {
		...
		double presav = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
		...
		for (int k = 0; k < npt; k++) {
			...
			double dderiv = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
			double distsq = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
			for (int i = 0; i < n; i++) {
			...
			int ilbd = 0;
			int iubd = 0;
			final double sumin = java.lang.Math.min(org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ONE, subd);
			for (int i = 0; i < n; i++) {
				final double tmp = (interpolationPoints.getEntry(k, i)) - (trustRegionCenterOffset.getEntry(i));
				if (tmp > (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO)) {
			...
			if (k == knew) {
				final double diff = dderiv - (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ONE);
				...
				final double d2 = (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.HALF) * dderiv;
				final double d3 = d2 - (diff * slbd);
				final double d4 = d2 - (diff * subd);
				if ((d3 * d4) < (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO)) {
				...
				vlag = slbd * ((org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ONE) - slbd);
				final double tmp = subd * ((org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ONE) - subd);
				if ((java.lang.Math.abs(tmp)) > (java.lang.Math.abs(vlag))) {
					step = subd;
					vlag = tmp;
					isbd = iubd;
				}
				if (subd > (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.HALF)) {
					if ((java.lang.Math.abs(vlag)) < (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ONE_OVER_FOUR)) {
						step = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.HALF;
						vlag = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ONE_OVER_FOUR;
						isbd = 0;
					}
				}
				vlag *= dderiv;
			}
			final double tmp = (step * ((org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ONE) - step)) * distsq;
		...
		int iflag = 0;
		double cauchy = java.lang.Double.NaN;
		double csave = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
		while (true) {
			double wfixsq = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
			double ggfree = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
			for (int i = 0; i < n; i++) {
				final double glagValue = glag.getEntry(i);
				work1.setEntry(i, org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO);
				if (((java.lang.Math.min(((trustRegionCenterOffset.getEntry(i)) - (lowerDifference.getEntry(i))), glagValue)) > (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO)) || ((java.lang.Math.max(((trustRegionCenterOffset.getEntry(i)) - (upperDifference.getEntry(i))), glagValue)) < (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO))) {
					work1.setEntry(i, bigstp);
					ggfree += glagValue * glagValue;
				}
			}
			if (ggfree == (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO)) {
				return new double[]{ alpha , org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO };
			}
			final double tmp1 = (adelt * adelt) - wfixsq;
			if (tmp1 > (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO)) {
				step = java.lang.Math.sqrt((tmp1 / ggfree));
				ggfree = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
				for (int i = 0; i < n; i++) {
			...
			double gw = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
			for (int i = 0; i < n; i++) {
				final double glagValue = glag.getEntry(i);
				if ((work1.getEntry(i)) == bigstp) {
					...
					if ((work1.getEntry(i)) == (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO)) {
						alternativeNewPoint.setEntry(i, trustRegionCenterOffset.getEntry(i));
					}else
						if (glagValue > (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO)) {
			...
			double curv = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
			for (int k = 0; k < npt; k++) {
				double tmp = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
				for (int j = 0; j < n; j++) {
			...
			if ((curv > (-gw)) && (curv < ((-gw) * ((org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ONE) + (java.lang.Math.sqrt(org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.TWO)))))) {
				...
				final double d1 = ((org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.HALF) * gw) * scale;
				cauchy = d1 * d1;
			}else {
				final double d1 = gw + ((org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.HALF) * curv);
				cauchy = d1 * d1;
			}
			if (iflag == 0) {
				for (int i = 0; i < n; i++) {
	...
	private void prelim(double[] lowerBound, double[] upperBound) {
		...
		for (int j = 0; j < n; j++) {
			...
			for (int k = 0; k < npt; k++) {
				interpolationPoints.setEntry(k, j, org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO);
			}
			for (int i = 0; i < ndim; i++) {
				bMatrix.setEntry(i, j, org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO);
			}
		}
		...
		for (int k = 0; k < npt; k++) {
			modelSecondDerivativesParameters.setEntry(k, org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO);
			for (int j = 0, max = npt - np; j < max; j++) {
				zMatrix.setEntry(k, j, org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO);
			}
		}
		int ipt = 0;
		int jpt = 0;
		...
		do {
			...
			if (nfm <= (2 * n)) {
				if ((nfm >= 1) && (nfm <= n)) {
					...
					if ((upperDifference.getEntry(nfmm)) == (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO)) {
						stepa = -stepa;
					}
					...
					if (nfm > n) {
						...
						if ((lowerDifference.getEntry(nfxm)) == (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO)) {
							stepb = java.lang.Math.min(((org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.TWO) * (initialTrustRegionRadius)), upperDifference.getEntry(nfxm));
						}
						if ((upperDifference.getEntry(nfxm)) == (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO)) {
							stepb = java.lang.Math.max(((-(org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.TWO)) * (initialTrustRegionRadius)), lowerDifference.getEntry(nfxm));
						}
			...
			if (numEval <= ((2 * n) + 1)) {
				if ((numEval >= 2) && (numEval <= (n + 1))) {
					...
					if (npt < (numEval + n)) {
						final double oneOverStepA = (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ONE) / stepa;
						bMatrix.setEntry(0, nfmm, (-oneOverStepA));
						bMatrix.setEntry(nfm, nfmm, oneOverStepA);
						bMatrix.setEntry((npt + nfmm), nfmm, ((-(org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.HALF)) * rhosq));
					}
				}else
					if (numEval >= (n + 2)) {
						...
						modelSecondDerivativesValues.setEntry(ih, (((org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.TWO) * (tmp - (gradientAtTrustRegionCenter.getEntry(nfxm)))) / diff));
						gradientAtTrustRegionCenter.setEntry(nfxm, ((((gradientAtTrustRegionCenter.getEntry(nfxm)) * stepb) - (tmp * stepa)) / diff));
						if ((stepa * stepb) < (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO)) {
						...
						bMatrix.setEntry(nfm, nfxm, ((-(org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.HALF)) / (interpolationPoints.getEntry((nfm - n), nfxm))));
						bMatrix.setEntry((nfm - n), nfxm, ((-(bMatrix.getEntry(0, nfxm))) - (bMatrix.getEntry(nfm, nfxm))));
						zMatrix.setEntry(0, nfxm, ((java.lang.Math.sqrt(org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.TWO)) / (stepa * stepb)));
						zMatrix.setEntry(nfm, nfxm, ((java.lang.Math.sqrt(org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.HALF)) / rhosq));
	...
	private double[] trsbox(double delta, org.apache.commons.math3.linear.ArrayRealVector gnew, org.apache.commons.math3.linear.ArrayRealVector xbdi, org.apache.commons.math3.linear.ArrayRealVector s, org.apache.commons.math3.linear.ArrayRealVector hs, org.apache.commons.math3.linear.ArrayRealVector hred) {
		...
		nact = 0;
		for (int i = 0; i < n; i++) {
			xbdi.setEntry(i, org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO);
			if ((trustRegionCenterOffset.getEntry(i)) <= (lowerDifference.getEntry(i))) {
				if ((gradientAtTrustRegionCenter.getEntry(i)) >= (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO)) {
					xbdi.setEntry(i, org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.MINUS_ONE);
				}
			}else
				if ((trustRegionCenterOffset.getEntry(i)) >= (upperDifference.getEntry(i))) {
					if ((gradientAtTrustRegionCenter.getEntry(i)) <= (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO)) {
						xbdi.setEntry(i, org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ONE);
					}
				}
			
			if ((xbdi.getEntry(i)) != (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO)) {
				++nact;
			}
			trialStepPoint.setEntry(i, org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO);
			gnew.setEntry(i, gradientAtTrustRegionCenter.getEntry(i));
		}
		delsq = delta * delta;
		qred = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
		crvmin = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.MINUS_ONE;
		int state = 20;
		for (; ;) {
			switch (state) {
				case 20 :
				...
				case 30 :
					{
						org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.printState(30);
						stepsq = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
						for (int i = 0; i < n; i++) {
							if ((xbdi.getEntry(i)) != (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO)) {
								s.setEntry(i, org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO);
							}else
								if (beta == (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO)) {
						...
						if (stepsq == (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO)) {
							state = 190;
							break;
						}
						if (beta == (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO)) {
				...
				case 50 :
					{
						org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.printState(50);
						resid = delsq;
						ds = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
						shs = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
						for (int i = 0; i < n; i++) {
							if ((xbdi.getEntry(i)) == (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO)) {
						...
						if (resid <= (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO)) {
							state = 90;
							break;
						}
						temp = java.lang.Math.sqrt(((stepsq * resid) + (ds * ds)));
						if (ds < (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO)) {
							blen = (temp - ds) / stepsq;
						}else {
							blen = resid / (temp + ds);
						}
						stplen = blen;
						if (shs > (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO)) {
							stplen = java.lang.Math.min(blen, (gredsq / shs));
						}
						iact = -1;
						for (int i = 0; i < n; i++) {
							if ((s.getEntry(i)) != (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO)) {
						...
						sdec = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
						if (stplen > (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO)) {
							++iterc;
							temp = shs / stepsq;
							if ((iact == (-1)) && (temp > (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO))) {
								crvmin = java.lang.Math.min(crvmin, temp);
								if (crvmin == (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.MINUS_ONE)) {
									crvmin = temp;
								}
							}
							ggsav = gredsq;
							gredsq = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
							for (int i = 0; i < n; i++) {
							...
							final double d1 = stplen * (ggsav - (((org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.HALF) * stplen) * shs));
							sdec = java.lang.Math.max(d1, org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO);
							qred += sdec;
						}
						if (iact >= 0) {
							++nact;
							xbdi.setEntry(iact, org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ONE);
							if ((s.getEntry(iact)) < (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO)) {
								xbdi.setEntry(iact, org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.MINUS_ONE);
							}
							final double d1 = trialStepPoint.getEntry(iact);
							delsq -= d1 * d1;
							if (delsq <= (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO)) {
								state = 190;
								break;
							}
							state = 20;
				...
				case 90 :
					{
						org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.printState(90);
						crvmin = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
					}
				case 100 :
					{
						org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.printState(100);
						if (nact >= (n - 1)) {
							state = 190;
							break;
						}
						dredsq = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
						dredg = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
						gredsq = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
						for (int i = 0; i < n; i++) {
							if ((xbdi.getEntry(i)) == (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO)) {
				...
				case 120 :
					{
						org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.printState(120);
						++iterc;
						...
						sredg = -temp;
						angbd = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ONE;
						iact = -1;
						for (int i = 0; i < n; i++) {
							if ((xbdi.getEntry(i)) == (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO)) {
								...
								if (tempa <= (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO)) {
									++nact;
									xbdi.setEntry(i, org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.MINUS_ONE);
									state = 100;
									break;
								}else
									if (tempb <= (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO)) {
										++nact;
										xbdi.setEntry(i, org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ONE);
										state = 100;
										break;
								...
								temp = ssq - (d1 * d1);
								if (temp > (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO)) {
									temp = (java.lang.Math.sqrt(temp)) - (s.getEntry(i));
									if ((angbd * temp) > tempa) {
										angbd = tempa / temp;
										iact = i;
										xsav = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.MINUS_ONE;
									}
								}
								...
								if (temp > (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO)) {
									...
									if ((angbd * temp) > tempb) {
										angbd = tempb / temp;
										iact = i;
										xsav = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ONE;
									}
								}
							}
						}
				...
				case 150 :
					{
						org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.printState(150);
						shs = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
						dhs = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
						dhd = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
						for (int i = 0; i < n; i++) {
							if ((xbdi.getEntry(i)) == (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO)) {
								shs += (s.getEntry(i)) * (hs.getEntry(i));
						...
						redmax = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
						isav = -1;
						redsav = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
						iu = ((int) ((angbd * 17.0) + 3.1));
						for (int i = 0; i < iu; i++) {
							angt = (angbd * i) / iu;
							sth = (angt + angt) / ((org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ONE) + (angt * angt));
							temp = shs + (angt * (((angt * dhd) - dhs) - dhs));
							rednew = sth * (((angt * dredg) - sredg) - (((org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.HALF) * sth) * temp));
							if (rednew > redmax) {
								redmax = rednew;
								isav = i;
								rdprev = redsav;
						...
						if (isav < iu) {
							...
							angt = (angbd * (isav + ((org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.HALF) * temp))) / iu;
						}
						cth = ((org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ONE) - (angt * angt)) / ((org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ONE) + (angt * angt));
						sth = (angt + angt) / ((org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ONE) + (angt * angt));
						temp = shs + (angt * (((angt * dhd) - dhs) - dhs));
						sdec = sth * (((angt * dredg) - sredg) - (((org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.HALF) * sth) * temp));
						if (sdec <= (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO)) {
							state = 190;
							break;
						}
						dredg = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
						gredsq = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
						for (int i = 0; i < n; i++) {
							gnew.setEntry(i, (((gnew.getEntry(i)) + ((cth - (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ONE)) * (hred.getEntry(i)))) + (sth * (hs.getEntry(i)))));
							if ((xbdi.getEntry(i)) == (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO)) {
				...
				case 190 :
					{
						org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.printState(190);
						dsq = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
						for (int i = 0; i < n; i++) {
							...
							if ((xbdi.getEntry(i)) == (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.MINUS_ONE)) {
								newPoint.setEntry(i, lowerDifference.getEntry(i));
							}
							if ((xbdi.getEntry(i)) == (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ONE)) {
				...
				case 210 :
					{
						...
						int ih = 0;
						for (int j = 0; j < n; j++) {
							hs.setEntry(j, org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO);
							for (int i = 0; i <= j; i++) {
								if (i < j) {
						...
						for (int k = 0; k < npt; k++) {
							if ((modelSecondDerivativesParameters.getEntry(k)) != (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO)) {
								for (int i = 0; i < n; i++) {
									hs.setEntry(i, ((hs.getEntry(i)) + ((tmp.getEntry(k)) * (interpolationPoints.getEntry(k, i)))));
								}
							}
						}
						if (crvmin != (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO)) {
							state = 50;
							break;
						}
						if (iterc > itcsav) {
	...
	private void update(double beta, double denom, int knew) {
		...
		double ztest = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO;
		for (int k = 0; k < npt; k++) {
			for (int j = 0; j < nptm; j++) {
		...
		for (int j = 1; j < nptm; j++) {
			...
			zMatrix.setEntry(knew, j, org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ZERO);
		}
		for (int i = 0; i < npt; i++) {
		...
		lagrangeValuesAtNewPoint.setEntry(knew, ((lagrangeValuesAtNewPoint.getEntry(knew)) - (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.ONE)));
	...
	private void setup(double[] lowerBound, double[] upperBound) {
		...
		if (dimension < (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.MINIMUM_PROBLEM_DIMENSION)) {
			throw new org.apache.commons.math3.exception.NumberIsTooSmallException(dimension, org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.MINIMUM_PROBLEM_DIMENSION, true);
		}
	...
	private static class PathIsExploredException extends java.lang.RuntimeException {
		...
		PathIsExploredException() {
			super((((org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.PathIsExploredException.PATH_IS_EXPLORED) + " ") + (org.apache.commons.math3.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer.caller(3))));
		}
	}
}
