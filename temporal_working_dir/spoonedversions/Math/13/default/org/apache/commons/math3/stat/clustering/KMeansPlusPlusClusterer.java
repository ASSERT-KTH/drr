...
LARGEST_VARIANCE, LARGEST_POINTS_NUMBER, FARTHEST_POINT, ERROR;	}
	...
	public java.util.List<org.apache.commons.math3.stat.clustering.Cluster<T>> cluster(final java.util.Collection<T> points, final int k, int numTrials, int maxIterationsPerTrial) throws org.apache.commons.math3.exception.ConvergenceException, org.apache.commons.math3.exception.MathIllegalArgumentException {
	...
	public java.util.List<org.apache.commons.math3.stat.clustering.Cluster<T>> cluster(final java.util.Collection<T> points, final int k, final int maxIterations) throws org.apache.commons.math3.exception.ConvergenceException, org.apache.commons.math3.exception.MathIllegalArgumentException {
	...
	private T getPointFromLargestVarianceCluster(final java.util.Collection<org.apache.commons.math3.stat.clustering.Cluster<T>> clusters) throws org.apache.commons.math3.exception.ConvergenceException {
	...
	private T getPointFromLargestNumberCluster(final java.util.Collection<org.apache.commons.math3.stat.clustering.Cluster<T>> clusters) throws org.apache.commons.math3.exception.ConvergenceException {
		int maxNumber = 0;
		org.apache.commons.math3.stat.clustering.Cluster<T> selected = null;
		for (final org.apache.commons.math3.stat.clustering.Cluster<T> cluster : clusters) {
	...
	private T getFarthestPoint(final java.util.Collection<org.apache.commons.math3.stat.clustering.Cluster<T>> clusters) throws org.apache.commons.math3.exception.ConvergenceException {
