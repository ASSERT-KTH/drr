...
public class SimplePointChecker<PAIR extends org.apache.commons.math3.util.Pair<double[], ? extends java.lang.Object>> extends org.apache.commons.math3.optim.AbstractConvergenceChecker<PAIR> {
	...
	public SimplePointChecker(final double relativeThreshold, final double absoluteThreshold) {
		...
		maxIterationCount = org.apache.commons.math3.optim.SimplePointChecker.ITERATION_CHECK_DISABLED;
	}
	...
	public boolean converged(final int iteration, final PAIR previous, final PAIR current) {
		if ((maxIterationCount) != (org.apache.commons.math3.optim.SimplePointChecker.ITERATION_CHECK_DISABLED)) {
