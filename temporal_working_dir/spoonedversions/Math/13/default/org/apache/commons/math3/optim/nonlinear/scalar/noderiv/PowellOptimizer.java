...
public class PowellOptimizer extends org.apache.commons.math3.optim.nonlinear.scalar.MultivariateOptimizer {
	...
	private class LineSearch extends org.apache.commons.math3.optim.univariate.BrentOptimizer {
		...
		LineSearch(double rel, double abs) {
			super(org.apache.commons.math3.optim.nonlinear.scalar.noderiv.PowellOptimizer.LineSearch.REL_TOL_UNUSED, org.apache.commons.math3.optim.nonlinear.scalar.noderiv.PowellOptimizer.LineSearch.ABS_TOL_UNUSED, new org.apache.commons.math3.optim.univariate.SimpleUnivariateValueChecker(rel, abs));
		}
		...
		public org.apache.commons.math3.optim.univariate.UnivariatePointValuePair search(final double[] p, final double[] d) {
			...
			final org.apache.commons.math3.analysis.UnivariateFunction f = new org.apache.commons.math3.analysis.UnivariateFunction() {
				public double value(double alpha) {
					...
					final double obj = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.PowellOptimizer.this.computeObjectiveValue(x);
					return obj;
				}
			};
			final org.apache.commons.math3.optim.nonlinear.scalar.GoalType goal = org.apache.commons.math3.optim.nonlinear.scalar.noderiv.PowellOptimizer.this.getGoalType();
			bracket.search(f, goal, 0, 1);
			return optimize(new org.apache.commons.math3.optim.MaxEval(java.lang.Integer.MAX_VALUE), new org.apache.commons.math3.optim.univariate.UnivariateObjectiveFunction(f), goal, new org.apache.commons.math3.optim.univariate.SearchInterval(bracket.getLo(), bracket.getHi(), bracket.getMid()));
		}
	}
}
