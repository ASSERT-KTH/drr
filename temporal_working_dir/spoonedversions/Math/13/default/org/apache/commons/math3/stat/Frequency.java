...
public class Frequency implements java.io.Serializable {
	...
	public void incrementValue(java.lang.Comparable<?> v, long increment) {
	...
	public void merge(org.apache.commons.math3.stat.Frequency other) {
		for (java.util.Iterator<java.util.Map.Entry<java.lang.Comparable<?>, java.lang.Long>> iter = other.entrySetIterator(); iter.hasNext();) {
			java.util.Map.Entry<java.lang.Comparable<?>, java.lang.Long> entry = iter.next();
			incrementValue(entry.getKey(), entry.getValue());
		}
	}

	public void merge(java.util.Collection<org.apache.commons.math3.stat.Frequency> others) {
		for (java.util.Iterator<org.apache.commons.math3.stat.Frequency> iter = others.iterator(); iter.hasNext();) {
			merge(iter.next());
		}
	}
