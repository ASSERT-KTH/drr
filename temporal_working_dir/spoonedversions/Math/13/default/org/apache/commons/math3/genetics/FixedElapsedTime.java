...
public class FixedElapsedTime implements org.apache.commons.math3.genetics.StoppingCondition {
	...
	public FixedElapsedTime(final long maxTime) throws org.apache.commons.math3.exception.NumberIsTooSmallException {
		this(maxTime, java.util.concurrent.TimeUnit.SECONDS);
	}

	public FixedElapsedTime(final long maxTime, final java.util.concurrent.TimeUnit unit) throws org.apache.commons.math3.exception.NumberIsTooSmallException {
		if (maxTime < 0) {
