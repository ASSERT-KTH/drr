...
public class StableRandomGenerator implements org.apache.commons.math3.random.NormalizedRandomGenerator {
	...
	public StableRandomGenerator(final org.apache.commons.math3.random.RandomGenerator generator, final double alpha, final double beta) throws org.apache.commons.math3.exception.NullArgumentException, org.apache.commons.math3.exception.OutOfRangeException {
		if (generator == null) {
