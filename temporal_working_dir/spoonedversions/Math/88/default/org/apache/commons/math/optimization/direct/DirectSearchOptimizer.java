...
public abstract class DirectSearchOptimizer implements java.io.Serializable , org.apache.commons.math.optimization.MultivariateRealOptimizer {
	...
	public void setStartConfiguration(final double[] steps) throws java.lang.IllegalArgumentException {
		...
		for (int i = 0; i < n; ++i) {
			...
			for (int j = 0; j < (i + 1); ++j) {
				if ((steps[j]) == 0.0) {
					throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException("equals vertices {0} and {1} in simplex configuration", j, (j + 1));
				}
	...
	public void setStartConfiguration(final double[][] referenceSimplex) throws java.lang.IllegalArgumentException {
		...
		for (int i = 0; i < (n + 1); ++i) {
			...
			if ((refI.length) != n) {
				throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException("dimension mismatch {0} != {1}", refI.length, n);
			}
			for (int j = 0; j < i; ++j) {
				...
				if (allEquals) {
					throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException("equals vertices {0} and {1} in simplex configuration", i, j);
				}
			}
			if (i > 0) {
	...
	public void setMaxIterations(int maxIterations) {
		org.apache.commons.math.optimization.direct.DirectSearchOptimizer.this.maxIterations = maxIterations;
	}
	...
	public void setMaxEvaluations(int maxEvaluations) {
		org.apache.commons.math.optimization.direct.DirectSearchOptimizer.this.maxEvaluations = maxEvaluations;
	}
	...
	public void setConvergenceChecker(org.apache.commons.math.optimization.RealConvergenceChecker checker) {
		org.apache.commons.math.optimization.direct.DirectSearchOptimizer.this.checker = checker;
	}
	...
	public org.apache.commons.math.optimization.RealPointValuePair optimize(final org.apache.commons.math.analysis.MultivariateRealFunction f, final org.apache.commons.math.optimization.GoalType goalType, final double[] startPoint) throws java.lang.IllegalArgumentException, org.apache.commons.math.FunctionEvaluationException, org.apache.commons.math.optimization.OptimizationException {
		if ((startConfiguration) == null) {
			final double[] unit = new double[startPoint.length];
			java.util.Arrays.fill(unit, 1.0);
			setStartConfiguration(unit);
		}
		org.apache.commons.math.optimization.direct.DirectSearchOptimizer.this.f = f;
	...
	protected double evaluate(final double[] x) throws java.lang.IllegalArgumentException, org.apache.commons.math.FunctionEvaluationException, org.apache.commons.math.optimization.OptimizationException {
		if ((++(evaluations)) > (maxEvaluations)) {
			throw new org.apache.commons.math.optimization.OptimizationException(new org.apache.commons.math.MaxEvaluationsExceededException(maxEvaluations));
		}
		return f.value(x);
	}
	...
	private void buildSimplex(final double[] startPoint) throws java.lang.IllegalArgumentException {
		...
		if (n != (startConfiguration.length)) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException("dimension mismatch {0} != {1}", n, simplex.length);
		}
