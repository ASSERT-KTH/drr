...
public class SparseFieldVector<T extends org.apache.commons.math.FieldElement<T>> implements java.io.Serializable , org.apache.commons.math.linear.FieldVector<T> {
	...
	public org.apache.commons.math.linear.FieldVector<T> add(org.apache.commons.math.linear.SparseFieldVector<T> v) {
	...
	public org.apache.commons.math.linear.FieldVector<T> append(org.apache.commons.math.linear.SparseFieldVector<T> v) {
		org.apache.commons.math.linear.SparseFieldVector<T> res = new org.apache.commons.math.linear.SparseFieldVector<T>(org.apache.commons.math.linear.SparseFieldVector.this, v.getDimension());
	...
	public org.apache.commons.math.linear.FieldVector<T> append(T d) {
		org.apache.commons.math.linear.FieldVector<T> res = new org.apache.commons.math.linear.SparseFieldVector<T>(org.apache.commons.math.linear.SparseFieldVector.this, 1);
		res.setEntry(virtualSize, d);
		return res;
	}

	public org.apache.commons.math.linear.FieldVector<T> append(T[] a) {
		org.apache.commons.math.linear.FieldVector<T> res = new org.apache.commons.math.linear.SparseFieldVector<T>(org.apache.commons.math.linear.SparseFieldVector.this, a.length);
	...
	public org.apache.commons.math.linear.FieldVector<T> copy() {
		return new org.apache.commons.math.linear.SparseFieldVector<T>(org.apache.commons.math.linear.SparseFieldVector.this);
	}
	...
	public org.apache.commons.math.linear.FieldVector<T> ebeDivide(org.apache.commons.math.linear.FieldVector<T> v) {
		checkVectorDimensions(v.getDimension());
		org.apache.commons.math.linear.SparseFieldVector<T> res = new org.apache.commons.math.linear.SparseFieldVector<T>(org.apache.commons.math.linear.SparseFieldVector.this);
	...
	public org.apache.commons.math.linear.FieldVector<T> mapAddToSelf(T d) {
		...
		return org.apache.commons.math.linear.SparseFieldVector.this;
	}
	...
	public org.apache.commons.math.linear.FieldMatrix<T> outerProduct(org.apache.commons.math.linear.SparseFieldVector<T> v) {
		final int n = v.getDimension();
		org.apache.commons.math.linear.SparseFieldMatrix<T> res = new org.apache.commons.math.linear.SparseFieldMatrix<T>(field, virtualSize, n);
		org.apache.commons.math.util.OpenIntToFieldHashMap<T>.Iterator iter = entries.iterator();
		while (iter.hasNext()) {
			iter.advance();
	...
	public org.apache.commons.math.linear.FieldMatrix<T> outerProduct(T[] v) {
		...
		org.apache.commons.math.linear.FieldMatrix<T> res = new org.apache.commons.math.linear.SparseFieldMatrix<T>(field, virtualSize, n);
		org.apache.commons.math.util.OpenIntToFieldHashMap<T>.Iterator iter = entries.iterator();
		while (iter.hasNext()) {
			iter.advance();
			int row = iter.key();
	...
	public org.apache.commons.math.linear.SparseFieldVector<T> subtract(org.apache.commons.math.linear.SparseFieldVector<T> v) {
		checkVectorDimensions(v.getDimension());
		org.apache.commons.math.linear.SparseFieldVector<T> res = ((org.apache.commons.math.linear.SparseFieldVector<T>) (copy()));
		org.apache.commons.math.util.OpenIntToFieldHashMap<T>.Iterator iter = v.getEntries().iterator();
		while (iter.hasNext()) {
	...
	private void checkIndex(final int index) {
		if ((index < 0) || (index >= (getDimension()))) {
			throw new org.apache.commons.math.exception.OutOfRangeException(index, 0, ((getDimension()) - 1));
		}
	}

	protected void checkVectorDimensions(int n) {
		if ((getDimension()) != n) {
			throw new org.apache.commons.math.exception.DimensionMismatchException(getDimension(), n);
		}
	}
	...
	public boolean equals(java.lang.Object obj) {
		if ((org.apache.commons.math.linear.SparseFieldVector.this) == obj) {
			return true;
		}
