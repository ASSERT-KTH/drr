...
class GillStepInterpolator extends org.apache.commons.math.ode.nonstiff.RungeKuttaStepInterpolator {
	private static final double TWO_MINUS_SQRT_2 = 2 - (org.apache.commons.math.util.FastMath.sqrt(2.0));

	private static final double TWO_PLUS_SQRT_2 = 2 + (org.apache.commons.math.util.FastMath.sqrt(2.0));
	...
	@java.lang.Override
	protected void computeInterpolatedStateAndDerivatives(final double theta, final double oneMinusThetaH) throws org.apache.commons.math.exception.MathUserException {
		...
		final double coeff2 = c23 * (org.apache.commons.math.ode.nonstiff.GillStepInterpolator.TWO_MINUS_SQRT_2);
		final double coeff3 = c23 * (org.apache.commons.math.ode.nonstiff.GillStepInterpolator.TWO_PLUS_SQRT_2);
		final double coeff4 = s * (1 + (theta * (1 + fourTheta)));
		final double coeffDot1 = (theta * (twoTheta - 3)) + 1;
		final double cDot23 = theta * oMt;
		final double coeffDot2 = cDot23 * (org.apache.commons.math.ode.nonstiff.GillStepInterpolator.TWO_MINUS_SQRT_2);
		final double coeffDot3 = cDot23 * (org.apache.commons.math.ode.nonstiff.GillStepInterpolator.TWO_PLUS_SQRT_2);
