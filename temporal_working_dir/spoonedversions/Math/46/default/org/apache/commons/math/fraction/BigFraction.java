...
public class BigFraction extends java.lang.Number implements java.io.Serializable , java.lang.Comparable<org.apache.commons.math.fraction.BigFraction> , org.apache.commons.math.FieldElement<org.apache.commons.math.fraction.BigFraction> {
	...
	public BigFraction(java.math.BigInteger num, java.math.BigInteger den) {
		if (num == null) {
			throw new org.apache.commons.math.exception.NullArgumentException(org.apache.commons.math.exception.util.LocalizedFormats.NUMERATOR);
		}
		if (den == null) {
			throw new org.apache.commons.math.exception.NullArgumentException(org.apache.commons.math.exception.util.LocalizedFormats.DENOMINATOR);
		}
		if (java.math.BigInteger.ZERO.equals(den)) {
			throw org.apache.commons.math.MathRuntimeException.createArithmeticException(org.apache.commons.math.exception.util.LocalizedFormats.ZERO_DENOMINATOR);
		}
	...
	public BigFraction(final double value) throws java.lang.IllegalArgumentException {
		if (java.lang.Double.isNaN(value)) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.util.LocalizedFormats.NAN_VALUE_CONVERSION);
		}
		if (java.lang.Double.isInfinite(value)) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.util.LocalizedFormats.INFINITE_VALUE_CONVERSION);
		}
	...
	public org.apache.commons.math.fraction.BigFraction abs() {
		return (java.math.BigInteger.ZERO.compareTo(numerator)) <= 0 ? org.apache.commons.math.fraction.BigFraction.this : negate();
	}
	...
	public org.apache.commons.math.fraction.BigFraction add(final org.apache.commons.math.fraction.BigFraction fraction) {
		...
		if (org.apache.commons.math.fraction.BigFraction.ZERO.equals(fraction)) {
			return org.apache.commons.math.fraction.BigFraction.this;
		}
	...
	public boolean equals(final java.lang.Object other) {
		boolean ret = false;
		if ((org.apache.commons.math.fraction.BigFraction.this) == other) {
			ret = true;
		}else
			if (other instanceof org.apache.commons.math.fraction.BigFraction) {
				...
				org.apache.commons.math.fraction.BigFraction thisOne = org.apache.commons.math.fraction.BigFraction.this.reduce();
	...
	public double percentageValue() {
		return numerator.divide(denominator).multiply(org.apache.commons.math.fraction.BigFraction.ONE_HUNDRED_DOUBLE).doubleValue();
	}
