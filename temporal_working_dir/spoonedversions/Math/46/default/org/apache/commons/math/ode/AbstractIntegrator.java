...
public abstract class AbstractIntegrator implements org.apache.commons.math.ode.FirstOrderIntegrator {
	...
	protected void sanityChecks(final org.apache.commons.math.ode.FirstOrderDifferentialEquations ode, final double t0, final double[] y0, final double t, final double[] y) throws org.apache.commons.math.exception.DimensionMismatchException, org.apache.commons.math.exception.NumberIsTooSmallException {
		if ((ode.getDimension()) != (y0.length)) {
			throw new org.apache.commons.math.exception.DimensionMismatchException(ode.getDimension(), y0.length);
		}
		if ((ode.getDimension()) != (y.length)) {
			throw new org.apache.commons.math.exception.DimensionMismatchException(ode.getDimension(), y.length);
		}
		if ((org.apache.commons.math.util.FastMath.abs((t - t0))) <= (1.0E-12 * (org.apache.commons.math.util.FastMath.max(org.apache.commons.math.util.FastMath.abs(t0), org.apache.commons.math.util.FastMath.abs(t))))) {
			throw new org.apache.commons.math.exception.NumberIsTooSmallException(org.apache.commons.math.exception.util.LocalizedFormats.TOO_SMALL_INTEGRATION_INTERVAL, org.apache.commons.math.util.FastMath.abs((t - t0)), (1.0E-12 * (org.apache.commons.math.util.FastMath.max(org.apache.commons.math.util.FastMath.abs(t0), org.apache.commons.math.util.FastMath.abs(t)))), false);
		}
	}
}
