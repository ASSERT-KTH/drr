...
public class ResizableDoubleArray implements java.io.Serializable , org.apache.commons.math.util.DoubleArray {
	...
	public ResizableDoubleArray(double[] initialArray) {
		if (initialArray == null) {
			org.apache.commons.math.util.ResizableDoubleArray.this.internalArray = new double[initialCapacity];
		}else {
			org.apache.commons.math.util.ResizableDoubleArray.this.internalArray = new double[initialArray.length];
			java.lang.System.arraycopy(initialArray, 0, org.apache.commons.math.util.ResizableDoubleArray.this.internalArray, 0, initialArray.length);
	...
	public ResizableDoubleArray(org.apache.commons.math.util.ResizableDoubleArray original) throws org.apache.commons.math.exception.NullArgumentException {
		org.apache.commons.math.util.MathUtils.checkNotNull(original);
	...
	public synchronized double substituteMostRecentElement(double value) {
		if ((numElements) < 1) {
			throw org.apache.commons.math.MathRuntimeException.createArrayIndexOutOfBoundsException(org.apache.commons.math.exception.util.LocalizedFormats.CANNOT_SUBSTITUTE_ELEMENT_FROM_EMPTY_ARRAY);
		}
	...
	protected void checkContractExpand(float contraction, float expansion) {
		if (contraction < expansion) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.util.LocalizedFormats.CONTRACTION_CRITERIA_SMALLER_THAN_EXPANSION_FACTOR, contraction, expansion);
		}
		if (contraction <= 1.0) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.util.LocalizedFormats.CONTRACTION_CRITERIA_SMALLER_THAN_ONE, contraction);
		}
		if (expansion <= 1.0) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.util.LocalizedFormats.EXPANSION_FACTOR_SMALLER_THAN_ONE, expansion);
		}
	}
	...
	private synchronized void discardExtremeElements(int i, boolean front) {
		if (i > (numElements)) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.util.LocalizedFormats.TOO_MANY_ELEMENTS_TO_DISCARD_FROM_ARRAY, i, numElements);
		}else
			if (i < 0) {
				throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.util.LocalizedFormats.CANNOT_DISCARD_NEGATIVE_NUMBER_OF_ELEMENTS, i);
			}else {
				numElements -= i;
				if (front) {
					startIndex += i;
	...
	public synchronized double getElement(int index) {
		if (index >= (numElements)) {
			throw org.apache.commons.math.MathRuntimeException.createArrayIndexOutOfBoundsException(org.apache.commons.math.exception.util.LocalizedFormats.INDEX_LARGER_THAN_MAX, index, ((numElements) - 1));
		}else
			if (index >= 0) {
				return internalArray[((startIndex) + index)];
			}else {
				throw org.apache.commons.math.MathRuntimeException.createArrayIndexOutOfBoundsException(org.apache.commons.math.exception.util.LocalizedFormats.CANNOT_RETRIEVE_AT_NEGATIVE_INDEX, index);
			}
	...
	public synchronized void setElement(int index, double value) {
		if (index < 0) {
			throw org.apache.commons.math.MathRuntimeException.createArrayIndexOutOfBoundsException(org.apache.commons.math.exception.util.LocalizedFormats.CANNOT_SET_AT_NEGATIVE_INDEX, index);
		}
	...
	protected void setInitialCapacity(int initialCapacity) {
		if (initialCapacity > 0) {
			...
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.util.LocalizedFormats.INITIAL_CAPACITY_NOT_POSITIVE, initialCapacity);
		}
	}

	public synchronized void setNumElements(int i) {
		if (i < 0) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.util.LocalizedFormats.INDEX_NOT_POSITIVE, i);
		}
	...
	public static void copy(org.apache.commons.math.util.ResizableDoubleArray source, org.apache.commons.math.util.ResizableDoubleArray dest) throws org.apache.commons.math.exception.NullArgumentException {
