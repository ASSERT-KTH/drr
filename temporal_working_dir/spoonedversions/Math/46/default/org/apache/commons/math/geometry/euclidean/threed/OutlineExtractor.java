		...
		private void addContribution(final org.apache.commons.math.geometry.partitioning.SubHyperplane<org.apache.commons.math.geometry.euclidean.threed.Euclidean3D> facet, final boolean reversed) {
			...
			if ((org.apache.commons.math.util.FastMath.abs(scal)) > 0.001) {
				...
				for (org.apache.commons.math.geometry.euclidean.twod.Vector2D[] loop : vertices) {
					...
					org.apache.commons.math.geometry.euclidean.threed.Vector3D previous3D = ((org.apache.commons.math.geometry.euclidean.threed.Vector3D) (plane.toSpace(loop[previous])));
					...
					while (current < (loop.length)) {
						final org.apache.commons.math.geometry.euclidean.threed.Vector3D current3D = ((org.apache.commons.math.geometry.euclidean.threed.Vector3D) (plane.toSpace(loop[current])));
