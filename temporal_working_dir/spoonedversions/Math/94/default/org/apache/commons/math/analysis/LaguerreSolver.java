...
public class LaguerreSolver extends org.apache.commons.math.analysis.UnivariateRealSolverImpl {
	...
	public LaguerreSolver(org.apache.commons.math.analysis.UnivariateRealFunction f) throws java.lang.IllegalArgumentException {
		...
		if (f instanceof org.apache.commons.math.analysis.PolynomialFunction) {
			...
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException("function is not polynomial", null);
		}
	}
	...
	public double solve(final org.apache.commons.math.analysis.UnivariateRealFunction f, final double min, final double max) throws org.apache.commons.math.ConvergenceException, org.apache.commons.math.FunctionEvaluationException {
		...
		verifyBracketing(min, max, f);
		double[] coefficients = ((org.apache.commons.math.analysis.PolynomialFunction) (f)).getCoefficients();
