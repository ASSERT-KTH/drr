...
public class ResizableDoubleArray implements java.io.Serializable , org.apache.commons.math.util.DoubleArray {
	...
	public int hashCode() {
		...
		hashData[0] = java.util.Arrays.hashCode(internalArray);
		hashData[1] = new java.lang.Float(expansionFactor).hashCode();
		hashData[2] = new java.lang.Float(contractionCriteria).hashCode();
