...
public class Kurtosis extends org.apache.commons.math.stat.descriptive.AbstractStorelessUnivariateStatistic {
	...
	public void increment(final double d) {
		if (incMoment) {
			...
			throw org.apache.commons.math.MathRuntimeException.createIllegalStateException(("statistics constructed from external " + "moments cannot be incremented"), null);
		}
	}
	...
	public void clear() {
		if (incMoment) {
			...
			throw org.apache.commons.math.MathRuntimeException.createIllegalStateException(("statistics constructed from external " + "moments cannot be cleared"), null);
		}
	}
	...
	public static void copy(org.apache.commons.math.stat.descriptive.moment.Kurtosis source, org.apache.commons.math.stat.descriptive.moment.Kurtosis dest) {
		dest.moment = ((org.apache.commons.math.stat.descriptive.moment.FourthMoment) (source.moment.copy()));
