...
public class RealVectorFormat extends org.apache.commons.math.util.CompositeFormat {
	...
	public RealVectorFormat(final java.lang.String prefix, final java.lang.String suffix, final java.lang.String separator, final java.text.NumberFormat format) {
		...
		org.apache.commons.math.linear.RealVectorFormat.this.format = format;
	}
	...
	public java.lang.StringBuffer format(java.lang.Object obj, java.lang.StringBuffer toAppendTo, java.text.FieldPosition pos) {
		...
		throw new java.lang.IllegalArgumentException("Cannot format given Object as a RealVector");
	}

	public org.apache.commons.math.linear.RealVectorImpl parse(java.lang.String source) throws java.text.ParseException {
		java.text.ParsePosition parsePosition = new java.text.ParsePosition(0);
		org.apache.commons.math.linear.RealVectorImpl result = parse(source, parsePosition);
		if ((parsePosition.getIndex()) == 0) {
			throw org.apache.commons.math.MathRuntimeException.createParseException("unparseable real vector: \"{0}\"", new java.lang.Object[]{ source }, parsePosition.getErrorIndex());
		}
		return result;
	}

	public org.apache.commons.math.linear.RealVectorImpl parse(java.lang.String source, java.text.ParsePosition pos) {
		...
		return new org.apache.commons.math.linear.RealVectorImpl(data, false);
	}
