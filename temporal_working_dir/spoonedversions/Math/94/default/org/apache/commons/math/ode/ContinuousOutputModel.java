...
public class ContinuousOutputModel implements java.io.Serializable , org.apache.commons.math.ode.sampling.StepHandler {
	...
	public void append(final org.apache.commons.math.ode.ContinuousOutputModel model) throws org.apache.commons.math.ode.DerivativeException {
		...
		if ((steps.size()) == 0) {
			...
			final org.apache.commons.math.ode.sampling.StepInterpolator lastInterpolator = ((org.apache.commons.math.ode.sampling.StepInterpolator) (steps.get(index)));
		...
		index = (steps.size()) - 1;
		finalTime = ((org.apache.commons.math.ode.sampling.StepInterpolator) (steps.get(index))).getCurrentTime();
	}
	...
	public void setInterpolatedTime(final double time) {
		try {
			...
			throw new org.apache.commons.math.MathRuntimeException("unexpected exception caught", null, de);
		}
	}
