...
public class RealVectorImpl implements java.io.Serializable , org.apache.commons.math.linear.RealVector {
	...
	public RealVectorImpl(org.apache.commons.math.linear.RealVectorImpl v1, double[] v2) {
		data = new double[(v1.data.length) + (v2.length)];
		java.lang.System.arraycopy(v1.data, 0, data, 0, v1.data.length);
		java.lang.System.arraycopy(v2, 0, data, v1.data.length, v2.length);
	}

	public RealVectorImpl(double[] v1, org.apache.commons.math.linear.RealVectorImpl v2) {
	...
	public org.apache.commons.math.linear.RealVectorImpl add(org.apache.commons.math.linear.RealVectorImpl v) throws java.lang.IllegalArgumentException {
		return ((org.apache.commons.math.linear.RealVectorImpl) (add(v.data)));
	}
	...
	public org.apache.commons.math.linear.RealVectorImpl subtract(org.apache.commons.math.linear.RealVectorImpl v) throws java.lang.IllegalArgumentException {
		return ((org.apache.commons.math.linear.RealVectorImpl) (subtract(v.data)));
	}
	...
	public org.apache.commons.math.linear.RealVectorImpl ebeMultiply(org.apache.commons.math.linear.RealVectorImpl v) throws java.lang.IllegalArgumentException {
		return ((org.apache.commons.math.linear.RealVectorImpl) (ebeMultiply(v.data)));
	}
	...
	public org.apache.commons.math.linear.RealVectorImpl ebeDivide(org.apache.commons.math.linear.RealVectorImpl v) throws java.lang.IllegalArgumentException {
		return ((org.apache.commons.math.linear.RealVectorImpl) (ebeDivide(v.data)));
	}
	...
	public org.apache.commons.math.linear.RealVector projection(double[] v) {
		return projection(new org.apache.commons.math.linear.RealVectorImpl(v, false));
	}
	...
	public org.apache.commons.math.linear.RealMatrix outerProduct(org.apache.commons.math.linear.RealVectorImpl v) throws java.lang.IllegalArgumentException {
	...
	public org.apache.commons.math.linear.RealVector append(double[] in) {
		return new org.apache.commons.math.linear.RealVectorImpl(org.apache.commons.math.linear.RealVectorImpl.this, in);
	}
	...
	private void checkIndex(final int index) throws org.apache.commons.math.linear.MatrixIndexException {
		if ((index < 0) || (index >= (getDimension()))) {
			throw new org.apache.commons.math.linear.MatrixIndexException("index {0} out of allowed range [{1}, {2}]", new java.lang.Object[]{ index , 0 , (getDimension()) - 1 });
		}
	}
}
