...
public abstract class AbstractLeastSquaresOptimizer extends org.apache.commons.math.optimization.direct.BaseAbstractVectorialOptimizer<org.apache.commons.math.analysis.DifferentiableMultivariateVectorFunction> implements org.apache.commons.math.optimization.DifferentiableMultivariateVectorialOptimizer {
	...
	protected AbstractLeastSquaresOptimizer(org.apache.commons.math.optimization.ConvergenceChecker<org.apache.commons.math.optimization.VectorialPointValuePair> checker) {
		super(checker);
	}
	...
	public double[][] getCovariances(double threshold) {
		...
		final org.apache.commons.math.linear.DecompositionSolver solver = new org.apache.commons.math.linear.LUDecomposition(org.apache.commons.math.linear.MatrixUtils.createRealMatrix(jTj), threshold).getSolver();
	...
	@java.lang.Override
	public org.apache.commons.math.optimization.VectorialPointValuePair optimize(int maxEval, final org.apache.commons.math.analysis.DifferentiableMultivariateVectorFunction f, final double[] target, final double[] weights, final double[] startPoint) {
