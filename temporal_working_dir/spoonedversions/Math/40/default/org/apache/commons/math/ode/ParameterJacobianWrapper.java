...
class ParameterJacobianWrapper implements org.apache.commons.math.ode.ParameterJacobianProvider {
	private final org.apache.commons.math.ode.FirstOrderDifferentialEquations fode;

	private final org.apache.commons.math.ode.ParameterizedODE pode;

	private final java.util.Map<java.lang.String, java.lang.Double> hParam;

	public ParameterJacobianWrapper(final org.apache.commons.math.ode.FirstOrderDifferentialEquations fode, final org.apache.commons.math.ode.ParameterizedODE pode, final org.apache.commons.math.ode.ParameterConfiguration[] paramsAndSteps) {
		this.fode = fode;
		this.pode = pode;
		this.hParam = new java.util.HashMap<java.lang.String, java.lang.Double>();
		for (final org.apache.commons.math.ode.ParameterConfiguration param : paramsAndSteps) {
	...
	public void computeParameterJacobian(double t, double[] y, double[] yDot, java.lang.String paramName, double[] dFdP) {
