...
public class FastFourierTransformer implements java.io.Serializable {
	...
	public org.apache.commons.math.complex.Complex[] transform2(double[] f) throws java.lang.IllegalArgumentException {
		double scalingCoefficient = 1.0 / (org.apache.commons.math.util.FastMath.sqrt(f.length));
		return org.apache.commons.math.transform.FastFourierTransformer.scaleArray(fft(f, false), scalingCoefficient);
	}
	...
	public org.apache.commons.math.complex.Complex[] transform2(org.apache.commons.math.analysis.UnivariateFunction f, double min, double max, int n) throws java.lang.IllegalArgumentException {
		double[] data = org.apache.commons.math.transform.FastFourierTransformer.sample(f, min, max, n);
		double scalingCoefficient = 1.0 / (org.apache.commons.math.util.FastMath.sqrt(n));
		return org.apache.commons.math.transform.FastFourierTransformer.scaleArray(fft(data, false), scalingCoefficient);
	}
	...
	public org.apache.commons.math.complex.Complex[] transform2(org.apache.commons.math.complex.Complex[] f) throws java.lang.IllegalArgumentException {
		roots.computeOmega(f.length);
		double scalingCoefficient = 1.0 / (org.apache.commons.math.util.FastMath.sqrt(f.length));
		return org.apache.commons.math.transform.FastFourierTransformer.scaleArray(fft(f), scalingCoefficient);
	}
	...
	public org.apache.commons.math.complex.Complex[] inverseTransform(double[] f) throws java.lang.IllegalArgumentException {
		...
		return org.apache.commons.math.transform.FastFourierTransformer.scaleArray(fft(f, true), scalingCoefficient);
	}
	...
	public org.apache.commons.math.complex.Complex[] inverseTransform(org.apache.commons.math.analysis.UnivariateFunction f, double min, double max, int n) throws java.lang.IllegalArgumentException {
		...
		return org.apache.commons.math.transform.FastFourierTransformer.scaleArray(fft(data, true), scalingCoefficient);
	}
