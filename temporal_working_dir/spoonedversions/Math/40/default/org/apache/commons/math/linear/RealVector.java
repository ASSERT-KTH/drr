...
public abstract class RealVector {
	...
	public abstract org.apache.commons.math.linear.RealVector append(org.apache.commons.math.linear.RealVector v);

	public abstract org.apache.commons.math.linear.RealVector append(double d);

	public abstract org.apache.commons.math.linear.RealVector getSubVector(int index, int n);

	public abstract void setSubVector(int index, org.apache.commons.math.linear.RealVector v);
	...
	public org.apache.commons.math.linear.RealVector mapAddToSelf(double d) {
		...
		return org.apache.commons.math.linear.RealVector.this;
	}
	...
	public double cosine(org.apache.commons.math.linear.RealVector v) {
	...
	public abstract org.apache.commons.math.linear.RealVector ebeDivide(org.apache.commons.math.linear.RealVector v);

	public abstract org.apache.commons.math.linear.RealVector ebeMultiply(org.apache.commons.math.linear.RealVector v);
	...
	public org.apache.commons.math.linear.RealMatrix outerProduct(org.apache.commons.math.linear.RealVector v) {
		...
		if ((v instanceof org.apache.commons.math.linear.SparseRealVector) || ((org.apache.commons.math.linear.RealVector.this) instanceof org.apache.commons.math.linear.SparseRealVector)) {
			product = new org.apache.commons.math.linear.OpenMapRealMatrix(org.apache.commons.math.linear.RealVector.this.getDimension(), v.getDimension());
		}else {
			product = new org.apache.commons.math.linear.Array2DRowRealMatrix(org.apache.commons.math.linear.RealVector.this.getDimension(), v.getDimension());
		}
	...
	public abstract org.apache.commons.math.linear.RealVector projection(org.apache.commons.math.linear.RealVector v);
	...
	public java.util.Iterator<org.apache.commons.math.linear.RealVector.Entry> sparseIterator() {
		return new org.apache.commons.math.linear.RealVector.SparseEntryIterator();
	}
	...
	public java.util.Iterator<org.apache.commons.math.linear.RealVector.Entry> iterator() {
		...
		return new java.util.Iterator<org.apache.commons.math.linear.RealVector.Entry>() {
			...
			private org.apache.commons.math.linear.RealVector.Entry e = new org.apache.commons.math.linear.RealVector.Entry();
	...
	public org.apache.commons.math.linear.RealVector map(org.apache.commons.math.analysis.UnivariateFunction function) {
		return copy().mapToSelf(function);
	}

	public org.apache.commons.math.linear.RealVector mapToSelf(org.apache.commons.math.analysis.UnivariateFunction function) {
	...
	public org.apache.commons.math.linear.RealVector combine(double a, double b, org.apache.commons.math.linear.RealVector y) {
		return copy().combineToSelf(a, b, y);
	}

	public org.apache.commons.math.linear.RealVector combineToSelf(double a, double b, org.apache.commons.math.linear.RealVector y) {
	...
	protected class SparseEntryIterator implements java.util.Iterator<org.apache.commons.math.linear.RealVector.Entry> {
		...
		private org.apache.commons.math.linear.RealVector.Entry current;

		private org.apache.commons.math.linear.RealVector.Entry next;

		protected SparseEntryIterator() {
			dim = getDimension();
			current = new org.apache.commons.math.linear.RealVector.Entry();
			next = new org.apache.commons.math.linear.RealVector.Entry();
			if ((next.getValue()) == 0) {
				advance(next);
			}
		}

		protected void advance(org.apache.commons.math.linear.RealVector.Entry e) {
			if (e == null) {
				return ;
			}
			do {
	...
	public static org.apache.commons.math.linear.RealVector unmodifiableRealVector(final org.apache.commons.math.linear.RealVector v) {
		return new org.apache.commons.math.linear.RealVector() {
			@java.lang.Override
			public org.apache.commons.math.linear.RealVector mapToSelf(org.apache.commons.math.analysis.UnivariateFunction function) {
				throw new org.apache.commons.math.exception.MathUnsupportedOperationException();
			}
			...
			@java.lang.Override
			public java.util.Iterator<org.apache.commons.math.linear.RealVector.Entry> iterator() {
				final java.util.Iterator<org.apache.commons.math.linear.RealVector.Entry> i = v.iterator();
				return new java.util.Iterator<org.apache.commons.math.linear.RealVector.Entry>() {
			...
			@java.lang.Override
			public java.util.Iterator<org.apache.commons.math.linear.RealVector.Entry> sparseIterator() {
				final java.util.Iterator<org.apache.commons.math.linear.RealVector.Entry> i = v.sparseIterator();
				return new java.util.Iterator<org.apache.commons.math.linear.RealVector.Entry>() {
					private final UnmodifiableEntry e = new UnmodifiableEntry();
			...
			@java.lang.Override
			public org.apache.commons.math.linear.RealVector add(org.apache.commons.math.linear.RealVector w) {
				return v.add(w);
			}

			@java.lang.Override
			public org.apache.commons.math.linear.RealVector subtract(org.apache.commons.math.linear.RealVector w) {
				return v.subtract(w);
			}
			...
			@java.lang.Override
			public org.apache.commons.math.linear.RealVector ebeMultiply(org.apache.commons.math.linear.RealVector w) {
				return v.ebeMultiply(w);
			}

			@java.lang.Override
			public org.apache.commons.math.linear.RealVector ebeDivide(org.apache.commons.math.linear.RealVector w) {
				return v.ebeDivide(w);
			}

			@java.lang.Override
			public double dotProduct(org.apache.commons.math.linear.RealVector w) {
				return v.dotProduct(w);
			}

			@java.lang.Override
			public double cosine(org.apache.commons.math.linear.RealVector w) {
				return v.cosine(w);
			}
			...
			@java.lang.Override
			public double getDistance(org.apache.commons.math.linear.RealVector w) {
				return v.getDistance(w);
			}

			@java.lang.Override
			public double getL1Distance(org.apache.commons.math.linear.RealVector w) {
				return v.getL1Distance(w);
			}

			@java.lang.Override
			public double getLInfDistance(org.apache.commons.math.linear.RealVector w) {
			...
			@java.lang.Override
			public org.apache.commons.math.linear.RealVector projection(org.apache.commons.math.linear.RealVector w) {
				return v.projection(w);
			}

			@java.lang.Override
			public org.apache.commons.math.linear.RealMatrix outerProduct(org.apache.commons.math.linear.RealVector w) {
			...
			@java.lang.Override
			public org.apache.commons.math.linear.RealVector append(org.apache.commons.math.linear.RealVector w) {
				return v.append(w);
			}
			...
			@java.lang.Override
			public void setSubVector(int index, org.apache.commons.math.linear.RealVector w) {
				throw new org.apache.commons.math.exception.MathUnsupportedOperationException();
			}
			...
			class UnmodifiableEntry extends org.apache.commons.math.linear.RealVector.Entry {
				@java.lang.Override
				public double getValue() {
