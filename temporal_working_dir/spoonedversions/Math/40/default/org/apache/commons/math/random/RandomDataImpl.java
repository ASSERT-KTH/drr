...
public class RandomDataImpl implements java.io.Serializable , org.apache.commons.math.random.RandomData {
	...
	static {
		final double LN2 = org.apache.commons.math.util.FastMath.log(2);
		double qi = 0;
		int i = 1;
		final org.apache.commons.math.util.ResizableDoubleArray ra = new org.apache.commons.math.util.ResizableDoubleArray(20);
		while (qi < 1) {
			qi += (org.apache.commons.math.util.FastMath.pow(LN2, i)) / (org.apache.commons.math.util.ArithmeticUtils.factorial(i));
			ra.addElement(qi);
			++i;
		} 
		org.apache.commons.math.random.RandomDataImpl.EXPONENTIAL_SA_QI = ra.getElements();
	}
	...
	public long nextPoisson(double mean) {
		...
		if (mean < pivot) {
			...
			final double logLambdaFactorial = org.apache.commons.math.util.ArithmeticUtils.factorialLog(((int) (lambda)));
			...
			for (; ;) {
				...
				if (v < (((y * logLambda) - (org.apache.commons.math.util.ArithmeticUtils.factorialLog(((int) (y + lambda))))) + logLambdaFactorial)) {
					y = lambda + y;
					break;
				}
			}
	...
	public double nextExponential(double mean) {
		...
		double a = 0;
		double u = org.apache.commons.math.random.RandomDataImpl.this.nextUniform(0, 1);
		while (u < 0.5) {
			a += org.apache.commons.math.random.RandomDataImpl.EXPONENTIAL_SA_QI[0];
			u *= 2;
		} 
		u += u - 1;
		if (u <= (org.apache.commons.math.random.RandomDataImpl.EXPONENTIAL_SA_QI[0])) {
			return mean * (a + u);
		}
		int i = 0;
		double u2 = org.apache.commons.math.random.RandomDataImpl.this.nextUniform(0, 1);
		double umin = u2;
		do {
			++i;
			u2 = org.apache.commons.math.random.RandomDataImpl.this.nextUniform(0, 1);
			if (u2 < umin) {
				umin = u2;
			}
		} while (u > (org.apache.commons.math.random.RandomDataImpl.EXPONENTIAL_SA_QI[i]) );
		return mean * (a + (umin * (org.apache.commons.math.random.RandomDataImpl.EXPONENTIAL_SA_QI[0])));
	}
	...
	public double nextBeta(double alpha, double beta) {
		return nextInversionDeviate(new org.apache.commons.math.distribution.BetaDistribution(alpha, beta));
	}

	public int nextBinomial(int numberOfTrials, double probabilityOfSuccess) {
		return nextInversionDeviate(new org.apache.commons.math.distribution.BinomialDistribution(numberOfTrials, probabilityOfSuccess));
	}

	public double nextCauchy(double median, double scale) {
		return nextInversionDeviate(new org.apache.commons.math.distribution.CauchyDistribution(median, scale));
	}

	public double nextChiSquare(double df) {
		return nextInversionDeviate(new org.apache.commons.math.distribution.ChiSquaredDistribution(df));
	}

	public double nextF(double numeratorDf, double denominatorDf) {
		return nextInversionDeviate(new org.apache.commons.math.distribution.FDistribution(numeratorDf, denominatorDf));
	}

	public double nextGamma(double shape, double scale) {
		if (shape < 1) {
			while (true) {
				final double u = org.apache.commons.math.random.RandomDataImpl.this.nextUniform(0, 1);
				final double bGS = 1 + (shape / (org.apache.commons.math.util.FastMath.E));
				final double p = bGS * u;
				if (p <= 1) {
					final double x = org.apache.commons.math.util.FastMath.pow(p, (1 / shape));
					final double u2 = org.apache.commons.math.random.RandomDataImpl.this.nextUniform(0.0, 1);
					if (u2 > (org.apache.commons.math.util.FastMath.exp((-x)))) {
						continue;
					}else {
						return scale * x;
					}
				}else {
					final double x = (-1) * (org.apache.commons.math.util.FastMath.log(((bGS - p) / shape)));
					final double u2 = org.apache.commons.math.random.RandomDataImpl.this.nextUniform(0, 1);
					if (u2 > (org.apache.commons.math.util.FastMath.pow(x, (shape - 1)))) {
						continue;
					}else {
						return scale * x;
					}
		...
		final org.apache.commons.math.random.RandomGenerator generator = org.apache.commons.math.random.RandomDataImpl.this.getRan();
		final double d = shape - 0.3333333333333333;
		final double c = 1.0 / (3 * (org.apache.commons.math.util.FastMath.sqrt(d)));
		while (true) {
			...
			if ((org.apache.commons.math.util.FastMath.log(u)) < ((0.5 * xx) + (d * ((1 - v) + (org.apache.commons.math.util.FastMath.log(v)))))) {
				return (scale * d) * v;
			}
		} 
	}
	...
	public int nextHypergeometric(int populationSize, int numberOfSuccesses, int sampleSize) {
		return nextInversionDeviate(new org.apache.commons.math.distribution.HypergeometricDistribution(populationSize, numberOfSuccesses, sampleSize));
	}

	public int nextPascal(int r, double p) {
		return nextInversionDeviate(new org.apache.commons.math.distribution.PascalDistribution(r, p));
	}

	public double nextT(double df) {
		return nextInversionDeviate(new org.apache.commons.math.distribution.TDistribution(df));
	}

	public double nextWeibull(double shape, double scale) {
		return nextInversionDeviate(new org.apache.commons.math.distribution.WeibullDistribution(shape, scale));
	}

	public int nextZipf(int numberOfElements, double exponent) {
		return nextInversionDeviate(new org.apache.commons.math.distribution.ZipfDistribution(numberOfElements, exponent));
	}

	private org.apache.commons.math.random.RandomGenerator getRan() {
		if ((rand) == null) {
			rand = new org.apache.commons.math.random.Well19937c(((java.lang.System.currentTimeMillis()) + (java.lang.System.identityHashCode(org.apache.commons.math.random.RandomDataImpl.this))));
		}
		return rand;
	}
	...
	private java.security.SecureRandom getSecRan() {
		if ((secRand) == null) {
			...
			secRand.setSeed(((java.lang.System.currentTimeMillis()) + (java.lang.System.identityHashCode(org.apache.commons.math.random.RandomDataImpl.this))));
		}
		return secRand;
	}
	...
	public double nextInversionDeviate(org.apache.commons.math.distribution.ContinuousDistribution distribution) {
		return distribution.inverseCumulativeProbability(nextUniform(0, 1));
	}

	public int nextInversionDeviate(org.apache.commons.math.distribution.IntegerDistribution distribution) {
