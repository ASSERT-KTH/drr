...
public class EmpiricalDistributionImpl implements java.io.Serializable , org.apache.commons.math.random.EmpiricalDistribution {
	...
	public void load(java.net.URL url) throws java.io.IOException {
		...
		try {
			...
			if ((sampleStats.getN()) == 0) {
				throw org.apache.commons.math.MathRuntimeException.createEOFException("URL {0} contains no data", new java.lang.Object[]{ url });
			}
	...
	public double getNextValue() throws java.lang.IllegalStateException {
		if (!(loaded)) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalStateException("distribution not loaded", null);
		}
		...
		throw new org.apache.commons.math.MathRuntimeException("no bin selected", null);
	}
