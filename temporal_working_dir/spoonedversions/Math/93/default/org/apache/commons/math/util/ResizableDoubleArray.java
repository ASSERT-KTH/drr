...
public class ResizableDoubleArray implements java.io.Serializable , org.apache.commons.math.util.DoubleArray {
	...
	public synchronized double substituteMostRecentElement(double value) {
		if ((numElements) < 1) {
			throw org.apache.commons.math.MathRuntimeException.createArrayIndexOutOfBoundsException("cannot substitute an element from an empty array", null);
		}
	...
	public synchronized double getElement(int index) {
		if (index >= (numElements)) {
			throw org.apache.commons.math.MathRuntimeException.createArrayIndexOutOfBoundsException("the index specified: {0} is larger than the current maximal index {1}", new java.lang.Object[]{ index , (numElements) - 1 });
		}else
			if (index >= 0) {
				return internalArray[((startIndex) + index)];
			}else {
				throw org.apache.commons.math.MathRuntimeException.createArrayIndexOutOfBoundsException("elements cannot be retrieved from a negative array index {0}", new java.lang.Object[]{ index });
			}
	...
	public synchronized void setElement(int index, double value) {
		if (index < 0) {
			throw org.apache.commons.math.MathRuntimeException.createArrayIndexOutOfBoundsException("cannot set an element at a negative index {0}", new java.lang.Object[]{ index });
		}
