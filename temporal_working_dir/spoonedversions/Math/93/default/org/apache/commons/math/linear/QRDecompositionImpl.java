...
public class QRDecompositionImpl implements org.apache.commons.math.linear.QRDecomposition {
	...
	private static class Solver implements org.apache.commons.math.linear.DecompositionSolver {
		...
		public double[] solve(double[] b) throws java.lang.IllegalArgumentException, org.apache.commons.math.linear.InvalidMatrixException {
			...
			final int m = qrt[0].length;
			if ((b.length) != m) {
				throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException("vector length mismatch: got {0} but expected {1}", new java.lang.Object[]{ b.length , m });
			}
			if (!(isNonSingular())) {
		...
		public org.apache.commons.math.linear.RealMatrix solve(org.apache.commons.math.linear.RealMatrix b) throws java.lang.IllegalArgumentException, org.apache.commons.math.linear.InvalidMatrixException {
			...
			if ((b.getRowDimension()) != m) {
				throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException("dimensions mismatch: got {0}x{1} but expected {2}x{3}", new java.lang.Object[]{ b.getRowDimension() , b.getColumnDimension() , m , "n" });
			}
			if (!(isNonSingular())) {
				throw new org.apache.commons.math.linear.SingularMatrixException();
			}
			final int columns = b.getColumnDimension();
			final int blockSize = org.apache.commons.math.linear.DenseRealMatrix.BLOCK_SIZE;
			final int cBlocks = ((columns + blockSize) - 1) / blockSize;
			final double[][] xBlocks = org.apache.commons.math.linear.DenseRealMatrix.createBlocksLayout(n, columns);
			...
			return new org.apache.commons.math.linear.DenseRealMatrix(n, columns, xBlocks, false);
		}
