...
public abstract class AbstractRealMatrix implements java.io.Serializable , org.apache.commons.math.linear.RealMatrix {
	...
	protected AbstractRealMatrix(final int rowDimension, final int columnDimension) throws java.lang.IllegalArgumentException {
		if (rowDimension <= 0) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(("invalid row dimension {0}" + " (must be positive)"), new java.lang.Object[]{ rowDimension });
		}
		if (columnDimension <= 0) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(("invalid column dimension {0}" + " (must be positive)"), new java.lang.Object[]{ columnDimension });
		}
		lu = null;
	}
	...
	public void copySubMatrix(final int startRow, final int endRow, final int startColumn, final int endColumn, final double[][] destination) throws java.lang.IllegalArgumentException, org.apache.commons.math.linear.MatrixIndexException {
		...
		if (((destination.length) < rowsCount) || ((destination[0].length) < columnsCount)) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException("dimensions mismatch: got {0}x{1} but expected {2}x{3}", new java.lang.Object[]{ destination.length , destination[0].length , rowsCount , columnsCount });
		}
	...
	public void copySubMatrix(int[] selectedRows, int[] selectedColumns, double[][] destination) throws java.lang.IllegalArgumentException, org.apache.commons.math.linear.MatrixIndexException {
		...
		if (((destination.length) < (selectedRows.length)) || ((destination[0].length) < (selectedColumns.length))) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException("dimensions mismatch: got {0}x{1} but expected {2}x{3}", new java.lang.Object[]{ destination.length , destination[0].length , selectedRows.length , selectedColumns.length });
		}
	...
	public void setSubMatrix(final double[][] subMatrix, final int row, final int column) throws org.apache.commons.math.linear.MatrixIndexException {
		...
		for (int r = 1; r < nRows; ++r) {
			if ((subMatrix[r].length) != nCols) {
				throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException("some rows have length {0} while others have length {1}", new java.lang.Object[]{ nCols , subMatrix[r].length });
			}
		}
		checkRowIndex(row);
	...
	public void setRowMatrix(final int row, final org.apache.commons.math.linear.RealMatrix matrix) throws org.apache.commons.math.linear.InvalidMatrixException, org.apache.commons.math.linear.MatrixIndexException {
		...
		if (((matrix.getRowDimension()) != 1) || ((matrix.getColumnDimension()) != nCols)) {
			throw new org.apache.commons.math.linear.InvalidMatrixException("dimensions mismatch: got {0}x{1} but expected {2}x{3}", new java.lang.Object[]{ matrix.getRowDimension() , matrix.getColumnDimension() , 1 , nCols });
		}
		for (int i = 0; i < nCols; ++i) {
	...
	public void setColumnMatrix(final int column, final org.apache.commons.math.linear.RealMatrix matrix) throws org.apache.commons.math.linear.InvalidMatrixException, org.apache.commons.math.linear.MatrixIndexException {
		...
		if (((matrix.getRowDimension()) != nRows) || ((matrix.getColumnDimension()) != 1)) {
			throw new org.apache.commons.math.linear.InvalidMatrixException("dimensions mismatch: got {0}x{1} but expected {2}x{3}", new java.lang.Object[]{ matrix.getRowDimension() , matrix.getColumnDimension() , nRows , 1 });
		}
		for (int i = 0; i < nRows; ++i) {
	...
	public void setRowVector(final int row, final org.apache.commons.math.linear.RealVector vector) throws org.apache.commons.math.linear.InvalidMatrixException, org.apache.commons.math.linear.MatrixIndexException {
		...
		if ((vector.getDimension()) != nCols) {
			throw new org.apache.commons.math.linear.InvalidMatrixException("dimensions mismatch: got {0}x{1} but expected {2}x{3}", new java.lang.Object[]{ 1 , vector.getDimension() , 1 , nCols });
		}
		for (int i = 0; i < nCols; ++i) {
	...
	public void setColumnVector(final int column, final org.apache.commons.math.linear.RealVector vector) throws org.apache.commons.math.linear.InvalidMatrixException, org.apache.commons.math.linear.MatrixIndexException {
		...
		if ((vector.getDimension()) != nRows) {
			throw new org.apache.commons.math.linear.InvalidMatrixException("dimensions mismatch: got {0}x{1} but expected {2}x{3}", new java.lang.Object[]{ vector.getDimension() , 1 , nRows , 1 });
		}
		for (int i = 0; i < nRows; ++i) {
	...
	public void setRow(final int row, final double[] array) throws org.apache.commons.math.linear.InvalidMatrixException, org.apache.commons.math.linear.MatrixIndexException {
		...
		if ((array.length) != nCols) {
			throw new org.apache.commons.math.linear.InvalidMatrixException("dimensions mismatch: got {0}x{1} but expected {2}x{3}", new java.lang.Object[]{ 1 , array.length , 1 , nCols });
		}
		for (int i = 0; i < nCols; ++i) {
	...
	public void setColumn(final int column, final double[] array) throws org.apache.commons.math.linear.InvalidMatrixException, org.apache.commons.math.linear.MatrixIndexException {
		...
		if ((array.length) != nRows) {
			throw new org.apache.commons.math.linear.InvalidMatrixException("dimensions mismatch: got {0}x{1} but expected {2}x{3}", new java.lang.Object[]{ array.length , 1 , nRows , 1 });
		}
		for (int i = 0; i < nRows; ++i) {
	...
	public org.apache.commons.math.linear.RealVector operate(final org.apache.commons.math.linear.RealVector v) throws java.lang.IllegalArgumentException {
		try {
			...
			if ((v.getDimension()) != nCols) {
				throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(("vector length mismatch:" + " got {0} but expected {1}"), new java.lang.Object[]{ v.getDimension() , nCols });
			}
			final double[] out = new double[nRows];
			for (int row = 0; row < nRows; ++row) {
				double sum = 0;
	...
	public org.apache.commons.math.linear.RealVector preMultiply(final org.apache.commons.math.linear.RealVector v) throws java.lang.IllegalArgumentException {
		try {
			...
			if ((v.getDimension()) != nRows) {
				throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(("vector length mismatch:" + " got {0} but expected {1}"), new java.lang.Object[]{ v.getDimension() , nRows });
			}
			final double[] out = new double[nCols];
			for (int col = 0; col < nCols; ++col) {
				double sum = 0;
	...
	protected void checkRowIndex(final int row) {
		if ((row < 0) || (row >= (getRowDimension()))) {
			throw new org.apache.commons.math.linear.MatrixIndexException("row index {0} out of allowed range [{1}, {2}]", new java.lang.Object[]{ row , 0 , (getRowDimension()) - 1 });
		}
	}

	protected void checkColumnIndex(final int column) throws org.apache.commons.math.linear.MatrixIndexException {
		if ((column < 0) || (column >= (getColumnDimension()))) {
			throw new org.apache.commons.math.linear.MatrixIndexException("column index {0} out of allowed range [{1}, {2}]", new java.lang.Object[]{ column , 0 , (getColumnDimension()) - 1 });
		}
	}
	...
	protected void checkSubMatrixIndex(final int startRow, final int endRow, final int startColumn, final int endColumn) {
		...
		if (startRow > endRow) {
			throw new org.apache.commons.math.linear.MatrixIndexException("initial row {0} after final row {1}", new java.lang.Object[]{ startRow , endRow });
		}
		checkColumnIndex(startColumn);
		checkColumnIndex(endColumn);
		if (startColumn > endColumn) {
			throw new org.apache.commons.math.linear.MatrixIndexException("initial column {0} after final column {1}", new java.lang.Object[]{ startColumn , endColumn });
		}
	}
	...
	protected void checkSubMatrixIndex(final int[] selectedRows, final int[] selectedColumns) {
		if (((selectedRows.length) * (selectedColumns.length)) == 0) {
			if ((selectedRows.length) == 0) {
				throw new org.apache.commons.math.linear.MatrixIndexException("empty selected row index array", null);
			}
			throw new org.apache.commons.math.linear.MatrixIndexException("empty selected column index array", null);
		}
	...
	protected void checkAdditionCompatible(final org.apache.commons.math.linear.RealMatrix m) {
		if (((getRowDimension()) != (m.getRowDimension())) || ((getColumnDimension()) != (m.getColumnDimension()))) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(("{0}x{1} and {2}x{3} matrices are not" + " addition compatible"), new java.lang.Object[]{ getRowDimension() , getColumnDimension() , m.getRowDimension() , m.getColumnDimension() });
		}
	}

	protected void checkSubtractionCompatible(final org.apache.commons.math.linear.RealMatrix m) {
		if (((getRowDimension()) != (m.getRowDimension())) || ((getColumnDimension()) != (m.getColumnDimension()))) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(("{0}x{1} and {2}x{3} matrices are not" + " subtraction compatible"), new java.lang.Object[]{ getRowDimension() , getColumnDimension() , m.getRowDimension() , m.getColumnDimension() });
		}
	}

	protected void checkMultiplicationCompatible(final org.apache.commons.math.linear.RealMatrix m) {
		if ((getColumnDimension()) != (m.getRowDimension())) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(("{0}x{1} and {2}x{3} matrices are not" + " multiplication compatible"), new java.lang.Object[]{ getRowDimension() , getColumnDimension() , m.getRowDimension() , m.getColumnDimension() });
		}
	}
}
