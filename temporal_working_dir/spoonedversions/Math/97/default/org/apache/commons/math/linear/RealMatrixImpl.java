...
public class RealMatrixImpl implements java.io.Serializable , org.apache.commons.math.linear.RealMatrix {
	...
	public double[] solve(double[] b) throws java.lang.IllegalArgumentException, org.apache.commons.math.linear.InvalidMatrixException {
		...
		final org.apache.commons.math.linear.RealMatrix bMatrix = new org.apache.commons.math.linear.RealMatrixImpl(b);
		final double[][] solution = ((org.apache.commons.math.linear.RealMatrixImpl) (solve(bMatrix))).getDataRef();
		final double[] out = new double[nRows];
		for (int row = 0; row < nRows; row++) {
	...
	public boolean equals(java.lang.Object object) {
		...
		for (int row = 0; row < nRows; row++) {
			final double[] dataRow = data[row];
			for (int col = 0; col < nCols; col++) {
				if ((java.lang.Double.doubleToLongBits(dataRow[col])) != (java.lang.Double.doubleToLongBits(m.getEntry(row, col)))) {
					return false;
				}
			}
		}
