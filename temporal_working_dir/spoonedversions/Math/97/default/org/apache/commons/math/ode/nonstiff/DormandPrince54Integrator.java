...
public class DormandPrince54Integrator extends org.apache.commons.math.ode.nonstiff.EmbeddedRungeKuttaIntegrator {
	...
	public DormandPrince54Integrator(final double minStep, final double maxStep, final double scalAbsoluteTolerance, final double scalRelativeTolerance) {
		super(true, org.apache.commons.math.ode.nonstiff.DormandPrince54Integrator.staticC, org.apache.commons.math.ode.nonstiff.DormandPrince54Integrator.staticA, org.apache.commons.math.ode.nonstiff.DormandPrince54Integrator.staticB, new org.apache.commons.math.ode.nonstiff.DormandPrince54StepInterpolator(), minStep, maxStep, scalAbsoluteTolerance, scalRelativeTolerance);
	}
	...
	public DormandPrince54Integrator(final double minStep, final double maxStep, final double[] vecAbsoluteTolerance, final double[] vecRelativeTolerance) {
		super(true, org.apache.commons.math.ode.nonstiff.DormandPrince54Integrator.staticC, org.apache.commons.math.ode.nonstiff.DormandPrince54Integrator.staticA, org.apache.commons.math.ode.nonstiff.DormandPrince54Integrator.staticB, new org.apache.commons.math.ode.nonstiff.DormandPrince54StepInterpolator(), minStep, maxStep, vecAbsoluteTolerance, vecRelativeTolerance);
	}

	public java.lang.String getName() {
		return org.apache.commons.math.ode.nonstiff.DormandPrince54Integrator.methodName;
	}
