...
public class HighamHall54Integrator extends org.apache.commons.math.ode.nonstiff.EmbeddedRungeKuttaIntegrator {
	...
	public HighamHall54Integrator(final double minStep, final double maxStep, final double scalAbsoluteTolerance, final double scalRelativeTolerance) {
		super(false, org.apache.commons.math.ode.nonstiff.HighamHall54Integrator.staticC, org.apache.commons.math.ode.nonstiff.HighamHall54Integrator.staticA, org.apache.commons.math.ode.nonstiff.HighamHall54Integrator.staticB, new org.apache.commons.math.ode.nonstiff.HighamHall54StepInterpolator(), minStep, maxStep, scalAbsoluteTolerance, scalRelativeTolerance);
	}
	...
	public HighamHall54Integrator(final double minStep, final double maxStep, final double[] vecAbsoluteTolerance, final double[] vecRelativeTolerance) {
		super(false, org.apache.commons.math.ode.nonstiff.HighamHall54Integrator.staticC, org.apache.commons.math.ode.nonstiff.HighamHall54Integrator.staticA, org.apache.commons.math.ode.nonstiff.HighamHall54Integrator.staticB, new org.apache.commons.math.ode.nonstiff.HighamHall54StepInterpolator(), minStep, maxStep, vecAbsoluteTolerance, vecRelativeTolerance);
	}

	public java.lang.String getName() {
		return org.apache.commons.math.ode.nonstiff.HighamHall54Integrator.methodName;
	}
