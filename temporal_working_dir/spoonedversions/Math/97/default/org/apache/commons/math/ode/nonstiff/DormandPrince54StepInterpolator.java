	...
	protected void computeInterpolatedState(final double theta, final double oneMinusThetaH) throws org.apache.commons.math.ode.DerivativeException {
		if (!(vectorsInitialized)) {
			...
			for (int i = 0; i < (interpolatedState.length); ++i) {
				v1[i] = (h) * ((((((org.apache.commons.math.ode.nonstiff.DormandPrince54StepInterpolator.a70) * (yDotK[0][i])) + ((org.apache.commons.math.ode.nonstiff.DormandPrince54StepInterpolator.a72) * (yDotK[2][i]))) + ((org.apache.commons.math.ode.nonstiff.DormandPrince54StepInterpolator.a73) * (yDotK[3][i]))) + ((org.apache.commons.math.ode.nonstiff.DormandPrince54StepInterpolator.a74) * (yDotK[4][i]))) + ((org.apache.commons.math.ode.nonstiff.DormandPrince54StepInterpolator.a75) * (yDotK[5][i])));
				v2[i] = ((h) * (yDotK[0][i])) - (v1[i]);
				v3[i] = ((v1[i]) - (v2[i])) - ((h) * (yDotK[6][i]));
				v4[i] = (h) * (((((((org.apache.commons.math.ode.nonstiff.DormandPrince54StepInterpolator.d0) * (yDotK[0][i])) + ((org.apache.commons.math.ode.nonstiff.DormandPrince54StepInterpolator.d2) * (yDotK[2][i]))) + ((org.apache.commons.math.ode.nonstiff.DormandPrince54StepInterpolator.d3) * (yDotK[3][i]))) + ((org.apache.commons.math.ode.nonstiff.DormandPrince54StepInterpolator.d4) * (yDotK[4][i]))) + ((org.apache.commons.math.ode.nonstiff.DormandPrince54StepInterpolator.d5) * (yDotK[5][i]))) + ((org.apache.commons.math.ode.nonstiff.DormandPrince54StepInterpolator.d6) * (yDotK[6][i])));
			}
