...
public class GraggBulirschStoerIntegrator extends org.apache.commons.math.ode.AdaptiveStepsizeIntegrator {
	...
	public void setStabilityCheck(final boolean performTest, final int maxIter, final int maxChecks, final double stabilityReduction) {
		org.apache.commons.math.ode.nonstiff.GraggBulirschStoerIntegrator.this.performTest = performTest;
		org.apache.commons.math.ode.nonstiff.GraggBulirschStoerIntegrator.this.maxIter = (maxIter <= 0) ? 2 : maxIter;
		org.apache.commons.math.ode.nonstiff.GraggBulirschStoerIntegrator.this.maxChecks = (maxChecks <= 0) ? 1 : maxChecks;
		if ((stabilityReduction < 1.0E-4) || (stabilityReduction > 0.9999)) {
			...
			org.apache.commons.math.ode.nonstiff.GraggBulirschStoerIntegrator.this.stabilityReduction = stabilityReduction;
		}
	}
	...
	public void setStepsizeControl(final double stepControl1, final double stepControl2, final double stepControl3, final double stepControl4) {
		if ((stepControl1 < 1.0E-4) || (stepControl1 > 0.9999)) {
			...
			org.apache.commons.math.ode.nonstiff.GraggBulirschStoerIntegrator.this.stepControl1 = stepControl1;
		}
		if ((stepControl2 < 1.0E-4) || (stepControl2 > 0.9999)) {
			...
			org.apache.commons.math.ode.nonstiff.GraggBulirschStoerIntegrator.this.stepControl2 = stepControl2;
		}
		if ((stepControl3 < 1.0E-4) || (stepControl3 > 0.9999)) {
			...
			org.apache.commons.math.ode.nonstiff.GraggBulirschStoerIntegrator.this.stepControl3 = stepControl3;
		}
		if ((stepControl4 < 1.0001) || (stepControl4 > 999.9)) {
			...
			org.apache.commons.math.ode.nonstiff.GraggBulirschStoerIntegrator.this.stepControl4 = stepControl4;
		}
	}
	...
	public void setOrderControl(final int maxOrder, final double orderControl1, final double orderControl2) {
		...
		if ((orderControl1 < 1.0E-4) || (orderControl1 > 0.9999)) {
			...
			org.apache.commons.math.ode.nonstiff.GraggBulirschStoerIntegrator.this.orderControl1 = orderControl1;
		}
		if ((orderControl2 < 1.0E-4) || (orderControl2 > 0.9999)) {
			...
			org.apache.commons.math.ode.nonstiff.GraggBulirschStoerIntegrator.this.orderControl2 = orderControl2;
		}
		initializeArrays();
	}
	...
	public void setInterpolationControl(final boolean useInterpolationError, final int mudif) {
		org.apache.commons.math.ode.nonstiff.GraggBulirschStoerIntegrator.this.useInterpolationError = useInterpolationError;
		if ((mudif <= 0) || (mudif >= 7)) {
			org.apache.commons.math.ode.nonstiff.GraggBulirschStoerIntegrator.this.mudif = 4;
		}else {
			org.apache.commons.math.ode.nonstiff.GraggBulirschStoerIntegrator.this.mudif = mudif;
		}
	}

	public java.lang.String getName() {
		return org.apache.commons.math.ode.nonstiff.GraggBulirschStoerIntegrator.methodName;
	}
		...
		while (!lastStep) {
			...
			for (boolean loop = true; loop;) {
				...
				if (!(tryStep(equations, stepStart, y, stepSize, k, scale, fk[k], (k == 0 ? yMidDots[0] : diagonal[(k - 1)]), (k == 0 ? y1 : y1Diag[(k - 1)]), yTmp))) {
					hNew = java.lang.Math.abs(filterStep(((stepSize) * (stabilityReduction)), false));
					reject = true;
					loop = false;
				}else {
					if (k > 0) {
						...
						if ((error > 1.0E15) || ((k > 1) && (error > maxError))) {
							...
							optimalStep[k] = java.lang.Math.abs(filterStep(((stepSize) * fac), true));
				...
				if (mu >= 0) {
					...
					if (!reject) {
						...
						if (eventsHandlersManager.evaluateStep(interpolator)) {
							reject = true;
							hNew = java.lang.Math.abs(((eventsHandlersManager.getEventTime()) - (stepStart)));
						}
					}
				}
				if (!reject) {
