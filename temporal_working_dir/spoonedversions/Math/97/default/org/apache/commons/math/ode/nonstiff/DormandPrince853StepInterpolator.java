	...
	protected void computeInterpolatedState(final double theta, final double oneMinusThetaH) throws org.apache.commons.math.ode.DerivativeException {
		if (!(vectorsInitialized)) {
			...
			for (int i = 0; i < (interpolatedState.length); ++i) {
				v[0][i] = (h) * (((((((((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.b_01) * (yDotK[0][i])) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.b_06) * (yDotK[5][i]))) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.b_07) * (yDotK[6][i]))) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.b_08) * (yDotK[7][i]))) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.b_09) * (yDotK[8][i]))) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.b_10) * (yDotK[9][i]))) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.b_11) * (yDotK[10][i]))) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.b_12) * (yDotK[11][i])));
				...
				for (int k = 0; k < (org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.d.length); ++k) {
					v[(k + 3)][i] = (h) * (((((((((((((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.d[k][0]) * (yDotK[0][i])) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.d[k][1]) * (yDotK[5][i]))) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.d[k][2]) * (yDotK[6][i]))) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.d[k][3]) * (yDotK[7][i]))) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.d[k][4]) * (yDotK[8][i]))) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.d[k][5]) * (yDotK[9][i]))) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.d[k][6]) * (yDotK[10][i]))) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.d[k][7]) * (yDotK[11][i]))) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.d[k][8]) * (yDotK[12][i]))) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.d[k][9]) * (yDotKLast[0][i]))) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.d[k][10]) * (yDotKLast[1][i]))) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.d[k][11]) * (yDotKLast[2][i])));
				}
			}
