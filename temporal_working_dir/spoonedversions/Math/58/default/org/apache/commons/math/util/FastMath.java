...
public class FastMath {
	...
	static {
		...
		for (i = 1; i < (org.apache.commons.math.util.FastMath.FACT.length); i++) {
		...
		for (i = 0; i < (org.apache.commons.math.util.FastMath.EXP_FRAC_TABLE_A.length); i++) {
		...
		for (i = 0; i < (org.apache.commons.math.util.FastMath.LN_MANT.length); i++) {
	...
	private static double doubleHighPart(double d) {
		if ((d > (-(org.apache.commons.math.util.MathUtils.SAFE_MIN))) && (d < (org.apache.commons.math.util.MathUtils.SAFE_MIN))) {
			return d;
		}
	...
	private static void split(final double d, final double[] split) {
		if ((d < 8.0E298) && (d > (-8.0E298))) {
			final double a = d * (org.apache.commons.math.util.FastMath.HEX_40000000);
			split[0] = (d + a) - a;
			split[1] = d - (split[0]);
		}else {
			final double a = d * 9.313225746154785E-10;
			split[0] = ((d + a) - d) * (org.apache.commons.math.util.FastMath.HEX_40000000);
			split[1] = d - (split[0]);
		}
	}
	...
	private static void resplit(final double[] a) {
		...
		if ((c < 8.0E298) && (c > (-8.0E298))) {
			double z = c * (org.apache.commons.math.util.FastMath.HEX_40000000);
			a[0] = (c + z) - z;
			a[1] = (c - (a[0])) + d;
		}else {
			double z = c * 9.313225746154785E-10;
			a[0] = ((c + z) - c) * (org.apache.commons.math.util.FastMath.HEX_40000000);
			a[1] = (c - (a[0])) + d;
		}
	}
