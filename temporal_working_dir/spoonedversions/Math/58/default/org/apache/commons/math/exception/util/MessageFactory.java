...
public class MessageFactory {
	...
	public static java.lang.String buildMessage(java.util.Locale locale, org.apache.commons.math.exception.util.Localizable specific, org.apache.commons.math.exception.util.Localizable general, java.lang.Object... arguments) {
		...
		if (general != null) {
			final java.text.MessageFormat fmt = new java.text.MessageFormat(general.getLocalizedString(locale), locale);
		...
		if (specific != null) {
			...
			final java.text.MessageFormat fmt = new java.text.MessageFormat(specific.getLocalizedString(locale), locale);
			sb.append(fmt.format(arguments));
		}
		return sb.toString();
	}
