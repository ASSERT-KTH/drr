...
public class NaturalRanking implements org.apache.commons.math.stat.ranking.RankingAlgorithm {
	...
	public NaturalRanking() {
		super();
		tiesStrategy = org.apache.commons.math.stat.ranking.NaturalRanking.DEFAULT_TIES_STRATEGY;
		nanStrategy = org.apache.commons.math.stat.ranking.NaturalRanking.DEFAULT_NAN_STRATEGY;
		randomData = null;
	}
	...
	private void resolveTie(double[] ranks, java.util.List<java.lang.Integer> tiesTrace) {
		...
		switch (tiesStrategy) {
			...
			case SEQUENTIAL :
				...
				f = org.apache.commons.math.util.FastMath.round(c);
				int i = 0;
				while (iterator.hasNext()) {
