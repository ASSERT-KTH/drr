...
public class CMAESOptimizer extends org.apache.commons.math.optimization.direct.BaseAbstractScalarOptimizer<org.apache.commons.math.analysis.MultivariateRealFunction> implements org.apache.commons.math.optimization.MultivariateRealOptimizer {
	...
	protected org.apache.commons.math.optimization.RealPointValuePair doOptimize() {
		...
		final org.apache.commons.math.optimization.direct.CMAESOptimizer.FitnessFunction fitfun = new org.apache.commons.math.optimization.direct.CMAESOptimizer.FitnessFunction(boundaries, isMinimize);
	...
	private class FitnessFunction {
		...
		private FitnessFunction(final double[][] boundaries, final boolean isMinimize) {
			org.apache.commons.math.optimization.direct.CMAESOptimizer.FitnessFunction.this.boundaries = boundaries;
			org.apache.commons.math.optimization.direct.CMAESOptimizer.FitnessFunction.this.isMinimize = isMinimize;
		}
