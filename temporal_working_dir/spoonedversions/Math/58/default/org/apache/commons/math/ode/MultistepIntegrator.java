...
public abstract class MultistepIntegrator extends org.apache.commons.math.ode.nonstiff.AdaptiveStepsizeIntegrator {
	...
	protected void start(final double t0, final double[] y0, final double t) throws org.apache.commons.math.exception.MathUserException, org.apache.commons.math.ode.IntegratorException {
		starter.clearEventHandlers();
		starter.clearStepHandlers();
		starter.addStepHandler(new org.apache.commons.math.ode.MultistepIntegrator.NordsieckInitializer(y0.length));
		try {
	...
	private class NordsieckInitializer implements org.apache.commons.math.ode.sampling.StepHandler {
		...
		public void handleStep(org.apache.commons.math.ode.sampling.StepInterpolator interpolator, boolean isLast) throws org.apache.commons.math.exception.MathUserException {
	...
	private static class InitializationCompletedMarkerException extends org.apache.commons.math.exception.MathUserException {
	...
	private class CountingDifferentialEquations implements org.apache.commons.math.ode.ExtendedFirstOrderDifferentialEquations {
		...
		public void computeDerivatives(double t, double[] y, double[] dot) throws org.apache.commons.math.exception.MathUserException {
