...
public class TrapezoidIntegrator extends org.apache.commons.math.analysis.integration.UnivariateRealIntegratorImpl {
	...
	public TrapezoidIntegrator() {
		super(org.apache.commons.math.analysis.integration.UnivariateRealIntegratorImpl.DEFAULT_MIN_ITERATIONS_COUNT, org.apache.commons.math.analysis.integration.TrapezoidIntegrator.TRAPEZOID_MAX_ITERATIONS_COUNT);
	}

	double stage(final org.apache.commons.math.analysis.integration.UnivariateRealIntegratorImpl baseIntegrator, final int n) throws org.apache.commons.math.exception.TooManyEvaluationsException {
		if (n == 0) {
