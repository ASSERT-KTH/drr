...
public class MatrixUtils {
	...
	public static <T extends org.apache.commons.math.FieldElement<T>> org.apache.commons.math.linear.FieldMatrix<T> createFieldIdentityMatrix(final org.apache.commons.math.Field<T> field, final int dimension) {
		...
		return new org.apache.commons.math.linear.Array2DRowFieldMatrix<T>(field, d, false);
	}
	...
	public static <T extends org.apache.commons.math.FieldElement<T>> org.apache.commons.math.linear.FieldVector<T> createFieldVector(final T[] data) {
		...
		return new org.apache.commons.math.linear.ArrayFieldVector<T>(data[0].getField(), data, true);
	}
	...
	public static void checkAdditionCompatible(final org.apache.commons.math.linear.AnyMatrix left, final org.apache.commons.math.linear.AnyMatrix right) {
		if (((left.getRowDimension()) != (right.getRowDimension())) || ((left.getColumnDimension()) != (right.getColumnDimension()))) {
			throw new org.apache.commons.math.linear.MatrixDimensionMismatchException(left.getRowDimension(), left.getColumnDimension(), right.getRowDimension(), right.getColumnDimension());
		}
	}
	...
	public static void solveLowerTriangularSystem(org.apache.commons.math.linear.RealMatrix rm, org.apache.commons.math.linear.RealVector b) {
		if (((rm == null) || (b == null)) || ((rm.getRowDimension()) != (b.getDimension()))) {
			throw new org.apache.commons.math.exception.MathIllegalArgumentException(org.apache.commons.math.exception.util.LocalizedFormats.DIMENSIONS_MISMATCH_SIMPLE, (rm == null ? 0 : rm.getRowDimension()), (b == null ? 0 : b.getDimension()));
		}
		if ((rm.getColumnDimension()) != (rm.getRowDimension())) {
			throw new org.apache.commons.math.exception.MathIllegalArgumentException(org.apache.commons.math.exception.util.LocalizedFormats.DIMENSIONS_MISMATCH_2x2, rm.getRowDimension(), rm.getRowDimension(), rm.getRowDimension(), rm.getColumnDimension());
		}
		int rows = rm.getRowDimension();
		for (int i = 0; i < rows; i++) {
			double diag = rm.getEntry(i, i);
			if ((org.apache.commons.math.util.FastMath.abs(diag)) < (org.apache.commons.math.util.Precision.SAFE_MIN)) {
				throw new org.apache.commons.math.exception.MathArithmeticException(org.apache.commons.math.exception.util.LocalizedFormats.ZERO_DENOMINATOR);
			}
	...
	public static void solveUpperTriangularSystem(org.apache.commons.math.linear.RealMatrix rm, org.apache.commons.math.linear.RealVector b) {
		if (((rm == null) || (b == null)) || ((rm.getRowDimension()) != (b.getDimension()))) {
			throw new org.apache.commons.math.exception.MathIllegalArgumentException(org.apache.commons.math.exception.util.LocalizedFormats.DIMENSIONS_MISMATCH_SIMPLE, (rm == null ? 0 : rm.getRowDimension()), (b == null ? 0 : b.getDimension()));
		}
		if ((rm.getColumnDimension()) != (rm.getRowDimension())) {
