...
public class CurveFitter {
	...
	public double[] fit(int maxEval, final org.apache.commons.math.analysis.ParametricUnivariateFunction f, final double[] initialGuess) {
		...
		org.apache.commons.math.optimization.VectorialPointValuePair optimum = optimizer.optimize(maxEval, new org.apache.commons.math.optimization.fitting.CurveFitter.TheoreticalValuesFunction(f), target, weights, initialGuess);
