...
public class VectorialMean implements java.io.Serializable {
	...
	public void increment(double[] v) {
		if ((v.length) != (means.length)) {
			throw new org.apache.commons.math.exception.DimensionMismatchException(v.length, means.length);
		}
	...
	public boolean equals(java.lang.Object obj) {
		if ((org.apache.commons.math.stat.descriptive.moment.VectorialMean.this) == obj) {
			return true;
		}
