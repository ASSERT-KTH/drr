...
public abstract class AbstractStepInterpolator implements org.apache.commons.math.ode.sampling.StepInterpolator {
	...
	private org.apache.commons.math.ode.EquationsMapper primaryMapper;

	private org.apache.commons.math.ode.EquationsMapper[] secondaryMappers;
	...
	protected AbstractStepInterpolator(final double[] y, final boolean forward, final org.apache.commons.math.ode.EquationsMapper primaryMapper, final org.apache.commons.math.ode.EquationsMapper[] secondaryMappers) {
		globalPreviousTime = java.lang.Double.NaN;
		globalCurrentTime = java.lang.Double.NaN;
		softPreviousTime = java.lang.Double.NaN;
		softCurrentTime = java.lang.Double.NaN;
		...
		org.apache.commons.math.ode.sampling.AbstractStepInterpolator.this.dirtyState = true;
		org.apache.commons.math.ode.sampling.AbstractStepInterpolator.this.primaryMapper = primaryMapper;
		org.apache.commons.math.ode.sampling.AbstractStepInterpolator.this.secondaryMappers = (secondaryMappers == null) ? null : secondaryMappers.clone();
	...
	protected void reinitialize(final double[] y, final boolean isForward, final org.apache.commons.math.ode.EquationsMapper primary, final org.apache.commons.math.ode.EquationsMapper[] secondary) {
		globalPreviousTime = java.lang.Double.NaN;
		globalCurrentTime = java.lang.Double.NaN;
		softPreviousTime = java.lang.Double.NaN;
		softCurrentTime = java.lang.Double.NaN;
		...
		org.apache.commons.math.ode.sampling.AbstractStepInterpolator.this.dirtyState = true;
		org.apache.commons.math.ode.sampling.AbstractStepInterpolator.this.primaryMapper = primary;
		org.apache.commons.math.ode.sampling.AbstractStepInterpolator.this.secondaryMappers = secondary.clone();
		allocateInterpolatedArrays(y.length);
	}

	public org.apache.commons.math.ode.sampling.StepInterpolator copy() {
		finalizeStep();
		return doCopy();
	}
	...
	protected void writeBaseExternal(final java.io.ObjectOutput out) throws java.io.IOException {
		...
		for (final org.apache.commons.math.ode.EquationsMapper mapper : secondaryMappers) {
	...
	protected double readBaseExternal(final java.io.ObjectInput in) throws java.io.IOException, java.lang.ClassNotFoundException {
		...
		primaryMapper = ((org.apache.commons.math.ode.EquationsMapper) (in.readObject()));
		secondaryMappers = new org.apache.commons.math.ode.EquationsMapper[in.read()];
		for (int i = 0; i < (secondaryMappers.length); ++i) {
			secondaryMappers[i] = ((org.apache.commons.math.ode.EquationsMapper) (in.readObject()));
		}
		dirtyState = true;
		if (dimension < 0) {
			currentState = null;
