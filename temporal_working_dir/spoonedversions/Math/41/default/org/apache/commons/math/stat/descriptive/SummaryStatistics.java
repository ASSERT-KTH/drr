...
public class SummaryStatistics implements java.io.Serializable , org.apache.commons.math.stat.descriptive.StatisticalSummary {
	...
	protected org.apache.commons.math.stat.descriptive.moment.Mean mean = new org.apache.commons.math.stat.descriptive.moment.Mean(secondMoment);

	protected org.apache.commons.math.stat.descriptive.moment.Variance variance = new org.apache.commons.math.stat.descriptive.moment.Variance(secondMoment);
	...
	public SummaryStatistics(org.apache.commons.math.stat.descriptive.SummaryStatistics original) {
		org.apache.commons.math.stat.descriptive.SummaryStatistics.copy(original, org.apache.commons.math.stat.descriptive.SummaryStatistics.this);
	}
	...
	public double getPopulationVariance() {
		org.apache.commons.math.stat.descriptive.moment.Variance populationVariance = new org.apache.commons.math.stat.descriptive.moment.Variance(secondMoment);
	...
	public boolean equals(java.lang.Object object) {
		...
		return (((((((org.apache.commons.math.util.Precision.equalsIncludingNaN(stat.getGeometricMean(), getGeometricMean())) && (org.apache.commons.math.util.Precision.equalsIncludingNaN(stat.getMax(), getMax()))) && (org.apache.commons.math.util.Precision.equalsIncludingNaN(stat.getMean(), getMean()))) && (org.apache.commons.math.util.Precision.equalsIncludingNaN(stat.getMin(), getMin()))) && (org.apache.commons.math.util.Precision.equalsIncludingNaN(stat.getN(), getN()))) && (org.apache.commons.math.util.Precision.equalsIncludingNaN(stat.getSum(), getSum()))) && (org.apache.commons.math.util.Precision.equalsIncludingNaN(stat.getSumsq(), getSumsq()))) && (org.apache.commons.math.util.Precision.equalsIncludingNaN(stat.getVariance(), getVariance()));
	}
	...
	private void checkEmpty() {
		if ((n) > 0) {
			throw new org.apache.commons.math.exception.MathIllegalStateException(org.apache.commons.math.exception.util.LocalizedFormats.VALUES_ADDED_BEFORE_CONFIGURING_STATISTIC, n);
		}
	}
	...
	public org.apache.commons.math.stat.descriptive.SummaryStatistics copy() {
		...
		org.apache.commons.math.stat.descriptive.SummaryStatistics.copy(org.apache.commons.math.stat.descriptive.SummaryStatistics.this, result);
		return result;
	}

	public static void copy(org.apache.commons.math.stat.descriptive.SummaryStatistics source, org.apache.commons.math.stat.descriptive.SummaryStatistics dest) throws org.apache.commons.math.exception.NullArgumentException {
		...
		dest.n = source.n;
		if ((source.getVarianceImpl()) instanceof org.apache.commons.math.stat.descriptive.moment.Variance) {
			dest.varianceImpl = new org.apache.commons.math.stat.descriptive.moment.Variance(dest.secondMoment);
		}else {
			dest.varianceImpl = source.varianceImpl.copy();
		}
		if ((source.meanImpl) instanceof org.apache.commons.math.stat.descriptive.moment.Mean) {
			dest.meanImpl = new org.apache.commons.math.stat.descriptive.moment.Mean(dest.secondMoment);
		}else {
