...
public class Rotation implements java.io.Serializable {
	...
	public Rotation(double[][] m, double threshold) throws org.apache.commons.math.geometry.NotARotationMatrixException {
		if (((((m.length) != 3) || ((m[0].length) != 3)) || ((m[1].length) != 3)) || ((m[2].length) != 3)) {
			throw new org.apache.commons.math.geometry.NotARotationMatrixException(("a {0}x{1} matrix" + " cannot be a rotation matrix"), new java.lang.String[]{ java.lang.Integer.toString(m.length) , java.lang.Integer.toString(m[0].length) });
		}
		...
		if (det < 0.0) {
			throw new org.apache.commons.math.geometry.NotARotationMatrixException(("the closest orthogonal matrix" + " has a negative determinant {0}"), new java.lang.String[]{ java.lang.Double.toString(det) });
		}
	...
	public double[] getAngles(org.apache.commons.math.geometry.RotationOrder order) throws org.apache.commons.math.geometry.CardanEulerSingularityException {
		...
		org.apache.commons.math.geometry.Vector3D v1 = null;
		org.apache.commons.math.geometry.Vector3D v2 = null;
		if (order == (org.apache.commons.math.geometry.RotationOrder.XYZ)) {
			v1 = applyTo(org.apache.commons.math.geometry.Vector3D.plusK);
			v2 = applyInverseTo(org.apache.commons.math.geometry.Vector3D.plusI);
			...
			angles[0] = java.lang.Math.atan2((-(v1.getY())), v1.getZ());
			angles[1] = java.lang.Math.asin(v2.getZ());
			angles[2] = java.lang.Math.atan2((-(v2.getY())), v2.getX());
		}else
			if (order == (org.apache.commons.math.geometry.RotationOrder.XZY)) {
				v1 = applyTo(org.apache.commons.math.geometry.Vector3D.plusJ);
				v2 = applyInverseTo(org.apache.commons.math.geometry.Vector3D.plusI);
				if (((v2.getY()) < minThreshold) || ((v2.getY()) > maxThreshold)) {
					throw new org.apache.commons.math.geometry.CardanEulerSingularityException(true);
				}
				angles[0] = java.lang.Math.atan2(v1.getZ(), v1.getY());
				angles[1] = -(java.lang.Math.asin(v2.getY()));
				angles[2] = java.lang.Math.atan2(v2.getZ(), v2.getX());
			}else
				if (order == (org.apache.commons.math.geometry.RotationOrder.YXZ)) {
					v1 = applyTo(org.apache.commons.math.geometry.Vector3D.plusK);
					v2 = applyInverseTo(org.apache.commons.math.geometry.Vector3D.plusJ);
					if (((v2.getZ()) < minThreshold) || ((v2.getZ()) > maxThreshold)) {
						throw new org.apache.commons.math.geometry.CardanEulerSingularityException(true);
					}
					angles[0] = java.lang.Math.atan2(v1.getX(), v1.getZ());
					angles[1] = -(java.lang.Math.asin(v2.getZ()));
					angles[2] = java.lang.Math.atan2(v2.getX(), v2.getY());
				}else
					if (order == (org.apache.commons.math.geometry.RotationOrder.YZX)) {
						v1 = applyTo(org.apache.commons.math.geometry.Vector3D.plusI);
						v2 = applyInverseTo(org.apache.commons.math.geometry.Vector3D.plusJ);
						if (((v2.getX()) < minThreshold) || ((v2.getX()) > maxThreshold)) {
							throw new org.apache.commons.math.geometry.CardanEulerSingularityException(true);
						}
						angles[0] = java.lang.Math.atan2((-(v1.getZ())), v1.getX());
						angles[1] = java.lang.Math.asin(v2.getX());
						angles[2] = java.lang.Math.atan2((-(v2.getZ())), v2.getY());
					}else
						if (order == (org.apache.commons.math.geometry.RotationOrder.ZXY)) {
							v1 = applyTo(org.apache.commons.math.geometry.Vector3D.plusJ);
							v2 = applyInverseTo(org.apache.commons.math.geometry.Vector3D.plusK);
							if (((v2.getY()) < minThreshold) || ((v2.getY()) > maxThreshold)) {
								throw new org.apache.commons.math.geometry.CardanEulerSingularityException(true);
							}
							angles[0] = java.lang.Math.atan2((-(v1.getX())), v1.getY());
							angles[1] = java.lang.Math.asin(v2.getY());
							angles[2] = java.lang.Math.atan2((-(v2.getX())), v2.getZ());
						}else
							if (order == (org.apache.commons.math.geometry.RotationOrder.ZYX)) {
								...
								angles[0] = java.lang.Math.atan2(v1.getY(), v1.getX());
								angles[1] = -(java.lang.Math.asin(v2.getX()));
								angles[2] = java.lang.Math.atan2(v2.getY(), v2.getZ());
							}else
								if (order == (org.apache.commons.math.geometry.RotationOrder.XYX)) {
									...
									angles[0] = java.lang.Math.atan2(v1.getY(), (-(v1.getZ())));
									angles[1] = java.lang.Math.acos(v2.getX());
									angles[2] = java.lang.Math.atan2(v2.getY(), v2.getZ());
								}else
									if (order == (org.apache.commons.math.geometry.RotationOrder.XZX)) {
										...
										if (order == (org.apache.commons.math.geometry.RotationOrder.YXY)) {
											...
											angles[0] = java.lang.Math.atan2(v1.getX(), v1.getZ());
											angles[1] = java.lang.Math.acos(v2.getY());
											angles[2] = java.lang.Math.atan2(v2.getX(), (-(v2.getZ())));
										}else
											if (order == (org.apache.commons.math.geometry.RotationOrder.YZY)) {
												...
												if (order == (org.apache.commons.math.geometry.RotationOrder.ZXZ)) {
													...
													angles[0] = java.lang.Math.atan2(v1.getX(), (-(v1.getY())));
													angles[1] = java.lang.Math.acos(v2.getZ());
													angles[2] = java.lang.Math.atan2(v2.getX(), v2.getY());
												}else {
													v1 = applyTo(org.apache.commons.math.geometry.Vector3D.plusK);
													v2 = applyInverseTo(org.apache.commons.math.geometry.Vector3D.plusK);
	...
	private double[][] orthogonalizeMatrix(double[][] m, double threshold) throws org.apache.commons.math.geometry.NotARotationMatrixException {
		...
		throw new org.apache.commons.math.geometry.NotARotationMatrixException(("unable to orthogonalize matrix" + " in {0} iterations"), new java.lang.String[]{ java.lang.Integer.toString((i - 1)) });
	}
