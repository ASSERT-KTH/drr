...
public class SingularValueDecompositionImpl implements org.apache.commons.math.linear.SingularValueDecomposition {
	...
	public SingularValueDecompositionImpl(final org.apache.commons.math.linear.RealMatrix matrix) {
		...
		int nu = org.apache.commons.math.util.FastMath.min(m, n);
		singularValues = new double[org.apache.commons.math.util.FastMath.min(((m) + 1), n)];
		...
		boolean wantu = true;
		boolean wantv = true;
		int nct = org.apache.commons.math.util.FastMath.min(((m) - 1), n);
		int nrt = org.apache.commons.math.util.FastMath.max(0, org.apache.commons.math.util.FastMath.min(((n) - 2), m));
		...
		int p = org.apache.commons.math.util.FastMath.min(n, ((m) + 1));
		if (nct < (n)) {
		...
		while (p > 0) {
			...
			for (k = p - 2; k >= (-1); k--) {
				...
				final double threshold = (org.apache.commons.math.linear.SingularValueDecompositionImpl.TINY) + ((org.apache.commons.math.linear.SingularValueDecompositionImpl.EPS) * ((org.apache.commons.math.util.FastMath.abs(singularValues[k])) + (org.apache.commons.math.util.FastMath.abs(singularValues[(k + 1)]))));
			...
			if (k == (p - 2)) {
				...
				for (ks = p - 1; ks >= k; ks--) {
					...
					double t = (ks != p ? org.apache.commons.math.util.FastMath.abs(e[ks]) : 0.0) + (ks != (k + 1) ? org.apache.commons.math.util.FastMath.abs(e[(ks - 1)]) : 0.0);
					if ((org.apache.commons.math.util.FastMath.abs(singularValues[ks])) <= ((org.apache.commons.math.linear.SingularValueDecompositionImpl.TINY) + ((org.apache.commons.math.linear.SingularValueDecompositionImpl.EPS) * t))) {
			...
			switch (kase) {
				...
				case 3 :
					{
						double scale = org.apache.commons.math.util.FastMath.max(org.apache.commons.math.util.FastMath.max(org.apache.commons.math.util.FastMath.max(org.apache.commons.math.util.FastMath.max(org.apache.commons.math.util.FastMath.abs(singularValues[(p - 1)]), org.apache.commons.math.util.FastMath.abs(singularValues[(p - 2)])), org.apache.commons.math.util.FastMath.abs(e[(p - 2)])), org.apache.commons.math.util.FastMath.abs(singularValues[k])), org.apache.commons.math.util.FastMath.abs(e[k]));
	...
	public double getConditionNumber() {
		return (singularValues[0]) / (singularValues[((org.apache.commons.math.util.FastMath.min(m, n)) - 1)]);
	}

	public int getRank() {
		double tol = ((org.apache.commons.math.util.FastMath.max(m, n)) * (singularValues[0])) * (org.apache.commons.math.linear.SingularValueDecompositionImpl.EPS);
		int r = 0;
