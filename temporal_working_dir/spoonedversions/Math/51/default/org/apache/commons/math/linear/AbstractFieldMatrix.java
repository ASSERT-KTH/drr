...
public abstract class AbstractFieldMatrix<T extends org.apache.commons.math.FieldElement<T>> implements org.apache.commons.math.linear.FieldMatrix<T> {
	...
	public org.apache.commons.math.linear.FieldMatrix<T> power(final int p) {
		if (p < 0) {
		...
		if (p == 0) {
			return org.apache.commons.math.linear.MatrixUtils.createFieldIdentityMatrix(org.apache.commons.math.linear.AbstractFieldMatrix.this.getField(), org.apache.commons.math.linear.AbstractFieldMatrix.this.getRowDimension());
		}
		if (p == 1) {
			return org.apache.commons.math.linear.AbstractFieldMatrix.this.copy();
		}
		final int power = p - 1;
		...
		java.util.ArrayList<org.apache.commons.math.linear.FieldMatrix<T>> results = new java.util.ArrayList<org.apache.commons.math.linear.FieldMatrix<T>>(binaryRepresentation.length);
		results.add(0, org.apache.commons.math.linear.AbstractFieldMatrix.this.copy());
		for (int i = 1; i < (binaryRepresentation.length); ++i) {
			final org.apache.commons.math.linear.FieldMatrix<T> s = results.get((i - 1));
			final org.apache.commons.math.linear.FieldMatrix<T> r = s.multiply(s);
			results.add(i, r);
		}
		org.apache.commons.math.linear.FieldMatrix<T> result = org.apache.commons.math.linear.AbstractFieldMatrix.this.copy();
	...
	public org.apache.commons.math.linear.FieldVector<T> getRowVector(final int row) {
		return new org.apache.commons.math.linear.ArrayFieldVector<T>(field, getRow(row), false);
	}
	...
	public org.apache.commons.math.linear.FieldVector<T> getColumnVector(final int column) {
		return new org.apache.commons.math.linear.ArrayFieldVector<T>(field, getColumn(column), false);
	}
	...
	public org.apache.commons.math.linear.FieldVector<T> operate(final org.apache.commons.math.linear.FieldVector<T> v) {
		try {
			return new org.apache.commons.math.linear.ArrayFieldVector<T>(field, operate(((org.apache.commons.math.linear.ArrayFieldVector<T>) (v)).getDataRef()), false);
	...
	public org.apache.commons.math.linear.FieldVector<T> preMultiply(final org.apache.commons.math.linear.FieldVector<T> v) {
		try {
			return new org.apache.commons.math.linear.ArrayFieldVector<T>(field, preMultiply(((org.apache.commons.math.linear.ArrayFieldVector<T>) (v)).getDataRef()), false);
		} catch (java.lang.ClassCastException cce) {
			final int nRows = getRowDimension();
			final int nCols = getColumnDimension();
