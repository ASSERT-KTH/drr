...
public class Skewness extends org.apache.commons.math.stat.descriptive.AbstractStorelessUnivariateStatistic implements java.io.Serializable {
	...
	public Skewness(org.apache.commons.math.stat.descriptive.moment.Skewness original) {
		org.apache.commons.math.stat.descriptive.moment.Skewness.copy(original, org.apache.commons.math.stat.descriptive.moment.Skewness.this);
	}
	...
	public double getResult() {
		...
		if (variance < 1.0E-19) {
			...
			return (n0 * (moment.m3)) / ((((n0 - 1) * (n0 - 2)) * (org.apache.commons.math.util.FastMath.sqrt(variance))) * variance);
		}
	}
	...
	public double evaluate(final double[] values, final int begin, final int length) {
		...
		if ((test(values, begin, length)) && (length > 2)) {
			...
			accum3 /= variance * (org.apache.commons.math.util.FastMath.sqrt(variance));
			double n0 = length;
	...
	public org.apache.commons.math.stat.descriptive.moment.Skewness copy() {
		...
		org.apache.commons.math.stat.descriptive.moment.Skewness.copy(org.apache.commons.math.stat.descriptive.moment.Skewness.this, result);
		return result;
	}

	public static void copy(org.apache.commons.math.stat.descriptive.moment.Skewness source, org.apache.commons.math.stat.descriptive.moment.Skewness dest) throws org.apache.commons.math.exception.NullArgumentException {
