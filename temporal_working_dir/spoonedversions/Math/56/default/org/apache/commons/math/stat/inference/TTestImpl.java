...
public class TTestImpl implements org.apache.commons.math.stat.inference.TTest {
	...
	public boolean tTest(org.apache.commons.math.stat.descriptive.StatisticalSummary sampleStats1, org.apache.commons.math.stat.descriptive.StatisticalSummary sampleStats2, double alpha) throws org.apache.commons.math.MathException {
		checkSignificanceLevel(alpha);
	...
	protected double tTest(double m, double mu, double v, double n) throws org.apache.commons.math.MathException {
		...
		org.apache.commons.math.distribution.TDistribution distribution = new org.apache.commons.math.distribution.TDistributionImpl((n - 1));
	...
	protected double tTest(double m1, double m2, double v1, double v2, double n1, double n2) throws org.apache.commons.math.MathException {
		...
		org.apache.commons.math.distribution.TDistribution distribution = new org.apache.commons.math.distribution.TDistributionImpl(degreesOfFreedom);
		return 2.0 * (distribution.cumulativeProbability((-t)));
	}
	...
	private void checkSampleData(final org.apache.commons.math.stat.descriptive.StatisticalSummary stat) {
		if (stat == null) {
			throw new org.apache.commons.math.exception.NullArgumentException();
		}
		if ((stat.getN()) < 2) {
