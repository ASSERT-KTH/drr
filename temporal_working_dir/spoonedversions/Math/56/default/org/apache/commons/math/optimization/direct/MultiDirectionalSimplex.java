...
public class MultiDirectionalSimplex extends org.apache.commons.math.optimization.direct.AbstractSimplex {
	...
	@java.lang.Override
	public void iterate(final org.apache.commons.math.analysis.MultivariateRealFunction evaluationFunction, final java.util.Comparator<org.apache.commons.math.optimization.RealPointValuePair> comparator) throws org.apache.commons.math.exception.MathUserException {
		final org.apache.commons.math.optimization.RealPointValuePair[] original = getPoints();
		final org.apache.commons.math.optimization.RealPointValuePair best = original[0];
		final org.apache.commons.math.optimization.RealPointValuePair reflected = evaluateNewSimplex(evaluationFunction, original, 1, comparator);
		if ((comparator.compare(reflected, best)) < 0) {
			final org.apache.commons.math.optimization.RealPointValuePair[] reflectedSimplex = getPoints();
			final org.apache.commons.math.optimization.RealPointValuePair expanded = evaluateNewSimplex(evaluationFunction, original, khi, comparator);
	...
	private org.apache.commons.math.optimization.RealPointValuePair evaluateNewSimplex(final org.apache.commons.math.analysis.MultivariateRealFunction evaluationFunction, final org.apache.commons.math.optimization.RealPointValuePair[] original, final double coeff, final java.util.Comparator<org.apache.commons.math.optimization.RealPointValuePair> comparator) throws org.apache.commons.math.exception.MathUserException {
		...
		for (int i = 1; i < (getSize()); i++) {
			...
			setPoint(i, new org.apache.commons.math.optimization.RealPointValuePair(xTransformed, java.lang.Double.NaN, false));
		}
