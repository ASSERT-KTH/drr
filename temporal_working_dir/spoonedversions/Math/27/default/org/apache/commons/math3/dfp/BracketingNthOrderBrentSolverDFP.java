...
public class BracketingNthOrderBrentSolverDFP {
	...
	public org.apache.commons.math3.dfp.Dfp solve(final int maxEval, final org.apache.commons.math3.dfp.UnivariateDfpFunction f, final org.apache.commons.math3.dfp.Dfp min, final org.apache.commons.math3.dfp.Dfp max, final org.apache.commons.math3.analysis.solvers.AllowedSolution allowedSolution) {
		return solve(maxEval, f, min, max, min.add(max).divide(2), allowedSolution);
	}

	public org.apache.commons.math3.dfp.Dfp solve(final int maxEval, final org.apache.commons.math3.dfp.UnivariateDfpFunction f, final org.apache.commons.math3.dfp.Dfp min, final org.apache.commons.math3.dfp.Dfp max, final org.apache.commons.math3.dfp.Dfp startValue, final org.apache.commons.math3.analysis.solvers.AllowedSolution allowedSolution) {
