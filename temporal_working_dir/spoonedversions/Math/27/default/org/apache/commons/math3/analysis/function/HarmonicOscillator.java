...
public class HarmonicOscillator implements org.apache.commons.math3.analysis.DifferentiableUnivariateFunction {
	...
	public org.apache.commons.math3.analysis.UnivariateFunction derivative() {
		return new org.apache.commons.math3.analysis.UnivariateFunction() {
			public double value(double x) {
				return ((-(amplitude)) * (omega)) * (org.apache.commons.math3.util.FastMath.sin((((omega) * x) + (phase))));
			}
		};
	}
