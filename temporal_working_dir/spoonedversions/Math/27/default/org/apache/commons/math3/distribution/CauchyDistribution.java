...
public class CauchyDistribution extends org.apache.commons.math3.distribution.AbstractRealDistribution {
	...
	public CauchyDistribution(double median, double scale, double inverseCumAccuracy) {
		this(new org.apache.commons.math3.random.Well19937c(), median, scale, inverseCumAccuracy);
	}

	public CauchyDistribution(org.apache.commons.math3.random.RandomGenerator rng, double median, double scale, double inverseCumAccuracy) {
		super(rng);
		if (scale <= 0) {
