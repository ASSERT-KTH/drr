...
public class PolynomialFunction implements java.io.Serializable , org.apache.commons.math.analysis.DifferentiableUnivariateRealFunction {
	...
	public PolynomialFunction(double[] c) {
		super();
		if ((c.length) < 1) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.analysis.polynomials.PolynomialFunction.EMPTY_ARRAY_MESSAGE);
		}
		int l = c.length;
		while ((l > 1) && ((c[(l - 1)]) == 0)) {
			--l;
