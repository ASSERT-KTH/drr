...
public abstract class MultistepStepInterpolator extends org.apache.commons.math.ode.sampling.AbstractStepInterpolator {
	...
	public MultistepStepInterpolator(final org.apache.commons.math.ode.sampling.MultistepStepInterpolator interpolator) {
		super(interpolator);
	...
	public void reinitialize(final double[] y, final double[] previousT, final double[][] previousF, final boolean forward) {
		...
		org.apache.commons.math.ode.sampling.MultistepStepInterpolator.this.previousT = previousT;
		org.apache.commons.math.ode.sampling.MultistepStepInterpolator.this.previousF = previousF;
		initializeCoefficients();
	}
