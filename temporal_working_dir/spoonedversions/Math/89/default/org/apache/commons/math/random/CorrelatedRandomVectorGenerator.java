...
public class CorrelatedRandomVectorGenerator implements org.apache.commons.math.random.RandomVectorGenerator {
	...
	public CorrelatedRandomVectorGenerator(double[] mean, org.apache.commons.math.linear.RealMatrix covariance, double small, org.apache.commons.math.random.NormalizedRandomGenerator generator) throws org.apache.commons.math.DimensionMismatchException, org.apache.commons.math.linear.decomposition.NotPositiveDefiniteMatrixException {
		...
		org.apache.commons.math.random.CorrelatedRandomVectorGenerator.this.mean = mean.clone();
		decompose(covariance, small);
		org.apache.commons.math.random.CorrelatedRandomVectorGenerator.this.generator = generator;
		normalized = new double[rank];
	}

	public CorrelatedRandomVectorGenerator(org.apache.commons.math.linear.RealMatrix covariance, double small, org.apache.commons.math.random.NormalizedRandomGenerator generator) throws org.apache.commons.math.linear.decomposition.NotPositiveDefiniteMatrixException {
		int order = covariance.getRowDimension();
	...
	private void decompose(org.apache.commons.math.linear.RealMatrix covariance, double small) throws org.apache.commons.math.linear.decomposition.NotPositiveDefiniteMatrixException {
		int order = covariance.getRowDimension();
