...
public class LUDecompositionImpl implements org.apache.commons.math.linear.decomposition.LUDecomposition {
	...
	public LUDecompositionImpl(org.apache.commons.math.linear.RealMatrix matrix) throws org.apache.commons.math.linear.InvalidMatrixException {
		this(matrix, org.apache.commons.math.linear.decomposition.LUDecompositionImpl.DEFAULT_TOO_SMALL);
	}

	public LUDecompositionImpl(org.apache.commons.math.linear.RealMatrix matrix, double singularityThreshold) throws org.apache.commons.math.linear.decomposition.NonSquareMatrixException {
		if (!(matrix.isSquare())) {
	...
	public org.apache.commons.math.linear.decomposition.DecompositionSolver getSolver() {
		return new org.apache.commons.math.linear.decomposition.LUDecompositionImpl.Solver(lu, pivot, singular);
	}
