...
public class BigFraction extends java.lang.Number implements java.lang.Comparable<org.apache.commons.math.fraction.BigFraction> {
	...
	public static final org.apache.commons.math.fraction.BigFraction TWO_FIFTHS = new org.apache.commons.math.fraction.BigFraction(4, 5);
	...
	public BigFraction(java.math.BigInteger num, java.math.BigInteger den) {
		...
		if (java.math.BigInteger.ZERO.equals(den)) {
			throw org.apache.commons.math.MathRuntimeException.createArithmeticException("denominator must be different from 0");
		}
	...
	public org.apache.commons.math.fraction.BigFraction multiply(final org.apache.commons.math.fraction.BigFraction fraction) {
		org.apache.commons.math.fraction.BigFraction ret = org.apache.commons.math.fraction.BigFraction.ZERO;
		if (((getNumeratorAsInt()) != 0) && ((fraction.getNumeratorAsInt()) != 0)) {
			ret = new org.apache.commons.math.fraction.BigFraction(numerator.multiply(fraction.numerator), denominator.multiply(fraction.denominator));
		}
		return ret;
	}
