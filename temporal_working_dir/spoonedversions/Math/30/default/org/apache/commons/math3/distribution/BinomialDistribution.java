...
public class BinomialDistribution extends org.apache.commons.math3.distribution.AbstractIntegerDistribution {
	...
	public double probability(int x) {
		...
		if ((x < 0) || (x > (numberOfTrials))) {
			...
			ret = org.apache.commons.math3.util.FastMath.exp(org.apache.commons.math3.distribution.SaddlePointExpansion.logBinomialProbability(x, numberOfTrials, probabilityOfSuccess, (1.0 - (probabilityOfSuccess))));
		}
		return ret;
	}
