...
public class ExceptionContext implements java.io.Serializable {
	...
	private java.util.List<org.apache.commons.math3.exception.util.Localizable> msgPatterns;
	...
	public ExceptionContext(final java.lang.Throwable throwable) {
		org.apache.commons.math3.exception.util.ExceptionContext.this.throwable = throwable;
		msgPatterns = new java.util.ArrayList<org.apache.commons.math3.exception.util.Localizable>();
	...
	public void addMessage(org.apache.commons.math3.exception.util.Localizable pattern, java.lang.Object... arguments) {
		msgPatterns.add(pattern);
		msgArguments.add(org.apache.commons.math3.exception.util.ArgUtils.flatten(arguments));
	}
	...
	private java.lang.String buildMessage(java.util.Locale locale, java.lang.String separator) {
		...
		for (int i = 0; i < len; i++) {
			final org.apache.commons.math3.exception.util.Localizable pat = msgPatterns.get(i);
	...
	private void deSerializeMessages(java.io.ObjectInputStream in) throws java.io.IOException, java.lang.ClassNotFoundException {
		...
		msgPatterns = new java.util.ArrayList<org.apache.commons.math3.exception.util.Localizable>(len);
		msgArguments = new java.util.ArrayList<java.lang.Object[]>(len);
		for (int i = 0; i < len; i++) {
			final org.apache.commons.math3.exception.util.Localizable pat = ((org.apache.commons.math3.exception.util.Localizable) (in.readObject()));
			msgPatterns.add(pat);
