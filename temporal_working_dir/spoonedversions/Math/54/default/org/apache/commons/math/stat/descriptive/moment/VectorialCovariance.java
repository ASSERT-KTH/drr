...
public class VectorialCovariance implements java.io.Serializable {
	...
	public void increment(double[] v) throws org.apache.commons.math.exception.DimensionMismatchException {
		if ((v.length) != (sums.length)) {
			throw new org.apache.commons.math.exception.DimensionMismatchException(v.length, sums.length);
		}
		int k = 0;
	...
	public boolean equals(java.lang.Object obj) {
		if ((org.apache.commons.math.stat.descriptive.moment.VectorialCovariance.this) == obj)
			return true;
