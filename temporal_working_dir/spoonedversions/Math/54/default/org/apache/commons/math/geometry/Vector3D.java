...
public class Vector3D implements java.io.Serializable {
	...
	public static org.apache.commons.math.geometry.Vector3D crossProduct(final org.apache.commons.math.geometry.Vector3D v1, final org.apache.commons.math.geometry.Vector3D v2) {
		...
		final double x1 = org.apache.commons.math.util.FastMath.scalb(v1.x, (-deltaExp));
		final double y1 = org.apache.commons.math.util.FastMath.scalb(v1.y, (-deltaExp));
		final double z1 = org.apache.commons.math.util.FastMath.scalb(v1.z, (-deltaExp));
		final double x2 = org.apache.commons.math.util.FastMath.scalb(v2.x, deltaExp);
		final double y2 = org.apache.commons.math.util.FastMath.scalb(v2.y, deltaExp);
		final double z2 = org.apache.commons.math.util.FastMath.scalb(v2.z, deltaExp);
		...
		return new org.apache.commons.math.geometry.Vector3D(((y3 * z2) - (z3 * y2)), ((z3 * x2) - (x3 * z2)), ((x3 * y2) - (y3 * x2)));
	}

	public static double distance1(org.apache.commons.math.geometry.Vector3D v1, org.apache.commons.math.geometry.Vector3D v2) {
		final double dx = org.apache.commons.math.util.FastMath.abs(((v2.x) - (v1.x)));
		final double dy = org.apache.commons.math.util.FastMath.abs(((v2.y) - (v1.y)));
		final double dz = org.apache.commons.math.util.FastMath.abs(((v2.z) - (v1.z)));
		return (dx + dy) + dz;
	}
