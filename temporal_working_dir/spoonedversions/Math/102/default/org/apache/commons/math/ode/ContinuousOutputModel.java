...
public class ContinuousOutputModel implements java.io.Serializable , org.apache.commons.math.ode.StepHandler {
	...
	public void append(org.apache.commons.math.ode.ContinuousOutputModel model) throws org.apache.commons.math.ode.DerivativeException {
		...
		for (java.util.Iterator iter = model.steps.iterator(); iter.hasNext();) {
			steps.add(((org.apache.commons.math.ode.AbstractStepInterpolator) (iter.next())).copy());
		}
		index = (steps.size()) - 1;
	...
	public void handleStep(org.apache.commons.math.ode.StepInterpolator interpolator, boolean isLast) throws org.apache.commons.math.ode.DerivativeException {
		org.apache.commons.math.ode.AbstractStepInterpolator ai = ((org.apache.commons.math.ode.AbstractStepInterpolator) (interpolator));
		if ((steps.size()) == 0) {
	...
	public double getInterpolatedTime() {
		return ((org.apache.commons.math.ode.StepInterpolator) (steps.get(index))).getInterpolatedTime();
	}

	public void setInterpolatedTime(double time) {
		try {
			int iMin = 0;
			org.apache.commons.math.ode.StepInterpolator sMin = ((org.apache.commons.math.ode.StepInterpolator) (steps.get(iMin)));
			double tMin = 0.5 * ((sMin.getPreviousTime()) + (sMin.getCurrentTime()));
			int iMax = (steps.size()) - 1;
			org.apache.commons.math.ode.StepInterpolator sMax = ((org.apache.commons.math.ode.StepInterpolator) (steps.get(iMax)));
			...
			while ((iMax - iMin) > 5) {
				org.apache.commons.math.ode.StepInterpolator si = ((org.apache.commons.math.ode.StepInterpolator) (steps.get(index)));
				...
				org.apache.commons.math.ode.StepInterpolator sMed = ((org.apache.commons.math.ode.StepInterpolator) (steps.get(iMed)));
			...
			index = iMin;
			while (((index) <= iMax) && ((locatePoint(time, ((org.apache.commons.math.ode.StepInterpolator) (steps.get(index))))) > 0)) {
				++(index);
			} 
			org.apache.commons.math.ode.StepInterpolator si = ((org.apache.commons.math.ode.StepInterpolator) (steps.get(index)));
			si.setInterpolatedTime(time);
	...
	public double[] getInterpolatedState() {
		return ((org.apache.commons.math.ode.StepInterpolator) (steps.get(index))).getInterpolatedState();
	}
