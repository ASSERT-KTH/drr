...
public abstract class AdaptiveStepsizeIntegrator implements org.apache.commons.math.ode.FirstOrderIntegrator {
	...
	protected void sanityChecks(org.apache.commons.math.ode.FirstOrderDifferentialEquations equations, double t0, double[] y0, double t, double[] y) throws org.apache.commons.math.ode.IntegratorException {
		...
		if (((vecAbsoluteTolerance) != null) && ((vecAbsoluteTolerance.length) != (y0.length))) {
			throw new org.apache.commons.math.ode.IntegratorException(("dimensions mismatch: state vector has dimension {0}," + " absolute tolerance vector has dimension {1}"), new java.lang.String[]{ java.lang.Integer.toString(y0.length) , java.lang.Integer.toString(vecAbsoluteTolerance.length) });
		}
		if (((vecRelativeTolerance) != null) && ((vecRelativeTolerance.length) != (y0.length))) {
			throw new org.apache.commons.math.ode.IntegratorException(("dimensions mismatch: state vector has dimension {0}," + " relative tolerance vector has dimension {1}"), new java.lang.String[]{ java.lang.Integer.toString(y0.length) , java.lang.Integer.toString(vecRelativeTolerance.length) });
		}
