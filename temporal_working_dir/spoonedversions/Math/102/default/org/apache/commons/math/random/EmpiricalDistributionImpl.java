...
public class EmpiricalDistributionImpl implements java.io.Serializable , org.apache.commons.math.random.EmpiricalDistribution {
	...
	private java.util.ArrayList binStats = null;
	...
	public EmpiricalDistributionImpl() {
		binStats = new java.util.ArrayList();
	}
	...
	private class StreamDataAdapter extends org.apache.commons.math.random.EmpiricalDistributionImpl.DataAdapter {
		...
		public void computeBinStats(double min, double delta) throws java.io.IOException {
			...
			while ((str = inputStream.readLine()) != null) {
				...
				org.apache.commons.math.stat.descriptive.SummaryStatistics stats = ((org.apache.commons.math.stat.descriptive.SummaryStatistics) (binStats.get(findBin(min, val, delta))));
				stats.addValue(val);
			} 
			inputStream.close();
			inputStream = null;
		...
		public void computeStats() throws java.io.IOException {
			java.lang.String str = null;
			double val = 0.0;
			sampleStats = org.apache.commons.math.stat.descriptive.SummaryStatistics.newInstance();
			while ((str = inputStream.readLine()) != null) {
				val = new java.lang.Double(str).doubleValue();
	...
	private class ArrayDataAdapter extends org.apache.commons.math.random.EmpiricalDistributionImpl.DataAdapter {
		...
		public void computeBinStats(double min, double delta) throws java.io.IOException {
			for (int i = 0; i < (inputArray.length); i++) {
				org.apache.commons.math.stat.descriptive.SummaryStatistics stats = ((org.apache.commons.math.stat.descriptive.SummaryStatistics) (binStats.get(findBin(min, inputArray[i], delta))));
	...
	private void fillBinStats(java.lang.Object in) throws java.io.IOException {
		...
		double delta = (max - min) / (new java.lang.Double(binCount).doubleValue());
		...
		for (int i = 0; i < (binCount); i++) {
			org.apache.commons.math.stat.descriptive.SummaryStatistics stats = org.apache.commons.math.stat.descriptive.SummaryStatistics.newInstance();
		...
		upperBounds[0] = ((double) (((org.apache.commons.math.stat.descriptive.SummaryStatistics) (binStats.get(0))).getN())) / ((double) (sampleStats.getN()));
		for (int i = 1; i < ((binCount) - 1); i++) {
			upperBounds[i] = (upperBounds[(i - 1)]) + (((double) (((org.apache.commons.math.stat.descriptive.SummaryStatistics) (binStats.get(i))).getN())) / ((double) (sampleStats.getN())));
		}
	...
	public double getNextValue() throws java.lang.IllegalStateException {
		...
		for (int i = 0; i < (binCount); i++) {
			if (x <= (upperBounds[i])) {
				org.apache.commons.math.stat.descriptive.SummaryStatistics stats = ((org.apache.commons.math.stat.descriptive.SummaryStatistics) (binStats.get(i)));
				if ((stats.getN()) > 0) {
