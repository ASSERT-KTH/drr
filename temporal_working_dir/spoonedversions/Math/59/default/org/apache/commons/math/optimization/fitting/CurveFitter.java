...
public class CurveFitter {
	...
	public double[] fit(final org.apache.commons.math.optimization.fitting.ParametricRealFunction f, final double[] initialGuess) {
		return fit(java.lang.Integer.MAX_VALUE, f, initialGuess);
	}

	public double[] fit(int maxEval, final org.apache.commons.math.optimization.fitting.ParametricRealFunction f, final double[] initialGuess) {
