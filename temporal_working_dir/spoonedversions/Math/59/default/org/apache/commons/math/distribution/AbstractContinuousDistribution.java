		...
		org.apache.commons.math.analysis.UnivariateRealFunction rootFindingFunction = new org.apache.commons.math.analysis.UnivariateRealFunction() {
			public double value(double x) throws org.apache.commons.math.exception.MathUserException {
				...
				try {
					...
					throw new org.apache.commons.math.exception.MathUserException(ex, ex.getSpecificPattern(), ex.getGeneralPattern(), ex.getArguments());
				}
				if (java.lang.Double.isNaN(ret)) {
					throw new org.apache.commons.math.exception.MathUserException(org.apache.commons.math.exception.util.LocalizedFormats.CUMULATIVE_PROBABILITY_RETURNED_NAN, x, p);
				}
				return ret;
			}
		};
