...
public class DfpMath {
	...
	public static org.apache.commons.math.dfp.Dfp exp(final org.apache.commons.math.dfp.Dfp a) {
		...
		if (ia > 2147483646) {
			return a.newInstance(((byte) (1)), org.apache.commons.math.dfp.Dfp.INFINITE);
		}
		if (ia < (-2147483646)) {
	...
	public static org.apache.commons.math.dfp.Dfp log(org.apache.commons.math.dfp.Dfp a) {
		...
		if (((a.equals(a.getZero())) || (a.lessThan(a.getZero()))) || (a.isNaN())) {
			...
			return a.dotrap(org.apache.commons.math.dfp.DfpField.FLAG_INVALID, "ln", a, a.newInstance(((byte) (1)), org.apache.commons.math.dfp.Dfp.QNAN));
		}
	...
	public static org.apache.commons.math.dfp.Dfp pow(org.apache.commons.math.dfp.Dfp x, final org.apache.commons.math.dfp.Dfp y) {
		...
		if ((x.isNaN()) || (y.isNaN())) {
			x.getField().setIEEEFlagsBits(org.apache.commons.math.dfp.DfpField.FLAG_INVALID);
			return x.dotrap(org.apache.commons.math.dfp.DfpField.FLAG_INVALID, org.apache.commons.math.dfp.DfpMath.POW_TRAP, x, x.newInstance(((byte) (1)), org.apache.commons.math.dfp.Dfp.QNAN));
		}
		if (x.equals(zero)) {
			if (org.apache.commons.math.dfp.Dfp.copysign(one, x).greaterThan(zero)) {
				if (y.greaterThan(zero)) {
					...
					return x.newInstance(x.newInstance(((byte) (1)), org.apache.commons.math.dfp.Dfp.INFINITE));
				}
			}else {
