...
public class BracketFinder {
	...
	public BracketFinder(double growLimit, int maxEvaluations) {
		...
		if (maxEvaluations <= 0) {
			throw new org.apache.commons.math.exception.NotStrictlyPositiveException(maxEvaluations);
		}
		this.growLimit = growLimit;
		evaluations.setMaximalCount(maxEvaluations);
	}

	public void search(org.apache.commons.math.analysis.UnivariateRealFunction func, org.apache.commons.math.optimization.GoalType goal, double xA, double xB) throws org.apache.commons.math.exception.MathUserException {
	...
	private double eval(org.apache.commons.math.analysis.UnivariateRealFunction f, double x) throws org.apache.commons.math.exception.MathUserException {
		try {
