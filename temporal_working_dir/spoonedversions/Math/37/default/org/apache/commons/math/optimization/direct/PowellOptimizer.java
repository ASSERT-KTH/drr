...
public class PowellOptimizer extends org.apache.commons.math.optimization.direct.BaseAbstractMultivariateOptimizer<org.apache.commons.math.analysis.MultivariateFunction> implements org.apache.commons.math.optimization.MultivariateOptimizer {
	...
	public PowellOptimizer(double rel, double abs, org.apache.commons.math.optimization.ConvergenceChecker<org.apache.commons.math.optimization.RealPointValuePair> checker) {
		super(checker);
	...
	protected org.apache.commons.math.optimization.RealPointValuePair doOptimize() {
		...
		while (true) {
			...
			double alphaMin = 0;
			for (int i = 0; i < n; i++) {
				final double[] d = org.apache.commons.math.util.MathArrays.copyOf(direc[i]);
				fX2 = fVal;
