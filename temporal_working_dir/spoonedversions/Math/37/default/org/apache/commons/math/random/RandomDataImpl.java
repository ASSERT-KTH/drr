...
public class RandomDataImpl implements java.io.Serializable , org.apache.commons.math.random.RandomData {
	...
	public int nextInt(int lower, int upper) {
		...
		return ((int) (org.apache.commons.math.util.FastMath.floor(scaled)));
	}
	...
	public long nextLong(long lower, long upper) {
		...
		double r = getRan().nextDouble();
		double scaled = ((r * upper) + ((1.0 - r) * lower)) + r;
		return ((long) (org.apache.commons.math.util.FastMath.floor(scaled)));
	}
	...
	public double nextUniform(double lower, double upper, boolean lowerInclusive) {
		...
		if ((java.lang.Double.isInfinite(lower)) || (java.lang.Double.isInfinite(upper))) {
			throw new org.apache.commons.math.exception.MathIllegalArgumentException(org.apache.commons.math.exception.util.LocalizedFormats.INFINITE_BOUND);
		}
		if ((java.lang.Double.isNaN(lower)) || (java.lang.Double.isNaN(upper))) {
			throw new org.apache.commons.math.exception.MathIllegalArgumentException(org.apache.commons.math.exception.util.LocalizedFormats.NAN_NOT_ALLOWED);
		}
		final org.apache.commons.math.random.RandomGenerator generator = getRan();
	...
	public void reSeed() {
		...
		rand.setSeed(((java.lang.System.currentTimeMillis()) + (java.lang.System.identityHashCode(org.apache.commons.math.random.RandomDataImpl.this))));
	}
	...
	public double nextInversionDeviate(org.apache.commons.math.distribution.RealDistribution distribution) {
