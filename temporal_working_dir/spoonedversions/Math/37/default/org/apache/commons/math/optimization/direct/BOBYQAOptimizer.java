...
public class BOBYQAOptimizer extends org.apache.commons.math.optimization.direct.BaseAbstractMultivariateSimpleBoundsOptimizer<org.apache.commons.math.analysis.MultivariateFunction> implements org.apache.commons.math.optimization.MultivariateOptimizer {
	...
	private org.apache.commons.math.linear.Array2DRowRealMatrix bMatrix;

	private org.apache.commons.math.linear.Array2DRowRealMatrix zMatrix;

	private org.apache.commons.math.linear.Array2DRowRealMatrix interpolationPoints;

	private org.apache.commons.math.linear.ArrayRealVector originShift;

	private org.apache.commons.math.linear.ArrayRealVector fAtInterpolationPoints;

	private org.apache.commons.math.linear.ArrayRealVector trustRegionCenterOffset;

	private org.apache.commons.math.linear.ArrayRealVector gradientAtTrustRegionCenter;

	private org.apache.commons.math.linear.ArrayRealVector lowerDifference;

	private org.apache.commons.math.linear.ArrayRealVector upperDifference;

	private org.apache.commons.math.linear.ArrayRealVector modelSecondDerivativesParameters;

	private org.apache.commons.math.linear.ArrayRealVector newPoint;

	private org.apache.commons.math.linear.ArrayRealVector alternativeNewPoint;

	private org.apache.commons.math.linear.ArrayRealVector trialStepPoint;

	private org.apache.commons.math.linear.ArrayRealVector lagrangeValuesAtNewPoint;

	private org.apache.commons.math.linear.ArrayRealVector modelSecondDerivativesValues;

	public BOBYQAOptimizer(int numberOfInterpolationPoints) {
		this(numberOfInterpolationPoints, org.apache.commons.math.optimization.direct.BOBYQAOptimizer.DEFAULT_INITIAL_RADIUS, org.apache.commons.math.optimization.direct.BOBYQAOptimizer.DEFAULT_STOPPING_RADIUS);
	}
	...
	private double bobyqa(double[] lowerBound, double[] upperBound) {
		org.apache.commons.math.optimization.direct.BOBYQAOptimizer.printMethod();
		...
		for (int j = 0; j < n; j++) {
			...
			if ((lowerDifference.getEntry(j)) >= (-(initialTrustRegionRadius))) {
				if ((lowerDifference.getEntry(j)) >= (org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO)) {
					currentBest.setEntry(j, lowerBound[j]);
					lowerDifference.setEntry(j, org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO);
				...
				if ((upperDifference.getEntry(j)) <= (initialTrustRegionRadius)) {
					if ((upperDifference.getEntry(j)) <= (org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO)) {
						currentBest.setEntry(j, upperBound[j]);
						lowerDifference.setEntry(j, (-boundDiff));
						upperDifference.setEntry(j, org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO);
					}else {
	...
	private double bobyqb(double[] lowerBound, double[] upperBound) {
		...
		double delta = rho;
		double diffa = org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO;
		double diffb = org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO;
		double diffc = org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO;
		double f = org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO;
		double beta = org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO;
		double adelt = org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO;
		double denom = org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO;
		double ratio = org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO;
		double dnorm = org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO;
		double scaden = org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO;
		double biglsq = org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO;
		...
		for (; ;)
			switch (state) {
				case 20 :
					{
						org.apache.commons.math.optimization.direct.BOBYQAOptimizer.printState(20);
						if ((trustRegionCenterInterpolationPointIndex) != kbase) {
							...
							if ((getEvaluations()) > npt) {
								for (int k = 0; k < npt; k++) {
									double temp = org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO;
									for (int j = 0; j < n; j++) {
								...
								throw new org.apache.commons.math.optimization.direct.BOBYQAOptimizer.PathIsExploredException();
							}
						}
					}
				case 60 :
					{
						org.apache.commons.math.optimization.direct.BOBYQAOptimizer.printState(60);
						...
						if (dnorm < ((org.apache.commons.math.optimization.direct.BOBYQAOptimizer.HALF) * rho)) {
							...
							final double frhosq = (rho * (org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ONE_OVER_EIGHT)) * rho;
				...
				case 90 :
					{
						org.apache.commons.math.optimization.direct.BOBYQAOptimizer.printState(90);
						if (dsq <= (xoptsq * (org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ONE_OVER_A_THOUSAND))) {
							final double fracsq = xoptsq * (org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ONE_OVER_FOUR);
							double sumpq = org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO;
							for (int k = 0; k < npt; k++) {
								sumpq += modelSecondDerivativesParameters.getEntry(k);
								double sum = (-(org.apache.commons.math.optimization.direct.BOBYQAOptimizer.HALF)) * xoptsq;
								for (int i = 0; i < n; i++) {
									sum += (interpolationPoints.getEntry(k, i)) * (trustRegionCenterOffset.getEntry(i));
								}
								work2.setEntry(k, sum);
								final double temp = fracsq - ((org.apache.commons.math.optimization.direct.BOBYQAOptimizer.HALF) * sum);
								for (int i = 0; i < n; i++) {
							...
							for (int m = 0; m < nptm; m++) {
								double sumz = org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO;
								double sumw = org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO;
								for (int k = 0; k < npt; k++) {
								...
								for (int j = 0; j < n; j++) {
									double sum = ((fracsq * sumz) - ((org.apache.commons.math.optimization.direct.BOBYQAOptimizer.HALF) * sumw)) * (trustRegionCenterOffset.getEntry(j));
									for (int k = 0; k < npt; k++) {
							...
							int ih = 0;
							for (int j = 0; j < n; j++) {
								work1.setEntry(j, (((-(org.apache.commons.math.optimization.direct.BOBYQAOptimizer.HALF)) * sumpq) * (trustRegionCenterOffset.getEntry(j))));
								for (int k = 0; k < npt; k++) {
							...
							for (int i = 0; i < n; i++) {
								...
								trustRegionCenterOffset.setEntry(i, org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO);
							}
				...
				case 210 :
					{
						org.apache.commons.math.optimization.direct.BOBYQAOptimizer.printState(210);
				...
				case 230 :
					{
						org.apache.commons.math.optimization.direct.BOBYQAOptimizer.printState(230);
						for (int k = 0; k < npt; k++) {
							double suma = org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO;
							double sumb = org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO;
							double sum = org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO;
							for (int j = 0; j < n; j++) {
						...
						double bsum = org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO;
						double dx = org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO;
						for (int j = 0; j < n; j++) {
						...
						lagrangeValuesAtNewPoint.setEntry(trustRegionCenterInterpolationPointIndex, ((lagrangeValuesAtNewPoint.getEntry(trustRegionCenterInterpolationPointIndex)) + (org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ONE)));
						if (ntrits == 0) {
							...
							for (int k = 0; k < npt; k++) {
								...
								double hdiag = org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO;
								for (int m = 0; m < nptm; m++) {
								...
								final double temp = java.lang.Math.max(org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ONE, (d4 * d4));
								if ((temp * den) > scaden) {
									scaden = temp * den;
									knew = k;
									denom = den;
				...
				case 360 :
					{
						org.apache.commons.math.optimization.direct.BOBYQAOptimizer.printState(360);
						for (int i = 0; i < n; i++) {
						...
						double vquad = org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO;
						int ih = 0;
						for (int j = 0; j < n; j++) {
							...
							for (int i = 0; i <= j; i++) {
								...
								if (i == j) {
									temp *= org.apache.commons.math.optimization.direct.BOBYQAOptimizer.HALF;
								}
						...
						for (int k = 0; k < npt; k++) {
							...
							vquad += ((org.apache.commons.math.optimization.direct.BOBYQAOptimizer.HALF) * (modelSecondDerivativesParameters.getEntry(k))) * d2;
						}
						...
						if (ntrits > 0) {
							...
							ratio = (f - fopt) / vquad;
							final double hDelta = (org.apache.commons.math.optimization.direct.BOBYQAOptimizer.HALF) * delta;
							...
							if (f < fopt) {
								...
								for (int k = 0; k < npt; k++) {
									...
									final double temp = java.lang.Math.max(org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ONE, (d3 * d3));
									if ((temp * den) > scaden) {
										scaden = temp * den;
										knew = k;
										denom = den;
						...
						modelSecondDerivativesParameters.setEntry(knew, org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO);
						for (int i = 0; i < n; i++) {
						...
						if (ntrits > 0) {
							...
							double gqsq = org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO;
							double gisq = org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO;
							for (int i = 0; i < n; i++) {
								double sum = org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO;
								for (int k = 0; k < npt; k++) {
								...
								if ((trustRegionCenterOffset.getEntry(i)) == (lowerDifference.getEntry(i))) {
									final double d1 = java.lang.Math.min(org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO, gradientAtTrustRegionCenter.getEntry(i));
									gqsq += d1 * d1;
									final double d2 = java.lang.Math.min(org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO, sum);
									gisq += d2 * d2;
								}else
									if ((trustRegionCenterOffset.getEntry(i)) == (upperDifference.getEntry(i))) {
										final double d1 = java.lang.Math.max(org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO, gradientAtTrustRegionCenter.getEntry(i));
										gqsq += d1 * d1;
										final double d2 = java.lang.Math.max(org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO, sum);
										gisq += d2 * d2;
									}else {
							...
							if (itest >= 3) {
								for (int i = 0, max = java.lang.Math.max(npt, nh); i < max; i++) {
									...
									if (i < nh) {
										modelSecondDerivativesValues.setEntry(i, org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO);
									}
									itest = 0;
								}
							}
						...
						final double d1 = (org.apache.commons.math.optimization.direct.BOBYQAOptimizer.TWO) * delta;
						final double d2 = (org.apache.commons.math.optimization.direct.BOBYQAOptimizer.TEN) * rho;
						distsq = java.lang.Math.max((d1 * d1), (d2 * d2));
					}
				case 650 :
					{
						org.apache.commons.math.optimization.direct.BOBYQAOptimizer.printState(650);
						knew = -1;
						for (int k = 0; k < npt; k++) {
							double sum = org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO;
							for (int j = 0; j < n; j++) {
						...
						if (knew >= 0) {
							...
							if (ntrits == (-1)) {
								delta = java.lang.Math.min(((org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ONE_OVER_TEN) * delta), ((org.apache.commons.math.optimization.direct.BOBYQAOptimizer.HALF) * dist));
								if (delta <= (rho * 1.5)) {
									delta = rho;
								}
							}
							ntrits = 0;
							final double d1 = java.lang.Math.min(((org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ONE_OVER_TEN) * dist), delta);
				...
				case 680 :
					{
						org.apache.commons.math.optimization.direct.BOBYQAOptimizer.printState(680);
						if (rho > (stoppingTrustRegionRadius)) {
							...
							if (ratio <= (org.apache.commons.math.optimization.direct.BOBYQAOptimizer.SIXTEEN)) {
								...
								if (ratio <= (org.apache.commons.math.optimization.direct.BOBYQAOptimizer.TWO_HUNDRED_FIFTY)) {
									...
									rho *= org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ONE_OVER_TEN;
								}
				...
				case 720 :
					{
						org.apache.commons.math.optimization.direct.BOBYQAOptimizer.printState(720);
	...
	private double[] altmov(int knew, double adelt) {
		...
		while (true) {
			...
			for (int i = 0; i < n; i++) {
				...
				if (((java.lang.Math.min(((trustRegionCenterOffset.getEntry(i)) - (lowerDifference.getEntry(i))), glagValue)) > (org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO)) || ((java.lang.Math.max(((trustRegionCenterOffset.getEntry(i)) - (upperDifference.getEntry(i))), glagValue)) < (org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO))) {
			...
			if (tmp1 > (org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO)) {
	...
	private void prelim(double[] lowerBound, double[] upperBound) {
		...
		for (int j = 0; j < n; j++) {
			...
			for (int k = 0; k < npt; k++) {
				interpolationPoints.setEntry(k, j, org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO);
			}
			for (int i = 0; i < ndim; i++) {
				bMatrix.setEntry(i, j, org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO);
			}
		}
		...
		for (int k = 0; k < npt; k++) {
			modelSecondDerivativesParameters.setEntry(k, org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO);
			for (int j = 0, max = npt - np; j < max; j++) {
				zMatrix.setEntry(k, j, org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO);
			}
		}
		int ipt = 0;
		int jpt = 0;
		...
		do {
			...
			if (nfm <= (2 * n)) {
				if ((nfm >= 1) && (nfm <= n)) {
					...
					if ((upperDifference.getEntry(nfmm)) == (org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO)) {
						stepa = -stepa;
						throw new org.apache.commons.math.optimization.direct.BOBYQAOptimizer.PathIsExploredException();
					}
					...
					if (nfm > n) {
						...
						if ((lowerDifference.getEntry(nfxm)) == (org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO)) {
							stepb = java.lang.Math.min(((org.apache.commons.math.optimization.direct.BOBYQAOptimizer.TWO) * (initialTrustRegionRadius)), upperDifference.getEntry(nfxm));
							throw new org.apache.commons.math.optimization.direct.BOBYQAOptimizer.PathIsExploredException();
						}
						if ((upperDifference.getEntry(nfxm)) == (org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO)) {
							stepb = java.lang.Math.max(((-(org.apache.commons.math.optimization.direct.BOBYQAOptimizer.TWO)) * (initialTrustRegionRadius)), lowerDifference.getEntry(nfxm));
							throw new org.apache.commons.math.optimization.direct.BOBYQAOptimizer.PathIsExploredException();
						}
			...
			if (numEval <= ((2 * n) + 1)) {
				if ((numEval >= 2) && (numEval <= (n + 1))) {
					...
					if (npt < (numEval + n)) {
						...
						bMatrix.setEntry((npt + nfmm), nfmm, ((-(org.apache.commons.math.optimization.direct.BOBYQAOptimizer.HALF)) * rhosq));
						throw new org.apache.commons.math.optimization.direct.BOBYQAOptimizer.PathIsExploredException();
					}
				}else
					if (numEval >= (n + 2)) {
						...
						modelSecondDerivativesValues.setEntry(ih, (((org.apache.commons.math.optimization.direct.BOBYQAOptimizer.TWO) * (tmp - (gradientAtTrustRegionCenter.getEntry(nfxm)))) / diff));
						...
						bMatrix.setEntry(nfm, nfxm, ((-(org.apache.commons.math.optimization.direct.BOBYQAOptimizer.HALF)) / (interpolationPoints.getEntry((nfm - n), nfxm))));
						bMatrix.setEntry((nfm - n), nfxm, ((-(bMatrix.getEntry(0, nfxm))) - (bMatrix.getEntry(nfm, nfxm))));
						zMatrix.setEntry(0, nfxm, ((java.lang.Math.sqrt(org.apache.commons.math.optimization.direct.BOBYQAOptimizer.TWO)) / (stepa * stepb)));
						zMatrix.setEntry(nfm, nfxm, ((java.lang.Math.sqrt(org.apache.commons.math.optimization.direct.BOBYQAOptimizer.HALF)) / rhosq));
	...
	private double[] trsbox(double delta, org.apache.commons.math.linear.ArrayRealVector gnew, org.apache.commons.math.linear.ArrayRealVector xbdi, org.apache.commons.math.linear.ArrayRealVector s, org.apache.commons.math.linear.ArrayRealVector hs, org.apache.commons.math.linear.ArrayRealVector hred) {
		org.apache.commons.math.optimization.direct.BOBYQAOptimizer.printMethod();
		final int n = currentBest.getDimension();
		final int npt = numberOfInterpolationPoints;
		double dsq = java.lang.Double.NaN;
		...
		for (int i = 0; i < n; i++) {
			...
			if ((trustRegionCenterOffset.getEntry(i)) <= (lowerDifference.getEntry(i))) {
				if ((gradientAtTrustRegionCenter.getEntry(i)) >= (org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO)) {
			...
			trialStepPoint.setEntry(i, org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO);
		...
		for (; ;) {
			switch (state) {
				...
				case 30 :
					{
						org.apache.commons.math.optimization.direct.BOBYQAOptimizer.printState(30);
				...
				case 50 :
					{
						org.apache.commons.math.optimization.direct.BOBYQAOptimizer.printState(50);
						resid = delsq;
				...
				case 100 :
					{
						org.apache.commons.math.optimization.direct.BOBYQAOptimizer.printState(100);
						if (nact >= (n - 1)) {
							state = 190;
							break;
						}
				...
				case 120 :
					{
						org.apache.commons.math.optimization.direct.BOBYQAOptimizer.printState(120);
						++iterc;
				...
				case 150 :
					{
						org.apache.commons.math.optimization.direct.BOBYQAOptimizer.printState(150);
						shs = org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO;
						...
						if (isav < iu) {
							...
							angt = (angbd * (isav + ((org.apache.commons.math.optimization.direct.BOBYQAOptimizer.HALF) * temp))) / iu;
						}
				...
				case 190 :
					{
						org.apache.commons.math.optimization.direct.BOBYQAOptimizer.printState(190);
						dsq = org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO;
						for (int i = 0; i < n; i++) {
				...
				case 210 :
					{
						...
						final org.apache.commons.math.linear.RealVector tmp = interpolationPoints.operate(s).ebeMultiply(modelSecondDerivativesParameters);
						for (int k = 0; k < npt; k++) {
							if ((modelSecondDerivativesParameters.getEntry(k)) != (org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO)) {
								for (int i = 0; i < n; i++) {
	...
	private void update(double beta, double denom, int knew) {
		...
		for (int j = 1; j < nptm; j++) {
			...
			zMatrix.setEntry(knew, j, org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ZERO);
		}
		for (int i = 0; i < npt; i++) {
		...
		lagrangeValuesAtNewPoint.setEntry(knew, ((lagrangeValuesAtNewPoint.getEntry(knew)) - (org.apache.commons.math.optimization.direct.BOBYQAOptimizer.ONE)));
	...
	private void setup(double[] lowerBound, double[] upperBound) {
		...
		bMatrix = new org.apache.commons.math.linear.Array2DRowRealMatrix((dimension + (numberOfInterpolationPoints)), dimension);
		zMatrix = new org.apache.commons.math.linear.Array2DRowRealMatrix(numberOfInterpolationPoints, (((numberOfInterpolationPoints) - dimension) - 1));
		interpolationPoints = new org.apache.commons.math.linear.Array2DRowRealMatrix(numberOfInterpolationPoints, dimension);
		originShift = new org.apache.commons.math.linear.ArrayRealVector(dimension);
		fAtInterpolationPoints = new org.apache.commons.math.linear.ArrayRealVector(numberOfInterpolationPoints);
		trustRegionCenterOffset = new org.apache.commons.math.linear.ArrayRealVector(dimension);
		gradientAtTrustRegionCenter = new org.apache.commons.math.linear.ArrayRealVector(dimension);
		lowerDifference = new org.apache.commons.math.linear.ArrayRealVector(dimension);
		upperDifference = new org.apache.commons.math.linear.ArrayRealVector(dimension);
		modelSecondDerivativesParameters = new org.apache.commons.math.linear.ArrayRealVector(numberOfInterpolationPoints);
		newPoint = new org.apache.commons.math.linear.ArrayRealVector(dimension);
		alternativeNewPoint = new org.apache.commons.math.linear.ArrayRealVector(dimension);
		trialStepPoint = new org.apache.commons.math.linear.ArrayRealVector(dimension);
		lagrangeValuesAtNewPoint = new org.apache.commons.math.linear.ArrayRealVector((dimension + (numberOfInterpolationPoints)));
		modelSecondDerivativesValues = new org.apache.commons.math.linear.ArrayRealVector(((dimension * (dimension + 1)) / 2));
	}
	...
	private static class PathIsExploredException extends java.lang.RuntimeException {
		...
		PathIsExploredException() {
			super((((org.apache.commons.math.optimization.direct.BOBYQAOptimizer.PathIsExploredException.PATH_IS_EXPLORED) + " ") + (org.apache.commons.math.optimization.direct.BOBYQAOptimizer.caller(3))));
		}
	}
}
