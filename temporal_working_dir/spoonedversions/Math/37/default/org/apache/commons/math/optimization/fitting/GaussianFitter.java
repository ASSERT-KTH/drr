...
public class GaussianFitter extends org.apache.commons.math.optimization.fitting.CurveFitter {
	public GaussianFitter(org.apache.commons.math.optimization.DifferentiableMultivariateVectorOptimizer optimizer) {
		super(optimizer);
	}

	public double[] fit(double[] initialGuess) {
		final org.apache.commons.math.analysis.ParametricUnivariateFunction f = new org.apache.commons.math.analysis.ParametricUnivariateFunction() {
			private final org.apache.commons.math.analysis.ParametricUnivariateFunction g = new org.apache.commons.math.analysis.function.Gaussian.Parametric();
