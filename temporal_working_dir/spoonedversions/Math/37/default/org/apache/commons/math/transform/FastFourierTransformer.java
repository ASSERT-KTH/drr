...
public class FastFourierTransformer implements java.io.Serializable {
	...
	public org.apache.commons.math.complex.Complex[] transform(double[] f) {
		if (unitary) {
			final double s = 1.0 / (org.apache.commons.math.util.FastMath.sqrt(f.length));
			return org.apache.commons.math.transform.TransformUtils.scaleArray(fft(f, false), s);
		}
		return fft(f, false);
	}

	public org.apache.commons.math.complex.Complex[] transform(org.apache.commons.math.analysis.UnivariateFunction f, double min, double max, int n) {
		...
		if (unitary) {
			...
			return org.apache.commons.math.transform.TransformUtils.scaleArray(fft(data, false), s);
		}
		return fft(data, false);
	}

	public org.apache.commons.math.complex.Complex[] transform(org.apache.commons.math.complex.Complex[] f) {
		roots.computeOmega(f.length);
		if (unitary) {
			final double s = 1.0 / (org.apache.commons.math.util.FastMath.sqrt(f.length));
			return org.apache.commons.math.transform.TransformUtils.scaleArray(fft(f), s);
		}
		return fft(f);
	}

	public org.apache.commons.math.complex.Complex[] inverseTransform(double[] f) {
		final double s = 1.0 / (unitary ? org.apache.commons.math.util.FastMath.sqrt(f.length) : f.length);
		return org.apache.commons.math.transform.TransformUtils.scaleArray(fft(f, true), s);
	}

	public org.apache.commons.math.complex.Complex[] inverseTransform(org.apache.commons.math.analysis.UnivariateFunction f, double min, double max, int n) {
		final double[] data = org.apache.commons.math.analysis.FunctionUtils.sample(f, min, max, n);
		final double s = 1.0 / (unitary ? org.apache.commons.math.util.FastMath.sqrt(n) : n);
		return org.apache.commons.math.transform.TransformUtils.scaleArray(fft(data, true), s);
	}

	public org.apache.commons.math.complex.Complex[] inverseTransform(org.apache.commons.math.complex.Complex[] f) {
		roots.computeOmega((-(f.length)));
		final double s = 1.0 / (unitary ? org.apache.commons.math.util.FastMath.sqrt(f.length) : f.length);
		return org.apache.commons.math.transform.TransformUtils.scaleArray(fft(f), s);
	}

	protected org.apache.commons.math.complex.Complex[] fft(double[] f, boolean isInverse) {
		...
		return org.apache.commons.math.transform.TransformUtils.scaleArray(transformed, 0.5);
	}

	protected org.apache.commons.math.complex.Complex[] fft(org.apache.commons.math.complex.Complex[] data) {
		if (!(org.apache.commons.math.util.ArithmeticUtils.isPowerOfTwo(data.length))) {
			throw new org.apache.commons.math.exception.MathIllegalArgumentException(org.apache.commons.math.exception.util.LocalizedFormats.NOT_POWER_OF_TWO_CONSIDER_PADDING, java.lang.Integer.valueOf(data.length));
		}
	...
	public java.lang.Object mdfft(java.lang.Object mdca, boolean forward) {
	...
	private void mdfft(org.apache.commons.math.transform.FastFourierTransformer.MultiDimensionalComplexMatrix mdcm, boolean forward, int d, int[] subVector) {
		int[] dimensionSize = mdcm.getDimensionSizes();
	...
	private static class RootsOfUnity implements java.io.Serializable {
		...
		public synchronized boolean isForward() throws org.apache.commons.math.exception.MathIllegalStateException {
			if ((omegaCount) == 0) {
		...
		public synchronized void computeOmega(int n) throws org.apache.commons.math.exception.ZeroException {
			if (n == 0) {
		...
		public synchronized double getOmegaReal(int k) throws org.apache.commons.math.exception.MathIllegalArgumentException, org.apache.commons.math.exception.MathIllegalStateException {
			if ((omegaCount) == 0) {
				throw new org.apache.commons.math.exception.MathIllegalStateException(org.apache.commons.math.exception.util.LocalizedFormats.ROOTS_OF_UNITY_NOT_COMPUTED_YET);
			}
			if ((k < 0) || (k >= (omegaCount))) {
		...
		public synchronized double getOmegaImaginary(int k) throws org.apache.commons.math.exception.MathIllegalStateException, org.apache.commons.math.exception.OutOfRangeException {
			if ((omegaCount) == 0) {
				throw new org.apache.commons.math.exception.MathIllegalStateException(org.apache.commons.math.exception.util.LocalizedFormats.ROOTS_OF_UNITY_NOT_COMPUTED_YET);
			}
			if ((k < 0) || (k >= (omegaCount))) {
