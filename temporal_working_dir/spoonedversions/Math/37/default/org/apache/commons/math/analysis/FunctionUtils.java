...
public class FunctionUtils {
	...
	public static org.apache.commons.math.analysis.UnivariateFunction combine(final org.apache.commons.math.analysis.BivariateRealFunction combiner, final org.apache.commons.math.analysis.UnivariateFunction f, final org.apache.commons.math.analysis.UnivariateFunction g) {
		return new org.apache.commons.math.analysis.UnivariateFunction() {
			public double value(double x) {
	...
	public static org.apache.commons.math.analysis.MultivariateFunction collector(final org.apache.commons.math.analysis.BivariateRealFunction combiner, final org.apache.commons.math.analysis.UnivariateFunction f, final double initialValue) {
	...
	public static org.apache.commons.math.analysis.MultivariateFunction collector(final org.apache.commons.math.analysis.BivariateRealFunction combiner, final double initialValue) {
	...
	public static org.apache.commons.math.analysis.UnivariateFunction fix1stArgument(final org.apache.commons.math.analysis.BivariateRealFunction f, final double fixed) {
		return new org.apache.commons.math.analysis.UnivariateFunction() {
			public double value(double x) {
	...
	public static org.apache.commons.math.analysis.UnivariateFunction fix2ndArgument(final org.apache.commons.math.analysis.BivariateRealFunction f, final double fixed) {
		return new org.apache.commons.math.analysis.UnivariateFunction() {
			public double value(double x) {
