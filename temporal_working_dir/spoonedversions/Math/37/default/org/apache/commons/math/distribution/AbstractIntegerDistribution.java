...
public abstract class AbstractIntegerDistribution implements java.io.Serializable , org.apache.commons.math.distribution.IntegerDistribution {
	...
	public double cumulativeProbability(int x0, int x1) throws org.apache.commons.math.exception.NumberIsTooLargeException {
		if (x1 < x0) {
	...
	public int inverseCumulativeProbability(final double p) throws org.apache.commons.math.exception.OutOfRangeException {
		if ((p < 0.0) || (p > 1.0)) {
		...
		final double sigma = org.apache.commons.math.util.FastMath.sqrt(getNumericalVariance());
		...
		if (chebyshevApplies) {
			double k = org.apache.commons.math.util.FastMath.sqrt(((1.0 - p) / p));
