...
public class UnivariateRealPeriodicInterpolator implements org.apache.commons.math.analysis.interpolation.UnivariateRealInterpolator {
	...
	public org.apache.commons.math.analysis.UnivariateFunction interpolate(double[] xval, double[] yval) {
		...
		org.apache.commons.math.util.MathArrays.sortInPlace(x, y);
		final org.apache.commons.math.analysis.UnivariateFunction f = interpolator.interpolate(x, y);
