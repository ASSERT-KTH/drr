...
public class FastMath {
	...
	static final int EXP_INT_TABLE_LEN = (org.apache.commons.math.util.FastMath.EXP_INT_TABLE_MAX_INDEX) * 2;
	...
	private static boolean LOAD_RESOURCES = false;
	...
	private static final long MASK_30BITS = (-1L) - ((org.apache.commons.math.util.FastMath.HEX_40000000) - 1);
	...
	private static double doubleHighPart(double d) {
		...
		xl = xl & (org.apache.commons.math.util.FastMath.MASK_30BITS);
	...
	public static float nextUp(final float a) {
		return org.apache.commons.math.util.FastMath.nextAfter(a, java.lang.Float.POSITIVE_INFINITY);
	}
	...
	private static double exp(double x, double extra, double[] hiPrec) {
		...
		final double fracPartA = org.apache.commons.math.util.FastMath.ExpFracTable.EXP_FRAC_TABLE_A[intFrac];
		final double fracPartB = org.apache.commons.math.util.FastMath.ExpFracTable.EXP_FRAC_TABLE_B[intFrac];
	...
	public static double expm1(double x) {
		return org.apache.commons.math.util.FastMath.expm1(x, null);
	}
	...
	private static double expm1(double x, double[] hiPrecOut) {
		...
		}
		{
			...
			double tempA = (org.apache.commons.math.util.FastMath.ExpFracTable.EXP_FRAC_TABLE_A[intFrac]) - 1.0;
			double tempB = org.apache.commons.math.util.FastMath.ExpFracTable.EXP_FRAC_TABLE_B[intFrac];
			double temp = tempA + tempB;
			tempB = -((temp - tempA) - tempB);
			tempA = temp;
			temp = tempA * (org.apache.commons.math.util.FastMath.HEX_40000000);
	...
	private static double log(final double x, final double[] hiPrec) {
		...
		double[] lnm = org.apache.commons.math.util.FastMath.lnMant.LN_MANT[((int) ((bits & 4499201580859392L) >> 42))];
	...
	public static double log1p(final double x) {
		...
		double y = (x * (org.apache.commons.math.util.FastMath.F_1_3)) - (org.apache.commons.math.util.FastMath.F_1_2);
		y = (y * x) + 1.0;
		y = y * x;
		return y;
	}
	...
	public static double log10(final double x) {
		...
		final double lores = org.apache.commons.math.util.FastMath.log(x, hiPrec);
		if (java.lang.Double.isInfinite(lores)) {
			return lores;
		}
		final double tmp = (hiPrec[0]) * (org.apache.commons.math.util.FastMath.HEX_40000000);
	...
	public static double pow(double x, double y) {
		...
		double lna = lns[0];
		double lnb = lns[1];
		double tmp1 = lna * (org.apache.commons.math.util.FastMath.HEX_40000000);
	...
	private static double sinQ(double xa, double xb) {
		...
		final double epsilon = xa - (org.apache.commons.math.util.FastMath.EIGHTHS[idx]);
		...
		final double temp = sinEpsA * (org.apache.commons.math.util.FastMath.HEX_40000000);
	...
	private static double tanQ(double xa, double xb, boolean cotanFlag) {
		...
		final double cosEpsA = 1.0;
		final double cosEpsB = org.apache.commons.math.util.FastMath.polyCosine(epsilon);
		double temp = sinEpsA * (org.apache.commons.math.util.FastMath.HEX_40000000);
		double temp2 = (sinEpsA + temp) - temp;
		sinEpsB += sinEpsA - temp2;
		sinEpsA = temp2;
		double a = 0;
		...
		temp = est * (org.apache.commons.math.util.FastMath.HEX_40000000);
		double esta = (est + temp) - temp;
		double estb = est - esta;
		temp = cosa * (org.apache.commons.math.util.FastMath.HEX_40000000);
	...
	private static void reducePayneHanek(double x, double[] result) {
		...
		double tmpA = (prod2A >>> 12) / (org.apache.commons.math.util.FastMath.TWO_POWER_52);
		double tmpB = ((((prod2A & 4095L) << 40) + (prod2B >>> 24)) / (org.apache.commons.math.util.FastMath.TWO_POWER_52)) / (org.apache.commons.math.util.FastMath.TWO_POWER_52);
	...
	private static double atan(double xa, double xb, boolean leftPlane) {
		...
		epsB = -((temp - epsA) - epsB);
		epsA = temp;
		temp = xa * (org.apache.commons.math.util.FastMath.HEX_40000000);
		...
		double result;
		double resultb;
		double za = (org.apache.commons.math.util.FastMath.EIGHTHS[idx]) + ya;
		double zb = -((za - (org.apache.commons.math.util.FastMath.EIGHTHS[idx])) - ya);
		temp = za + yb;
		zb += -((temp - za) - yb);
		za = temp;
		result = za + zb;
	...
	public static double atan2(double y, double x) {
		...
		double ra = org.apache.commons.math.util.FastMath.doubleHighPart(r);
		double rb = r - ra;
		final double xa = org.apache.commons.math.util.FastMath.doubleHighPart(x);
	...
	public static double asin(double x) {
		...
		double temp = x * (org.apache.commons.math.util.FastMath.HEX_40000000);
		...
		za = temp;
		double y;
		y = org.apache.commons.math.util.FastMath.sqrt(za);
		temp = y * (org.apache.commons.math.util.FastMath.HEX_40000000);
		ya = (y + temp) - temp;
		yb = y - ya;
		yb += (((za - (ya * ya)) - ((2 * ya) * yb)) - (yb * yb)) / (2.0 * y);
		double dx = zb / (2.0 * y);
		double r = x / y;
		temp = r * (org.apache.commons.math.util.FastMath.HEX_40000000);
		...
		rb = -((temp - ra) - rb);
		ra = temp;
		return org.apache.commons.math.util.FastMath.atan(ra, rb, false);
	}
	...
	public static double acos(double x) {
		...
		zb += -((temp - za) - yb);
		za = temp;
		double y = org.apache.commons.math.util.FastMath.sqrt(za);
		temp = y * (org.apache.commons.math.util.FastMath.HEX_40000000);
		ya = (y + temp) - temp;
		yb = y - ya;
		yb += (((za - (ya * ya)) - ((2 * ya) * yb)) - (yb * yb)) / (2.0 * y);
		...
		rb = -((temp - ra) - rb);
		ra = temp;
		return org.apache.commons.math.util.FastMath.atan(ra, rb, (x < 0));
	}
	...
	public static double cbrt(double x) {
		...
		est *= org.apache.commons.math.util.FastMath.CBRTTWO[((exponent % 3) + 2)];
		final double xs = x / ((p2 * p2) * p2);
		est += (xs - ((est * est) * est)) / ((3 * est) * est);
		est += (xs - ((est * est) * est)) / ((3 * est) * est);
		double temp = est * (org.apache.commons.math.util.FastMath.HEX_40000000);
	...
	public static double toRadians(double x) {
		...
		double xa = org.apache.commons.math.util.FastMath.doubleHighPart(x);
		double xb = x - xa;
	...
	public static float ulp(float x) {
		...
		return org.apache.commons.math.util.FastMath.abs((x - (java.lang.Float.intBitsToFloat(((java.lang.Float.floatToIntBits(x)) ^ 1)))));
	}
	...
	public static int round(final float x) {
		return ((int) (org.apache.commons.math.util.FastMath.floor((x + 0.5F))));
	}
	...
	public static void main(java.lang.String[] a) {
		...
		org.apache.commons.math.util.FastMathCalc.printarray(out, "EXP_INT_TABLE_A", org.apache.commons.math.util.FastMath.EXP_INT_TABLE_LEN, org.apache.commons.math.util.FastMath.ExpIntTable.EXP_INT_TABLE_A);
		org.apache.commons.math.util.FastMathCalc.printarray(out, "EXP_INT_TABLE_B", org.apache.commons.math.util.FastMath.EXP_INT_TABLE_LEN, org.apache.commons.math.util.FastMath.ExpIntTable.EXP_INT_TABLE_B);
		org.apache.commons.math.util.FastMathCalc.printarray(out, "EXP_FRAC_TABLE_A", org.apache.commons.math.util.FastMath.EXP_FRAC_TABLE_LEN, org.apache.commons.math.util.FastMath.ExpFracTable.EXP_FRAC_TABLE_A);
		org.apache.commons.math.util.FastMathCalc.printarray(out, "EXP_FRAC_TABLE_B", org.apache.commons.math.util.FastMath.EXP_FRAC_TABLE_LEN, org.apache.commons.math.util.FastMath.ExpFracTable.EXP_FRAC_TABLE_B);
		org.apache.commons.math.util.FastMathCalc.printarray(out, "LN_MANT", org.apache.commons.math.util.FastMath.LN_MANT_LEN, org.apache.commons.math.util.FastMath.lnMant.LN_MANT);
		org.apache.commons.math.util.FastMathCalc.printarray(out, "SINE_TABLE_A", org.apache.commons.math.util.FastMath.SINE_TABLE_LEN, org.apache.commons.math.util.FastMath.SINE_TABLE_A);
		org.apache.commons.math.util.FastMathCalc.printarray(out, "SINE_TABLE_B", org.apache.commons.math.util.FastMath.SINE_TABLE_LEN, org.apache.commons.math.util.FastMath.SINE_TABLE_B);
		org.apache.commons.math.util.FastMathCalc.printarray(out, "COSINE_TABLE_A", org.apache.commons.math.util.FastMath.SINE_TABLE_LEN, org.apache.commons.math.util.FastMath.COSINE_TABLE_A);
		org.apache.commons.math.util.FastMathCalc.printarray(out, "COSINE_TABLE_B", org.apache.commons.math.util.FastMath.SINE_TABLE_LEN, org.apache.commons.math.util.FastMath.COSINE_TABLE_B);
		org.apache.commons.math.util.FastMathCalc.printarray(out, "TANGENT_TABLE_A", org.apache.commons.math.util.FastMath.SINE_TABLE_LEN, org.apache.commons.math.util.FastMath.TANGENT_TABLE_A);
		org.apache.commons.math.util.FastMathCalc.printarray(out, "TANGENT_TABLE_B", org.apache.commons.math.util.FastMath.SINE_TABLE_LEN, org.apache.commons.math.util.FastMath.TANGENT_TABLE_B);
	}
