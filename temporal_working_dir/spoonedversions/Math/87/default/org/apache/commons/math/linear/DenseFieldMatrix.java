...
public class DenseFieldMatrix<T extends org.apache.commons.math.FieldElement<T>> extends org.apache.commons.math.linear.AbstractFieldMatrix<T> implements java.io.Serializable {
	...
	public DenseFieldMatrix(final org.apache.commons.math.Field<T> field, final int rows, final int columns) throws java.lang.IllegalArgumentException {
		super(field, rows, columns);
		this.rows = rows;
		this.columns = columns;
		blockRows = ((rows + (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE)) - 1) / (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE);
		blockColumns = ((columns + (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE)) - 1) / (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE);
		blocks = org.apache.commons.math.linear.DenseFieldMatrix.createBlocksLayout(field, rows, columns);
	}

	public DenseFieldMatrix(final T[][] rawData) throws java.lang.IllegalArgumentException {
		this(rawData.length, rawData[0].length, org.apache.commons.math.linear.DenseFieldMatrix.toBlocksLayout(rawData), false);
	}

	public DenseFieldMatrix(final int rows, final int columns, final T[][] blockData, final boolean copyArray) throws java.lang.IllegalArgumentException {
	...
	public static <T extends org.apache.commons.math.FieldElement<T>> T[][] toBlocksLayout(final T[][] rawData) throws java.lang.IllegalArgumentException {
		...
		final int blockRows = ((rows + (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE)) - 1) / (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE);
		final int blockColumns = ((columns + (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE)) - 1) / (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE);
		...
		for (int iBlock = 0, blockIndex = 0; iBlock < blockRows; ++iBlock) {
			final int pStart = iBlock * (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE);
			final int pEnd = java.lang.Math.min((pStart + (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE)), rows);
			final int iHeight = pEnd - pStart;
			for (int jBlock = 0; jBlock < blockColumns; ++jBlock , ++blockIndex) {
				final int qStart = jBlock * (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE);
				final int qEnd = java.lang.Math.min((qStart + (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE)), columns);
	...
	public org.apache.commons.math.linear.FieldMatrix<T> createMatrix(final int rowDimension, final int columnDimension) throws java.lang.IllegalArgumentException {
		return new org.apache.commons.math.linear.DenseFieldMatrix<T>(getField(), rowDimension, columnDimension);
	}

	@java.lang.Override
	public org.apache.commons.math.linear.FieldMatrix<T> copy() {
		org.apache.commons.math.linear.DenseFieldMatrix<T> copied = new org.apache.commons.math.linear.DenseFieldMatrix<T>(getField(), rows, columns);
	...
	public org.apache.commons.math.linear.FieldMatrix<T> add(final org.apache.commons.math.linear.FieldMatrix<T> m) throws java.lang.IllegalArgumentException {
		try {
			return add(((org.apache.commons.math.linear.DenseFieldMatrix<T>) (m)));
		} catch (java.lang.ClassCastException cce) {
			checkAdditionCompatible(m);
			final org.apache.commons.math.linear.DenseFieldMatrix<T> out = new org.apache.commons.math.linear.DenseFieldMatrix<T>(getField(), rows, columns);
			int blockIndex = 0;
	...
	public org.apache.commons.math.linear.DenseFieldMatrix<T> add(final org.apache.commons.math.linear.DenseFieldMatrix<T> m) throws java.lang.IllegalArgumentException {
		checkAdditionCompatible(m);
		final org.apache.commons.math.linear.DenseFieldMatrix<T> out = new org.apache.commons.math.linear.DenseFieldMatrix<T>(getField(), rows, columns);
	...
	public org.apache.commons.math.linear.FieldMatrix<T> subtract(final org.apache.commons.math.linear.FieldMatrix<T> m) throws java.lang.IllegalArgumentException {
		try {
			return subtract(((org.apache.commons.math.linear.DenseFieldMatrix<T>) (m)));
		} catch (java.lang.ClassCastException cce) {
	...
	public org.apache.commons.math.linear.DenseFieldMatrix<T> subtract(final org.apache.commons.math.linear.DenseFieldMatrix<T> m) throws java.lang.IllegalArgumentException {
		checkSubtractionCompatible(m);
		final org.apache.commons.math.linear.DenseFieldMatrix<T> out = new org.apache.commons.math.linear.DenseFieldMatrix<T>(getField(), rows, columns);
		for (int blockIndex = 0; blockIndex < (out.blocks.length); ++blockIndex) {
			final T[] outBlock = out.blocks[blockIndex];
	...
	public org.apache.commons.math.linear.FieldMatrix<T> multiply(final org.apache.commons.math.linear.FieldMatrix<T> m) throws java.lang.IllegalArgumentException {
		try {
			return multiply(((org.apache.commons.math.linear.DenseFieldMatrix<T>) (m)));
		} catch (java.lang.ClassCastException cce) {
			checkMultiplicationCompatible(m);
			final org.apache.commons.math.linear.DenseFieldMatrix<T> out = new org.apache.commons.math.linear.DenseFieldMatrix<T>(getField(), rows, m.getColumnDimension());
			...
			for (int iBlock = 0; iBlock < (out.blockRows); ++iBlock) {
				...
				for (int jBlock = 0; jBlock < (out.blockColumns); ++jBlock) {
					final int qStart = jBlock * (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE);
					final int qEnd = java.lang.Math.min((qStart + (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE)), m.getColumnDimension());
					final T[] outBlock = out.blocks[blockIndex];
					for (int kBlock = 0; kBlock < (blockColumns); ++kBlock) {
						final int kWidth = blockWidth(kBlock);
						final T[] tBlock = blocks[((iBlock * (blockColumns)) + kBlock)];
						final int rStart = kBlock * (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE);
						for (int p = pStart, k = 0; p < pEnd; ++p) {
	...
	public org.apache.commons.math.linear.DenseFieldMatrix<T> multiply(org.apache.commons.math.linear.DenseFieldMatrix<T> m) throws java.lang.IllegalArgumentException {
		checkMultiplicationCompatible(m);
		final org.apache.commons.math.linear.DenseFieldMatrix<T> out = new org.apache.commons.math.linear.DenseFieldMatrix<T>(getField(), rows, m.columns);
		final T zero = getField().getZero();
		int blockIndex = 0;
		for (int iBlock = 0; iBlock < (out.blockRows); ++iBlock) {
			final int pStart = iBlock * (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE);
	...
	public T[][] getData() {
		...
		final int lastColumns = (columns) - (((blockColumns) - 1) * (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE));
		for (int iBlock = 0; iBlock < (blockRows); ++iBlock) {
			final int pStart = iBlock * (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE);
			final int pEnd = java.lang.Math.min((pStart + (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE)), rows);
			int regularPos = 0;
			...
			for (int p = pStart; p < pEnd; ++p) {
				...
				for (int jBlock = 0; jBlock < ((blockColumns) - 1); ++jBlock) {
					java.lang.System.arraycopy(blocks[(blockIndex++)], regularPos, dataP, dataPos, org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE);
					dataPos += org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE;
				}
				java.lang.System.arraycopy(blocks[blockIndex], lastPos, dataP, dataPos, lastColumns);
				regularPos += org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE;
				lastPos += lastColumns;
			}
		}
		return data;
	...
	public org.apache.commons.math.linear.FieldMatrix<T> getSubMatrix(final int startRow, final int endRow, final int startColumn, final int endColumn) throws org.apache.commons.math.linear.MatrixIndexException {
		...
		final org.apache.commons.math.linear.DenseFieldMatrix<T> out = new org.apache.commons.math.linear.DenseFieldMatrix<T>(getField(), ((endRow - startRow) + 1), ((endColumn - startColumn) + 1));
		final int blockStartRow = startRow / (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE);
		final int rowsShift = startRow % (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE);
		final int blockStartColumn = startColumn / (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE);
		final int columnsShift = startColumn % (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE);
		for (int iBlock = 0, pBlock = blockStartRow; iBlock < (out.blockRows); ++iBlock , ++pBlock) {
			...
			for (int jBlock = 0, qBlock = blockStartColumn; jBlock < (out.blockColumns); ++jBlock , ++qBlock) {
				...
				final int heightExcess = (iHeight + rowsShift) - (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE);
				final int widthExcess = (jWidth + columnsShift) - (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE);
				if (heightExcess > 0) {
					if (widthExcess > 0) {
						final int width2 = blockWidth((qBlock + 1));
						copyBlockPart(blocks[index], width, rowsShift, org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE, columnsShift, org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE, outBlock, jWidth, 0, 0);
						copyBlockPart(blocks[(index + 1)], width2, rowsShift, org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE, 0, widthExcess, outBlock, jWidth, 0, (jWidth - widthExcess));
						copyBlockPart(blocks[(index + (blockColumns))], width, 0, heightExcess, columnsShift, org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE, outBlock, jWidth, (iHeight - heightExcess), 0);
						...
						copyBlockPart(blocks[index], width, rowsShift, org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE, columnsShift, (jWidth + columnsShift), outBlock, jWidth, 0, 0);
					...
					if (widthExcess > 0) {
						final int width2 = blockWidth((qBlock + 1));
						copyBlockPart(blocks[index], width, rowsShift, (iHeight + rowsShift), columnsShift, org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE, outBlock, jWidth, 0, 0);
	...
	public void setSubMatrix(final T[][] subMatrix, final int row, final int column) throws org.apache.commons.math.linear.MatrixIndexException {
		...
		final int blockStartRow = row / (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE);
		final int blockEndRow = (endRow + (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE)) / (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE);
		final int blockStartColumn = column / (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE);
		final int blockEndColumn = (endColumn + (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE)) / (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE);
		for (int iBlock = blockStartRow; iBlock < blockEndRow; ++iBlock) {
			final int iHeight = blockHeight(iBlock);
			final int firstRow = iBlock * (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE);
			...
			for (int jBlock = blockStartColumn; jBlock < blockEndColumn; ++jBlock) {
				...
				final int firstColumn = jBlock * (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE);
	...
	public org.apache.commons.math.linear.FieldMatrix<T> getRowMatrix(final int row) throws org.apache.commons.math.linear.MatrixIndexException {
		checkRowIndex(row);
		final org.apache.commons.math.linear.DenseFieldMatrix<T> out = new org.apache.commons.math.linear.DenseFieldMatrix<T>(getField(), 1, columns);
		final int iBlock = row / (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE);
		final int iRow = row - (iBlock * (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE));
		int outBlockIndex = 0;
		int outIndex = 0;
	...
	public void setRowMatrix(final int row, final org.apache.commons.math.linear.FieldMatrix<T> matrix) throws org.apache.commons.math.linear.InvalidMatrixException, org.apache.commons.math.linear.MatrixIndexException {
		try {
			setRowMatrix(row, ((org.apache.commons.math.linear.DenseFieldMatrix<T>) (matrix)));
		} catch (java.lang.ClassCastException cce) {
			super.setRowMatrix(row, matrix);
		}
	}

	public void setRowMatrix(final int row, final org.apache.commons.math.linear.DenseFieldMatrix<T> matrix) throws org.apache.commons.math.linear.InvalidMatrixException, org.apache.commons.math.linear.MatrixIndexException {
		checkRowIndex(row);
	...
	public org.apache.commons.math.linear.FieldMatrix<T> getColumnMatrix(final int column) throws org.apache.commons.math.linear.MatrixIndexException {
		...
		final org.apache.commons.math.linear.DenseFieldMatrix<T> out = new org.apache.commons.math.linear.DenseFieldMatrix<T>(getField(), rows, 1);
		final int jBlock = column / (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE);
		final int jColumn = column - (jBlock * (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE));
		final int jWidth = blockWidth(jBlock);
		int outBlockIndex = 0;
		int outIndex = 0;
		T[] outBlock = out.blocks[outBlockIndex];
	...
	public void setColumnMatrix(final int column, final org.apache.commons.math.linear.FieldMatrix<T> matrix) throws org.apache.commons.math.linear.InvalidMatrixException, org.apache.commons.math.linear.MatrixIndexException {
		try {
			setColumnMatrix(column, ((org.apache.commons.math.linear.DenseFieldMatrix<T>) (matrix)));
		} catch (java.lang.ClassCastException cce) {
			super.setColumnMatrix(column, matrix);
		}
	}

	void setColumnMatrix(final int column, final org.apache.commons.math.linear.DenseFieldMatrix<T> matrix) throws org.apache.commons.math.linear.InvalidMatrixException, org.apache.commons.math.linear.MatrixIndexException {
		checkColumnIndex(column);
	...
	public org.apache.commons.math.linear.FieldVector<T> getRowVector(final int row) throws org.apache.commons.math.linear.MatrixIndexException {
		...
		return new org.apache.commons.math.linear.FieldVectorImpl<T>(outData, false);
	}
	...
	public void setRowVector(final int row, final org.apache.commons.math.linear.FieldVector<T> vector) throws org.apache.commons.math.linear.InvalidMatrixException, org.apache.commons.math.linear.MatrixIndexException {
		try {
			setRow(row, ((org.apache.commons.math.linear.FieldVectorImpl<T>) (vector)).getDataRef());
		} catch (java.lang.ClassCastException cce) {
	...
	public void setColumnVector(final int column, final org.apache.commons.math.linear.FieldVector<T> vector) throws org.apache.commons.math.linear.InvalidMatrixException, org.apache.commons.math.linear.MatrixIndexException {
		try {
			setColumn(column, ((org.apache.commons.math.linear.FieldVectorImpl<T>) (vector)).getDataRef());
		} catch (java.lang.ClassCastException cce) {
	...
	public T getEntry(final int row, final int column) throws org.apache.commons.math.linear.MatrixIndexException {
		try {
			final int iBlock = row / (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE);
			final int jBlock = column / (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE);
			final int k = ((row - (iBlock * (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE))) * (blockWidth(jBlock))) + (column - (jBlock * (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE)));
	...
	public org.apache.commons.math.linear.FieldMatrix<T> transpose() {
		final int nRows = getRowDimension();
		final int nCols = getColumnDimension();
		final org.apache.commons.math.linear.DenseFieldMatrix<T> out = new org.apache.commons.math.linear.DenseFieldMatrix<T>(getField(), nCols, nRows);
		int blockIndex = 0;
		for (int iBlock = 0; iBlock < (blockColumns); ++iBlock) {
			for (int jBlock = 0; jBlock < (blockRows); ++jBlock) {
				...
				final int pStart = iBlock * (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE);
				final int pEnd = java.lang.Math.min((pStart + (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE)), columns);
				final int qStart = jBlock * (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE);
				final int qEnd = java.lang.Math.min((qStart + (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE)), rows);
				for (int p = pStart, k = 0; p < pEnd; ++p) {
	...
	public T walkInRowOrder(final org.apache.commons.math.linear.FieldMatrixChangingVisitor<T> visitor, final int startRow, final int endRow, final int startColumn, final int endColumn) throws org.apache.commons.math.linear.MatrixIndexException, org.apache.commons.math.linear.MatrixVisitorException {
		...
		for (int iBlock = startRow / (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE); iBlock < (1 + (endRow / (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE))); ++iBlock) {
			final int p0 = iBlock * (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE);
			final int pStart = java.lang.Math.max(startRow, p0);
			final int pEnd = java.lang.Math.min(((iBlock + 1) * (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE)), (1 + endRow));
			for (int p = pStart; p < pEnd; ++p) {
				for (int jBlock = startColumn / (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE); jBlock < (1 + (endColumn / (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE))); ++jBlock) {
					final int jWidth = blockWidth(jBlock);
					final int q0 = jBlock * (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE);
					final int qStart = java.lang.Math.max(startColumn, q0);
					final int qEnd = java.lang.Math.min(((jBlock + 1) * (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE)), (1 + endColumn));
					final T[] block = blocks[((iBlock * (blockColumns)) + jBlock)];
	...
	private int blockHeight(final int blockRow) {
		return blockRow == ((blockRows) - 1) ? (rows) - (blockRow * (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE)) : org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE;
	}

	private int blockWidth(final int blockColumn) {
		return blockColumn == ((blockColumns) - 1) ? (columns) - (blockColumn * (org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE)) : org.apache.commons.math.linear.DenseFieldMatrix.BLOCK_SIZE;
	}
}
