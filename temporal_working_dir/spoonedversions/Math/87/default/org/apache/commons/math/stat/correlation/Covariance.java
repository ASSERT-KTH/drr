...
public class Covariance {
	...
	public Covariance(double[][] data, boolean biasCorrected) {
		this(new org.apache.commons.math.linear.DenseRealMatrix(data), biasCorrected);
	}
	...
	protected org.apache.commons.math.linear.RealMatrix computeCovarianceMatrix(org.apache.commons.math.linear.RealMatrix matrix, boolean biasCorrected) {
		...
		org.apache.commons.math.linear.RealMatrix outMatrix = new org.apache.commons.math.linear.DenseRealMatrix(dimension, dimension);
	...
	protected org.apache.commons.math.linear.RealMatrix computeCovarianceMatrix(double[][] data, boolean biasCorrected) {
		return computeCovarianceMatrix(new org.apache.commons.math.linear.DenseRealMatrix(data), biasCorrected);
	}
