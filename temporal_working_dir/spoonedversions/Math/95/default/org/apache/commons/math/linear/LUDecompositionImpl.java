...
public class LUDecompositionImpl implements org.apache.commons.math.linear.LUDecomposition {
	...
	public void decompose(org.apache.commons.math.linear.RealMatrix matrix) throws org.apache.commons.math.linear.InvalidMatrixException {
		decompose(matrix, org.apache.commons.math.linear.LUDecompositionImpl.DEFAULT_TOO_SMALL);
	}

	public void decompose(org.apache.commons.math.linear.RealMatrix matrix, double singularityThreshold) throws org.apache.commons.math.linear.InvalidMatrixException {
		if (!(matrix.isSquare())) {
	...
	public org.apache.commons.math.linear.RealMatrix getL() throws java.lang.IllegalStateException {
		checkDecomposed();
	...
	public org.apache.commons.math.linear.RealMatrix getU() throws java.lang.IllegalStateException {
		checkDecomposed();
	...
	public org.apache.commons.math.linear.RealMatrix getP() throws java.lang.IllegalStateException {
		checkDecomposed();
	...
	public int[] getPivot() throws java.lang.IllegalStateException {
		checkDecomposed();
		return pivot.clone();
	}

	public boolean isNonSingular() throws java.lang.IllegalStateException {
		checkDecomposed();
		return !(singular);
	}

	public double getDeterminant() throws java.lang.IllegalStateException {
		checkDecomposed();
		if (singular) {
			return 0;
		}else {
