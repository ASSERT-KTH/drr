...
public class MultivariateSummaryStatistics implements java.io.Serializable , org.apache.commons.math.stat.descriptive.StatisticalMultivariateSummary {
	...
	public MultivariateSummaryStatistics(int k, boolean isCovarianceBiasCorrected) {
		org.apache.commons.math.stat.descriptive.MultivariateSummaryStatistics.this.k = k;
	...
	public void clear() {
		org.apache.commons.math.stat.descriptive.MultivariateSummaryStatistics.this.n = 0;
		for (int i = 0; i < (k); ++i) {
			minImpl[i].clear();
			maxImpl[i].clear();
			sumImpl[i].clear();
	...
	public boolean equals(java.lang.Object object) {
		if (object == (org.apache.commons.math.stat.descriptive.MultivariateSummaryStatistics.this)) {
			return true;
		}
		...
		return ((((((((org.apache.commons.math.util.MathUtils.equals(stat.getGeometricMean(), org.apache.commons.math.stat.descriptive.MultivariateSummaryStatistics.this.getGeometricMean())) && (org.apache.commons.math.util.MathUtils.equals(stat.getMax(), org.apache.commons.math.stat.descriptive.MultivariateSummaryStatistics.this.getMax()))) && (org.apache.commons.math.util.MathUtils.equals(stat.getMean(), org.apache.commons.math.stat.descriptive.MultivariateSummaryStatistics.this.getMean()))) && (org.apache.commons.math.util.MathUtils.equals(stat.getMin(), org.apache.commons.math.stat.descriptive.MultivariateSummaryStatistics.this.getMin()))) && (org.apache.commons.math.util.MathUtils.equals(stat.getN(), org.apache.commons.math.stat.descriptive.MultivariateSummaryStatistics.this.getN()))) && (org.apache.commons.math.util.MathUtils.equals(stat.getSum(), org.apache.commons.math.stat.descriptive.MultivariateSummaryStatistics.this.getSum()))) && (org.apache.commons.math.util.MathUtils.equals(stat.getSumSq(), org.apache.commons.math.stat.descriptive.MultivariateSummaryStatistics.this.getSumSq()))) && (org.apache.commons.math.util.MathUtils.equals(stat.getSumLog(), org.apache.commons.math.stat.descriptive.MultivariateSummaryStatistics.this.getSumLog()))) && (stat.getCovariance().equals(org.apache.commons.math.stat.descriptive.MultivariateSummaryStatistics.this.getCovariance()));
	}
	...
	public org.apache.commons.math.stat.descriptive.StorelessUnivariateStatistic[] getSumImpl() {
		return ((org.apache.commons.math.stat.descriptive.StorelessUnivariateStatistic[]) (sumImpl.clone()));
	}
	...
	public void setSumImpl(org.apache.commons.math.stat.descriptive.StorelessUnivariateStatistic[] sumImpl) throws org.apache.commons.math.DimensionMismatchException {
		setImpl(sumImpl, org.apache.commons.math.stat.descriptive.MultivariateSummaryStatistics.this.sumImpl);
	}

	public org.apache.commons.math.stat.descriptive.StorelessUnivariateStatistic[] getSumsqImpl() {
		return ((org.apache.commons.math.stat.descriptive.StorelessUnivariateStatistic[]) (sumSqImpl.clone()));
	}
	...
	public void setSumsqImpl(org.apache.commons.math.stat.descriptive.StorelessUnivariateStatistic[] sumsqImpl) throws org.apache.commons.math.DimensionMismatchException {
		setImpl(sumsqImpl, org.apache.commons.math.stat.descriptive.MultivariateSummaryStatistics.this.sumSqImpl);
	}

	public org.apache.commons.math.stat.descriptive.StorelessUnivariateStatistic[] getMinImpl() {
		return ((org.apache.commons.math.stat.descriptive.StorelessUnivariateStatistic[]) (minImpl.clone()));
	}
	...
	public void setMinImpl(org.apache.commons.math.stat.descriptive.StorelessUnivariateStatistic[] minImpl) throws org.apache.commons.math.DimensionMismatchException {
		setImpl(minImpl, org.apache.commons.math.stat.descriptive.MultivariateSummaryStatistics.this.minImpl);
	}

	public org.apache.commons.math.stat.descriptive.StorelessUnivariateStatistic[] getMaxImpl() {
		return ((org.apache.commons.math.stat.descriptive.StorelessUnivariateStatistic[]) (maxImpl.clone()));
	}
	...
	public void setMaxImpl(org.apache.commons.math.stat.descriptive.StorelessUnivariateStatistic[] maxImpl) throws org.apache.commons.math.DimensionMismatchException {
		setImpl(maxImpl, org.apache.commons.math.stat.descriptive.MultivariateSummaryStatistics.this.maxImpl);
	}

	public org.apache.commons.math.stat.descriptive.StorelessUnivariateStatistic[] getSumLogImpl() {
		return ((org.apache.commons.math.stat.descriptive.StorelessUnivariateStatistic[]) (sumLogImpl.clone()));
	}
	...
	public void setSumLogImpl(org.apache.commons.math.stat.descriptive.StorelessUnivariateStatistic[] sumLogImpl) throws org.apache.commons.math.DimensionMismatchException {
		setImpl(sumLogImpl, org.apache.commons.math.stat.descriptive.MultivariateSummaryStatistics.this.sumLogImpl);
	}

	public org.apache.commons.math.stat.descriptive.StorelessUnivariateStatistic[] getGeoMeanImpl() {
		return ((org.apache.commons.math.stat.descriptive.StorelessUnivariateStatistic[]) (geoMeanImpl.clone()));
	}
	...
	public void setGeoMeanImpl(org.apache.commons.math.stat.descriptive.StorelessUnivariateStatistic[] geoMeanImpl) throws org.apache.commons.math.DimensionMismatchException {
		setImpl(geoMeanImpl, org.apache.commons.math.stat.descriptive.MultivariateSummaryStatistics.this.geoMeanImpl);
	}

	public org.apache.commons.math.stat.descriptive.StorelessUnivariateStatistic[] getMeanImpl() {
		return ((org.apache.commons.math.stat.descriptive.StorelessUnivariateStatistic[]) (meanImpl.clone()));
	}
	...
	public void setMeanImpl(org.apache.commons.math.stat.descriptive.StorelessUnivariateStatistic[] meanImpl) throws org.apache.commons.math.DimensionMismatchException {
		setImpl(meanImpl, org.apache.commons.math.stat.descriptive.MultivariateSummaryStatistics.this.meanImpl);
	}

	private void checkEmpty() {
		if ((n) > 0) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalStateException("{0} values have been added before statistic is configured", new java.lang.Object[]{ n });
		}
	}
