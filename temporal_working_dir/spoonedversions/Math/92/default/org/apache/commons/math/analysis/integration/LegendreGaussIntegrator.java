	...
	public LegendreGaussIntegrator(final int n, final int defaultMaximalIterationCount) throws java.lang.IllegalArgumentException {
		...
		switch (n) {
			...
			case 5 :
				...
				break;
			default :
				throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(("{0} points Legendre-Gauss integrator not supported, " + "number of points must be in the {1}-{2} range"), new java.lang.Object[]{ n , 2 , 5 });
		}
	}
