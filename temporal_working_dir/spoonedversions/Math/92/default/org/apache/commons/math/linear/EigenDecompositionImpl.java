...
public class EigenDecompositionImpl implements org.apache.commons.math.linear.EigenDecomposition {
	...
	public EigenDecompositionImpl(final org.apache.commons.math.linear.RealMatrix matrix, final double splitTolerance) throws org.apache.commons.math.linear.InvalidMatrixException {
		if (isSymmetric(matrix)) {
			...
			throw new org.apache.commons.math.linear.InvalidMatrixException("eigen decomposition of assymetric matrices not supported yet", null);
		}
	}
	...
	private void process2RowsBlock(final int index) throws org.apache.commons.math.linear.InvalidMatrixException {
		...
		if (delta < 0) {
			throw new org.apache.commons.math.linear.InvalidMatrixException("cannot solve degree {0} equation", new java.lang.Object[]{ 2 });
		}
	...
	private void process3RowsBlock(final int index) throws org.apache.commons.math.linear.InvalidMatrixException {
		...
		if (delta >= 0) {
			throw new org.apache.commons.math.linear.InvalidMatrixException("cannot solve degree {0} equation", new java.lang.Object[]{ 3 });
		}
	...
	private void processGeneralBlock(final int n) throws org.apache.commons.math.linear.InvalidMatrixException {
		...
		while (n0 > 0) {
			...
			for (int k = 0; i0 < n0; ++k) {
				...
				n0 = goodStep(i0, n0);
				pingPong = 1 - (pingPong);
				if (((((pingPong) == 0) && ((n0 - i0) > 3)) && ((work[((4 * n0) - 1)]) <= ((org.apache.commons.math.linear.EigenDecompositionImpl.TOLERANCE_2) * qMax))) && ((work[((4 * n0) - 2)]) <= ((org.apache.commons.math.linear.EigenDecompositionImpl.TOLERANCE_2) * (sigma)))) {
					int split = i0 - 1;
					qMax = work[(4 * i0)];
					eMin = work[((4 * i0) + 2)];
