		...
		if (sign > 0) {
			if ((java.lang.Math.abs(yMin)) <= (functionValueAccuracy)) {
				...
				if ((java.lang.Math.abs(yMax)) <= (functionValueAccuracy)) {
					...
					throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(("function values at endpoints do not have different signs.  " + "Endpoints: [{0}, {1}], Values: [{2}, {3}]"), new java.lang.Object[]{ min , max , yMin , yMax });
				}
