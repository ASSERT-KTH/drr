...
public abstract class DirectSearchOptimizer {
	...
	public org.apache.commons.math.optimization.PointCostPair minimize(org.apache.commons.math.optimization.CostFunction f, int maxEvaluations, org.apache.commons.math.optimization.ConvergenceChecker checker, double[][] vertices, int starts, long seed) throws org.apache.commons.math.ConvergenceException, org.apache.commons.math.optimization.CostException, org.apache.commons.math.random.NotPositiveDefiniteMatrixException {
		try {
			...
			org.apache.commons.math.stat.descriptive.moment.VectorialCovariance covStat = new org.apache.commons.math.stat.descriptive.moment.VectorialCovariance(vertices[0].length, true);
			...
			throw new org.apache.commons.math.MathRuntimeException("unexpected exception caught", null, dme);
		}
	}
	...
	private void setMultiStart(int starts, org.apache.commons.math.random.RandomVectorGenerator generator) {
		if (starts < 2) {
	...
	private org.apache.commons.math.optimization.PointCostPair minimize(org.apache.commons.math.optimization.CostFunction f, int maxEvaluations, org.apache.commons.math.optimization.ConvergenceChecker checker) throws org.apache.commons.math.ConvergenceException, org.apache.commons.math.optimization.CostException {
		...
		if ((minima[0]) == null) {
			throw new org.apache.commons.math.ConvergenceException(("none of the {0} start points" + " lead to convergence"), new java.lang.Object[]{ java.lang.Integer.toString(starts) });
		}
		return minima[0];
	}
	...
	protected void evaluateSimplex() throws org.apache.commons.math.optimization.CostException {
		for (int i = 0; i < (simplex.length); ++i) {
			...
			if (java.lang.Double.isNaN(pair.getCost())) {
				simplex[i] = new org.apache.commons.math.optimization.PointCostPair(pair.getPoint(), evaluateCost(pair.getPoint()));
			}
		}
	...
	private static java.util.Comparator<org.apache.commons.math.optimization.PointCostPair> pointCostPairComparator = new java.util.Comparator<org.apache.commons.math.optimization.PointCostPair>() {
		public int compare(org.apache.commons.math.optimization.PointCostPair o1, org.apache.commons.math.optimization.PointCostPair o2) {
			if (o1 == null) {
				return o2 == null ? 0 : +1;
			}else
				if (o2 == null) {
