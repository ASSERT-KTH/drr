...
public class BlockRealMatrix extends org.apache.commons.math.linear.AbstractRealMatrix implements java.io.Serializable {
	...
	public BlockRealMatrix(final int rows, final int columns, final double[][] blockData, final boolean copyArray) {
		super(rows, columns);
		this.rows = rows;
		this.columns = columns;
		blockRows = ((rows + (org.apache.commons.math.linear.BlockRealMatrix.BLOCK_SIZE)) - 1) / (org.apache.commons.math.linear.BlockRealMatrix.BLOCK_SIZE);
	...
	public static double[][] toBlocksLayout(final double[][] rawData) {
		...
		for (int iBlock = 0; iBlock < blockRows; ++iBlock) {
			...
			final int pEnd = org.apache.commons.math.util.FastMath.min((pStart + (org.apache.commons.math.linear.BlockRealMatrix.BLOCK_SIZE)), rows);
			final int iHeight = pEnd - pStart;
			for (int jBlock = 0; jBlock < blockColumns; ++jBlock) {
				final int qStart = jBlock * (org.apache.commons.math.linear.BlockRealMatrix.BLOCK_SIZE);
				final int qEnd = org.apache.commons.math.util.FastMath.min((qStart + (org.apache.commons.math.linear.BlockRealMatrix.BLOCK_SIZE)), columns);
	...
	@java.lang.Override
	public org.apache.commons.math.linear.BlockRealMatrix createMatrix(final int rowDimension, final int columnDimension) {
	...
	@java.lang.Override
	public org.apache.commons.math.linear.BlockRealMatrix add(final org.apache.commons.math.linear.RealMatrix m) {
		try {
			return add(((org.apache.commons.math.linear.BlockRealMatrix) (m)));
		} catch (java.lang.ClassCastException cce) {
			org.apache.commons.math.linear.MatrixUtils.checkAdditionCompatible(org.apache.commons.math.linear.BlockRealMatrix.this, m);
	...
	public org.apache.commons.math.linear.BlockRealMatrix add(final org.apache.commons.math.linear.BlockRealMatrix m) {
		org.apache.commons.math.linear.MatrixUtils.checkAdditionCompatible(org.apache.commons.math.linear.BlockRealMatrix.this, m);
		final org.apache.commons.math.linear.BlockRealMatrix out = new org.apache.commons.math.linear.BlockRealMatrix(rows, columns);
	...
	@java.lang.Override
	public org.apache.commons.math.linear.BlockRealMatrix subtract(final org.apache.commons.math.linear.RealMatrix m) {
		try {
			return subtract(((org.apache.commons.math.linear.BlockRealMatrix) (m)));
		} catch (java.lang.ClassCastException cce) {
			org.apache.commons.math.linear.MatrixUtils.checkSubtractionCompatible(org.apache.commons.math.linear.BlockRealMatrix.this, m);
			final org.apache.commons.math.linear.BlockRealMatrix out = new org.apache.commons.math.linear.BlockRealMatrix(rows, columns);
			int blockIndex = 0;
			for (int iBlock = 0; iBlock < (out.blockRows); ++iBlock) {
				for (int jBlock = 0; jBlock < (out.blockColumns); ++jBlock) {
	...
	public org.apache.commons.math.linear.BlockRealMatrix subtract(final org.apache.commons.math.linear.BlockRealMatrix m) {
		org.apache.commons.math.linear.MatrixUtils.checkSubtractionCompatible(org.apache.commons.math.linear.BlockRealMatrix.this, m);
		final org.apache.commons.math.linear.BlockRealMatrix out = new org.apache.commons.math.linear.BlockRealMatrix(rows, columns);
		for (int blockIndex = 0; blockIndex < (out.blocks.length); ++blockIndex) {
			final double[] outBlock = out.blocks[blockIndex];
	...
	@java.lang.Override
	public org.apache.commons.math.linear.BlockRealMatrix scalarAdd(final double d) {
		final org.apache.commons.math.linear.BlockRealMatrix out = new org.apache.commons.math.linear.BlockRealMatrix(rows, columns);
		for (int blockIndex = 0; blockIndex < (out.blocks.length); ++blockIndex) {
			final double[] outBlock = out.blocks[blockIndex];
			final double[] tBlock = blocks[blockIndex];
	...
	@java.lang.Override
	public org.apache.commons.math.linear.BlockRealMatrix multiply(final org.apache.commons.math.linear.RealMatrix m) {
		try {
			return multiply(((org.apache.commons.math.linear.BlockRealMatrix) (m)));
		} catch (java.lang.ClassCastException cce) {
			org.apache.commons.math.linear.MatrixUtils.checkMultiplicationCompatible(org.apache.commons.math.linear.BlockRealMatrix.this, m);
			...
			for (int iBlock = 0; iBlock < (out.blockRows); ++iBlock) {
				...
				for (int jBlock = 0; jBlock < (out.blockColumns); ++jBlock) {
					final int qStart = jBlock * (org.apache.commons.math.linear.BlockRealMatrix.BLOCK_SIZE);
					final int qEnd = org.apache.commons.math.util.FastMath.min((qStart + (org.apache.commons.math.linear.BlockRealMatrix.BLOCK_SIZE)), m.getColumnDimension());
					final double[] outBlock = out.blocks[blockIndex];
	...
	public org.apache.commons.math.linear.BlockRealMatrix multiply(org.apache.commons.math.linear.BlockRealMatrix m) {
		org.apache.commons.math.linear.MatrixUtils.checkMultiplicationCompatible(org.apache.commons.math.linear.BlockRealMatrix.this, m);
	...
	public double getNorm() {
		...
		for (int jBlock = 0; jBlock < (blockColumns); jBlock++) {
			...
			for (int j = 0; j < jWidth; ++j) {
				maxColSum = org.apache.commons.math.util.FastMath.max(maxColSum, colSums[j]);
			}
		}
		return maxColSum;
	}
	...
	@java.lang.Override
	public org.apache.commons.math.linear.BlockRealMatrix getSubMatrix(final int startRow, final int endRow, final int startColumn, final int endColumn) {
		org.apache.commons.math.linear.MatrixUtils.checkSubMatrixIndex(org.apache.commons.math.linear.BlockRealMatrix.this, startRow, endRow, startColumn, endColumn);
			...
			for (int jBlock = 0; jBlock < (out.blockColumns); ++jBlock) {
				...
				if (heightExcess > 0) {
					if (widthExcess > 0) {
						...
						copyBlockPart(blocks[index], width, rowsShift, org.apache.commons.math.linear.BlockRealMatrix.BLOCK_SIZE, columnsShift, org.apache.commons.math.linear.BlockRealMatrix.BLOCK_SIZE, outBlock, jWidth, 0, 0);
						copyBlockPart(blocks[(index + 1)], width2, rowsShift, org.apache.commons.math.linear.BlockRealMatrix.BLOCK_SIZE, 0, widthExcess, outBlock, jWidth, 0, (jWidth - widthExcess));
						copyBlockPart(blocks[(index + (blockColumns))], width, 0, heightExcess, columnsShift, org.apache.commons.math.linear.BlockRealMatrix.BLOCK_SIZE, outBlock, jWidth, (iHeight - heightExcess), 0);
						...
						copyBlockPart(blocks[index], width, rowsShift, org.apache.commons.math.linear.BlockRealMatrix.BLOCK_SIZE, columnsShift, (jWidth + columnsShift), outBlock, jWidth, 0, 0);
					...
					if (widthExcess > 0) {
						final int width2 = blockWidth((qBlock + 1));
						copyBlockPart(blocks[index], width, rowsShift, (iHeight + rowsShift), columnsShift, org.apache.commons.math.linear.BlockRealMatrix.BLOCK_SIZE, outBlock, jWidth, 0, 0);
	...
	public void setSubMatrix(final double[][] subMatrix, final int row, final int column) {
		...
		org.apache.commons.math.linear.MatrixUtils.checkSubMatrixIndex(org.apache.commons.math.linear.BlockRealMatrix.this, row, endRow, column, endColumn);
	...
	@java.lang.Override
	public org.apache.commons.math.linear.BlockRealMatrix getRowMatrix(final int row) {
		org.apache.commons.math.linear.MatrixUtils.checkRowIndex(org.apache.commons.math.linear.BlockRealMatrix.this, row);
	...
	public void setRowMatrix(final int row, final org.apache.commons.math.linear.BlockRealMatrix matrix) {
		org.apache.commons.math.linear.MatrixUtils.checkRowIndex(org.apache.commons.math.linear.BlockRealMatrix.this, row);
	...
	@java.lang.Override
	public org.apache.commons.math.linear.BlockRealMatrix getColumnMatrix(final int column) {
		org.apache.commons.math.linear.MatrixUtils.checkColumnIndex(org.apache.commons.math.linear.BlockRealMatrix.this, column);
	...
	void setColumnMatrix(final int column, final org.apache.commons.math.linear.BlockRealMatrix matrix) {
		org.apache.commons.math.linear.MatrixUtils.checkColumnIndex(org.apache.commons.math.linear.BlockRealMatrix.this, column);
	...
	public double getEntry(final int row, final int column) {
		org.apache.commons.math.linear.MatrixUtils.checkMatrixIndex(org.apache.commons.math.linear.BlockRealMatrix.this, row, column);
		final int iBlock = row / (org.apache.commons.math.linear.BlockRealMatrix.BLOCK_SIZE);
		final int jBlock = column / (org.apache.commons.math.linear.BlockRealMatrix.BLOCK_SIZE);
		final int k = ((row - (iBlock * (org.apache.commons.math.linear.BlockRealMatrix.BLOCK_SIZE))) * (blockWidth(jBlock))) + (column - (jBlock * (org.apache.commons.math.linear.BlockRealMatrix.BLOCK_SIZE)));
	...
	public org.apache.commons.math.linear.BlockRealMatrix transpose() {
		...
		for (int iBlock = 0; iBlock < (blockColumns); ++iBlock) {
			for (int jBlock = 0; jBlock < (blockRows); ++jBlock) {
				...
				final int pStart = iBlock * (org.apache.commons.math.linear.BlockRealMatrix.BLOCK_SIZE);
				final int pEnd = org.apache.commons.math.util.FastMath.min((pStart + (org.apache.commons.math.linear.BlockRealMatrix.BLOCK_SIZE)), columns);
				final int qStart = jBlock * (org.apache.commons.math.linear.BlockRealMatrix.BLOCK_SIZE);
				final int qEnd = org.apache.commons.math.util.FastMath.min((qStart + (org.apache.commons.math.linear.BlockRealMatrix.BLOCK_SIZE)), rows);
				int k = 0;
				for (int p = pStart; p < pEnd; ++p) {
	...
	public double walkInRowOrder(final org.apache.commons.math.linear.RealMatrixChangingVisitor visitor, final int startRow, final int endRow, final int startColumn, final int endColumn) {
		...
		for (int iBlock = startRow / (org.apache.commons.math.linear.BlockRealMatrix.BLOCK_SIZE); iBlock < (1 + (endRow / (org.apache.commons.math.linear.BlockRealMatrix.BLOCK_SIZE))); ++iBlock) {
			...
			final int pEnd = org.apache.commons.math.util.FastMath.min(((iBlock + 1) * (org.apache.commons.math.linear.BlockRealMatrix.BLOCK_SIZE)), (1 + endRow));
			for (int p = pStart; p < pEnd; ++p) {
				for (int jBlock = startColumn / (org.apache.commons.math.linear.BlockRealMatrix.BLOCK_SIZE); jBlock < (1 + (endColumn / (org.apache.commons.math.linear.BlockRealMatrix.BLOCK_SIZE))); ++jBlock) {
					...
					final int qEnd = org.apache.commons.math.util.FastMath.min(((jBlock + 1) * (org.apache.commons.math.linear.BlockRealMatrix.BLOCK_SIZE)), (1 + endColumn));
					final double[] block = blocks[((iBlock * (blockColumns)) + jBlock)];
	...
	private int blockHeight(final int blockRow) {
		return blockRow == ((blockRows) - 1) ? (rows) - (blockRow * (org.apache.commons.math.linear.BlockRealMatrix.BLOCK_SIZE)) : org.apache.commons.math.linear.BlockRealMatrix.BLOCK_SIZE;
	}

	private int blockWidth(final int blockColumn) {
		return blockColumn == ((blockColumns) - 1) ? (columns) - (blockColumn * (org.apache.commons.math.linear.BlockRealMatrix.BLOCK_SIZE)) : org.apache.commons.math.linear.BlockRealMatrix.BLOCK_SIZE;
	}
}
