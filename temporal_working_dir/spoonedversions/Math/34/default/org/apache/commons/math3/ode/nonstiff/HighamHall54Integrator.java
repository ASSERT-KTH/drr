...
public class HighamHall54Integrator extends org.apache.commons.math3.ode.nonstiff.EmbeddedRungeKuttaIntegrator {
	...
	public HighamHall54Integrator(final double minStep, final double maxStep, final double scalAbsoluteTolerance, final double scalRelativeTolerance) {
		super(org.apache.commons.math3.ode.nonstiff.HighamHall54Integrator.METHOD_NAME, false, org.apache.commons.math3.ode.nonstiff.HighamHall54Integrator.STATIC_C, org.apache.commons.math3.ode.nonstiff.HighamHall54Integrator.STATIC_A, org.apache.commons.math3.ode.nonstiff.HighamHall54Integrator.STATIC_B, new org.apache.commons.math3.ode.nonstiff.HighamHall54StepInterpolator(), minStep, maxStep, scalAbsoluteTolerance, scalRelativeTolerance);
	}
	...
	public HighamHall54Integrator(final double minStep, final double maxStep, final double[] vecAbsoluteTolerance, final double[] vecRelativeTolerance) {
		super(org.apache.commons.math3.ode.nonstiff.HighamHall54Integrator.METHOD_NAME, false, org.apache.commons.math3.ode.nonstiff.HighamHall54Integrator.STATIC_C, org.apache.commons.math3.ode.nonstiff.HighamHall54Integrator.STATIC_A, org.apache.commons.math3.ode.nonstiff.HighamHall54Integrator.STATIC_B, new org.apache.commons.math3.ode.nonstiff.HighamHall54StepInterpolator(), minStep, maxStep, vecAbsoluteTolerance, vecRelativeTolerance);
	}
	...
	protected double estimateError(final double[][] yDotK, final double[] y0, final double[] y1, final double h) {
		...
		for (int j = 0; j < (mainSetDimension); ++j) {
			double errSum = (org.apache.commons.math3.ode.nonstiff.HighamHall54Integrator.STATIC_E[0]) * (yDotK[0][j]);
			for (int l = 1; l < (org.apache.commons.math3.ode.nonstiff.HighamHall54Integrator.STATIC_E.length); ++l) {
				errSum += (org.apache.commons.math3.ode.nonstiff.HighamHall54Integrator.STATIC_E[l]) * (yDotK[l][j]);
			}
