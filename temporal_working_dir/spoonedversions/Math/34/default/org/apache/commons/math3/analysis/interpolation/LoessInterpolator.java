...
public class LoessInterpolator implements java.io.Serializable , org.apache.commons.math3.analysis.interpolation.UnivariateInterpolator {
	...
	public LoessInterpolator() {
		this.bandwidth = org.apache.commons.math3.analysis.interpolation.LoessInterpolator.DEFAULT_BANDWIDTH;
		this.robustnessIters = org.apache.commons.math3.analysis.interpolation.LoessInterpolator.DEFAULT_ROBUSTNESS_ITERS;
		this.accuracy = org.apache.commons.math3.analysis.interpolation.LoessInterpolator.DEFAULT_ACCURACY;
	}

	public LoessInterpolator(double bandwidth, int robustnessIters) {
		this(bandwidth, robustnessIters, org.apache.commons.math3.analysis.interpolation.LoessInterpolator.DEFAULT_ACCURACY);
	}
	...
	public final org.apache.commons.math3.analysis.polynomials.PolynomialSplineFunction interpolate(final double[] xval, final double[] yval) {
		return new org.apache.commons.math3.analysis.interpolation.SplineInterpolator().interpolate(xval, smooth(xval, yval));
	}
	...
	public final double[] smooth(final double[] xval, final double[] yval, final double[] weights) {
		...
		org.apache.commons.math3.analysis.interpolation.LoessInterpolator.checkAllFiniteReal(xval);
		org.apache.commons.math3.analysis.interpolation.LoessInterpolator.checkAllFiniteReal(yval);
		org.apache.commons.math3.analysis.interpolation.LoessInterpolator.checkAllFiniteReal(weights);
		...
		if (bandwidthInPoints < 2) {
			throw new org.apache.commons.math3.exception.NumberIsTooSmallException(org.apache.commons.math3.exception.util.LocalizedFormats.BANDWIDTH, bandwidthInPoints, 2, true);
		}
	...
	private static void updateBandwidthInterval(final double[] xval, final double[] weights, final int i, final int[] bandwidthInterval) {
		...
		int nextRight = org.apache.commons.math3.analysis.interpolation.LoessInterpolator.nextNonzero(weights, right);
