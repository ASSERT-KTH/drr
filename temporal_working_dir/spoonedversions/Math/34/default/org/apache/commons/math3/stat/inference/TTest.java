...
public class TTest {
	...
	protected double tTest(final double m, final double mu, final double v, final double n) throws org.apache.commons.math3.exception.MaxCountExceededException {
	...
	protected double tTest(final double m1, final double m2, final double v1, final double v2, final double n1, final double n2) throws org.apache.commons.math3.exception.MaxCountExceededException {
	...
	protected double homoscedasticTTest(double m1, double m2, double v1, double v2, double n1, double n2) throws org.apache.commons.math3.exception.MaxCountExceededException {
