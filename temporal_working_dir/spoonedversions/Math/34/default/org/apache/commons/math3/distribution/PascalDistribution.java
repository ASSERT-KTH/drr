...
public class PascalDistribution extends org.apache.commons.math3.distribution.AbstractIntegerDistribution {
	...
	public double probability(int x) {
		...
		if (x < 0) {
			...
			ret = ((org.apache.commons.math3.util.ArithmeticUtils.binomialCoefficientDouble(((x + (numberOfSuccesses)) - 1), ((numberOfSuccesses) - 1))) * (org.apache.commons.math3.util.FastMath.pow(probabilityOfSuccess, numberOfSuccesses))) * (org.apache.commons.math3.util.FastMath.pow((1.0 - (probabilityOfSuccess)), x));
		}
		return ret;
	}
	...
	public double cumulativeProbability(int x) {
		...
		if (x < 0) {
			...
			ret = org.apache.commons.math3.special.Beta.regularizedBeta(probabilityOfSuccess, numberOfSuccesses, (x + 1));
		}
		return ret;
	}
