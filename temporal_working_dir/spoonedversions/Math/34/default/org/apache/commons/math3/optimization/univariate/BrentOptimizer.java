			...
			if (!stop) {
				...
				if (fu <= fx) {
					...
					if ((fu <= fw) || (org.apache.commons.math3.util.Precision.equals(w, x))) {
						...
						if (((fu <= fv) || (org.apache.commons.math3.util.Precision.equals(v, x))) || (org.apache.commons.math3.util.Precision.equals(v, w))) {
							v = u;
							fv = fu;
						}
				...
				previous = current;
				current = new org.apache.commons.math3.optimization.univariate.UnivariatePointValuePair(x, (isMinim ? fx : -fx));
				if (checker != null) {
