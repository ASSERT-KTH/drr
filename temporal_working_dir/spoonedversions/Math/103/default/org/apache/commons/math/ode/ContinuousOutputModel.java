...
public class ContinuousOutputModel implements java.io.Serializable , org.apache.commons.math.ode.StepHandler {
	...
	public void append(org.apache.commons.math.ode.ContinuousOutputModel model) {
		...
		for (java.util.Iterator iter = model.steps.iterator(); iter.hasNext();) {
			org.apache.commons.math.ode.AbstractStepInterpolator ai = ((org.apache.commons.math.ode.AbstractStepInterpolator) (iter.next()));
			steps.add(ai.clone());
		}
		index = (steps.size()) - 1;
