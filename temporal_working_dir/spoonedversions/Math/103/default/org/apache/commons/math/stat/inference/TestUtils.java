...
public class TestUtils {
	...
	private static org.apache.commons.math.stat.inference.TTest tTest = org.apache.commons.math.stat.inference.TestFactory.newInstance().createTTest();

	private static org.apache.commons.math.stat.inference.ChiSquareTest chiSquareTest = org.apache.commons.math.stat.inference.TestFactory.newInstance().createChiSquareTest();
	...
	public static double chiSquareDataSetsComparison(long[] observed1, long[] observed2) throws java.lang.IllegalArgumentException {
		return org.apache.commons.math.stat.inference.TestUtils.chiSquareTest.chiSquareDataSetsComparison(observed1, observed2);
	}
	...
	public static double chiSquareTestDataSetsComparison(long[] observed1, long[] observed2) throws java.lang.IllegalArgumentException, org.apache.commons.math.MathException {
		return org.apache.commons.math.stat.inference.TestUtils.chiSquareTest.chiSquareTestDataSetsComparison(observed1, observed2);
	}
	...
	public static boolean chiSquareTestDataSetsComparison(long[] observed1, long[] observed2, double alpha) throws java.lang.IllegalArgumentException, org.apache.commons.math.MathException {
		return org.apache.commons.math.stat.inference.TestUtils.chiSquareTest.chiSquareTestDataSetsComparison(observed1, observed2, alpha);
	}
}
