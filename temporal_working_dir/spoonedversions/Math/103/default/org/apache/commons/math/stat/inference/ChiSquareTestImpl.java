...
public class ChiSquareTestImpl implements org.apache.commons.math.stat.inference.ChiSquareTest {
	...
	public double chiSquareDataSetsComparison(long[] observed1, long[] observed2) throws java.lang.IllegalArgumentException {
		if (((observed1.length) < 2) || ((observed1.length) != (observed2.length))) {
			throw new java.lang.IllegalArgumentException("oberved1, observed2 array lengths incorrect");
		}
		if ((!(isNonNegative(observed1))) || (!(isNonNegative(observed2)))) {
			throw new java.lang.IllegalArgumentException("observed counts must be non-negative");
		}
		long countSum1 = 0;
		long countSum2 = 0;
		...
		if ((countSum1 * countSum2) == 0) {
			throw new java.lang.IllegalArgumentException("observed counts cannot all be 0");
		}
		...
		for (int i = 0; i < (observed1.length); i++) {
			if (((observed1[i]) == 0) && ((observed2[i]) == 0)) {
				throw new java.lang.IllegalArgumentException("observed counts must not both be zero");
			}else {
