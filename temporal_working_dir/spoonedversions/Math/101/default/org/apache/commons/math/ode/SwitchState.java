...
class SwitchState implements java.io.Serializable {
	...
	public void reinitializeBegin(double t0, double[] y0) throws org.apache.commons.math.FunctionEvaluationException {
		org.apache.commons.math.ode.SwitchState.this.t0 = t0;
		g0 = function.g(t0, y0);
		g0Positive = (g0) >= 0;
	}

	public boolean evaluateStep(final org.apache.commons.math.ode.StepInterpolator interpolator) throws org.apache.commons.math.ConvergenceException, org.apache.commons.math.FunctionEvaluationException, org.apache.commons.math.ode.DerivativeException {
		try {
	...
	public void stepAccepted(double t, double[] y) throws org.apache.commons.math.FunctionEvaluationException {
		t0 = t;
		g0 = function.g(t, y);
		if (pendingEvent) {
			previousEventTime = t;
