...
public class Rotation implements java.io.Serializable {
	...
	public Rotation(org.apache.commons.math.geometry.Vector3D axis, double angle) {
		...
		if (norm == 0) {
			throw new java.lang.ArithmeticException("zero norm for rotation axis");
		}
	...
	public Rotation(double[][] m, double threshold) throws org.apache.commons.math.geometry.NotARotationMatrixException {
		if (((((m.length) != 3) || ((m[0].length) != 3)) || ((m[1].length) != 3)) || ((m[2].length) != 3)) {
			throw new org.apache.commons.math.geometry.NotARotationMatrixException(("a {0}x{1} matrix" + " cannot be a rotation matrix"), new java.lang.Object[]{ java.lang.Integer.toString(m.length) , java.lang.Integer.toString(m[0].length) });
		}
		...
		if (det < 0.0) {
			throw new org.apache.commons.math.geometry.NotARotationMatrixException(("the closest orthogonal matrix" + " has a negative determinant {0}"), new java.lang.Object[]{ java.lang.Double.toString(det) });
		}
	...
	public Rotation(org.apache.commons.math.geometry.Vector3D u1, org.apache.commons.math.geometry.Vector3D u2, org.apache.commons.math.geometry.Vector3D v1, org.apache.commons.math.geometry.Vector3D v2) {
		...
		if ((((u1u1 == 0) || (u2u2 == 0)) || (v1v1 == 0)) || (v2v2 == 0)) {
			throw new java.lang.IllegalArgumentException("zero norm for rotation defining vector");
		}
		double u1x = u1.getX();
		double u1y = u1.getY();
		double u1z = u1.getZ();
	...
	public double[] getAngles(org.apache.commons.math.geometry.RotationOrder order) throws org.apache.commons.math.geometry.CardanEulerSingularityException {
		if (order == (org.apache.commons.math.geometry.RotationOrder.XYZ)) {
			org.apache.commons.math.geometry.Vector3D v1 = applyTo(org.apache.commons.math.geometry.Vector3D.plusK);
			org.apache.commons.math.geometry.Vector3D v2 = applyInverseTo(org.apache.commons.math.geometry.Vector3D.plusI);
			...
			if (order == (org.apache.commons.math.geometry.RotationOrder.XZY)) {
				org.apache.commons.math.geometry.Vector3D v1 = applyTo(org.apache.commons.math.geometry.Vector3D.plusJ);
				org.apache.commons.math.geometry.Vector3D v2 = applyInverseTo(org.apache.commons.math.geometry.Vector3D.plusI);
				...
				if (order == (org.apache.commons.math.geometry.RotationOrder.YXZ)) {
					org.apache.commons.math.geometry.Vector3D v1 = applyTo(org.apache.commons.math.geometry.Vector3D.plusK);
					org.apache.commons.math.geometry.Vector3D v2 = applyInverseTo(org.apache.commons.math.geometry.Vector3D.plusJ);
					if (((v2.getZ()) < (-0.9999999999)) || ((v2.getZ()) > 0.9999999999)) {
						throw new org.apache.commons.math.geometry.CardanEulerSingularityException(true);
					}
					...
					if (order == (org.apache.commons.math.geometry.RotationOrder.YZX)) {
						org.apache.commons.math.geometry.Vector3D v1 = applyTo(org.apache.commons.math.geometry.Vector3D.plusI);
						org.apache.commons.math.geometry.Vector3D v2 = applyInverseTo(org.apache.commons.math.geometry.Vector3D.plusJ);
						...
						if (order == (org.apache.commons.math.geometry.RotationOrder.ZXY)) {
							org.apache.commons.math.geometry.Vector3D v1 = applyTo(org.apache.commons.math.geometry.Vector3D.plusJ);
							org.apache.commons.math.geometry.Vector3D v2 = applyInverseTo(org.apache.commons.math.geometry.Vector3D.plusK);
							if (((v2.getY()) < (-0.9999999999)) || ((v2.getY()) > 0.9999999999)) {
								throw new org.apache.commons.math.geometry.CardanEulerSingularityException(true);
							}
	...
	private double[][] orthogonalizeMatrix(double[][] m, double threshold) throws org.apache.commons.math.geometry.NotARotationMatrixException {
		...
		throw new org.apache.commons.math.geometry.NotARotationMatrixException(("unable to orthogonalize matrix" + " in {0} iterations"), new java.lang.Object[]{ java.lang.Integer.toString((i - 1)) });
	}
