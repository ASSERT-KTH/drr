...
public final class StatUtils {
	private static org.apache.commons.math.stat.descriptive.UnivariateStatistic sum = new org.apache.commons.math.stat.descriptive.summary.Sum();

	private static org.apache.commons.math.stat.descriptive.UnivariateStatistic sumSq = new org.apache.commons.math.stat.descriptive.summary.SumOfSquares();

	private static org.apache.commons.math.stat.descriptive.UnivariateStatistic prod = new org.apache.commons.math.stat.descriptive.summary.Product();

	private static org.apache.commons.math.stat.descriptive.UnivariateStatistic sumLog = new org.apache.commons.math.stat.descriptive.summary.SumOfLogs();

	private static org.apache.commons.math.stat.descriptive.UnivariateStatistic min = new org.apache.commons.math.stat.descriptive.rank.Min();

	private static org.apache.commons.math.stat.descriptive.UnivariateStatistic max = new org.apache.commons.math.stat.descriptive.rank.Max();

	private static org.apache.commons.math.stat.descriptive.UnivariateStatistic mean = new org.apache.commons.math.stat.descriptive.moment.Mean();

	private static org.apache.commons.math.stat.descriptive.moment.Variance variance = new org.apache.commons.math.stat.descriptive.moment.Variance();

	private static org.apache.commons.math.stat.descriptive.rank.Percentile percentile = new org.apache.commons.math.stat.descriptive.rank.Percentile();

	private static org.apache.commons.math.stat.descriptive.moment.GeometricMean geometricMean = new org.apache.commons.math.stat.descriptive.moment.GeometricMean();
	...
	public static double sumDifference(final double[] sample1, final double[] sample2) throws java.lang.IllegalArgumentException {
		...
		if ((n != (sample2.length)) || (n < 1)) {
			throw new java.lang.IllegalArgumentException("Input arrays must have the same (positive) length.");
		}
		double result = 0;
		for (int i = 0; i < n; i++) {
	...
	public static double meanDifference(final double[] sample1, final double[] sample2) throws java.lang.IllegalArgumentException {
		return (org.apache.commons.math.stat.StatUtils.sumDifference(sample1, sample2)) / ((double) (sample1.length));
	}
	...
	public static double varianceDifference(final double[] sample1, final double[] sample2, double meanDifference) throws java.lang.IllegalArgumentException {
		...
		if ((n < 2) || (n != (sample2.length))) {
			throw new java.lang.IllegalArgumentException("Input array lengths must be equal and at least 2.");
		}
		for (int i = 0; i < n; i++) {
