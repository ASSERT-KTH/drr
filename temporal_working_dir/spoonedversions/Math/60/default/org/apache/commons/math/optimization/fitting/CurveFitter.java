...
public class CurveFitter {
	...
	public double[] fit(final org.apache.commons.math.optimization.fitting.ParametricRealFunction f, final double[] initialGuess) throws org.apache.commons.math.exception.MathUserException {
		...
		org.apache.commons.math.optimization.VectorialPointValuePair optimum = optimizer.optimize(new org.apache.commons.math.optimization.fitting.CurveFitter.TheoreticalValuesFunction(f), target, weights, initialGuess);
