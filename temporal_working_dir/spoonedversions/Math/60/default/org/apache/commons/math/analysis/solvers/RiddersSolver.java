...
public class RiddersSolver extends org.apache.commons.math.analysis.solvers.AbstractUnivariateRealSolver {
	...
	protected double doSolve() {
		...
		while (true) {
			...
			final double correction = (((org.apache.commons.math.util.MathUtils.sign(y2)) * (org.apache.commons.math.util.MathUtils.sign(y3))) * (x3 - x1)) / (org.apache.commons.math.util.FastMath.sqrt(delta));
