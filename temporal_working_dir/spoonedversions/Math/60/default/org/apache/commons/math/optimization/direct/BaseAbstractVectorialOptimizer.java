...
public abstract class BaseAbstractVectorialOptimizer<FUNC extends org.apache.commons.math.analysis.MultivariateVectorialFunction> implements org.apache.commons.math.optimization.BaseMultivariateVectorialOptimizer<FUNC> {
	...
	public org.apache.commons.math.optimization.VectorialPointValuePair optimize(FUNC f, double[] t, double[] w, double[] startPoint) throws org.apache.commons.math.exception.MathUserException {
		if (f == null) {
	...
	protected abstract org.apache.commons.math.optimization.VectorialPointValuePair doOptimize() throws org.apache.commons.math.exception.MathUserException;
