...
public abstract class AdamsIntegrator extends org.apache.commons.math.ode.MultistepIntegrator {
	...
	@java.lang.Override
	public abstract double integrate(final org.apache.commons.math.ode.FirstOrderDifferentialEquations equations, final double t0, final double[] y0, final double t, final double[] y) throws org.apache.commons.math.exception.MathUserException, org.apache.commons.math.ode.IntegratorException;
