...
public class LaguerreSolver extends org.apache.commons.math.analysis.solvers.AbstractPolynomialSolver {
	public static final double DEFAULT_ABSOLUTE_ACCURACY = 1.0E-6;

	protected org.apache.commons.math.analysis.solvers.LaguerreSolver.ComplexSolver complexSolver = new org.apache.commons.math.analysis.solvers.LaguerreSolver.ComplexSolver();

	public LaguerreSolver() {
		this(org.apache.commons.math.analysis.solvers.LaguerreSolver.DEFAULT_ABSOLUTE_ACCURACY);
	}
	...
	public double doSolve() {
		...
		if ((org.apache.commons.math.util.FastMath.abs(yInitial)) <= functionValueAccuracy) {
			return initial;
		}
		double yMin = computeObjectiveValue(min);
		if ((org.apache.commons.math.util.FastMath.abs(yMin)) <= functionValueAccuracy) {
			return min;
		}
		if ((yInitial * yMin) < 0) {
		...
		if ((org.apache.commons.math.util.FastMath.abs(yMax)) <= functionValueAccuracy) {
			return max;
		}
		if ((yInitial * yMax) < 0) {
			return laguerre(initial, max, yInitial, yMax);
		}
		throw new org.apache.commons.math.exception.NoBracketingException(min, max, yMin, yMax);
	}
	...
	public double laguerre(double lo, double hi, double fLo, double fHi) {
		...
		for (int i = 0; i < (coefficients.length); i++) {
			c[i] = new org.apache.commons.math.complex.Complex(coefficients[i], 0);
		}
		org.apache.commons.math.complex.Complex initial = new org.apache.commons.math.complex.Complex((0.5 * (lo + hi)), 0);
		org.apache.commons.math.complex.Complex z = complexSolver.solve(c, initial);
		if (complexSolver.isRoot(lo, hi, z)) {
			return z.getReal();
		}else {
			double r = java.lang.Double.NaN;
			org.apache.commons.math.complex.Complex[] root = complexSolver.solveAll(c, initial);
	...
	private class ComplexSolver {
		public boolean isRoot(double min, double max, org.apache.commons.math.complex.Complex z) {
			double tolerance = org.apache.commons.math.util.FastMath.max(((getRelativeAccuracy()) * (z.abs())), getAbsoluteAccuracy());
			return (isSequence(min, z.getReal(), max)) && (((org.apache.commons.math.util.FastMath.abs(z.getImaginary())) <= tolerance) || ((z.abs()) <= (getFunctionValueAccuracy())));
		}

		public org.apache.commons.math.complex.Complex[] solveAll(double[] coefficients, double initial) {
			if (coefficients == null) {
				throw new org.apache.commons.math.exception.NullArgumentException();
			}
			org.apache.commons.math.complex.Complex[] c = new org.apache.commons.math.complex.Complex[coefficients.length];
			org.apache.commons.math.complex.Complex z = new org.apache.commons.math.complex.Complex(initial, 0);
		...
		public org.apache.commons.math.complex.Complex[] solveAll(org.apache.commons.math.complex.Complex[] coefficients, org.apache.commons.math.complex.Complex initial) {
			if (coefficients == null) {
				throw new org.apache.commons.math.exception.NullArgumentException();
			}
			int n = (coefficients.length) - 1;
			if (n == 0) {
				throw new org.apache.commons.math.exception.NoDataException(org.apache.commons.math.exception.util.LocalizedFormats.POLYNOMIAL);
			}
		...
		public org.apache.commons.math.complex.Complex solve(org.apache.commons.math.complex.Complex[] coefficients, org.apache.commons.math.complex.Complex initial) {
			if (coefficients == null) {
				throw new org.apache.commons.math.exception.NullArgumentException();
			}
			int n = (coefficients.length) - 1;
			...
			while (true) {
				...
				double tolerance = org.apache.commons.math.util.FastMath.max((relativeAccuracy * (z.abs())), absoluteAccuracy);
