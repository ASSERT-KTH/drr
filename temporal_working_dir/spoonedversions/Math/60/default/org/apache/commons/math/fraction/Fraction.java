...
public class Fraction extends java.lang.Number implements java.io.Serializable , java.lang.Comparable<org.apache.commons.math.fraction.Fraction> , org.apache.commons.math.FieldElement<org.apache.commons.math.fraction.Fraction> {
	...
	public Fraction(int num, int den) {
		if (den == 0) {
			throw org.apache.commons.math.MathRuntimeException.createArithmeticException(org.apache.commons.math.exception.util.LocalizedFormats.ZERO_DENOMINATOR_IN_FRACTION, num, den);
		}
		if (den < 0) {
			if ((num == (java.lang.Integer.MIN_VALUE)) || (den == (java.lang.Integer.MIN_VALUE))) {
				throw org.apache.commons.math.MathRuntimeException.createArithmeticException(org.apache.commons.math.exception.util.LocalizedFormats.OVERFLOW_IN_FRACTION, num, den);
			}
			num = -num;
			den = -den;
		}
	...
	public org.apache.commons.math.fraction.Fraction negate() {
		if ((numerator) == (java.lang.Integer.MIN_VALUE)) {
			throw org.apache.commons.math.MathRuntimeException.createArithmeticException(org.apache.commons.math.exception.util.LocalizedFormats.OVERFLOW_IN_FRACTION, numerator, denominator);
		}
	...
	public org.apache.commons.math.fraction.Fraction divide(org.apache.commons.math.fraction.Fraction fraction) {
		...
		if ((fraction.numerator) == 0) {
			throw org.apache.commons.math.MathRuntimeException.createArithmeticException(org.apache.commons.math.exception.util.LocalizedFormats.ZERO_FRACTION_TO_DIVIDE_BY, fraction.numerator, fraction.denominator);
		}
	...
	public static org.apache.commons.math.fraction.Fraction getReducedFraction(int numerator, int denominator) {
		if (denominator == 0) {
			throw org.apache.commons.math.MathRuntimeException.createArithmeticException(org.apache.commons.math.exception.util.LocalizedFormats.ZERO_DENOMINATOR_IN_FRACTION, numerator, denominator);
		}
		if (numerator == 0) {
			return org.apache.commons.math.fraction.Fraction.ZERO;
		}
