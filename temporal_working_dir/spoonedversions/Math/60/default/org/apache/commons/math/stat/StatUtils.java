...
public final class StatUtils {
	...
	public static double sumDifference(final double[] sample1, final double[] sample2) throws java.lang.IllegalArgumentException {
		...
		if (n != (sample2.length)) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.util.LocalizedFormats.DIMENSIONS_MISMATCH_SIMPLE, n, sample2.length);
		}
		if (n < 1) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.util.LocalizedFormats.INSUFFICIENT_DIMENSION, sample2.length, 1);
		}
		double result = 0;
		for (int i = 0; i < n; i++) {
	...
	public static double varianceDifference(final double[] sample1, final double[] sample2, double meanDifference) throws java.lang.IllegalArgumentException {
		...
		if (n < 2) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.exception.util.LocalizedFormats.INSUFFICIENT_DIMENSION, n, 2);
		}
		for (int i = 0; i < n; i++) {
