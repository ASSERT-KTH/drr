...
public class NordsieckStepInterpolator extends org.apache.commons.math.ode.sampling.AbstractStepInterpolator {
	...
	public void reinitialize(final double referenceTime, final double scalingH, final double[] scaled, final org.apache.commons.math.linear.Array2DRowRealMatrix nordsieck) {
		org.apache.commons.math.ode.sampling.NordsieckStepInterpolator.this.referenceTime = referenceTime;
	...
	public void rescale(final double scalingH) {
		final double ratio = scalingH / (org.apache.commons.math.ode.sampling.NordsieckStepInterpolator.this.scalingH);
