...
public class DateUtils {
	...
	public static long getFragmentInMilliseconds(java.util.Date date, int fragment) {
		return org.apache.commons.lang.time.DateUtils.getFragment(date, fragment, java.util.Calendar.MILLISECOND);
	}

	public static long getFragmentInSeconds(java.util.Date date, int fragment) {
		return org.apache.commons.lang.time.DateUtils.getFragment(date, fragment, java.util.Calendar.SECOND);
	}

	public static long getFragmentInMinutes(java.util.Date date, int fragment) {
		return org.apache.commons.lang.time.DateUtils.getFragment(date, fragment, java.util.Calendar.MINUTE);
	}

	public static long getFragmentInHours(java.util.Date date, int fragment) {
		return org.apache.commons.lang.time.DateUtils.getFragment(date, fragment, java.util.Calendar.HOUR_OF_DAY);
	}

	public static long getFragmentInDays(java.util.Date date, int fragment) {
		return org.apache.commons.lang.time.DateUtils.getFragment(date, fragment, java.util.Calendar.DAY_OF_YEAR);
	}

	public static long getFragmentInMilliseconds(java.util.Calendar calendar, int fragment) {
		return org.apache.commons.lang.time.DateUtils.getFragment(calendar, fragment, java.util.Calendar.MILLISECOND);
	}

	public static long getFragmentInSeconds(java.util.Calendar calendar, int fragment) {
		return org.apache.commons.lang.time.DateUtils.getFragment(calendar, fragment, java.util.Calendar.SECOND);
	}

	public static long getFragmentInMinutes(java.util.Calendar calendar, int fragment) {
		return org.apache.commons.lang.time.DateUtils.getFragment(calendar, fragment, java.util.Calendar.MINUTE);
	}

	public static long getFragmentInHours(java.util.Calendar calendar, int fragment) {
		return org.apache.commons.lang.time.DateUtils.getFragment(calendar, fragment, java.util.Calendar.HOUR_OF_DAY);
	}

	public static long getFragmentInDays(java.util.Calendar calendar, int fragment) {
		return org.apache.commons.lang.time.DateUtils.getFragment(calendar, fragment, java.util.Calendar.DAY_OF_YEAR);
	}
	...
	private static long getFragment(java.util.Date date, int fragment, int unit) {
		...
		return org.apache.commons.lang.time.DateUtils.getFragment(calendar, fragment, unit);
	}
	...
	private static long getFragment(java.util.Calendar calendar, int fragment, int unit) {
		...
		long millisPerUnit = org.apache.commons.lang.time.DateUtils.getMillisPerUnit(unit);
		long result = 0;
		switch (fragment) {
			case java.util.Calendar.YEAR :
				result += ((calendar.get(java.util.Calendar.DAY_OF_YEAR)) * (org.apache.commons.lang.time.DateUtils.MILLIS_PER_DAY)) / millisPerUnit;
				break;
			case java.util.Calendar.MONTH :
				result += ((calendar.get(java.util.Calendar.DAY_OF_MONTH)) * (org.apache.commons.lang.time.DateUtils.MILLIS_PER_DAY)) / millisPerUnit;
				break;
		}
		switch (fragment) {
			case java.util.Calendar.YEAR :
			...
			case java.util.Calendar.DATE :
				result += ((calendar.get(java.util.Calendar.HOUR_OF_DAY)) * (org.apache.commons.lang.time.DateUtils.MILLIS_PER_HOUR)) / millisPerUnit;
			case java.util.Calendar.HOUR_OF_DAY :
				result += ((calendar.get(java.util.Calendar.MINUTE)) * (org.apache.commons.lang.time.DateUtils.MILLIS_PER_MINUTE)) / millisPerUnit;
			case java.util.Calendar.MINUTE :
				result += ((calendar.get(java.util.Calendar.SECOND)) * (org.apache.commons.lang.time.DateUtils.MILLIS_PER_SECOND)) / millisPerUnit;
	...
	private static long getMillisPerUnit(int unit) {
		...
		switch (unit) {
			case java.util.Calendar.DAY_OF_YEAR :
			case java.util.Calendar.DATE :
				result = org.apache.commons.lang.time.DateUtils.MILLIS_PER_DAY;
				break;
			case java.util.Calendar.HOUR_OF_DAY :
				result = org.apache.commons.lang.time.DateUtils.MILLIS_PER_HOUR;
				break;
			case java.util.Calendar.MINUTE :
				result = org.apache.commons.lang.time.DateUtils.MILLIS_PER_MINUTE;
				break;
			case java.util.Calendar.SECOND :
				result = org.apache.commons.lang.time.DateUtils.MILLIS_PER_SECOND;
				break;
			case java.util.Calendar.MILLISECOND :
				result = 1;
				break;
