...
public class LocaleUtils {
	...
	public static java.util.List<java.util.Locale> availableLocaleList() {
		if ((org.apache.commons.lang3.LocaleUtils.cAvailableLocaleList) == null) {
			org.apache.commons.lang3.LocaleUtils.initAvailableLocaleList();
		}
		return org.apache.commons.lang3.LocaleUtils.cAvailableLocaleList;
	}
	...
	private static synchronized void initAvailableLocaleList() {
		if ((org.apache.commons.lang3.LocaleUtils.cAvailableLocaleList) == null) {
			...
			org.apache.commons.lang3.LocaleUtils.cAvailableLocaleList = java.util.Collections.unmodifiableList(list);
		}
	}

	public static java.util.Set<java.util.Locale> availableLocaleSet() {
		if ((org.apache.commons.lang3.LocaleUtils.cAvailableLocaleSet) == null) {
			org.apache.commons.lang3.LocaleUtils.initAvailableLocaleSet();
		}
		return org.apache.commons.lang3.LocaleUtils.cAvailableLocaleSet;
	}

	private static synchronized void initAvailableLocaleSet() {
		if ((org.apache.commons.lang3.LocaleUtils.cAvailableLocaleSet) == null) {
			org.apache.commons.lang3.LocaleUtils.cAvailableLocaleSet = java.util.Collections.unmodifiableSet(new java.util.HashSet<java.util.Locale>(org.apache.commons.lang3.LocaleUtils.availableLocaleList()));
		}
	}
	...
	public static java.util.List<java.util.Locale> languagesByCountry(java.lang.String countryCode) {
		...
		if (langs == null) {
			if (countryCode != null) {
				...
				java.util.List<java.util.Locale> locales = org.apache.commons.lang3.LocaleUtils.availableLocaleList();
			...
			org.apache.commons.lang3.LocaleUtils.cLanguagesByCountry.put(countryCode, langs);
		}
		return langs;
	}
	...
	public static java.util.List<java.util.Locale> countriesByLanguage(java.lang.String languageCode) {
		...
		if (countries == null) {
			...
			org.apache.commons.lang3.LocaleUtils.cCountriesByLanguage.put(languageCode, countries);
		}
		return countries;
	}
}
