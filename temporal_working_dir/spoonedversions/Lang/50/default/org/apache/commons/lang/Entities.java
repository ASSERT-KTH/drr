...
class Entities {
	...
	public java.lang.String escape(java.lang.String str) {
		java.io.StringWriter stringWriter = createStringWriter(str);
		try {
			org.apache.commons.lang.Entities.this.escape(stringWriter, str);
	...
	public java.lang.String unescape(java.lang.String str) {
		...
		if (firstAmp < 0) {
			...
			java.io.StringWriter stringWriter = createStringWriter(str);
			try {
				org.apache.commons.lang.Entities.this.doUnescape(stringWriter, str, firstAmp);
			} catch (java.io.IOException e) {
				throw new org.apache.commons.lang.UnhandledException(e);
			}
			return stringWriter.toString();
	...
	private java.io.StringWriter createStringWriter(java.lang.String str) {
		return new java.io.StringWriter(((int) ((str.length()) + ((str.length()) * 0.1))));
	}
	...
	private void doUnescape(java.io.Writer writer, java.lang.String str, int firstAmp) throws java.io.IOException {
		...
		for (int i = firstAmp; i < len; i++) {
			...
			if (c == '&') {
				...
				java.lang.String entityContent = str.substring(nextIdx, semiColonIdx);
				int entityValue = -1;
