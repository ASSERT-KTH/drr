...
public class ExceptionUtils {
	...
	public static void addCauseMethodName(java.lang.String methodName) {
		if ((org.apache.commons.lang3.StringUtils.isNotEmpty(methodName)) && (!(org.apache.commons.lang3.exception.ExceptionUtils.isCauseMethodName(methodName)))) {
			java.util.List<java.lang.String> list = org.apache.commons.lang3.exception.ExceptionUtils.getCauseMethodNameList();
			if (list.add(methodName)) {
				synchronized(org.apache.commons.lang3.exception.ExceptionUtils.CAUSE_METHOD_NAMES_LOCK) {
					org.apache.commons.lang3.exception.ExceptionUtils.CAUSE_METHOD_NAMES = org.apache.commons.lang3.exception.ExceptionUtils.toArray(list);
				}
			}
		}
	}
	...
	public static boolean setCause(java.lang.Throwable target, java.lang.Throwable cause) {
		...
		if ((org.apache.commons.lang3.exception.ExceptionUtils.THROWABLE_INITCAUSE_METHOD) != null) {
			try {
				org.apache.commons.lang3.exception.ExceptionUtils.THROWABLE_INITCAUSE_METHOD.invoke(target, causeArgs);
				modifiedTarget = true;
	...
	private static java.util.ArrayList<java.lang.String> getCauseMethodNameList() {
		synchronized(org.apache.commons.lang3.exception.ExceptionUtils.CAUSE_METHOD_NAMES_LOCK) {
			return new java.util.ArrayList<java.lang.String>(java.util.Arrays.asList(org.apache.commons.lang3.exception.ExceptionUtils.CAUSE_METHOD_NAMES));
		}
	}

	public static boolean isCauseMethodName(java.lang.String methodName) {
		synchronized(org.apache.commons.lang3.exception.ExceptionUtils.CAUSE_METHOD_NAMES_LOCK) {
			return (org.apache.commons.lang3.ArrayUtils.indexOf(org.apache.commons.lang3.exception.ExceptionUtils.CAUSE_METHOD_NAMES, methodName)) >= 0;
		}
	}
	...
	public static java.lang.Throwable getCause(java.lang.Throwable throwable, java.lang.String[] methodNames) {
		...
		java.lang.Throwable cause = org.apache.commons.lang3.exception.ExceptionUtils.getCauseUsingWellKnownTypes(throwable);
		if (cause == null) {
			if (methodNames == null) {
				synchronized(org.apache.commons.lang3.exception.ExceptionUtils.CAUSE_METHOD_NAMES_LOCK) {
			...
			for (int i = 0; i < (methodNames.length); i++) {
				...
				if (methodName != null) {
					cause = org.apache.commons.lang3.exception.ExceptionUtils.getCauseUsingMethodName(throwable, methodName);
					if (cause != null) {
						break;
					}
				}
			...
			if (cause == null) {
				cause = org.apache.commons.lang3.exception.ExceptionUtils.getCauseUsingFieldName(throwable, "detail");
			}
		}
		return cause;
	}
	...
	public static boolean isThrowableNested() {
		return (org.apache.commons.lang3.exception.ExceptionUtils.THROWABLE_CAUSE_METHOD) != null;
	}
	...
	public static boolean isNestedThrowable(java.lang.Throwable throwable) {
		...
		if (throwable instanceof java.sql.SQLException) {
			...
			if (throwable instanceof java.lang.reflect.InvocationTargetException) {
				...
				if (org.apache.commons.lang3.exception.ExceptionUtils.isThrowableNested()) {
					return true;
				}
		...
		synchronized(org.apache.commons.lang3.exception.ExceptionUtils.CAUSE_METHOD_NAMES_LOCK) {
			for (int i = 0, isize = org.apache.commons.lang3.exception.ExceptionUtils.CAUSE_METHOD_NAMES.length; i < isize; i++) {
				try {
					java.lang.reflect.Method method = cls.getMethod(org.apache.commons.lang3.exception.ExceptionUtils.CAUSE_METHOD_NAMES[i], ((java.lang.Class[]) (null)));
					if ((method != null) && (java.lang.Throwable.class.isAssignableFrom(method.getReturnType()))) {
						return true;
					}
				} catch (java.lang.NoSuchMethodException ignored) {
	...
	public static java.lang.String getFullStackTrace(java.lang.Throwable throwable) {
		...
		java.lang.Throwable[] ts = org.apache.commons.lang3.exception.ExceptionUtils.getThrowables(throwable);
		for (int i = 0; i < (ts.length); i++) {
			ts[i].printStackTrace(pw);
			if (org.apache.commons.lang3.exception.ExceptionUtils.isNestedThrowable(ts[i])) {
				break;
			}
		}
	...
	static java.lang.String[] getStackFrames(java.lang.String stackTrace) {
		...
		return org.apache.commons.lang3.exception.ExceptionUtils.toArray(list);
	}
