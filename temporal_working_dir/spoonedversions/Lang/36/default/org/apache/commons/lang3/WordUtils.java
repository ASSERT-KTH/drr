...
public class WordUtils {
	...
	public static java.lang.String wrap(java.lang.String str, int wrapLength) {
		return org.apache.commons.lang3.WordUtils.wrap(str, wrapLength, null, false);
	}
	...
	public static java.lang.String wrap(java.lang.String str, int wrapLength, java.lang.String newLineStr, boolean wrapLongWords) {
		...
		int offset = 0;
		java.lang.StringBuilder wrappedLine = new java.lang.StringBuilder((inputLineLength + 32));
	...
	public static java.lang.String capitalize(java.lang.String str) {
		return org.apache.commons.lang3.WordUtils.capitalize(str, null);
	}
	...
	public static java.lang.String capitalize(java.lang.String str, char[] delimiters) {
		...
		for (int i = 0; i < strLen; i++) {
			...
			if (org.apache.commons.lang3.WordUtils.isDelimiter(ch, delimiters)) {
				buffer.append(ch);
				capitalizeNext = true;
			}else
				if (capitalizeNext) {
	...
	public static java.lang.String capitalizeFully(java.lang.String str) {
		return org.apache.commons.lang3.WordUtils.capitalizeFully(str, null);
	}
	...
	public static java.lang.String capitalizeFully(java.lang.String str, char[] delimiters) {
		...
		str = str.toLowerCase();
		return org.apache.commons.lang3.WordUtils.capitalize(str, delimiters);
	}

	public static java.lang.String uncapitalize(java.lang.String str) {
		return org.apache.commons.lang3.WordUtils.uncapitalize(str, null);
	}
	...
	public static java.lang.String initials(java.lang.String str) {
		return org.apache.commons.lang3.WordUtils.initials(str, null);
	}
	...
	public static java.lang.String abbreviate(java.lang.String str, int lower, int upper, java.lang.String appendToEnd) {
		...
		int index = org.apache.commons.lang3.StringUtils.indexOf(str, " ", lower);
		if (index == (-1)) {
			result.append(str.substring(0, upper));
			if (upper != (str.length())) {
				result.append(org.apache.commons.lang3.StringUtils.defaultString(appendToEnd));
			}
		}else
			if (index > upper) {
				result.append(str.substring(0, upper));
