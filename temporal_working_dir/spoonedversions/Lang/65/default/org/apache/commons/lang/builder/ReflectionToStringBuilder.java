...
public class ReflectionToStringBuilder extends org.apache.commons.lang.builder.ToStringBuilder {
	...
	static java.util.Set getRegistry() {
		return ((java.util.Set) (org.apache.commons.lang.builder.ReflectionToStringBuilder.registry.get()));
	}

	static boolean isRegistered(java.lang.Object value) {
		return org.apache.commons.lang.builder.ReflectionToStringBuilder.getRegistry().contains(value);
	}

	static void register(java.lang.Object value) {
		org.apache.commons.lang.builder.ReflectionToStringBuilder.getRegistry().add(value);
	}
	...
	public static java.lang.String toString(java.lang.Object object, org.apache.commons.lang.builder.ToStringStyle style, boolean outputTransients, boolean outputStatics, java.lang.Class reflectUpToClass) {
		return new org.apache.commons.lang.builder.ReflectionToStringBuilder(object, style, null, reflectUpToClass, outputTransients, outputStatics).toString();
	}

	public static java.lang.String toString(java.lang.Object object, org.apache.commons.lang.builder.ToStringStyle style, boolean outputTransients, java.lang.Class reflectUpToClass) {
		return new org.apache.commons.lang.builder.ReflectionToStringBuilder(object, style, null, reflectUpToClass, outputTransients).toString();
	}
	...
	static java.lang.String[] toNoNullStringArray(java.util.Collection collection) {
		if (collection == null) {
	...
	static java.lang.String[] toNoNullStringArray(java.lang.Object[] array) {
		...
		for (int i = 0; i < (array.length); i++) {
			java.lang.Object e = array[i];
			if (e != null) {
				list.add(e.toString());
			}
		}
		return ((java.lang.String[]) (list.toArray(org.apache.commons.lang.ArrayUtils.EMPTY_STRING_ARRAY)));
	}

	public static java.lang.String toStringExclude(java.lang.Object object, java.lang.String[] excludeFieldNames) {
		return new org.apache.commons.lang.builder.ReflectionToStringBuilder(object).setExcludeFieldNames(excludeFieldNames).toString();
	}

	static void unregister(java.lang.Object value) {
		org.apache.commons.lang.builder.ReflectionToStringBuilder.getRegistry().remove(value);
	}
	...
	public ReflectionToStringBuilder(java.lang.Object object, org.apache.commons.lang.builder.ToStringStyle style) {
		super(object, style);
	}

	public ReflectionToStringBuilder(java.lang.Object object, org.apache.commons.lang.builder.ToStringStyle style, java.lang.StringBuffer buffer) {
		super(object, style, buffer);
	}

	public ReflectionToStringBuilder(java.lang.Object object, org.apache.commons.lang.builder.ToStringStyle style, java.lang.StringBuffer buffer, java.lang.Class reflectUpToClass, boolean outputTransients) {
		super(object, style, buffer);
	...
	public ReflectionToStringBuilder(java.lang.Object object, org.apache.commons.lang.builder.ToStringStyle style, java.lang.StringBuffer buffer, java.lang.Class reflectUpToClass, boolean outputTransients, boolean outputStatics) {
		super(object, style, buffer);
		org.apache.commons.lang.builder.ReflectionToStringBuilder.this.setUpToClass(reflectUpToClass);
		org.apache.commons.lang.builder.ReflectionToStringBuilder.this.setAppendTransients(outputTransients);
	...
	protected boolean accept(java.lang.reflect.Field field) {
		...
		if (((org.apache.commons.lang.builder.ReflectionToStringBuilder.this.getExcludeFieldNames()) != null) && ((java.util.Arrays.binarySearch(org.apache.commons.lang.builder.ReflectionToStringBuilder.this.getExcludeFieldNames(), field.getName())) >= 0)) {
			return false;
		}
		return true;
	}
	...
	protected void appendFieldsIn(java.lang.Class clazz) {
		if (org.apache.commons.lang.builder.ReflectionToStringBuilder.isRegistered(org.apache.commons.lang.builder.ReflectionToStringBuilder.this.getObject())) {
			org.apache.commons.lang.builder.ReflectionToStringBuilder.this.appendAsObjectToString(org.apache.commons.lang.builder.ReflectionToStringBuilder.this.getObject());
			return ;
		}
		try {
			org.apache.commons.lang.builder.ReflectionToStringBuilder.this.registerObject();
			if (clazz.isArray()) {
			...
			for (int i = 0; i < (fields.length); i++) {
				...
				if (org.apache.commons.lang.builder.ReflectionToStringBuilder.this.accept(field)) {
					try {
						...
						if ((org.apache.commons.lang.builder.ReflectionToStringBuilder.isRegistered(fieldValue)) && (!(field.getType().isPrimitive()))) {
							org.apache.commons.lang.builder.ReflectionToStringBuilder.this.getStyle().appendFieldStart(org.apache.commons.lang.builder.ReflectionToStringBuilder.this.getStringBuffer(), fieldName);
							org.apache.commons.lang.builder.ReflectionToStringBuilder.this.appendAsObjectToString(fieldValue);
							org.apache.commons.lang.builder.ReflectionToStringBuilder.this.getStyle().appendFieldEnd(org.apache.commons.lang.builder.ReflectionToStringBuilder.this.getStringBuffer(), fieldName);
						}else {
							try {
								org.apache.commons.lang.builder.ReflectionToStringBuilder.this.registerObject();
								org.apache.commons.lang.builder.ReflectionToStringBuilder.this.append(fieldName, fieldValue);
							} finally {
								org.apache.commons.lang.builder.ReflectionToStringBuilder.this.unregisterObject();
							}
						}
	...
	public java.lang.String[] getExcludeFieldNames() {
		return org.apache.commons.lang.builder.ReflectionToStringBuilder.this.excludeFieldNames;
	}
	...
	public org.apache.commons.lang.builder.ToStringBuilder reflectionAppendArray(java.lang.Object array) {
	...
	void registerObject() {
		org.apache.commons.lang.builder.ReflectionToStringBuilder.register(org.apache.commons.lang.builder.ReflectionToStringBuilder.this.getObject());
	}
	...
	public org.apache.commons.lang.builder.ReflectionToStringBuilder setExcludeFieldNames(java.lang.String[] excludeFieldNamesParam) {
		if (excludeFieldNamesParam == null) {
			org.apache.commons.lang.builder.ReflectionToStringBuilder.this.excludeFieldNames = null;
		}else {
			org.apache.commons.lang.builder.ReflectionToStringBuilder.this.excludeFieldNames = ((java.lang.String[]) (org.apache.commons.lang.builder.ReflectionToStringBuilder.toNoNullStringArray(excludeFieldNamesParam)));
	...
	void unregisterObject() {
		org.apache.commons.lang.builder.ReflectionToStringBuilder.unregister(org.apache.commons.lang.builder.ReflectionToStringBuilder.this.getObject());
	}
}
