...
public class DateUtils {
	...
	public static java.util.Date parseDate(java.lang.String str, java.lang.String... parsePatterns) throws java.text.ParseException {
		return org.apache.commons.lang3.time.DateUtils.parseDateWithLeniency(str, parsePatterns, true);
	}
	...
	public static java.util.Date parseDateStrictly(java.lang.String str, java.lang.String... parsePatterns) throws java.text.ParseException {
		return org.apache.commons.lang3.time.DateUtils.parseDateWithLeniency(str, parsePatterns, false);
	}

	private static java.util.Date parseDateWithLeniency(java.lang.String str, java.lang.String[] parsePatterns, boolean lenient) throws java.text.ParseException {
	...
	public static int truncatedCompareTo(java.util.Calendar cal1, java.util.Calendar cal2, int field) {
		java.util.Calendar truncatedCal1 = org.apache.commons.lang3.time.DateUtils.truncate(cal1, field);
		java.util.Calendar truncatedCal2 = org.apache.commons.lang3.time.DateUtils.truncate(cal2, field);
		return truncatedCal1.compareTo(truncatedCal2);
	}

	public static int truncatedCompareTo(java.util.Date date1, java.util.Date date2, int field) {
		java.util.Date truncatedDate1 = org.apache.commons.lang3.time.DateUtils.truncate(date1, field);
		java.util.Date truncatedDate2 = org.apache.commons.lang3.time.DateUtils.truncate(date2, field);
