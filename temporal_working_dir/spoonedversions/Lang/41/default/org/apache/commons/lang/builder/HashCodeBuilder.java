...
public class HashCodeBuilder {
	private static final java.lang.ThreadLocal<java.util.Set<org.apache.commons.lang.builder.IDKey>> registry = new java.lang.ThreadLocal<java.util.Set<org.apache.commons.lang.builder.IDKey>>() {
		@java.lang.Override
		protected java.util.Set<org.apache.commons.lang.builder.IDKey> initialValue() {
			return new java.util.HashSet<org.apache.commons.lang.builder.IDKey>();
		}
	};

	static java.util.Set<org.apache.commons.lang.builder.IDKey> getRegistry() {
		return org.apache.commons.lang.builder.HashCodeBuilder.registry.get();
	}

	static boolean isRegistered(java.lang.Object value) {
		return org.apache.commons.lang.builder.HashCodeBuilder.getRegistry().contains(new org.apache.commons.lang.builder.IDKey(value));
	}
	...
	private static void reflectionAppend(java.lang.Object object, java.lang.Class<?> clazz, org.apache.commons.lang.builder.HashCodeBuilder builder, boolean useTransients, java.lang.String[] excludeFields) {
		...
		try {
			...
			java.util.List<java.lang.String> excludedFieldList = excludeFields != null ? java.util.Arrays.asList(excludeFields) : java.util.Collections.EMPTY_LIST;
	...
	static void register(java.lang.Object value) {
		org.apache.commons.lang.builder.HashCodeBuilder.getRegistry().add(new org.apache.commons.lang.builder.IDKey(value));
	}

	static void unregister(java.lang.Object value) {
		org.apache.commons.lang.builder.HashCodeBuilder.getRegistry().remove(new org.apache.commons.lang.builder.IDKey(value));
	}
