...
public class DurationFormatUtils {
			...
			if (!(org.apache.commons.lang.time.DurationFormatUtils.Token.containsTokenWithValue(tokens, org.apache.commons.lang.time.DurationFormatUtils.y))) {
				...
				while ((start.get(java.util.Calendar.YEAR)) != target) {
					...
					if (start instanceof java.util.GregorianCalendar) {
						if (((start.get(java.util.Calendar.MONTH)) == (java.util.Calendar.FEBRUARY)) && ((start.get(java.util.Calendar.DAY_OF_MONTH)) == 29)) {
							days += 1;
						}
					}
	...
	static org.apache.commons.lang.time.DurationFormatUtils.Token[] lexx(java.lang.String format) {
		...
		java.util.ArrayList<org.apache.commons.lang.time.DurationFormatUtils.Token> list = new java.util.ArrayList<org.apache.commons.lang.time.DurationFormatUtils.Token>(array.length);
		...
		return list.toArray(new org.apache.commons.lang.time.DurationFormatUtils.Token[list.size()]);
	}
