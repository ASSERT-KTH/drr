...
public abstract class ToStringStyle implements java.io.Serializable {
	...
	private static final java.lang.ThreadLocal<java.util.Set<java.lang.Object>> registry = new java.lang.ThreadLocal<java.util.Set<java.lang.Object>>() {
		@java.lang.Override
		protected java.util.Set<java.lang.Object> initialValue() {
			return new java.util.HashSet<java.lang.Object>();
		}
	};

	static java.util.Set<java.lang.Object> getRegistry() {
		return org.apache.commons.lang.builder.ToStringStyle.registry.get();
	}
	...
	protected void appendCyclicObject(java.lang.StringBuffer buffer, java.lang.String fieldName, java.lang.Object value) {
		org.apache.commons.lang.ObjectUtils.identityToString(buffer, value);
	}
