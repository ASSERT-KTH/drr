...
public final class Fraction extends java.lang.Number implements java.lang.Comparable<org.apache.commons.lang.math.Fraction> {
	...
	public org.apache.commons.lang.math.Fraction reduce() {
		if ((numerator) == 0) {
			return equals(org.apache.commons.lang.math.Fraction.ZERO) ? org.apache.commons.lang.math.Fraction.this : org.apache.commons.lang.math.Fraction.ZERO;
		}
	...
	public int compareTo(org.apache.commons.lang.math.Fraction other) {
	...
	public java.lang.String toString() {
		if ((toString) == null) {
			toString = new java.lang.StringBuilder(32).append(getNumerator()).append('/').append(getDenominator()).toString();
		}
		return toString;
	}
					...
					if ((numerator) == ((-1) * (denominator))) {
						...
						if (((numerator) > 0 ? -(numerator) : numerator) < (-(denominator))) {
							...
							if (properNumerator == 0) {
								...
								toProperString = new java.lang.StringBuilder(32).append(getProperWhole()).append(' ').append(properNumerator).append('/').append(getDenominator()).toString();
							}
						}else {
							toProperString = new java.lang.StringBuilder(32).append(getNumerator()).append('/').append(getDenominator()).toString();
						}
