...
public class StrTokenizer implements java.lang.Cloneable , java.util.ListIterator<java.lang.String> {
	...
	public StrTokenizer(char[] input) {
		super();
		org.apache.commons.lang.text.StrTokenizer.this.chars = org.apache.commons.lang.ArrayUtils.clone(input);
	}
	...
	public java.util.List<java.lang.String> getTokenList() {
		checkTokenized();
		java.util.List<java.lang.String> list = new java.util.ArrayList<java.lang.String>(tokens.length);
		for (java.lang.String element : tokens) {
			list.add(element);
		}
		return list;
	}
	...
	private void checkTokenized() {
		if ((tokens) == null) {
			if ((chars) == null) {
				java.util.List<java.lang.String> split = tokenize(null, 0, 0);
				tokens = split.toArray(new java.lang.String[split.size()]);
			}else {
				java.util.List<java.lang.String> split = tokenize(chars, 0, chars.length);
				tokens = split.toArray(new java.lang.String[split.size()]);
			}
		}
	}
	...
	private void addToken(java.util.List<java.lang.String> list, java.lang.String tok) {
	...
	private int readNextToken(char[] chars, int start, int len, org.apache.commons.lang.text.StrBuilder workArea, java.util.List<java.lang.String> tokens) {
		while (start < len) {
	...
	private int readWithQuotes(char[] chars, int start, int len, org.apache.commons.lang.text.StrBuilder workArea, java.util.List<java.lang.String> tokens, int quoteStart, int quoteLen) {
		workArea.clear();
		int pos = start;
