...
public class ClassUtils {
	...
	public static java.lang.String getShortClassName(java.lang.String className) {
		...
		java.lang.StringBuilder arrayPrefix = new java.lang.StringBuilder();
		...
		if (org.apache.commons.lang.ClassUtils.reverseAbbreviationMap.containsKey(className)) {
			className = org.apache.commons.lang.ClassUtils.reverseAbbreviationMap.get(className);
		}
	...
	private static java.lang.String toCanonicalName(java.lang.String className) {
		...
		if (className == null) {
			...
			if (className.endsWith("[]")) {
				java.lang.StringBuilder classNameBuffer = new java.lang.StringBuilder();
	...
	private static java.lang.String getCanonicalName(java.lang.String className) {
		...
		if (className == null) {
			...
			if (dim < 1) {
				...
				java.lang.StringBuilder canonicalClassNameBuffer = new java.lang.StringBuilder(className);
				for (int i = 0; i < dim; i++) {
