...
public class DateUtils {
	...
	public static java.util.Date round(java.util.Date date, int field) {
		...
		gval.setTime(date);
		org.apache.commons.lang.time.DateUtils.modify(gval, field, org.apache.commons.lang.time.DateUtils.MODIFY_ROUND);
		return gval.getTime();
	}
	...
	public static java.util.Calendar round(java.util.Calendar date, int field) {
		...
		org.apache.commons.lang.time.DateUtils.modify(rounded, field, org.apache.commons.lang.time.DateUtils.MODIFY_ROUND);
		return rounded;
	}
	...
	public static java.util.Date truncate(java.util.Date date, int field) {
		...
		java.util.Calendar gval = java.util.Calendar.getInstance();
		gval.setTime(date);
		org.apache.commons.lang.time.DateUtils.modify(gval, field, org.apache.commons.lang.time.DateUtils.MODIFY_TRUNCATE);
		return gval.getTime();
	}
	...
	public static java.util.Calendar truncate(java.util.Calendar date, int field) {
		...
		org.apache.commons.lang.time.DateUtils.modify(truncated, field, org.apache.commons.lang.time.DateUtils.MODIFY_TRUNCATE);
		return truncated;
	}
	...
	public static java.util.Date ceiling(java.util.Date date, int field) {
		...
		java.util.Calendar gval = java.util.Calendar.getInstance();
		gval.setTime(date);
		org.apache.commons.lang.time.DateUtils.modify(gval, field, org.apache.commons.lang.time.DateUtils.MODIFY_CEILING);
		return gval.getTime();
	}
	...
	public static java.util.Calendar ceiling(java.util.Calendar date, int field) {
		...
		org.apache.commons.lang.time.DateUtils.modify(ceiled, field, org.apache.commons.lang.time.DateUtils.MODIFY_CEILING);
		return ceiled;
	}
	...
	public static java.util.Date ceiling(java.lang.Object date, int field) {
		...
		if (date instanceof java.util.Date) {
			return org.apache.commons.lang.time.DateUtils.ceiling(((java.util.Date) (date)), field);
		}else
			if (date instanceof java.util.Calendar) {
				return org.apache.commons.lang.time.DateUtils.ceiling(((java.util.Calendar) (date)), field).getTime();
			}else {
	...
	private static void modify(java.util.Calendar val, int field, int modType) {
		...
		if (((org.apache.commons.lang.time.DateUtils.MODIFY_TRUNCATE) == modType) || (millisecs < 500)) {
			time = time - millisecs;
		}
		...
		if ((!done) && (((org.apache.commons.lang.time.DateUtils.MODIFY_TRUNCATE) == modType) || (seconds < 30))) {
		...
		if ((!done) && (((org.apache.commons.lang.time.DateUtils.MODIFY_TRUNCATE) == modType) || (minutes < 30))) {
		...
		for (int i = 0; i < (org.apache.commons.lang.time.DateUtils.fields.length); i++) {
			for (int j = 0; j < (org.apache.commons.lang.time.DateUtils.fields[i].length); j++) {
				if ((org.apache.commons.lang.time.DateUtils.fields[i][j]) == field) {
					if ((modType == (org.apache.commons.lang.time.DateUtils.MODIFY_CEILING)) || ((modType == (org.apache.commons.lang.time.DateUtils.MODIFY_ROUND)) && roundUp)) {
