	...
	public static java.lang.String formatPeriod(long startMillis, long endMillis, java.lang.String format, boolean padWithZeros, java.util.TimeZone timezone) {
		...
		while (months < 0) {
			...
			if (start instanceof java.util.GregorianCalendar) {
				if ((((java.util.GregorianCalendar) (start)).isLeapYear(((start.get(java.util.Calendar.YEAR)) + 1))) && ((end.get(java.util.Calendar.MONTH)) > 1)) {
					leapDays += 1;
				}
			}
			if (end instanceof java.util.GregorianCalendar) {
				if ((((java.util.GregorianCalendar) (end)).isLeapYear(end.get(java.util.Calendar.YEAR))) && ((end.get(java.util.Calendar.MONTH)) < 1)) {
					leapDays -= 1;
				}
			}
			start.add(java.util.Calendar.YEAR, 1);
		} 
		if ((!(org.apache.commons.lang.time.DurationFormatUtils.Token.containsTokenWithValue(tokens, org.apache.commons.lang.time.DurationFormatUtils.y))) && (years != 0)) {
			if (org.apache.commons.lang.time.DurationFormatUtils.Token.containsTokenWithValue(tokens, org.apache.commons.lang.time.DurationFormatUtils.M)) {
				months += 12 * years;
				years = 0;
			}else {
		...
		start.set(java.util.Calendar.YEAR, end.get(java.util.Calendar.YEAR));
		if ((!(org.apache.commons.lang.time.DurationFormatUtils.Token.containsTokenWithValue(tokens, org.apache.commons.lang.time.DurationFormatUtils.M))) && (months != 0)) {
			while ((start.get(java.util.Calendar.MONTH)) != (end.get(java.util.Calendar.MONTH))) {
				java.lang.String date = start.getTime().toString();
				days += start.getActualMaximum(java.util.Calendar.DAY_OF_MONTH);
				start.add(java.util.Calendar.MONTH, 1);
			} 
			days += leapDays;
		...
		start.set(java.util.Calendar.MONTH, end.get(java.util.Calendar.MONTH));
		if (!(org.apache.commons.lang.time.DurationFormatUtils.Token.containsTokenWithValue(tokens, org.apache.commons.lang.time.DurationFormatUtils.d))) {
			hours += 24 * days;
			days = 0;
		}
