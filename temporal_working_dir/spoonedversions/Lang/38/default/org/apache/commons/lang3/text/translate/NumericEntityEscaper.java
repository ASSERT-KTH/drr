...
public class NumericEntityEscaper extends org.apache.commons.lang3.text.translate.CodePointTranslator {
	...
	public static org.apache.commons.lang3.text.translate.NumericEntityEscaper below(int codepoint) {
		return org.apache.commons.lang3.text.translate.NumericEntityEscaper.outsideOf(codepoint, java.lang.Integer.MAX_VALUE);
	}

	public static org.apache.commons.lang3.text.translate.NumericEntityEscaper above(int codepoint) {
		return org.apache.commons.lang3.text.translate.NumericEntityEscaper.outsideOf(0, codepoint);
	}

	public static org.apache.commons.lang3.text.translate.NumericEntityEscaper between(int codepointLow, int codepointHigh) {
		return new org.apache.commons.lang3.text.translate.NumericEntityEscaper(codepointLow, codepointHigh, true);
	}

	public static org.apache.commons.lang3.text.translate.NumericEntityEscaper outsideOf(int codepointLow, int codepointHigh) {
