...
abstract class MemberUtils {
	...
	static {
		...
		if (org.apache.commons.lang3.SystemUtils.isJavaVersionAtLeast(1.5F)) {
			try {
				isSynthetic = java.lang.reflect.Member.class.getMethod("isSynthetic", org.apache.commons.lang3.ArrayUtils.EMPTY_CLASS_ARRAY);
	...
	static boolean isAccessible(java.lang.reflect.Member m) {
		return ((m != null) && (java.lang.reflect.Modifier.isPublic(m.getModifiers()))) && (!(org.apache.commons.lang3.reflect.MemberUtils.isSynthetic(m)));
	}

	static boolean isSynthetic(java.lang.reflect.Member m) {
		if ((org.apache.commons.lang3.reflect.MemberUtils.IS_SYNTHETIC) != null) {
			try {
				return ((java.lang.Boolean) (org.apache.commons.lang3.reflect.MemberUtils.IS_SYNTHETIC.invoke(m, ((java.lang.Object[]) (null))))).booleanValue();
			} catch (java.lang.Exception e) {
			}
		}
		return false;
