...
public class SystemUtils {
	...
	public static final boolean IS_OS_AIX = org.apache.commons.lang3.SystemUtils.getOSMatches("AIX");

	public static final boolean IS_OS_HP_UX = org.apache.commons.lang3.SystemUtils.getOSMatches("HP-UX");

	public static final boolean IS_OS_IRIX = org.apache.commons.lang3.SystemUtils.getOSMatches("Irix");

	public static final boolean IS_OS_LINUX = (org.apache.commons.lang3.SystemUtils.getOSMatches("Linux")) || (org.apache.commons.lang3.SystemUtils.getOSMatches("LINUX"));

	public static final boolean IS_OS_MAC = org.apache.commons.lang3.SystemUtils.getOSMatches("Mac");

	public static final boolean IS_OS_MAC_OSX = org.apache.commons.lang3.SystemUtils.getOSMatches("Mac OS X");

	public static final boolean IS_OS_OS2 = org.apache.commons.lang3.SystemUtils.getOSMatches("OS/2");

	public static final boolean IS_OS_SOLARIS = org.apache.commons.lang3.SystemUtils.getOSMatches("Solaris");

	public static final boolean IS_OS_SUN_OS = org.apache.commons.lang3.SystemUtils.getOSMatches("SunOS");
	...
	public static final boolean IS_OS_WINDOWS = org.apache.commons.lang3.SystemUtils.getOSMatches(org.apache.commons.lang3.SystemUtils.OS_NAME_WINDOWS_PREFIX);
	...
	public static final boolean IS_OS_WINDOWS_NT = org.apache.commons.lang3.SystemUtils.getOSMatches(((org.apache.commons.lang3.SystemUtils.OS_NAME_WINDOWS_PREFIX) + " NT"));
	...
	private static float getJavaVersionAsFloat() {
		if ((org.apache.commons.lang3.SystemUtils.JAVA_VERSION_TRIMMED) == null) {
			return 0.0F;
		}
		java.lang.String str = org.apache.commons.lang3.SystemUtils.JAVA_VERSION_TRIMMED.substring(0, 3);
		if ((org.apache.commons.lang3.SystemUtils.JAVA_VERSION_TRIMMED.length()) >= 5) {
			str = str + (org.apache.commons.lang3.SystemUtils.JAVA_VERSION_TRIMMED.substring(4, 5));
		}
		try {
	...
	private static int getJavaVersionAsInt() {
		...
		java.lang.String str = org.apache.commons.lang3.SystemUtils.JAVA_VERSION_TRIMMED.substring(0, 1);
		str = str + (org.apache.commons.lang3.SystemUtils.JAVA_VERSION_TRIMMED.substring(2, 3));
		if ((org.apache.commons.lang3.SystemUtils.JAVA_VERSION_TRIMMED.length()) >= 5) {
			str = str + (org.apache.commons.lang3.SystemUtils.JAVA_VERSION_TRIMMED.substring(4, 5));
		}else {
			str = str + "0";
	...
	private static boolean getJavaVersionMatches(java.lang.String versionPrefix) {
		...
		return org.apache.commons.lang3.SystemUtils.JAVA_VERSION_TRIMMED.startsWith(versionPrefix);
	}

	private static boolean getOSMatches(java.lang.String osNamePrefix) {
		if ((org.apache.commons.lang3.SystemUtils.OS_NAME) == null) {
			return false;
		}
		return org.apache.commons.lang3.SystemUtils.OS_NAME.startsWith(osNamePrefix);
	}

	private static boolean getOSMatches(java.lang.String osNamePrefix, java.lang.String osVersionPrefix) {
		if (((org.apache.commons.lang3.SystemUtils.OS_NAME) == null) || ((org.apache.commons.lang3.SystemUtils.OS_VERSION) == null)) {
			return false;
		}
		return (org.apache.commons.lang3.SystemUtils.OS_NAME.startsWith(osNamePrefix)) && (org.apache.commons.lang3.SystemUtils.OS_VERSION.startsWith(osVersionPrefix));
	}
