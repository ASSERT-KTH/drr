...
public class FastDateFormat extends java.text.Format {
	...
	private static final java.util.Map<org.apache.commons.lang3.time.FastDateFormat, org.apache.commons.lang3.time.FastDateFormat> cInstanceCache = new java.util.HashMap<org.apache.commons.lang3.time.FastDateFormat, org.apache.commons.lang3.time.FastDateFormat>(7);

	private static final java.util.Map<java.lang.Object, org.apache.commons.lang3.time.FastDateFormat> cDateInstanceCache = new java.util.HashMap<java.lang.Object, org.apache.commons.lang3.time.FastDateFormat>(7);

	private static final java.util.Map<java.lang.Object, org.apache.commons.lang3.time.FastDateFormat> cTimeInstanceCache = new java.util.HashMap<java.lang.Object, org.apache.commons.lang3.time.FastDateFormat>(7);

	private static final java.util.Map<java.lang.Object, org.apache.commons.lang3.time.FastDateFormat> cDateTimeInstanceCache = new java.util.HashMap<java.lang.Object, org.apache.commons.lang3.time.FastDateFormat>(7);
	...
	public static org.apache.commons.lang3.time.FastDateFormat getInstance() {
		return org.apache.commons.lang3.time.FastDateFormat.getInstance(org.apache.commons.lang3.time.FastDateFormat.getDefaultPattern(), null, null);
	}

	public static org.apache.commons.lang3.time.FastDateFormat getInstance(java.lang.String pattern) {
		return org.apache.commons.lang3.time.FastDateFormat.getInstance(pattern, null, null);
	}
	...
	public static org.apache.commons.lang3.time.FastDateFormat getInstance(java.lang.String pattern, java.util.TimeZone timeZone) {
		return org.apache.commons.lang3.time.FastDateFormat.getInstance(pattern, timeZone, null);
	}

	public static org.apache.commons.lang3.time.FastDateFormat getInstance(java.lang.String pattern, java.util.Locale locale) {
		return org.apache.commons.lang3.time.FastDateFormat.getInstance(pattern, null, locale);
	}

	public static synchronized org.apache.commons.lang3.time.FastDateFormat getInstance(java.lang.String pattern, java.util.TimeZone timeZone, java.util.Locale locale) {
		org.apache.commons.lang3.time.FastDateFormat emptyFormat = new org.apache.commons.lang3.time.FastDateFormat(pattern, timeZone, locale);
		org.apache.commons.lang3.time.FastDateFormat format = org.apache.commons.lang3.time.FastDateFormat.cInstanceCache.get(emptyFormat);
		if (format == null) {
			format = emptyFormat;
			format.init();
			org.apache.commons.lang3.time.FastDateFormat.cInstanceCache.put(format, format);
		}
		return format;
	}

	public static org.apache.commons.lang3.time.FastDateFormat getDateInstance(int style) {
		return org.apache.commons.lang3.time.FastDateFormat.getDateInstance(style, null, null);
	}

	public static org.apache.commons.lang3.time.FastDateFormat getDateInstance(int style, java.util.Locale locale) {
		return org.apache.commons.lang3.time.FastDateFormat.getDateInstance(style, null, locale);
	}

	public static org.apache.commons.lang3.time.FastDateFormat getDateInstance(int style, java.util.TimeZone timeZone) {
		return org.apache.commons.lang3.time.FastDateFormat.getDateInstance(style, timeZone, null);
	}

	public static synchronized org.apache.commons.lang3.time.FastDateFormat getDateInstance(int style, java.util.TimeZone timeZone, java.util.Locale locale) {
		java.lang.Object key = java.lang.Integer.valueOf(style);
		if (timeZone != null) {
			key = new org.apache.commons.lang3.time.FastDateFormat.Pair(key, timeZone);
		}
		if (locale == null) {
			locale = java.util.Locale.getDefault();
		}
		key = new org.apache.commons.lang3.time.FastDateFormat.Pair(key, locale);
		org.apache.commons.lang3.time.FastDateFormat format = org.apache.commons.lang3.time.FastDateFormat.cDateInstanceCache.get(key);
		if (format == null) {
			try {
				...
				format = org.apache.commons.lang3.time.FastDateFormat.getInstance(pattern, timeZone, locale);
				org.apache.commons.lang3.time.FastDateFormat.cDateInstanceCache.put(key, format);
	...
	public static org.apache.commons.lang3.time.FastDateFormat getTimeInstance(int style) {
		return org.apache.commons.lang3.time.FastDateFormat.getTimeInstance(style, null, null);
	}

	public static org.apache.commons.lang3.time.FastDateFormat getTimeInstance(int style, java.util.Locale locale) {
		return org.apache.commons.lang3.time.FastDateFormat.getTimeInstance(style, null, locale);
	}

	public static org.apache.commons.lang3.time.FastDateFormat getTimeInstance(int style, java.util.TimeZone timeZone) {
		return org.apache.commons.lang3.time.FastDateFormat.getTimeInstance(style, timeZone, null);
	}

	public static synchronized org.apache.commons.lang3.time.FastDateFormat getTimeInstance(int style, java.util.TimeZone timeZone, java.util.Locale locale) {
		java.lang.Object key = java.lang.Integer.valueOf(style);
		if (timeZone != null) {
			key = new org.apache.commons.lang3.time.FastDateFormat.Pair(key, timeZone);
		}
		...
		org.apache.commons.lang3.time.FastDateFormat format = org.apache.commons.lang3.time.FastDateFormat.cTimeInstanceCache.get(key);
		if (format == null) {
			if (locale == null) {
				locale = java.util.Locale.getDefault();
			}
			try {
				...
				java.lang.String pattern = formatter.toPattern();
				format = org.apache.commons.lang3.time.FastDateFormat.getInstance(pattern, timeZone, locale);
				org.apache.commons.lang3.time.FastDateFormat.cTimeInstanceCache.put(key, format);
			} catch (java.lang.ClassCastException ex) {
				throw new java.lang.IllegalArgumentException(("No date pattern for locale: " + locale));
			}
		}
	...
	public static org.apache.commons.lang3.time.FastDateFormat getDateTimeInstance(int dateStyle, int timeStyle) {
		return org.apache.commons.lang3.time.FastDateFormat.getDateTimeInstance(dateStyle, timeStyle, null, null);
	}
	...
	public static org.apache.commons.lang3.time.FastDateFormat getDateTimeInstance(int dateStyle, int timeStyle, java.util.Locale locale) {
		return org.apache.commons.lang3.time.FastDateFormat.getDateTimeInstance(dateStyle, timeStyle, null, locale);
	}
	...
	public static synchronized org.apache.commons.lang3.time.FastDateFormat getDateTimeInstance(int dateStyle, int timeStyle, java.util.TimeZone timeZone, java.util.Locale locale) {
		java.lang.Object key = new org.apache.commons.lang3.time.FastDateFormat.Pair(java.lang.Integer.valueOf(dateStyle), java.lang.Integer.valueOf(timeStyle));
		if (timeZone != null) {
			key = new org.apache.commons.lang3.time.FastDateFormat.Pair(key, timeZone);
		}
		if (locale == null) {
		...
		key = new org.apache.commons.lang3.time.FastDateFormat.Pair(key, locale);
		org.apache.commons.lang3.time.FastDateFormat format = org.apache.commons.lang3.time.FastDateFormat.cDateTimeInstanceCache.get(key);
		if (format == null) {
			try {
				...
				java.lang.String pattern = formatter.toPattern();
				format = org.apache.commons.lang3.time.FastDateFormat.getInstance(pattern, timeZone, locale);
				org.apache.commons.lang3.time.FastDateFormat.cDateTimeInstanceCache.put(key, format);
			} catch (java.lang.ClassCastException ex) {
	...
	static synchronized java.lang.String getTimeZoneDisplay(java.util.TimeZone tz, boolean daylight, int style, java.util.Locale locale) {
		java.lang.Object key = new org.apache.commons.lang3.time.FastDateFormat.TimeZoneDisplayKey(tz, daylight, style, locale);
		java.lang.String value = org.apache.commons.lang3.time.FastDateFormat.cTimeZoneDisplayCache.get(key);
		if (value == null) {
			value = tz.getDisplayName(daylight, style, locale);
			org.apache.commons.lang3.time.FastDateFormat.cTimeZoneDisplayCache.put(key, value);
		}
		return value;
	}

	private static synchronized java.lang.String getDefaultPattern() {
		if ((org.apache.commons.lang3.time.FastDateFormat.cDefaultPattern) == null) {
			org.apache.commons.lang3.time.FastDateFormat.cDefaultPattern = new java.text.SimpleDateFormat().toPattern();
		}
		return org.apache.commons.lang3.time.FastDateFormat.cDefaultPattern;
	}
	...
	protected java.util.List<org.apache.commons.lang3.time.FastDateFormat.Rule> parsePattern() {
		...
		for (int i = 0; i < length; i++) {
			...
			switch (c) {
				...
				case 'z' :
					if (tokenLen >= 4) {
						rule = new org.apache.commons.lang3.time.FastDateFormat.TimeZoneNameRule(mTimeZone, mTimeZoneForced, mLocale, java.util.TimeZone.LONG);
					}else {
						rule = new org.apache.commons.lang3.time.FastDateFormat.TimeZoneNameRule(mTimeZone, mTimeZoneForced, mLocale, java.util.TimeZone.SHORT);
					}
					break;
				case 'Z' :
					if (tokenLen == 1) {
	...
	protected java.lang.StringBuffer applyRules(java.util.Calendar calendar, java.lang.StringBuffer buf) {
		org.apache.commons.lang3.time.FastDateFormat.Rule[] rules = mRules;
		...
		public void appendTo(java.lang.StringBuffer buffer, java.util.Calendar calendar) {
			if (mTimeZoneForced) {
				...
				if ((timeZone.useDaylightTime()) && ((calendar.get(java.util.Calendar.DST_OFFSET)) != 0)) {
					buffer.append(org.apache.commons.lang3.time.FastDateFormat.getTimeZoneDisplay(timeZone, true, mStyle, mLocale));
				}else {
					buffer.append(org.apache.commons.lang3.time.FastDateFormat.getTimeZoneDisplay(timeZone, false, mStyle, mLocale));
				}
			}
		}
	}
	...
	private static class TimeZoneDisplayKey {
		...
		@java.lang.Override
		public boolean equals(java.lang.Object obj) {
			if ((org.apache.commons.lang3.time.FastDateFormat.TimeZoneDisplayKey.this) == obj) {
				return true;
			}
	...
	private static class Pair {
		...
		@java.lang.Override
		public boolean equals(java.lang.Object obj) {
			if ((org.apache.commons.lang3.time.FastDateFormat.Pair.this) == obj) {
				return true;
			}
			if (!(obj instanceof org.apache.commons.lang3.time.FastDateFormat.Pair)) {
				return false;
			}
			org.apache.commons.lang3.time.FastDateFormat.Pair key = ((org.apache.commons.lang3.time.FastDateFormat.Pair) (obj));
