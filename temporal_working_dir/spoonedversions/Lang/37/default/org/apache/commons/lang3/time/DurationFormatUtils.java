...
public class DurationFormatUtils {
	...
	public static java.lang.String formatDuration(long durationMillis, java.lang.String format, boolean padWithZeros) {
		org.apache.commons.lang3.time.DurationFormatUtils.Token[] tokens = org.apache.commons.lang3.time.DurationFormatUtils.lexx(format);
		int days = 0;
		int hours = 0;
		int minutes = 0;
		int seconds = 0;
	...
	static java.lang.String format(org.apache.commons.lang3.time.DurationFormatUtils.Token[] tokens, int years, int months, int days, int hours, int minutes, int seconds, int milliseconds, boolean padWithZeros) {
		java.lang.StringBuffer buffer = new java.lang.StringBuffer();
		boolean lastOutputSeconds = false;
		int sz = tokens.length;
		for (int i = 0; i < sz; i++) {
			org.apache.commons.lang3.time.DurationFormatUtils.Token token = tokens[i];
			...
			if (value instanceof java.lang.StringBuffer) {
				...
				if (value == (org.apache.commons.lang3.time.DurationFormatUtils.y)) {
					...
					if (value == (org.apache.commons.lang3.time.DurationFormatUtils.M)) {
						...
						if (value == (org.apache.commons.lang3.time.DurationFormatUtils.d)) {
							...
							if (value == (org.apache.commons.lang3.time.DurationFormatUtils.H)) {
								...
								if (value == (org.apache.commons.lang3.time.DurationFormatUtils.m)) {
									...
									if (value == (org.apache.commons.lang3.time.DurationFormatUtils.s)) {
										...
										if (value == (org.apache.commons.lang3.time.DurationFormatUtils.S)) {
											if (lastOutputSeconds) {
												milliseconds += 1000;
												java.lang.String str = padWithZeros ? org.apache.commons.lang3.StringUtils.leftPad(java.lang.Integer.toString(milliseconds), count, '0') : java.lang.Integer.toString(milliseconds);
	...
	static org.apache.commons.lang3.time.DurationFormatUtils.Token[] lexx(java.lang.String format) {
		char[] array = format.toCharArray();
		java.util.ArrayList<org.apache.commons.lang3.time.DurationFormatUtils.Token> list = new java.util.ArrayList<org.apache.commons.lang3.time.DurationFormatUtils.Token>(array.length);
		...
		for (int i = 0; i < sz; i++) {
			...
			if (value != null) {
				if ((previous != null) && ((previous.getValue()) == value)) {
					...
					org.apache.commons.lang3.time.DurationFormatUtils.Token token = new org.apache.commons.lang3.time.DurationFormatUtils.Token(value);
					list.add(token);
					previous = token;
				}
				buffer = null;
	...
	static class Token {
		static boolean containsTokenWithValue(org.apache.commons.lang3.time.DurationFormatUtils.Token[] tokens, java.lang.Object value) {
			int sz = tokens.length;
			for (int i = 0; i < sz; i++) {
		...
		Token(java.lang.Object value) {
			org.apache.commons.lang3.time.DurationFormatUtils.Token.this.value = value;
		...
		public boolean equals(java.lang.Object obj2) {
			if (obj2 instanceof org.apache.commons.lang3.time.DurationFormatUtils.Token) {
				org.apache.commons.lang3.time.DurationFormatUtils.Token tok2 = ((org.apache.commons.lang3.time.DurationFormatUtils.Token) (obj2));
				...
				if ((org.apache.commons.lang3.time.DurationFormatUtils.Token.this.value) instanceof java.lang.StringBuffer) {
