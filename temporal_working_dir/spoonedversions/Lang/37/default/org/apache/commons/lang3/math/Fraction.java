...
public final class Fraction extends java.lang.Number implements java.lang.Comparable<org.apache.commons.lang3.math.Fraction> {
	...
	public static org.apache.commons.lang3.math.Fraction getFraction(int whole, int numerator, int denominator) {
		if (denominator == 0) {
			throw new java.lang.ArithmeticException("The denominator must not be zero");
		}
		if (denominator < 0) {
	...
	public static org.apache.commons.lang3.math.Fraction getReducedFraction(int numerator, int denominator) {
		...
		int gcd = org.apache.commons.lang3.math.Fraction.greatestCommonDivisor(numerator, denominator);
		numerator /= gcd;
		denominator /= gcd;
		return new org.apache.commons.lang3.math.Fraction(numerator, denominator);
	}
	...
	public org.apache.commons.lang3.math.Fraction reduce() {
		...
		int gcd = org.apache.commons.lang3.math.Fraction.greatestCommonDivisor(java.lang.Math.abs(numerator), denominator);
		if (gcd == 1) {
	...
	public org.apache.commons.lang3.math.Fraction pow(int power) {
		if (power == 1) {
			return org.apache.commons.lang3.math.Fraction.this;
		}else
			if (power == 0) {
				...
				if (power < 0) {
					...
					org.apache.commons.lang3.math.Fraction f = org.apache.commons.lang3.math.Fraction.this.multiplyBy(org.apache.commons.lang3.math.Fraction.this);
					if ((power % 2) == 0) {
	...
	public org.apache.commons.lang3.math.Fraction add(org.apache.commons.lang3.math.Fraction fraction) {
		return addSub(fraction, true);
	}

	public org.apache.commons.lang3.math.Fraction subtract(org.apache.commons.lang3.math.Fraction fraction) {
		return addSub(fraction, false);
	}

	private org.apache.commons.lang3.math.Fraction addSub(org.apache.commons.lang3.math.Fraction fraction, boolean isAdd) {
		if (fraction == null) {
		...
		int d1 = org.apache.commons.lang3.math.Fraction.greatestCommonDivisor(denominator, fraction.denominator);
		if (d1 == 1) {
			int uvp = org.apache.commons.lang3.math.Fraction.mulAndCheck(numerator, fraction.denominator);
			int upv = org.apache.commons.lang3.math.Fraction.mulAndCheck(fraction.numerator, denominator);
		...
		int d2 = tmodd1 == 0 ? d1 : org.apache.commons.lang3.math.Fraction.greatestCommonDivisor(tmodd1, d1);
	...
	public org.apache.commons.lang3.math.Fraction multiplyBy(org.apache.commons.lang3.math.Fraction fraction) {
		if (fraction == null) {
			throw new java.lang.IllegalArgumentException("The fraction must not be null");
		}
		...
		int d1 = org.apache.commons.lang3.math.Fraction.greatestCommonDivisor(numerator, fraction.denominator);
		int d2 = org.apache.commons.lang3.math.Fraction.greatestCommonDivisor(fraction.numerator, denominator);
	...
	public org.apache.commons.lang3.math.Fraction divideBy(org.apache.commons.lang3.math.Fraction fraction) {
		if (fraction == null) {
			throw new java.lang.IllegalArgumentException("The fraction must not be null");
		}
		if ((fraction.numerator) == 0) {
	...
	public boolean equals(java.lang.Object obj) {
		...
		org.apache.commons.lang3.math.Fraction other = ((org.apache.commons.lang3.math.Fraction) (obj));
	...
	public int compareTo(org.apache.commons.lang3.math.Fraction other) {
