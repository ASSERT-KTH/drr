...
public class StringUtils {
	...
	public static java.lang.String replaceEach(java.lang.String text, java.lang.String[] repl, java.lang.String[] with) {
		return org.apache.commons.lang.StringUtils.replaceEach(text, repl, with, false, 0);
	}

	public static java.lang.String replaceEachRepeatedly(java.lang.String text, java.lang.String[] repl, java.lang.String[] with) {
		int timeToLive = repl == null ? 0 : repl.length;
		return org.apache.commons.lang.StringUtils.replaceEach(text, repl, with, true, timeToLive);
	}

	private static java.lang.String replaceEach(java.lang.String text, java.lang.String[] repl, java.lang.String[] with, boolean repeat, int timeToLive) {
		...
		if (replLength != withLength) {
			throw new java.lang.IllegalArgumentException(((("Search and Replace array lengths don't match: " + replLength) + " vs ") + withLength));
		}
		...
		return org.apache.commons.lang.StringUtils.replaceEach(result, repl, with, repeat, (timeToLive - 1));
	}
