...
escapePlus;	}
	...
	private final java.util.EnumSet<org.apache.commons.lang3.text.translate.UnicodeUnescaper.OPTION> options;

	public UnicodeUnescaper(org.apache.commons.lang3.text.translate.UnicodeUnescaper.OPTION... options) {
		if ((options.length) > 0) {
	...
	public boolean isSet(org.apache.commons.lang3.text.translate.UnicodeUnescaper.OPTION opt) {
	...
	public int translate(java.lang.CharSequence input, int index, java.io.Writer out) throws java.io.IOException {
		if ((input.charAt(index)) == '\\') {
			if (((index + 1) < (input.length())) && ((input.charAt((index + 1))) == 'u')) {
				...
				if (isSet(org.apache.commons.lang3.text.translate.UnicodeUnescaper.OPTION.escapePlus)) {
