...
public final class CharRange implements java.io.Serializable , java.lang.Iterable<java.lang.Character> {
	...
	private static class CharacterIterator implements java.util.Iterator<java.lang.Character> {
		...
		private CharacterIterator(org.apache.commons.lang3.CharRange r) {
			range = r;
			hasNext = true;
			if (range.negated) {
				if ((range.start) == 0) {
