...
public class StrTokenizer implements java.lang.Cloneable , java.util.ListIterator<java.lang.String> {
	...
	public static org.apache.commons.lang3.text.StrTokenizer getCSVInstance(java.lang.String input) {
		org.apache.commons.lang3.text.StrTokenizer tok = org.apache.commons.lang3.text.StrTokenizer.getCSVClone();
		tok.reset(input);
		return tok;
	}

	public static org.apache.commons.lang3.text.StrTokenizer getCSVInstance(char[] input) {
		org.apache.commons.lang3.text.StrTokenizer tok = org.apache.commons.lang3.text.StrTokenizer.getCSVClone();
		tok.reset(input);
		return tok;
	}
	...
	public static org.apache.commons.lang3.text.StrTokenizer getTSVInstance(java.lang.String input) {
		org.apache.commons.lang3.text.StrTokenizer tok = org.apache.commons.lang3.text.StrTokenizer.getTSVClone();
		tok.reset(input);
		return tok;
	}

	public static org.apache.commons.lang3.text.StrTokenizer getTSVInstance(char[] input) {
		org.apache.commons.lang3.text.StrTokenizer tok = org.apache.commons.lang3.text.StrTokenizer.getTSVClone();
		tok.reset(input);
		return tok;
	}
	...
	public StrTokenizer(java.lang.String input, org.apache.commons.lang3.text.StrMatcher delim) {
		this(input);
	...
	public StrTokenizer(java.lang.String input, org.apache.commons.lang3.text.StrMatcher delim, org.apache.commons.lang3.text.StrMatcher quote) {
		this(input, delim);
	...
	public StrTokenizer(char[] input, org.apache.commons.lang3.text.StrMatcher delim) {
		this(input);
		setDelimiterMatcher(delim);
	}
	...
	public StrTokenizer(char[] input, org.apache.commons.lang3.text.StrMatcher delim, org.apache.commons.lang3.text.StrMatcher quote) {
		this(input, delim);
		setQuoteMatcher(quote);
	}
	...
	public org.apache.commons.lang3.text.StrTokenizer reset(java.lang.String input) {
		reset();
		if (input != null) {
	...
	public org.apache.commons.lang3.text.StrTokenizer reset(char[] input) {
		reset();
		org.apache.commons.lang3.text.StrTokenizer.this.chars = org.apache.commons.lang3.ArrayUtils.clone(input);
		return org.apache.commons.lang3.text.StrTokenizer.this;
	}
	...
	protected java.util.List<java.lang.String> tokenize(char[] chars, int offset, int count) {
		...
		org.apache.commons.lang3.text.StrBuilder buf = new org.apache.commons.lang3.text.StrBuilder();
	...
	private int readNextToken(char[] chars, int start, int len, org.apache.commons.lang3.text.StrBuilder workArea, java.util.List<java.lang.String> tokens) {
		while (start < len) {
	...
	private int readWithQuotes(char[] chars, int start, int len, org.apache.commons.lang3.text.StrBuilder workArea, java.util.List<java.lang.String> tokens, int quoteStart, int quoteLen) {
		workArea.clear();
		int pos = start;
	...
	public org.apache.commons.lang3.text.StrTokenizer setDelimiterMatcher(org.apache.commons.lang3.text.StrMatcher delim) {
		if (delim == null) {
	...
	public org.apache.commons.lang3.text.StrTokenizer setDelimiterChar(char delim) {
		return setDelimiterMatcher(org.apache.commons.lang3.text.StrMatcher.charMatcher(delim));
	}

	public org.apache.commons.lang3.text.StrTokenizer setDelimiterString(java.lang.String delim) {
	...
	public org.apache.commons.lang3.text.StrTokenizer setQuoteMatcher(org.apache.commons.lang3.text.StrMatcher quote) {
		if (quote != null) {
	...
	public org.apache.commons.lang3.text.StrTokenizer setQuoteChar(char quote) {
	...
	public org.apache.commons.lang3.text.StrTokenizer setIgnoredMatcher(org.apache.commons.lang3.text.StrMatcher ignored) {
		if (ignored != null) {
	...
	public org.apache.commons.lang3.text.StrTokenizer setIgnoredChar(char ignored) {
	...
	public org.apache.commons.lang3.text.StrTokenizer setTrimmerMatcher(org.apache.commons.lang3.text.StrMatcher trimmer) {
		if (trimmer != null) {
	...
	public org.apache.commons.lang3.text.StrTokenizer setEmptyTokenAsNull(boolean emptyAsNull) {
	...
	public org.apache.commons.lang3.text.StrTokenizer setIgnoreEmptyTokens(boolean ignoreEmptyTokens) {
	...
	java.lang.Object cloneReset() throws java.lang.CloneNotSupportedException {
		org.apache.commons.lang3.text.StrTokenizer cloned = ((org.apache.commons.lang3.text.StrTokenizer) (super.clone()));
