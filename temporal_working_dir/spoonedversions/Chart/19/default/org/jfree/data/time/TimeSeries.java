...
public class TimeSeries extends org.jfree.data.general.Series implements java.io.Serializable , java.lang.Cloneable {
	...
	public int hashCode() {
		int result;
		result = ((org.jfree.data.time.TimeSeries.this.domain) != null) ? org.jfree.data.time.TimeSeries.this.domain.hashCode() : 0;
		...
		result = (29 * result) + (org.jfree.data.time.TimeSeries.this.data.hashCode());
