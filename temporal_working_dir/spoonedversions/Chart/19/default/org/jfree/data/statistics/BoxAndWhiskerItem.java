...
public class BoxAndWhiskerItem implements java.io.Serializable {
	...
	public BoxAndWhiskerItem(double mean, double median, double q1, double q3, double minRegularValue, double maxRegularValue, double minOutlier, double maxOutlier, java.util.List outliers) {
		this(new java.lang.Double(mean), new java.lang.Double(median), new java.lang.Double(q1), new java.lang.Double(q3), new java.lang.Double(minRegularValue), new java.lang.Double(maxRegularValue), new java.lang.Double(minOutlier), new java.lang.Double(maxOutlier), outliers);
	}
