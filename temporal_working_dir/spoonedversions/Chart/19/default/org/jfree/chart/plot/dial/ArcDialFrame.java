...
public class ArcDialFrame extends org.jfree.chart.plot.dial.AbstractDialLayer implements java.io.Serializable , java.lang.Cloneable , org.jfree.chart.plot.dial.DialFrame , org.jfree.chart.util.PublicCloneable {
	...
	public int hashCode() {
		...
		result = (37 * result) + ((int) (temp ^ (temp >>> 32)));
		result = (37 * result) + (org.jfree.chart.HashUtilities.hashCodeForPaint(org.jfree.chart.plot.dial.ArcDialFrame.this.backgroundPaint));
		result = (37 * result) + (org.jfree.chart.HashUtilities.hashCodeForPaint(org.jfree.chart.plot.dial.ArcDialFrame.this.foregroundPaint));
