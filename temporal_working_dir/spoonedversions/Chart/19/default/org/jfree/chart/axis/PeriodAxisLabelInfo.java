...
public class PeriodAxisLabelInfo implements java.io.Serializable , java.lang.Cloneable {
	...
	public org.jfree.data.time.RegularTimePeriod createInstance(java.util.Date millisecond, java.util.TimeZone zone) {
		org.jfree.data.time.RegularTimePeriod result = null;
		try {
			java.lang.reflect.Constructor c = org.jfree.chart.axis.PeriodAxisLabelInfo.this.periodClass.getDeclaredConstructor(new java.lang.Class[]{ java.util.Date.class , java.util.TimeZone.class });
