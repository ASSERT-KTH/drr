...
public class ComparableObjectSeries extends org.jfree.data.general.Series implements java.io.Serializable , java.lang.Cloneable {
	...
	public int hashCode() {
		...
		if (count > 0) {
			org.jfree.data.ComparableObjectItem item = getDataItem(0);
			result = (29 * result) + (item.hashCode());
		}
		if (count > 1) {
			org.jfree.data.ComparableObjectItem item = getDataItem((count - 1));
			result = (29 * result) + (item.hashCode());
		}
		if (count > 2) {
			org.jfree.data.ComparableObjectItem item = getDataItem((count / 2));
			result = (29 * result) + (item.hashCode());
		}
