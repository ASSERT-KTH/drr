...
public class PolarPlot extends org.jfree.chart.plot.Plot implements java.io.Serializable , java.lang.Cloneable , org.jfree.chart.event.RendererChangeListener , org.jfree.chart.plot.ValueAxisPlot , org.jfree.chart.plot.Zoomable {
	...
	private java.awt.Font angleLabelFont = new java.awt.Font("SansSerif", java.awt.Font.PLAIN, 12);
	...
	protected java.util.List refreshAngleTicks() {
		...
		for (double currentTickVal = 0.0; currentTickVal < 360.0; currentTickVal += org.jfree.chart.plot.PolarPlot.this.angleTickUnit.getSize()) {
			org.jfree.chart.axis.NumberTick tick = new org.jfree.chart.axis.NumberTick(java.lang.Double.valueOf(currentTickVal), org.jfree.chart.plot.PolarPlot.this.angleTickUnit.valueToString(currentTickVal), org.jfree.chart.text.TextAnchor.CENTER, org.jfree.chart.text.TextAnchor.CENTER, 0.0);
			ticks.add(tick);
		}
		return ticks;
	}
