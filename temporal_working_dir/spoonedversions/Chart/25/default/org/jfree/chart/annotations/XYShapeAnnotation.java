...
public class XYShapeAnnotation extends org.jfree.chart.annotations.AbstractXYAnnotation implements java.io.Serializable , java.lang.Cloneable , org.jfree.chart.util.PublicCloneable {
	...
	public int hashCode() {
		...
		result = (37 * result) + (org.jfree.chart.HashUtilities.hashCodeForPaint(org.jfree.chart.annotations.XYShapeAnnotation.this.outlinePaint));
		result = (37 * result) + (org.jfree.chart.HashUtilities.hashCodeForPaint(org.jfree.chart.annotations.XYShapeAnnotation.this.fillPaint));
		return result;
	}
