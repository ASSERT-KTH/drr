...
public class KeyedObjects implements java.io.Serializable , java.lang.Cloneable , org.jfree.chart.util.PublicCloneable {
	...
	public void sortByKeys(org.jfree.chart.util.SortOrder order) {
		java.util.Comparator comparator = new org.jfree.data.KeyedObjectComparator(org.jfree.data.KeyedObjectComparatorType.BY_KEY, order);
		java.util.Collections.sort(org.jfree.data.KeyedObjects.this.data, comparator);
	}

	public void sortByObjects(org.jfree.chart.util.SortOrder order) {
		java.util.Comparator comparator = new org.jfree.data.KeyedObjectComparator(org.jfree.data.KeyedObjectComparatorType.BY_VALUE, order);
		java.util.Collections.sort(org.jfree.data.KeyedObjects.this.data, comparator);
	}
