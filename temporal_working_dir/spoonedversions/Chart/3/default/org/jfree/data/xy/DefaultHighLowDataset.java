...
public class DefaultHighLowDataset extends org.jfree.data.xy.AbstractXYDataset implements org.jfree.chart.util.PublicCloneable , org.jfree.data.xy.OHLCDataset , org.jfree.data.xy.SelectableXYDataset , org.jfree.data.xy.XYDatasetSelectionState {
	...
	public DefaultHighLowDataset(java.lang.Comparable seriesKey, java.util.Date[] date, double[] high, double[] low, double[] open, double[] close, double[] volume) {
		...
		org.jfree.data.xy.DefaultHighLowDataset.this.selected = new boolean[org.jfree.data.xy.DefaultHighLowDataset.this.date.length];
		...
		setSelectionState(org.jfree.data.xy.DefaultHighLowDataset.this);
	}
	...
	public double getHighValue(int series, int item) {
		...
		java.lang.Number n = getHigh(series, item);
		if (n != null) {
	...
	public boolean isSelected(int series, int item) {
		return org.jfree.data.xy.DefaultHighLowDataset.this.selected[item];
	}
	...
	public void setSelected(int series, int item, boolean selected, boolean notify) {
		if (series != 0) {
			throw new java.lang.IllegalArgumentException(("Invalid series: " + series));
		}
		org.jfree.data.xy.DefaultHighLowDataset.this.selected[item] = selected;
		if (notify) {
			fireSelectionEvent();
		}
	}
	...
	public void clearSelection() {
		java.util.Arrays.fill(org.jfree.data.xy.DefaultHighLowDataset.this.selected, false);
		fireSelectionEvent();
	}
}
