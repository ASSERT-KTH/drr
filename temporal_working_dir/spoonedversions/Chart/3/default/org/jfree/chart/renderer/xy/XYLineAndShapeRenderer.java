...
public class XYLineAndShapeRenderer extends org.jfree.chart.renderer.xy.AbstractXYItemRenderer implements java.io.Serializable , java.lang.Cloneable , org.jfree.chart.renderer.xy.XYItemRenderer , org.jfree.chart.util.PublicCloneable {
	...
	protected void drawPrimaryLine(org.jfree.chart.renderer.xy.XYItemRendererState state, java.awt.Graphics2D g2, org.jfree.chart.plot.XYPlot plot, org.jfree.data.xy.XYDataset dataset, int pass, int series, int item, boolean selected, org.jfree.chart.axis.ValueAxis domainAxis, org.jfree.chart.axis.ValueAxis rangeAxis, java.awt.geom.Rectangle2D dataArea) {
		...
		visible = org.jfree.chart.util.LineUtilities.clipLine(state.workingLine, dataArea);
		if (visible) {
			drawShape1(g2, pass, series, item, selected, state.workingLine);
		}
	}

	protected void drawShape1(java.awt.Graphics2D g2, int pass, int series, int item, boolean selected, java.awt.Shape shape) {
	...
	protected void drawShape2(java.awt.Graphics2D g2, java.awt.geom.Rectangle2D dataArea, org.jfree.chart.plot.XYPlot plot, org.jfree.data.xy.XYDataset dataset, int pass, int series, int item, boolean selected, org.jfree.chart.axis.ValueAxis domainAxis, org.jfree.chart.axis.ValueAxis rangeAxis, org.jfree.chart.plot.CrosshairState crosshairState, org.jfree.chart.entity.EntityCollection entities) {
		...
		if ((entities != null) && (org.jfree.chart.util.ShapeUtilities.isPointInRect(xx, yy, dataArea))) {
