...
public class CategoryAxis extends org.jfree.chart.axis.Axis implements java.io.Serializable , java.lang.Cloneable {
	...
	public double getCategoryMiddle(int category, int categoryCount, java.awt.geom.Rectangle2D area, org.jfree.chart.util.RectangleEdge edge) {
		if ((category < 0) || (category >= categoryCount)) {
			throw new java.lang.IllegalArgumentException(("Invalid category index: " + category));
		}
	...
	public double getCategoryMiddle(java.lang.Comparable category, java.util.List categories, java.awt.geom.Rectangle2D area, org.jfree.chart.util.RectangleEdge edge) {
		if (categories == null) {
			throw new java.lang.IllegalArgumentException("Null 'categories' argument.");
		}
	...
	public double getCategorySeriesMiddle(java.lang.Comparable category, java.lang.Comparable seriesKey, org.jfree.data.category.CategoryDataset dataset, double itemMargin, java.awt.geom.Rectangle2D area, org.jfree.chart.util.RectangleEdge edge) {
	...
	public double getCategorySeriesMiddle(int categoryIndex, int categoryCount, int seriesIndex, int seriesCount, double itemMargin, java.awt.geom.Rectangle2D area, org.jfree.chart.util.RectangleEdge edge) {
		double start = getCategoryStart(categoryIndex, categoryCount, area, edge);
		double end = getCategoryEnd(categoryIndex, categoryCount, area, edge);
		double width = end - start;
		if (seriesCount == 1) {
	...
	public void drawTickMarks(java.awt.Graphics2D g2, double cursor, java.awt.geom.Rectangle2D dataArea, org.jfree.chart.util.RectangleEdge edge, org.jfree.chart.axis.AxisState state) {
		org.jfree.chart.plot.Plot p = getPlot();
		if (p == null) {
			return ;
		}
		org.jfree.chart.plot.CategoryPlot plot = ((org.jfree.chart.plot.CategoryPlot) (p));
	...
	private boolean equalPaintMaps(java.util.Map map1, java.util.Map map2) {
		...
		java.util.Set entries = map1.entrySet();
		java.util.Iterator iterator = entries.iterator();
		while (iterator.hasNext()) {
			java.util.Map.Entry entry = ((java.util.Map.Entry) (iterator.next()));
			java.awt.Paint p1 = ((java.awt.Paint) (entry.getValue()));
			java.awt.Paint p2 = ((java.awt.Paint) (map2.get(entry.getKey())));
