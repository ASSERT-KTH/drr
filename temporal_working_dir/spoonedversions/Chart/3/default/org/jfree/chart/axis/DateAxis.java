...
public class DateAxis extends org.jfree.chart.axis.ValueAxis implements java.io.Serializable , java.lang.Cloneable {
	...
	public static final org.jfree.chart.axis.DateTickUnit DEFAULT_DATE_TICK_UNIT = new org.jfree.chart.axis.DateTickUnit(org.jfree.chart.axis.DateTickUnitType.DAY, 1, new java.text.SimpleDateFormat());
	...
	public DateAxis(java.lang.String label, java.util.TimeZone zone) {
		this(label, zone, java.util.Locale.getDefault());
	}

	public DateAxis(java.lang.String label, java.util.TimeZone zone, java.util.Locale locale) {
		super(label, org.jfree.chart.axis.DateAxis.createStandardDateTickUnits(zone, locale));
		...
		org.jfree.chart.axis.DateAxis.this.locale = locale;
	...
	public void setTimeZone(java.util.TimeZone zone) {
		...
		if (!(org.jfree.chart.axis.DateAxis.this.timeZone.equals(zone))) {
			org.jfree.chart.axis.DateAxis.this.timeZone = zone;
			setStandardTickUnits(org.jfree.chart.axis.DateAxis.createStandardDateTickUnits(zone, org.jfree.chart.axis.DateAxis.this.locale));
	...
	public double valueToJava2D(double value, java.awt.geom.Rectangle2D area, org.jfree.chart.util.RectangleEdge edge) {
		...
		double axisMin = org.jfree.chart.axis.DateAxis.this.timeline.toTimelineValue(range.getLowerMillis());
		double axisMax = org.jfree.chart.axis.DateAxis.this.timeline.toTimelineValue(range.getUpperMillis());
		double result = 0.0;
	...
	protected java.util.Date previousStandardDate(java.util.Date date, org.jfree.chart.axis.DateTickUnit unit) {
		...
		int months;
		int years;
		java.util.Calendar calendar = java.util.Calendar.getInstance(org.jfree.chart.axis.DateAxis.this.timeZone, org.jfree.chart.axis.DateAxis.this.locale);
		calendar.setTime(date);
		int count = unit.getMultiple();
		int current = calendar.get(unit.getCalendarField());
		int value = count * (current / count);
		org.jfree.chart.axis.DateTickUnitType t = unit.getUnitType();
		if (t.equals(org.jfree.chart.axis.DateTickUnitType.MILLISECOND)) {
			...
			if (t.equals(org.jfree.chart.axis.DateTickUnitType.SECOND)) {
				years = calendar.get(java.util.Calendar.YEAR);
				months = calendar.get(java.util.Calendar.MONTH);
				days = calendar.get(java.util.Calendar.DATE);
				hours = calendar.get(java.util.Calendar.HOUR_OF_DAY);
				...
				if (t.equals(org.jfree.chart.axis.DateTickUnitType.MINUTE)) {
					years = calendar.get(java.util.Calendar.YEAR);
					months = calendar.get(java.util.Calendar.MONTH);
					days = calendar.get(java.util.Calendar.DATE);
					hours = calendar.get(java.util.Calendar.HOUR_OF_DAY);
					...
					if (t.equals(org.jfree.chart.axis.DateTickUnitType.HOUR)) {
						years = calendar.get(java.util.Calendar.YEAR);
						months = calendar.get(java.util.Calendar.MONTH);
						days = calendar.get(java.util.Calendar.DATE);
						if ((org.jfree.chart.axis.DateAxis.this.tickMarkPosition) == (org.jfree.chart.axis.DateTickMarkPosition.START)) {
						...
						if (t.equals(org.jfree.chart.axis.DateTickUnitType.DAY)) {
							years = calendar.get(java.util.Calendar.YEAR);
							months = calendar.get(java.util.Calendar.MONTH);
							if ((org.jfree.chart.axis.DateAxis.this.tickMarkPosition) == (org.jfree.chart.axis.DateTickMarkPosition.START)) {
								hours = 0;
							...
							if (t.equals(org.jfree.chart.axis.DateTickUnitType.MONTH)) {
								years = calendar.get(java.util.Calendar.YEAR);
								calendar.clear(java.util.Calendar.MILLISECOND);
								calendar.set(years, value, 1, 0, 0, 0);
								org.jfree.data.time.Month month = new org.jfree.data.time.Month(calendar.getTime(), org.jfree.chart.axis.DateAxis.this.timeZone, org.jfree.chart.axis.DateAxis.this.locale);
								...
								if (millis >= (date.getTime())) {
									...
									month.peg(java.util.Calendar.getInstance(org.jfree.chart.axis.DateAxis.this.timeZone));
									standardDate = calculateDateForPosition(month, org.jfree.chart.axis.DateAxis.this.tickMarkPosition);
								}
								return standardDate;
							}else
								if (t.equals(org.jfree.chart.axis.DateTickUnitType.YEAR)) {
									if ((org.jfree.chart.axis.DateAxis.this.tickMarkPosition) == (org.jfree.chart.axis.DateTickMarkPosition.START)) {
										months = 0;
										days = 1;
									}else
	...
	public static org.jfree.chart.axis.TickUnitSource createStandardDateTickUnits() {
		return org.jfree.chart.axis.DateAxis.createStandardDateTickUnits(java.util.TimeZone.getDefault(), java.util.Locale.getDefault());
	}

	public static org.jfree.chart.axis.TickUnitSource createStandardDateTickUnits(java.util.TimeZone zone) {
		return org.jfree.chart.axis.DateAxis.createStandardDateTickUnits(zone, java.util.Locale.getDefault());
	}

	public static org.jfree.chart.axis.TickUnitSource createStandardDateTickUnits(java.util.TimeZone zone, java.util.Locale locale) {
		if (zone == null) {
			throw new java.lang.IllegalArgumentException("Null 'zone' argument.");
		}
		if (locale == null) {
		...
		java.text.DateFormat f1 = new java.text.SimpleDateFormat("HH:mm:ss.SSS", locale);
		java.text.DateFormat f2 = new java.text.SimpleDateFormat("HH:mm:ss", locale);
		java.text.DateFormat f3 = new java.text.SimpleDateFormat("HH:mm", locale);
		java.text.DateFormat f4 = new java.text.SimpleDateFormat("d-MMM, HH:mm", locale);
		java.text.DateFormat f5 = new java.text.SimpleDateFormat("d-MMM", locale);
		java.text.DateFormat f6 = new java.text.SimpleDateFormat("MMM-yyyy", locale);
		java.text.DateFormat f7 = new java.text.SimpleDateFormat("yyyy", locale);
		f1.setTimeZone(zone);
		f2.setTimeZone(zone);
		f3.setTimeZone(zone);
		f4.setTimeZone(zone);
		...
		f6.setTimeZone(zone);
		f7.setTimeZone(zone);
		units.add(new org.jfree.chart.axis.DateTickUnit(org.jfree.chart.axis.DateTickUnitType.MILLISECOND, 1, f1));
		units.add(new org.jfree.chart.axis.DateTickUnit(org.jfree.chart.axis.DateTickUnitType.MILLISECOND, 5, org.jfree.chart.axis.DateTickUnitType.MILLISECOND, 1, f1));
		units.add(new org.jfree.chart.axis.DateTickUnit(org.jfree.chart.axis.DateTickUnitType.MILLISECOND, 10, org.jfree.chart.axis.DateTickUnitType.MILLISECOND, 1, f1));
		units.add(new org.jfree.chart.axis.DateTickUnit(org.jfree.chart.axis.DateTickUnitType.MILLISECOND, 25, org.jfree.chart.axis.DateTickUnitType.MILLISECOND, 5, f1));
		units.add(new org.jfree.chart.axis.DateTickUnit(org.jfree.chart.axis.DateTickUnitType.MILLISECOND, 50, org.jfree.chart.axis.DateTickUnitType.MILLISECOND, 10, f1));
		units.add(new org.jfree.chart.axis.DateTickUnit(org.jfree.chart.axis.DateTickUnitType.MILLISECOND, 100, org.jfree.chart.axis.DateTickUnitType.MILLISECOND, 10, f1));
		units.add(new org.jfree.chart.axis.DateTickUnit(org.jfree.chart.axis.DateTickUnitType.MILLISECOND, 250, org.jfree.chart.axis.DateTickUnitType.MILLISECOND, 10, f1));
		units.add(new org.jfree.chart.axis.DateTickUnit(org.jfree.chart.axis.DateTickUnitType.MILLISECOND, 500, org.jfree.chart.axis.DateTickUnitType.MILLISECOND, 50, f1));
		units.add(new org.jfree.chart.axis.DateTickUnit(org.jfree.chart.axis.DateTickUnitType.SECOND, 1, org.jfree.chart.axis.DateTickUnitType.MILLISECOND, 50, f2));
		units.add(new org.jfree.chart.axis.DateTickUnit(org.jfree.chart.axis.DateTickUnitType.SECOND, 5, org.jfree.chart.axis.DateTickUnitType.SECOND, 1, f2));
		units.add(new org.jfree.chart.axis.DateTickUnit(org.jfree.chart.axis.DateTickUnitType.SECOND, 10, org.jfree.chart.axis.DateTickUnitType.SECOND, 1, f2));
		units.add(new org.jfree.chart.axis.DateTickUnit(org.jfree.chart.axis.DateTickUnitType.SECOND, 30, org.jfree.chart.axis.DateTickUnitType.SECOND, 5, f2));
		units.add(new org.jfree.chart.axis.DateTickUnit(org.jfree.chart.axis.DateTickUnitType.MINUTE, 1, org.jfree.chart.axis.DateTickUnitType.SECOND, 5, f3));
		units.add(new org.jfree.chart.axis.DateTickUnit(org.jfree.chart.axis.DateTickUnitType.MINUTE, 2, org.jfree.chart.axis.DateTickUnitType.SECOND, 10, f3));
		units.add(new org.jfree.chart.axis.DateTickUnit(org.jfree.chart.axis.DateTickUnitType.MINUTE, 5, org.jfree.chart.axis.DateTickUnitType.MINUTE, 1, f3));
		units.add(new org.jfree.chart.axis.DateTickUnit(org.jfree.chart.axis.DateTickUnitType.MINUTE, 10, org.jfree.chart.axis.DateTickUnitType.MINUTE, 1, f3));
		units.add(new org.jfree.chart.axis.DateTickUnit(org.jfree.chart.axis.DateTickUnitType.MINUTE, 15, org.jfree.chart.axis.DateTickUnitType.MINUTE, 5, f3));
		units.add(new org.jfree.chart.axis.DateTickUnit(org.jfree.chart.axis.DateTickUnitType.MINUTE, 20, org.jfree.chart.axis.DateTickUnitType.MINUTE, 5, f3));
		units.add(new org.jfree.chart.axis.DateTickUnit(org.jfree.chart.axis.DateTickUnitType.MINUTE, 30, org.jfree.chart.axis.DateTickUnitType.MINUTE, 5, f3));
		units.add(new org.jfree.chart.axis.DateTickUnit(org.jfree.chart.axis.DateTickUnitType.HOUR, 1, org.jfree.chart.axis.DateTickUnitType.MINUTE, 5, f3));
		units.add(new org.jfree.chart.axis.DateTickUnit(org.jfree.chart.axis.DateTickUnitType.HOUR, 2, org.jfree.chart.axis.DateTickUnitType.MINUTE, 10, f3));
		units.add(new org.jfree.chart.axis.DateTickUnit(org.jfree.chart.axis.DateTickUnitType.HOUR, 4, org.jfree.chart.axis.DateTickUnitType.MINUTE, 30, f3));
		units.add(new org.jfree.chart.axis.DateTickUnit(org.jfree.chart.axis.DateTickUnitType.HOUR, 6, org.jfree.chart.axis.DateTickUnitType.HOUR, 1, f3));
		units.add(new org.jfree.chart.axis.DateTickUnit(org.jfree.chart.axis.DateTickUnitType.HOUR, 12, org.jfree.chart.axis.DateTickUnitType.HOUR, 1, f4));
		units.add(new org.jfree.chart.axis.DateTickUnit(org.jfree.chart.axis.DateTickUnitType.DAY, 1, org.jfree.chart.axis.DateTickUnitType.HOUR, 1, f5));
		units.add(new org.jfree.chart.axis.DateTickUnit(org.jfree.chart.axis.DateTickUnitType.DAY, 2, org.jfree.chart.axis.DateTickUnitType.HOUR, 1, f5));
		units.add(new org.jfree.chart.axis.DateTickUnit(org.jfree.chart.axis.DateTickUnitType.DAY, 7, org.jfree.chart.axis.DateTickUnitType.DAY, 1, f5));
		units.add(new org.jfree.chart.axis.DateTickUnit(org.jfree.chart.axis.DateTickUnitType.DAY, 15, org.jfree.chart.axis.DateTickUnitType.DAY, 1, f5));
		units.add(new org.jfree.chart.axis.DateTickUnit(org.jfree.chart.axis.DateTickUnitType.MONTH, 1, org.jfree.chart.axis.DateTickUnitType.DAY, 1, f6));
		units.add(new org.jfree.chart.axis.DateTickUnit(org.jfree.chart.axis.DateTickUnitType.MONTH, 2, org.jfree.chart.axis.DateTickUnitType.DAY, 1, f6));
		units.add(new org.jfree.chart.axis.DateTickUnit(org.jfree.chart.axis.DateTickUnitType.MONTH, 3, org.jfree.chart.axis.DateTickUnitType.MONTH, 1, f6));
		units.add(new org.jfree.chart.axis.DateTickUnit(org.jfree.chart.axis.DateTickUnitType.MONTH, 4, org.jfree.chart.axis.DateTickUnitType.MONTH, 1, f6));
		units.add(new org.jfree.chart.axis.DateTickUnit(org.jfree.chart.axis.DateTickUnitType.MONTH, 6, org.jfree.chart.axis.DateTickUnitType.MONTH, 1, f6));
		units.add(new org.jfree.chart.axis.DateTickUnit(org.jfree.chart.axis.DateTickUnitType.YEAR, 1, org.jfree.chart.axis.DateTickUnitType.MONTH, 1, f7));
		units.add(new org.jfree.chart.axis.DateTickUnit(org.jfree.chart.axis.DateTickUnitType.YEAR, 2, org.jfree.chart.axis.DateTickUnitType.MONTH, 3, f7));
		units.add(new org.jfree.chart.axis.DateTickUnit(org.jfree.chart.axis.DateTickUnitType.YEAR, 5, org.jfree.chart.axis.DateTickUnitType.YEAR, 1, f7));
		units.add(new org.jfree.chart.axis.DateTickUnit(org.jfree.chart.axis.DateTickUnitType.YEAR, 10, org.jfree.chart.axis.DateTickUnitType.YEAR, 1, f7));
		units.add(new org.jfree.chart.axis.DateTickUnit(org.jfree.chart.axis.DateTickUnitType.YEAR, 25, org.jfree.chart.axis.DateTickUnitType.YEAR, 5, f7));
		units.add(new org.jfree.chart.axis.DateTickUnit(org.jfree.chart.axis.DateTickUnitType.YEAR, 50, org.jfree.chart.axis.DateTickUnitType.YEAR, 10, f7));
		units.add(new org.jfree.chart.axis.DateTickUnit(org.jfree.chart.axis.DateTickUnitType.YEAR, 100, org.jfree.chart.axis.DateTickUnitType.YEAR, 20, f7));
		return units;
	}
	...
	private java.util.Date correctTickDateForPosition(java.util.Date time, org.jfree.chart.axis.DateTickUnit unit, org.jfree.chart.axis.DateTickMarkPosition position) {
		java.util.Date result = time;
		org.jfree.chart.axis.DateTickUnitType t = unit.getUnitType();
		if (t.equals(org.jfree.chart.axis.DateTickUnitType.MONTH)) {
			result = calculateDateForPosition(new org.jfree.data.time.Month(time, org.jfree.chart.axis.DateAxis.this.timeZone, org.jfree.chart.axis.DateAxis.this.locale), position);
		}else
			if (t.equals(org.jfree.chart.axis.DateTickUnitType.YEAR)) {
				result = calculateDateForPosition(new org.jfree.data.time.Year(time, org.jfree.chart.axis.DateAxis.this.timeZone, org.jfree.chart.axis.DateAxis.this.locale), position);
			}
	...
	protected java.util.List refreshTicksHorizontal(java.awt.Graphics2D g2, java.awt.geom.Rectangle2D dataArea, org.jfree.chart.util.RectangleEdge edge) {
		...
		while (tickDate.before(upperDate)) {
			tickDate = correctTickDateForPosition(tickDate, unit, org.jfree.chart.axis.DateAxis.this.tickMarkPosition);
			long lowestTickTime = tickDate.getTime();
			long distance = (unit.addToDate(tickDate, org.jfree.chart.axis.DateAxis.this.timeZone).getTime()) - lowestTickTime;
			...
			for (int minorTick = 1; minorTick < minorTickSpaces; minorTick++) {
				...
				if (((minorTickTime > 0) && (getRange().contains(minorTickTime))) && (!(isHiddenValue(minorTickTime)))) {
					result.add(new org.jfree.chart.axis.DateTick(org.jfree.chart.axis.TickType.MINOR, new java.util.Date(minorTickTime), "", org.jfree.chart.text.TextAnchor.TOP_CENTER, org.jfree.chart.text.TextAnchor.CENTER, 0.0));
				}
			}
