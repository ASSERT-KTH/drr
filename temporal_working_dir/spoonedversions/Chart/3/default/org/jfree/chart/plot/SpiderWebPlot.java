...
public class SpiderWebPlot extends org.jfree.chart.plot.Plot implements java.io.Serializable , java.lang.Cloneable {
	...
	public void setDataset(org.jfree.data.category.CategoryDataset dataset) {
		...
		datasetChanged(new org.jfree.data.event.DatasetChangeEvent(org.jfree.chart.plot.SpiderWebPlot.this, dataset, new org.jfree.chart.event.DatasetChangeInfo()));
	}
				...
				if (value >= 0) {
					...
					if (entities != null) {
						...
						if ((org.jfree.chart.plot.SpiderWebPlot.this.toolTipGenerator) != null) {
							tip = org.jfree.chart.plot.SpiderWebPlot.this.toolTipGenerator.generateToolTip(org.jfree.chart.plot.SpiderWebPlot.this.dataset, row, col);
						}
						java.lang.String url = null;
						if ((org.jfree.chart.plot.SpiderWebPlot.this.urlGenerator) != null) {
							url = org.jfree.chart.plot.SpiderWebPlot.this.urlGenerator.generateURL(org.jfree.chart.plot.SpiderWebPlot.this.dataset, row, col);
						}
						java.awt.Shape area = new java.awt.Rectangle(((int) ((point.getX()) - headW)), ((int) ((point.getY()) - headH)), ((int) (headW * 2)), ((int) (headH * 2)));
						org.jfree.chart.entity.CategoryItemEntity entity = new org.jfree.chart.entity.CategoryItemEntity(area, tip, url, org.jfree.chart.plot.SpiderWebPlot.this.dataset, org.jfree.chart.plot.SpiderWebPlot.this.dataset.getRowKey(row), org.jfree.chart.plot.SpiderWebPlot.this.dataset.getColumnKey(col));
						entities.add(entity);
					}
				}
			}
