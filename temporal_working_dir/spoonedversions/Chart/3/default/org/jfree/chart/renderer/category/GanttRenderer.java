	...
	protected void drawTasks(java.awt.Graphics2D g2, org.jfree.chart.renderer.category.CategoryItemRendererState state, java.awt.geom.Rectangle2D dataArea, org.jfree.chart.plot.CategoryPlot plot, org.jfree.chart.axis.CategoryAxis domainAxis, org.jfree.chart.axis.ValueAxis rangeAxis, org.jfree.data.gantt.GanttCategoryDataset dataset, int row, int column, boolean selected) {
		...
		for (int subinterval = 0; subinterval < count; subinterval++) {
			...
			if (getShadowsVisible()) {
				getBarPainter().paintBarShadow(g2, org.jfree.chart.renderer.category.GanttRenderer.this, row, column, selected, bar, barBase, true);
			}
			getBarPainter().paintBar(g2, org.jfree.chart.renderer.category.GanttRenderer.this, row, column, selected, bar, barBase);
			if (completeBar != null) {
