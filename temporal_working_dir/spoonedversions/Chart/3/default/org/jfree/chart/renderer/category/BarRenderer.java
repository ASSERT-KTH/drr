...
public class BarRenderer extends org.jfree.chart.renderer.category.AbstractCategoryItemRenderer implements java.io.Serializable , java.lang.Cloneable , org.jfree.chart.util.PublicCloneable {
	...
	protected double[] calculateBarL0L1(double value, double min, double max) {
		...
		barLow = java.lang.Math.max(barLow, min);
		barHigh = java.lang.Math.min(barHigh, max);
	...
	public java.awt.geom.Rectangle2D createHotSpotBounds(java.awt.Graphics2D g2, java.awt.geom.Rectangle2D dataArea, org.jfree.chart.plot.CategoryPlot plot, org.jfree.chart.axis.CategoryAxis domainAxis, org.jfree.chart.axis.ValueAxis rangeAxis, org.jfree.data.category.CategoryDataset dataset, int row, int column, boolean selected, org.jfree.chart.renderer.category.CategoryItemRendererState state, java.awt.geom.Rectangle2D result) {
		...
		if (!(org.jfree.chart.renderer.category.BarRenderer.this.getItemVisible(row, column))) {
			return null;
		}
		java.lang.Number dataValue = dataset.getValue(row, column);
		if (dataValue == null) {
