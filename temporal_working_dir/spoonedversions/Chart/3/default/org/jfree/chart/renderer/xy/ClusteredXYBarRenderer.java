...
public class ClusteredXYBarRenderer extends org.jfree.chart.renderer.xy.XYBarRenderer implements java.io.Serializable , java.lang.Cloneable , org.jfree.chart.util.PublicCloneable {
	...
	public void drawItem(java.awt.Graphics2D g2, org.jfree.chart.renderer.xy.XYItemRendererState state, java.awt.geom.Rectangle2D dataArea, org.jfree.chart.plot.XYPlot plot, org.jfree.chart.axis.ValueAxis domainAxis, org.jfree.chart.axis.ValueAxis rangeAxis, org.jfree.data.xy.XYDataset dataset, int series, int item, boolean selected, int pass) {
		...
		if ((pass == 0) && (getShadowsVisible())) {
			getBarPainter().paintBarShadow(g2, org.jfree.chart.renderer.xy.ClusteredXYBarRenderer.this, series, item, selected, bar, barBase, (!(getUseYInterval())));
		}
		if (pass == 1) {
			getBarPainter().paintBar(g2, org.jfree.chart.renderer.xy.ClusteredXYBarRenderer.this, series, item, selected, bar, barBase);
			...
			if ((state.getInfo()) != null) {
				org.jfree.chart.entity.EntityCollection entities = state.getInfo().getOwner().getEntityCollection();
				if (entities != null) {
