...
public class CombinedDomainXYPlot extends org.jfree.chart.plot.XYPlot implements org.jfree.chart.event.PlotChangeListener {
	...
	protected org.jfree.chart.axis.AxisSpace calculateAxisSpace(java.awt.Graphics2D g2, java.awt.geom.Rectangle2D plotArea) {
		...
		int totalWeight = 0;
		for (int i = 0; i < n; i++) {
			org.jfree.chart.plot.XYPlot sub = ((org.jfree.chart.plot.XYPlot) (org.jfree.chart.plot.CombinedDomainXYPlot.this.subplots.get(i)));
	...
	public void zoomRangeAxes(double factor, org.jfree.chart.plot.PlotRenderingInfo state, java.awt.geom.Point2D source, boolean useAnchor) {
		org.jfree.chart.plot.XYPlot subplot = findSubplot(state, source);
		if (subplot != null) {
	...
	public boolean equals(java.lang.Object obj) {
		...
		org.jfree.chart.plot.CombinedDomainXYPlot that = ((org.jfree.chart.plot.CombinedDomainXYPlot) (obj));
		if ((org.jfree.chart.plot.CombinedDomainXYPlot.this.gap) != (that.gap)) {
			return false;
		}
		if (!(org.jfree.chart.util.ObjectUtilities.equal(org.jfree.chart.plot.CombinedDomainXYPlot.this.subplots, that.subplots))) {
			return false;
		}
