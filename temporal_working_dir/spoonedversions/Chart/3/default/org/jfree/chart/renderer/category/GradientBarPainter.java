...
public class GradientBarPainter implements java.io.Serializable , org.jfree.chart.renderer.category.BarPainter {
	private double g1;
	...
	public GradientBarPainter(double g1, double g2, double g3) {
		org.jfree.chart.renderer.category.GradientBarPainter.this.g1 = g1;
		org.jfree.chart.renderer.category.GradientBarPainter.this.g2 = g2;
		org.jfree.chart.renderer.category.GradientBarPainter.this.g3 = g3;
	}
	...
	public void paintBar(java.awt.Graphics2D g2, org.jfree.chart.renderer.category.BarRenderer renderer, int row, int column, boolean selected, java.awt.geom.RectangularShape bar, org.jfree.chart.util.RectangleEdge base) {
		...
		if ((base == (org.jfree.chart.util.RectangleEdge.TOP)) || (base == (org.jfree.chart.util.RectangleEdge.BOTTOM))) {
			java.awt.geom.Rectangle2D[] regions = splitVerticalBar(bar, org.jfree.chart.renderer.category.GradientBarPainter.this.g1, org.jfree.chart.renderer.category.GradientBarPainter.this.g2, org.jfree.chart.renderer.category.GradientBarPainter.this.g3);
			...
			if ((base == (org.jfree.chart.util.RectangleEdge.LEFT)) || (base == (org.jfree.chart.util.RectangleEdge.RIGHT))) {
				java.awt.geom.Rectangle2D[] regions = splitHorizontalBar(bar, org.jfree.chart.renderer.category.GradientBarPainter.this.g1, org.jfree.chart.renderer.category.GradientBarPainter.this.g2, org.jfree.chart.renderer.category.GradientBarPainter.this.g3);
	...
	public boolean equals(java.lang.Object obj) {
		if (obj == (org.jfree.chart.renderer.category.GradientBarPainter.this)) {
			return true;
		}
		if (!(obj instanceof org.jfree.chart.renderer.category.GradientBarPainter)) {
			return false;
		}
		org.jfree.chart.renderer.category.GradientBarPainter that = ((org.jfree.chart.renderer.category.GradientBarPainter) (obj));
		if ((org.jfree.chart.renderer.category.GradientBarPainter.this.g1) != (that.g1)) {
			return false;
		}
		if ((org.jfree.chart.renderer.category.GradientBarPainter.this.g2) != (that.g2)) {
			return false;
		}
		if ((org.jfree.chart.renderer.category.GradientBarPainter.this.g3) != (that.g3)) {
			return false;
		}
		return true;
	}
	...
	public int hashCode() {
		int hash = 37;
		hash = org.jfree.chart.util.HashUtilities.hashCode(hash, org.jfree.chart.renderer.category.GradientBarPainter.this.g1);
		hash = org.jfree.chart.util.HashUtilities.hashCode(hash, org.jfree.chart.renderer.category.GradientBarPainter.this.g2);
		hash = org.jfree.chart.util.HashUtilities.hashCode(hash, org.jfree.chart.renderer.category.GradientBarPainter.this.g3);
		return hash;
	}
}
