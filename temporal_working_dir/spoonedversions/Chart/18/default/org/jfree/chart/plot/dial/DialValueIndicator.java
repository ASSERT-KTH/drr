...
public class DialValueIndicator extends org.jfree.chart.plot.dial.AbstractDialLayer implements java.io.Serializable , java.lang.Cloneable , org.jfree.chart.plot.dial.DialLayer , org.jfree.chart.util.PublicCloneable {
	...
	public int hashCode() {
		int result = 193;
		result = (37 * result) + (org.jfree.chart.HashUtilities.hashCodeForPaint(org.jfree.chart.plot.dial.DialValueIndicator.this.paint));
		result = (37 * result) + (org.jfree.chart.HashUtilities.hashCodeForPaint(org.jfree.chart.plot.dial.DialValueIndicator.this.backgroundPaint));
		result = (37 * result) + (org.jfree.chart.HashUtilities.hashCodeForPaint(org.jfree.chart.plot.dial.DialValueIndicator.this.outlinePaint));
