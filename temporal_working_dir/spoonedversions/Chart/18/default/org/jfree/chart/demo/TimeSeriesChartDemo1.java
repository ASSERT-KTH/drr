...
public class TimeSeriesChartDemo1 extends org.jfree.chart.util.ApplicationFrame {
	...
	private static org.jfree.data.xy.XYDataset createDataset() {
		org.jfree.data.time.TimeSeries s1 = new org.jfree.data.time.TimeSeries("L&G European Index Trust", org.jfree.data.time.Month.class);
		...
		org.jfree.data.time.TimeSeries s2 = new org.jfree.data.time.TimeSeries("L&G UK Index Trust", org.jfree.data.time.Month.class);
