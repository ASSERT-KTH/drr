...
public abstract class AbstractDataset implements java.io.ObjectInputValidation , java.io.Serializable , java.lang.Cloneable , org.jfree.data.general.Dataset {
	...
	public void addChangeListener(org.jfree.data.general.DatasetChangeListener listener) {
		org.jfree.data.general.AbstractDataset.this.listenerList.add(org.jfree.data.general.DatasetChangeListener.class, listener);
	}

	public void removeChangeListener(org.jfree.data.general.DatasetChangeListener listener) {
		org.jfree.data.general.AbstractDataset.this.listenerList.remove(org.jfree.data.general.DatasetChangeListener.class, listener);
	}
	...
	protected void fireDatasetChanged() {
		notifyListeners(new org.jfree.data.general.DatasetChangeEvent(org.jfree.data.general.AbstractDataset.this, org.jfree.data.general.AbstractDataset.this));
	}

	protected void notifyListeners(org.jfree.data.general.DatasetChangeEvent event) {
