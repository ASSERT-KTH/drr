...
public class PaintMap implements java.io.Serializable , java.lang.Cloneable {
	...
	public PaintMap() {
		org.jfree.chart.PaintMap.this.store = new java.util.HashMap();
	}
	...
	public java.awt.Paint getPaint(java.lang.Comparable key) {
		...
		return ((java.awt.Paint) (org.jfree.chart.PaintMap.this.store.get(key)));
	}

	public boolean containsKey(java.lang.Comparable key) {
		return org.jfree.chart.PaintMap.this.store.containsKey(key);
	}
	...
	public void put(java.lang.Comparable key, java.awt.Paint paint) {
		...
		org.jfree.chart.PaintMap.this.store.put(key, paint);
	}

	public void clear() {
		org.jfree.chart.PaintMap.this.store.clear();
	}

	public boolean equals(java.lang.Object obj) {
		if (obj == (org.jfree.chart.PaintMap.this)) {
			return true;
		}
		if (!(obj instanceof org.jfree.chart.PaintMap)) {
			return false;
		}
		org.jfree.chart.PaintMap that = ((org.jfree.chart.PaintMap) (obj));
		if ((org.jfree.chart.PaintMap.this.store.size()) != (that.store.size())) {
			return false;
		}
		java.util.Set keys = org.jfree.chart.PaintMap.this.store.keySet();
	...
	private void writeObject(java.io.ObjectOutputStream stream) throws java.io.IOException {
		...
		stream.writeInt(org.jfree.chart.PaintMap.this.store.size());
		java.util.Set keys = org.jfree.chart.PaintMap.this.store.keySet();
		java.util.Iterator iterator = keys.iterator();
		while (iterator.hasNext()) {
			java.lang.Comparable key = ((java.lang.Comparable) (iterator.next()));
