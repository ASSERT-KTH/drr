...
public class Outlier implements java.lang.Comparable {
	...
	public boolean equals(java.lang.Object obj) {
		if (obj == (org.jfree.chart.renderer.Outlier.this)) {
			return true;
		}
		if (!(obj instanceof org.jfree.chart.renderer.Outlier)) {
			return false;
		}
		org.jfree.chart.renderer.Outlier that = ((org.jfree.chart.renderer.Outlier) (obj));
		if (!(org.jfree.chart.renderer.Outlier.this.point.equals(that.point))) {
			return false;
		}
		if ((org.jfree.chart.renderer.Outlier.this.radius) != (that.radius)) {
			return false;
		}
		return true;
	}
