...
public abstract class Series implements java.io.Serializable , java.lang.Cloneable {
	...
	public void addChangeListener(org.jfree.data.general.SeriesChangeListener listener) {
		org.jfree.data.general.Series.this.listeners.add(org.jfree.data.general.SeriesChangeListener.class, listener);
	}

	public void removeChangeListener(org.jfree.data.general.SeriesChangeListener listener) {
		org.jfree.data.general.Series.this.listeners.remove(org.jfree.data.general.SeriesChangeListener.class, listener);
	}
	...
	protected void notifyListeners(org.jfree.data.general.SeriesChangeEvent event) {
