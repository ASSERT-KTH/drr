...
public class KeyedObjects2D implements java.io.Serializable , java.lang.Cloneable {
	...
	public java.lang.Object getObject(java.lang.Comparable rowKey, java.lang.Comparable columnKey) {
		...
		int column = org.jfree.data.KeyedObjects2D.this.columnKeys.indexOf(columnKey);
		if (column < 0) {
	...
	public void removeObject(java.lang.Comparable rowKey, java.lang.Comparable columnKey) {
		...
		org.jfree.data.KeyedObjects row = ((org.jfree.data.KeyedObjects) (org.jfree.data.KeyedObjects2D.this.rows.get(rowIndex)));
		...
		allNull = true;
		for (int item = 0, itemCount = org.jfree.data.KeyedObjects2D.this.rows.size(); item < itemCount; item++) {
			row = ((org.jfree.data.KeyedObjects) (org.jfree.data.KeyedObjects2D.this.rows.get(item)));
	...
	public void clear() {
		org.jfree.data.KeyedObjects2D.this.rowKeys.clear();
		org.jfree.data.KeyedObjects2D.this.columnKeys.clear();
		org.jfree.data.KeyedObjects2D.this.rows.clear();
	}
	...
	public java.lang.Object clone() throws java.lang.CloneNotSupportedException {
		...
		clone.columnKeys = new java.util.ArrayList(org.jfree.data.KeyedObjects2D.this.columnKeys);
		clone.rowKeys = new java.util.ArrayList(org.jfree.data.KeyedObjects2D.this.rowKeys);
		clone.rows = new java.util.ArrayList(org.jfree.data.KeyedObjects2D.this.rows.size());
		java.util.Iterator iterator = org.jfree.data.KeyedObjects2D.this.rows.iterator();
		while (iterator.hasNext()) {
