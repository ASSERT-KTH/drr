...
public class XYSplineAndShapeRenderer extends org.jfree.chart.renderer.xy.XYLineAndShapeRenderer {
	...
	class ControlPoint {
		...
		public boolean equals(java.lang.Object obj) {
			if (obj == (org.jfree.chart.renderer.xy.XYSplineAndShapeRenderer.ControlPoint.this)) {
				return true;
			}
			if (!(obj instanceof org.jfree.chart.renderer.xy.XYSplineAndShapeRenderer.ControlPoint)) {
				return false;
			}
			org.jfree.chart.renderer.xy.XYSplineAndShapeRenderer.ControlPoint that = ((org.jfree.chart.renderer.xy.XYSplineAndShapeRenderer.ControlPoint) (obj));
			if ((org.jfree.chart.renderer.xy.XYSplineAndShapeRenderer.ControlPoint.this.x) != (that.x)) {
				return false;
			}
			return true;
		}
