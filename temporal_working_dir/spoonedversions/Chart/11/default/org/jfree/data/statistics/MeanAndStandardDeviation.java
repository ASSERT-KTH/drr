...
public class MeanAndStandardDeviation implements java.io.Serializable {
	...
	public double getMeanValue() {
		...
		if ((org.jfree.data.statistics.MeanAndStandardDeviation.this.mean) != null) {
			result = org.jfree.data.statistics.MeanAndStandardDeviation.this.mean.doubleValue();
		}
		return result;
	}
	...
	public double getStandardDeviationValue() {
		double result = java.lang.Double.NaN;
		if ((org.jfree.data.statistics.MeanAndStandardDeviation.this.standardDeviation) != null) {
			result = org.jfree.data.statistics.MeanAndStandardDeviation.this.standardDeviation.doubleValue();
		}
		return result;
	}
	...
	public java.lang.String toString() {
		return ((("[" + (org.jfree.data.statistics.MeanAndStandardDeviation.this.mean)) + ", ") + (org.jfree.data.statistics.MeanAndStandardDeviation.this.standardDeviation)) + "]";
	}
}
