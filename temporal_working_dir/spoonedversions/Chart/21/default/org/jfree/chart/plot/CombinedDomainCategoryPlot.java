...
public class CombinedDomainCategoryPlot extends org.jfree.chart.plot.CategoryPlot implements java.io.Serializable , java.lang.Cloneable , org.jfree.chart.event.PlotChangeListener , org.jfree.chart.plot.Zoomable , org.jfree.chart.util.PublicCloneable {
	...
	public CombinedDomainCategoryPlot(org.jfree.chart.axis.CategoryAxis domainAxis) {
		...
		org.jfree.chart.plot.CombinedDomainCategoryPlot.this.totalWeight = 0;
	...
	public void setGap(double gap) {
		...
		notifyListeners(new org.jfree.chart.event.PlotChangeEvent(org.jfree.chart.plot.CombinedDomainCategoryPlot.this));
	}
	...
	public void add(org.jfree.chart.plot.CategoryPlot subplot, int weight) {
		...
		org.jfree.chart.plot.CombinedDomainCategoryPlot.this.totalWeight += weight;
	...
	public void remove(org.jfree.chart.plot.CategoryPlot subplot) {
		...
		if (position != (-1)) {
			...
			org.jfree.chart.plot.CombinedDomainCategoryPlot.this.totalWeight -= subplot.getWeight();
	...
	protected org.jfree.chart.axis.AxisSpace calculateAxisSpace(java.awt.Graphics2D g2, java.awt.geom.Rectangle2D plotArea) {
		...
		for (int i = 0; i < n; i++) {
			...
			if (orientation == (org.jfree.chart.plot.PlotOrientation.HORIZONTAL)) {
				double w = (usableSize * (plot.getWeight())) / (org.jfree.chart.plot.CombinedDomainCategoryPlot.this.totalWeight);
				...
				if (orientation == (org.jfree.chart.plot.PlotOrientation.VERTICAL)) {
					double h = (usableSize * (plot.getWeight())) / (org.jfree.chart.plot.CombinedDomainCategoryPlot.this.totalWeight);
	...
	public void draw(java.awt.Graphics2D g2, java.awt.geom.Rectangle2D area, java.awt.geom.Point2D anchor, org.jfree.chart.plot.PlotState parentState, org.jfree.chart.plot.PlotRenderingInfo info) {
		...
		for (int i = 0; i < (org.jfree.chart.plot.CombinedDomainCategoryPlot.this.subplots.size()); i++) {
			...
			plot.draw(g2, org.jfree.chart.plot.CombinedDomainCategoryPlot.this.subplotAreas[i], null, parentState, subplotInfo);
		}
		if (info != null) {
	...
	public boolean equals(java.lang.Object obj) {
		...
		org.jfree.chart.plot.CombinedDomainCategoryPlot plot = ((org.jfree.chart.plot.CombinedDomainCategoryPlot) (obj));
		if (!(org.jfree.chart.util.ObjectUtilities.equal(org.jfree.chart.plot.CombinedDomainCategoryPlot.this.subplots, plot.subplots))) {
			return false;
		}
		if ((org.jfree.chart.plot.CombinedDomainCategoryPlot.this.totalWeight) != (plot.totalWeight)) {
			return false;
		}
		if ((org.jfree.chart.plot.CombinedDomainCategoryPlot.this.gap) != (plot.gap)) {
			return false;
		}
		return true;
	}
