...
public class WaterfallBarRenderer extends org.jfree.chart.renderer.category.BarRenderer implements java.io.Serializable , java.lang.Cloneable , org.jfree.chart.util.PublicCloneable {
	...
	public org.jfree.data.Range findRangeBounds(org.jfree.data.category.CategoryDataset dataset) {
		return org.jfree.data.general.DatasetUtilities.findCumulativeRangeBounds(dataset);
	}
	...
	public void setFirstBarPaint(java.awt.Paint paint) {
		...
		notifyListeners(new org.jfree.chart.event.RendererChangeEvent(org.jfree.chart.renderer.category.WaterfallBarRenderer.this));
	}
