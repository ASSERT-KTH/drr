...
public class LogAxis extends org.jfree.chart.axis.ValueAxis {
	...
	public LogAxis(java.lang.String label) {
		...
		org.jfree.chart.axis.LogAxis.this.minorTickCount = 10;
	}
	...
	protected java.util.List refreshTicksHorizontal(java.awt.Graphics2D g2, java.awt.geom.Rectangle2D dataArea, org.jfree.chart.util.RectangleEdge edge) {
		...
		while (current <= end) {
			...
			if (range.contains(v)) {
				ticks.add(new org.jfree.chart.axis.NumberTick(org.jfree.chart.axis.TickType.MAJOR, v, createTickLabel(v), org.jfree.chart.text.TextAnchor.TOP_CENTER, org.jfree.chart.text.TextAnchor.CENTER, 0.0));
			}
			...
			for (int i = 1; i < (org.jfree.chart.axis.LogAxis.this.minorTickCount); i++) {
				...
				if (range.contains(minorV)) {
					ticks.add(new org.jfree.chart.axis.NumberTick(org.jfree.chart.axis.TickType.MINOR, minorV, "", org.jfree.chart.text.TextAnchor.TOP_CENTER, org.jfree.chart.text.TextAnchor.CENTER, 0.0));
				}
			}
	...
	protected java.util.List refreshTicksVertical(java.awt.Graphics2D g2, java.awt.geom.Rectangle2D dataArea, org.jfree.chart.util.RectangleEdge edge) {
		...
		while (current <= end) {
			double v = calculateValue(current);
			if (range.contains(v)) {
				ticks.add(new org.jfree.chart.axis.NumberTick(org.jfree.chart.axis.TickType.MINOR, v, createTickLabel(v), org.jfree.chart.text.TextAnchor.CENTER_RIGHT, org.jfree.chart.text.TextAnchor.CENTER, 0.0));
			}
			double next = java.lang.Math.pow(org.jfree.chart.axis.LogAxis.this.base, (current + (org.jfree.chart.axis.LogAxis.this.tickUnit.getSize())));
			for (int i = 1; i < (org.jfree.chart.axis.LogAxis.this.minorTickCount); i++) {
				double minorV = v + (i * ((next - v) / (org.jfree.chart.axis.LogAxis.this.minorTickCount)));
				if (range.contains(minorV)) {
					ticks.add(new org.jfree.chart.axis.NumberTick(org.jfree.chart.axis.TickType.MINOR, minorV, "", org.jfree.chart.text.TextAnchor.CENTER_RIGHT, org.jfree.chart.text.TextAnchor.CENTER, 0.0));
				}
			}
			current = current + (org.jfree.chart.axis.LogAxis.this.tickUnit.getSize());
		} 
	...
	private java.lang.String createTickLabel(double value) {
