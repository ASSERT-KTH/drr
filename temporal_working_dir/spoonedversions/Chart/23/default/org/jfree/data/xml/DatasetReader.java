...
public class DatasetReader {
	public static org.jfree.data.general.PieDataset readPieDatasetFromXML(java.io.File file) throws java.io.IOException {
		java.io.InputStream in = new java.io.FileInputStream(file);
		return org.jfree.data.xml.DatasetReader.readPieDatasetFromXML(in);
	}

	public static org.jfree.data.general.PieDataset readPieDatasetFromXML(java.io.InputStream in) throws java.io.IOException {
		org.jfree.data.general.PieDataset result = null;
