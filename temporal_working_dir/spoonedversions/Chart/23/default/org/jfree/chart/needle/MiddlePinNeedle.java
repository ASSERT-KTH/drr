...
public class MiddlePinNeedle extends org.jfree.chart.needle.MeterNeedle implements java.io.Serializable , java.lang.Cloneable {
	...
	protected void drawNeedle(java.awt.Graphics2D g2, java.awt.geom.Rectangle2D plotArea, java.awt.geom.Point2D rotate, double angle) {
		...
		pointer.closePath();
		lenX = 4 * lenX;
		java.awt.geom.Ellipse2D circle = new java.awt.geom.Ellipse2D.Double((midX - (lenX / 2)), (midY - lenX), lenX, lenX);
	...
	public boolean equals(java.lang.Object object) {
		...
		if (object == (org.jfree.chart.needle.MiddlePinNeedle.this)) {
			return true;
		}
		if ((super.equals(object)) && (object instanceof org.jfree.chart.needle.MiddlePinNeedle)) {
			return true;
		}
		return false;
	}
