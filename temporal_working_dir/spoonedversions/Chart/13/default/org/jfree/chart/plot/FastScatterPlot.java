...
public class FastScatterPlot extends org.jfree.chart.plot.Plot implements java.io.Serializable , java.lang.Cloneable , org.jfree.chart.plot.ValueAxisPlot , org.jfree.chart.plot.Zoomable {
	...
	public void zoomDomainAxes(double factor, org.jfree.chart.plot.PlotRenderingInfo info, java.awt.geom.Point2D source, boolean useAnchor) {
		if (useAnchor) {
			...
			org.jfree.chart.plot.FastScatterPlot.this.domainAxis.resizeRange(factor, anchorX);
		}else {
			org.jfree.chart.plot.FastScatterPlot.this.domainAxis.resizeRange(factor);
		}
	}
	...
	public void zoomRangeAxes(double factor, org.jfree.chart.plot.PlotRenderingInfo info, java.awt.geom.Point2D source, boolean useAnchor) {
		if (useAnchor) {
			double sourceX = source.getX();
			double anchorX = org.jfree.chart.plot.FastScatterPlot.this.rangeAxis.java2DToValue(sourceX, info.getDataArea(), org.jfree.chart.util.RectangleEdge.LEFT);
			org.jfree.chart.plot.FastScatterPlot.this.rangeAxis.resizeRange(factor, anchorX);
		}else {
			org.jfree.chart.plot.FastScatterPlot.this.rangeAxis.resizeRange(factor);
		}
	}
