...
public class XYIntervalSeriesCollection extends org.jfree.data.xy.AbstractIntervalXYDataset implements java.io.Serializable , org.jfree.chart.util.PublicCloneable , org.jfree.data.xy.IntervalXYDataset {
	...
	public void removeSeries(int series) {
		...
		org.jfree.data.xy.XYIntervalSeries ts = ((org.jfree.data.xy.XYIntervalSeries) (org.jfree.data.xy.XYIntervalSeriesCollection.this.data.get(series)));
		ts.removeChangeListener(org.jfree.data.xy.XYIntervalSeriesCollection.this);
		org.jfree.data.xy.XYIntervalSeriesCollection.this.data.remove(series);
		fireDatasetChanged();
	}

	public void removeSeries(org.jfree.data.xy.XYIntervalSeries series) {
		if (series == null) {
			throw new java.lang.IllegalArgumentException("Null 'series' argument.");
		}
		if (org.jfree.data.xy.XYIntervalSeriesCollection.this.data.contains(series)) {
			series.removeChangeListener(org.jfree.data.xy.XYIntervalSeriesCollection.this);
			org.jfree.data.xy.XYIntervalSeriesCollection.this.data.remove(series);
			fireDatasetChanged();
		}
	}
	...
	public void removeAllSeries() {
		for (int i = 0; i < (org.jfree.data.xy.XYIntervalSeriesCollection.this.data.size()); i++) {
			org.jfree.data.xy.XYIntervalSeries series = ((org.jfree.data.xy.XYIntervalSeries) (org.jfree.data.xy.XYIntervalSeriesCollection.this.data.get(i)));
			series.removeChangeListener(org.jfree.data.xy.XYIntervalSeriesCollection.this);
		}
		org.jfree.data.xy.XYIntervalSeriesCollection.this.data.clear();
		fireDatasetChanged();
	}
