...
public class ChartPanel extends javax.swing.JPanel implements java.awt.event.ActionListener , java.awt.event.MouseListener , java.awt.event.MouseMotionListener , java.awt.print.Printable , java.io.Serializable , org.jfree.chart.event.ChartChangeListener , org.jfree.chart.event.ChartProgressListener {
	...
	private java.awt.geom.Point2D getPointInRectangle(int x, int y, java.awt.geom.Rectangle2D area) {
		double xx = java.lang.Math.max(area.getMinX(), java.lang.Math.min(x, area.getMaxX()));
		double yy = java.lang.Math.max(area.getMinY(), java.lang.Math.min(y, area.getMaxY()));
		return new java.awt.geom.Point2D.Double(xx, yy);
	}
			...
			if (zoomTrigger1 || zoomTrigger2) {
				if ((hZoom && ((e.getX()) < (org.jfree.chart.ChartPanel.this.zoomPoint.getX()))) || (vZoom && ((e.getY()) < (org.jfree.chart.ChartPanel.this.zoomPoint.getY())))) {
					...
					if (!vZoom) {
						...
						w = java.lang.Math.min(org.jfree.chart.ChartPanel.this.zoomRectangle.getWidth(), (maxX - (org.jfree.chart.ChartPanel.this.zoomPoint.getX())));
						...
						if (!hZoom) {
							...
							h = java.lang.Math.min(org.jfree.chart.ChartPanel.this.zoomRectangle.getHeight(), (maxY - (org.jfree.chart.ChartPanel.this.zoomPoint.getY())));
						}else {
							x = org.jfree.chart.ChartPanel.this.zoomPoint.getX();
							y = org.jfree.chart.ChartPanel.this.zoomPoint.getY();
							w = java.lang.Math.min(org.jfree.chart.ChartPanel.this.zoomRectangle.getWidth(), (maxX - (org.jfree.chart.ChartPanel.this.zoomPoint.getX())));
