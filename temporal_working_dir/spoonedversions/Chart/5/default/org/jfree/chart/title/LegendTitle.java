...
public class LegendTitle extends org.jfree.chart.title.Title implements java.io.Serializable , java.lang.Cloneable , org.jfree.chart.util.PublicCloneable {
	...
	public static final java.awt.Font DEFAULT_ITEM_FONT = new java.awt.Font("Tahoma", java.awt.Font.PLAIN, 12);
	...
	protected org.jfree.chart.block.Block createLegendItemBlock(org.jfree.chart.LegendItem item) {
		...
		java.awt.Font textFont = item.getLabelFont();
		if (textFont == null) {
			textFont = org.jfree.chart.title.LegendTitle.this.itemFont;
		}
		java.awt.Paint textPaint = item.getLabelPaint();
		if (textPaint == null) {
			textPaint = org.jfree.chart.title.LegendTitle.this.itemPaint;
		}
		org.jfree.chart.block.LabelBlock labelBlock = new org.jfree.chart.block.LabelBlock(item.getLabel(), textFont, textPaint);
	...
	public org.jfree.chart.block.BlockContainer getWrapper() {
		return org.jfree.chart.title.LegendTitle.this.wrapper;
	}
