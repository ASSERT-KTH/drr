...
public class StandardBarPainter implements java.io.Serializable , org.jfree.chart.renderer.category.BarPainter {
	public StandardBarPainter() {
	}

	public void paintBar(java.awt.Graphics2D g2, org.jfree.chart.renderer.category.BarRenderer renderer, int row, int column, java.awt.geom.RectangularShape bar, org.jfree.chart.util.RectangleEdge base) {
	...
	public void paintBarShadow(java.awt.Graphics2D g2, org.jfree.chart.renderer.category.BarRenderer renderer, int row, int column, java.awt.geom.RectangularShape bar, org.jfree.chart.util.RectangleEdge base, boolean pegShadow) {
		java.awt.Paint itemPaint = renderer.getItemPaint(row, column);
	...
	public boolean equals(java.lang.Object obj) {
		if (obj == (org.jfree.chart.renderer.category.StandardBarPainter.this)) {
			return true;
		}
		if (!(obj instanceof org.jfree.chart.renderer.category.StandardBarPainter)) {
			return false;
		}
		return true;
	}
