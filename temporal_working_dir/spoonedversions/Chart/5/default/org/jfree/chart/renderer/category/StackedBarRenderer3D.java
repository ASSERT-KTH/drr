...
public class StackedBarRenderer3D extends org.jfree.chart.renderer.category.BarRenderer3D implements java.io.Serializable , java.lang.Cloneable , org.jfree.chart.util.PublicCloneable {
	...
	protected java.util.List createStackedValueList(org.jfree.data.category.CategoryDataset dataset, java.lang.Comparable category, double base, boolean asPercentages) {
		...
		for (int s = 0; s < seriesCount; s++) {
			...
			if ((v > 0.0) || ((!(org.jfree.chart.renderer.category.StackedBarRenderer3D.this.ignoreZeroValues)) && (v >= 0.0))) {
				...
				if (v < 0.0) {
					...
					negBase = negBase + v;
					result.add(0, new java.lang.Object[]{ new java.lang.Integer(((-s) - 1)) , new java.lang.Double(negBase) });
					baseIndex++;
				}
	...
	public void drawItem(java.awt.Graphics2D g2, org.jfree.chart.renderer.category.CategoryItemRendererState state, java.awt.geom.Rectangle2D dataArea, org.jfree.chart.plot.CategoryPlot plot, org.jfree.chart.axis.CategoryAxis domainAxis, org.jfree.chart.axis.ValueAxis rangeAxis, org.jfree.data.category.CategoryDataset dataset, int row, int column, int pass) {
		...
		java.util.List values = createStackedValueList(dataset, dataset.getColumnKey(column), getBase(), org.jfree.chart.renderer.category.StackedBarRenderer3D.this.renderAsPercentages);
