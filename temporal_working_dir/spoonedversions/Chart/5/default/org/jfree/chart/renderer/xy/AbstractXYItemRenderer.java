...
public abstract class AbstractXYItemRenderer extends org.jfree.chart.renderer.AbstractRenderer implements java.io.Serializable , java.lang.Cloneable , org.jfree.chart.renderer.xy.XYItemRenderer {
	...
	protected void addEntity(org.jfree.chart.entity.EntityCollection entities, java.awt.Shape area, org.jfree.data.xy.XYDataset dataset, int series, int item, double entityX, double entityY) {
		...
		if (hotspot == null) {
			double w = (org.jfree.chart.renderer.xy.AbstractXYItemRenderer.this.defaultEntityRadius) * 2;
			if ((getPlot().getOrientation()) == (org.jfree.chart.plot.PlotOrientation.VERTICAL)) {
				hotspot = new java.awt.geom.Ellipse2D.Double((entityX - (org.jfree.chart.renderer.xy.AbstractXYItemRenderer.this.defaultEntityRadius)), (entityY - (org.jfree.chart.renderer.xy.AbstractXYItemRenderer.this.defaultEntityRadius)), w, w);
			}else {
				hotspot = new java.awt.geom.Ellipse2D.Double((entityY - (org.jfree.chart.renderer.xy.AbstractXYItemRenderer.this.defaultEntityRadius)), (entityX - (org.jfree.chart.renderer.xy.AbstractXYItemRenderer.this.defaultEntityRadius)), w, w);
			}
		}
