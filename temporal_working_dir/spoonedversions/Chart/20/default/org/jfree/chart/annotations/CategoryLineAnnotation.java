...
public class CategoryLineAnnotation implements java.io.Serializable , java.lang.Cloneable , org.jfree.chart.annotations.CategoryAnnotation {
	...
	public int hashCode() {
		...
		result = (37 * result) + ((int) (temp ^ (temp >>> 32)));
		result = (37 * result) + (org.jfree.chart.HashUtilities.hashCodeForPaint(org.jfree.chart.annotations.CategoryLineAnnotation.this.paint));
