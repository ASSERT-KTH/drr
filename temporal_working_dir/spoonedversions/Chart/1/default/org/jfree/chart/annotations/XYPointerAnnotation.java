...
public class XYPointerAnnotation extends org.jfree.chart.annotations.XYTextAnnotation implements java.io.Serializable , java.lang.Cloneable , org.jfree.chart.util.PublicCloneable {
	...
	public void draw(java.awt.Graphics2D g2, org.jfree.chart.plot.XYPlot plot, java.awt.geom.Rectangle2D dataArea, org.jfree.chart.axis.ValueAxis domainAxis, org.jfree.chart.axis.ValueAxis rangeAxis, int rendererIndex, org.jfree.chart.plot.PlotRenderingInfo info) {
		...
		java.awt.geom.Line2D line = new java.awt.geom.Line2D.Double(startX, startY, arrowBaseX, arrowBaseY);
		g2.draw(line);
		g2.fill(arrow);
		...
		g2.setFont(getFont());
		java.awt.Shape hotspot = org.jfree.chart.text.TextUtilities.calculateRotatedStringBounds(getText(), g2, ((float) (labelX)), ((float) (labelY)), getTextAnchor(), getRotationAngle(), getRotationAnchor());
		if ((getBackgroundPaint()) != null) {
			g2.setPaint(getBackgroundPaint());
			g2.fill(hotspot);
		}
		g2.setPaint(getPaint());
		org.jfree.chart.text.TextUtilities.drawRotatedString(getText(), g2, ((float) (labelX)), ((float) (labelY)), getTextAnchor(), getRotationAngle(), getRotationAnchor());
		if (isOutlineVisible()) {
	...
	public int hashCode() {
		...
		result = (37 * result) + ((int) (temp ^ (temp >>> 32)));
		result = (result * 37) + (org.jfree.chart.util.HashUtilities.hashCodeForPaint(org.jfree.chart.annotations.XYPointerAnnotation.this.arrowPaint));
