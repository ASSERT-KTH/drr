...
public class MultiplePiePlot extends org.jfree.chart.plot.Plot implements java.io.Serializable , java.lang.Cloneable {
	...
	public MultiplePiePlot(org.jfree.data.category.CategoryDataset dataset) {
		...
		org.jfree.chart.title.TextTitle seriesTitle = new org.jfree.chart.title.TextTitle("Series Title", new java.awt.Font("Tahoma", java.awt.Font.BOLD, 12));
		...
		org.jfree.chart.plot.MultiplePiePlot.this.legendItemShape = new java.awt.geom.Ellipse2D.Double((-4.0), (-4.0), 8.0, 8.0);
	}
	...
	public void setDataset(org.jfree.data.category.CategoryDataset dataset) {
		...
		datasetChanged(new org.jfree.data.event.DatasetChangeEvent(org.jfree.chart.plot.MultiplePiePlot.this, dataset, new org.jfree.chart.event.DatasetChangeInfo()));
	}
	...
	public java.awt.Shape getLegendItemShape() {
		return org.jfree.chart.plot.MultiplePiePlot.this.legendItemShape;
	}
	...
	public void setLegendItemShape(java.awt.Shape shape) {
		...
		org.jfree.chart.plot.MultiplePiePlot.this.legendItemShape = shape;
		fireChangeEvent();
	}
	...
	public void draw(java.awt.Graphics2D g2, java.awt.geom.Rectangle2D area, java.awt.geom.Point2D anchor, org.jfree.chart.plot.PlotState parentState, org.jfree.chart.plot.PlotRenderingInfo info) {
		...
		for (int pieIndex = 0; pieIndex < pieCount; pieIndex++) {
			...
			org.jfree.data.pie.PieDataset piedataset = null;
			org.jfree.data.pie.PieDataset dd = new org.jfree.data.category.CategoryToPieDataset(org.jfree.chart.plot.MultiplePiePlot.this.dataset, org.jfree.chart.plot.MultiplePiePlot.this.dataExtractOrder, pieIndex);
	...
	private void prefetchSectionPaints() {
		...
		if ((org.jfree.chart.plot.MultiplePiePlot.this.dataExtractOrder) == (org.jfree.chart.util.TableOrder.BY_ROW)) {
			for (int c = 0; c < (org.jfree.chart.plot.MultiplePiePlot.this.dataset.getColumnCount()); c++) {
				...
				java.awt.Paint p = piePlot.getSectionPaint(key, false);
				if (p == null) {
					p = ((java.awt.Paint) (org.jfree.chart.plot.MultiplePiePlot.this.sectionPaints.get(key)));
					if (p == null) {
	...
	public org.jfree.chart.LegendItemCollection getLegendItems() {
		...
		while (iterator.hasNext()) {
			...
			org.jfree.chart.LegendItem item = new org.jfree.chart.LegendItem(label, description, null, null, getLegendItemShape(), paint, org.jfree.chart.plot.Plot.DEFAULT_OUTLINE_STROKE, paint);
		...
		if ((org.jfree.chart.plot.MultiplePiePlot.this.limit) > 0.0) {
			org.jfree.chart.LegendItem a = new org.jfree.chart.LegendItem(org.jfree.chart.plot.MultiplePiePlot.this.aggregatedItemsKey.toString(), org.jfree.chart.plot.MultiplePiePlot.this.aggregatedItemsKey.toString(), null, null, getLegendItemShape(), org.jfree.chart.plot.MultiplePiePlot.this.aggregatedItemsPaint, org.jfree.chart.plot.Plot.DEFAULT_OUTLINE_STROKE, org.jfree.chart.plot.MultiplePiePlot.this.aggregatedItemsPaint);
			result.add(a);
		}
		return result;
	}
	...
	public boolean equals(java.lang.Object obj) {
		...
		if (!(org.jfree.chart.util.ShapeUtilities.equal(org.jfree.chart.plot.MultiplePiePlot.this.legendItemShape, that.legendItemShape))) {
			return false;
		}
		if (!(super.equals(obj))) {
			return false;
	...
	public java.lang.Object clone() throws java.lang.CloneNotSupportedException {
		org.jfree.chart.plot.MultiplePiePlot clone = ((org.jfree.chart.plot.MultiplePiePlot) (super.clone()));
		clone.pieChart = ((org.jfree.chart.JFreeChart) (org.jfree.chart.plot.MultiplePiePlot.this.pieChart.clone()));
		clone.sectionPaints = new java.util.HashMap(org.jfree.chart.plot.MultiplePiePlot.this.sectionPaints);
		clone.legendItemShape = org.jfree.chart.util.ShapeUtilities.clone(org.jfree.chart.plot.MultiplePiePlot.this.legendItemShape);
		return clone;
	}
	...
	private void writeObject(java.io.ObjectOutputStream stream) throws java.io.IOException {
		...
		org.jfree.chart.util.SerialUtilities.writeShape(org.jfree.chart.plot.MultiplePiePlot.this.legendItemShape, stream);
	}
	...
	private void readObject(java.io.ObjectInputStream stream) throws java.io.IOException, java.lang.ClassNotFoundException {
		...
		org.jfree.chart.plot.MultiplePiePlot.this.legendItemShape = org.jfree.chart.util.SerialUtilities.readShape(stream);
		org.jfree.chart.plot.MultiplePiePlot.this.sectionPaints = new java.util.HashMap();
	}
}
