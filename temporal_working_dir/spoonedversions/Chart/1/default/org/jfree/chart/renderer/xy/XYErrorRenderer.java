...
public class XYErrorRenderer extends org.jfree.chart.renderer.xy.XYLineAndShapeRenderer {
	...
	public XYErrorRenderer() {
		...
		org.jfree.chart.renderer.xy.XYErrorRenderer.this.errorStroke = null;
	...
	public java.awt.Stroke getErrorStroke() {
		return org.jfree.chart.renderer.xy.XYErrorRenderer.this.errorStroke;
	}

	public void setErrorStroke(java.awt.Stroke stroke) {
		org.jfree.chart.renderer.xy.XYErrorRenderer.this.errorStroke = stroke;
		fireChangeEvent();
	}
	...
	public void drawItem(java.awt.Graphics2D g2, org.jfree.chart.renderer.xy.XYItemRendererState state, java.awt.geom.Rectangle2D dataArea, org.jfree.chart.plot.XYPlot plot, org.jfree.chart.axis.ValueAxis domainAxis, org.jfree.chart.axis.ValueAxis rangeAxis, org.jfree.data.xy.XYDataset dataset, int series, int item, boolean selected, int pass) {
		if (((pass == 0) && (dataset instanceof org.jfree.data.xy.IntervalXYDataset)) && (getItemVisible(series, item))) {
			...
			if (org.jfree.chart.renderer.xy.XYErrorRenderer.this.drawXError) {
				...
				if ((org.jfree.chart.renderer.xy.XYErrorRenderer.this.errorStroke) != null) {
					g2.setStroke(org.jfree.chart.renderer.xy.XYErrorRenderer.this.errorStroke);
				}else {
	...
	public boolean equals(java.lang.Object obj) {
		...
		if (!(org.jfree.chart.util.ObjectUtilities.equal(org.jfree.chart.renderer.xy.XYErrorRenderer.this.errorStroke, that.errorStroke))) {
			return false;
		}
	...
	private void readObject(java.io.ObjectInputStream stream) throws java.io.IOException, java.lang.ClassNotFoundException {
		...
		org.jfree.chart.renderer.xy.XYErrorRenderer.this.errorStroke = org.jfree.chart.util.SerialUtilities.readStroke(stream);
	}
	...
	private void writeObject(java.io.ObjectOutputStream stream) throws java.io.IOException {
		...
		org.jfree.chart.util.SerialUtilities.writeStroke(org.jfree.chart.renderer.xy.XYErrorRenderer.this.errorStroke, stream);
	}
}
