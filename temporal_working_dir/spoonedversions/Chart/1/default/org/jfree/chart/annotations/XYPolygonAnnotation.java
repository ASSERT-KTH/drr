...
public class XYPolygonAnnotation extends org.jfree.chart.annotations.AbstractXYAnnotation implements java.io.Serializable , java.lang.Cloneable , org.jfree.chart.util.PublicCloneable {
	...
	public int hashCode() {
		int result = 193;
		result = (37 * result) + (org.jfree.chart.util.HashUtilities.hashCodeForDoubleArray(org.jfree.chart.annotations.XYPolygonAnnotation.this.polygon));
		result = (37 * result) + (org.jfree.chart.util.HashUtilities.hashCodeForPaint(org.jfree.chart.annotations.XYPolygonAnnotation.this.fillPaint));
		result = (37 * result) + (org.jfree.chart.util.HashUtilities.hashCodeForPaint(org.jfree.chart.annotations.XYPolygonAnnotation.this.outlinePaint));
