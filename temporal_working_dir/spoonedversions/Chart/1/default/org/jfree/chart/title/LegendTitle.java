...
public class LegendTitle extends org.jfree.chart.title.Title implements java.io.Serializable , java.lang.Cloneable , org.jfree.chart.util.PublicCloneable {
	...
	public java.lang.Object draw(java.awt.Graphics2D g2, java.awt.geom.Rectangle2D area, java.lang.Object params) {
		...
		java.awt.geom.Rectangle2D hotspot = ((java.awt.geom.Rectangle2D) (area.clone()));
		org.jfree.chart.entity.StandardEntityCollection sec = null;
		if ((params instanceof org.jfree.chart.block.EntityBlockParams) && (((org.jfree.chart.block.EntityBlockParams) (params)).getGenerateEntities())) {
			sec = new org.jfree.chart.entity.StandardEntityCollection();
			sec.add(new org.jfree.chart.entity.TitleEntity(hotspot, org.jfree.chart.title.LegendTitle.this));
		}
		...
		java.lang.Object val = container.draw(g2, target, params);
		if (val instanceof org.jfree.chart.block.BlockResult) {
			org.jfree.chart.entity.EntityCollection ec = ((org.jfree.chart.block.BlockResult) (val)).getEntityCollection();
			if ((ec != null) && (sec != null)) {
				sec.addAll(ec);
				((org.jfree.chart.block.BlockResult) (val)).setEntityCollection(sec);
			}
		}
		return val;
	}
