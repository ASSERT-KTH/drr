...
public class PieChartDemo1 extends org.jfree.chart.util.ApplicationFrame {
	...
	private static org.jfree.data.pie.PieDataset createDataset() {
		org.jfree.data.pie.DefaultPieDataset dataset = new org.jfree.data.pie.DefaultPieDataset();
	...
	private static org.jfree.chart.JFreeChart createChart(org.jfree.data.pie.PieDataset dataset) {
		org.jfree.chart.JFreeChart chart = org.jfree.chart.ChartFactory.createPieChart("Pie Chart Demo 1", dataset, true);
