...
public abstract class AbstractXYItemRenderer extends org.jfree.chart.renderer.AbstractRenderer implements java.io.Serializable , java.lang.Cloneable , org.jfree.chart.event.AnnotationChangeListener , org.jfree.chart.renderer.xy.XYItemRenderer {
	...
	protected org.jfree.chart.renderer.xy.XYItemRendererState createState(org.jfree.chart.plot.PlotRenderingInfo info) {
	...
	public org.jfree.chart.renderer.xy.XYItemRendererState initialise(java.awt.Graphics2D g2, java.awt.geom.Rectangle2D dataArea, org.jfree.chart.plot.XYPlot plot, org.jfree.data.xy.XYDataset dataset, org.jfree.chart.plot.PlotRenderingInfo info) {
		org.jfree.chart.renderer.xy.XYItemRendererState state = createState(info);
		org.jfree.data.xy.XYDatasetSelectionState selectionState = null;
		if (dataset instanceof org.jfree.data.xy.SelectableXYDataset) {
			org.jfree.data.xy.SelectableXYDataset sxyd = ((org.jfree.data.xy.SelectableXYDataset) (dataset));
		...
		if ((selectionState == null) && (info != null)) {
			...
			if (cri != null) {
				...
				selectionState = ((org.jfree.data.xy.XYDatasetSelectionState) (rs.getSelectionState(dataset)));
			}
		}
	...
	public void addAnnotation(org.jfree.chart.annotations.XYAnnotation annotation, org.jfree.chart.util.Layer layer) {
		...
		if (layer.equals(org.jfree.chart.util.Layer.FOREGROUND)) {
			...
			annotation.addChangeListener(org.jfree.chart.renderer.xy.AbstractXYItemRenderer.this);
			fireChangeEvent();
		}else
	...
	public boolean removeAnnotation(org.jfree.chart.annotations.XYAnnotation annotation) {
		...
		annotation.removeChangeListener(org.jfree.chart.renderer.xy.AbstractXYItemRenderer.this);
		fireChangeEvent();
		return removed;
	}

	public void removeAnnotations() {
		for (int i = 0; i < (org.jfree.chart.renderer.xy.AbstractXYItemRenderer.this.foregroundAnnotations.size()); i++) {
			org.jfree.chart.annotations.XYAnnotation annotation = ((org.jfree.chart.annotations.XYAnnotation) (org.jfree.chart.renderer.xy.AbstractXYItemRenderer.this.foregroundAnnotations.get(i)));
			annotation.removeChangeListener(org.jfree.chart.renderer.xy.AbstractXYItemRenderer.this);
		}
		for (int i = 0; i < (org.jfree.chart.renderer.xy.AbstractXYItemRenderer.this.backgroundAnnotations.size()); i++) {
			org.jfree.chart.annotations.XYAnnotation annotation = ((org.jfree.chart.annotations.XYAnnotation) (org.jfree.chart.renderer.xy.AbstractXYItemRenderer.this.backgroundAnnotations.get(i)));
			annotation.removeChangeListener(org.jfree.chart.renderer.xy.AbstractXYItemRenderer.this);
		}
	...
	public java.util.Collection getAnnotations() {
		java.util.List result = new java.util.ArrayList(org.jfree.chart.renderer.xy.AbstractXYItemRenderer.this.foregroundAnnotations);
		result.addAll(org.jfree.chart.renderer.xy.AbstractXYItemRenderer.this.backgroundAnnotations);
		return result;
	}
	...
	protected org.jfree.data.Range findRangeBounds(org.jfree.data.xy.XYDataset dataset, boolean includeInterval) {
		...
		if (getDataBoundsIncludesVisibleSeriesOnly()) {
			...
			if (p != null) {
				...
				int index = p.getIndexOf(org.jfree.chart.renderer.xy.AbstractXYItemRenderer.this);
				if (index >= 0) {
	...
	public java.awt.Shape createHotSpotShape(java.awt.Graphics2D g2, java.awt.geom.Rectangle2D dataArea, org.jfree.chart.plot.XYPlot plot, org.jfree.chart.axis.ValueAxis domainAxis, org.jfree.chart.axis.ValueAxis rangeAxis, org.jfree.data.xy.XYDataset dataset, int series, int item, org.jfree.chart.renderer.xy.XYItemRendererState state, boolean selected) {
		return createHotSpotBounds(g2, dataArea, plot, domainAxis, rangeAxis, dataset, series, item, selected, state, null);
	}

	public boolean hitTest(double xx, double yy, java.awt.Graphics2D g2, java.awt.geom.Rectangle2D dataArea, org.jfree.chart.plot.XYPlot plot, org.jfree.chart.axis.ValueAxis domainAxis, org.jfree.chart.axis.ValueAxis rangeAxis, org.jfree.data.xy.XYDataset dataset, int series, int item, org.jfree.chart.renderer.xy.XYItemRendererState state, boolean selected) {
		java.awt.geom.Rectangle2D bounds = createHotSpotBounds(g2, dataArea, plot, domainAxis, rangeAxis, dataset, series, item, selected, state, null);
		if (bounds == null) {
			return false;
		}
	...
	public void drawAnnotations(java.awt.Graphics2D g2, java.awt.geom.Rectangle2D dataArea, org.jfree.chart.axis.ValueAxis domainAxis, org.jfree.chart.axis.ValueAxis rangeAxis, org.jfree.chart.util.Layer layer, org.jfree.chart.plot.PlotRenderingInfo info) {
		...
		while (iterator.hasNext()) {
			...
			int index = org.jfree.chart.renderer.xy.AbstractXYItemRenderer.this.plot.getIndexOf(org.jfree.chart.renderer.xy.AbstractXYItemRenderer.this);
			annotation.draw(g2, org.jfree.chart.renderer.xy.AbstractXYItemRenderer.this.plot, dataArea, domainAxis, rangeAxis, index, info);
		} 
	}
