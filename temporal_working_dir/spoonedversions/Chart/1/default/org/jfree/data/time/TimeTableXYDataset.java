...
public class TimeTableXYDataset extends org.jfree.data.xy.AbstractIntervalXYDataset implements java.lang.Cloneable , org.jfree.chart.util.PublicCloneable , org.jfree.data.DomainInfo , org.jfree.data.xy.IntervalXYDataset , org.jfree.data.xy.TableXYDataset {
	...
	public void add(org.jfree.data.time.TimePeriod period, double y, java.lang.Comparable seriesName) {
		add(period, new java.lang.Double(y), seriesName, true);
	}

	public void add(org.jfree.data.time.TimePeriod period, java.lang.Number y, java.lang.Comparable seriesName, boolean notify) {
	...
	public void remove(org.jfree.data.time.TimePeriod period, java.lang.Comparable seriesName) {
		remove(period, seriesName, true);
	}

	public void remove(org.jfree.data.time.TimePeriod period, java.lang.Comparable seriesName, boolean notify) {
