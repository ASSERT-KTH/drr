...
public class TextBox implements java.io.Serializable {
	...
	public void draw(java.awt.Graphics2D g2, float x, float y, org.jfree.chart.util.RectangleAnchor anchor) {
		...
		if ((org.jfree.chart.text.TextBox.this.shadowPaint) != null) {
			java.awt.geom.Rectangle2D shadow = new java.awt.geom.Rectangle2D.Double(((bounds.getX()) + (org.jfree.chart.text.TextBox.this.shadowXOffset)), ((bounds.getY()) + (org.jfree.chart.text.TextBox.this.shadowYOffset)), bounds.getWidth(), bounds.getHeight());
