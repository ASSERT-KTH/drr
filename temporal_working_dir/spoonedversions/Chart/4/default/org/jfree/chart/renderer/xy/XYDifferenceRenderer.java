...
public class XYDifferenceRenderer extends org.jfree.chart.renderer.xy.AbstractXYItemRenderer implements org.jfree.chart.renderer.xy.XYItemRenderer , org.jfree.chart.util.PublicCloneable {
	...
	protected void drawItemPass0(java.awt.Graphics2D x_graphics, org.jfree.chart.renderer.xy.XYItemRendererState state, java.awt.geom.Rectangle2D x_dataArea, org.jfree.chart.plot.XYPlot x_plot, org.jfree.chart.axis.ValueAxis x_domainAxis, org.jfree.chart.axis.ValueAxis x_rangeAxis, org.jfree.data.xy.XYDataset x_dataset, int x_series, int x_item, boolean selected) {
	...
	protected void drawItemPass1(java.awt.Graphics2D x_graphics, org.jfree.chart.renderer.xy.XYItemRendererState state, java.awt.geom.Rectangle2D x_dataArea, org.jfree.chart.plot.XYPlot x_plot, org.jfree.chart.axis.ValueAxis x_domainAxis, org.jfree.chart.axis.ValueAxis x_rangeAxis, org.jfree.data.xy.XYDataset x_dataset, int x_series, int x_item, boolean selected) {
		...
		java.awt.Paint l_seriesPaint = getItemPaint(x_series, x_item, selected);
		java.awt.Stroke l_seriesStroke = getItemStroke(x_series, x_item, selected);
		...
		if (getShapesVisible()) {
			java.awt.Shape l_shape = getItemShape(x_series, x_item, selected);
		...
		if (null != l_entities) {
			...
			org.jfree.chart.labels.XYToolTipGenerator l_tipGenerator = getToolTipGenerator(x_series, x_item, selected);
			if (null != l_tipGenerator) {
				l_tip = l_tipGenerator.generateToolTip(x_dataset, x_series, x_item);
			}
			java.lang.String l_url = null;
			org.jfree.chart.urls.XYURLGenerator l_urlGenerator = getURLGenerator(x_series, x_item, selected);
