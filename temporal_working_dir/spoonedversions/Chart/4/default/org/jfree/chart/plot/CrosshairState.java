...
public class CrosshairState {
	...
	public void updateCrosshairPoint(double x, double y, double transX, double transY, org.jfree.chart.plot.PlotOrientation orientation) {
	...
	public int getDatasetIndex() {
		return org.jfree.chart.plot.CrosshairState.this.datasetIndex;
	}

	public void setDatasetIndex(int index) {
		org.jfree.chart.plot.CrosshairState.this.datasetIndex = index;
	}
