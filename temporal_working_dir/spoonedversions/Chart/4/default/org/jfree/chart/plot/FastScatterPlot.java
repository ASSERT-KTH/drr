...
public class FastScatterPlot extends org.jfree.chart.plot.Plot implements java.io.Serializable , java.lang.Cloneable , org.jfree.chart.plot.Pannable , org.jfree.chart.plot.ValueAxisPlot , org.jfree.chart.plot.Zoomable {
	...
	public void zoomDomainAxes(double factor, org.jfree.chart.plot.PlotRenderingInfo info, java.awt.geom.Point2D source, boolean useAnchor) {
		if (useAnchor) {
			...
			double anchorX = org.jfree.chart.plot.FastScatterPlot.this.domainAxis.java2DToValue(sourceX, info.getDataArea(), org.jfree.chart.util.RectangleEdge.BOTTOM);
			org.jfree.chart.plot.FastScatterPlot.this.domainAxis.resizeRange2(factor, anchorX);
		}else {
			org.jfree.chart.plot.FastScatterPlot.this.domainAxis.resizeRange(factor);
		}
	}
	...
	public void zoomRangeAxes(double factor, org.jfree.chart.plot.PlotRenderingInfo info, java.awt.geom.Point2D source, boolean useAnchor) {
		if (useAnchor) {
			...
			double anchorY = org.jfree.chart.plot.FastScatterPlot.this.rangeAxis.java2DToValue(sourceY, info.getDataArea(), org.jfree.chart.util.RectangleEdge.LEFT);
			org.jfree.chart.plot.FastScatterPlot.this.rangeAxis.resizeRange2(factor, anchorY);
		}else {
			org.jfree.chart.plot.FastScatterPlot.this.rangeAxis.resizeRange(factor);
		}
	}
	...
	public boolean isDomainPannable() {
		return org.jfree.chart.plot.FastScatterPlot.this.domainPannable;
	}

	public void setDomainPannable(boolean pannable) {
		org.jfree.chart.plot.FastScatterPlot.this.domainPannable = pannable;
	}

	public boolean isRangePannable() {
		return org.jfree.chart.plot.FastScatterPlot.this.rangePannable;
	}

	public void setRangePannable(boolean pannable) {
		org.jfree.chart.plot.FastScatterPlot.this.rangePannable = pannable;
	}

	public void panDomainAxes(double percent, org.jfree.chart.plot.PlotRenderingInfo info, java.awt.geom.Point2D source) {
		if ((!(isDomainPannable())) || ((org.jfree.chart.plot.FastScatterPlot.this.domainAxis) == null)) {
			return ;
		}
		double length = org.jfree.chart.plot.FastScatterPlot.this.domainAxis.getRange().getLength();
		double adj = (-percent) * length;
		if (org.jfree.chart.plot.FastScatterPlot.this.domainAxis.isInverted()) {
			adj = -adj;
		}
		org.jfree.chart.plot.FastScatterPlot.this.domainAxis.setRange(((org.jfree.chart.plot.FastScatterPlot.this.domainAxis.getLowerBound()) + adj), ((org.jfree.chart.plot.FastScatterPlot.this.domainAxis.getUpperBound()) + adj));
	}

	public void panRangeAxes(double percent, org.jfree.chart.plot.PlotRenderingInfo info, java.awt.geom.Point2D source) {
		if ((!(isRangePannable())) || ((org.jfree.chart.plot.FastScatterPlot.this.rangeAxis) == null)) {
			return ;
		}
		double length = org.jfree.chart.plot.FastScatterPlot.this.rangeAxis.getRange().getLength();
		double adj = percent * length;
		if (org.jfree.chart.plot.FastScatterPlot.this.rangeAxis.isInverted()) {
			adj = -adj;
		}
		org.jfree.chart.plot.FastScatterPlot.this.rangeAxis.setRange(((org.jfree.chart.plot.FastScatterPlot.this.rangeAxis.getLowerBound()) + adj), ((org.jfree.chart.plot.FastScatterPlot.this.rangeAxis.getUpperBound()) + adj));
	}
	...
	public boolean equals(java.lang.Object obj) {
		...
		if ((org.jfree.chart.plot.FastScatterPlot.this.domainPannable) != (that.domainPannable)) {
			return false;
		}
		if ((org.jfree.chart.plot.FastScatterPlot.this.rangePannable) != (that.rangePannable)) {
			return false;
		}
