...
public interface XYItemRenderer extends org.jfree.chart.LegendItemSource {
	...
	public org.jfree.chart.labels.XYToolTipGenerator getToolTipGenerator(int row, int column, boolean selected);
	...
	public org.jfree.chart.labels.XYItemLabelGenerator getItemLabelGenerator(int row, int column, boolean selected);
