...
public class StandardChartTheme implements java.io.Serializable , java.lang.Cloneable , org.jfree.chart.ChartTheme , org.jfree.chart.util.PublicCloneable {
	...
	public static org.jfree.chart.ChartTheme createDarknessTheme() {
		...
		theme.baselinePaint = java.awt.Color.white;
	...
	public StandardChartTheme(java.lang.String name) {
		...
		org.jfree.chart.StandardChartTheme.this.baselinePaint = java.awt.Color.black;
	...
	public java.awt.Font getSmallFont() {
		return org.jfree.chart.StandardChartTheme.this.smallFont;
	}
	...
	public void setSmallFont(java.awt.Font font) {
		...
		org.jfree.chart.StandardChartTheme.this.smallFont = font;
	}
	...
	public java.awt.Paint getBaselinePaint() {
		return org.jfree.chart.StandardChartTheme.this.baselinePaint;
	}
	...
	public void setBaselinePaint(java.awt.Paint paint) {
		...
		org.jfree.chart.StandardChartTheme.this.baselinePaint = paint;
	}
	...
	protected void applyToCategoryPlot(org.jfree.chart.plot.CategoryPlot plot) {
		...
		plot.setRangeZeroBaselinePaint(org.jfree.chart.StandardChartTheme.this.baselinePaint);
		int domainAxisCount = plot.getDomainAxisCount();
		for (int i = 0; i < domainAxisCount; i++) {
			org.jfree.chart.axis.CategoryAxis axis = plot.getDomainAxis(i);
			if (axis != null) {
	...
	protected void applyToXYPlot(org.jfree.chart.plot.XYPlot plot) {
		plot.setAxisOffset(org.jfree.chart.StandardChartTheme.this.axisOffset);
		plot.setDomainZeroBaselinePaint(org.jfree.chart.StandardChartTheme.this.baselinePaint);
		plot.setRangeZeroBaselinePaint(org.jfree.chart.StandardChartTheme.this.baselinePaint);
		plot.setDomainGridlinePaint(org.jfree.chart.StandardChartTheme.this.domainGridlinePaint);
		plot.setRangeGridlinePaint(org.jfree.chart.StandardChartTheme.this.rangeGridlinePaint);
		...
		int domainAxisCount = plot.getDomainAxisCount();
		for (int i = 0; i < domainAxisCount; i++) {
			org.jfree.chart.axis.ValueAxis axis = plot.getDomainAxis(i);
			if (axis != null) {
				applyToValueAxis(axis);
			}
		}
	...
	private void writeObject(java.io.ObjectOutputStream stream) throws java.io.IOException {
		...
		org.jfree.chart.util.SerialUtilities.writePaint(org.jfree.chart.StandardChartTheme.this.baselinePaint, stream);
	...
	private void readObject(java.io.ObjectInputStream stream) throws java.io.IOException, java.lang.ClassNotFoundException {
		...
		org.jfree.chart.StandardChartTheme.this.baselinePaint = org.jfree.chart.util.SerialUtilities.readPaint(stream);
