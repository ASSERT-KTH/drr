...
public abstract class ChartFactory {
	private static org.jfree.chart.ChartTheme currentTheme = new org.jfree.chart.StandardChartTheme("JFree");

	public static org.jfree.chart.ChartTheme getChartTheme() {
		return org.jfree.chart.ChartFactory.currentTheme;
	}

	public static void setChartTheme(org.jfree.chart.ChartTheme theme) {
		if (theme == null) {
			throw new java.lang.IllegalArgumentException("Null 'theme' argument.");
		}
		org.jfree.chart.ChartFactory.currentTheme = theme;
		if (theme instanceof org.jfree.chart.StandardChartTheme) {
			org.jfree.chart.StandardChartTheme sct = ((org.jfree.chart.StandardChartTheme) (theme));
			if (sct.getName().equals("Legacy")) {
				org.jfree.chart.renderer.category.BarRenderer.setDefaultBarPainter(new org.jfree.chart.renderer.category.StandardBarPainter());
				org.jfree.chart.renderer.xy.XYBarRenderer.setDefaultBarPainter(new org.jfree.chart.renderer.xy.StandardXYBarPainter());
			}else {
				org.jfree.chart.renderer.category.BarRenderer.setDefaultBarPainter(new org.jfree.chart.renderer.category.GradientBarPainter());
				org.jfree.chart.renderer.xy.XYBarRenderer.setDefaultBarPainter(new org.jfree.chart.renderer.xy.GradientXYBarPainter());
			}
		}
	}
	...
	public static org.jfree.chart.JFreeChart createPieChart(java.lang.String title, org.jfree.data.general.PieDataset dataset, boolean legend, boolean tooltips, java.util.Locale locale) {
		...
		org.jfree.chart.ChartFactory.currentTheme.apply(chart);
		return chart;
	}
	...
	public static org.jfree.chart.JFreeChart createPieChart(java.lang.String title, org.jfree.data.general.PieDataset dataset, org.jfree.data.general.PieDataset previousDataset, int percentDiffForMaxScale, boolean greenForIncrease, boolean legend, boolean tooltips, java.util.Locale locale, boolean subTitle, boolean showDifference) {
		...
		if (subTitle) {
			...
			subtitle = new org.jfree.chart.title.TextTitle((((((((("Bright " + (greenForIncrease ? "red" : "green")) + "=change >=-") + percentDiffForMaxScale) + "%, Bright ") + (!greenForIncrease ? "red" : "green")) + "=change >=+") + percentDiffForMaxScale) + "%"), new java.awt.Font("Tahoma", java.awt.Font.PLAIN, 10));
