...
public class DialValueIndicator extends org.jfree.chart.plot.dial.AbstractDialLayer implements java.io.Serializable , java.lang.Cloneable , org.jfree.chart.plot.dial.DialLayer , org.jfree.chart.util.PublicCloneable {
	...
	public DialValueIndicator(int datasetIndex) {
		...
		org.jfree.chart.plot.dial.DialValueIndicator.this.maxTemplateValue = null;
		org.jfree.chart.plot.dial.DialValueIndicator.this.formatter = new java.text.DecimalFormat("0.0");
		org.jfree.chart.plot.dial.DialValueIndicator.this.font = new java.awt.Font("Tahoma", java.awt.Font.BOLD, 14);
	...
	public java.lang.Number getMaxTemplateValue() {
		return org.jfree.chart.plot.dial.DialValueIndicator.this.maxTemplateValue;
	}

	public void setMaxTemplateValue(java.lang.Number value) {
		org.jfree.chart.plot.dial.DialValueIndicator.this.maxTemplateValue = value;
		notifyListeners(new org.jfree.chart.plot.dial.DialLayerChangeEvent(org.jfree.chart.plot.dial.DialValueIndicator.this));
	}
	...
	public void draw(java.awt.Graphics2D g2, org.jfree.chart.plot.dial.DialPlot plot, java.awt.geom.Rectangle2D frame, java.awt.geom.Rectangle2D view) {
		...
		java.awt.geom.Rectangle2D valueBounds = org.jfree.chart.text.TextUtilities.getTextBounds(valueStr, g2, fm);
		...
		double maxW = java.lang.Double.MAX_VALUE;
		double maxH = java.lang.Double.MAX_VALUE;
		if ((org.jfree.chart.plot.dial.DialValueIndicator.this.maxTemplateValue) != null) {
			s = org.jfree.chart.plot.dial.DialValueIndicator.this.formatter.format(org.jfree.chart.plot.dial.DialValueIndicator.this.maxTemplateValue);
			tb = org.jfree.chart.text.TextUtilities.getTextBounds(s, g2, fm);
			maxW = java.lang.Math.max(tb.getWidth(), minW);
			maxH = java.lang.Math.max(tb.getHeight(), minH);
		}
		double w = fixToRange(valueBounds.getWidth(), minW, maxW);
		double h = fixToRange(valueBounds.getHeight(), minH, maxH);
		java.awt.geom.Rectangle2D bounds = org.jfree.chart.util.RectangleAnchor.createRectangle(new org.jfree.chart.util.Size2D(w, h), pt.getX(), pt.getY(), org.jfree.chart.plot.dial.DialValueIndicator.this.frameAnchor);
	...
	private double fixToRange(double x, double minX, double maxX) {
		if (minX > maxX) {
			throw new java.lang.IllegalArgumentException("Requires 'minX' <= 'maxX'.");
		}
		if (x < minX) {
			return minX;
		}else
	...
	public boolean equals(java.lang.Object obj) {
		...
		if (!(org.jfree.chart.util.ObjectUtilities.equal(org.jfree.chart.plot.dial.DialValueIndicator.this.maxTemplateValue, that.maxTemplateValue))) {
			return false;
		}
