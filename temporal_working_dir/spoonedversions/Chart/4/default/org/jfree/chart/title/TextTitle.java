...
public class TextTitle extends org.jfree.chart.title.Title implements java.io.Serializable , java.lang.Cloneable , org.jfree.chart.util.PublicCloneable {
	...
	public static final java.awt.Font DEFAULT_FONT = new java.awt.Font("Tahoma", java.awt.Font.BOLD, 12);
	...
	private int maximumLinesToDisplay = java.lang.Integer.MAX_VALUE;
	...
	public int getMaximumLinesToDisplay() {
		return org.jfree.chart.title.TextTitle.this.maximumLinesToDisplay;
	}

	public void setMaximumLinesToDisplay(int max) {
		org.jfree.chart.title.TextTitle.this.maximumLinesToDisplay = max;
		notifyListeners(new org.jfree.chart.event.TitleChangeEvent(org.jfree.chart.title.TextTitle.this));
	}
	...
	protected org.jfree.chart.util.Size2D arrangeFN(java.awt.Graphics2D g2, double w) {
		...
		if ((position == (org.jfree.chart.util.RectangleEdge.TOP)) || (position == (org.jfree.chart.util.RectangleEdge.BOTTOM))) {
			...
			org.jfree.chart.title.TextTitle.this.content = org.jfree.chart.text.TextUtilities.createTextBlock(org.jfree.chart.title.TextTitle.this.text, org.jfree.chart.title.TextTitle.this.font, org.jfree.chart.title.TextTitle.this.paint, maxWidth, org.jfree.chart.title.TextTitle.this.maximumLinesToDisplay, new org.jfree.chart.text.G2TextMeasurer(g2));
			...
			if ((position == (org.jfree.chart.util.RectangleEdge.LEFT)) || (position == (org.jfree.chart.util.RectangleEdge.RIGHT))) {
				float maxWidth = java.lang.Float.MAX_VALUE;
				g2.setFont(org.jfree.chart.title.TextTitle.this.font);
				org.jfree.chart.title.TextTitle.this.content = org.jfree.chart.text.TextUtilities.createTextBlock(org.jfree.chart.title.TextTitle.this.text, org.jfree.chart.title.TextTitle.this.font, org.jfree.chart.title.TextTitle.this.paint, maxWidth, org.jfree.chart.title.TextTitle.this.maximumLinesToDisplay, new org.jfree.chart.text.G2TextMeasurer(g2));
				org.jfree.chart.title.TextTitle.this.content.setLineAlignment(org.jfree.chart.title.TextTitle.this.textAlignment);
				org.jfree.chart.util.Size2D contentSize = org.jfree.chart.title.TextTitle.this.content.calculateDimensions(g2);
	...
	public java.lang.Object draw(java.awt.Graphics2D g2, java.awt.geom.Rectangle2D area, java.lang.Object params) {
		...
		if (params instanceof org.jfree.chart.block.EntityBlockParams) {
			...
			if (p.getGenerateEntities()) {
				entity = new org.jfree.chart.entity.TitleEntity(area, org.jfree.chart.title.TextTitle.this, org.jfree.chart.title.TextTitle.this.toolTipText, org.jfree.chart.title.TextTitle.this.urlText);
			}
		}
	...
	public boolean equals(java.lang.Object obj) {
		...
		if ((org.jfree.chart.title.TextTitle.this.maximumLinesToDisplay) != (that.maximumLinesToDisplay)) {
			return false;
		}
		if ((org.jfree.chart.title.TextTitle.this.expandToFitSpace) != (that.expandToFitSpace)) {
			return false;
		}
		if (!(org.jfree.chart.util.ObjectUtilities.equal(org.jfree.chart.title.TextTitle.this.toolTipText, that.toolTipText))) {
			return false;
		}
		if (!(org.jfree.chart.util.ObjectUtilities.equal(org.jfree.chart.title.TextTitle.this.urlText, that.urlText))) {
			return false;
		}
