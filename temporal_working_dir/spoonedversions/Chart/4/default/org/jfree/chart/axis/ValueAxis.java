...
public abstract class ValueAxis extends org.jfree.chart.axis.Axis implements java.io.Serializable , java.lang.Cloneable , org.jfree.chart.util.PublicCloneable {
	...
	protected ValueAxis(java.lang.String label, org.jfree.chart.axis.TickUnitSource standardTickUnits) {
		...
		org.jfree.chart.axis.ValueAxis.this.minorTickCount = 0;
	}
	...
	protected org.jfree.chart.axis.AxisState drawTickMarksAndLabels(java.awt.Graphics2D g2, double cursor, java.awt.geom.Rectangle2D plotArea, java.awt.geom.Rectangle2D dataArea, org.jfree.chart.util.RectangleEdge edge, org.jfree.chart.plot.PlotRenderingInfo info) {
		...
		while (iterator.hasNext()) {
			...
			if (((isTickMarksVisible()) && (tick.getTickType().equals(org.jfree.chart.axis.TickType.MAJOR))) || ((isMinorTickMarksVisible()) && (tick.getTickType().equals(org.jfree.chart.axis.TickType.MINOR)))) {
				double ol = tick.getTickType().equals(org.jfree.chart.axis.TickType.MINOR) ? getMinorTickMarkOutsideLength() : getTickMarkOutsideLength();
				double il = tick.getTickType().equals(org.jfree.chart.axis.TickType.MINOR) ? getMinorTickMarkInsideLength() : getTickMarkInsideLength();
	...
	public int getMinorTickCount() {
		return org.jfree.chart.axis.ValueAxis.this.minorTickCount;
	}

	public void setMinorTickCount(int count) {
		org.jfree.chart.axis.ValueAxis.this.minorTickCount = count;
		notifyListeners(new org.jfree.chart.event.AxisChangeEvent(org.jfree.chart.axis.ValueAxis.this));
	}
	...
	public void resizeRange2(double percent, double anchorValue) {
		if (percent > 0.0) {
			...
			org.jfree.data.Range adjusted = new org.jfree.data.Range((anchorValue - (left * percent)), (anchorValue + (right * percent)));
			setRange(adjusted);
		}else {
			setAutoRange(true);
		}
	...
	public boolean equals(java.lang.Object obj) {
		...
		if ((!(org.jfree.chart.axis.ValueAxis.this.autoRange)) && (!(org.jfree.chart.util.ObjectUtilities.equal(org.jfree.chart.axis.ValueAxis.this.range, that.range)))) {
			return false;
		}
		...
		if ((org.jfree.chart.axis.ValueAxis.this.minorTickCount) != (that.minorTickCount)) {
			return false;
		}
