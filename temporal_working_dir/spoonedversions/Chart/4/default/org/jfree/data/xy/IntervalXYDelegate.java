...
public class IntervalXYDelegate implements java.io.Serializable , java.lang.Cloneable , org.jfree.chart.util.PublicCloneable , org.jfree.data.DomainInfo , org.jfree.data.general.DatasetChangeListener {
	...
	public int hashCode() {
		int hash = 5;
		hash = org.jfree.chart.util.HashUtilities.hashCode(hash, org.jfree.data.xy.IntervalXYDelegate.this.autoWidth);
		hash = org.jfree.chart.util.HashUtilities.hashCode(hash, org.jfree.data.xy.IntervalXYDelegate.this.intervalPositionFactor);
		hash = org.jfree.chart.util.HashUtilities.hashCode(hash, org.jfree.data.xy.IntervalXYDelegate.this.fixedIntervalWidth);
		return hash;
	}
}
