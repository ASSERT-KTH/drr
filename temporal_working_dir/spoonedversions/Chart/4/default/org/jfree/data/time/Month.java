...
public class Month extends org.jfree.data.time.RegularTimePeriod implements java.io.Serializable {
	...
	public boolean equals(java.lang.Object obj) {
		if (obj == (org.jfree.data.time.Month.this)) {
			return true;
		}
		if (!(obj instanceof org.jfree.data.time.Month)) {
			return false;
		}
		org.jfree.data.time.Month that = ((org.jfree.data.time.Month) (obj));
		if ((org.jfree.data.time.Month.this.month) != (that.month)) {
			return false;
		}
		if ((org.jfree.data.time.Month.this.year) != (that.year)) {
			return false;
		}
		return true;
	}
