...
public class OHLCSeriesCollection extends org.jfree.data.xy.AbstractXYDataset implements java.io.Serializable , org.jfree.data.xy.OHLCDataset {
	...
	public org.jfree.data.time.TimePeriodAnchor getXPosition() {
		return org.jfree.data.time.ohlc.OHLCSeriesCollection.this.xPosition;
	}
	...
	public void setXPosition(org.jfree.data.time.TimePeriodAnchor anchor) {
		...
		org.jfree.data.time.ohlc.OHLCSeriesCollection.this.xPosition = anchor;
		notifyListeners(new org.jfree.data.general.DatasetChangeEvent(org.jfree.data.time.ohlc.OHLCSeriesCollection.this, org.jfree.data.time.ohlc.OHLCSeriesCollection.this));
	}
	...
	public void removeSeries(int index) {
		org.jfree.data.time.ohlc.OHLCSeries series = getSeries(index);
		if (series != null) {
			removeSeries(series);
		}
	}

	public boolean removeSeries(org.jfree.data.time.ohlc.OHLCSeries series) {
		if (series == null) {
			throw new java.lang.IllegalArgumentException("Null 'series' argument.");
		}
		boolean removed = org.jfree.data.time.ohlc.OHLCSeriesCollection.this.data.remove(series);
		if (removed) {
			series.removeChangeListener(org.jfree.data.time.ohlc.OHLCSeriesCollection.this);
			fireDatasetChanged();
		}
		return removed;
	}
	...
	public void removeAllSeries() {
		if ((org.jfree.data.time.ohlc.OHLCSeriesCollection.this.data.size()) == 0) {
			return ;
		}
		for (int i = 0; i < (org.jfree.data.time.ohlc.OHLCSeriesCollection.this.data.size()); i++) {
			org.jfree.data.time.ohlc.OHLCSeries series = ((org.jfree.data.time.ohlc.OHLCSeries) (org.jfree.data.time.ohlc.OHLCSeriesCollection.this.data.get(i)));
			series.removeChangeListener(org.jfree.data.time.ohlc.OHLCSeriesCollection.this);
		}
		org.jfree.data.time.ohlc.OHLCSeriesCollection.this.data.clear();
		fireDatasetChanged();
	}
	...
	public boolean equals(java.lang.Object obj) {
		...
		if (!(org.jfree.data.time.ohlc.OHLCSeriesCollection.this.xPosition.equals(that.xPosition))) {
			return false;
		}
	...
	public int hashCode() {
		int result = 137;
		result = org.jfree.chart.util.HashUtilities.hashCode(result, org.jfree.data.time.ohlc.OHLCSeriesCollection.this.xPosition);
		for (int i = 0; i < (org.jfree.data.time.ohlc.OHLCSeriesCollection.this.data.size()); i++) {
			result = org.jfree.chart.util.HashUtilities.hashCode(result, org.jfree.data.time.ohlc.OHLCSeriesCollection.this.data.get(i));
		}
		return result;
	}
