...
public class StrokeMap implements java.io.Serializable , java.lang.Cloneable {
	...
	public StrokeMap() {
		org.jfree.chart.StrokeMap.this.store = new java.util.TreeMap();
	}
	...
	public java.awt.Stroke getStroke(java.lang.Comparable key) {
		...
		return ((java.awt.Stroke) (org.jfree.chart.StrokeMap.this.store.get(key)));
	}

	public boolean containsKey(java.lang.Comparable key) {
		return org.jfree.chart.StrokeMap.this.store.containsKey(key);
	}
	...
	public void put(java.lang.Comparable key, java.awt.Stroke stroke) {
		...
		org.jfree.chart.StrokeMap.this.store.put(key, stroke);
	}

	public void clear() {
		org.jfree.chart.StrokeMap.this.store.clear();
	}

	public boolean equals(java.lang.Object obj) {
		if (obj == (org.jfree.chart.StrokeMap.this)) {
			return true;
		}
		if (!(obj instanceof org.jfree.chart.StrokeMap)) {
			return false;
		}
		org.jfree.chart.StrokeMap that = ((org.jfree.chart.StrokeMap) (obj));
		if ((org.jfree.chart.StrokeMap.this.store.size()) != (that.store.size())) {
			return false;
		}
		java.util.Set keys = org.jfree.chart.StrokeMap.this.store.keySet();
	...
	private void writeObject(java.io.ObjectOutputStream stream) throws java.io.IOException {
		...
		stream.writeInt(org.jfree.chart.StrokeMap.this.store.size());
		java.util.Set keys = org.jfree.chart.StrokeMap.this.store.keySet();
		java.util.Iterator iterator = keys.iterator();
		while (iterator.hasNext()) {
			java.lang.Comparable key = ((java.lang.Comparable) (iterator.next()));
