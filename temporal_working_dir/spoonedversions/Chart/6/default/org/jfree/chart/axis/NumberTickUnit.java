...
public class NumberTickUnit extends org.jfree.chart.axis.TickUnit implements java.io.Serializable {
	...
	public NumberTickUnit(double size, java.text.NumberFormat formatter, int minorTickCount) {
	...
	public java.lang.String toString() {
		return ("[size=" + (org.jfree.chart.axis.NumberTickUnit.this.valueToString(org.jfree.chart.axis.NumberTickUnit.this.getSize()))) + "]";
	}
