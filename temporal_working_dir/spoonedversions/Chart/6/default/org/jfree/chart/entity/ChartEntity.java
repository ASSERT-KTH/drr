...
public class ChartEntity implements java.io.Serializable , java.lang.Cloneable , org.jfree.chart.util.PublicCloneable {
	...
	public java.lang.String getImageMapAreaTag(org.jfree.chart.imagemap.ToolTipTagFragmentGenerator toolTipTagFragmentGenerator, org.jfree.chart.imagemap.URLTagFragmentGenerator urlTagFragmentGenerator) {
		...
		if (hasURL || hasToolTip) {
			...
			if (hasToolTip) {
				tag.append(toolTipTagFragmentGenerator.generateToolTipFragment(org.jfree.chart.imagemap.ImageMapUtilities.htmlEscape(org.jfree.chart.entity.ChartEntity.this.toolTipText)));
			}
			if (hasURL) {
				tag.append(urlTagFragmentGenerator.generateURLFragment(org.jfree.chart.imagemap.ImageMapUtilities.htmlEscape(org.jfree.chart.entity.ChartEntity.this.urlText)));
			}else {
	...
	public int hashCode() {
		int result = 37;
		result = org.jfree.chart.util.HashUtilities.hashCode(result, org.jfree.chart.entity.ChartEntity.this.toolTipText);
		result = org.jfree.chart.util.HashUtilities.hashCode(result, org.jfree.chart.entity.ChartEntity.this.urlText);
		return result;
	}
