	...
	public int compareTo(java.lang.Object obj) {
		...
		if (obj instanceof org.jfree.data.time.Millisecond) {
			...
			if (obj instanceof org.jfree.data.time.RegularTimePeriod) {
				org.jfree.data.time.RegularTimePeriod rtp = ((org.jfree.data.time.RegularTimePeriod) (obj));
				final long thisVal = org.jfree.data.time.Millisecond.this.getFirstMillisecond();
