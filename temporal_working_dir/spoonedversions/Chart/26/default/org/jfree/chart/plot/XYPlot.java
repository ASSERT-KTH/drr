...
public class XYPlot extends org.jfree.chart.plot.Plot implements java.io.Serializable , java.lang.Cloneable , org.jfree.chart.event.RendererChangeListener , org.jfree.chart.plot.ValueAxisPlot , org.jfree.chart.plot.Zoomable , org.jfree.chart.util.PublicCloneable {
	...
	public XYPlot(org.jfree.data.xy.XYDataset dataset, org.jfree.chart.axis.ValueAxis domainAxis, org.jfree.chart.axis.ValueAxis rangeAxis, org.jfree.chart.renderer.xy.XYItemRenderer renderer) {
		...
		org.jfree.chart.plot.XYPlot.this.axisOffset = org.jfree.chart.util.RectangleInsets.ZERO_INSETS;
		...
		org.jfree.chart.plot.XYPlot.this.datasetToDomainAxisMap = new java.util.TreeMap();
		org.jfree.chart.plot.XYPlot.this.datasetToRangeAxisMap = new java.util.TreeMap();
	...
	public void setOrientation(org.jfree.chart.plot.PlotOrientation orientation) {
		...
		if (orientation != (org.jfree.chart.plot.XYPlot.this.orientation)) {
			...
			notifyListeners(new org.jfree.chart.event.PlotChangeEvent(org.jfree.chart.plot.XYPlot.this));
		}
	}
	...
	public void mapDatasetToDomainAxis(int index, int axisIndex) {
		org.jfree.chart.plot.XYPlot.this.datasetToDomainAxisMap.put(new java.lang.Integer(index), new java.lang.Integer(axisIndex));
	...
	public void mapDatasetToRangeAxis(int index, int axisIndex) {
		org.jfree.chart.plot.XYPlot.this.datasetToRangeAxisMap.put(new java.lang.Integer(index), new java.lang.Integer(axisIndex));
		datasetChanged(new org.jfree.data.general.DatasetChangeEvent(org.jfree.chart.plot.XYPlot.this, getDataset(index)));
	}
	...
	public java.awt.Paint getQuadrantPaint(int index) {
		if ((index < 0) || (index > 3)) {
			throw new java.lang.IllegalArgumentException("The index should be in the range 0 to 3.");
		}
	...
	protected void drawQuadrants(java.awt.Graphics2D g2, java.awt.geom.Rectangle2D area) {
		...
		double x = org.jfree.chart.plot.XYPlot.this.quadrantOrigin.getX();
		double xx = xAxis.valueToJava2D(x, area, getDomainAxisEdge());
		org.jfree.chart.axis.ValueAxis yAxis = getRangeAxis();
		double y = org.jfree.chart.plot.XYPlot.this.quadrantOrigin.getY();
				...
				for (int pass = 0; pass < passCount; pass++) {
					...
					for (int series = seriesCount - 1; series >= 0; series--) {
						...
						for (int item = firstItem; item <= lastItem; item++) {
							renderer.drawItem(g2, state, dataArea, info, org.jfree.chart.plot.XYPlot.this, xAxis, yAxis, dataset, series, item, crosshairState, pass);
						}
					}
				}
			}else {
	...
	public org.jfree.chart.axis.ValueAxis getDomainAxisForDataset(int index) {
		...
		java.lang.Integer axisIndex = ((java.lang.Integer) (org.jfree.chart.plot.XYPlot.this.datasetToDomainAxisMap.get(new java.lang.Integer(index))));
		if (axisIndex != null) {
	...
	public org.jfree.chart.axis.ValueAxis getRangeAxisForDataset(int index) {
		...
		org.jfree.chart.axis.ValueAxis valueAxis = null;
		java.lang.Integer axisIndex = ((java.lang.Integer) (org.jfree.chart.plot.XYPlot.this.datasetToRangeAxisMap.get(new java.lang.Integer(index))));
		if (axisIndex != null) {
	...
	protected void drawDomainGridlines(java.awt.Graphics2D g2, java.awt.geom.Rectangle2D dataArea, java.util.List ticks) {
		...
		if (isDomainGridlinesVisible()) {
			...
			while (iterator.hasNext()) {
				org.jfree.chart.axis.ValueTick tick = ((org.jfree.chart.axis.ValueTick) (iterator.next()));
				getRenderer().drawDomainLine(g2, org.jfree.chart.plot.XYPlot.this, getDomainAxis(), dataArea, tick.getValue(), gridPaint, gridStroke);
			} 
		}
	}
	...
	private java.util.List getDatasetsMappedToDomainAxis(java.lang.Integer axisIndex) {
		...
		for (int i = 0; i < (org.jfree.chart.plot.XYPlot.this.datasets.size()); i++) {
			java.lang.Integer mappedAxis = ((java.lang.Integer) (org.jfree.chart.plot.XYPlot.this.datasetToDomainAxisMap.get(new java.lang.Integer(i))));
			if (mappedAxis == null) {
	...
	private java.util.List getDatasetsMappedToRangeAxis(java.lang.Integer axisIndex) {
		...
		java.util.List result = new java.util.ArrayList();
		for (int i = 0; i < (org.jfree.chart.plot.XYPlot.this.datasets.size()); i++) {
			java.lang.Integer mappedAxis = ((java.lang.Integer) (org.jfree.chart.plot.XYPlot.this.datasetToRangeAxisMap.get(new java.lang.Integer(i))));
			if (mappedAxis == null) {
				if (axisIndex.equals(org.jfree.chart.plot.Plot.ZERO)) {
					result.add(org.jfree.chart.plot.XYPlot.this.datasets.get(i));
				}
	...
	public boolean equals(java.lang.Object obj) {
		...
		if (!(org.jfree.chart.util.ObjectUtilities.equal(org.jfree.chart.plot.XYPlot.this.datasetToDomainAxisMap, that.datasetToDomainAxisMap))) {
			return false;
		}
		if (!(org.jfree.chart.util.ObjectUtilities.equal(org.jfree.chart.plot.XYPlot.this.datasetToRangeAxisMap, that.datasetToRangeAxisMap))) {
			return false;
		}
	...
	public java.lang.Object clone() throws java.lang.CloneNotSupportedException {
		...
		clone.datasetToDomainAxisMap.putAll(org.jfree.chart.plot.XYPlot.this.datasetToDomainAxisMap);
		clone.datasetToRangeAxisMap = new java.util.TreeMap();
		clone.datasetToRangeAxisMap.putAll(org.jfree.chart.plot.XYPlot.this.datasetToRangeAxisMap);
