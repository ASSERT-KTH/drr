...
public class LegendItem implements java.io.Serializable {
	...
	public boolean equals(java.lang.Object obj) {
		...
		if (!(org.jfree.chart.LegendItem.this.fillPaint.equals(that.fillPaint))) {
			return false;
		}
		...
		if (!(org.jfree.chart.LegendItem.this.outlinePaint.equals(that.outlinePaint))) {
			return false;
		}
		...
		if (!(org.jfree.chart.LegendItem.this.linePaint.equals(that.linePaint))) {
			return false;
		}
		return true;
	}
