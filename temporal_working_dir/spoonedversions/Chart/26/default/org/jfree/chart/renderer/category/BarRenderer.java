...
public class BarRenderer extends org.jfree.chart.renderer.category.AbstractCategoryItemRenderer implements java.io.Serializable , java.lang.Cloneable , org.jfree.chart.util.PublicCloneable {
	...
	public BarRenderer() {
		...
		org.jfree.chart.renderer.category.BarRenderer.this.drawBarOutline = true;
	...
	public void setBase(double base) {
		...
		notifyListeners(new org.jfree.chart.event.RendererChangeEvent(org.jfree.chart.renderer.category.BarRenderer.this));
	}
	...
	public org.jfree.data.Range findRangeBounds(org.jfree.data.category.CategoryDataset dataset) {
		org.jfree.data.Range result = org.jfree.data.general.DatasetUtilities.findRangeBounds(dataset);
		if (result != null) {
	...
	public org.jfree.chart.LegendItem getLegendItem(int datasetIndex, int series) {
		...
		java.awt.Shape shape = new java.awt.geom.Rectangle2D.Double((-4.0), (-4.0), 8.0, 8.0);
	...
	public void drawItem(java.awt.Graphics2D g2, org.jfree.chart.renderer.category.CategoryItemRendererState state, java.awt.geom.Rectangle2D dataArea, org.jfree.chart.plot.CategoryPlot plot, org.jfree.chart.axis.CategoryAxis domainAxis, org.jfree.chart.axis.ValueAxis rangeAxis, org.jfree.data.category.CategoryDataset dataset, int row, int column, int pass) {
		...
		double barLength = java.lang.Math.max(java.lang.Math.abs((transL1 - transL0)), getMinimumBarLength());
	...
	protected void drawItemLabel(java.awt.Graphics2D g2, org.jfree.data.category.CategoryDataset data, int row, int column, org.jfree.chart.plot.CategoryPlot plot, org.jfree.chart.labels.CategoryItemLabelGenerator generator, java.awt.geom.Rectangle2D bar, boolean negative) {
		java.lang.String label = generator.generateLabel(data, row, column);
		if (label == null) {
			return ;
		}
