...
public class StackedBarRenderer3D extends org.jfree.chart.renderer.category.BarRenderer3D implements java.io.Serializable , java.lang.Cloneable , org.jfree.chart.util.PublicCloneable {
	...
	protected static java.util.List createStackedValueList(org.jfree.data.category.CategoryDataset dataset, java.lang.Comparable category, double base, boolean asPercentages) {
		java.util.List result = new java.util.ArrayList();
		double posBase = base;
		double negBase = base;
		double total = 0.0;
		if (asPercentages) {
			total = org.jfree.data.DataUtilities.calculateColumnTotal(dataset, dataset.getColumnIndex(category));
		}
		int baseIndex = -1;
		int seriesCount = dataset.getRowCount();
		for (int s = 0; s < seriesCount; s++) {
			java.lang.Number n = dataset.getValue(dataset.getRowKey(s), category);
			if (n == null) {
				continue;
			}
			...
			if (v >= 0.0) {
				...
				posBase = posBase + v;
				result.add(new java.lang.Object[]{ new java.lang.Integer(s) , new java.lang.Double(posBase) });
			}else
				if (v < 0.0) {
					if (baseIndex < 0) {
						result.add(new java.lang.Object[]{ null , new java.lang.Double(base) });
					...
					negBase = negBase + v;
					result.add(0, new java.lang.Object[]{ new java.lang.Integer((-s)) , new java.lang.Double(negBase) });
					baseIndex++;
				}
	...
	public void drawItem(java.awt.Graphics2D g2, org.jfree.chart.renderer.category.CategoryItemRendererState state, java.awt.geom.Rectangle2D dataArea, org.jfree.chart.plot.CategoryPlot plot, org.jfree.chart.axis.CategoryAxis domainAxis, org.jfree.chart.axis.ValueAxis rangeAxis, org.jfree.data.category.CategoryDataset dataset, int row, int column, int pass) {
		...
		java.util.List values = org.jfree.chart.renderer.category.StackedBarRenderer3D.createStackedValueList(dataset, dataset.getColumnKey(column), getBase(), org.jfree.chart.renderer.category.StackedBarRenderer3D.this.renderAsPercentages);
	...
	protected void drawStackHorizontal(java.util.List values, java.lang.Comparable category, java.awt.Graphics2D g2, org.jfree.chart.renderer.category.CategoryItemRendererState state, java.awt.geom.Rectangle2D dataArea, org.jfree.chart.plot.CategoryPlot plot, org.jfree.chart.axis.CategoryAxis domainAxis, org.jfree.chart.axis.ValueAxis rangeAxis, org.jfree.data.category.CategoryDataset dataset) {
		...
		for (int k = 0; k < blockCount; k++) {
			...
			int series = 0;
			if ((curr[0]) == null) {
				series = -(((java.lang.Integer) (prev[0])).intValue());
			}else {
			...
			java.awt.Paint fillPaint = getItemPaint(series, column);
		...
		for (int i = 0; i < (itemLabelList.size()); i++) {
			...
			org.jfree.chart.labels.CategoryItemLabelGenerator generator = getItemLabelGenerator(series, column);
