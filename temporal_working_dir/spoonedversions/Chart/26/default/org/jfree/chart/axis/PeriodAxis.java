...
public class PeriodAxis extends org.jfree.chart.axis.ValueAxis implements java.io.Serializable , java.lang.Cloneable , org.jfree.chart.util.PublicCloneable {
	...
	public PeriodAxis(java.lang.String label, org.jfree.data.time.RegularTimePeriod first, org.jfree.data.time.RegularTimePeriod last) {
		this(label, first, last, java.util.TimeZone.getDefault());
	}

	public PeriodAxis(java.lang.String label, org.jfree.data.time.RegularTimePeriod first, org.jfree.data.time.RegularTimePeriod last, java.util.TimeZone timeZone) {
		super(label, null);
		...
		org.jfree.chart.axis.PeriodAxis.this.calendar = java.util.Calendar.getInstance(timeZone);
		...
		org.jfree.chart.axis.PeriodAxis.this.labelInfo[0] = new org.jfree.chart.axis.PeriodAxisLabelInfo(org.jfree.data.time.Month.class, new java.text.SimpleDateFormat("MMM"));
		org.jfree.chart.axis.PeriodAxis.this.labelInfo[1] = new org.jfree.chart.axis.PeriodAxisLabelInfo(org.jfree.data.time.Year.class, new java.text.SimpleDateFormat("yyyy"));
	}
	...
	public void setTimeZone(java.util.TimeZone zone) {
		...
		org.jfree.chart.axis.PeriodAxis.this.calendar = java.util.Calendar.getInstance(zone);
		notifyListeners(new org.jfree.chart.event.AxisChangeEvent(org.jfree.chart.axis.PeriodAxis.this));
	}
	...
	public void setRange(org.jfree.data.Range range, boolean turnOffAutoRange, boolean notify) {
		...
		org.jfree.chart.axis.PeriodAxis.this.first = createInstance(org.jfree.chart.axis.PeriodAxis.this.autoRangeTimePeriodClass, new java.util.Date(lower), org.jfree.chart.axis.PeriodAxis.this.timeZone);
		org.jfree.chart.axis.PeriodAxis.this.last = createInstance(org.jfree.chart.axis.PeriodAxis.this.autoRangeTimePeriodClass, new java.util.Date(upper), org.jfree.chart.axis.PeriodAxis.this.timeZone);
	}
	...
	protected void drawTickMarksHorizontal(java.awt.Graphics2D g2, org.jfree.chart.axis.AxisState state, java.awt.geom.Rectangle2D dataArea, org.jfree.chart.util.RectangleEdge edge) {
		...
		org.jfree.data.time.RegularTimePeriod t = org.jfree.data.time.RegularTimePeriod.createInstance(org.jfree.chart.axis.PeriodAxis.this.majorTickTimePeriodClass, org.jfree.chart.axis.PeriodAxis.this.first.getStart(), getTimeZone());
		long t0 = t.getFirstMillisecond(org.jfree.chart.axis.PeriodAxis.this.calendar);
		java.awt.geom.Line2D inside = null;
		java.awt.geom.Line2D outside = null;
		long firstOnAxis = getFirst().getFirstMillisecond(org.jfree.chart.axis.PeriodAxis.this.calendar);
		long lastOnAxis = getLast().getLastMillisecond(org.jfree.chart.axis.PeriodAxis.this.calendar);
		while (t0 <= lastOnAxis) {
			...
			if (org.jfree.chart.axis.PeriodAxis.this.minorTickMarksVisible) {
				org.jfree.data.time.RegularTimePeriod tminor = org.jfree.data.time.RegularTimePeriod.createInstance(org.jfree.chart.axis.PeriodAxis.this.minorTickTimePeriodClass, new java.util.Date(t0), getTimeZone());
				long tt0 = tminor.getFirstMillisecond(org.jfree.chart.axis.PeriodAxis.this.calendar);
				while ((tt0 < (t.getLastMillisecond(org.jfree.chart.axis.PeriodAxis.this.calendar))) && (tt0 < lastOnAxis)) {
					...
					tminor = tminor.next();
					tt0 = tminor.getFirstMillisecond(org.jfree.chart.axis.PeriodAxis.this.calendar);
				} 
			}
			t = t.next();
			t0 = t.getFirstMillisecond(org.jfree.chart.axis.PeriodAxis.this.calendar);
		} 
		if (edge == (org.jfree.chart.util.RectangleEdge.TOP)) {
	...
	protected org.jfree.chart.axis.AxisState drawTickLabels(int band, java.awt.Graphics2D g2, org.jfree.chart.axis.AxisState state, java.awt.geom.Rectangle2D dataArea, org.jfree.chart.util.RectangleEdge edge) {
		...
		long axisMin = org.jfree.chart.axis.PeriodAxis.this.first.getFirstMillisecond(org.jfree.chart.axis.PeriodAxis.this.calendar);
		long axisMax = org.jfree.chart.axis.PeriodAxis.this.last.getLastMillisecond(org.jfree.chart.axis.PeriodAxis.this.calendar);
		...
		org.jfree.data.time.RegularTimePeriod p1 = org.jfree.chart.axis.PeriodAxis.this.labelInfo[band].createInstance(new java.util.Date(axisMin), org.jfree.chart.axis.PeriodAxis.this.timeZone);
		org.jfree.data.time.RegularTimePeriod p2 = org.jfree.chart.axis.PeriodAxis.this.labelInfo[band].createInstance(new java.util.Date(axisMax), org.jfree.chart.axis.PeriodAxis.this.timeZone);
		java.lang.String label1 = org.jfree.chart.axis.PeriodAxis.this.labelInfo[band].getDateFormat().format(new java.util.Date(p1.getMiddleMillisecond(org.jfree.chart.axis.PeriodAxis.this.calendar)));
		java.lang.String label2 = org.jfree.chart.axis.PeriodAxis.this.labelInfo[band].getDateFormat().format(new java.util.Date(p2.getMiddleMillisecond(org.jfree.chart.axis.PeriodAxis.this.calendar)));
		...
		long ww = (java.lang.Math.round(java2DToValue((((dataArea.getX()) + w) + 5.0), dataArea, edge))) - axisMin;
		long length = (p1.getLastMillisecond(org.jfree.chart.axis.PeriodAxis.this.calendar)) - (p1.getFirstMillisecond(org.jfree.chart.axis.PeriodAxis.this.calendar));
		int periods = ((int) (ww / length)) + 1;
		org.jfree.data.time.RegularTimePeriod p = org.jfree.chart.axis.PeriodAxis.this.labelInfo[band].createInstance(new java.util.Date(axisMin), org.jfree.chart.axis.PeriodAxis.this.timeZone);
		...
		while ((p.getFirstMillisecond(org.jfree.chart.axis.PeriodAxis.this.calendar)) <= axisMax) {
			float x = ((float) (valueToJava2D(p.getMiddleMillisecond(org.jfree.chart.axis.PeriodAxis.this.calendar), dataArea, edge)));
			java.text.DateFormat df = org.jfree.chart.axis.PeriodAxis.this.labelInfo[band].getDateFormat();
			java.lang.String label = df.format(new java.util.Date(p.getMiddleMillisecond(org.jfree.chart.axis.PeriodAxis.this.calendar)));
			long first = p.getFirstMillisecond(org.jfree.chart.axis.PeriodAxis.this.calendar);
			long last = p.getLastMillisecond(org.jfree.chart.axis.PeriodAxis.this.calendar);
			if (last > axisMax) {
			...
			if (lastXX > 0L) {
				if (org.jfree.chart.axis.PeriodAxis.this.labelInfo[band].getDrawDividers()) {
					long nextXX = p.getFirstMillisecond(org.jfree.chart.axis.PeriodAxis.this.calendar);
	...
	public double valueToJava2D(double value, java.awt.geom.Rectangle2D area, org.jfree.chart.util.RectangleEdge edge) {
		...
		double axisMin = org.jfree.chart.axis.PeriodAxis.this.first.getFirstMillisecond(org.jfree.chart.axis.PeriodAxis.this.calendar);
		double axisMax = org.jfree.chart.axis.PeriodAxis.this.last.getLastMillisecond(org.jfree.chart.axis.PeriodAxis.this.calendar);
		if (org.jfree.chart.util.RectangleEdge.isTopOrBottom(edge)) {
	...
	public boolean equals(java.lang.Object obj) {
		...
		if ((obj instanceof org.jfree.chart.axis.PeriodAxis) && (super.equals(obj))) {
	...
	private org.jfree.data.time.RegularTimePeriod createInstance(java.lang.Class periodClass, java.util.Date millisecond, java.util.TimeZone zone) {
		org.jfree.data.time.RegularTimePeriod result = null;
		try {
			java.lang.reflect.Constructor c = periodClass.getDeclaredConstructor(new java.lang.Class[]{ java.util.Date.class , java.util.TimeZone.class });
			result = ((org.jfree.data.time.RegularTimePeriod) (c.newInstance(new java.lang.Object[]{ millisecond , zone })));
