...
public class SegmentedTimeline implements java.io.Serializable , java.lang.Cloneable , org.jfree.chart.axis.Timeline {
	...
	private java.util.Calendar workingCalendarNoDST = new java.util.GregorianCalendar(org.jfree.chart.axis.SegmentedTimeline.NO_DST_TIME_ZONE);
	...
	public static org.jfree.chart.axis.SegmentedTimeline newMondayThroughFridayTimeline() {
		...
		timeline.setStartTime(org.jfree.chart.axis.SegmentedTimeline.FIRST_MONDAY_AFTER_1900);
		return timeline;
	}
	...
	public static org.jfree.chart.axis.SegmentedTimeline newFifteenMinuteTimeline() {
		...
		timeline.setStartTime(((org.jfree.chart.axis.SegmentedTimeline.FIRST_MONDAY_AFTER_1900) + (36 * (timeline.getSegmentSize()))));
	...
	public long toTimelineValue(long millisecond) {
		...
		if (groupMilliseconds >= (org.jfree.chart.axis.SegmentedTimeline.this.segmentsIncludedSize)) {
			...
			if (segment.inExceptionSegments()) {
				do {
					segment = getSegment((millisecond = (segment.getSegmentEnd()) + 1));
