...
public class PolarPlot extends org.jfree.chart.plot.Plot implements java.io.Serializable , java.lang.Cloneable , org.jfree.chart.event.RendererChangeListener , org.jfree.chart.plot.ValueAxisPlot , org.jfree.chart.plot.Zoomable {
	...
	public PolarPlot(org.jfree.data.xy.XYDataset dataset, org.jfree.chart.axis.ValueAxis radiusAxis, org.jfree.chart.renderer.PolarItemRenderer renderer) {
		...
		org.jfree.chart.plot.PolarPlot.this.angleTicks = new java.util.ArrayList();
		org.jfree.chart.plot.PolarPlot.this.angleTicks.add(new org.jfree.chart.axis.NumberTick(new java.lang.Double(0.0), "0", org.jfree.chart.text.TextAnchor.CENTER, org.jfree.chart.text.TextAnchor.CENTER, 0.0));
		org.jfree.chart.plot.PolarPlot.this.angleTicks.add(new org.jfree.chart.axis.NumberTick(new java.lang.Double(45.0), "45", org.jfree.chart.text.TextAnchor.CENTER, org.jfree.chart.text.TextAnchor.CENTER, 0.0));
		org.jfree.chart.plot.PolarPlot.this.angleTicks.add(new org.jfree.chart.axis.NumberTick(new java.lang.Double(90.0), "90", org.jfree.chart.text.TextAnchor.CENTER, org.jfree.chart.text.TextAnchor.CENTER, 0.0));
		org.jfree.chart.plot.PolarPlot.this.angleTicks.add(new org.jfree.chart.axis.NumberTick(new java.lang.Double(135.0), "135", org.jfree.chart.text.TextAnchor.CENTER, org.jfree.chart.text.TextAnchor.CENTER, 0.0));
		org.jfree.chart.plot.PolarPlot.this.angleTicks.add(new org.jfree.chart.axis.NumberTick(new java.lang.Double(180.0), "180", org.jfree.chart.text.TextAnchor.CENTER, org.jfree.chart.text.TextAnchor.CENTER, 0.0));
		org.jfree.chart.plot.PolarPlot.this.angleTicks.add(new org.jfree.chart.axis.NumberTick(new java.lang.Double(225.0), "225", org.jfree.chart.text.TextAnchor.CENTER, org.jfree.chart.text.TextAnchor.CENTER, 0.0));
		org.jfree.chart.plot.PolarPlot.this.angleTicks.add(new org.jfree.chart.axis.NumberTick(new java.lang.Double(270.0), "270", org.jfree.chart.text.TextAnchor.CENTER, org.jfree.chart.text.TextAnchor.CENTER, 0.0));
		org.jfree.chart.plot.PolarPlot.this.angleTicks.add(new org.jfree.chart.axis.NumberTick(new java.lang.Double(315.0), "315", org.jfree.chart.text.TextAnchor.CENTER, org.jfree.chart.text.TextAnchor.CENTER, 0.0));
	...
	public void addCornerTextItem(java.lang.String text) {
		...
		org.jfree.chart.plot.PolarPlot.this.notifyListeners(new org.jfree.chart.event.PlotChangeEvent(org.jfree.chart.plot.PolarPlot.this));
	}
	...
	public void setAxis(org.jfree.chart.axis.ValueAxis axis) {
		...
		notifyListeners(new org.jfree.chart.event.PlotChangeEvent(org.jfree.chart.plot.PolarPlot.this));
	}
