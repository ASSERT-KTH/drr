...
public class MinMaxCategoryRenderer extends org.jfree.chart.renderer.category.AbstractCategoryItemRenderer {
	...
	public void setDrawLines(boolean draw) {
		if ((org.jfree.chart.renderer.category.MinMaxCategoryRenderer.this.plotLines) != draw) {
			...
			org.jfree.chart.renderer.category.MinMaxCategoryRenderer.this.notifyListeners(new org.jfree.chart.event.RendererChangeEvent(org.jfree.chart.renderer.category.MinMaxCategoryRenderer.this));
		}
	}
	...
	public void setGroupPaint(java.awt.Paint paint) {
		...
		notifyListeners(new org.jfree.chart.event.RendererChangeEvent(org.jfree.chart.renderer.category.MinMaxCategoryRenderer.this));
	}
	...
	public void setGroupStroke(java.awt.Stroke groupStroke) {
		org.jfree.chart.renderer.category.MinMaxCategoryRenderer.this.groupStroke = groupStroke;
	}
		...
		if (value != null) {
			...
			if ((state.getInfo()) != null) {
				...
				if ((entities != null) && (shape != null)) {
					...
					org.jfree.chart.entity.CategoryItemEntity entity = new org.jfree.chart.entity.CategoryItemEntity(shape, tip, null, dataset, dataset.getRowKey(row), dataset.getColumnKey(column));
					entities.add(entity);
				}
			}
		}
