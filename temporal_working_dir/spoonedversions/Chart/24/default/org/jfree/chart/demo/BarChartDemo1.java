...
public class BarChartDemo1 extends org.jfree.chart.util.ApplicationFrame {
	public BarChartDemo1(java.lang.String title) {
		...
		org.jfree.chart.ChartPanel chartPanel = new org.jfree.chart.ChartPanel(chart, false);
	...
	private static org.jfree.chart.JFreeChart createChart(org.jfree.data.category.CategoryDataset dataset) {
		org.jfree.chart.JFreeChart chart = org.jfree.chart.ChartFactory.createBarChart("Bar Chart Demo 1", "Category", "Value", dataset, org.jfree.chart.plot.PlotOrientation.VERTICAL, true, true, false);
