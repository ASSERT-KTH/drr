...
public class DefaultBoxAndWhiskerXYDataset extends org.jfree.data.xy.AbstractXYDataset implements org.jfree.data.RangeInfo , org.jfree.data.statistics.BoxAndWhiskerXYDataset {
	...
	public boolean equals(java.lang.Object obj) {
		if (obj == (org.jfree.data.statistics.DefaultBoxAndWhiskerXYDataset.this)) {
			return true;
		}
		if (!(obj instanceof org.jfree.data.statistics.DefaultBoxAndWhiskerXYDataset)) {
			return false;
		}
		org.jfree.data.statistics.DefaultBoxAndWhiskerXYDataset that = ((org.jfree.data.statistics.DefaultBoxAndWhiskerXYDataset) (obj));
		if (!(org.jfree.chart.util.ObjectUtilities.equal(org.jfree.data.statistics.DefaultBoxAndWhiskerXYDataset.this.seriesKey, that.seriesKey))) {
			return false;
		}
		if (!(org.jfree.data.statistics.DefaultBoxAndWhiskerXYDataset.this.dates.equals(that.dates))) {
			return false;
		}
		if (!(org.jfree.data.statistics.DefaultBoxAndWhiskerXYDataset.this.items.equals(that.items))) {
			return false;
		}
		return true;
	}
	...
	public java.lang.Object clone() throws java.lang.CloneNotSupportedException {
		org.jfree.data.statistics.DefaultBoxAndWhiskerXYDataset clone = ((org.jfree.data.statistics.DefaultBoxAndWhiskerXYDataset) (super.clone()));
		clone.dates = new java.util.ArrayList(org.jfree.data.statistics.DefaultBoxAndWhiskerXYDataset.this.dates);
		clone.items = new java.util.ArrayList(org.jfree.data.statistics.DefaultBoxAndWhiskerXYDataset.this.items);
		return clone;
	}
}
