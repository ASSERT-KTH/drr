...
public class DefaultBoxAndWhiskerCategoryDataset extends org.jfree.data.general.AbstractDataset implements org.jfree.chart.util.PublicCloneable , org.jfree.data.RangeInfo , org.jfree.data.statistics.BoxAndWhiskerCategoryDataset {
	...
	public void add(org.jfree.data.statistics.BoxAndWhiskerItem item, java.lang.Comparable rowKey, java.lang.Comparable columnKey) {
		...
		if ((((org.jfree.data.statistics.DefaultBoxAndWhiskerCategoryDataset.this.maximumRangeValueRow) == r) && ((org.jfree.data.statistics.DefaultBoxAndWhiskerCategoryDataset.this.maximumRangeValueColumn) == c)) || (((org.jfree.data.statistics.DefaultBoxAndWhiskerCategoryDataset.this.minimumRangeValueRow) == r) && ((org.jfree.data.statistics.DefaultBoxAndWhiskerCategoryDataset.this.minimumRangeValueColumn) == c))) {
			updateBounds();
		}else {
	...
	public void remove(java.lang.Comparable rowKey, java.lang.Comparable columnKey) {
		...
		org.jfree.data.statistics.DefaultBoxAndWhiskerCategoryDataset.this.data.removeObject(rowKey, columnKey);
		if ((((org.jfree.data.statistics.DefaultBoxAndWhiskerCategoryDataset.this.maximumRangeValueRow) == r) && ((org.jfree.data.statistics.DefaultBoxAndWhiskerCategoryDataset.this.maximumRangeValueColumn) == c)) || (((org.jfree.data.statistics.DefaultBoxAndWhiskerCategoryDataset.this.minimumRangeValueRow) == r) && ((org.jfree.data.statistics.DefaultBoxAndWhiskerCategoryDataset.this.minimumRangeValueColumn) == c))) {
			updateBounds();
		}
		fireDatasetChanged(new org.jfree.chart.event.DatasetChangeInfo());
	...
	public void removeRow(int rowIndex) {
		org.jfree.data.statistics.DefaultBoxAndWhiskerCategoryDataset.this.data.removeRow(rowIndex);
		updateBounds();
		fireDatasetChanged(new org.jfree.chart.event.DatasetChangeInfo());
	}

	public void removeRow(java.lang.Comparable rowKey) {
		org.jfree.data.statistics.DefaultBoxAndWhiskerCategoryDataset.this.data.removeRow(rowKey);
		updateBounds();
		fireDatasetChanged(new org.jfree.chart.event.DatasetChangeInfo());
	}

	public void removeColumn(int columnIndex) {
		org.jfree.data.statistics.DefaultBoxAndWhiskerCategoryDataset.this.data.removeColumn(columnIndex);
		updateBounds();
		fireDatasetChanged(new org.jfree.chart.event.DatasetChangeInfo());
	}

	public void removeColumn(java.lang.Comparable columnKey) {
		org.jfree.data.statistics.DefaultBoxAndWhiskerCategoryDataset.this.data.removeColumn(columnKey);
		updateBounds();
		fireDatasetChanged(new org.jfree.chart.event.DatasetChangeInfo());
	}

	public void clear() {
		org.jfree.data.statistics.DefaultBoxAndWhiskerCategoryDataset.this.data.clear();
		updateBounds();
		fireDatasetChanged(new org.jfree.chart.event.DatasetChangeInfo());
	}
	...
	public org.jfree.data.Range getRangeBounds(boolean includeInterval) {
		return new org.jfree.data.Range(org.jfree.data.statistics.DefaultBoxAndWhiskerCategoryDataset.this.minimumRangeValue, org.jfree.data.statistics.DefaultBoxAndWhiskerCategoryDataset.this.maximumRangeValue);
	}
	...
	private void updateBounds() {
		...
		for (int r = 0; r < rowCount; r++) {
			for (int c = 0; c < columnCount; c++) {
				org.jfree.data.statistics.BoxAndWhiskerItem item = getItem(r, c);
				if (item != null) {
					java.lang.Number min = item.getMinOutlier();
					if (min != null) {
						double minv = min.doubleValue();
						if (!(java.lang.Double.isNaN(minv))) {
							if ((minv < (org.jfree.data.statistics.DefaultBoxAndWhiskerCategoryDataset.this.minimumRangeValue)) || (java.lang.Double.isNaN(org.jfree.data.statistics.DefaultBoxAndWhiskerCategoryDataset.this.minimumRangeValue))) {
								org.jfree.data.statistics.DefaultBoxAndWhiskerCategoryDataset.this.minimumRangeValue = minv;
								org.jfree.data.statistics.DefaultBoxAndWhiskerCategoryDataset.this.minimumRangeValueRow = r;
								org.jfree.data.statistics.DefaultBoxAndWhiskerCategoryDataset.this.minimumRangeValueColumn = c;
							}
						}
					}
					java.lang.Number max = item.getMaxOutlier();
					if (max != null) {
						double maxv = max.doubleValue();
						if (!(java.lang.Double.isNaN(maxv))) {
							if ((maxv > (org.jfree.data.statistics.DefaultBoxAndWhiskerCategoryDataset.this.maximumRangeValue)) || (java.lang.Double.isNaN(org.jfree.data.statistics.DefaultBoxAndWhiskerCategoryDataset.this.maximumRangeValue))) {
								org.jfree.data.statistics.DefaultBoxAndWhiskerCategoryDataset.this.maximumRangeValue = maxv;
								org.jfree.data.statistics.DefaultBoxAndWhiskerCategoryDataset.this.maximumRangeValueRow = r;
								org.jfree.data.statistics.DefaultBoxAndWhiskerCategoryDataset.this.maximumRangeValueColumn = c;
							}
						}
