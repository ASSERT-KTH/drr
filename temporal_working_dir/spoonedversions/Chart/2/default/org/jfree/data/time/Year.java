...
public class Year extends org.jfree.data.time.RegularTimePeriod implements java.io.Serializable {
	...
	public Year(int year) {
		if ((year < (org.jfree.data.time.Year.MINIMUM_YEAR)) || (year > (org.jfree.data.time.Year.MAXIMUM_YEAR))) {
	...
	public org.jfree.data.time.RegularTimePeriod previous() {
		if ((org.jfree.data.time.Year.this.year) > (org.jfree.data.time.Year.MINIMUM_YEAR)) {
	...
	public org.jfree.data.time.RegularTimePeriod next() {
		if ((org.jfree.data.time.Year.this.year) < (org.jfree.data.time.Year.MAXIMUM_YEAR)) {
			return new org.jfree.data.time.Year(((org.jfree.data.time.Year.this.year) + 1));
		}else {
			return null;
		}
	...
	public boolean equals(java.lang.Object obj) {
		if (obj == (org.jfree.data.time.Year.this)) {
			return true;
		}
		if (!(obj instanceof org.jfree.data.time.Year)) {
			return false;
		}
		org.jfree.data.time.Year that = ((org.jfree.data.time.Year) (obj));
		return (org.jfree.data.time.Year.this.year) == (that.year);
	}
