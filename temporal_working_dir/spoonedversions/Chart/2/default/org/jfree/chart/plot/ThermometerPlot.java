...
public class ThermometerPlot extends org.jfree.chart.plot.Plot implements java.io.Serializable , java.lang.Cloneable , org.jfree.chart.plot.ValueAxisPlot , org.jfree.chart.plot.Zoomable {
	...
	private int bulbRadius = org.jfree.chart.plot.ThermometerPlot.DEFAULT_BULB_RADIUS;

	private int columnRadius = org.jfree.chart.plot.ThermometerPlot.DEFAULT_COLUMN_RADIUS;

	private int gap = org.jfree.chart.plot.ThermometerPlot.DEFAULT_GAP;
	...
	private java.awt.Font valueFont = new java.awt.Font("Tahoma", java.awt.Font.BOLD, 16);
	...
	public void setDataset(org.jfree.data.general.ValueDataset dataset) {
		...
		org.jfree.data.event.DatasetChangeEvent event = new org.jfree.data.event.DatasetChangeEvent(org.jfree.chart.plot.ThermometerPlot.this, dataset, new org.jfree.chart.event.DatasetChangeInfo());
	...
	public int getBulbRadius() {
		return org.jfree.chart.plot.ThermometerPlot.this.bulbRadius;
	}

	public void setBulbRadius(int r) {
		org.jfree.chart.plot.ThermometerPlot.this.bulbRadius = r;
		fireChangeEvent();
	}
	...
	public int getColumnRadius() {
		return org.jfree.chart.plot.ThermometerPlot.this.columnRadius;
	}

	public void setColumnRadius(int r) {
		org.jfree.chart.plot.ThermometerPlot.this.columnRadius = r;
		fireChangeEvent();
	}
	...
	public int getGap() {
		return org.jfree.chart.plot.ThermometerPlot.this.gap;
	}

	public void setGap(int gap) {
		org.jfree.chart.plot.ThermometerPlot.this.gap = gap;
		fireChangeEvent();
	}
	...
	public void draw(java.awt.Graphics2D g2, java.awt.geom.Rectangle2D area, java.awt.geom.Point2D anchor, org.jfree.chart.plot.PlotState parentState, org.jfree.chart.plot.PlotRenderingInfo info) {
		...
		java.awt.geom.Rectangle2D dataArea = new java.awt.geom.Rectangle2D.Double((midX - (getColumnRadius())), stemTop, getColumnRadius(), (stemBottom - stemTop));
		...
		if (((org.jfree.chart.plot.ThermometerPlot.this.dataset) != null) && ((org.jfree.chart.plot.ThermometerPlot.this.dataset.getValue()) != null)) {
			...
			switch (org.jfree.chart.plot.ThermometerPlot.this.valueLocation) {
				case org.jfree.chart.plot.ThermometerPlot.RIGHT :
					g2.drawString(org.jfree.chart.plot.ThermometerPlot.this.valueFormat.format(current), ((midX + (getColumnRadius())) + (getGap())), midY);
					break;
				case org.jfree.chart.plot.ThermometerPlot.LEFT :
		...
		g2.setFont(org.jfree.chart.plot.ThermometerPlot.this.valueFont);
		metrics = g2.getFontMetrics();
		int tickX1 = ((midX - (getColumnRadius())) - ((getGap()) * 2)) - (metrics.stringWidth(org.jfree.chart.plot.ThermometerPlot.UNITS[org.jfree.chart.plot.ThermometerPlot.this.units]));
	...
	public boolean equals(java.lang.Object obj) {
		...
		if ((org.jfree.chart.plot.ThermometerPlot.this.bulbRadius) != (that.bulbRadius)) {
			return false;
		}
		if ((org.jfree.chart.plot.ThermometerPlot.this.columnRadius) != (that.columnRadius)) {
			return false;
		}
		if ((org.jfree.chart.plot.ThermometerPlot.this.gap) != (that.gap)) {
			return false;
		}
	...
	public void zoomRangeAxes(double factor, org.jfree.chart.plot.PlotRenderingInfo state, java.awt.geom.Point2D source, boolean useAnchor) {
		double anchorY = org.jfree.chart.plot.ThermometerPlot.this.getRangeAxis().java2DToValue(source.getY(), state.getDataArea(), org.jfree.chart.util.RectangleEdge.LEFT);
		org.jfree.chart.plot.ThermometerPlot.this.rangeAxis.resizeRange(factor, anchorY);
	}
