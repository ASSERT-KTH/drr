...
public class PiePlot3D extends org.jfree.chart.plot.PiePlot implements java.io.Serializable {
	...
	public PiePlot3D(org.jfree.data.pie.PieDataset dataset) {
		super(dataset);
	...
	public boolean getDarkerSides() {
		return org.jfree.chart.plot.PiePlot3D.this.darkerSides;
	}

	public void setDarkerSides(boolean darker) {
		org.jfree.chart.plot.PiePlot3D.this.darkerSides = darker;
		fireChangeEvent();
	}
	...
	public void draw(java.awt.Graphics2D g2, java.awt.geom.Rectangle2D plotArea, java.awt.geom.Point2D anchor, org.jfree.chart.plot.PlotState parentState, org.jfree.chart.plot.PlotRenderingInfo info) {
		...
		if ((dataset.getKeys().size()) > (plotArea.getWidth())) {
			...
			java.awt.Font sfont = new java.awt.Font("Tahoma", java.awt.Font.BOLD, 10);
			g2.setFont(sfont);
	...
	public boolean equals(java.lang.Object obj) {
		...
		if ((org.jfree.chart.plot.PiePlot3D.this.darkerSides) != (that.darkerSides)) {
			return false;
		}
