...
public class PiePlot extends org.jfree.chart.plot.Plot implements java.io.Serializable , java.lang.Cloneable , org.jfree.chart.plot.Selectable {
	...
	public static final java.awt.Font DEFAULT_LABEL_FONT = new java.awt.Font("Tahoma", java.awt.Font.PLAIN, 10);
	...
	private org.jfree.chart.util.PaintMap sectionPaintMap;
	...
	private org.jfree.chart.util.PaintMap sectionOutlinePaintMap;

	private transient java.awt.Paint baseSectionOutlinePaint;

	private boolean autoPopulateSectionOutlinePaint;

	private org.jfree.chart.util.StrokeMap sectionOutlineStrokeMap;
	...
	private org.jfree.chart.plot.PieSelectionAttributes selectedItemAttributes;
	...
	public PiePlot(org.jfree.data.pie.PieDataset dataset) {
		super();
		...
		org.jfree.chart.plot.PiePlot.this.sectionPaintMap = new org.jfree.chart.util.PaintMap();
		org.jfree.chart.plot.PiePlot.this.baseSectionPaint = java.awt.Color.gray;
		org.jfree.chart.plot.PiePlot.this.autoPopulateSectionPaint = true;
		org.jfree.chart.plot.PiePlot.this.sectionOutlinesVisible = true;
		org.jfree.chart.plot.PiePlot.this.sectionOutlinePaintMap = new org.jfree.chart.util.PaintMap();
		org.jfree.chart.plot.PiePlot.this.baseSectionOutlinePaint = org.jfree.chart.plot.Plot.DEFAULT_OUTLINE_PAINT;
		org.jfree.chart.plot.PiePlot.this.autoPopulateSectionOutlinePaint = false;
		org.jfree.chart.plot.PiePlot.this.sectionOutlineStrokeMap = new org.jfree.chart.util.StrokeMap();
		org.jfree.chart.plot.PiePlot.this.baseSectionOutlineStroke = org.jfree.chart.plot.Plot.DEFAULT_OUTLINE_STROKE;
		org.jfree.chart.plot.PiePlot.this.autoPopulateSectionOutlineStroke = false;
		...
		org.jfree.chart.plot.PiePlot.this.selectedItemAttributes = new org.jfree.chart.plot.PieSelectionAttributes();
		org.jfree.chart.plot.PiePlot.this.shadowGenerator = new org.jfree.chart.util.DefaultShadowGenerator();
	}
	...
	public void setDataset(org.jfree.data.pie.PieDataset dataset) {
		org.jfree.data.pie.PieDataset existing = org.jfree.chart.plot.PiePlot.this.dataset;
		if (existing != null) {
		...
		org.jfree.data.event.DatasetChangeEvent event = new org.jfree.data.event.DatasetChangeEvent(org.jfree.chart.plot.PiePlot.this, dataset, new org.jfree.data.pie.PieDatasetChangeInfo(org.jfree.data.pie.PieDatasetChangeType.UPDATE, (-1), (-1)));
	...
	protected java.awt.Paint lookupSectionPaint(java.lang.Comparable key, boolean selected) {
		java.awt.Paint result = null;
		if (selected) {
			result = org.jfree.chart.plot.PiePlot.this.selectedItemAttributes.lookupSectionPaint(key);
		}
		if (result == null) {
	...
	protected java.awt.Paint lookupSectionPaint(java.lang.Comparable key, boolean selected, boolean autoPopulate) {
		if (selected) {
		}
		java.awt.Paint result = null;
	...
	public java.awt.Paint getSectionPaint(java.lang.Comparable key, boolean selected) {
		if (selected) {
	...
	public void clearSectionPaints(boolean notify) {
		org.jfree.chart.plot.PiePlot.this.sectionPaintMap.clear();
		if (notify) {
			fireChangeEvent();
		}
	}
	...
	public boolean getAutoPopulateSectionPaint() {
		return org.jfree.chart.plot.PiePlot.this.autoPopulateSectionPaint;
	}

	public void setAutoPopulateSectionPaint(boolean auto) {
		org.jfree.chart.plot.PiePlot.this.autoPopulateSectionPaint = auto;
		fireChangeEvent();
	}
	...
	protected java.awt.Paint lookupSectionOutlinePaint(java.lang.Comparable key, boolean selected) {
		java.awt.Paint result = null;
		if (selected) {
			result = org.jfree.chart.plot.PiePlot.this.selectedItemAttributes.lookupSectionOutlinePaint(key);
		}
		if (result == null) {
	...
	protected java.awt.Paint lookupSectionOutlinePaint(java.lang.Comparable key, boolean selected, boolean autoPopulate) {
		java.awt.Paint result = null;
		if (selected) {
			return java.awt.Color.WHITE;
		}
	...
	public void clearSectionOutlinePaints(boolean notify) {
		org.jfree.chart.plot.PiePlot.this.sectionOutlinePaintMap.clear();
		if (notify) {
			fireChangeEvent();
		}
	}
	...
	public boolean getAutoPopulateSectionOutlinePaint() {
		return org.jfree.chart.plot.PiePlot.this.autoPopulateSectionOutlinePaint;
	}

	public void setAutoPopulateSectionOutlinePaint(boolean auto) {
		org.jfree.chart.plot.PiePlot.this.autoPopulateSectionOutlinePaint = auto;
		fireChangeEvent();
	}

	protected java.awt.Stroke lookupSectionOutlineStroke(java.lang.Comparable key, boolean selected) {
		java.awt.Stroke s = null;
		if (selected) {
			s = org.jfree.chart.plot.PiePlot.this.selectedItemAttributes.lookupSectionOutlineStroke(key);
		}
		if (s == null) {
	...
	protected java.awt.Stroke lookupSectionOutlineStroke(java.lang.Comparable key, boolean selected, boolean autoPopulate) {
	...
	public void clearSectionOutlineStrokes(boolean notify) {
		org.jfree.chart.plot.PiePlot.this.sectionOutlineStrokeMap.clear();
		if (notify) {
			fireChangeEvent();
		}
	}
	...
	public boolean getAutoPopulateSectionOutlineStroke() {
		return org.jfree.chart.plot.PiePlot.this.autoPopulateSectionOutlineStroke;
	}

	public void setAutoPopulateSectionOutlineStroke(boolean auto) {
		org.jfree.chart.plot.PiePlot.this.autoPopulateSectionOutlineStroke = auto;
		fireChangeEvent();
	}
	...
	public org.jfree.chart.util.ShadowGenerator getShadowGenerator() {
		return org.jfree.chart.plot.PiePlot.this.shadowGenerator;
	}

	public void setShadowGenerator(org.jfree.chart.util.ShadowGenerator generator) {
		org.jfree.chart.plot.PiePlot.this.shadowGenerator = generator;
		fireChangeEvent();
	}
	...
	public void draw(java.awt.Graphics2D g2, java.awt.geom.Rectangle2D area, java.awt.geom.Point2D anchor, org.jfree.chart.plot.PlotState parentState, org.jfree.chart.plot.PlotRenderingInfo info) {
		...
		if (!(org.jfree.data.general.DatasetUtilities.isEmptyOrNull(org.jfree.chart.plot.PiePlot.this.dataset))) {
			...
			java.awt.geom.Rectangle2D savedDataArea = area;
			java.awt.image.BufferedImage dataImage = null;
			if ((org.jfree.chart.plot.PiePlot.this.shadowGenerator) != null) {
				dataImage = new java.awt.image.BufferedImage(((int) (area.getWidth())), ((int) (area.getHeight())), java.awt.image.BufferedImage.TYPE_INT_ARGB);
				g2 = dataImage.createGraphics();
				g2.setRenderingHints(savedG2.getRenderingHints());
				area = new java.awt.Rectangle(0, 0, dataImage.getWidth(), dataImage.getHeight());
			}
			drawPie(g2, area, info);
			if ((org.jfree.chart.plot.PiePlot.this.shadowGenerator) != null) {
				java.awt.image.BufferedImage shadowImage = org.jfree.chart.plot.PiePlot.this.shadowGenerator.createDropShadow(dataImage);
				g2 = savedG2;
				area = savedDataArea;
				g2.drawImage(shadowImage, (((int) (savedDataArea.getX())) + (org.jfree.chart.plot.PiePlot.this.shadowGenerator.calculateOffsetX())), (((int) (savedDataArea.getY())) + (org.jfree.chart.plot.PiePlot.this.shadowGenerator.calculateOffsetY())), null);
	...
	private java.awt.geom.Rectangle2D[] calculateLinkAndExplodeAreas(java.awt.Graphics2D g2, java.awt.geom.Rectangle2D plotArea) {
		java.awt.geom.Rectangle2D[] result = new java.awt.geom.Rectangle2D[2];
	...
	protected void drawPie(java.awt.Graphics2D g2, java.awt.geom.Rectangle2D plotArea, org.jfree.chart.plot.PlotRenderingInfo info) {
		...
		java.awt.geom.Rectangle2D[] areas = calculateLinkAndExplodeAreas(g2, plotArea);
		java.awt.geom.Rectangle2D linkArea = areas[0];
		java.awt.geom.Rectangle2D explodeArea = areas[1];
		...
		if (((org.jfree.chart.plot.PiePlot.this.dataset) != null) && ((org.jfree.chart.plot.PiePlot.this.dataset.getKeys().size()) > 0)) {
			org.jfree.data.pie.PieDatasetSelectionState ss = findSelectionStateForDataset(org.jfree.chart.plot.PiePlot.this.dataset, state);
				...
				for (int section = 0; section < (keys.size()); section++) {
					...
					if (n != null) {
						...
						if (value > 0.0) {
							...
							if (ss != null) {
								selected = ss.isSelected(org.jfree.chart.plot.PiePlot.this.dataset.getKey(section));
							}
	...
	protected void drawItem(java.awt.Graphics2D g2, int section, boolean selected, java.awt.geom.Rectangle2D dataArea, org.jfree.chart.plot.PiePlotState state, int currentPass) {
		java.lang.Number n = org.jfree.chart.plot.PiePlot.this.dataset.getValue(section);
		if (n == null) {
			return ;
		}
		...
		if ((java.lang.Math.abs(angle)) > (getMinimumArcAngleToDraw())) {
			...
			if (currentPass == 0) {
				...
				if (currentPass == 1) {
					...
					java.awt.Paint paint = lookupSectionPaint(key, selected);
					java.awt.Shape savedClip = g2.getClip();
					g2.clip(arc);
					g2.setPaint(paint);
					g2.fill(arc);
					java.awt.Paint outlinePaint = lookupSectionOutlinePaint(key, selected);
					java.awt.Stroke outlineStroke = lookupSectionOutlineStroke(key, selected);
	...
	protected void drawSimpleLabels(java.awt.Graphics2D g2, java.util.List keys, double totalValue, java.awt.geom.Rectangle2D plotArea, java.awt.geom.Rectangle2D pieArea, org.jfree.chart.plot.PiePlotState state) {
		...
		while (iterator.hasNext()) {
			...
			if (include) {
				...
				if (((org.jfree.chart.plot.PiePlot.this.labelShadowPaint) != null) && ((org.jfree.chart.plot.PiePlot.this.shadowGenerator) == null)) {
	...
	protected void drawLeftLabels(org.jfree.data.KeyedValues leftKeys, java.awt.Graphics2D g2, java.awt.geom.Rectangle2D plotArea, java.awt.geom.Rectangle2D linkArea, float maxLabelWidth, org.jfree.chart.plot.PiePlotState state) {
		...
		for (int i = 0; i < (leftKeys.getItemCount()); i++) {
			...
			if (label != null) {
				...
				org.jfree.chart.plot.PiePlot.this.labelDistributor.addPieLabelRecord(new org.jfree.chart.plot.PieLabelRecord(leftKeys.getKey(i), theta, baseY, labelBox, hh, ((lGap / 2.0) + ((lGap / 2.0) * (-(java.lang.Math.cos(theta))))), ((1.0 - (getLabelLinkDepth())) + (getExplodePercent(leftKeys.getKey(i))))));
			}
		}
	...
	protected void drawRightLabels(org.jfree.data.KeyedValues keys, java.awt.Graphics2D g2, java.awt.geom.Rectangle2D plotArea, java.awt.geom.Rectangle2D linkArea, float maxLabelWidth, org.jfree.chart.plot.PiePlotState state) {
		...
		for (int i = 0; i < (keys.getItemCount()); i++) {
			...
			if (label != null) {
				...
				double baseY = (state.getPieCenterY()) - ((java.lang.Math.sin(theta)) * verticalLinkRadius);
				double hh = labelBox.getHeight(g2);
				org.jfree.chart.plot.PiePlot.this.labelDistributor.addPieLabelRecord(new org.jfree.chart.plot.PieLabelRecord(keys.getKey(i), theta, baseY, labelBox, hh, ((lGap / 2.0) + ((lGap / 2.0) * (java.lang.Math.cos(theta)))), ((1.0 - (getLabelLinkDepth())) + (getExplodePercent(keys.getKey(i))))));
			}
		}
		double hh = plotArea.getHeight();
		double gap = hh * (getInteriorGap());
		...
		while (iterator.hasNext()) {
			...
			if (include) {
				...
				if (label != null) {
					...
					java.awt.Paint paint = lookupSectionPaint(key, false);
					java.awt.Paint outlinePaint = lookupSectionOutlinePaint(key, false);
					java.awt.Stroke outlineStroke = lookupSectionOutlineStroke(key, false);
					...
					item.setSeriesIndex(org.jfree.chart.plot.PiePlot.this.dataset.getIndex(key));
	...
	private org.jfree.data.pie.PieDatasetSelectionState findSelectionStateForDataset(org.jfree.data.pie.PieDataset dataset, java.lang.Object source) {
		if (dataset instanceof org.jfree.data.pie.SelectablePieDataset) {
			org.jfree.data.pie.SelectablePieDataset sd = ((org.jfree.data.pie.SelectablePieDataset) (dataset));
			org.jfree.data.pie.PieDatasetSelectionState s = sd.getSelectionState();
			return s;
		}
	...
	public void select(double x, double y, java.awt.geom.Rectangle2D dataArea, org.jfree.chart.RenderingSource source) {
		java.lang.System.out.println(((("select " + x) + ", ") + y));
		org.jfree.data.pie.PieDatasetSelectionState state = findSelectionStateForDataset(dataset, source);
		if (state == null) {
			return ;
		}
		java.awt.geom.Rectangle2D[] areas = calculateLinkAndExplodeAreas(null, dataArea);
		java.awt.geom.Rectangle2D linkArea = areas[0];
		java.awt.geom.Rectangle2D explodeArea = areas[1];
		double maximumExplodePercent = getMaximumExplodePercent();
		double percent = maximumExplodePercent / (1.0 + maximumExplodePercent);
		...
		if (((org.jfree.chart.plot.PiePlot.this.dataset) != null) && ((org.jfree.chart.plot.PiePlot.this.dataset.getKeys().size()) > 0)) {
			java.util.List keys = org.jfree.chart.plot.PiePlot.this.dataset.getKeys();
			double total = org.jfree.data.general.DatasetUtilities.calculatePieDatasetTotal(org.jfree.chart.plot.PiePlot.this.dataset);
			double runningTotal = 0.0;
			for (int section = 0; section < (keys.size()); section++) {
				java.lang.Number n = org.jfree.chart.plot.PiePlot.this.dataset.getValue(section);
				if (n == null) {
				...
				if (value > 0.0) {
					...
					runningTotal += value;
					java.lang.System.out.println(org.jfree.chart.plot.PiePlot.this.dataset.getValue(section));
					java.lang.System.out.println(angle0);
					java.lang.System.out.println(angle1);
					...
					if ((java.lang.Math.abs(angle)) > (getMinimumArcAngleToDraw())) {
						...
						java.awt.geom.Rectangle2D arcBounds = getArcBounds(pieArea, explodeArea, angle0, angle, ep);
						java.awt.geom.Arc2D.Double arc = new java.awt.geom.Arc2D.Double(arcBounds, angle0, angle, java.awt.geom.Arc2D.PIE);
						if (arc.contains(x, y)) {
							java.lang.Comparable key = org.jfree.chart.plot.PiePlot.this.dataset.getKey(section);
							state.setSelected(key, (!(state.isSelected(key))));
							java.lang.System.out.println(((key + " is ") + (state.isSelected(key))));
						}
					}
				}
			}
	...
	private double calculateAngleForValue(double value, double total) {
		if ((org.jfree.chart.plot.PiePlot.this.direction) == (org.jfree.chart.util.Rotation.CLOCKWISE)) {
			return (org.jfree.chart.plot.PiePlot.this.startAngle) - ((value / total) * 360.0);
		}else
			if ((org.jfree.chart.plot.PiePlot.this.direction) == (org.jfree.chart.util.Rotation.ANTICLOCKWISE)) {
				return (org.jfree.chart.plot.PiePlot.this.startAngle) + ((value / total) * 360.0);
			}
		
		throw new java.lang.RuntimeException("Unrecognised Rotation type.");
	}
	...
	public void clearSelection() {
		java.lang.System.out.println("Clear selection.");
	}

	public java.awt.Shape createHotSpotShape(java.awt.Graphics2D g2, java.awt.geom.Rectangle2D dataArea, int section, boolean selected) {
		java.lang.Number n = org.jfree.chart.plot.PiePlot.this.dataset.getValue(section);
		if (n == null) {
			return null;
		}
		...
		if ((org.jfree.chart.plot.PiePlot.this.direction) == (org.jfree.chart.util.Rotation.CLOCKWISE)) {
			for (int i = 0; i < section; i++) {
				n = org.jfree.chart.plot.PiePlot.this.dataset.getValue(i);
				if (n != null) {
					value = n.doubleValue();
					if (value >= 0.0) {
						lead = lead + value;
		...
		if ((java.lang.Math.abs(angle)) > (getMinimumArcAngleToDraw())) {
			...
			java.awt.geom.Rectangle2D arcBounds = getArcBounds(dataArea, dataArea, angle1, angle, ep);
			java.awt.geom.Arc2D.Double arc = new java.awt.geom.Arc2D.Double(arcBounds, angle1, angle, java.awt.geom.Arc2D.PIE);
			return arc;
		}
		return null;
	...
	public boolean equals(java.lang.Object obj) {
		...
		if ((org.jfree.chart.plot.PiePlot.this.autoPopulateSectionPaint) != (that.autoPopulateSectionPaint)) {
			return false;
		}
		if ((org.jfree.chart.plot.PiePlot.this.autoPopulateSectionOutlinePaint) != (that.autoPopulateSectionOutlinePaint)) {
			return false;
		}
		if ((org.jfree.chart.plot.PiePlot.this.autoPopulateSectionOutlineStroke) != (that.autoPopulateSectionOutlineStroke)) {
			return false;
		}
		if (!(org.jfree.chart.util.ObjectUtilities.equal(org.jfree.chart.plot.PiePlot.this.shadowGenerator, that.shadowGenerator))) {
			return false;
		}
		return true;
	}
	...
	public org.jfree.chart.plot.PieSelectionAttributes getSelectedItemAttributes() {
		return org.jfree.chart.plot.PiePlot.this.selectedItemAttributes;
	}
}
