...
public class XYShapeRenderer extends org.jfree.chart.renderer.xy.AbstractXYItemRenderer implements java.io.Serializable , java.lang.Cloneable , org.jfree.chart.renderer.xy.XYItemRenderer {
	...
	protected java.awt.Paint getPaint(org.jfree.data.xy.XYDataset dataset, int series, int item, boolean selected) {
	...
	public boolean equals(java.lang.Object obj) {
		...
		if (!(org.jfree.chart.renderer.xy.XYShapeRenderer.this.paintScale.equals(that.paintScale))) {
			return false;
		}
		...
		if (!(org.jfree.chart.renderer.xy.XYShapeRenderer.this.guideLinePaint.equals(that.guideLinePaint))) {
			return false;
		}
		if (!(org.jfree.chart.renderer.xy.XYShapeRenderer.this.guideLineStroke.equals(that.guideLineStroke))) {
			return false;
		}
