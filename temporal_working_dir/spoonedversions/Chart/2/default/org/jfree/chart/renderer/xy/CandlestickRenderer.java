...
public class CandlestickRenderer extends org.jfree.chart.renderer.xy.AbstractXYItemRenderer implements java.io.Serializable , java.lang.Cloneable , org.jfree.chart.renderer.xy.XYItemRenderer , org.jfree.chart.util.PublicCloneable {
	...
	public void drawItem(java.awt.Graphics2D g2, org.jfree.chart.renderer.xy.XYItemRendererState state, java.awt.geom.Rectangle2D dataArea, org.jfree.chart.plot.XYPlot plot, org.jfree.chart.axis.ValueAxis domainAxis, org.jfree.chart.axis.ValueAxis rangeAxis, org.jfree.data.xy.XYDataset dataset, int series, int item, boolean selected, int pass) {
		...
		java.awt.geom.Rectangle2D body = null;
		java.awt.geom.Rectangle2D hotspot = null;
		double length = java.lang.Math.abs((yyHigh - yyLow));
		double base = java.lang.Math.min(yyHigh, yyLow);
		if (horiz) {
			body = new java.awt.geom.Rectangle2D.Double(yyMinOpenClose, (xx - (stickWidth / 2)), (yyMaxOpenClose - yyMinOpenClose), stickWidth);
			hotspot = new java.awt.geom.Rectangle2D.Double(base, (xx - (stickWidth / 2)), length, stickWidth);
		}else {
			body = new java.awt.geom.Rectangle2D.Double((xx - (stickWidth / 2)), yyMinOpenClose, stickWidth, (yyMaxOpenClose - yyMinOpenClose));
			hotspot = new java.awt.geom.Rectangle2D.Double((xx - (stickWidth / 2)), base, stickWidth, length);
		}
		if (yClose > yOpen) {
	...
	public java.awt.geom.Rectangle2D createHotSpotBounds(java.awt.Graphics2D g2, java.awt.geom.Rectangle2D dataArea, org.jfree.chart.plot.XYPlot plot, org.jfree.chart.axis.ValueAxis domainAxis, org.jfree.chart.axis.ValueAxis rangeAxis, org.jfree.data.xy.XYDataset dataset, int series, int item, boolean selected, org.jfree.chart.renderer.xy.XYItemRendererState state, java.awt.geom.Rectangle2D result) {
		return super.createHotSpotBounds(g2, dataArea, plot, domainAxis, rangeAxis, dataset, series, item, selected, state, result);
	}
}
