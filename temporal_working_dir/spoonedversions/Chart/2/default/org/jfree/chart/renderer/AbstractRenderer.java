...
public abstract class AbstractRenderer implements java.io.Serializable , java.lang.Cloneable {
	...
	private transient java.awt.Shape baseLegendShape;

	private boolean treatLegendShapeAsLine;

	private org.jfree.chart.util.ObjectList legendTextFont;

	private java.awt.Font baseLegendTextFont;

	private org.jfree.chart.util.PaintList legendTextPaint;

	private transient java.awt.Paint baseLegendTextPaint;
	...
	private org.jfree.chart.renderer.RenderAttributes selectedItemAttributes;
	...
	public AbstractRenderer() {
		...
		org.jfree.chart.renderer.AbstractRenderer.this.autoPopulateSeriesStroke = true;
		...
		org.jfree.chart.renderer.AbstractRenderer.this.baseItemLabelFont = new java.awt.Font("Tahoma", java.awt.Font.PLAIN, 10);
		...
		org.jfree.chart.renderer.AbstractRenderer.this.defaultEntityRadius = 3;
		org.jfree.chart.renderer.AbstractRenderer.this.legendShapeList = new org.jfree.chart.util.ShapeList();
		org.jfree.chart.renderer.AbstractRenderer.this.baseLegendShape = null;
		org.jfree.chart.renderer.AbstractRenderer.this.treatLegendShapeAsLine = false;
		org.jfree.chart.renderer.AbstractRenderer.this.legendTextFont = new org.jfree.chart.util.ObjectList();
		org.jfree.chart.renderer.AbstractRenderer.this.baseLegendTextFont = null;
		org.jfree.chart.renderer.AbstractRenderer.this.legendTextPaint = new org.jfree.chart.util.PaintList();
		org.jfree.chart.renderer.AbstractRenderer.this.baseLegendTextPaint = null;
		org.jfree.chart.renderer.AbstractRenderer.this.listenerList = new javax.swing.event.EventListenerList();
		org.jfree.chart.renderer.AbstractRenderer.this.selectedItemAttributes = new org.jfree.chart.renderer.RenderAttributes();
		org.jfree.chart.renderer.AbstractRenderer.this.selectedItemAttributes.setDefaultFillPaint(java.awt.Color.WHITE);
	}
	...
	public org.jfree.chart.renderer.RenderAttributes getSelectedItemAttributes() {
		return org.jfree.chart.renderer.AbstractRenderer.this.selectedItemAttributes;
	}
	...
	public void setSeriesVisible(int series, java.lang.Boolean visible, boolean notify) {
		...
		if (notify) {
			org.jfree.chart.event.RendererChangeEvent e = new org.jfree.chart.event.RendererChangeEvent(org.jfree.chart.renderer.AbstractRenderer.this, true);
			notifyListeners(e);
		}
	}
	...
	public java.awt.Paint getItemPaint(int series, int item, boolean selected) {
		java.awt.Paint result = null;
		if (selected) {
			result = org.jfree.chart.renderer.AbstractRenderer.this.selectedItemAttributes.getItemPaint(series, item);
		}
		if (result == null) {
	...
	public void clearSeriesPaints(boolean notify) {
		org.jfree.chart.renderer.AbstractRenderer.this.paintList.clear();
		if (notify) {
			fireChangeEvent();
		}
	}
	...
	public java.awt.Paint getItemFillPaint(int series, int item, boolean selected) {
		java.awt.Paint result = null;
		if (selected) {
			result = org.jfree.chart.renderer.AbstractRenderer.this.selectedItemAttributes.getItemFillPaint(series, item);
		}
		if (result == null) {
	...
	public java.awt.Paint getItemOutlinePaint(int series, int item, boolean selected) {
		java.awt.Paint result = null;
		if (selected) {
			result = org.jfree.chart.renderer.AbstractRenderer.this.selectedItemAttributes.getItemOutlinePaint(series, item);
		}
		if (result == null) {
	...
	public java.awt.Stroke getItemStroke(int series, int item, boolean selected) {
	...
	public void clearSeriesStrokes(boolean notify) {
		org.jfree.chart.renderer.AbstractRenderer.this.strokeList.clear();
		if (notify) {
			fireChangeEvent();
		}
	}
	...
	public java.awt.Stroke getItemOutlineStroke(int series, int item, boolean selected) {
	...
	public java.awt.Shape getItemShape(int series, int item, boolean selected) {
		java.awt.Shape result = null;
		if (selected) {
			result = org.jfree.chart.renderer.AbstractRenderer.this.selectedItemAttributes.getItemShape(series, item);
		}
		if (result == null) {
	...
	public java.awt.Font getItemLabelFont(int series, int item, boolean selected) {
		java.awt.Font result = getSeriesItemLabelFont(series);
		if (result == null) {
	...
	public java.awt.Paint getItemLabelPaint(int series, int item, boolean selected) {
		java.awt.Paint result = getSeriesItemLabelPaint(series);
		if (result == null) {
	...
	public org.jfree.chart.labels.ItemLabelPosition getPositiveItemLabelPosition(int series, int item, boolean selected) {
	...
	public org.jfree.chart.labels.ItemLabelPosition getNegativeItemLabelPosition(int series, int item, boolean selected) {
	...
	public int getDefaultEntityRadius() {
		return org.jfree.chart.renderer.AbstractRenderer.this.defaultEntityRadius;
	}

	public void setDefaultEntityRadius(int radius) {
		org.jfree.chart.renderer.AbstractRenderer.this.defaultEntityRadius = radius;
	}

	public java.awt.Shape lookupLegendShape(int series) {
		java.awt.Shape result = getLegendShape(series);
		if (result == null) {
			result = org.jfree.chart.renderer.AbstractRenderer.this.baseLegendShape;
		}
		if (result == null) {
			result = lookupSeriesShape(series);
		}
	...
	public java.awt.Shape getLegendShape(int series) {
		return org.jfree.chart.renderer.AbstractRenderer.this.legendShapeList.getShape(series);
	}

	public void setLegendShape(int series, java.awt.Shape shape) {
		org.jfree.chart.renderer.AbstractRenderer.this.legendShapeList.setShape(series, shape);
		fireChangeEvent();
	}

	public java.awt.Shape getBaseLegendShape() {
		return org.jfree.chart.renderer.AbstractRenderer.this.baseLegendShape;
	}

	public void setBaseLegendShape(java.awt.Shape shape) {
		org.jfree.chart.renderer.AbstractRenderer.this.baseLegendShape = shape;
		fireChangeEvent();
	}

	protected boolean getTreatLegendShapeAsLine() {
		return org.jfree.chart.renderer.AbstractRenderer.this.treatLegendShapeAsLine;
	}

	protected void setTreatLegendShapeAsLine(boolean treatAsLine) {
		if ((org.jfree.chart.renderer.AbstractRenderer.this.treatLegendShapeAsLine) != treatAsLine) {
			org.jfree.chart.renderer.AbstractRenderer.this.treatLegendShapeAsLine = treatAsLine;
			fireChangeEvent();
		}
	}

	public java.awt.Font lookupLegendTextFont(int series) {
		java.awt.Font result = getLegendTextFont(series);
		if (result == null) {
			result = org.jfree.chart.renderer.AbstractRenderer.this.baseLegendTextFont;
		}
		return result;
	}

	public java.awt.Font getLegendTextFont(int series) {
		return ((java.awt.Font) (org.jfree.chart.renderer.AbstractRenderer.this.legendTextFont.get(series)));
	}

	public void setLegendTextFont(int series, java.awt.Font font) {
		org.jfree.chart.renderer.AbstractRenderer.this.legendTextFont.set(series, font);
		fireChangeEvent();
	}

	public java.awt.Font getBaseLegendTextFont() {
		return org.jfree.chart.renderer.AbstractRenderer.this.baseLegendTextFont;
	}

	public void setBaseLegendTextFont(java.awt.Font font) {
		org.jfree.chart.renderer.AbstractRenderer.this.baseLegendTextFont = font;
		fireChangeEvent();
	}

	public java.awt.Paint lookupLegendTextPaint(int series) {
		java.awt.Paint result = getLegendTextPaint(series);
		if (result == null) {
			result = org.jfree.chart.renderer.AbstractRenderer.this.baseLegendTextPaint;
		}
		return result;
	}

	public java.awt.Paint getLegendTextPaint(int series) {
		return org.jfree.chart.renderer.AbstractRenderer.this.legendTextPaint.getPaint(series);
	}

	public void setLegendTextPaint(int series, java.awt.Paint paint) {
		org.jfree.chart.renderer.AbstractRenderer.this.legendTextPaint.setPaint(series, paint);
		fireChangeEvent();
	}

	public java.awt.Paint getBaseLegendTextPaint() {
		return org.jfree.chart.renderer.AbstractRenderer.this.baseLegendTextPaint;
	}

	public void setBaseLegendTextPaint(java.awt.Paint paint) {
		org.jfree.chart.renderer.AbstractRenderer.this.baseLegendTextPaint = paint;
		fireChangeEvent();
	}

	public boolean getDataBoundsIncludesVisibleSeriesOnly() {
		return org.jfree.chart.renderer.AbstractRenderer.this.dataBoundsIncludesVisibleSeriesOnly;
	}

	public void setDataBoundsIncludesVisibleSeriesOnly(boolean visibleOnly) {
		org.jfree.chart.renderer.AbstractRenderer.this.dataBoundsIncludesVisibleSeriesOnly = visibleOnly;
		notifyListeners(new org.jfree.chart.event.RendererChangeEvent(org.jfree.chart.renderer.AbstractRenderer.this, true));
	}
	...
	public boolean equals(java.lang.Object obj) {
		...
		if ((org.jfree.chart.renderer.AbstractRenderer.this.dataBoundsIncludesVisibleSeriesOnly) != (that.dataBoundsIncludesVisibleSeriesOnly)) {
			return false;
		}
		if ((org.jfree.chart.renderer.AbstractRenderer.this.treatLegendShapeAsLine) != (that.treatLegendShapeAsLine)) {
			return false;
		}
		if ((org.jfree.chart.renderer.AbstractRenderer.this.defaultEntityRadius) != (that.defaultEntityRadius)) {
			return false;
		}
		...
		if (!(org.jfree.chart.util.ShapeUtilities.equal(org.jfree.chart.renderer.AbstractRenderer.this.baseShape, that.baseShape))) {
			return false;
		}
		...
		if (!(org.jfree.chart.util.ObjectUtilities.equal(org.jfree.chart.renderer.AbstractRenderer.this.legendShapeList, that.legendShapeList))) {
			return false;
		}
		if (!(org.jfree.chart.util.ShapeUtilities.equal(org.jfree.chart.renderer.AbstractRenderer.this.baseLegendShape, that.baseLegendShape))) {
			return false;
		}
		if (!(org.jfree.chart.util.ObjectUtilities.equal(org.jfree.chart.renderer.AbstractRenderer.this.legendTextFont, that.legendTextFont))) {
			return false;
		}
		if (!(org.jfree.chart.util.ObjectUtilities.equal(org.jfree.chart.renderer.AbstractRenderer.this.baseLegendTextFont, that.baseLegendTextFont))) {
			return false;
		}
		if (!(org.jfree.chart.util.ObjectUtilities.equal(org.jfree.chart.renderer.AbstractRenderer.this.legendTextPaint, that.legendTextPaint))) {
			return false;
		}
		if (!(org.jfree.chart.util.PaintUtilities.equal(org.jfree.chart.renderer.AbstractRenderer.this.baseLegendTextPaint, that.baseLegendTextPaint))) {
			return false;
		}
		return true;
	}
	...
	protected java.lang.Object clone() throws java.lang.CloneNotSupportedException {
		...
		if ((org.jfree.chart.renderer.AbstractRenderer.this.legendShapeList) != null) {
			clone.legendShapeList = ((org.jfree.chart.util.ShapeList) (org.jfree.chart.renderer.AbstractRenderer.this.legendShapeList.clone()));
		}
		if ((org.jfree.chart.renderer.AbstractRenderer.this.legendTextFont) != null) {
			clone.legendTextFont = ((org.jfree.chart.util.ObjectList) (org.jfree.chart.renderer.AbstractRenderer.this.legendTextFont.clone()));
		}
		if ((org.jfree.chart.renderer.AbstractRenderer.this.legendTextPaint) != null) {
			clone.legendTextPaint = ((org.jfree.chart.util.PaintList) (org.jfree.chart.renderer.AbstractRenderer.this.legendTextPaint.clone()));
		}
	...
	private void writeObject(java.io.ObjectOutputStream stream) throws java.io.IOException {
		...
		org.jfree.chart.util.SerialUtilities.writeShape(org.jfree.chart.renderer.AbstractRenderer.this.baseLegendShape, stream);
		org.jfree.chart.util.SerialUtilities.writePaint(org.jfree.chart.renderer.AbstractRenderer.this.baseLegendTextPaint, stream);
	}
	...
	private void readObject(java.io.ObjectInputStream stream) throws java.io.IOException, java.lang.ClassNotFoundException {
		...
		org.jfree.chart.renderer.AbstractRenderer.this.baseLegendShape = org.jfree.chart.util.SerialUtilities.readShape(stream);
		org.jfree.chart.renderer.AbstractRenderer.this.baseLegendTextPaint = org.jfree.chart.util.SerialUtilities.readPaint(stream);
		org.jfree.chart.renderer.AbstractRenderer.this.listenerList = new javax.swing.event.EventListenerList();
	}
}
