...
public class TextAnnotation extends org.jfree.chart.annotations.AbstractAnnotation implements java.io.Serializable {
	...
	public int hashCode() {
		...
		result = (37 * result) + (org.jfree.chart.util.HashUtilities.hashCodeForPaint(org.jfree.chart.annotations.TextAnnotation.this.paint));
