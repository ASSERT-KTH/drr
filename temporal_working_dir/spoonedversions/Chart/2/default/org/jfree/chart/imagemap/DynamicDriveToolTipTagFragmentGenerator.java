...
public class DynamicDriveToolTipTagFragmentGenerator implements org.jfree.chart.imagemap.ToolTipTagFragmentGenerator {
	...
	public java.lang.String generateToolTipFragment(java.lang.String toolTipText) {
		return ((((((" onMouseOver=\"return stm([\'" + (org.jfree.chart.imagemap.ImageMapUtilities.javascriptEscape(org.jfree.chart.imagemap.DynamicDriveToolTipTagFragmentGenerator.this.title))) + "','") + (org.jfree.chart.imagemap.ImageMapUtilities.javascriptEscape(toolTipText))) + "'],Style[") + (org.jfree.chart.imagemap.DynamicDriveToolTipTagFragmentGenerator.this.style)) + "]);\"") + " onMouseOut=\"return htm();\"";
	}
}
