...
public class TextBox implements java.io.Serializable {
	...
	public TextBox(java.lang.String text) {
		...
		if (text != null) {
			...
			org.jfree.chart.text.TextBox.this.textBlock.addLine(text, new java.awt.Font("Tahoma", java.awt.Font.PLAIN, 10), java.awt.Color.black);
		}
	}

	public TextBox(org.jfree.chart.text.TextBlock block) {
	...
	public void setInteriorGap(org.jfree.chart.util.RectangleInsets gap) {
	...
	public void setTextBlock(org.jfree.chart.text.TextBlock block) {
		org.jfree.chart.text.TextBox.this.textBlock = block;
	}

	public void draw(java.awt.Graphics2D g2, float x, float y, org.jfree.chart.util.RectangleAnchor anchor) {
		org.jfree.chart.util.Size2D d1 = org.jfree.chart.text.TextBox.this.textBlock.calculateDimensions(g2);
		double w = org.jfree.chart.text.TextBox.this.interiorGap.extendWidth(d1.getWidth());
		double h = org.jfree.chart.text.TextBox.this.interiorGap.extendHeight(d1.getHeight());
		org.jfree.chart.util.Size2D d2 = new org.jfree.chart.util.Size2D(w, h);
		java.awt.geom.Rectangle2D bounds = org.jfree.chart.util.RectangleAnchor.createRectangle(d2, x, y, anchor);
		double xx = bounds.getX();
		double yy = bounds.getY();
		if ((org.jfree.chart.text.TextBox.this.shadowPaint) != null) {
			java.awt.geom.Rectangle2D shadow = new java.awt.geom.Rectangle2D.Double((xx + (org.jfree.chart.text.TextBox.this.shadowXOffset)), (yy + (org.jfree.chart.text.TextBox.this.shadowYOffset)), bounds.getWidth(), bounds.getHeight());
		...
		org.jfree.chart.text.TextBox.this.textBlock.draw(g2, ((float) (xx + (org.jfree.chart.text.TextBox.this.interiorGap.calculateLeftInset(w)))), ((float) (yy + (org.jfree.chart.text.TextBox.this.interiorGap.calculateTopInset(h)))), org.jfree.chart.text.TextBlockAnchor.TOP_LEFT);
	}

	public double getHeight(java.awt.Graphics2D g2) {
		org.jfree.chart.util.Size2D d = org.jfree.chart.text.TextBox.this.textBlock.calculateDimensions(g2);
