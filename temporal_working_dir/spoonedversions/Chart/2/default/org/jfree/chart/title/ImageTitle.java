...
public class ImageTitle extends org.jfree.chart.title.Title {
	...
	public org.jfree.chart.util.Size2D arrange(java.awt.Graphics2D g2, org.jfree.chart.block.RectangleConstraint constraint) {
		org.jfree.chart.util.Size2D s = new org.jfree.chart.util.Size2D(org.jfree.chart.title.ImageTitle.this.image.getWidth(null), org.jfree.chart.title.ImageTitle.this.image.getHeight(null));
	...
	public boolean equals(java.lang.Object obj) {
		if (obj == (org.jfree.chart.title.ImageTitle.this)) {
			return true;
		}
		if (!(obj instanceof org.jfree.chart.title.ImageTitle)) {
			return false;
		}
		org.jfree.chart.title.ImageTitle that = ((org.jfree.chart.title.ImageTitle) (obj));
		if (!(org.jfree.chart.util.ObjectUtilities.equal(org.jfree.chart.title.ImageTitle.this.image, that.image))) {
			return false;
		}
