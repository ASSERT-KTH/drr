...
public class XYPlot extends org.jfree.chart.plot.Plot implements java.io.Serializable , java.lang.Cloneable , org.jfree.chart.event.RendererChangeListener , org.jfree.chart.plot.Pannable , org.jfree.chart.plot.Selectable , org.jfree.chart.plot.ValueAxisPlot , org.jfree.chart.plot.Zoomable , org.jfree.chart.util.PublicCloneable {
	...
	public XYPlot(org.jfree.data.xy.XYDataset dataset, org.jfree.chart.axis.ValueAxis domainAxis, org.jfree.chart.axis.ValueAxis rangeAxis, org.jfree.chart.renderer.xy.XYItemRenderer renderer) {
		...
		org.jfree.chart.plot.XYPlot.this.shadowGenerator = null;
	}
	...
	public void setDataset(int index, org.jfree.data.xy.XYDataset dataset) {
		...
		org.jfree.data.event.DatasetChangeEvent event = new org.jfree.data.event.DatasetChangeEvent(org.jfree.chart.plot.XYPlot.this, dataset, new org.jfree.chart.event.DatasetChangeInfo());
	...
	public void mapDatasetToDomainAxes(int index, java.util.List axisIndices) {
		...
		datasetChanged(new org.jfree.data.event.DatasetChangeEvent(org.jfree.chart.plot.XYPlot.this, getDataset(index), new org.jfree.chart.event.DatasetChangeInfo()));
	}
	...
	public void addAnnotation(org.jfree.chart.annotations.XYAnnotation annotation, boolean notify) {
		...
		annotation.addChangeListener(org.jfree.chart.plot.XYPlot.this);
		if (notify) {
			fireChangeEvent();
		}
	}
	...
	public boolean removeAnnotation(org.jfree.chart.annotations.XYAnnotation annotation, boolean notify) {
		...
		annotation.removeChangeListener(org.jfree.chart.plot.XYPlot.this);
		if (removed && notify) {
			fireChangeEvent();
		}
		return removed;
	...
	public void clearAnnotations() {
		for (int i = 0; i < (org.jfree.chart.plot.XYPlot.this.annotations.size()); i++) {
			org.jfree.chart.annotations.XYAnnotation annotation = ((org.jfree.chart.annotations.XYAnnotation) (org.jfree.chart.plot.XYPlot.this.annotations.get(i)));
			annotation.removeChangeListener(org.jfree.chart.plot.XYPlot.this);
		}
	...
	public org.jfree.chart.util.ShadowGenerator getShadowGenerator() {
		return org.jfree.chart.plot.XYPlot.this.shadowGenerator;
	}

	public void setShadowGenerator(org.jfree.chart.util.ShadowGenerator generator) {
		org.jfree.chart.plot.XYPlot.this.shadowGenerator = generator;
		fireChangeEvent();
	}
	...
	public void draw(java.awt.Graphics2D g2, java.awt.geom.Rectangle2D area, java.awt.geom.Point2D anchor, org.jfree.chart.plot.PlotState parentState, org.jfree.chart.plot.PlotRenderingInfo info) {
		...
		if ((org.jfree.chart.plot.XYPlot.this.shadowGenerator) != null) {
		...
		if ((org.jfree.chart.plot.XYPlot.this.shadowGenerator) != null) {
			java.awt.image.BufferedImage shadowImage = org.jfree.chart.plot.XYPlot.this.shadowGenerator.createDropShadow(dataImage);
			g2 = savedG2;
			dataArea = savedDataArea;
			g2.drawImage(shadowImage, (((int) (savedDataArea.getX())) + (org.jfree.chart.plot.XYPlot.this.shadowGenerator.calculateOffsetX())), (((int) (savedDataArea.getY())) + (org.jfree.chart.plot.XYPlot.this.shadowGenerator.calculateOffsetY())), null);
	...
	public boolean equals(java.lang.Object obj) {
		...
		if (!(org.jfree.chart.util.ObjectUtilities.equal(org.jfree.chart.plot.XYPlot.this.shadowGenerator, that.shadowGenerator))) {
			return false;
		}
	...
	public java.lang.Object clone() throws java.lang.CloneNotSupportedException {
		...
		for (int i = 0; i < (org.jfree.chart.plot.XYPlot.this.renderers.size()); i++) {
			...
			if (renderer2 instanceof org.jfree.chart.util.PublicCloneable) {
				...
				org.jfree.chart.renderer.xy.XYItemRenderer rc = ((org.jfree.chart.renderer.xy.XYItemRenderer) (pc.clone()));
	...
	public void select(double xx, double yy, java.awt.geom.Rectangle2D dataArea, org.jfree.chart.RenderingSource source) {
		int datasetCount = org.jfree.chart.plot.XYPlot.this.datasets.size();
		for (int d = 0; d < datasetCount; d++) {
			...
			org.jfree.chart.renderer.xy.XYItemRenderer renderer = getRendererForDataset(dataset);
			org.jfree.chart.renderer.xy.XYItemRendererState rs = renderer.initialise(source.createGraphics2D(), dataArea, org.jfree.chart.plot.XYPlot.this, dataset, null);
			int seriesCount = dataset.getSeriesCount();
			for (int s = 0; s < seriesCount; s++) {
				int itemCount = dataset.getItemCount(s);
				for (int i = 0; i < itemCount; i++) {
					if (renderer.hitTest(xx, yy, g2, dataArea, org.jfree.chart.plot.XYPlot.this, getDomainAxisForDataset(d), getRangeAxisForDataset(d), dataset, s, i, rs, false)) {
