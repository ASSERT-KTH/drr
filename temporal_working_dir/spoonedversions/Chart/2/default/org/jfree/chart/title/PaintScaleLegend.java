...
public class PaintScaleLegend extends org.jfree.chart.title.Title implements org.jfree.chart.event.AxisChangeListener , org.jfree.chart.util.PublicCloneable {
	...
	public PaintScaleLegend(org.jfree.chart.renderer.PaintScale scale, org.jfree.chart.axis.ValueAxis axis) {
		...
		org.jfree.chart.title.PaintScaleLegend.this.axis.addChangeListener(org.jfree.chart.title.PaintScaleLegend.this);
		...
		org.jfree.chart.title.PaintScaleLegend.this.stripOutlineVisible = true;
	...
	public void setAxis(org.jfree.chart.axis.ValueAxis axis) {
		...
		org.jfree.chart.title.PaintScaleLegend.this.axis.removeChangeListener(org.jfree.chart.title.PaintScaleLegend.this);
		org.jfree.chart.title.PaintScaleLegend.this.axis = axis;
		org.jfree.chart.title.PaintScaleLegend.this.axis.addChangeListener(org.jfree.chart.title.PaintScaleLegend.this);
		notifyListeners(new org.jfree.chart.event.TitleChangeEvent(org.jfree.chart.title.PaintScaleLegend.this));
	}
	...
	public void axisChanged(org.jfree.chart.event.AxisChangeEvent event) {
		if ((org.jfree.chart.title.PaintScaleLegend.this.axis) == (event.getAxis())) {
			notifyListeners(new org.jfree.chart.event.TitleChangeEvent(org.jfree.chart.title.PaintScaleLegend.this));
		}
	}
		...
		if (org.jfree.chart.util.RectangleEdge.isTopOrBottom(getPosition())) {
			...
			if (axisEdge == (org.jfree.chart.util.RectangleEdge.TOP)) {
				for (int i = 0; i < (org.jfree.chart.title.PaintScaleLegend.this.subdivisions); i++) {
					...
					double ww = (java.lang.Math.abs((vv1 - vv0))) + 1.0;
			...
			if (axisEdge == (org.jfree.chart.util.RectangleEdge.LEFT)) {
				for (int i = 0; i < (org.jfree.chart.title.PaintScaleLegend.this.subdivisions); i++) {
					...
					double hh = (java.lang.Math.abs((vv1 - vv0))) + 1.0;
