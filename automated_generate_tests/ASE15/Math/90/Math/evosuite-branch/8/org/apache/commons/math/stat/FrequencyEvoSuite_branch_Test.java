...
public class FrequencyEvoSuite_branch_Test  {
  ...
  public void test00()  throws Throwable  {
      ...
      char char0 = 'V';
      String string0 = "/Zpb*9bm>{#qx";
      char char1 = '1';
      int int0 = (-1851);
      frequency0.addValue(int0);
      Integer integer0 = Integer.getInteger(string0, (int) char1);
      ...
      long long0 = frequency0.getCumFreq((long) integer0);
      assertFalse(integer0.equals((Object)int0));
      assertFalse(char1 == char0);
  ...
  public void test15()  throws Throwable  {
      ...
      String string0 = "/Zpb*9bm>{#qx";
      frequency0.addValue((int) char0);
      Integer integer0 = Integer.getInteger(string0, (int) char0);
