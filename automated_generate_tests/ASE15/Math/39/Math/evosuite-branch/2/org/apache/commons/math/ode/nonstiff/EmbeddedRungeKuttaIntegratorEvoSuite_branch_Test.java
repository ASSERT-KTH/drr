...
public class EmbeddedRungeKuttaIntegratorEvoSuite_branch_Test  {
  ...
  public void test0()  throws Throwable  {
      double double0 = 2508.683677293484;
      ...
      assertEquals(2508.683677293484, highamHall54Integrator0.getMinStep(), 0.01D);
      ...
      assertEquals(2508.683677293484, highamHall54Integrator0.getCurrentSignedStepsize(), 0.01D);
      assertEquals(0.2, highamHall54Integrator0.getMinReduction(), 0.01D);
      assertEquals(2508.683677293484, highamHall54Integrator0.getMaxStep(), 0.01D);
  ...
  public void test1()  throws Throwable  {
      double double0 = 60.012180868232576;
      ...
      assertEquals(10.0, highamHall54Integrator0.getMaxGrowth(), 0.01D);
      assertEquals(60.012180868232576, highamHall54Integrator0.getCurrentSignedStepsize(), 0.01D);
      assertEquals(2147483647, highamHall54Integrator0.getMaxEvaluations());
      assertEquals(0.2, highamHall54Integrator0.getMinReduction(), 0.01D);
      assertEquals(60.012180868232576, highamHall54Integrator0.getMaxStep(), 0.01D);
      assertEquals(0, highamHall54Integrator0.getEvaluations());
      assertEquals(60.012180868232576, highamHall54Integrator0.getMinStep(), 0.01D);
      assertEquals(5, highamHall54Integrator0.getOrder());
      assertEquals("Higham-Hall 5(4)", highamHall54Integrator0.getName());
      assertEquals(0.9, highamHall54Integrator0.getSafety(), 0.01D);
      assertEquals(Double.NaN, highamHall54Integrator0.getCurrentStepStart(), 0.01D);
