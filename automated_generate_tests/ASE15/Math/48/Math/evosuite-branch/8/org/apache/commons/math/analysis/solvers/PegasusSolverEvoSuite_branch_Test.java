...
public class PegasusSolverEvoSuite_branch_Test  {
  ...
  public void test0()  throws Throwable  {
      ...
      assertEquals((-700.9101152), pegasusSolver0.getRelativeAccuracy(), 0.01D);
      assertEquals(0.0, pegasusSolver0.getMax(), 0.01D);
      assertEquals((-700.9101152), pegasusSolver0.getAbsoluteAccuracy(), 0.01D);
      assertEquals(0, pegasusSolver0.getEvaluations());
      assertEquals(0.0, pegasusSolver0.getMin(), 0.01D);
      assertEquals((-700.9101152), pegasusSolver0.getFunctionValueAccuracy(), 0.01D);
  }

  @Test
  public void test1()  throws Throwable  {
      double double0 = 2409.65031368;
      ...
      assertEquals(0.0, pegasusSolver0.getMax(), 0.01D);
      assertEquals(0.0, pegasusSolver0.getStartValue(), 0.01D);
      assertEquals(2409.65031368, pegasusSolver0.getAbsoluteAccuracy(), 0.01D);
      assertEquals(0, pegasusSolver0.getEvaluations());
      assertEquals(0.0, pegasusSolver0.getMin(), 0.01D);
