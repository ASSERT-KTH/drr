...
public class RegulaFalsiSolverEvoSuite_branch_Test  {
  ...
  public void test2()  throws Throwable  {
      double double0 = 1856.7633828720227;
      RegulaFalsiSolver regulaFalsiSolver0 = new RegulaFalsiSolver(double0, double0, double0);
      assertNotNull(regulaFalsiSolver0);
      assertEquals(0, regulaFalsiSolver0.getEvaluations());
      assertEquals(0, regulaFalsiSolver0.getMaxEvaluations());
      assertEquals(1856.7633828720227, regulaFalsiSolver0.getRelativeAccuracy(), 0.01D);
      assertEquals(1856.7633828720227, regulaFalsiSolver0.getFunctionValueAccuracy(), 0.01D);
      assertEquals(0.0, regulaFalsiSolver0.getStartValue(), 0.01D);
      assertEquals(1856.7633828720227, regulaFalsiSolver0.getAbsoluteAccuracy(), 0.01D);
      assertEquals(0.0, regulaFalsiSolver0.getMax(), 0.01D);
      assertEquals(0.0, regulaFalsiSolver0.getMin(), 0.01D);
  }
  ...
  public void test3()  throws Throwable  {
      double double0 = (-1129.65073832929);
      ...
      assertEquals(0, regulaFalsiSolver0.getMaxEvaluations());
      assertEquals(0.0, regulaFalsiSolver0.getMin(), 0.01D);
      assertEquals((-1129.65073832929), regulaFalsiSolver0.getAbsoluteAccuracy(), 0.01D);
      assertEquals((-1129.65073832929), regulaFalsiSolver0.getRelativeAccuracy(), 0.01D);
      assertEquals(0.0, regulaFalsiSolver0.getMax(), 0.01D);
      assertEquals(1.0E-15, regulaFalsiSolver0.getFunctionValueAccuracy(), 0.01D);
  }
}
