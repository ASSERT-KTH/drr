...
public class LineEvoSuite_branch_Test  {
  ...
  public void test04()  throws Throwable  {
      ...
      assertEquals(0.0, vector3D1.getDelta(), 0.01D);
      assertEquals(1.0, vector3D1.getNormSq(), 0.01D);
      assertEquals(2.0, vector3D3.getNormSq(), 0.01D);
      assertEquals(1.0, vector3D3.getNormInf(), 0.01D);
      assertEquals(1.4142135623730951, vector3D3.getNorm(), 0.01D);
      ...
      assertEquals(2.0, vector3D3.getNorm1(), 0.01D);
      assertEquals(0.7853981633974482, vector3D3.getDelta(), 0.01D);
