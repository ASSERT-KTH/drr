...
public class LineEvoSuite_branch_Test  {
  ...
  public void test06()  throws Throwable  {
      ...
      assertEquals(false, vector3D0.isNaN());
      assertEquals(false, vector3D0.isInfinite());
      assertEquals(5.323190480471894, vector3D0.getNorm1(), 0.01D);
      assertEquals((-1.7743968268239647), vector3D0.getZ(), 0.01D);
      assertEquals(1.7743968268239647, vector3D0.getNormInf(), 0.01D);
      assertEquals((-2.356194490192345), vector3D0.getAlpha(), 0.01D);
      assertEquals(3.0733454568481013, vector3D0.getNorm(), 0.01D);
      assertEquals((-1.7743968268239647), vector3D0.getY(), 0.01D);
      assertEquals((-1.7743968268239647), vector3D0.getX(), 0.01D);
      assertEquals((-0.6154797086703873), vector3D0.getDelta(), 0.01D);
      assertEquals(9.445452297128865, vector3D0.getNormSq(), 0.01D);
      assertNotNull(vector3D0);
      
      Vector3D vector3D1 = vector3D0.scalarMultiply(double0);
      assertEquals(3.148484099042955, vector3D1.getX(), 0.01D);
      assertEquals(3.148484099042955, vector3D1.getZ(), 0.01D);
      assertEquals(3.148484099042955, vector3D1.getY(), 0.01D);
      assertEquals(9.445452297128865, vector3D1.getNorm1(), 0.01D);
      assertEquals(5.453334426365119, vector3D1.getNorm(), 0.01D);
      assertEquals(29.738856365778982, vector3D1.getNormSq(), 0.01D);
      assertEquals(0.6154797086703873, vector3D1.getDelta(), 0.01D);
      assertEquals(false, vector3D1.isInfinite());
      assertEquals(3.148484099042955, vector3D1.getNormInf(), 0.01D);
      assertEquals(false, vector3D1.isNaN());
