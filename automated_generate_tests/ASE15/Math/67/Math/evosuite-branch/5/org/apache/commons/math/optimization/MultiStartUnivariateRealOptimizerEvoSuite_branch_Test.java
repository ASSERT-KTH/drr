...
public class MultiStartUnivariateRealOptimizerEvoSuite_branch_Test  {
  ...
  public void test00()  throws Throwable  {
      ...
      try {
        double double0 = multiStartUnivariateRealOptimizer1.optimize((UnivariateRealFunction) polynomialFunction0, goalType0, doubleArray0[0], doubleArray0[2], (double) int0);
  ...
  public void test11()  throws Throwable  {
      ...
      byte byte0 = (byte) (-13);
      MultiStartUnivariateRealOptimizer multiStartUnivariateRealOptimizer0 = new MultiStartUnivariateRealOptimizer(univariateRealOptimizer0, (int) byte0, (RandomGenerator) jDKRandomGenerator0);
      assertNotNull(multiStartUnivariateRealOptimizer0);
      assertEquals(0, multiStartUnivariateRealOptimizer0.getEvaluations());
      assertEquals(2147483647, multiStartUnivariateRealOptimizer0.getMaximalIterationCount());
      assertEquals(2147483647, multiStartUnivariateRealOptimizer0.getMaxEvaluations());
      ...
      // Undeclared exception!
      try {
        multiStartUnivariateRealOptimizer0.setRelativeAccuracy((double) byte0);
        fail("Expecting exception: NullPointerException");
