...
public class Incrementor_ESTest extends Incrementor_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      incrementor0.setMaximalCount(565);
      incrementor0.incrementCount(565);
      boolean boolean0 = incrementor0.canIncrement();
      assertEquals(565, incrementor0.getMaximalCount());
  ...
  public void test03()  throws Throwable  {
      Incrementor incrementor0 = new Incrementor(2600);
  ...
  public void test05()  throws Throwable  {
      Incrementor incrementor0 = new Incrementor(537);
      incrementor0.incrementCount();
      // Undeclared exception!
      try { 
        incrementor0.incrementCount(537);
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // illegal state: maximal count (537) exceeded
         //
  ...
  public void test07()  throws Throwable  {
      Incrementor incrementor0 = new Incrementor((-429));
      incrementor0.incrementCount((-429));
      assertEquals(-429, incrementor0.getMaximalCount());
      assertEquals(0, incrementor0.getCount());
  }
  ...
  public void test11()  throws Throwable  {
      Incrementor incrementor0 = new Incrementor(2600);
      int int0 = incrementor0.getCount();
      assertEquals(2600, incrementor0.getMaximalCount());
      assertEquals(0, int0);
  }
