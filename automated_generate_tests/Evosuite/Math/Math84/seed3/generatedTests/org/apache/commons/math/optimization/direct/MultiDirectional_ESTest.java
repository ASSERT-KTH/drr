...
public class MultiDirectional_ESTest extends MultiDirectional_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      RealPointValuePair realPointValuePair0 = new RealPointValuePair(doubleArray0, 0.0);
      realPointValuePairArray0[0] = realPointValuePair0;
      RealPointValuePair realPointValuePair1 = new RealPointValuePair(doubleArray0, (-3771.52));
  ...
  public void test2()  throws Throwable  {
      MultiDirectional multiDirectional0 = new MultiDirectional(1629.085, 1629.085);
      RealPointValuePair[] realPointValuePairArray0 = new RealPointValuePair[1];
      double[] doubleArray0 = new double[0];
      RealPointValuePair realPointValuePair0 = new RealPointValuePair(doubleArray0, 1629.085, true);
      realPointValuePairArray0[0] = realPointValuePair0;
      multiDirectional0.simplex = realPointValuePairArray0;
      // Undeclared exception!
      try { 
  ...
  public void test3()  throws Throwable  {
      MultiDirectional multiDirectional0 = new MultiDirectional(506.259435555306, 0.708);
      ...
      multiDirectional0.setMaxEvaluations((-1503));
      multiDirectional0.simplex = realPointValuePairArray0;
      try { 
        multiDirectional0.iterateSimplex((Comparator<RealPointValuePair>) null);
        fail("Expecting exception: Exception");
         ...
         //
         // org.evosuite.runtime.mock.java.lang.MockThrowable: Maximal number of evaluations (-1,503) exceeded
         //
  ...
  public void test4()  throws Throwable  {
      MultiDirectional multiDirectional0 = new MultiDirectional();
      multiDirectional0.setMaxIterations((-3826));
      try { 
        multiDirectional0.iterateSimplex((Comparator<RealPointValuePair>) null);
        fail("Expecting exception: Exception");
         ...
         //
         // org.evosuite.runtime.mock.java.lang.MockThrowable: Maximal number of iterations (-3,826) exceeded
         //
         verifyException("org.apache.commons.math.optimization.direct.DirectSearchOptimizer", e);
      }
  }
  ...
  public void test5()  throws Throwable  {
      MultiDirectional multiDirectional0 = new MultiDirectional(2226.9057683462, Double.NaN);
      double[] doubleArray0 = new double[8];
      doubleArray0[1] = Double.NaN;
      RealPointValuePair[] realPointValuePairArray0 = new RealPointValuePair[6];
      RealPointValuePair realPointValuePair0 = new RealPointValuePair(doubleArray0, (-2862.7000275584));
      realPointValuePairArray0[0] = realPointValuePair0;
